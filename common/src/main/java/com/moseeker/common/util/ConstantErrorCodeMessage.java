...
public final class ConstantErrorCodeMessage {
	...
	public static final String PROGRAM_EXCEPTION = "{'status':9999 ,'发生异常，此时稍候再试!'}";
	...
	public static final String LOGIN_ACCOUNT_UNLEGAL = "{'status':10010,'message':'系统繁忙，请稍后再试！'}";
	public static final String LOGIN_VALIDATION_CODE_UNLEGAL = "{'status':10011,'message':'无效验证码！'}";
