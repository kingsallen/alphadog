...
public class CacheconfigRediskey extends TableImpl<CacheconfigRediskeyRecord> {
	...
	private static final long serialVersionUID = -160698457;
	...
	/**
	 * The column <code>configDB.cacheconfig_rediskey.project_appid</code>. 项目id， 0 基础服务
	 */
	public final TableField<CacheconfigRediskeyRecord, Integer> PROJECT_APPID = createField("project_appid", org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "项目id， 0 基础服务");
	...
	/**
	 * The column <code>configDB.cacheconfig_rediskey.type</code>. 缓存类型 1 data  2. session 3 log
	 */
	public final TableField<CacheconfigRediskeyRecord, Byte> TYPE = createField("type", org.jooq.impl.SQLDataType.TINYINT.nullable(false), this, "缓存类型 1 data  2. session 3 log");
