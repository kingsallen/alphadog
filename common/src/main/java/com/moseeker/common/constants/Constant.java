...
public final class Constant {
    ...
    public static final String PROFILE_SEARCH_KEYWORD_COLUMS="recent_job.company_name;recent_job.position_name;recent_job.description;" +
            "other_workexps.company_name;other_workexps.position_name;other_workexps.description;educations.major_name;" +
