...
public enum BindingStatus {
	...
	// 6：绑定程序发生错误（前端和2状态一致），7：刷新程序发生错误（前端和3状态一致），8:绑定成功，正在获取信息，9:取消分配,100:需要获取验证码'
	UNBIND(0), BOUND(1),BOUNDING(2),REFRESH(3),INFOWRONG(4),FAIL(5),ERROR(6),REFRESHWRONG(7),GETINGINFO(8),UNDISPATCH(9),NEEDCODE(100);
