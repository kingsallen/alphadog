...
public enum KeyIdentifier {
    ...
    MQ_MESSAGE_NOTICE_TEMPLATE_DEMONSTRATION_DELAY,
    ...
    HEADHUNTER_REFERRAL_PROFILE,
    EMPLOYEE_REFERRAL_PROFILE_TYPE,
    MALL_ORDER,
    MALL_ORDER_OPERATION,
    MALL_ORDER_ID,
    ...
    TEN_MINUTE_TEMPLATE,
    THIRD_PARTY_ACCOUNT_BINDING_MESSAGE_UNIQUE,
    JOB58_TOKEN_REFRESH,
    REDIS_LOG,
    POSITION_LIST_FALLBACK,
    NEO4J_SERVICE_DATA_CACHE,
    THIRD_PARTY_POSITION_SYNCHRONIZATION_JOBNUMBER,
    THIRD_PARTY_POSITION_SYNC_POSITIONID,
    USER_EMPLOYEE_ISEMPLOYEE,
