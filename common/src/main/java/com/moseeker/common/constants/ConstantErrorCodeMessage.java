...
public final class ConstantErrorCodeMessage {
    ...
    public static final String CRAWLER_SERVICE_NEED_VERIFY_CODE = "{'status':32011,'message':'需要'}";
    public static final String CRAWLER_SERVICE_ACCOUNT_LIMIT = "{'status':32012,'message':'简历为空'}";
    //talentpool
