...
public final class ConstantErrorCodeMessage {
    ...
    //职位同步
    public static final String POSITION_SYNC_VERIFY_TIMEOUT = "{'status':61001,'message':'验证超时，请重新发布'}";
    ...
    public static final String POSITION_SYNC_EMPTY_MOBILE_CODE = "{'status':61007,'message':'验证处理--验证码为空'}";
    //APPBS错误代码61000
