...
public class LRUCache {
	...
	class Node {
		...
		CacheConfigRedisKey redisKey;
		Node preNode;
		Node nextNode;

		public Node(String appIdAndKeyIdentifier, CacheConfigRedisKey rediskey) {
	 ...
	 */
	public CacheConfigRedisKey getRedisKey(String appIdAndKeyIdentifier) {
	 ...
	 */
	public void set(String appIdAndKeyIdentifier, CacheConfigRedisKey redisKey) {
		if (cache.containsKey(appIdAndKeyIdentifier)) {
	 ...
	 */
	public CacheConfigRedisKey getLRUData() {
		return end.redisKey;
	}
	 ...
	 */
	public List<CacheConfigRedisKey> getCacheDataInListForm() {
		ArrayList<CacheConfigRedisKey> listOfCacheData = new ArrayList<>();
		Node temp = head;
		while (temp != null) {
