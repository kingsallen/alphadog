...
public class HrWxNoticeMessage extends TableImpl<HrWxNoticeMessageRecord> {
	...
	private static final long serialVersionUID = 390438565;

	/**
	 * The reference instance of <code>dqv4.hr_wx_notice_message</code>
	 */
	...
	/**
	 * The column <code>dqv4.hr_wx_notice_message.id</code>. 主key
	 */
	...
	/**
	 * The column <code>dqv4.hr_wx_notice_message.wechat_id</code>. 所属公众号
	 */
	...
	/**
	 * The column <code>dqv4.hr_wx_notice_message.notice_id</code>. sys_notice_message.id
	 */
	...
	/**
	 * The column <code>dqv4.hr_wx_notice_message.first</code>. 消息模板first文案
	 */
	...
	/**
	 * The column <code>dqv4.hr_wx_notice_message.remark</code>. 消息模板remark文案
	 */
	...
	/**
	 * The column <code>dqv4.hr_wx_notice_message.status</code>. 是否开启, 1:开启, 0:关闭
	 */
	...
	/**
	 * Create a <code>dqv4.hr_wx_notice_message</code> table reference
	 */
	...
	/**
	 * Create an aliased <code>dqv4.hr_wx_notice_message</code> table reference
	 */
	...
	private HrWxNoticeMessage(String alias, Table<HrWxNoticeMessageRecord> aliased, Field<?>[] parameters) {
		super(alias, Dqv4.DQV4, aliased, parameters, "微信消息通知, first和remark文案暂不使用");
	}
