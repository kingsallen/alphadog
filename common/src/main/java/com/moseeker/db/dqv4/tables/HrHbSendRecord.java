...
public class HrHbSendRecord extends TableImpl<HrHbSendRecordRecord> {
	...
	private static final long serialVersionUID = -1737655486;

	/**
	 * The reference instance of <code>dqv4.hr_hb_send_record</code>
	 */
	...
	/**
	 * The column <code>dqv4.hr_hb_send_record.id</code>.
	 */
	...
	/**
	 * The column <code>dqv4.hr_hb_send_record.return_code</code>. SUCCESS/FAIL 此字段是通信标识,非交易标识,交易是否成功需要查看result_code来判断
	 */
	...
	/**
	 * The column <code>dqv4.hr_hb_send_record.return_msg</code>. 返回信息,如非空,为错误原因
	 */
	...
	/**
	 * The column <code>dqv4.hr_hb_send_record.sign</code>. 生成签名
	 */
	...
	/**
	 * The column <code>dqv4.hr_hb_send_record.result_code</code>. SUCCESS/FAIL
	 */
	...
	/**
	 * The column <code>dqv4.hr_hb_send_record.err_code</code>. 错误码信息
	 */
	...
	/**
	 * The column <code>dqv4.hr_hb_send_record.err_code_des</code>. 结果信息描述
	 */
	...
	/**
	 * The column <code>dqv4.hr_hb_send_record.mch_billno</code>. 商户订单号
	 */
	...
	/**
	 * The column <code>dqv4.hr_hb_send_record.mch_id</code>. 微信支付分配的商户号
	 */
	...
	/**
	 * The column <code>dqv4.hr_hb_send_record.wxappid</code>. 商户appid
	 */
	...
	/**
	 * The column <code>dqv4.hr_hb_send_record.re_openid</code>. 接受收红包的用户,用户在wxappid下的openid
	 */
	...
	/**
	 * The column <code>dqv4.hr_hb_send_record.total_amount</code>. 付款金额,单位分
	 */
	...
	/**
	 * The column <code>dqv4.hr_hb_send_record.send_time</code>. 红包发送时间
	 */
	...
	/**
	 * The column <code>dqv4.hr_hb_send_record.send_listid</code>. 红包订单的微信单号
	 */
	...
	/**
	 * The column <code>dqv4.hr_hb_send_record.create_time</code>.
	 */
	...
	/**
	 * Create a <code>dqv4.hr_hb_send_record</code> table reference
	 */
	...
	/**
	 * Create an aliased <code>dqv4.hr_hb_send_record</code> table reference
	 */
	...
	private HrHbSendRecord(String alias, Table<HrHbSendRecordRecord> aliased, Field<?>[] parameters) {
		super(alias, Dqv4.DQV4, aliased, parameters, "红包发送记录");
	}
