...
public class HrWxHrChatList extends TableImpl<HrWxHrChatListRecord> {
	...
	private static final long serialVersionUID = 2132345046;

	/**
	 * The reference instance of <code>dqv4.hr_wx_hr_chat_list</code>
	 */
	...
	/**
	 * The column <code>dqv4.hr_wx_hr_chat_list.id</code>. ID
	 */
	...
	/**
	 * The column <code>dqv4.hr_wx_hr_chat_list.sysuser_id</code>. sysuser.id
	 */
	...
	/**
	 * The column <code>dqv4.hr_wx_hr_chat_list.hraccount_id</code>. hr_account.id
	 */
	...
	/**
	 * The column <code>dqv4.hr_wx_hr_chat_list.status</code>. 状态，0：有效，1：无效
	 */
	...
	/**
	 * The column <code>dqv4.hr_wx_hr_chat_list.create_time</code>. 创建时间
	 */
	...
	/**
	 * The column <code>dqv4.hr_wx_hr_chat_list.wx_chat_time</code>. sysuser最近一次聊天时间
	 */
	...
	/**
	 * The column <code>dqv4.hr_wx_hr_chat_list.hr_chat_time</code>. HR最近一次聊天时间
	 */
	...
	/**
	 * Create a <code>dqv4.hr_wx_hr_chat_list</code> table reference
	 */
	...
	/**
	 * Create an aliased <code>dqv4.hr_wx_hr_chat_list</code> table reference
	 */
	...
	private HrWxHrChatList(String alias, Table<HrWxHrChatListRecord> aliased, Field<?>[] parameters) {
		super(alias, Dqv4.DQV4, aliased, parameters, "IM聊天人关系");
	}
