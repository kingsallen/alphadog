...
public class LogWxMessageRecord extends TableImpl<LogWxMessageRecordRecord> {
	...
	private static final long serialVersionUID = 1778547286;

	/**
	 * The reference instance of <code>dqv4.log_wx_message_record</code>
	 */
	...
	/**
	 * The column <code>dqv4.log_wx_message_record.id</code>. 主key
	 */
	...
	/**
	 * The column <code>dqv4.log_wx_message_record.template_id</code>. 我的模板ID
	 */
	...
	/**
	 * The column <code>dqv4.log_wx_message_record.wechat_id</code>. 所属公众号
	 */
	...
	/**
	 * The column <code>dqv4.log_wx_message_record.msgid</code>. 发送消息ID
	 */
	...
	/**
	 * The column <code>dqv4.log_wx_message_record.open_id</code>. 微信用户OPENID
	 */
	...
	/**
	 * The column <code>dqv4.log_wx_message_record.url</code>. link
	 */
	...
	/**
	 * The column <code>dqv4.log_wx_message_record.topcolor</code>. 信息顶部颜色
	 */
	...
	/**
	 * The column <code>dqv4.log_wx_message_record.jsondata</code>. 发送的json数据
	 */
	...
	/**
	 * The column <code>dqv4.log_wx_message_record.errcode</code>. 返回结果值
	 */
	...
	/**
	 * The column <code>dqv4.log_wx_message_record.errmsg</code>. 返回提示信息
	 */
	...
	/**
	 * The column <code>dqv4.log_wx_message_record.sendtime</code>. 发送时间
	 */
	...
	/**
	 * The column <code>dqv4.log_wx_message_record.updatetime</code>. 反馈状态时间
	 */
	...
	/**
	 * The column <code>dqv4.log_wx_message_record.sendstatus</code>. 发送状态
	 */
	...
	/**
	 * The column <code>dqv4.log_wx_message_record.sendtype</code>. 发送类型 0:微信 1:邮件 2:短信
	 */
	...
	/**
	 * The column <code>dqv4.log_wx_message_record.access_token</code>. 发送时的access_token
	 */
	...
	/**
	 * Create a <code>dqv4.log_wx_message_record</code> table reference
	 */
	...
	/**
	 * Create an aliased <code>dqv4.log_wx_message_record</code> table reference
	 */
	...
	private LogWxMessageRecord(String alias, Table<LogWxMessageRecordRecord> aliased, Field<?>[] parameters) {
		super(alias, Dqv4.DQV4, aliased, parameters, "模板消息发送结果记录表");
	}
