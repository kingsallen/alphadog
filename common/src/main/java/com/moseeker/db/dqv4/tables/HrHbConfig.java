...
public class HrHbConfig extends TableImpl<HrHbConfigRecord> {
	...
	private static final long serialVersionUID = -527804254;

	/**
	 * The reference instance of <code>dqv4.hr_hb_config</code>
	 */
	...
	/**
	 * The column <code>dqv4.hr_hb_config.id</code>.
	 */
	public final TableField<HrHbConfigRecord, Integer> ID = createField("id", org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");

	/**
	 * The column <code>dqv4.hr_hb_config.type</code>. 0:员工认证红包，1:推荐评价红包，2:转发被点击红包，3:转发被申请红包
	 */
	...
	/**
	 * The column <code>dqv4.hr_hb_config.target</code>. 0:员工，1:员工及员工二度，2:粉丝
	 */
	...
	/**
	 * The column <code>dqv4.hr_hb_config.company_id</code>. company.id
	 */
	...
	/**
	 * The column <code>dqv4.hr_hb_config.start_time</code>. 红包活动开始时间
	 */
	...
	/**
	 * The column <code>dqv4.hr_hb_config.end_time</code>. 红包活动结束时间，直到红包用尽：2037-12-31 23:59:59）
	 */
	...
	/**
	 * The column <code>dqv4.hr_hb_config.total_amount</code>. 总预算
	 */
	...
	/**
	 * The column <code>dqv4.hr_hb_config.range_min</code>. 红包最小金额
	 */
	...
	/**
	 * The column <code>dqv4.hr_hb_config.range_max</code>. 红包最大金额
	 */
	...
	/**
	 * The column <code>dqv4.hr_hb_config.probability</code>. 中奖几率: 0 < x <= 100
	 */
	...
	/**
	 * The column <code>dqv4.hr_hb_config.d_type</code>. 分布类型 0:平均分布，1:指数分布
	 */
	...
	/**
	 * The column <code>dqv4.hr_hb_config.headline</code>. 抽奖页面标题
	 */
	...
	/**
	 * The column <code>dqv4.hr_hb_config.headline_failure</code>. 抽奖失败页面标题
	 */
	...
	/**
	 * The column <code>dqv4.hr_hb_config.share_title</code>. 转发消息标题
	 */
	...
	/**
	 * The column <code>dqv4.hr_hb_config.share_desc</code>. 转发消息摘要
	 */
	...
	/**
	 * The column <code>dqv4.hr_hb_config.share_img</code>. 转发消息背景图地址
	 */
	...
	/**
	 * The column <code>dqv4.hr_hb_config.status</code>. 0:待审核，1:已审核，2:未开始，3:进行中：4:暂停中，5：已完成， －1: 已删除
	 */
	...
	/**
	 * The column <code>dqv4.hr_hb_config.checked</code>. 0:未审核，1:审核通过，2:审核不通过
	 */
	...
	/**
	 * The column <code>dqv4.hr_hb_config.estimated_total</code>. 预估红包总数
	 */
	...
	/**
	 * The column <code>dqv4.hr_hb_config.create_time</code>. 创建时间
	 */
	...
	/**
	 * The column <code>dqv4.hr_hb_config.update_time</code>. 更新时间
	 */
	...
	/**
	 * The column <code>dqv4.hr_hb_config.actual_total</code>. 实际红包总数
	 */
	...
	/**
	 * Create a <code>dqv4.hr_hb_config</code> table reference
	 */
	public HrHbConfig() {
	...
	/**
	 * Create an aliased <code>dqv4.hr_hb_config</code> table reference
	 */
	...
	private HrHbConfig(String alias, Table<HrHbConfigRecord> aliased, Field<?>[] parameters) {
		super(alias, Dqv4.DQV4, aliased, parameters, "红包配置表");
	}
