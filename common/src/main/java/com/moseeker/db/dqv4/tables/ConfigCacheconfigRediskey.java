...
public class ConfigCacheconfigRediskey extends TableImpl<ConfigCacheconfigRediskeyRecord> {
	...
	private static final long serialVersionUID = -1455519459;

	/**
	 * The reference instance of <code>dqv4.config_cacheconfig_rediskey</code>
	 */
	...
	/**
	 * The column <code>dqv4.config_cacheconfig_rediskey.id</code>.
	 */
	...
	/**
	 * The column <code>dqv4.config_cacheconfig_rediskey.project_appid</code>. 项目id 0 基础服务
	 */
	...
	/**
	 * The column <code>dqv4.config_cacheconfig_rediskey.key_identifier</code>. 标识符， 大写英文字母
	 */
	...
	/**
	 * The column <code>dqv4.config_cacheconfig_rediskey.type</code>. 缓存类型 1 data  2. session 3 log
	 */
	...
	/**
	 * The column <code>dqv4.config_cacheconfig_rediskey.pattern</code>. 格式， 形如 ip_limit_%s
	 */
	...
	/**
	 * The column <code>dqv4.config_cacheconfig_rediskey.json_extraparams</code>. 额外参数， 如{'maxPerHour':100}
	 */
	...
	/**
	 * The column <code>dqv4.config_cacheconfig_rediskey.ttl</code>. 生存时间， 单位秒
	 */
	...
	/**
	 * The column <code>dqv4.config_cacheconfig_rediskey.desc</code>. 备注， 包含json_extraparams的解释
	 */
	...
	/**
	 * The column <code>dqv4.config_cacheconfig_rediskey.create_time</code>.
	 */
	...
	/**
	 * Create a <code>dqv4.config_cacheconfig_rediskey</code> table reference
	 */
	...
	/**
	 * Create an aliased <code>dqv4.config_cacheconfig_rediskey</code> table reference
	 */
	...
	private ConfigCacheconfigRediskey(String alias, Table<ConfigCacheconfigRediskeyRecord> aliased, Field<?>[] parameters) {
		super(alias, Dqv4.DQV4, aliased, parameters, "redis缓存配置表");
	}
