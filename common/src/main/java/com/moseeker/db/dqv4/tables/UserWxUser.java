...
public class UserWxUser extends TableImpl<UserWxUserRecord> {
	...
	private static final long serialVersionUID = 656626288;

	/**
	 * The reference instance of <code>dqv4.user_wx_user</code>
	 */
	...
	/**
	 * The column <code>dqv4.user_wx_user.id</code>. 主key
	 */
	...
	/**
	 * The column <code>dqv4.user_wx_user.wechat_id</code>. 所属公众号
	 */
	...
	/**
	 * The column <code>dqv4.user_wx_user.group_id</code>. 分组ID
	 */
	...
	/**
	 * The column <code>dqv4.user_wx_user.sysuser_id</code>.
	 */
	...
	/**
	 * The column <code>dqv4.user_wx_user.is_subscribe</code>. 是否关注 1:关注 0：没关注
	 */
	...
	/**
	 * The column <code>dqv4.user_wx_user.openid</code>. 用户标示
	 */
	...
	/**
	 * The column <code>dqv4.user_wx_user.nickname</code>. 用户昵称
	 */
	...
	/**
	 * The column <code>dqv4.user_wx_user.sex</code>. 用户性别 0:未知 1:男性 2:女性
	 */
	...
	/**
	 * The column <code>dqv4.user_wx_user.city</code>. 用户所在城市
	 */
	...
	/**
	 * The column <code>dqv4.user_wx_user.country</code>. 用户所在国家
	 */
	...
	/**
	 * The column <code>dqv4.user_wx_user.province</code>. 用户所在省份
	 */
	...
	/**
	 * The column <code>dqv4.user_wx_user.language</code>. 用户语言
	 */
	...
	/**
	 * The column <code>dqv4.user_wx_user.headimgurl</code>. 用户头像
	 */
	...
	/**
	 * The column <code>dqv4.user_wx_user.subscribe_time</code>. 用户关注时间
	 */
	...
	/**
	 * The column <code>dqv4.user_wx_user.unsubscibe_time</code>.
	 */
	...
	/**
	 * The column <code>dqv4.user_wx_user.unionid</code>. UnionID
	 */
	...
	/**
	 * The column <code>dqv4.user_wx_user.reward</code>. 积分奖励，暂时不用
	 */
	...
	/**
	 * The column <code>dqv4.user_wx_user.auto_sync_info</code>. 0：需要处理，1：处理过了
	 */
	...
	/**
	 * The column <code>dqv4.user_wx_user.create_time</code>. 创建时间
	 */
	...
	/**
	 * The column <code>dqv4.user_wx_user.update_time</code>.
	 */
	...
	/**
	 * The column <code>dqv4.user_wx_user.source</code>. insert来源 1:SUBSCRIBED 2:UNSUBSCRIBED 3:订阅号调用api的48001 4:oauth 5:update all 6:update short 7:oauth update 8:微信扫码注册 9:upd unionid 10:upd sysuser, 11:ups sysnuser 12：微信端我也要招人注册
	 */
	...
	/**
	 * Create a <code>dqv4.user_wx_user</code> table reference
	 */
	public UserWxUser() {
	...
	/**
	 * Create an aliased <code>dqv4.user_wx_user</code> table reference
	 */
	...
	private UserWxUser(String alias, Table<UserWxUserRecord> aliased, Field<?>[] parameters) {
		super(alias, Dqv4.DQV4, aliased, parameters, "微信用户表");
	}
