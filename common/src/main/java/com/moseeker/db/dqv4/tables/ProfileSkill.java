...
public class ProfileSkill extends TableImpl<ProfileSkillRecord> {
	...
	private static final long serialVersionUID = -2121583606;

	/**
	 * The reference instance of <code>dqv4.profile_skill</code>
	 */
	...
	/**
	 * The column <code>dqv4.profile_skill.id</code>. 主key
	 */
	...
	/**
	 * The column <code>dqv4.profile_skill.profile_id</code>. profile.id
	 */
	...
	/**
	 * The column <code>dqv4.profile_skill.name</code>. 技能名称
	 */
	...
	/**
	 * The column <code>dqv4.profile_skill.level</code>. 掌握程度 0:未填写 1：掌握 2：熟练 3：精通
	 */
	...
	/**
	 * The column <code>dqv4.profile_skill.month</code>. 使用/月
	 */
	...
	/**
	 * The column <code>dqv4.profile_skill.create_time</code>. 创建时间
	 */
	...
	/**
	 * The column <code>dqv4.profile_skill.update_time</code>. 更新时间
	 */
	...
	/**
	 * Create a <code>dqv4.profile_skill</code> table reference
	 */
	public ProfileSkill() {
	...
	/**
	 * Create an aliased <code>dqv4.profile_skill</code> table reference
	 */
	...
	private ProfileSkill(String alias, Table<ProfileSkillRecord> aliased, Field<?>[] parameters) {
		super(alias, Dqv4.DQV4, aliased, parameters, "Profile的技能");
	}
