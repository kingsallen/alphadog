...
public class HrFeedback extends TableImpl<HrFeedbackRecord> {
	...
	private static final long serialVersionUID = -199844127;

	/**
	 * The reference instance of <code>dqv4.hr_feedback</code>
	 */
	...
	/**
	 * The column <code>dqv4.hr_feedback.id</code>. ID
	 */
	...
	/**
	 * The column <code>dqv4.hr_feedback.hraccount_id</code>. hr_account.id 账号编号
	 */
	...
	/**
	 * The column <code>dqv4.hr_feedback.name</code>. 姓名
	 */
	...
	/**
	 * The column <code>dqv4.hr_feedback.email</code>. 邮箱
	 */
	...
	/**
	 * The column <code>dqv4.hr_feedback.images</code>. 反馈图片
	 */
	...
	/**
	 * The column <code>dqv4.hr_feedback.content</code>. 反馈内容
	 */
	...
	/**
	 * The column <code>dqv4.hr_feedback.create_time</code>.
	 */
	...
	/**
	 * The column <code>dqv4.hr_feedback.update_time</code>.
	 */
	...
	/**
	 * Create a <code>dqv4.hr_feedback</code> table reference
	 */
	public HrFeedback() {
	...
	/**
	 * Create an aliased <code>dqv4.hr_feedback</code> table reference
	 */
	...
	private HrFeedback(String alias, Table<HrFeedbackRecord> aliased, Field<?>[] parameters) {
		super(alias, Dqv4.DQV4, aliased, parameters, "HR反馈表");
	}
