...
public class ProfileReward extends TableImpl<ProfileRewardRecord> {
	...
	private static final long serialVersionUID = -296428271;

	/**
	 * The reference instance of <code>dqv4.profile_reward</code>
	 */
	...
	/**
	 * The column <code>dqv4.profile_reward.id</code>. 主key
	 */
	...
	/**
	 * The column <code>dqv4.profile_reward.profile_id</code>. profile.id
	 */
	...
	/**
	 * The column <code>dqv4.profile_reward.type</code>. 0：无法识别 1:竞赛 2:荣誉
	 */
	...
	/**
	 * The column <code>dqv4.profile_reward.reward_date</code>. 获取证书
	 */
	...
	/**
	 * The column <code>dqv4.profile_reward.name</code>. 获得奖励名称
	 */
	...
	/**
	 * The column <code>dqv4.profile_reward.description</code>. 描述
	 */
	...
	/**
	 * The column <code>dqv4.profile_reward.create_time</code>. 创建时间
	 */
	...
	/**
	 * The column <code>dqv4.profile_reward.update_time</code>. 更新时间
	 */
	...
	/**
	 * Create a <code>dqv4.profile_reward</code> table reference
	 */
	...
	/**
	 * Create an aliased <code>dqv4.profile_reward</code> table reference
	 */
	...
	private ProfileReward(String alias, Table<ProfileRewardRecord> aliased, Field<?>[] parameters) {
		super(alias, Dqv4.DQV4, aliased, parameters, "Profile的荣誉证书竞赛表");
	}
