...
public class HrWxHrChatListRecord extends UpdatableRecordImpl<HrWxHrChatListRecord> implements Record7<UInteger, Integer, Integer, Byte, Timestamp, Timestamp, Timestamp> {
	...
	private static final long serialVersionUID = 748274686;

	/**
	 * Setter for <code>dqv4.hr_wx_hr_chat_list.id</code>. ID
	 */
	...
	/**
	 * Getter for <code>dqv4.hr_wx_hr_chat_list.id</code>. ID
	 */
	...
	/**
	 * Setter for <code>dqv4.hr_wx_hr_chat_list.sysuser_id</code>. sysuser.id
	 */
	...
	/**
	 * Getter for <code>dqv4.hr_wx_hr_chat_list.sysuser_id</code>. sysuser.id
	 */
	...
	/**
	 * Setter for <code>dqv4.hr_wx_hr_chat_list.hraccount_id</code>. hr_account.id
	 */
	...
	/**
	 * Getter for <code>dqv4.hr_wx_hr_chat_list.hraccount_id</code>. hr_account.id
	 */
	...
	/**
	 * Setter for <code>dqv4.hr_wx_hr_chat_list.status</code>. 状态，0：有效，1：无效
	 */
	...
	/**
	 * Getter for <code>dqv4.hr_wx_hr_chat_list.status</code>. 状态，0：有效，1：无效
	 */
	...
	/**
	 * Setter for <code>dqv4.hr_wx_hr_chat_list.create_time</code>. 创建时间
	 */
	...
	/**
	 * Getter for <code>dqv4.hr_wx_hr_chat_list.create_time</code>. 创建时间
	 */
	...
	/**
	 * Setter for <code>dqv4.hr_wx_hr_chat_list.wx_chat_time</code>. sysuser最近一次聊天时间
	 */
	...
	/**
	 * Getter for <code>dqv4.hr_wx_hr_chat_list.wx_chat_time</code>. sysuser最近一次聊天时间
	 */
	...
	/**
	 * Setter for <code>dqv4.hr_wx_hr_chat_list.hr_chat_time</code>. HR最近一次聊天时间
	 */
	...
	/**
	 * Getter for <code>dqv4.hr_wx_hr_chat_list.hr_chat_time</code>. HR最近一次聊天时间
	 */
