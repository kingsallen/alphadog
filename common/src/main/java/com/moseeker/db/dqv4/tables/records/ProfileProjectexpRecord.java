...
public class ProfileProjectexpRecord extends UpdatableRecordImpl<ProfileProjectexpRecord> implements Record12<UInteger, UInteger, Date, Date, Byte, String, String, String, String, String, Timestamp, Timestamp> {
	...
	private static final long serialVersionUID = -298901537;

	/**
	 * Setter for <code>dqv4.profile_projectexp.id</code>. 主key
	 */
	...
	/**
	 * Getter for <code>dqv4.profile_projectexp.id</code>. 主key
	 */
	...
	/**
	 * Setter for <code>dqv4.profile_projectexp.profile_id</code>. profile.id
	 */
	...
	/**
	 * Getter for <code>dqv4.profile_projectexp.profile_id</code>. profile.id
	 */
	...
	/**
	 * Setter for <code>dqv4.profile_projectexp.start</code>. 起止时间-起 yyyy-mm-dd
	 */
	...
	/**
	 * Getter for <code>dqv4.profile_projectexp.start</code>. 起止时间-起 yyyy-mm-dd
	 */
	...
	/**
	 * Setter for <code>dqv4.profile_projectexp.end</code>. 起止时间-止 yyyy-mm-dd
	 */
	...
	/**
	 * Getter for <code>dqv4.profile_projectexp.end</code>. 起止时间-止 yyyy-mm-dd
	 */
	public Date getEnd() {
	...
	/**
	 * Setter for <code>dqv4.profile_projectexp.end_until_now</code>. 是否至今 0：否 1：是
	 */
	...
	/**
	 * Getter for <code>dqv4.profile_projectexp.end_until_now</code>. 是否至今 0：否 1：是
	 */
	...
	/**
	 * Setter for <code>dqv4.profile_projectexp.company</code>. 公司名称
	 */
	...
	/**
	 * Getter for <code>dqv4.profile_projectexp.company</code>. 公司名称
	 */
	...
	/**
	 * Setter for <code>dqv4.profile_projectexp.name</code>. 项目名称
	 */
	...
	/**
	 * Getter for <code>dqv4.profile_projectexp.name</code>. 项目名称
	 */
	...
	/**
	 * Setter for <code>dqv4.profile_projectexp.role</code>. 项目角色
	 */
	...
	/**
	 * Getter for <code>dqv4.profile_projectexp.role</code>. 项目角色
	 */
	...
	/**
	 * Setter for <code>dqv4.profile_projectexp.work_desc</code>. 工作描述
	 */
	...
	/**
	 * Getter for <code>dqv4.profile_projectexp.work_desc</code>. 工作描述
	 */
	...
	/**
	 * Setter for <code>dqv4.profile_projectexp.project_desc</code>. 项目描述
	 */
	...
	/**
	 * Getter for <code>dqv4.profile_projectexp.project_desc</code>. 项目描述
	 */
	...
	/**
	 * Setter for <code>dqv4.profile_projectexp.create_time</code>. 创建时间
	 */
	...
	/**
	 * Getter for <code>dqv4.profile_projectexp.create_time</code>. 创建时间
	 */
	...
	/**
	 * Setter for <code>dqv4.profile_projectexp.update_time</code>. 更新时间
	 */
	...
	/**
	 * Getter for <code>dqv4.profile_projectexp.update_time</code>. 更新时间
	 */
