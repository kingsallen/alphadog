...
public class UserWxViewer extends TableImpl<UserWxViewerRecord> {
	...
	private static final long serialVersionUID = -842336003;

	/**
	 * The reference instance of <code>dqv4.user_wx_viewer</code>
	 */
	...
	/**
	 * The column <code>dqv4.user_wx_viewer.id</code>. 主key
	 */
	...
	/**
	 * The column <code>dqv4.user_wx_viewer.sysuser_id</code>.
	 */
	...
	/**
	 * The column <code>dqv4.user_wx_viewer.idcode</code>.
	 */
	...
	/**
	 * The column <code>dqv4.user_wx_viewer.client_type</code>.
	 */
	...
	/**
	 * Create a <code>dqv4.user_wx_viewer</code> table reference
	 */
	public UserWxViewer() {
	...
	/**
	 * Create an aliased <code>dqv4.user_wx_viewer</code> table reference
	 */
	...
	private UserWxViewer(String alias, Table<UserWxViewerRecord> aliased, Field<?>[] parameters) {
		super(alias, Dqv4.DQV4, aliased, parameters, "用户浏览者记录");
	}
