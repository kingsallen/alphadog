...
public class HrWxWechatNoticeSyncStatus extends TableImpl<HrWxWechatNoticeSyncStatusRecord> {
	...
	private static final long serialVersionUID = 1391412661;

	/**
	 * The reference instance of <code>dqv4.hr_wx_wechat_notice_sync_status</code>
	 */
	...
	/**
	 * The column <code>dqv4.hr_wx_wechat_notice_sync_status.id</code>. 主key
	 */
	...
	/**
	 * The column <code>dqv4.hr_wx_wechat_notice_sync_status.wechat_id</code>. 所属公众号
	 */
	...
	/**
	 * The column <code>dqv4.hr_wx_wechat_notice_sync_status.status</code>. 同步状态 0:成功, 1:行业修改失败, 2:模板数量超出上限, 3:接口调用失败
	 */
	...
	/**
	 * The column <code>dqv4.hr_wx_wechat_notice_sync_status.count</code>. 同步状态提示应该删除信息的数量
	 */
	...
	/**
	 * The column <code>dqv4.hr_wx_wechat_notice_sync_status.update_time</code>.
	 */
	...
	/**
	 * Create a <code>dqv4.hr_wx_wechat_notice_sync_status</code> table reference
	 */
	...
	/**
	 * Create an aliased <code>dqv4.hr_wx_wechat_notice_sync_status</code> table reference
	 */
	...
	private HrWxWechatNoticeSyncStatus(String alias, Table<HrWxWechatNoticeSyncStatusRecord> aliased, Field<?>[] parameters) {
		super(alias, Dqv4.DQV4, aliased, parameters, "微信消息通知同步状态");
	}
