...
public class HrWxTemplateMessage extends TableImpl<HrWxTemplateMessageRecord> {
	...
	private static final long serialVersionUID = 1677989648;

	/**
	 * The reference instance of <code>dqv4.hr_wx_template_message</code>
	 */
	...
	/**
	 * The column <code>dqv4.hr_wx_template_message.id</code>. 主key
	 */
	...
	/**
	 * The column <code>dqv4.hr_wx_template_message.sys_template_id</code>. 模板ID
	 */
	...
	/**
	 * The column <code>dqv4.hr_wx_template_message.wx_template_id</code>. 微信模板ID
	 */
	...
	/**
	 * The column <code>dqv4.hr_wx_template_message.display</code>. 是否显示
	 */
	...
	/**
	 * The column <code>dqv4.hr_wx_template_message.priority</code>. 排序
	 */
	...
	/**
	 * The column <code>dqv4.hr_wx_template_message.wechat_id</code>. 所属公众号
	 */
	...
	/**
	 * The column <code>dqv4.hr_wx_template_message.disable</code>. 是否可用
	 */
	...
	/**
	 * The column <code>dqv4.hr_wx_template_message.url</code>. 跳转URL
	 */
	...
	/**
	 * The column <code>dqv4.hr_wx_template_message.topcolor</code>. 消息头部颜色
	 */
	...
	/**
	 * The column <code>dqv4.hr_wx_template_message.first</code>. 问候语
	 */
	...
	/**
	 * The column <code>dqv4.hr_wx_template_message.remark</code>. 结束语
	 */
	...
	/**
	 * Create a <code>dqv4.hr_wx_template_message</code> table reference
	 */
	...
	/**
	 * Create an aliased <code>dqv4.hr_wx_template_message</code> table reference
	 */
	...
	private HrWxTemplateMessage(String alias, Table<HrWxTemplateMessageRecord> aliased, Field<?>[] parameters) {
		super(alias, Dqv4.DQV4, aliased, parameters, "微信模板消息");
	}
