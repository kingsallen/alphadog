...
@Repository
public class ThirdpartyVeryeastPositionDao extends AbstractThirdPartyPositionDao<ThirdpartyVeryEastPositionDO, ThirdpartyVeryeastPositionRecord>{
    ...
    public List<TwoParam<HrThirdPartyPositionDO, ThirdpartyVeryEastPositionDO>> getDatas(List<HrThirdPartyPositionDO> list) {
        ...
        Query query = new Query.QueryBuilder().where(new Condition(ThirdpartyVeryeastPosition.THIRDPARTY_VERYEAST_POSITION.PID.getName(), ids, ValueOp.IN)).buildQuery();
