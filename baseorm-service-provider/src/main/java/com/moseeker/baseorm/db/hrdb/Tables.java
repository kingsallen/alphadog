...
public class Tables {
     ...
     * 人工智能系统配置表
     */
    public static final HrAiConf HR_AI_CONF = HrAiConf.HR_AI_CONF;
     ...
     * 自定义简历模板导出字段表
     */
    public static final HrAppExportFields HR_APP_EXPORT_FIELDS = HrAppExportFields.HR_APP_EXPORT_FIELDS;
     ...
     * 邮件额度每天使用日志
     */
    public static final HrCompanyCs HR_COMPANY_CS = HrCompanyCs.HR_COMPANY_CS;

    /**
     * 企业邮件总量信息表
     */
    public static final HrCompanyEmailInfo HR_COMPANY_EMAIL_INFO = HrCompanyEmailInfo.HR_COMPANY_EMAIL_INFO;

    /**
     * 公司福利特色
     */
    public static final HrCompanyFeature HR_COMPANY_FEATURE = HrCompanyFeature.HR_COMPANY_FEATURE;
     ...
     */
    public static final HrGroupCompany HR_GROUP_COMPANY = HrGroupCompany.HR_GROUP_COMPANY;

    /**
     * The table <code>hrdb.hr_group_company_rel</code>.
     */
    public static final HrGroupCompanyRel HR_GROUP_COMPANY_REL = HrGroupCompanyRel.HR_GROUP_COMPANY_REL;
     ...
     * nps打分推荐表
     */
    public static final HrNps HR_NPS = HrNps.HR_NPS;

    /**
     * hr推荐同行表
     */
    public static final HrNpsRecommend HR_NPS_RECOMMEND = HrNpsRecommend.HR_NPS_RECOMMEND;
