...
public class HistoryCampaignPersonaRecomRecord extends UpdatableRecordImpl<HistoryCampaignPersonaRecomRecord> implements Record9<Integer, Integer, Integer, Integer, Timestamp, Timestamp, Byte, Timestamp, Byte> {
    ...
    private static final long serialVersionUID = 1483708524;
     ...
     */
    @Override
    public HistoryCampaignPersonaRecomRecord value9(Byte value) {
        setType(value);
        return this;
    }
     ...
     */
    @Override
    public HistoryCampaignPersonaRecomRecord values(Integer value1, Integer value2, Integer value3, Integer value4, Timestamp value5, Timestamp value6, Byte value7, Timestamp value8, Byte value9) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public HistoryCampaignPersonaRecomRecord(Integer id, Integer userId, Integer companyId, Integer positionId, Timestamp createTime, Timestamp sendTime, Byte isSend, Timestamp updateTime, Byte type) {
        super(HistoryCampaignPersonaRecom.HISTORY_CAMPAIGN_PERSONA_RECOM);
