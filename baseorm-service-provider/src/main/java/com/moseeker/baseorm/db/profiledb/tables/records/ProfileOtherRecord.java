...
public class ProfileOtherRecord extends UpdatableRecordImpl<ProfileOtherRecord> implements Record4<UInteger, String, Timestamp, Timestamp> {
	...
	private static final long serialVersionUID = -93534244;
	 ...
	 */
	@Override
	public ProfileOtherRecord value1(UInteger value) {
		setProfileId(value);
		return this;
	}
	 ...
	 */
	@Override
	public ProfileOtherRecord values(UInteger value1, String value2, Timestamp value3, Timestamp value4) {
		value1(value1);
		value2(value2);
		value3(value3);
		value4(value4);
	 ...
	 */
	public ProfileOtherRecord(UInteger profileId, String other, Timestamp createTime, Timestamp updateTime) {
		super(ProfileOther.PROFILE_OTHER);
