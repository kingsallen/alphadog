...
public class HrHbItemsBackup implements Serializable {

    private static final long serialVersionUID = -2139266222;
    ...
    public HrHbItemsBackup(HrHbItemsBackup value) {
        this.id = value.id;
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("HrHbItemsBackup (");
