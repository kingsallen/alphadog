...
public class HrHtml5UniqueStatistics extends TableImpl<HrHtml5UniqueStatisticsRecord> {
    ...
    private static final long serialVersionUID = 2008928229;
     ...
     */
    public final TableField<HrHtml5UniqueStatisticsRecord, Integer> TOPIC_ID = createField("topic_id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "wx_topic.id");
     ...
     */
    public final TableField<HrHtml5UniqueStatisticsRecord, Integer> VIEW_NUM_UV = createField("view_num_uv", org.jooq.impl.SQLDataType.INTEGER.defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "浏览人数");

    /**
     * The column <code>hrdb.hr_html5_unique_statistics.recom_view_num_uv</code>. 推荐浏览人数
     */
    public final TableField<HrHtml5UniqueStatisticsRecord, Integer> RECOM_VIEW_NUM_UV = createField("recom_view_num_uv", org.jooq.impl.SQLDataType.INTEGER.defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "推荐浏览人数");
     ...
     */
    public final TableField<HrHtml5UniqueStatisticsRecord, Integer> INFO_TYPE = createField("info_type", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "0: 日数据，1：周数据，2：月数据");
