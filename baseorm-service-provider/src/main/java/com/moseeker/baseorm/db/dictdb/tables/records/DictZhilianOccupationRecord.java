...
public class DictZhilianOccupationRecord extends UpdatableRecordImpl<DictZhilianOccupationRecord> implements Record7<Integer, Integer, String, String, Short, Short, Timestamp> {
    ...
    private static final long serialVersionUID = 784782624;
     ...
     */
    @Override
    public DictZhilianOccupationRecord value4(String value) {
        setCodeOther(value);
        return this;
    }
     ...
     */
    @Override
    public DictZhilianOccupationRecord values(Integer value1, Integer value2, String value3, String value4, Short value5, Short value6, Timestamp value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public DictZhilianOccupationRecord(Integer code, Integer parentId, String name, String codeOther, Short level, Short status, Timestamp createtime) {
        super(DictZhilianOccupation.DICT_ZHILIAN_OCCUPATION);
