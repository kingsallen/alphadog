...
public class ProfileIntention implements Serializable {

    private static final long serialVersionUID = 24149660;
    ...
    public ProfileIntention(ProfileIntention value) {
        this.id = value.id;
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("ProfileIntention (");
