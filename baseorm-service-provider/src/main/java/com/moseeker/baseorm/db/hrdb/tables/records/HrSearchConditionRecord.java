...
public class HrSearchConditionRecord extends UpdatableRecordImpl<HrSearchConditionRecord> implements Record22<Integer, String, Integer, Integer, String, String, String, String, String, String, Integer, Integer, Integer, Integer, Integer, String, String, Integer, Integer, Timestamp, Integer, Integer> {
     ...
     */
    @Override
    public Row22<Integer, String, Integer, Integer, String, String, String, String, String, String, Integer, Integer, Integer, Integer, Integer, String, String, Integer, Integer, Timestamp, Integer, Integer> fieldsRow() {
     ...
     */
    @Override
    public Row22<Integer, String, Integer, Integer, String, String, String, String, String, String, Integer, Integer, Integer, Integer, Integer, String, String, Integer, Integer, Timestamp, Integer, Integer> valuesRow() {
