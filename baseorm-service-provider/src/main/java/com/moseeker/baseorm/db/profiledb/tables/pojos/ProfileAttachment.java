...
public class ProfileAttachment implements Serializable {
    ...
    private static final long serialVersionUID = 2060566682;
    ...
    public ProfileAttachment(ProfileAttachment value) {
        this.id = value.id;
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("ProfileAttachment (");
