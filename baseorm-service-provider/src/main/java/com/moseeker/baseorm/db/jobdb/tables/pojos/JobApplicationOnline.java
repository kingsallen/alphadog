...
public class JobApplicationOnline implements Serializable {

    private static final long serialVersionUID = 2073994562;
    ...
    public JobApplicationOnline(JobApplicationOnline value) {
        this.id = value.id;
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("JobApplicationOnline (");
