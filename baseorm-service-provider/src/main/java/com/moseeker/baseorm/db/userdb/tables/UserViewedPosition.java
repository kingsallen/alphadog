...
public class UserViewedPosition extends TableImpl<UserViewedPositionRecord> {
	...
	private static final long serialVersionUID = 1311335810;
	 ...
	 */
	public final TableField<UserViewedPositionRecord, Timestamp> CREATE_TIME = createField("create_time", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaulted(true), this, "创建时间");
	...
	private UserViewedPosition(String alias, Table<UserViewedPositionRecord> aliased, Field<?>[] parameters) {
		super(alias, Userdb.USERDB, aliased, parameters, "用户查看过的职位");
	}
