...
public class ProfileIntentionRecord extends UpdatableRecordImpl<ProfileIntentionRecord> implements Record9<UInteger, UInteger, UByte, UByte, UByte, String, Byte, Timestamp, Timestamp> {
	...
	private static final long serialVersionUID = -361062952;
	 ...
	 */
	public ProfileIntentionRecord(UInteger id, UInteger profileId, UByte worktype, UByte workstate, UByte salaryCode, String tag, Byte considerVentureCompanyOpportunities, Timestamp createTime, Timestamp updateTime) {
		super(ProfileIntention.PROFILE_INTENTION);
