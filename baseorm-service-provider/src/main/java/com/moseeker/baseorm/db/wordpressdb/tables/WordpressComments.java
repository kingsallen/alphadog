...
public class WordpressComments extends TableImpl<WordpressCommentsRecord> {
    ...
    private static final long serialVersionUID = -2036295952;
     ...
     */
    public final TableField<WordpressCommentsRecord, Long> COMMENT_POST_ID = createField("comment_post_ID", org.jooq.impl.SQLDataType.BIGINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.BIGINT)), this, "");
     ...
     */
    public final TableField<WordpressCommentsRecord, String> COMMENT_AUTHOR_EMAIL = createField("comment_author_email", org.jooq.impl.SQLDataType.VARCHAR.length(100).nullable(false).defaultValue(org.jooq.impl.DSL.field("", org.jooq.impl.SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>wordpressdb.wordpress_comments.comment_author_url</code>.
     */
    public final TableField<WordpressCommentsRecord, String> COMMENT_AUTHOR_URL = createField("comment_author_url", org.jooq.impl.SQLDataType.VARCHAR.length(200).nullable(false).defaultValue(org.jooq.impl.DSL.field("", org.jooq.impl.SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>wordpressdb.wordpress_comments.comment_author_IP</code>.
     */
    public final TableField<WordpressCommentsRecord, String> COMMENT_AUTHOR_IP = createField("comment_author_IP", org.jooq.impl.SQLDataType.VARCHAR.length(100).nullable(false).defaultValue(org.jooq.impl.DSL.field("", org.jooq.impl.SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>wordpressdb.wordpress_comments.comment_date</code>.
     */
    public final TableField<WordpressCommentsRecord, Timestamp> COMMENT_DATE = createField("comment_date", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.field("0000-00-00 00:00:00", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "");

    /**
     * The column <code>wordpressdb.wordpress_comments.comment_date_gmt</code>.
     */
    public final TableField<WordpressCommentsRecord, Timestamp> COMMENT_DATE_GMT = createField("comment_date_gmt", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.field("0000-00-00 00:00:00", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "");
     ...
     */
    public final TableField<WordpressCommentsRecord, Integer> COMMENT_KARMA = createField("comment_karma", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "");

    /**
     * The column <code>wordpressdb.wordpress_comments.comment_approved</code>.
     */
    public final TableField<WordpressCommentsRecord, String> COMMENT_APPROVED = createField("comment_approved", org.jooq.impl.SQLDataType.VARCHAR.length(20).nullable(false).defaultValue(org.jooq.impl.DSL.field("1", org.jooq.impl.SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>wordpressdb.wordpress_comments.comment_agent</code>.
     */
    public final TableField<WordpressCommentsRecord, String> COMMENT_AGENT = createField("comment_agent", org.jooq.impl.SQLDataType.VARCHAR.length(255).nullable(false).defaultValue(org.jooq.impl.DSL.field("", org.jooq.impl.SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>wordpressdb.wordpress_comments.comment_type</code>.
     */
    public final TableField<WordpressCommentsRecord, String> COMMENT_TYPE = createField("comment_type", org.jooq.impl.SQLDataType.VARCHAR.length(20).nullable(false).defaultValue(org.jooq.impl.DSL.field("", org.jooq.impl.SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>wordpressdb.wordpress_comments.comment_parent</code>.
     */
    public final TableField<WordpressCommentsRecord, Long> COMMENT_PARENT = createField("comment_parent", org.jooq.impl.SQLDataType.BIGINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.BIGINT)), this, "");

    /**
     * The column <code>wordpressdb.wordpress_comments.user_id</code>.
     */
    public final TableField<WordpressCommentsRecord, Long> USER_ID = createField("user_id", org.jooq.impl.SQLDataType.BIGINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.BIGINT)), this, "");
