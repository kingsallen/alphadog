...
public class WordpressComments extends TableImpl<WordpressCommentsRecord> {
	...
	private static final long serialVersionUID = -572070964;
	 ...
	 */
	public final TableField<WordpressCommentsRecord, ULong> COMMENT_ID = createField("comment_ID", org.jooq.impl.SQLDataType.BIGINTUNSIGNED.nullable(false), this, "");

	/**
	 * The column <code>wordpressdb.wordpress_comments.comment_post_ID</code>.
	 */
	public final TableField<WordpressCommentsRecord, ULong> COMMENT_POST_ID = createField("comment_post_ID", org.jooq.impl.SQLDataType.BIGINTUNSIGNED.nullable(false).defaulted(true), this, "");
	 ...
	 */
	public final TableField<WordpressCommentsRecord, String> COMMENT_AUTHOR_EMAIL = createField("comment_author_email", org.jooq.impl.SQLDataType.VARCHAR.length(100).nullable(false).defaulted(true), this, "");

	/**
	 * The column <code>wordpressdb.wordpress_comments.comment_author_url</code>.
	 */
	public final TableField<WordpressCommentsRecord, String> COMMENT_AUTHOR_URL = createField("comment_author_url", org.jooq.impl.SQLDataType.VARCHAR.length(200).nullable(false).defaulted(true), this, "");

	/**
	 * The column <code>wordpressdb.wordpress_comments.comment_author_IP</code>.
	 */
	public final TableField<WordpressCommentsRecord, String> COMMENT_AUTHOR_IP = createField("comment_author_IP", org.jooq.impl.SQLDataType.VARCHAR.length(100).nullable(false).defaulted(true), this, "");

	/**
	 * The column <code>wordpressdb.wordpress_comments.comment_date</code>.
	 */
	public final TableField<WordpressCommentsRecord, Timestamp> COMMENT_DATE = createField("comment_date", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaulted(true), this, "");

	/**
	 * The column <code>wordpressdb.wordpress_comments.comment_date_gmt</code>.
	 */
	public final TableField<WordpressCommentsRecord, Timestamp> COMMENT_DATE_GMT = createField("comment_date_gmt", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaulted(true), this, "");
	 ...
	 */
	public final TableField<WordpressCommentsRecord, Integer> COMMENT_KARMA = createField("comment_karma", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaulted(true), this, "");

	/**
	 * The column <code>wordpressdb.wordpress_comments.comment_approved</code>.
	 */
	public final TableField<WordpressCommentsRecord, String> COMMENT_APPROVED = createField("comment_approved", org.jooq.impl.SQLDataType.VARCHAR.length(20).nullable(false).defaulted(true), this, "");

	/**
	 * The column <code>wordpressdb.wordpress_comments.comment_agent</code>.
	 */
	public final TableField<WordpressCommentsRecord, String> COMMENT_AGENT = createField("comment_agent", org.jooq.impl.SQLDataType.VARCHAR.length(255).nullable(false).defaulted(true), this, "");

	/**
	 * The column <code>wordpressdb.wordpress_comments.comment_type</code>.
	 */
	public final TableField<WordpressCommentsRecord, String> COMMENT_TYPE = createField("comment_type", org.jooq.impl.SQLDataType.VARCHAR.length(20).nullable(false).defaulted(true), this, "");

	/**
	 * The column <code>wordpressdb.wordpress_comments.comment_parent</code>.
	 */
	public final TableField<WordpressCommentsRecord, ULong> COMMENT_PARENT = createField("comment_parent", org.jooq.impl.SQLDataType.BIGINTUNSIGNED.nullable(false).defaulted(true), this, "");

	/**
	 * The column <code>wordpressdb.wordpress_comments.user_id</code>.
	 */
	public final TableField<WordpressCommentsRecord, ULong> USER_ID = createField("user_id", org.jooq.impl.SQLDataType.BIGINTUNSIGNED.nullable(false).defaulted(true), this, "");
	 ...
	 */
	@Override
	public Identity<WordpressCommentsRecord, ULong> getIdentity() {
