...
public class ProfileIntentionPosition extends TableImpl<ProfileIntentionPositionRecord> {
    ...
    private static final long serialVersionUID = -2142264768;
     ...
     */
    public final TableField<ProfileIntentionPositionRecord, Integer> POSITION_CODE = createField("position_code", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "职能字典编码");

    /**
     * The column <code>profiledb.profile_intention_position.position_name</code>. 职能名称
     */
    public final TableField<ProfileIntentionPositionRecord, String> POSITION_NAME = createField("position_name", org.jooq.impl.SQLDataType.VARCHAR.length(100).nullable(false).defaultValue(org.jooq.impl.DSL.field("", org.jooq.impl.SQLDataType.VARCHAR)), this, "职能名称");
