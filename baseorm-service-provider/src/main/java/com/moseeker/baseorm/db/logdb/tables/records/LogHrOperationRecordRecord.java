...
public class LogHrOperationRecordRecord extends UpdatableRecordImpl<LogHrOperationRecordRecord> implements Record5<UInteger, Integer, Integer, String, Timestamp> {

    private static final long serialVersionUID = -551033514;
     ...
     */
    @Override
    public LogHrOperationRecordRecord value1(UInteger value) {
        setId(value);
        return this;
    }
     ...
     */
    @Override
    public LogHrOperationRecordRecord values(UInteger value1, Integer value2, Integer value3, String value4, Timestamp value5) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public LogHrOperationRecordRecord(UInteger id, Integer type, Integer hraccountId, String description, Timestamp createTime) {
        super(LogHrOperationRecord.LOG_HR_OPERATION_RECORD);
