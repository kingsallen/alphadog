...
public class TalentpoolHrTalent extends TableImpl<TalentpoolHrTalentRecord> {
    ...
    private static final long serialVersionUID = -709746800;
    ...
    /**
     * The column <code>talentpooldb.talentpool_hr_talent.talent_id</code>. 人才编号.id,简历
     */
    public final TableField<TalentpoolHrTalentRecord, Integer> TALENT_ID = createField("talent_id", org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "人才编号.id,简历");
