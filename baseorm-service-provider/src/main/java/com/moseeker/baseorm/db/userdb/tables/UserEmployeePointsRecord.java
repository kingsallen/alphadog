...
public class UserEmployeePointsRecord extends TableImpl<UserEmployeePointsRecordRecord> {
    ...
    private static final long serialVersionUID = 1111138598;
     ...
     */
    public final TableField<UserEmployeePointsRecordRecord, Integer> RECOM_USER_ID = createField("recom_user_id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "userdb.user_user.id 推荐者的C端账号");

    /**
     * The column <code>userdb.user_employee_points_record.berecom_user_id</code>. userdb.user_user.id 被推荐者的C端账号
     */
    public final TableField<UserEmployeePointsRecordRecord, Integer> BERECOM_USER_ID = createField("berecom_user_id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "userdb.user_user.id 被推荐者的C端账号");
