...
public class HistoryHrMedia extends TableImpl<HistoryHrMediaRecord> {
    ...
    private static final long serialVersionUID = 857184529;
     ...
     */
    public final TableField<HistoryHrMediaRecord, String> LONGTEXT = createField("longtext", org.jooq.impl.SQLDataType.VARCHAR.length(2048).nullable(false).defaultValue(org.jooq.impl.DSL.field("", org.jooq.impl.SQLDataType.VARCHAR)), this, "描述");

    /**
     * The column <code>historydb.history_hr_media.attrs</code>. 客户属性，可选 字段
     */
    public final TableField<HistoryHrMediaRecord, String> ATTRS = createField("attrs", org.jooq.impl.SQLDataType.VARCHAR.length(1024).nullable(false).defaultValue(org.jooq.impl.DSL.field("", org.jooq.impl.SQLDataType.VARCHAR)), this, "客户属性，可选 字段");

    /**
     * The column <code>historydb.history_hr_media.title</code>. 模板名称
     */
    public final TableField<HistoryHrMediaRecord, String> TITLE = createField("title", org.jooq.impl.SQLDataType.VARCHAR.length(128).nullable(false).defaultValue(org.jooq.impl.DSL.field("", org.jooq.impl.SQLDataType.VARCHAR)), this, "模板名称");

    /**
     * The column <code>historydb.history_hr_media.sub_title</code>. 模板子名称
     */
    public final TableField<HistoryHrMediaRecord, String> SUB_TITLE = createField("sub_title", org.jooq.impl.SQLDataType.VARCHAR.length(128).nullable(false).defaultValue(org.jooq.impl.DSL.field("", org.jooq.impl.SQLDataType.VARCHAR)), this, "模板子名称");

    /**
     * The column <code>historydb.history_hr_media.link</code>. 模板链接
     */
    public final TableField<HistoryHrMediaRecord, String> LINK = createField("link", org.jooq.impl.SQLDataType.VARCHAR.length(512).nullable(false).defaultValue(org.jooq.impl.DSL.field("", org.jooq.impl.SQLDataType.VARCHAR)), this, "模板链接");

    /**
     * The column <code>historydb.history_hr_media.res_id</code>. 资源hr_resource.id
     */
    public final TableField<HistoryHrMediaRecord, Integer> RES_ID = createField("res_id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "资源hr_resource.id");
