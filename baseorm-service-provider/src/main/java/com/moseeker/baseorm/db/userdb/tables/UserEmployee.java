...
public class UserEmployee extends TableImpl<UserEmployeeRecord> {
	...
	private static final long serialVersionUID = -1576521409;
	 ...
	 */
	public final TableField<UserEmployeeRecord, Integer> WXUSER_ID = createField("wxuser_id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaulted(true), this, "userdb.user_wx_user.id 微信账号编号。现在已经废弃。关于员工绑定的C端账号，请参考user_id");
	 ...
	 */
	public final TableField<UserEmployeeRecord, Integer> HR_WXUSER_ID = createField("hr_wxuser_id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaulted(true), this, "hr招聘助手的微信ID，wx_group_user.id");
	 ...
	 */
	public final TableField<UserEmployeeRecord, String> CUSTOM_FIELD_VALUES = createField("custom_field_values", org.jooq.impl.SQLDataType.VARCHAR.length(4096).nullable(false).defaulted(true), this, "自定 义字段");
