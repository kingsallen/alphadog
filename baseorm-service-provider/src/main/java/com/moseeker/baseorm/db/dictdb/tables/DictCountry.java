...
public class DictCountry extends TableImpl<DictCountryRecord> {
     ...
     */
    public final TableField<DictCountryRecord, Byte> HOT_COUNTRY = createField("hot_country", org.jooq.impl.SQLDataType.TINYINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.TINYINT)), this, "热门国家 0=否 1=是");

    /**
     * The column <code>dictdb.dict_country.continent_code</code>. 7大洲code, dict_constant.parent_code: 9103
     */
    public final TableField<DictCountryRecord, Integer> CONTINENT_CODE = createField("continent_code", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "7大洲code, dict_constant.parent_code: 9103");

    /**
     * The column <code>dictdb.dict_country.priority</code>. 优先级
     */
    public final TableField<DictCountryRecord, Short> PRIORITY = createField("priority", org.jooq.impl.SQLDataType.SMALLINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.SMALLINT)), this, "优先级");
