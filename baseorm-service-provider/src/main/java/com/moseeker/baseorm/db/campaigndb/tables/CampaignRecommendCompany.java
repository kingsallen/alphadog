...
public class CampaignRecommendCompany extends TableImpl<CampaignRecommendCompanyRecord> {
    ...
    private static final long serialVersionUID = -147496560;
     ...
     */
    public final TableField<CampaignRecommendCompanyRecord, Integer> WEIGHT = createField("weight", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "权重值");

    /**
     * The column <code>campaigndb.campaign_recommend_company.disable</code>. 是否禁用(0: 启用，1: 禁用)
     */
    public final TableField<CampaignRecommendCompanyRecord, Byte> DISABLE = createField("disable", org.jooq.impl.SQLDataType.TINYINT.defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.TINYINT)), this, "是否禁用(0: 启用，1: 禁用)");

    /**
     * The column <code>campaigndb.campaign_recommend_company.create_time</code>. 创建时间
     */
    public final TableField<CampaignRecommendCompanyRecord, Timestamp> CREATE_TIME = createField("create_time", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "创建时间");

    /**
     * The column <code>campaigndb.campaign_recommend_company.update_time</code>. 修改时间
     */
    public final TableField<CampaignRecommendCompanyRecord, Timestamp> UPDATE_TIME = createField("update_time", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "修改时间");
