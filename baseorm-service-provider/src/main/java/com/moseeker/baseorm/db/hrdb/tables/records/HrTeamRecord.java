...
public class HrTeamRecord extends UpdatableRecordImpl<HrTeamRecord> implements Record16<Integer, String, String, String, Integer, String, Integer, Timestamp, Timestamp, Integer, String, Integer, String, Integer, String, String> {

    private static final long serialVersionUID = -600094284;
     ...
     */
    @Override
    public HrTeamRecord values(Integer value1, String value2, String value3, String value4, Integer value5, String value6, Integer value7, Timestamp value8, Timestamp value9, Integer value10, String value11, Integer value12, String value13, Integer value14, String value15, String value16) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public HrTeamRecord(Integer id, String name, String summary, String description, Integer showOrder, String jdMedia, Integer companyId, Timestamp createTime, Timestamp updateTime, Integer isShow, String slogan, Integer resId, String teamDetail, Integer disable, String subTitle, String resAttrs) {
        super(HrTeam.HR_TEAM);
