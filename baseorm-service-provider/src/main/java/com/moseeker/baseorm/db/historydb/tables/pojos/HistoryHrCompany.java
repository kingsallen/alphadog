...
public class HistoryHrCompany implements Serializable {

    private static final long serialVersionUID = 247158834;
    ...
    public HistoryHrCompany(HistoryHrCompany value) {
        this.id = value.id;
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("HistoryHrCompany (");
