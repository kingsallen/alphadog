...
public class ConfigAdminnotificationGroupmembers extends TableImpl<ConfigAdminnotificationGroupmembersRecord> {
    ...
    private static final long serialVersionUID = 1026545280;
     ...
     */
    public final TableField<ConfigAdminnotificationGroupmembersRecord, Timestamp> CREATE_TIME = createField("create_time", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "");
