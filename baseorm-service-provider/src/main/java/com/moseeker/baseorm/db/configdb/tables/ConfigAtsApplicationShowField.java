...
public class ConfigAtsApplicationShowField extends TableImpl<ConfigAtsApplicationShowFieldRecord> {
    ...
    private static final long serialVersionUID = 995729170;
    ...
    /**
     * The column <code>configdb.config_ats_application_show_field.disable</code>. 状态：0 有效  1 无效 2 逻辑删除
     */
    public final TableField<ConfigAtsApplicationShowFieldRecord, Integer> DISABLE = createField("disable", org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "状态：0 有效  1 无效 2 逻辑删除");
