...
public class HrHbSendRecord extends TableImpl<HrHbSendRecordRecord> {
	...
	private static final long serialVersionUID = -1174510769;
	 ...
	 */
	public final TableField<HrHbSendRecordRecord, Integer> HB_ITEM_ID = createField("hb_item_id", org.jooq.impl.SQLDataType.INTEGER.defaulted(true), this, "hr_hb_items.id 该红包 api 调用所对应的红包记录");
	...
	private HrHbSendRecord(String alias, Table<HrHbSendRecordRecord> aliased, Field<?>[] parameters) {
		super(alias, Hrdb.HRDB, aliased, parameters, "红包发送记录");
	}
