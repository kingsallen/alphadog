...
public class TalentpoolProfileMoveDetailRecord extends UpdatableRecordImpl<TalentpoolProfileMoveDetailRecord> implements Record7<Integer, Long, Integer, Byte, Timestamp, Timestamp, Integer> {

    private static final long serialVersionUID = 1261777246;
    ...
    /**
     * Setter for <code>talentpooldb.talentpool_profile_move_detail.hr_id</code>. hraccount.id
     */
    ...
    /**
     * Getter for <code>talentpooldb.talentpool_profile_move_detail.hr_id</code>. hraccount.id
     */
     ...
     */
    @Override
    public Row7<Integer, Long, Integer, Byte, Timestamp, Timestamp, Integer> fieldsRow() {
     ...
     */
    @Override
    public Row7<Integer, Long, Integer, Byte, Timestamp, Timestamp, Integer> valuesRow() {
     ...
     */
    @Override
    public TalentpoolProfileMoveDetailRecord value7(Integer value) {
        setHrId(value);
        return this;
    }
     ...
     */
    @Override
    public TalentpoolProfileMoveDetailRecord values(Integer value1, Long value2, Integer value3, Byte value4, Timestamp value5, Timestamp value6, Integer value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public TalentpoolProfileMoveDetailRecord(Integer id, Long mobile, Integer profileMoveRecordId, Byte profileMoveStatus, Timestamp createTime, Timestamp updateTime, Integer hrId) {
        super(TalentpoolProfileMoveDetail.TALENTPOOL_PROFILE_MOVE_DETAIL);
