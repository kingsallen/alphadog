...
public class HrWxHrChatListBakBak extends TableImpl<HrWxHrChatListBakBakRecord> {
    ...
    private static final long serialVersionUID = 1784542035;
     ...
     */
    public final TableField<HrWxHrChatListBakBakRecord, Integer> SYSUSER_ID = createField("sysuser_id", org.jooq.impl.SQLDataType.INTEGER.defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "sysuser.id");

    /**
     * The column <code>historydb.hr_wx_hr_chat_list_bak_bak.hraccount_id</code>. hr_account.id
     */
    public final TableField<HrWxHrChatListBakBakRecord, Integer> HRACCOUNT_ID = createField("hraccount_id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "hr_account.id");

    /**
     * The column <code>historydb.hr_wx_hr_chat_list_bak_bak.status</code>. 状态，0：有效，1：无效
     */
    public final TableField<HrWxHrChatListBakBakRecord, Byte> STATUS = createField("status", org.jooq.impl.SQLDataType.TINYINT.defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.TINYINT)), this, "状态，0：有效，1：无效");

    /**
     * The column <code>historydb.hr_wx_hr_chat_list_bak_bak.create_time</code>. 创建时间
     */
    public final TableField<HrWxHrChatListBakBakRecord, Timestamp> CREATE_TIME = createField("create_time", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "创建时间");
     ...
     */
    public final TableField<HrWxHrChatListBakBakRecord, Timestamp> UPDATE_TIME = createField("update_time", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "创建时间");
