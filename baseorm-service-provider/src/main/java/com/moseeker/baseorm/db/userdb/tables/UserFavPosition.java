...
public class UserFavPosition extends TableImpl<UserFavPositionRecord> {
	...
	private static final long serialVersionUID = 307070048;
	 ...
	 */
	public final TableField<UserFavPositionRecord, Integer> WXUSER_ID = createField("wxuser_id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaulted(true), this, "wx_user.id");

	/**
	 * The column <code>userdb.user_fav_position.recom_id</code>. 推荐者 fk:wx_user.id。已经废弃，推荐者微信编号由推荐者C端账号编号替代，请参考recom_user_id
	 */
	public final TableField<UserFavPositionRecord, Integer> RECOM_ID = createField("recom_id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaulted(true), this, "推荐者 fk:wx_user.id。已经废弃，推荐者微信编号由推荐者C端账号编号替代，请参考recom_user_id");
