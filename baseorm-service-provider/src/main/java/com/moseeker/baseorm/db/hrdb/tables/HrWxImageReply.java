...
public class HrWxImageReply extends TableImpl<HrWxImageReplyRecord> {
    ...
    private static final long serialVersionUID = -1186306487;
     ...
     */
    public final TableField<HrWxImageReplyRecord, Integer> RID = createField("rid", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "wx_rule.id, 规则ID");
