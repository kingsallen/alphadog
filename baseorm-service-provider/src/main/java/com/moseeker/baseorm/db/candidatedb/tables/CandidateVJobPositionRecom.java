...
public class CandidateVJobPositionRecom extends TableImpl<CandidateVJobPositionRecomRecord> {
    ...
    private static final long serialVersionUID = -88227751;
     ...
     */
    public final TableField<CandidateVJobPositionRecomRecord, Integer> RECOM_ID = createField("recom_id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "userdb.user_user.id 转发者的C端账号编号");

    /**
     * The column <code>candidatedb.candidate_v_job_position_recom.presentee_id</code>. userdb.user_user.id 浏览者的C端账号编号
     */
    public final TableField<CandidateVJobPositionRecomRecord, Integer> PRESENTEE_ID = createField("presentee_id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "userdb.user_user.id 浏览者的C端账号编号");

    /**
     * The column <code>candidatedb.candidate_v_job_position_recom.create_time</code>. 创建时间
     */
    public final TableField<CandidateVJobPositionRecomRecord, Timestamp> CREATE_TIME = createField("create_time", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.field("0000-00-00 00:00:00", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "创建时间");
