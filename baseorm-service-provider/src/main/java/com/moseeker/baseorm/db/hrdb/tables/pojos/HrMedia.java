...
public class HrMedia implements Serializable {

    private static final long serialVersionUID = 589932246;
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("HrMedia (");
