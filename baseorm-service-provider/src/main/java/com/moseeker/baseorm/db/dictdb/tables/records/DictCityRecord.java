...
public class DictCityRecord extends TableRecordImpl<DictCityRecord> implements Record6<Integer, String, Byte, Byte, String, Byte> {

    private static final long serialVersionUID = 1709760514;
