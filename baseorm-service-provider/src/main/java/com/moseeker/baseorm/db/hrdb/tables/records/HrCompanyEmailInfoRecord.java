...
public class HrCompanyEmailInfoRecord extends UpdatableRecordImpl<HrCompanyEmailInfoRecord> implements Record7<Integer, Integer, Integer, Integer, Timestamp, Timestamp, Byte> {

    private static final long serialVersionUID = 725324290;
    ...
    /**
     * Setter for <code>hrdb.hr_company_email_info.disable</code>. 是否有效 0有效 1无效
     */
    ...
    /**
     * Getter for <code>hrdb.hr_company_email_info.disable</code>. 是否有效 0有效 1无效
     */
    ...
    public Field<Byte> field7() {
        return HrCompanyEmailInfo.HR_COMPANY_EMAIL_INFO.DISABLE;
    }
     ...
     */
    @Override
    public HrCompanyEmailInfoRecord value7(Byte value) {
        setDisable(value);
        return this;
    }
     ...
     */
    @Override
    public HrCompanyEmailInfoRecord values(Integer value1, Integer value2, Integer value3, Integer value4, Timestamp value5, Timestamp value6, Byte value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public HrCompanyEmailInfoRecord(Integer id, Integer companyId, Integer total, Integer balance, Timestamp createTime, Timestamp updateTime, Byte disable) {
        super(HrCompanyEmailInfo.HR_COMPANY_EMAIL_INFO);
