...
public class HrWxHrChatListBakBak implements Serializable {

    private static final long serialVersionUID = 820354904;
    ...
    public HrWxHrChatListBakBak(HrWxHrChatListBakBak value) {
        this.id = value.id;
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("HrWxHrChatListBakBak (");
