...
public class JobCustom extends TableImpl<JobCustomRecord> {
    ...
    private static final long serialVersionUID = 556256010;
     ...
     */
    public final TableField<JobCustomRecord, Byte> STATUS = createField("status", org.jooq.impl.SQLDataType.TINYINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("1", org.jooq.impl.SQLDataType.TINYINT)), this, "职位自定义字段是否有效，0：无效；1：有效");

    /**
     * The column <code>jobdb.job_custom.name</code>. 职位自定义字段值
     */
    public final TableField<JobCustomRecord, String> NAME = createField("name", org.jooq.impl.SQLDataType.VARCHAR.length(50).nullable(false).defaultValue(org.jooq.impl.DSL.field("", org.jooq.impl.SQLDataType.VARCHAR)), this, "职位自定义字段值");

    /**
     * The column <code>jobdb.job_custom.type</code>. 职位自定义字段类型，1：select；2：text；3：radio；4：checkbox
     */
    public final TableField<JobCustomRecord, Byte> TYPE = createField("type", org.jooq.impl.SQLDataType.TINYINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("1", org.jooq.impl.SQLDataType.TINYINT)), this, "职位自定义字段类型，1：select；2：text；3：radio；4：checkbox");

    /**
     * The column <code>jobdb.job_custom.create_time</code>. 创建时间
     */
    public final TableField<JobCustomRecord, Timestamp> CREATE_TIME = createField("create_time", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "创建时间");

    /**
     * The column <code>jobdb.job_custom.update_time</code>. 修改时间
     */
    public final TableField<JobCustomRecord, Timestamp> UPDATE_TIME = createField("update_time", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "修改时间");
