...
public class HrWxHrChat extends TableImpl<HrWxHrChatRecord> {
    ...
    private static final long serialVersionUID = 1789501735;
     ...
     */
    public final TableField<HrWxHrChatRecord, String> CONTENT = createField("content", org.jooq.impl.SQLDataType.VARCHAR.length(999).nullable(false).defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.VARCHAR)), this, "聊天内容");
