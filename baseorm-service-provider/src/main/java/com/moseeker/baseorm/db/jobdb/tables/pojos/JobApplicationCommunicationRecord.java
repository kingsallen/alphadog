...
public class JobApplicationCommunicationRecord implements Serializable {

    private static final long serialVersionUID = 246995243;
    ...
    public JobApplicationCommunicationRecord(JobApplicationCommunicationRecord value) {
        this.id = value.id;
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("JobApplicationCommunicationRecord (");
