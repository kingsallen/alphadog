...
public class DictZhilianOccupation extends TableImpl<DictZhilianOccupationRecord> {
    ...
    private static final long serialVersionUID = 1620175966;
     ...
     */
    public final TableField<DictZhilianOccupationRecord, Integer> PARENT_ID = createField("parent_id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "父Id，上一级职能的ID");
     ...
     */
    public final TableField<DictZhilianOccupationRecord, Integer> CODE_OTHER = createField("code_other", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "第三方职能id");

    /**
     * The column <code>dictdb.dict_zhilian_occupation.LEVEL</code>. 职能级别 1是一级2是二级依次类推
     */
    public final TableField<DictZhilianOccupationRecord, Short> LEVEL = createField("LEVEL", org.jooq.impl.SQLDataType.SMALLINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.SMALLINT)), this, "职能级别 1是一级2是二级依次类推");

    /**
     * The column <code>dictdb.dict_zhilian_occupation.STATUS</code>. 只能状态 0 是有效 1是无效
     */
    public final TableField<DictZhilianOccupationRecord, Short> STATUS = createField("STATUS", org.jooq.impl.SQLDataType.SMALLINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.SMALLINT)), this, "只能状态 0 是有效 1是无效");
