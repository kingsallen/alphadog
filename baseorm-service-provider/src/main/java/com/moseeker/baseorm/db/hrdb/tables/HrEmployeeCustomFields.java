...
public class HrEmployeeCustomFields extends TableImpl<HrEmployeeCustomFieldsRecord> {
    ...
    private static final long serialVersionUID = -1905629156;
    ...
    /**
     * The column <code>hrdb.hr_employee_custom_fields.option_type</code>. 选项类型  0:下拉列表, 1:文本
     */
    public final TableField<HrEmployeeCustomFieldsRecord, Integer> OPTION_TYPE = createField("option_type", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.INTEGER)), this, "选项类型  0:下拉列表, 1:文本");
