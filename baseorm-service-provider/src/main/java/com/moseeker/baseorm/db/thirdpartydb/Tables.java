...
public class Tables {
     ...
     * 数据杂项表
     */
    public static final ThirdpartyCommonInfo THIRDPARTY_COMMON_INFO = com.moseeker.baseorm.db.thirdpartydb.tables.ThirdpartyCommonInfo.THIRDPARTY_COMMON_INFO;
