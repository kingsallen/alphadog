...
public class ProfileProfile implements Serializable {

    private static final long serialVersionUID = -359169517;
    ...
    public ProfileProfile(ProfileProfile value) {
        this.id = value.id;
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("ProfileProfile (");
