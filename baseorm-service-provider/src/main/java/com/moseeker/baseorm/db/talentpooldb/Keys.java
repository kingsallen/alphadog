...
public class Keys {
    ...
    public static final Identity<TalentpoolTalentRecord, Integer> IDENTITY_TALENTPOOL_TALENT = Identities0.IDENTITY_TALENTPOOL_TALENT;
    ...
    public static final UniqueKey<TalentpoolTalentRecord> KEY_TALENTPOOL_TALENT_TALENTPOOL_TAG_USER_ID_COMPANY_ID = UniqueKeys0.KEY_TALENTPOOL_TALENT_TALENTPOOL_TAG_USER_ID_COMPANY_ID;
    ...
    private static class Identities0 extends AbstractKeys {
        ...
        public static Identity<TalentpoolTalentRecord, Integer> IDENTITY_TALENTPOOL_TALENT = createIdentity(TalentpoolTalent.TALENTPOOL_TALENT, TalentpoolTalent.TALENTPOOL_TALENT.ID);
    }
    ...
    private static class UniqueKeys0 extends AbstractKeys {
        ...
        public static final UniqueKey<TalentpoolHrTalentRecord> KEY_TALENTPOOL_HR_TALENT_PRIMARY = createUniqueKey(TalentpoolHrTalent.TALENTPOOL_HR_TALENT, "KEY_talentpool_hr_talent_PRIMARY", TalentpoolHrTalent.TALENTPOOL_HR_TALENT.HR_ID, TalentpoolHrTalent.TALENTPOOL_HR_TALENT.TALENT_ID);
        ...
        public static final UniqueKey<TalentpoolTalentRecord> KEY_TALENTPOOL_TALENT_PRIMARY = createUniqueKey(TalentpoolTalent.TALENTPOOL_TALENT, "KEY_talentpool_talent_PRIMARY", TalentpoolTalent.TALENTPOOL_TALENT.ID);
        public static final UniqueKey<TalentpoolTalentRecord> KEY_TALENTPOOL_TALENT_TALENTPOOL_TAG_USER_ID_COMPANY_ID = createUniqueKey(TalentpoolTalent.TALENTPOOL_TALENT, "KEY_talentpool_talent_talentpool_tag_user_id_company_id", TalentpoolTalent.TALENTPOOL_TALENT.USER_ID, TalentpoolTalent.TALENTPOOL_TALENT.COMPANY_ID);
        public static final UniqueKey<TalentpoolUserTagRecord> KEY_TALENTPOOL_USER_TAG_PRIMARY = createUniqueKey(TalentpoolUserTag.TALENTPOOL_USER_TAG, "KEY_talentpool_user_tag_PRIMARY", TalentpoolUserTag.TALENTPOOL_USER_TAG.TAG_ID, TalentpoolUserTag.TALENTPOOL_USER_TAG.TALENT_ID);
    }
}
