...
public class ProfileWorkexp extends TableImpl<ProfileWorkexpRecord> {
    ...
    private static final long serialVersionUID = 1088086697;

    /**
     * The reference instance of <code>historydb.profile_workexp</code>
     */
    ...
    /**
     * The column <code>historydb.profile_workexp.id</code>. 主key
     */
    ...
    /**
     * The column <code>historydb.profile_workexp.profile_id</code>. profile.id
     */
    ...
    /**
     * The column <code>historydb.profile_workexp.start</code>. 起止时间-起 yyyy-mm-dd
     */
    ...
    /**
     * The column <code>historydb.profile_workexp.end</code>. 起止时间-止 yyyy-mm-dd
     */
    ...
    /**
     * The column <code>historydb.profile_workexp.end_until_now</code>. 是否至今 0：否 1：是
     */
    ...
    /**
     * The column <code>historydb.profile_workexp.salary_code</code>. 薪资code
     */
    ...
    /**
     * The column <code>historydb.profile_workexp.industry_code</code>. 行业字典编码
     */
    ...
    /**
     * The column <code>historydb.profile_workexp.industry_name</code>. 行业名称
     */
    ...
    /**
     * The column <code>historydb.profile_workexp.company_id</code>. 公司ID, hr_company.id
     */
    ...
    /**
     * The column <code>historydb.profile_workexp.department_name</code>. 部门名称
     */
    ...
    /**
     * The column <code>historydb.profile_workexp.position_code</code>. 职能字典编码
     */
    ...
    /**
     * The column <code>historydb.profile_workexp.position_name</code>. 职能字典名称
     */
    ...
    /**
     * The column <code>historydb.profile_workexp.description</code>. 工作描述
     */
    public final TableField<ProfileWorkexpRecord, String> DESCRIPTION = createField("description", org.jooq.impl.SQLDataType.VARCHAR.length(1000).nullable(false).defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.VARCHAR)), this, "工作描述");

    /**
     * The column <code>historydb.profile_workexp.type</code>. 工作类型 0:没选择 1:全职 2:兼职 3:实习
     */
    ...
    /**
     * The column <code>historydb.profile_workexp.city_code</code>. 工作地点（城市），字典编码
     */
    ...
    /**
     * The column <code>historydb.profile_workexp.city_name</code>. 工作地点（城市）名称
     */
    ...
    /**
     * The column <code>historydb.profile_workexp.report_to</code>. 汇报对象
     */
    ...
    /**
     * The column <code>historydb.profile_workexp.underlings</code>. 下属人数, 0:没有下属
     */
    ...
    /**
     * The column <code>historydb.profile_workexp.reference</code>. 证明人
     */
    ...
    /**
     * The column <code>historydb.profile_workexp.resign_reason</code>. 离职原因
     */
    ...
    /**
     * The column <code>historydb.profile_workexp.achievement</code>. 主要业绩
     */
    ...
    /**
     * The column <code>historydb.profile_workexp.create_time</code>. 创建时间
     */
    ...
    /**
     * The column <code>historydb.profile_workexp.update_time</code>. 更新时间
     */
    ...
    /**
     * The column <code>historydb.profile_workexp.job</code>. 所处职位
     */
    ...
    /**
     * Create a <code>historydb.profile_workexp</code> table reference
     */
    ...
    /**
     * Create an aliased <code>historydb.profile_workexp</code> table reference
     */
