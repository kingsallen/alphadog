...
public class LogWxTemplateMessageSendrecord implements Serializable {

    private static final long serialVersionUID = -1778243721;
    ...
    public LogWxTemplateMessageSendrecord(LogWxTemplateMessageSendrecord value) {
        this.id = value.id;
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("LogWxTemplateMessageSendrecord (");
