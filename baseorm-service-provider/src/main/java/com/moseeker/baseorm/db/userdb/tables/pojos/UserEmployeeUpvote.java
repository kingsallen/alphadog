...
public class UserEmployeeUpvote implements Serializable {

    private static final long serialVersionUID = 1343271555;
    ...
    public UserEmployeeUpvote(UserEmployeeUpvote value) {
        this.id = value.id;
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("UserEmployeeUpvote (");
