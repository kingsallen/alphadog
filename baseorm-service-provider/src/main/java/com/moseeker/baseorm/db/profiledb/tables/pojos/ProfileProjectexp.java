...
public class ProfileProjectexp implements Serializable {

    private static final long serialVersionUID = 485173588;
    ...
    public ProfileProjectexp(ProfileProjectexp value) {
        this.id = value.id;
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("ProfileProjectexp (");
