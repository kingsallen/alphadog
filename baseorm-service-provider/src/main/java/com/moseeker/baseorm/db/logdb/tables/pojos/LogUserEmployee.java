...
public class LogUserEmployee implements Serializable {

    private static final long serialVersionUID = -1834446183;
    ...
    public LogUserEmployee(LogUserEmployee value) {
        this.id = value.id;
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("LogUserEmployee (");
