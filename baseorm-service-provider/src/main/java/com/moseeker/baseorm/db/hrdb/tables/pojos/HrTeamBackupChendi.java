...
public class HrTeamBackupChendi implements Serializable {

    private static final long serialVersionUID = 1631171768;
    ...
    public HrTeamBackupChendi(HrTeamBackupChendi value) {
        this.id = value.id;
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("HrTeamBackupChendi (");
