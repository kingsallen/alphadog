...
public class HrWxHrChatList extends TableImpl<HrWxHrChatListRecord> {
    ...
    private static final long serialVersionUID = -482738911;
     ...
     */
    public final TableField<HrWxHrChatListRecord, Timestamp> UPDATE_TIME = createField("update_time", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "创建时间");
