...
public class UserEmployeeCopy implements Serializable {

    private static final long serialVersionUID = 1684502637;
    ...
    public UserEmployeeCopy(UserEmployeeCopy value) {
        this.id = value.id;
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("UserEmployeeCopy (");
