...
public class ConfigSysTemplateType extends TableImpl<ConfigSysTemplateTypeRecord> {
    ...
    private static final long serialVersionUID = -305729167;
     ...
     */
    public final TableField<ConfigSysTemplateTypeRecord, String> NAME = createField("name", org.jooq.impl.SQLDataType.VARCHAR.length(50).nullable(false).defaultValue(org.jooq.impl.DSL.field("", org.jooq.impl.SQLDataType.VARCHAR)), this, "类型名称");

    /**
     * The column <code>configdb.config_sys_template_type.create_time</code>. 创建时间
     */
    public final TableField<ConfigSysTemplateTypeRecord, Timestamp> CREATE_TIME = createField("create_time", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "创建时间");

    /**
     * The column <code>configdb.config_sys_template_type.update_time</code>. 修改时间
     */
    public final TableField<ConfigSysTemplateTypeRecord, Timestamp> UPDATE_TIME = createField("update_time", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "修改时间");

    /**
     * The column <code>configdb.config_sys_template_type.status</code>. 是否有效 0：有效1：无效
     */
    public final TableField<ConfigSysTemplateTypeRecord, Byte> STATUS = createField("status", org.jooq.impl.SQLDataType.TINYINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.TINYINT)), this, "是否有效 0：有效1：无效");
