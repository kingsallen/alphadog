...
public class HrEmployeeCustomFields extends TableImpl<HrEmployeeCustomFieldsRecord> {
    ...
    private static final long serialVersionUID = 839149810;

    /**
     * The reference instance of <code>referraldb.hr_employee_custom_fields</code>
     */
    ...
    /**
     * The column <code>referraldb.hr_employee_custom_fields.id</code>.
     */
    ...
    /**
     * The column <code>referraldb.hr_employee_custom_fields.company_id</code>. sys_company.id, 部门ID
     */
    ...
    /**
     * The column <code>referraldb.hr_employee_custom_fields.fname</code>. 自定义字段名
     */
    ...
    /**
     * The column <code>referraldb.hr_employee_custom_fields.fvalues</code>. 自定义字段可选值
     */
    ...
    /**
     * The column <code>referraldb.hr_employee_custom_fields.forder</code>. 排序优先级，0:不显示, 正整数由小到大排序
     */
    ...
    /**
     * The column <code>referraldb.hr_employee_custom_fields.disable</code>. 是否停用 0:不停用(有效)， 1:停用(无效)
     */
    ...
    /**
     * The column <code>referraldb.hr_employee_custom_fields.mandatory</code>. 是否必填 0:不是必填, 1:必填
     */
    ...
    /**
     * The column <code>referraldb.hr_employee_custom_fields.status</code>. 0: 正常 1: 被删除
     */
    ...
    /**
     * The column <code>referraldb.hr_employee_custom_fields.option_type</code>. 选项类型  0:下拉选项, 1:文本
     */
    ...
    /**
     * Create a <code>referraldb.hr_employee_custom_fields</code> table reference
     */
    ...
    /**
     * Create an aliased <code>referraldb.hr_employee_custom_fields</code> table reference
     */
