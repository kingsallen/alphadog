...
public class HrHtml5Statistics extends TableImpl<HrHtml5StatisticsRecord> {
    ...
    private static final long serialVersionUID = 1299171342;
     ...
     */
    public final TableField<HrHtml5StatisticsRecord, Integer> TOPIC_ID = createField("topic_id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "wx_topic.id");
     ...
     */
    public final TableField<HrHtml5StatisticsRecord, Integer> VIEW_NUM_PV = createField("view_num_pv", org.jooq.impl.SQLDataType.INTEGER.defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "浏览次数");

    /**
     * The column <code>hrdb.hr_html5_statistics.recom_view_num_pv</code>. 推荐浏览次数
     */
    public final TableField<HrHtml5StatisticsRecord, Integer> RECOM_VIEW_NUM_PV = createField("recom_view_num_pv", org.jooq.impl.SQLDataType.INTEGER.defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "推荐浏览次数");
