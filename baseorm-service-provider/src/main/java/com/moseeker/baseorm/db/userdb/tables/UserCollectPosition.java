...
public class UserCollectPosition extends TableImpl<UserCollectPositionRecord> {
	...
	private static final long serialVersionUID = -655686327;
	 ...
	 */
	public final TableField<UserCollectPositionRecord, Integer> STATUS = createField("status", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaulted(true), this, "0:收藏, 1:取消收藏");

	/**
	 * The column <code>userdb.user_collect_position.create_time</code>. 创建时间
	 */
	public final TableField<UserCollectPositionRecord, Timestamp> CREATE_TIME = createField("create_time", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaulted(true), this, "创建时间");

	/**
	 * The column <code>userdb.user_collect_position.update_time</code>. 修改时间
	 */
	public final TableField<UserCollectPositionRecord, Timestamp> UPDATE_TIME = createField("update_time", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaulted(true), this, "修改时间");
