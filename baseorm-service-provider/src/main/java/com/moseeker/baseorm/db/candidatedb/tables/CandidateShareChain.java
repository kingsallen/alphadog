...
public class CandidateShareChain extends TableImpl<CandidateShareChainRecord> {
    ...
    private static final long serialVersionUID = 1871478529;
     ...
     */
    public final TableField<CandidateShareChainRecord, Integer> POSITION_ID = createField("position_id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "jobdb.job_position.id,相关职位 id");

    /**
     * The column <code>candidatedb.candidate_share_chain.root_recom_user_id</code>. userdb.user_user.id,最初转发人的 user_user.id
     */
    public final TableField<CandidateShareChainRecord, Integer> ROOT_RECOM_USER_ID = createField("root_recom_user_id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "userdb.user_user.id,最初转发人的 user_user.id");

    /**
     * The column <code>candidatedb.candidate_share_chain.root2_recom_user_id</code>. userdb.user_user.id,最初转发人后一个的 user_user.id
     */
    public final TableField<CandidateShareChainRecord, Integer> ROOT2_RECOM_USER_ID = createField("root2_recom_user_id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "userdb.user_user.id,最初转发人后一个的 user_user.id");

    /**
     * The column <code>candidatedb.candidate_share_chain.recom_user_id</code>. userdb.user_user.id,转发人的 user_user.id
     */
    public final TableField<CandidateShareChainRecord, Integer> RECOM_USER_ID = createField("recom_user_id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "userdb.user_user.id,转发人的 user_user.id");

    /**
     * The column <code>candidatedb.candidate_share_chain.presentee_user_id</code>. userdb.user_user.id,点击者 user_id
     */
    public final TableField<CandidateShareChainRecord, Integer> PRESENTEE_USER_ID = createField("presentee_user_id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "userdb.user_user.id,点击者 user_id");

    /**
     * The column <code>candidatedb.candidate_share_chain.depth</code>. 第几层关系, 默认从 1 开始,当 presentee_id 是员工时,depth 为 0,表示该员工把链路截断了
     */
    public final TableField<CandidateShareChainRecord, Integer> DEPTH = createField("depth", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "第几层关系, 默认从 1 开始,当 presentee_id 是员工时,depth 为 0,表示该员工把链路截断了");

    /**
     * The column <code>candidatedb.candidate_share_chain.parent_id</code>. candidatedb.candidate_share_chain.id,上一条 share_chain.id
     */
    public final TableField<CandidateShareChainRecord, Integer> PARENT_ID = createField("parent_id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "candidatedb.candidate_share_chain.id,上一条 share_chain.id");
     ...
     */
    public final TableField<CandidateShareChainRecord, Timestamp> CREATE_TIME = createField("create_time", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "创建时间");
