...
public class JobPcAdvertisement extends TableImpl<JobPcAdvertisementRecord> {
    ...
    private static final long serialVersionUID = -1201299982;
    ...
    /**
     * The column <code>jobdb.job_pc_advertisement.href</code>.
     */
    public final TableField<JobPcAdvertisementRecord, String> HREF = createField("href", org.jooq.impl.SQLDataType.VARCHAR.length(200).nullable(false).defaultValue(org.jooq.impl.DSL.field("", org.jooq.impl.SQLDataType.VARCHAR)), this, "");
     ...
     */
    public final TableField<JobPcAdvertisementRecord, Timestamp> CREATE_TIME = createField("create_time", org.jooq.impl.SQLDataType.TIMESTAMP, this, "创建时间");
