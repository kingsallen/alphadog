...
public class JobPcAdvertisement extends TableImpl<JobPcAdvertisementRecord> {
    ...
    private static final long serialVersionUID = -343581677;
     ...
     */
    public final TableField<JobPcAdvertisementRecord, String> IMG = createField("img", org.jooq.impl.SQLDataType.VARCHAR.length(100).nullable(false).defaultValue(org.jooq.impl.DSL.field("", org.jooq.impl.SQLDataType.VARCHAR)), this, "图片地址");

    /**
     * The column <code>jobdb.job_pc_advertisement.name</code>. 推荐模块名称
     */
    public final TableField<JobPcAdvertisementRecord, String> NAME = createField("name", org.jooq.impl.SQLDataType.VARCHAR.length(64).nullable(false).defaultValue(org.jooq.impl.DSL.field("", org.jooq.impl.SQLDataType.VARCHAR)), this, "推荐模块名称");

    /**
     * The column <code>jobdb.job_pc_advertisement.href</code>. 广告位链接地址
     */
    public final TableField<JobPcAdvertisementRecord, String> HREF = createField("href", org.jooq.impl.SQLDataType.VARCHAR.length(200).nullable(false).defaultValue(org.jooq.impl.DSL.field("", org.jooq.impl.SQLDataType.VARCHAR)), this, "广告位链接地址");

    /**
     * The column <code>jobdb.job_pc_advertisement.status</code>. 是否可以用，0：不可用 1：可用
     */
    public final TableField<JobPcAdvertisementRecord, Byte> STATUS = createField("status", org.jooq.impl.SQLDataType.TINYINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("1", org.jooq.impl.SQLDataType.TINYINT)), this, "是否可以用，0：不可用 1：可用");

    /**
     * The column <code>jobdb.job_pc_advertisement.description</code>. 广告位说明
     */
    public final TableField<JobPcAdvertisementRecord, String> DESCRIPTION = createField("description", org.jooq.impl.SQLDataType.VARCHAR.length(200).defaultValue(org.jooq.impl.DSL.field("", org.jooq.impl.SQLDataType.VARCHAR)), this, "广告位说明");

    /**
     * The column <code>jobdb.job_pc_advertisement.create_time</code>. 创建时间
     */
    public final TableField<JobPcAdvertisementRecord, Timestamp> CREATE_TIME = createField("create_time", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "创建时间");

    /**
     * The column <code>jobdb.job_pc_advertisement.update_time</code>. 更新时间
     */
    public final TableField<JobPcAdvertisementRecord, Timestamp> UPDATE_TIME = createField("update_time", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "更新时间");
