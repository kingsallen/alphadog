...
public class HrCompany extends TableImpl<HrCompanyRecord> {
    ...
    private static final long serialVersionUID = -1168023352;
     ...
     */
    public final TableField<HrCompanyRecord, UByte> TYPE = createField("type", org.jooq.impl.SQLDataType.TINYINTUNSIGNED.nullable(false).defaultValue(org.jooq.impl.DSL.field("1", org.jooq.impl.SQLDataType.TINYINTUNSIGNED)), this, "公司区分(其它:2,免费用户:1,企业用户:0)");
     ...
     */
    public final TableField<HrCompanyRecord, UByte> SCALE = createField("scale", org.jooq.impl.SQLDataType.TINYINTUNSIGNED.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.TINYINTUNSIGNED)), this, "公司规模, dict_constant.parent_code=1102");
     ...
     */
    public final TableField<HrCompanyRecord, UInteger> PARENT_ID = createField("parent_id", org.jooq.impl.SQLDataType.INTEGERUNSIGNED.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGERUNSIGNED)), this, "上级公司");
