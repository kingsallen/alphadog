...
public class UserEmployeeTest implements Serializable {

    private static final long serialVersionUID = 267980097;
    ...
    public UserEmployeeTest(UserEmployeeTest value) {
        this.id = value.id;
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("UserEmployeeTest (");
