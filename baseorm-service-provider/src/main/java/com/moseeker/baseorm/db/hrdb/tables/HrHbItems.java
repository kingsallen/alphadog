...
public class HrHbItems extends TableImpl<HrHbItemsRecord> {
    ...
    private static final long serialVersionUID = 1919898875;
     ...
     */
    public final TableField<HrHbItemsRecord, Integer> HB_CONFIG_ID = createField("hb_config_id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "hr_hb_config.id");
     ...
     */
    public final TableField<HrHbItemsRecord, BigDecimal> AMOUNT = createField("amount", org.jooq.impl.SQLDataType.DECIMAL.precision(11, 2).nullable(false).defaultValue(org.jooq.impl.DSL.field("0.00", org.jooq.impl.SQLDataType.DECIMAL)), this, "红包金额");

    /**
     * The column <code>hrdb.hr_hb_items.status</code>. 0:还未送出，1:已经送出
     */
    public final TableField<HrHbItemsRecord, Byte> STATUS = createField("status", org.jooq.impl.SQLDataType.TINYINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.TINYINT)), this, "0:还未送出，1:已经送出");

    /**
     * The column <code>hrdb.hr_hb_items.wxuser_id</code>. 获取红包的用户
     */
    public final TableField<HrHbItemsRecord, Integer> WXUSER_ID = createField("wxuser_id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "获取红包的用户");
     ...
     */
    public final TableField<HrHbItemsRecord, Timestamp> CREATE_TIME = createField("create_time", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "创建时间");

    /**
     * The column <code>hrdb.hr_hb_items.update_time</code>. 更新时间
     */
    public final TableField<HrHbItemsRecord, Timestamp> UPDATE_TIME = createField("update_time", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "更新时间");

    /**
     * The column <code>hrdb.hr_hb_items.trigger_wxuser_id</code>. 触发发送红包行为时的当前用户, 即 JD 页点击者或职位申请者 wx_group_user.id
     */
    public final TableField<HrHbItemsRecord, Integer> TRIGGER_WXUSER_ID = createField("trigger_wxuser_id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "触发发送红包行为时的当前用户, 即 JD 页点击者或职位申请者 wx_group_user.id");
