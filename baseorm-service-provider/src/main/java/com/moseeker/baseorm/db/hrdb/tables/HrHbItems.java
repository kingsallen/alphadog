...
public class HrHbItems extends TableImpl<HrHbItemsRecord> {
    ...
    private static final long serialVersionUID = -1617813230;
     ...
     */
    public final TableField<HrHbItemsRecord, Integer> INDEX = createField("index", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.INTEGER)), this, "这条数据是第几个红包 0 < x <= 总红包数");
     ...
     */
    public final TableField<HrHbItemsRecord, Byte> STATUS = createField("status", org.jooq.impl.SQLDataType.TINYINT.nullable(false).defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.TINYINT)), this, "0:还未送出，1:已经送出");
