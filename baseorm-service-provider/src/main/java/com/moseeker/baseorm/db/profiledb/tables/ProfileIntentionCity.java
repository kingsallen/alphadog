...
public class ProfileIntentionCity extends TableImpl<ProfileIntentionCityRecord> {
    ...
    private static final long serialVersionUID = 1334011688;
     ...
     */
    public final TableField<ProfileIntentionCityRecord, Integer> CITY_CODE = createField("city_code", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "期望城市字典编码");

    /**
     * The column <code>profiledb.profile_intention_city.city_name</code>. 期望城市名称
     */
    public final TableField<ProfileIntentionCityRecord, String> CITY_NAME = createField("city_name", org.jooq.impl.SQLDataType.VARCHAR.length(50).nullable(false).defaultValue(org.jooq.impl.DSL.field("", org.jooq.impl.SQLDataType.VARCHAR)), this, "期望城市名称");
