...
public class CandidatePositionShareRecordRecord extends UpdatableRecordImpl<CandidatePositionShareRecordRecord> implements Record14<Integer, Long, Long, Long, Integer, String, Long, Long, Byte, Timestamp, Timestamp, Byte, Integer, Integer> {

    private static final long serialVersionUID = -1720044629;
    ...
    /**
     * Setter for <code>candidatedb.candidate_position_share_record.share_chain_id</code>.
     */
    ...
    /**
     * Getter for <code>candidatedb.candidate_position_share_record.share_chain_id</code>.
     */
     ...
     */
    @Override
    public Row14<Integer, Long, Long, Long, Integer, String, Long, Long, Byte, Timestamp, Timestamp, Byte, Integer, Integer> fieldsRow() {
     ...
     */
    @Override
    public Row14<Integer, Long, Long, Long, Integer, String, Long, Long, Byte, Timestamp, Timestamp, Byte, Integer, Integer> valuesRow() {
     ...
     */
    @Override
    public CandidatePositionShareRecordRecord value8(Long value) {
     ...
     */
    @Override
    public CandidatePositionShareRecordRecord value9(Byte value) {
        setSource(value);
        return this;
    }
     ...
     */
    @Override
    public CandidatePositionShareRecordRecord value11(Timestamp value) {
        setUpdateTime(value);
        return this;
    }
     ...
     */
    @Override
    public CandidatePositionShareRecordRecord values(Integer value1, Long value2, Long value3, Long value4, Integer value5, String value6, Long value7, Long value8, Byte value9, Timestamp value10, Timestamp value11, Byte value12, Integer value13, Integer value14) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public CandidatePositionShareRecordRecord(Integer id, Long wechatId, Long positionId, Long recomId, Integer recomUserId, String viewerId, Long viewerIp, Long presenteeId, Byte source, Timestamp createTime, Timestamp updateTime, Byte clickFrom, Integer presenteeUserId, Integer shareChainId) {
        super(CandidatePositionShareRecord.CANDIDATE_POSITION_SHARE_RECORD);
