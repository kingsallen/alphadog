...
public class Profiledb extends SchemaImpl {
     ...
     * Profile的简历附件
     */
    public final ProfileAttachment PROFILE_ATTACHMENT = ProfileAttachment.PROFILE_ATTACHMENT;

    /**
     * Profile的获得奖项表
     */
    public final ProfileAwards PROFILE_AWARDS = ProfileAwards.PROFILE_AWARDS;

    /**
     * 用户profile基础个人信息表
     */
    public final ProfileBasic PROFILE_BASIC = ProfileBasic.PROFILE_BASIC;

    /**
     * profile各个部分完成度表
     */
    public final ProfileCompleteness PROFILE_COMPLETENESS = ProfileCompleteness.PROFILE_COMPLETENESS;

    /**
     * Profile的证书表
     */
    public final ProfileCredentials PROFILE_CREDENTIALS = ProfileCredentials.PROFILE_CREDENTIALS;

    /**
     * Profile的教育经历
     */
    public final ProfileEducation PROFILE_EDUCATION = ProfileEducation.PROFILE_EDUCATION;

    /**
     * 用户profile导入记录信息
     */
    public final ProfileImport PROFILE_IMPORT = ProfileImport.PROFILE_IMPORT;

    /**
     * Profile的求职意向
     */
    public final ProfileIntention PROFILE_INTENTION = ProfileIntention.PROFILE_INTENTION;

    /**
     * Profile的求职意向-期望城市关系表
     */
    public final ProfileIntentionCity PROFILE_INTENTION_CITY = ProfileIntentionCity.PROFILE_INTENTION_CITY;

    /**
     * Profile的求职意向-行业关系表
     */
    public final ProfileIntentionIndustry PROFILE_INTENTION_INDUSTRY = ProfileIntentionIndustry.PROFILE_INTENTION_INDUSTRY;

    /**
     * Profile的求职意向-职能关系表
     */
    public final ProfileIntentionPosition PROFILE_INTENTION_POSITION = ProfileIntentionPosition.PROFILE_INTENTION_POSITION;

    /**
     * Profile的语言
     */
    public final ProfileLanguage PROFILE_LANGUAGE = ProfileLanguage.PROFILE_LANGUAGE;

    /**
     * 用户profile导入记录信息
     */
    public final ProfileOther PROFILE_OTHER = ProfileOther.PROFILE_OTHER;

    /**
     * 用户profile表
     */
    public final ProfileProfile PROFILE_PROFILE = ProfileProfile.PROFILE_PROFILE;

    /**
     * Profile的项目经验
     */
    public final ProfileProjectexp PROFILE_PROJECTEXP = ProfileProjectexp.PROFILE_PROJECTEXP;

    /**
     * Profile的技能
     */
    public final ProfileSkill PROFILE_SKILL = ProfileSkill.PROFILE_SKILL;

    /**
     * Profile的工作经历
     */
    public final ProfileWorkexp PROFILE_WORKEXP = ProfileWorkexp.PROFILE_WORKEXP;

    /**
     * Profile的个人作品
     */
    public final ProfileWorks PROFILE_WORKS = ProfileWorks.PROFILE_WORKS;
