...
public class HrMediaBackupChendiRecord extends UpdatableRecordImpl<HrMediaBackupChendiRecord> implements Record7<Integer, String, String, String, String, String, Integer> {
