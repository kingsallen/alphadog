...
public class HrCompanyConf extends TableImpl<HrCompanyConfRecord> {
    ...
    private static final long serialVersionUID = 267342926;
     ...
     */
    public final TableField<HrCompanyConfRecord, String> JOB_OCCUPATION = createField("job_occupation", org.jooq.impl.SQLDataType.VARCHAR.length(30).defaultValue(org.jooq.impl.DSL.inline("职位职能", org.jooq.impl.SQLDataType.VARCHAR)), this, "自定义字段名称");
    ...
    /**
     * The column <code>hrdb.hr_company_conf.talentpool_status</code>.
     */
    public final TableField<HrCompanyConfRecord, Byte> TALENTPOOL_STATUS = createField("talentpool_status", org.jooq.impl.SQLDataType.TINYINT.nullable(false).defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.TINYINT)), this, "");
