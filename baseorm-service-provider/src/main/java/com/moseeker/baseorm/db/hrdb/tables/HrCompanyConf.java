...
public class HrCompanyConf extends TableImpl<HrCompanyConfRecord> {
    ...
    private static final long serialVersionUID = 514839417;
     ...
     */
    public final TableField<HrCompanyConfRecord, Byte> SHOW_QX_ONLY = createField("show_qx_only", org.jooq.impl.SQLDataType.TINYINT.nullable(false).defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.TINYINT)), this, "公司信息、团队信息、职位信息等只在仟寻展示，0: 否， 1: 是");
