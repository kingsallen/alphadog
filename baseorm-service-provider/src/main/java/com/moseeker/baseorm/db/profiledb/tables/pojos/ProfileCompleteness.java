...
public class ProfileCompleteness implements Serializable {
    ...
    private static final long serialVersionUID = 332311271;
    ...
    public ProfileCompleteness(ProfileCompleteness value) {
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("ProfileCompleteness (");
