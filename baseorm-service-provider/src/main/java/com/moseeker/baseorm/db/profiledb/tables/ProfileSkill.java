...
public class ProfileSkill extends TableImpl<ProfileSkillRecord> {
    ...
    private static final long serialVersionUID = 1046848335;
     ...
     */
    public final TableField<ProfileSkillRecord, Integer> PROFILE_ID = createField("profile_id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "profile.id");

    /**
     * The column <code>profiledb.profile_skill.name</code>. 技能名称
     */
    public final TableField<ProfileSkillRecord, String> NAME = createField("name", org.jooq.impl.SQLDataType.VARCHAR.length(128).nullable(false).defaultValue(org.jooq.impl.DSL.field("", org.jooq.impl.SQLDataType.VARCHAR)), this, "技能名称");

    /**
     * The column <code>profiledb.profile_skill.level</code>. 掌握程度 0:未填写 1:了解, 2:掌握 3:熟练 4:精通
     */
    public final TableField<ProfileSkillRecord, Byte> LEVEL = createField("level", org.jooq.impl.SQLDataType.TINYINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.TINYINT)), this, "掌握程度 0:未填写 1:了解, 2:掌握 3:熟练 4:精通");

    /**
     * The column <code>profiledb.profile_skill.month</code>. 使用 单位(月)
     */
    public final TableField<ProfileSkillRecord, Integer> MONTH = createField("month", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "使用 单位(月)");

    /**
     * The column <code>profiledb.profile_skill.create_time</code>. 创建时间
     */
    public final TableField<ProfileSkillRecord, Timestamp> CREATE_TIME = createField("create_time", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "创建时间");

    /**
     * The column <code>profiledb.profile_skill.update_time</code>. 更新时间
     */
    public final TableField<ProfileSkillRecord, Timestamp> UPDATE_TIME = createField("update_time", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "更新时间");
