...
public class ConfigSysTemplateMessageColumnConfig extends TableImpl<ConfigSysTemplateMessageColumnConfigRecord> {
     ...
     */
    public final TableField<ConfigSysTemplateMessageColumnConfigRecord, String> _DEFAULT = createField("_default", org.jooq.impl.SQLDataType.VARCHAR.length(200).nullable(false).defaultValue(org.jooq.impl.DSL.field("", org.jooq.impl.SQLDataType.VARCHAR)), this, "default value");
