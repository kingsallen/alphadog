...
public class CandidateTemplateShareChainDao extends DAOImpl<CandidateTemplateShareChainRecord, com.moseeker.baseorm.db.candidatedb.tables.pojos.CandidateTemplateShareChain, Integer> {
     ...
     */
    public List<com.moseeker.baseorm.db.candidatedb.tables.pojos.CandidateTemplateShareChain> fetchByClickFrom(Integer... values) {
        return fetch(CandidateTemplateShareChain.CANDIDATE_TEMPLATE_SHARE_CHAIN.CLICK_FROM, values);
    }
}
