...
public class HrWxBasicReply extends TableImpl<HrWxBasicReplyRecord> {
    ...
    private static final long serialVersionUID = 744659812;
     ...
     */
    public final TableField<HrWxBasicReplyRecord, Integer> RID = createField("rid", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "");
