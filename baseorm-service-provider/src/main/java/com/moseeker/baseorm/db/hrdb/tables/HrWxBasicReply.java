...
public class HrWxBasicReply extends TableImpl<HrWxBasicReplyRecord> {
    ...
    private static final long serialVersionUID = 1100207173;
     ...
     */
    public final TableField<HrWxBasicReplyRecord, UInteger> RID = createField("rid", org.jooq.impl.SQLDataType.INTEGERUNSIGNED.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGERUNSIGNED)), this, "");
