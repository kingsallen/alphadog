...
public class HrThirdPartyPosition extends TableImpl<HrThirdPartyPositionRecord> {
    ...
    private static final long serialVersionUID = -2118589688;
     ...
     */
    public final TableField<HrThirdPartyPositionRecord, UInteger> POSITION_ID = createField("position_id", org.jooq.impl.SQLDataType.INTEGERUNSIGNED.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGERUNSIGNED)), this, "jobdb.job_position.id");
     ...
     */
    public final TableField<HrThirdPartyPositionRecord, Timestamp> SYNC_TIME = createField("sync_time", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.field("0000-00-00 00:00:00", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "职位同步时间");

    /**
     * The column <code>hrdb.hr_third_party_position.refresh_time</code>. 职位刷新时间
     */
    public final TableField<HrThirdPartyPositionRecord, Timestamp> REFRESH_TIME = createField("refresh_time", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "职位刷新时间");
