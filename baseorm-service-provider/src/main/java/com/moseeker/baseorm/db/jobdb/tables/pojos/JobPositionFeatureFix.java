...
public class JobPositionFeatureFix implements Serializable {

    private static final long serialVersionUID = 14593486;
    ...
    public JobPositionFeatureFix(JobPositionFeatureFix value) {
        this.id = value.id;
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("JobPositionFeatureFix (");
