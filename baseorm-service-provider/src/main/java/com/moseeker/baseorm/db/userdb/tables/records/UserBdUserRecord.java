...
public class UserBdUserRecord extends UpdatableRecordImpl<UserBdUserRecord> implements Record8<ULong, Long, Integer, String, Integer, String, Timestamp, Timestamp> {
    ...
    private static final long serialVersionUID = 1446528366;
     ...
     */
    @Override
    public Row8<ULong, Long, Integer, String, Integer, String, Timestamp, Timestamp> fieldsRow() {
     ...
     */
    @Override
    public Row8<ULong, Long, Integer, String, Integer, String, Timestamp, Timestamp> valuesRow() {
     ...
     */
    @Override
    public UserBdUserRecord value1(ULong value) {
        setId(value);
        return this;
    }
     ...
     */
    @Override
    public UserBdUserRecord values(ULong value1, Long value2, Integer value3, String value4, Integer value5, String value6, Timestamp value7, Timestamp value8) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public UserBdUserRecord(ULong id, Long uid, Integer userId, String username, Integer sex, String headimgurl, Timestamp createTime, Timestamp updateTime) {
        super(UserBdUser.USER_BD_USER);
