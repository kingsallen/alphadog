...
public class ProfileIntention extends TableImpl<ProfileIntentionRecord> {
    ...
    private static final long serialVersionUID = -1130588360;
     ...
     */
    public final TableField<ProfileIntentionRecord, Integer> PROFILE_ID = createField("profile_id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "profile.id");

    /**
     * The column <code>profiledb.profile_intention.worktype</code>. 工作类型, {"0":"没选择", "1":"全职", "2":"兼职", "3":"实习"}
     */
    public final TableField<ProfileIntentionRecord, Byte> WORKTYPE = createField("worktype", org.jooq.impl.SQLDataType.TINYINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.TINYINT)), this, "工作类型, {\"0\":\"没选择\", \"1\":\"全职\", \"2\":\"兼职\", \"3\":\"实习\"}");
     ...
     */
    public final TableField<ProfileIntentionRecord, Byte> WORKSTATE = createField("workstate", org.jooq.impl.SQLDataType.TINYINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.TINYINT)), this, "当前是否在职状态, 0:未填写 1: 在职，看看新机会, 2: 在职，急寻新工作, 3:在职，暂无跳槽打算, 4:离职，正在找工作, 5:应届毕业生");

    /**
     * The column <code>profiledb.profile_intention.salary_code</code>. 薪资code
     */
    public final TableField<ProfileIntentionRecord, Byte> SALARY_CODE = createField("salary_code", org.jooq.impl.SQLDataType.TINYINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.TINYINT)), this, "薪资code");

    /**
     * The column <code>profiledb.profile_intention.tag</code>. 关键词，单个tag最多100个字符，以#隔开
     */
    public final TableField<ProfileIntentionRecord, String> TAG = createField("tag", org.jooq.impl.SQLDataType.VARCHAR.length(1010).nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.VARCHAR)), this, "关键词，单个tag最多100个字符，以#隔开");

    /**
     * The column <code>profiledb.profile_intention.consider_venture_company_opportunities</code>. 是否考虑创业公司机会 0：未填写 1:考虑 2:不考虑
     */
    public final TableField<ProfileIntentionRecord, Byte> CONSIDER_VENTURE_COMPANY_OPPORTUNITIES = createField("consider_venture_company_opportunities", org.jooq.impl.SQLDataType.TINYINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.TINYINT)), this, "是否考虑创业公司机会 0：未填写 1:考虑 2:不考虑");

    /**
     * The column <code>profiledb.profile_intention.create_time</code>. 创建时间
     */
    public final TableField<ProfileIntentionRecord, Timestamp> CREATE_TIME = createField("create_time", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "创建时间");

    /**
     * The column <code>profiledb.profile_intention.update_time</code>. 更新时间
     */
    public final TableField<ProfileIntentionRecord, Timestamp> UPDATE_TIME = createField("update_time", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "更新时间");
