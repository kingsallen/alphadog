...
public class ProfileIntention extends TableImpl<ProfileIntentionRecord> {
	...
	private static final long serialVersionUID = 843281371;
	 ...
	 */
	public final TableField<ProfileIntentionRecord, Integer> PROFILE_ID = createField("profile_id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaulted(true), this, "profile.id");

	/**
	 * The column <code>profiledb.profile_intention.worktype</code>. 工作类型, {"0":"没选择", "1":"全职", "2":"兼职", "3":"实习"}
	 */
	public final TableField<ProfileIntentionRecord, Byte> WORKTYPE = createField("worktype", org.jooq.impl.SQLDataType.TINYINT.nullable(false).defaulted(true), this, "工作类型, {\"0\":\"没选择\", \"1\":\"全职\", \"2\":\"兼职\", \"3\":\"实习\"}");
	 ...
	 */
	public final TableField<ProfileIntentionRecord, Byte> WORKSTATE = createField("workstate", org.jooq.impl.SQLDataType.TINYINT.nullable(false).defaulted(true), this, "当前是否在职状态, 0:未填写 1: 在职，看看新机会, 2: 在职，急寻新工作, 3:在职，暂无跳槽打算, 4:离职，正在找工作, 5:应届毕业生");

	/**
	 * The column <code>profiledb.profile_intention.salary_code</code>. 薪资code
	 */
	public final TableField<ProfileIntentionRecord, Byte> SALARY_CODE = createField("salary_code", org.jooq.impl.SQLDataType.TINYINT.nullable(false).defaulted(true), this, "薪资code");
