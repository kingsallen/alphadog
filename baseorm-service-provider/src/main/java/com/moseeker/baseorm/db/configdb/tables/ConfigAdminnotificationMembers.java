...
public class ConfigAdminnotificationMembers extends TableImpl<ConfigAdminnotificationMembersRecord> {
    ...
    private static final long serialVersionUID = 542125766;
     ...
     */
    public final TableField<ConfigAdminnotificationMembersRecord, Byte> STATUS = createField("status", org.jooq.impl.SQLDataType.TINYINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("1", org.jooq.impl.SQLDataType.TINYINT)), this, "1 有效 0 无效");

    /**
     * The column <code>configdb.config_adminnotification_members.create_time</code>.
     */
    public final TableField<ConfigAdminnotificationMembersRecord, Timestamp> CREATE_TIME = createField("create_time", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "");
