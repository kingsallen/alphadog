...
public class WordpressOptions extends TableImpl<WordpressOptionsRecord> {
    ...
    private static final long serialVersionUID = 1645892050;
     ...
     */
    public final TableField<WordpressOptionsRecord, String> OPTION_NAME = createField("option_name", org.jooq.impl.SQLDataType.VARCHAR.length(191).nullable(false).defaultValue(org.jooq.impl.DSL.field("", org.jooq.impl.SQLDataType.VARCHAR)), this, "");
     ...
     */
    public final TableField<WordpressOptionsRecord, String> AUTOLOAD = createField("autoload", org.jooq.impl.SQLDataType.VARCHAR.length(20).nullable(false).defaultValue(org.jooq.impl.DSL.field("yes", org.jooq.impl.SQLDataType.VARCHAR)), this, "");
