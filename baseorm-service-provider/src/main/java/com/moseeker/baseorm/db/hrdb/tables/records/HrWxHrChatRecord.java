...
public class HrWxHrChatRecord extends UpdatableRecordImpl<HrWxHrChatRecord> implements Record11<Integer, Integer, String, Integer, Byte, Byte, Timestamp, Byte, String, String, String> {
    ...
    private static final long serialVersionUID = -795029846;
    ...
    /**
     * Setter for <code>hrdb.hr_wx_hr_chat.msg_type</code>. 信息类型,暂定html、image、qrcode、button
     */
    ...
    /**
     * Getter for <code>hrdb.hr_wx_hr_chat.msg_type</code>. 信息类型,暂定html、image、qrcode、button
     */
     ...
     */
    @Override
    public HrWxHrChatRecord values(Integer value1, Integer value2, String value3, Integer value4, Byte value5, Byte value6, Timestamp value7, Byte value8, String value9, String value10, String value11) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public HrWxHrChatRecord(Integer id, Integer chatlistId, String content, Integer pid, Byte speaker, Byte status, Timestamp createTime, Byte origin, String msgType, String picUrl, String btnContent) {
        super(HrWxHrChat.HR_WX_HR_CHAT);
