...
public class HrWxHrChatRecord extends UpdatableRecordImpl<HrWxHrChatRecord> implements Record14<Integer, Integer, String, Integer, Byte, Byte, Timestamp, Byte, String, String, String, String, String, Integer> {

    private static final long serialVersionUID = -647735337;
    ...
    /**
     * Setter for <code>hrdb.hr_wx_hr_chat.speaker</code>. 聊天的发起人，0：求职者，1：HR回复,  2：MoBot自动回复
     */
    ...
    /**
     * Getter for <code>hrdb.hr_wx_hr_chat.speaker</code>. 聊天的发起人，0：求职者，1：HR回复,  2：MoBot自动回复
     */
    ...
    /**
     * Setter for <code>hrdb.hr_wx_hr_chat.status</code>. 问题状态，0：正常聊天内容，1：等待HR回复，2:HR已回复
     */
    ...
    /**
     * Getter for <code>hrdb.hr_wx_hr_chat.status</code>. 问题状态，0：正常聊天内容，1：等待HR回复，2:HR已回复
     */
    ...
    /**
     * Setter for <code>hrdb.hr_wx_hr_chat.compound_content</code>. 消息类型对应的json数据内容
     */
    ...
    /**
     * Getter for <code>hrdb.hr_wx_hr_chat.compound_content</code>. 消息类型对应的json数据内容
     */
    ...
    /**
     * Setter for <code>hrdb.hr_wx_hr_chat.hr_reply_question_chat_id</code>. HR回复问题对应的聊天内容ID，hrdb.hr_wx_hr_chat.id
     */
    public void setHrReplyQuestionChatId(Integer value) {
        set(13, value);
    }

    /**
     * Getter for <code>hrdb.hr_wx_hr_chat.hr_reply_question_chat_id</code>. HR回复问题对应的聊天内容ID，hrdb.hr_wx_hr_chat.id
     */
     ...
     */
    @Override
    public Row14<Integer, Integer, String, Integer, Byte, Byte, Timestamp, Byte, String, String, String, String, String, Integer> fieldsRow() {
     ...
     */
    @Override
    public Row14<Integer, Integer, String, Integer, Byte, Byte, Timestamp, Byte, String, String, String, String, String, Integer> valuesRow() {
    ...
    public Field<Integer> field14() {
        return HrWxHrChat.HR_WX_HR_CHAT.HR_REPLY_QUESTION_CHAT_ID;
    }
    ...
    public Integer value14() {
        return getHrReplyQuestionChatId();
    }
     ...
     */
    @Override
    public HrWxHrChatRecord value14(Integer value) {
        setHrReplyQuestionChatId(value);
        return this;
    }
     ...
     */
    @Override
    public HrWxHrChatRecord values(Integer value1, Integer value2, String value3, Integer value4, Byte value5, Byte value6, Timestamp value7, Byte value8, String value9, String value10, String value11, String value12, String value13, Integer value14) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public HrWxHrChatRecord(Integer id, Integer chatlistId, String content, Integer pid, Byte speaker, Byte status, Timestamp createTime, Byte origin, String msgType, String picUrl, String btnContent, String compoundContent, String stats, Integer hrReplyQuestionChatId) {
        super(HrWxHrChat.HR_WX_HR_CHAT);
