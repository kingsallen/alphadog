...
public class ProfileEducation extends TableImpl<ProfileEducationRecord> {
	...
	private static final long serialVersionUID = -18097078;
	 ...
	 */
	public final TableField<ProfileEducationRecord, Integer> PROFILE_ID = createField("profile_id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaulted(true), this, "profile.id");
	 ...
	 */
	public final TableField<ProfileEducationRecord, Byte> DEGREE = createField("degree", org.jooq.impl.SQLDataType.TINYINT.nullable(false).defaulted(true), this, "学历 0:未选择 1: 初中及以下, 2:中专, 3:高中, 4: 大专, 5: 本科, 6: 硕士, 7: 博士, 8:博士以上, 9:其他");
	 ...
	 */
	public final TableField<ProfileEducationRecord, Byte> IS_FULL = createField("is_full", org.jooq.impl.SQLDataType.TINYINT.nullable(false).defaulted(true), this, "是否全日制 0:没填写, 1:是, 2:否");

	/**
	 * The column <code>profiledb.profile_education.is_unified</code>. 是否统招 0:没填写, 1:是, 2:否
	 */
	public final TableField<ProfileEducationRecord, Byte> IS_UNIFIED = createField("is_unified", org.jooq.impl.SQLDataType.TINYINT.nullable(false).defaulted(true), this, "是否统招 0:没填写, 1:是, 2:否");

	/**
	 * The column <code>profiledb.profile_education.is_study_abroad</code>. 是否海外学习经历 0:没填写, 1:是, 2:否
	 */
	public final TableField<ProfileEducationRecord, Byte> IS_STUDY_ABROAD = createField("is_study_abroad", org.jooq.impl.SQLDataType.TINYINT.nullable(false).defaulted(true), this, "是否海外学习经历 0:没填写, 1:是, 2:否");
