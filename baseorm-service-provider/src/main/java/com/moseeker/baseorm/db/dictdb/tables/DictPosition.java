...
public class DictPosition extends TableImpl<DictPositionRecord> {
    ...
    private static final long serialVersionUID = -1343573979;
     ...
     */
    public final TableField<DictPositionRecord, Integer> CODE = createField("code", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("000000", org.jooq.impl.SQLDataType.INTEGER)), this, "字典code");

    /**
     * The column <code>dictdb.dict_position.name</code>. 字典name
     */
    public final TableField<DictPositionRecord, String> NAME = createField("name", org.jooq.impl.SQLDataType.VARCHAR.length(128).nullable(false).defaultValue(org.jooq.impl.DSL.field("", org.jooq.impl.SQLDataType.VARCHAR)), this, "字典name");

    /**
     * The column <code>dictdb.dict_position.parent</code>. 父编码
     */
    public final TableField<DictPositionRecord, Integer> PARENT = createField("parent", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("000000", org.jooq.impl.SQLDataType.INTEGER)), this, "父编码");
