...
public class HrWxNewsReply extends TableImpl<HrWxNewsReplyRecord> {
    ...
    private static final long serialVersionUID = -1420848964;
     ...
     */
    public final TableField<HrWxNewsReplyRecord, Integer> RID = createField("rid", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "");

    /**
     * The column <code>hrdb.hr_wx_news_reply.parentid</code>.
     */
    public final TableField<HrWxNewsReplyRecord, Integer> PARENTID = createField("parentid", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "");
