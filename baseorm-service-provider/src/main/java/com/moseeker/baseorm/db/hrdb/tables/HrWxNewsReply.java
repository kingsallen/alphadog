...
public class HrWxNewsReply extends TableImpl<HrWxNewsReplyRecord> {
    ...
    private static final long serialVersionUID = 320573818;
     ...
     */
    public final TableField<HrWxNewsReplyRecord, UInteger> RID = createField("rid", org.jooq.impl.SQLDataType.INTEGERUNSIGNED.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGERUNSIGNED)), this, "");

    /**
     * The column <code>hrdb.hr_wx_news_reply.parentid</code>.
     */
    public final TableField<HrWxNewsReplyRecord, UInteger> PARENTID = createField("parentid", org.jooq.impl.SQLDataType.INTEGERUNSIGNED.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGERUNSIGNED)), this, "");

    /**
     * The column <code>hrdb.hr_wx_news_reply.title</code>.
     */
    public final TableField<HrWxNewsReplyRecord, String> TITLE = createField("title", org.jooq.impl.SQLDataType.VARCHAR.length(150).nullable(false).defaultValue(org.jooq.impl.DSL.field("", org.jooq.impl.SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>hrdb.hr_wx_news_reply.description</code>.
     */
    public final TableField<HrWxNewsReplyRecord, String> DESCRIPTION = createField("description", org.jooq.impl.SQLDataType.VARCHAR.length(255).nullable(false).defaultValue(org.jooq.impl.DSL.field("", org.jooq.impl.SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>hrdb.hr_wx_news_reply.thumb</code>.
     */
    public final TableField<HrWxNewsReplyRecord, String> THUMB = createField("thumb", org.jooq.impl.SQLDataType.VARCHAR.length(128).nullable(false).defaultValue(org.jooq.impl.DSL.field("", org.jooq.impl.SQLDataType.VARCHAR)), this, "");
     ...
     */
    public final TableField<HrWxNewsReplyRecord, String> URL = createField("url", org.jooq.impl.SQLDataType.VARCHAR.length(255).nullable(false).defaultValue(org.jooq.impl.DSL.field("", org.jooq.impl.SQLDataType.VARCHAR)), this, "");
