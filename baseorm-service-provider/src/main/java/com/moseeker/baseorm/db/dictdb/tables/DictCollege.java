...
public class DictCollege extends TableImpl<DictCollegeRecord> {
    ...
    private static final long serialVersionUID = 1853988938;
    ...
    /**
     * The column <code>dictdb.dict_college.country_code</code>. dict_country.id
     */
    public final TableField<DictCollegeRecord, Integer> COUNTRY_CODE = createField("country_code", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.inline("0000086", org.jooq.impl.SQLDataType.INTEGER)), this, "dict_country.id");
