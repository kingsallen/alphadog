...
public class ConfigSysTemplateMessageLibrary extends TableImpl<ConfigSysTemplateMessageLibraryRecord> {
    ...
    private static final long serialVersionUID = 1785638030;
     ...
     */
    public final TableField<ConfigSysTemplateMessageLibraryRecord, Byte> TYPE = createField("type", org.jooq.impl.SQLDataType.TINYINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.TINYINT)), this, "模板类别 0:微信 1:邮件 2:短信 3:申请模板 4:其他");

    /**
     * The column <code>configdb.config_sys_template_message_library.template_id_short</code>. 模板库中模板的编号
     */
    public final TableField<ConfigSysTemplateMessageLibraryRecord, String> TEMPLATE_ID_SHORT = createField("template_id_short", org.jooq.impl.SQLDataType.VARCHAR.length(50).nullable(false).defaultValue(org.jooq.impl.DSL.field("", org.jooq.impl.SQLDataType.VARCHAR)), this, "模板库中模板的编号");
