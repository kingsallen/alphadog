...
public class HrHbScratchCard extends TableImpl<HrHbScratchCardRecord> {
    ...
    private static final long serialVersionUID = 1573421289;
     ...
     */
    public final TableField<HrHbScratchCardRecord, Integer> WECHAT_ID = createField("wechat_id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "");
     ...
     */
    public final TableField<HrHbScratchCardRecord, Integer> STATUS = createField("status", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "状态: 0：未拆开 1：已拆开");

    /**
     * The column <code>hrdb.hr_hb_scratch_card.amount</code>. 红包金额： 0.00 表示不发红包
     */
    public final TableField<HrHbScratchCardRecord, BigDecimal> AMOUNT = createField("amount", org.jooq.impl.SQLDataType.DECIMAL.precision(4, 2).nullable(false).defaultValue(org.jooq.impl.DSL.field("0.00", org.jooq.impl.SQLDataType.DECIMAL)), this, "红包金额： 0.00 表示不发红包");

    /**
     * The column <code>hrdb.hr_hb_scratch_card.hb_config_id</code>.
     */
    public final TableField<HrHbScratchCardRecord, Integer> HB_CONFIG_ID = createField("hb_config_id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "");

    /**
     * The column <code>hrdb.hr_hb_scratch_card.bagging_openid</code>. 聚合号的 openid
     */
    public final TableField<HrHbScratchCardRecord, String> BAGGING_OPENID = createField("bagging_openid", org.jooq.impl.SQLDataType.VARCHAR.length(512).nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.VARCHAR)), this, "聚合号的 openid");

    /**
     * The column <code>hrdb.hr_hb_scratch_card.create_time</code>.
     */
    public final TableField<HrHbScratchCardRecord, Timestamp> CREATE_TIME = createField("create_time", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "");

    /**
     * The column <code>hrdb.hr_hb_scratch_card.hb_item_id</code>.
     */
    public final TableField<HrHbScratchCardRecord, Integer> HB_ITEM_ID = createField("hb_item_id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "");

    /**
     * The column <code>hrdb.hr_hb_scratch_card.tips</code>. 是否是小费 0:不是，1:是
     */
    public final TableField<HrHbScratchCardRecord, Byte> TIPS = createField("tips", org.jooq.impl.SQLDataType.TINYINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.TINYINT)), this, "是否是小费 0:不是，1:是");
