...
public class DictIndustryRecord extends UpdatableRecordImpl<DictIndustryRecord> implements Record3<Integer, String, DictIndustryTypeRecord> {

    private static final long serialVersionUID = 1397471855;
     ...
     */
    @Override
    public Row3<Integer, String, DictIndustryTypeRecord> fieldsRow() {
     ...
     */
    @Override
    public Row3<Integer, String, DictIndustryTypeRecord> valuesRow() {
     ...
     */
    @Override
    public DictIndustryRecord values(Integer value1, String value2, DictIndustryTypeRecord value3) {
        value1(value1);
        value2(value2);
        value3(value3);
        return this;
