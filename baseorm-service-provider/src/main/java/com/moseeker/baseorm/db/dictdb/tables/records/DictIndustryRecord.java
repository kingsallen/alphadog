...
public class DictIndustryRecord extends UpdatableRecordImpl<DictIndustryRecord> implements Record4<Integer, String, String, Integer> {

    private static final long serialVersionUID = 1476122843;
    ...
    /**
     * Setter for <code>dictdb.dict_industry.ename</code>.
     */
    ...
    /**
     * Getter for <code>dictdb.dict_industry.ename</code>.
     */
     ...
     */
    @Override
    public DictIndustryRecord value3(String value) {
        setEname(value);
        return this;
    }
     ...
     */
    @Override
    public DictIndustryRecord value4(Integer value) {
        setType(value);
        return this;
    }
     ...
     */
    @Override
    public DictIndustryRecord values(Integer value1, String value2, String value3, Integer value4) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public DictIndustryRecord(Integer code, String name, String ename, Integer type) {
        super(DictIndustry.DICT_INDUSTRY);
