...
public class LogSmsSendrecord extends TableImpl<LogSmsSendrecordRecord> {
     ...
     */
    public final TableField<LogSmsSendrecordRecord, Long> MOBILE = createField("mobile", org.jooq.impl.SQLDataType.BIGINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.BIGINT)), this, "");
