...
public class HrWxNoticeMessage extends TableImpl<HrWxNoticeMessageRecord> {
    ...
    private static final long serialVersionUID = 1217571982;
     ...
     */
    public final TableField<HrWxNoticeMessageRecord, Integer> WECHAT_ID = createField("wechat_id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("10", org.jooq.impl.SQLDataType.INTEGER)), this, "所属公众号");
