...
public class RedpacketActivityPositionRecord extends UpdatableRecordImpl<RedpacketActivityPositionRecord> implements Record8<Integer, Integer, Integer, Integer, Integer, Byte, Timestamp, Timestamp> {

    private static final long serialVersionUID = 1969542530;
     ...
     */
    @Override
    public RedpacketActivityPositionRecord values(Integer value1, Integer value2, Integer value3, Integer value4, Integer value5, Byte value6, Timestamp value7, Timestamp value8) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public RedpacketActivityPositionRecord(Integer id, Integer activityId, Integer positionId, Integer totalAmount, Integer leftAmount, Byte enable, Timestamp createTime, Timestamp updateTime) {
        super(RedpacketActivityPosition.REDPACKET_ACTIVITY_POSITION);
