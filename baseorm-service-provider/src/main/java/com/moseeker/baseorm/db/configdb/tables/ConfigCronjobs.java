...
public class ConfigCronjobs extends TableImpl<ConfigCronjobsRecord> {
    ...
    private static final long serialVersionUID = 178683404;
     ...
     */
    public final TableField<ConfigCronjobsRecord, Integer> CHECK_DELAY = createField("check_delay", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("45", org.jooq.impl.SQLDataType.INTEGER)), this, "job开始几分钟后开始检查结果");
