...
public class UserProfileJobapply extends TableImpl<UserProfileJobapplyRecord> {
     ...
     */
    public final TableField<UserProfileJobapplyRecord, Integer> 用户ID = createField("用户ID", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "主key");

    /**
     * The column <code>jobdb.user_profile_jobapply.同上1</code>. sys_user.id, 用户ID
     */
    public final TableField<UserProfileJobapplyRecord, Integer> 同上1 = createField("同上1", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "sys_user.id, 用户ID");

    /**
     * The column <code>jobdb.user_profile_jobapply.同上2</code>. 用户ID
     */
    public final TableField<UserProfileJobapplyRecord, Integer> 同上2 = createField("同上2", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "用户ID");

    /**
     * The column <code>jobdb.user_profile_jobapply.投递职位jobnumer</code>. 职位编号
     */
    public final TableField<UserProfileJobapplyRecord, String> 投递职位JOBNUMER = createField("投递职位jobnumer", org.jooq.impl.SQLDataType.VARCHAR.length(40).nullable(false).defaultValue(org.jooq.impl.DSL.field("", org.jooq.impl.SQLDataType.VARCHAR)), this, "职位编号");
     ...
     */
    public final TableField<UserProfileJobapplyRecord, Integer> ATS来源是9 = createField("ats来源是9", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "职位来源 0：Moseeker");

    /**
     * The column <code>jobdb.user_profile_jobapply.姓名</code>. 姓名
     */
    public final TableField<UserProfileJobapplyRecord, String> 姓名 = createField("姓名", org.jooq.impl.SQLDataType.VARCHAR.length(100).nullable(false).defaultValue(org.jooq.impl.DSL.field("", org.jooq.impl.SQLDataType.VARCHAR)), this, "姓名");
