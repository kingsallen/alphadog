...
public class HistoryJobApplicationStatusBeisen implements Serializable {

    private static final long serialVersionUID = -2091868012;
    ...
    public HistoryJobApplicationStatusBeisen(HistoryJobApplicationStatusBeisen value) {
        this.id = value.id;
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("HistoryJobApplicationStatusBeisen (");
