...
public class WordpressUsers extends TableImpl<WordpressUsersRecord> {
    ...
    private static final long serialVersionUID = 1092749898;
     ...
     */
    public final TableField<WordpressUsersRecord, String> USER_LOGIN = createField("user_login", org.jooq.impl.SQLDataType.VARCHAR.length(60).nullable(false).defaultValue(org.jooq.impl.DSL.field("", org.jooq.impl.SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>wordpressdb.wordpress_users.user_pass</code>.
     */
    public final TableField<WordpressUsersRecord, String> USER_PASS = createField("user_pass", org.jooq.impl.SQLDataType.VARCHAR.length(255).nullable(false).defaultValue(org.jooq.impl.DSL.field("", org.jooq.impl.SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>wordpressdb.wordpress_users.user_nicename</code>.
     */
    public final TableField<WordpressUsersRecord, String> USER_NICENAME = createField("user_nicename", org.jooq.impl.SQLDataType.VARCHAR.length(50).nullable(false).defaultValue(org.jooq.impl.DSL.field("", org.jooq.impl.SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>wordpressdb.wordpress_users.user_email</code>.
     */
    public final TableField<WordpressUsersRecord, String> USER_EMAIL = createField("user_email", org.jooq.impl.SQLDataType.VARCHAR.length(100).nullable(false).defaultValue(org.jooq.impl.DSL.field("", org.jooq.impl.SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>wordpressdb.wordpress_users.user_url</code>.
     */
    public final TableField<WordpressUsersRecord, String> USER_URL = createField("user_url", org.jooq.impl.SQLDataType.VARCHAR.length(100).nullable(false).defaultValue(org.jooq.impl.DSL.field("", org.jooq.impl.SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>wordpressdb.wordpress_users.user_registered</code>.
     */
    public final TableField<WordpressUsersRecord, Timestamp> USER_REGISTERED = createField("user_registered", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.field("0000-00-00 00:00:00", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "");

    /**
     * The column <code>wordpressdb.wordpress_users.user_activation_key</code>.
     */
    public final TableField<WordpressUsersRecord, String> USER_ACTIVATION_KEY = createField("user_activation_key", org.jooq.impl.SQLDataType.VARCHAR.length(255).nullable(false).defaultValue(org.jooq.impl.DSL.field("", org.jooq.impl.SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>wordpressdb.wordpress_users.user_status</code>.
     */
    public final TableField<WordpressUsersRecord, Integer> USER_STATUS = createField("user_status", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "");

    /**
     * The column <code>wordpressdb.wordpress_users.display_name</code>.
     */
    public final TableField<WordpressUsersRecord, String> DISPLAY_NAME = createField("display_name", org.jooq.impl.SQLDataType.VARCHAR.length(250).nullable(false).defaultValue(org.jooq.impl.DSL.field("", org.jooq.impl.SQLDataType.VARCHAR)), this, "");
