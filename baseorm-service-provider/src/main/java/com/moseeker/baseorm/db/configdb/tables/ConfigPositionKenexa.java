...
public class ConfigPositionKenexa extends TableImpl<ConfigPositionKenexaRecord> {
    ...
    private static final long serialVersionUID = -1971551231;
     ...
     */
    public final TableField<ConfigPositionKenexaRecord, Integer> SOURCE_ID = createField("source_id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "ATS来源ID");

    /**
     * The column <code>configdb.config_position_kenexa.position_column</code>. 职位表字段名,  _ 暂未设置
     */
    public final TableField<ConfigPositionKenexaRecord, String> POSITION_COLUMN = createField("position_column", org.jooq.impl.SQLDataType.VARCHAR.length(32).nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.VARCHAR)), this, "职位表字段名,  _ 暂未设置");

    /**
     * The column <code>configdb.config_position_kenexa.kenexa_job_id</code>. kenexa对应的JOB字段ID
     */
    public final TableField<ConfigPositionKenexaRecord, String> KENEXA_JOB_ID = createField("kenexa_job_id", org.jooq.impl.SQLDataType.VARCHAR.length(20).nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.VARCHAR)), this, "kenexa对应的JOB字段ID");

    /**
     * The column <code>configdb.config_position_kenexa.disable</code>. 是否有效，0：有效，1：无效
     */
    public final TableField<ConfigPositionKenexaRecord, Integer> DISABLE = createField("disable", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "是否有效，0：有效，1：无效");

    /**
     * The column <code>configdb.config_position_kenexa.create_time</code>. 创建时间
     */
    public final TableField<ConfigPositionKenexaRecord, Timestamp> CREATE_TIME = createField("create_time", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "创建时间");

    /**
     * The column <code>configdb.config_position_kenexa.update_time</code>. 修改时间
     */
    public final TableField<ConfigPositionKenexaRecord, Timestamp> UPDATE_TIME = createField("update_time", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "修改时间");

    /**
     * The column <code>configdb.config_position_kenexa.app_tpl_id</code>. 模板Id
     */
    public final TableField<ConfigPositionKenexaRecord, Integer> APP_TPL_ID = createField("app_tpl_id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "模板Id");
