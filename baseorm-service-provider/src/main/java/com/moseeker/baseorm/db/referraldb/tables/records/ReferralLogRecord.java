...
public class ReferralLogRecord extends UpdatableRecordImpl<ReferralLogRecord> implements Record11<Integer, Integer, Integer, Integer, Integer, Timestamp, Byte, Timestamp, Timestamp, Timestamp, Integer> {

    private static final long serialVersionUID = -572129208;
     ...
     */
    @Override
    public Row11<Integer, Integer, Integer, Integer, Integer, Timestamp, Byte, Timestamp, Timestamp, Timestamp, Integer> fieldsRow() {
     ...
     */
    @Override
    public Row11<Integer, Integer, Integer, Integer, Integer, Timestamp, Byte, Timestamp, Timestamp, Timestamp, Integer> valuesRow() {
     ...
     */
    @Override
    public ReferralLogRecord values(Integer value1, Integer value2, Integer value3, Integer value4, Integer value5, Timestamp value6, Byte value7, Timestamp value8, Timestamp value9, Timestamp value10, Integer value11) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public ReferralLogRecord(Integer id, Integer employeeId, Integer referenceId, Integer positionId, Integer type, Timestamp referralTime, Byte claim, Timestamp claimTime, Timestamp createTime, Timestamp updateTime, Integer oldReferenceId) {
        super(ReferralLog.REFERRAL_LOG);
