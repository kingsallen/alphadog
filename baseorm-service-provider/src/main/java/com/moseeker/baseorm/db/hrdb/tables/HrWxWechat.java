...
public class HrWxWechat extends TableImpl<HrWxWechatRecord> {
	...
	private static final long serialVersionUID = 1941385195;
	 ...
	 */
	public final TableField<HrWxWechatRecord, Integer> SHOW_NEW_JD = createField("show_new_jd", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaulted(true), this, "显示新JD样式, 0:不启用, 1:启用");
