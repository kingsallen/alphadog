...
public class CandidatePosition extends TableImpl<CandidatePositionRecord> {
    ...
    private static final long serialVersionUID = 686235439;
     ...
     */
    public final TableField<CandidatePositionRecord, Integer> POSITION_ID = createField("position_id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "hr_position.id");

    /**
     * The column <code>candidatedb.candidate_position.update_time</code>. 修改时间
     */
    public final TableField<CandidatePositionRecord, Timestamp> UPDATE_TIME = createField("update_time", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "修改时间");

    /**
     * The column <code>candidatedb.candidate_position.wxuser_id</code>. user_wx_user.id，表示候选人代表的微信账号。已经废弃。微信账号由C端账号代替，请参考user_id
     */
    public final TableField<CandidatePositionRecord, Integer> WXUSER_ID = createField("wxuser_id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "user_wx_user.id，表示候选人代表的微信账号。已经废弃。微信账号由C端账号代替，请参考user_id");

    /**
     * The column <code>candidatedb.candidate_position.is_interested</code>. 是否感兴趣
     */
    public final TableField<CandidatePositionRecord, Byte> IS_INTERESTED = createField("is_interested", org.jooq.impl.SQLDataType.TINYINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.TINYINT)), this, "是否感兴趣");

    /**
     * The column <code>candidatedb.candidate_position.candidate_company_id</code>. candidate_company.id
     */
    public final TableField<CandidatePositionRecord, Integer> CANDIDATE_COMPANY_ID = createField("candidate_company_id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "candidate_company.id");

    /**
     * The column <code>candidatedb.candidate_position.view_number</code>. 查看次数
     */
    public final TableField<CandidatePositionRecord, Integer> VIEW_NUMBER = createField("view_number", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "查看次数");

    /**
     * The column <code>candidatedb.candidate_position.shared_from_employee</code>.
     */
    public final TableField<CandidatePositionRecord, Byte> SHARED_FROM_EMPLOYEE = createField("shared_from_employee", org.jooq.impl.SQLDataType.TINYINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.TINYINT)), this, "");

    /**
     * The column <code>candidatedb.candidate_position.user_id</code>. userdb.user_user.id 候选人代表的C端用户
     */
    public final TableField<CandidatePositionRecord, Integer> USER_ID = createField("user_id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "userdb.user_user.id 候选人代表的C端用户");
