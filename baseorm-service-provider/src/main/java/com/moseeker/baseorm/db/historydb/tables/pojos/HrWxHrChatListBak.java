...
public class HrWxHrChatListBak implements Serializable {

    private static final long serialVersionUID = 1137933183;
    ...
    public HrWxHrChatListBak(HrWxHrChatListBak value) {
        this.id = value.id;
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("HrWxHrChatListBak (");
