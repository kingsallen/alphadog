...
public class LogSmsSendrecordRecord extends UpdatableRecordImpl<LogSmsSendrecordRecord> implements Record6<UInteger, Byte, Long, String, String, Timestamp> {
    ...
    private static final long serialVersionUID = 865410128;
    ...
    /**
     * Setter for <code>logdb.log_sms_sendrecord.sys</code>. 来自系统，0:未知 1:platform 2:qx 3:hr 4:官网 5:基础服务 9:script
     */
    ...
    /**
     * Getter for <code>logdb.log_sms_sendrecord.sys</code>. 来自系统，0:未知 1:platform 2:qx 3:hr 4:官网 5:基础服务 9:script
     */
    public Byte getSys() {
        return (Byte) get(1);
    }
     ...
     */
    @Override
    public LogSmsSendrecordRecord value1(UInteger value) {
        setId(value);
        return this;
    }
     ...
     */
    @Override
    public LogSmsSendrecordRecord values(UInteger value1, Byte value2, Long value3, String value4, String value5, Timestamp value6) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public LogSmsSendrecordRecord(UInteger id, Byte sys, Long mobile, String msg, String ip, Timestamp createTime) {
        super(LogSmsSendrecord.LOG_SMS_SENDRECORD);
