...
public class CandidatePositionRecord extends UpdatableRecordImpl<CandidatePositionRecord> implements Record9<Integer, Timestamp, Integer, Byte, Integer, Integer, Byte, Integer, Byte> {

    private static final long serialVersionUID = -858836396;
    ...
    /**
     * Setter for <code>candidatedb.candidate_position.type</code>.
     */
    ...
    /**
     * Getter for <code>candidatedb.candidate_position.type</code>.
     */
    public Byte getType() {
        return (Byte) get(8);
    }
     ...
     */
    @Override
    public Row9<Integer, Timestamp, Integer, Byte, Integer, Integer, Byte, Integer, Byte> fieldsRow() {
     ...
     */
    @Override
    public Row9<Integer, Timestamp, Integer, Byte, Integer, Integer, Byte, Integer, Byte> valuesRow() {
    ...
    public Field<Byte> field9() {
        return CandidatePosition.CANDIDATE_POSITION.TYPE;
    }
     ...
     */
    @Override
    public CandidatePositionRecord value9(Byte value) {
        setType(value);
        return this;
    }
     ...
     */
    @Override
    public CandidatePositionRecord values(Integer value1, Timestamp value2, Integer value3, Byte value4, Integer value5, Integer value6, Byte value7, Integer value8, Byte value9) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public CandidatePositionRecord(Integer positionId, Timestamp updateTime, Integer wxuserId, Byte isInterested, Integer candidateCompanyId, Integer viewNumber, Byte sharedFromEmployee, Integer userId, Byte type) {
        super(CandidatePosition.CANDIDATE_POSITION);
