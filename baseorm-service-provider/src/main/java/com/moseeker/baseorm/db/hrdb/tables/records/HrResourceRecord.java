...
public class HrResourceRecord extends UpdatableRecordImpl<HrResourceRecord> implements Record7<Integer, String, Integer, String, Integer, String, Integer> {

	private static final long serialVersionUID = -1953329595;
	 ...
	 */
	@Override
	public HrResourceRecord values(Integer value1, String value2, Integer value3, String value4, Integer value5, String value6, Integer value7) {
		value1(value1);
		value2(value2);
		value3(value3);
		value4(value4);
	 ...
	 */
	public HrResourceRecord(Integer id, String resUrl, Integer resType, String remark, Integer companyId, String title, Integer disable) {
		super(HrResource.HR_RESOURCE);
