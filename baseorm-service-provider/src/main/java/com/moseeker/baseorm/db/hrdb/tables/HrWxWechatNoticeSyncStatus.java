...
public class HrWxWechatNoticeSyncStatus extends TableImpl<HrWxWechatNoticeSyncStatusRecord> {
    ...
    private static final long serialVersionUID = 1798640031;
     ...
     */
    public final TableField<HrWxWechatNoticeSyncStatusRecord, Integer> WECHAT_ID = createField("wechat_id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("10", org.jooq.impl.SQLDataType.INTEGER)), this, "所属公众号");
