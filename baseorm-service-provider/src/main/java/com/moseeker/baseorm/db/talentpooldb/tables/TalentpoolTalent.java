...
public class TalentpoolTalent extends TableImpl<TalentpoolTalentRecord> {
    ...
    private static final long serialVersionUID = -775881882;
    ...
    /**
     * The column <code>talentpooldb.talentpool_talent.id</code>. 主键
     */
    public final TableField<TalentpoolTalentRecord, Integer> ID = createField("id", org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "主键");
     ...
     */
    @Override
    public Identity<TalentpoolTalentRecord, Integer> getIdentity() {
        return Keys.IDENTITY_TALENTPOOL_TALENT;
    }
    ...
    public List<UniqueKey<TalentpoolTalentRecord>> getKeys() {
        return Arrays.<UniqueKey<TalentpoolTalentRecord>>asList(Keys.KEY_TALENTPOOL_TALENT_PRIMARY, Keys.KEY_TALENTPOOL_TALENT_TALENTPOOL_TAG_USER_ID_COMPANY_ID);
    }
