...
public class JobPcRecommendPositionsModule extends TableImpl<JobPcRecommendPositionsModuleRecord> {
    ...
    private static final long serialVersionUID = 1365128217;
     ...
     */
    public final TableField<JobPcRecommendPositionsModuleRecord, String> NAME = createField("name", org.jooq.impl.SQLDataType.VARCHAR.length(50).defaultValue(org.jooq.impl.DSL.field("", org.jooq.impl.SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>jobdb.job_pc_recommend_positions_module.status</code>. 是否可用：1：可用，0：不可用
     */
    public final TableField<JobPcRecommendPositionsModuleRecord, Byte> STATUS = createField("status", org.jooq.impl.SQLDataType.TINYINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("1", org.jooq.impl.SQLDataType.TINYINT)), this, "是否可用：1：可用，0：不可用");

    /**
     * The column <code>jobdb.job_pc_recommend_positions_module.create_time</code>. 创建时间
     */
    public final TableField<JobPcRecommendPositionsModuleRecord, Timestamp> CREATE_TIME = createField("create_time", org.jooq.impl.SQLDataType.TIMESTAMP.defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "创建时间");

    /**
     * The column <code>jobdb.job_pc_recommend_positions_module.update_time</code>. 更新时间
     */
    public final TableField<JobPcRecommendPositionsModuleRecord, Timestamp> UPDATE_TIME = createField("update_time", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "更新时间");
