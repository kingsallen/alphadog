...
public class JobPcRecommendPositionsModule extends TableImpl<JobPcRecommendPositionsModuleRecord> {
    ...
    private static final long serialVersionUID = -1175685407;
     ...
     */
    public final TableField<JobPcRecommendPositionsModuleRecord, Timestamp> CREATE_TIME = createField("create_time", org.jooq.impl.SQLDataType.TIMESTAMP, this, "创建时间");

    /**
     * The column <code>jobdb.job_pc_recommend_positions_module.status</code>.
     */
    public final TableField<JobPcRecommendPositionsModuleRecord, Byte> STATUS = createField("status", org.jooq.impl.SQLDataType.TINYINT, this, "");
