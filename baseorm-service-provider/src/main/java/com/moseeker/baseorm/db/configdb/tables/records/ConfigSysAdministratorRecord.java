...
public class ConfigSysAdministratorRecord extends UpdatableRecordImpl<ConfigSysAdministratorRecord> implements Record10<UInteger, String, String, String, String, Integer, Integer, Timestamp, Timestamp, Integer> {

    private static final long serialVersionUID = -1266179973;
     ...
     */
    @Override
    public Row10<UInteger, String, String, String, String, Integer, Integer, Timestamp, Timestamp, Integer> fieldsRow() {
     ...
     */
    @Override
    public Row10<UInteger, String, String, String, String, Integer, Integer, Timestamp, Timestamp, Integer> valuesRow() {
     ...
     */
    @Override
    public ConfigSysAdministratorRecord values(UInteger value1, String value2, String value3, String value4, String value5, Integer value6, Integer value7, Timestamp value8, Timestamp value9, Integer value10) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public ConfigSysAdministratorRecord(UInteger id, String name, String email, String mobile, String password, Integer isDisable, Integer loginCount, Timestamp lastLoginTime, Timestamp createTime, Integer authGroupId) {
        super(ConfigSysAdministrator.CONFIG_SYS_ADMINISTRATOR);
