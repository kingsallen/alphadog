...
public class UserReferralRecordRecord extends UpdatableRecordImpl<UserReferralRecordRecord> implements Record6<Integer, Integer, Integer, Integer, Timestamp, Timestamp> {
    ...
    private static final long serialVersionUID = 362637812;
     ...
     */
    @Override
    public UserReferralRecordRecord values(Integer value1, Integer value2, Integer value3, Integer value4, Timestamp value5, Timestamp value6) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
