...
public class TalentpoolCompanyTag extends TableImpl<TalentpoolCompanyTagRecord> {
     ...
     */
    public final TableField<TalentpoolCompanyTagRecord, String> KEYWORDS = createField("keywords", org.jooq.impl.SQLDataType.VARCHAR.length(255).nullable(false).defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.VARCHAR)), this, "关键词，以;分割，最多10个");
