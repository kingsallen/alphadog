...
public class ProfileAwards extends TableImpl<ProfileAwardsRecord> {
    ...
    private static final long serialVersionUID = 1631952913;
     ...
     */
    public final TableField<ProfileAwardsRecord, Integer> PROFILE_ID = createField("profile_id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "profile.id");
     ...
     */
    public final TableField<ProfileAwardsRecord, String> NAME = createField("name", org.jooq.impl.SQLDataType.VARCHAR.length(256).nullable(false).defaultValue(org.jooq.impl.DSL.field("", org.jooq.impl.SQLDataType.VARCHAR)), this, "获得奖项名称");

    /**
     * The column <code>profiledb.profile_awards.award_winning_status</code>. 获奖身份
     */
    public final TableField<ProfileAwardsRecord, String> AWARD_WINNING_STATUS = createField("award_winning_status", org.jooq.impl.SQLDataType.VARCHAR.length(256).nullable(false).defaultValue(org.jooq.impl.DSL.field("", org.jooq.impl.SQLDataType.VARCHAR)), this, "获奖身份");

    /**
     * The column <code>profiledb.profile_awards.level</code>. 级别
     */
    public final TableField<ProfileAwardsRecord, String> LEVEL = createField("level", org.jooq.impl.SQLDataType.VARCHAR.length(256).nullable(false).defaultValue(org.jooq.impl.DSL.field("", org.jooq.impl.SQLDataType.VARCHAR)), this, "级别");

    /**
     * The column <code>profiledb.profile_awards.description</code>. 描述
     */
    public final TableField<ProfileAwardsRecord, String> DESCRIPTION = createField("description", org.jooq.impl.SQLDataType.VARCHAR.length(1000).nullable(false).defaultValue(org.jooq.impl.DSL.field("", org.jooq.impl.SQLDataType.VARCHAR)), this, "描述");

    /**
     * The column <code>profiledb.profile_awards.create_time</code>. 创建时间
     */
    public final TableField<ProfileAwardsRecord, Timestamp> CREATE_TIME = createField("create_time", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "创建时间");

    /**
     * The column <code>profiledb.profile_awards.update_time</code>. 更新时间
     */
    public final TableField<ProfileAwardsRecord, Timestamp> UPDATE_TIME = createField("update_time", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "更新时间");
