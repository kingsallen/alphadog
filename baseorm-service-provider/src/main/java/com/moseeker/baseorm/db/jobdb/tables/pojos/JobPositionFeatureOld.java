...
public class JobPositionFeatureOld implements Serializable {

    private static final long serialVersionUID = -1253928562;
    ...
    public JobPositionFeatureOld(JobPositionFeatureOld value) {
        this.id = value.id;
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("JobPositionFeatureOld (");
