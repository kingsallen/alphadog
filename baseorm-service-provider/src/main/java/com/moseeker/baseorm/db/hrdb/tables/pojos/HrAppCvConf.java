...
public class HrAppCvConf implements Serializable {

    private static final long serialVersionUID = 1908647679;
    ...
    public HrAppCvConf(HrAppCvConf value) {
        this.id = value.id;
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("HrAppCvConf (");
