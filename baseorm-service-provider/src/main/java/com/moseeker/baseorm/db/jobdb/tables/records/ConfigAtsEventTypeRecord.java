...
public class ConfigAtsEventTypeRecord extends UpdatableRecordImpl<ConfigAtsEventTypeRecord> implements Record8<Integer, Byte, String, Byte, String, String, Timestamp, Timestamp> {
    ...
    private static final long serialVersionUID = 199133725;

    /**
     * Setter for <code>jobdb.config_ats_event_type.id</code>.
     */
    ...
    /**
     * Getter for <code>jobdb.config_ats_event_type.id</code>.
     */
    ...
    /**
     * Setter for <code>jobdb.config_ats_event_type.event_type</code>. 事件类型
     */
    ...
    /**
     * Getter for <code>jobdb.config_ats_event_type.event_type</code>. 事件类型
     */
    ...
    /**
     * Setter for <code>jobdb.config_ats_event_type.event_name</code>. 事件名称
     */
    ...
    /**
     * Getter for <code>jobdb.config_ats_event_type.event_name</code>. 事件名称
     */
    ...
    /**
     * Setter for <code>jobdb.config_ats_event_type.status_code</code>. 状态code
     */
    ...
    /**
     * Getter for <code>jobdb.config_ats_event_type.status_code</code>. 状态code
     */
    ...
    /**
     * Setter for <code>jobdb.config_ats_event_type.status_filter_text</code>. 状态显示文案（筛选）
     */
    ...
    /**
     * Getter for <code>jobdb.config_ats_event_type.status_filter_text</code>. 状态显示文案（筛选）
     */
    ...
    /**
     * Setter for <code>jobdb.config_ats_event_type.status_list_text</code>. 状态显示文案（列表）
     */
    ...
    /**
     * Getter for <code>jobdb.config_ats_event_type.status_list_text</code>. 状态显示文案（列表）
     */
    ...
    /**
     * Setter for <code>jobdb.config_ats_event_type.create_time</code>. 创建时间
     */
    ...
    /**
     * Getter for <code>jobdb.config_ats_event_type.create_time</code>. 创建时间
     */
    ...
    /**
     * Setter for <code>jobdb.config_ats_event_type.update_time</code>. 更新时间
     */
    ...
    /**
     * Getter for <code>jobdb.config_ats_event_type.update_time</code>. 更新时间
     */
