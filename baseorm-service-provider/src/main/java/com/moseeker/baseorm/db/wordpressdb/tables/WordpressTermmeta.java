...
public class WordpressTermmeta extends TableImpl<WordpressTermmetaRecord> {
	...
	private static final long serialVersionUID = -1409634502;
	 ...
	 */
	public final TableField<WordpressTermmetaRecord, ULong> META_ID = createField("meta_id", org.jooq.impl.SQLDataType.BIGINTUNSIGNED.nullable(false), this, "");

	/**
	 * The column <code>wordpressdb.wordpress_termmeta.term_id</code>.
	 */
	public final TableField<WordpressTermmetaRecord, ULong> TERM_ID = createField("term_id", org.jooq.impl.SQLDataType.BIGINTUNSIGNED.nullable(false).defaulted(true), this, "");
	 ...
	 */
	@Override
	public Identity<WordpressTermmetaRecord, ULong> getIdentity() {
