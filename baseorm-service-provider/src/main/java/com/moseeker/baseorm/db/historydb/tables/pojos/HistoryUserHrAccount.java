...
public class HistoryUserHrAccount implements Serializable {

    private static final long serialVersionUID = -1643319118;
    ...
    public HistoryUserHrAccount(HistoryUserHrAccount value) {
        this.id = value.id;
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("HistoryUserHrAccount (");
