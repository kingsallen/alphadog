...
public class HrThirdPartyPositionRecord extends UpdatableRecordImpl<HrThirdPartyPositionRecord> implements Record11<Integer, UInteger, String, Short, Short, Short, Timestamp, Timestamp, Timestamp, String, String> {

	private static final long serialVersionUID = 718680861;
	 ...
	 */
	@Override
	public Row11<Integer, UInteger, String, Short, Short, Short, Timestamp, Timestamp, Timestamp, String, String> fieldsRow() {
	 ...
	 */
	@Override
	public Row11<Integer, UInteger, String, Short, Short, Short, Timestamp, Timestamp, Timestamp, String, String> valuesRow() {
	 ...
	 */
	@Override
	public HrThirdPartyPositionRecord values(Integer value1, UInteger value2, String value3, Short value4, Short value5, Short value6, Timestamp value7, Timestamp value8, Timestamp value9, String value10, String value11) {
		value1(value1);
		value2(value2);
		value3(value3);
		value4(value4);
	 ...
	 */
	public HrThirdPartyPositionRecord(Integer id, UInteger positionId, String thirdPartPositionId, Short channel, Short isSynchronization, Short isRefresh, Timestamp syncTime, Timestamp refreshTime, Timestamp updateTime, String occupation, String address) {
		super(HrThirdPartyPosition.HR_THIRD_PARTY_POSITION);
