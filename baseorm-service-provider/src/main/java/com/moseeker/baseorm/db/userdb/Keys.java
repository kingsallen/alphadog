...
public class Keys {
	...
	private static class UniqueKeys0 extends AbstractKeys {
		public static final UniqueKey<UserBdUserRecord> KEY_USER_BD_USER_PRIMARY = createUniqueKey(UserBdUser.USER_BD_USER, UserBdUser.USER_BD_USER.ID);
		public static final UniqueKey<UserBdUserRecord> KEY_USER_BD_USER_UID = createUniqueKey(UserBdUser.USER_BD_USER, UserBdUser.USER_BD_USER.UID);
		public static final UniqueKey<UserCollectPositionRecord> KEY_USER_COLLECT_POSITION_PRIMARY = createUniqueKey(UserCollectPosition.USER_COLLECT_POSITION, UserCollectPosition.USER_COLLECT_POSITION.ID);
		...
		public static final UniqueKey<UserSearchConditionRecord> KEY_USER_SEARCH_CONDITION_PRIMARY = createUniqueKey(UserSearchCondition.USER_SEARCH_CONDITION, UserSearchCondition.USER_SEARCH_CONDITION.ID);
		...
		public static final UniqueKey<UserThirdpartyUserRecord> KEY_USER_THIRDPARTY_USER_PRIMARY = createUniqueKey(UserThirdpartyUser.USER_THIRDPARTY_USER, UserThirdpartyUser.USER_THIRDPARTY_USER.ID);
		public static final UniqueKey<UserThirdpartyUserRecord> KEY_USER_THIRDPARTY_USER_USER_ID = createUniqueKey(UserThirdpartyUser.USER_THIRDPARTY_USER, UserThirdpartyUser.USER_THIRDPARTY_USER.USER_ID, UserThirdpartyUser.USER_THIRDPARTY_USER.SOURCE_ID);
		...
		public static final UniqueKey<UserUserNameEmail1128Record> KEY_USER_USER_NAME_EMAIL1128_PRIMARY = createUniqueKey(UserUserNameEmail1128.USER_USER_NAME_EMAIL1128, UserUserNameEmail1128.USER_USER_NAME_EMAIL1128.ID);
		...
		public static final UniqueKey<UserViewedPositionRecord> KEY_USER_VIEWED_POSITION_PRIMARY = createUniqueKey(UserViewedPosition.USER_VIEWED_POSITION, UserViewedPosition.USER_VIEWED_POSITION.ID);
		public static final UniqueKey<UserViewedPositionRecord> KEY_USER_VIEWED_POSITION_USER_POSITION_UNIQUE = createUniqueKey(UserViewedPosition.USER_VIEWED_POSITION, UserViewedPosition.USER_VIEWED_POSITION.USER_ID, UserViewedPosition.USER_VIEWED_POSITION.POSITION_ID);
