...
public class LogEmployeeOperationLogRecord extends UpdatableRecordImpl<LogEmployeeOperationLogRecord> implements Record8<Integer, Integer, Byte, Byte, Byte, Integer, Integer, Timestamp> {
    ...
    private static final long serialVersionUID = -1293624939;
    ...
    /**
     * Setter for <code>logdb.log_employee_operation_log.type</code>. 入口类型  0：我是员工
     */
    ...
    /**
     * Getter for <code>logdb.log_employee_operation_log.type</code>. 入口类型  0：我是员工
     */
    public Byte getType() {
        return (Byte) get(2);
    }
    ...
    /**
     * Setter for <code>logdb.log_employee_operation_log.profile_id</code>. profile_profile id 建立成功的简历id,其他为0。
     */
    ...
    /**
     * Getter for <code>logdb.log_employee_operation_log.profile_id</code>. profile_profile id 建立成功的简历id,其他为0。
     */
