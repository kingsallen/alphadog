...
public class HrThirdPartyAccount extends TableImpl<HrThirdPartyAccountRecord> {
    ...
    private static final long serialVersionUID = -845442411;
     ...
     */
    public final TableField<HrThirdPartyAccountRecord, Short> BINDING = createField("binding", org.jooq.impl.SQLDataType.SMALLINT.defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.SMALLINT)), this, "0=未绑定,1=绑定");

    /**
     * The column <code>hrdb.hr_third_party_account.company_id</code>. hrdb.hr_company.id
     */
    public final TableField<HrThirdPartyAccountRecord, Integer> COMPANY_ID = createField("company_id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "hrdb.hr_company.id");

    /**
     * The column <code>hrdb.hr_third_party_account.remain_num</code>. 点数
     */
    public final TableField<HrThirdPartyAccountRecord, Integer> REMAIN_NUM = createField("remain_num", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "点数");
