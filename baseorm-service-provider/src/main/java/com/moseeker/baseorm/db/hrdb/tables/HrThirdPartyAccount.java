...
public class HrThirdPartyAccount extends TableImpl<HrThirdPartyAccountRecord> {
    ...
    private static final long serialVersionUID = 458965613;
    ...
    /**
     * The column <code>hrdb.hr_third_party_account.ext2</code>. 扩展字段，目前是由于猎聘登录时会返回token和usereid（用户在猎聘的id）两个字段，分别使用ext和ext2存储该两个字段
     */
    public final TableField<HrThirdPartyAccountRecord, String> EXT2 = createField("ext2", org.jooq.impl.SQLDataType.VARCHAR.length(100), this, "扩展字段，目前是由于猎聘登录时会返回token和usereid（用户在猎聘的id）两个字段，分别使用ext和ext2存储该两个字段");
