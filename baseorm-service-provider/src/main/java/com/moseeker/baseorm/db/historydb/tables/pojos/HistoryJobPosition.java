...
public class HistoryJobPosition implements Serializable {

    private static final long serialVersionUID = 1676654928;
    ...
    public HistoryJobPosition(HistoryJobPosition value) {
        this.id = value.id;
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("HistoryJobPosition (");
