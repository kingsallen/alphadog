...
public class ProfileLanguage extends TableImpl<ProfileLanguageRecord> {
    ...
    private static final long serialVersionUID = -99915893;
     ...
     */
    public final TableField<ProfileLanguageRecord, Integer> PROFILE_ID = createField("profile_id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "profile.id");

    /**
     * The column <code>profiledb.profile_language.name</code>. 语言
     */
    public final TableField<ProfileLanguageRecord, String> NAME = createField("name", org.jooq.impl.SQLDataType.VARCHAR.length(100).nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.VARCHAR)), this, "语言");

    /**
     * The column <code>profiledb.profile_language.level</code>. 掌握程度, dict_constant.parent_code:3108
     */
    public final TableField<ProfileLanguageRecord, Byte> LEVEL = createField("level", org.jooq.impl.SQLDataType.TINYINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.TINYINT)), this, "掌握程度, dict_constant.parent_code:3108");

    /**
     * The column <code>profiledb.profile_language.create_time</code>. 创建时间
     */
    public final TableField<ProfileLanguageRecord, Timestamp> CREATE_TIME = createField("create_time", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "创建时间");

    /**
     * The column <code>profiledb.profile_language.update_time</code>. 更新时间
     */
    public final TableField<ProfileLanguageRecord, Timestamp> UPDATE_TIME = createField("update_time", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "更新时间");
