...
public class JobPositionExtRecord extends UpdatableRecordImpl<JobPositionExtRecord> implements Record8<Integer, Integer, Timestamp, Timestamp, String, Integer, Integer, String> {

    private static final long serialVersionUID = 39652204;
     ...
     */
    @Override
    public Row8<Integer, Integer, Timestamp, Timestamp, String, Integer, Integer, String> fieldsRow() {
     ...
     */
    @Override
    public Row8<Integer, Integer, Timestamp, Timestamp, String, Integer, Integer, String> valuesRow() {
     ...
     */
    @Override
    public JobPositionExtRecord value5(String value) {
        setExtra(value);
        return this;
    }
     ...
     */
    @Override
    public JobPositionExtRecord value6(Integer value) {
     ...
     */
    @Override
    public JobPositionExtRecord values(Integer value1, Integer value2, Timestamp value3, Timestamp value4, String value5, Integer value6, Integer value7, String value8) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public JobPositionExtRecord(Integer pid, Integer jobCustomId, Timestamp createTime, Timestamp updateTime, String extra, Integer jobOccupationId, Integer alipayJobId, String ext) {
        super(JobPositionExt.JOB_POSITION_EXT);
