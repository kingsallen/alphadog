...
public class JobPositionExtRecord extends UpdatableRecordImpl<JobPositionExtRecord> implements Record7<Integer, Integer, Timestamp, Timestamp, String, Integer, Integer> {

    private static final long serialVersionUID = -679711611;
     ...
     */
    @Override
    public Row7<Integer, Integer, Timestamp, Timestamp, String, Integer, Integer> fieldsRow() {
     ...
     */
    @Override
    public Row7<Integer, Integer, Timestamp, Timestamp, String, Integer, Integer> valuesRow() {
     ...
     */
    @Override
    public JobPositionExtRecord values(Integer value1, Integer value2, Timestamp value3, Timestamp value4, String value5, Integer value6, Integer value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public JobPositionExtRecord(Integer pid, Integer jobCustomId, Timestamp createTime, Timestamp updateTime, String extra, Integer jobOccupationId, Integer alipayJobId) {
        super(JobPositionExt.JOB_POSITION_EXT);
