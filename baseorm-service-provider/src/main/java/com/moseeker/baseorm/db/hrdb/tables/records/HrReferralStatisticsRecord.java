...
public class HrReferralStatisticsRecord extends UpdatableRecordImpl<HrReferralStatisticsRecord> implements Record16<Integer, Integer, Integer, Date, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, String, String> {

    private static final long serialVersionUID = 1968833940;
     ...
     */
    @Override
    public Row16<Integer, Integer, Integer, Date, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, String, String> fieldsRow() {
     ...
     */
    @Override
    public Row16<Integer, Integer, Integer, Date, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, String, String> valuesRow() {
     ...
     */
    @Override
    public HrReferralStatisticsRecord value3(Integer value) {
        setCompanyId(value);
        return this;
    }
     ...
     */
    @Override
    public HrReferralStatisticsRecord value15(String value) {
     ...
     */
    @Override
    public HrReferralStatisticsRecord value16(String value) {
     ...
     */
    @Override
    public HrReferralStatisticsRecord values(Integer value1, Integer value2, Integer value3, Date value4, Integer value5, Integer value6, Integer value7, Integer value8, Integer value9, Integer value10, Integer value11, Integer value12, Integer value13, Integer value14, String value15, String value16) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
    ...
    public HrReferralStatisticsRecord(Integer id, Integer employeeId, Integer companyId, Date createDate, Integer recomNum, Integer recomFavNum, Integer recomMobileNum, Integer recomApplyNum, Integer recomAfterReviewNum, Integer recomAfterInterviewNum, Integer recomOnBoardNum, Integer infoType, Integer publisher, Integer positionId, String employeeName, String positionTitle) {
        ...
        set(4, recomNum);
        set(5, recomFavNum);
        set(6, recomMobileNum);
        set(7, recomApplyNum);
        set(8, recomAfterReviewNum);
        set(9, recomAfterInterviewNum);
        set(10, recomOnBoardNum);
        set(11, infoType);
        set(12, publisher);
        set(13, positionId);
        set(14, employeeName);
        set(15, positionTitle);
    }
}
