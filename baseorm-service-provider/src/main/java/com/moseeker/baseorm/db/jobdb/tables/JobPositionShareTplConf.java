...
public class JobPositionShareTplConf extends TableImpl<JobPositionShareTplConfRecord> {
    ...
    private static final long serialVersionUID = -707818868;
     ...
     */
    public final TableField<JobPositionShareTplConfRecord, Short> TYPE = createField("type", org.jooq.impl.SQLDataType.SMALLINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("1", org.jooq.impl.SQLDataType.SMALLINT)), this, "模板分类 1：雇主分享模板 2：员工分享模板");
