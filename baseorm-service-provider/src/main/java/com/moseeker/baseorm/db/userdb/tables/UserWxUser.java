...
public class UserWxUser extends TableImpl<UserWxUserRecord> {
	...
	private static final long serialVersionUID = -827578594;
	 ...
	 */
	public final TableField<UserWxUserRecord, Integer> GROUP_ID = createField("group_id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaulted(true), this, "分组ID");
	 ...
	 */
	public final TableField<UserWxUserRecord, Byte> IS_SUBSCRIBE = createField("is_subscribe", org.jooq.impl.SQLDataType.TINYINT.nullable(false).defaulted(true), this, "是否关注 1:关注 0：没关注");
