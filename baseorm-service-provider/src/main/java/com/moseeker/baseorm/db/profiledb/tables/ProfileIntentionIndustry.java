...
public class ProfileIntentionIndustry extends TableImpl<ProfileIntentionIndustryRecord> {
    ...
    private static final long serialVersionUID = -259995946;
     ...
     */
    public final TableField<ProfileIntentionIndustryRecord, Integer> INDUSTRY_CODE = createField("industry_code", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "行业字典编码");

    /**
     * The column <code>profiledb.profile_intention_industry.industry_name</code>. 行业名称
     */
    public final TableField<ProfileIntentionIndustryRecord, String> INDUSTRY_NAME = createField("industry_name", org.jooq.impl.SQLDataType.VARCHAR.length(100).nullable(false).defaultValue(org.jooq.impl.DSL.field("", org.jooq.impl.SQLDataType.VARCHAR)), this, "行业名称");
