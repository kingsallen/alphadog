...
public class ProfileImport extends TableImpl<ProfileImportRecord> {
    ...
    private static final long serialVersionUID = 25237076;
     ...
     */
    public final TableField<ProfileImportRecord, Integer> PROFILE_ID = createField("profile_id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "profile.id");

    /**
     * The column <code>profiledb.profile_import.source</code>. 来源, 0:无法识别 1:51Job 2:Liepin 3:zhilian 4:linkedin
     */
    public final TableField<ProfileImportRecord, Byte> SOURCE = createField("source", org.jooq.impl.SQLDataType.TINYINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.TINYINT)), this, "来源, 0:无法识别 1:51Job 2:Liepin 3:zhilian 4:linkedin");
     ...
     */
    public final TableField<ProfileImportRecord, String> ACCOUNT_ID = createField("account_id", org.jooq.impl.SQLDataType.VARCHAR.length(100).nullable(false).defaultValue(org.jooq.impl.DSL.field("", org.jooq.impl.SQLDataType.VARCHAR)), this, "他系统的用户ID");

    /**
     * The column <code>profiledb.profile_import.resume_id</code>. 他系统的简历ID
     */
    public final TableField<ProfileImportRecord, String> RESUME_ID = createField("resume_id", org.jooq.impl.SQLDataType.VARCHAR.length(100).nullable(false).defaultValue(org.jooq.impl.DSL.field("", org.jooq.impl.SQLDataType.VARCHAR)), this, "他系统的简历ID");

    /**
     * The column <code>profiledb.profile_import.user_name</code>. 他系统的登陆用户名
     */
    public final TableField<ProfileImportRecord, String> USER_NAME = createField("user_name", org.jooq.impl.SQLDataType.VARCHAR.length(100).nullable(false).defaultValue(org.jooq.impl.DSL.field("", org.jooq.impl.SQLDataType.VARCHAR)), this, "他系统的登陆用户名");

    /**
     * The column <code>profiledb.profile_import.create_time</code>. 创建时间
     */
    public final TableField<ProfileImportRecord, Timestamp> CREATE_TIME = createField("create_time", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "创建时间");

    /**
     * The column <code>profiledb.profile_import.update_time</code>. 更新时间
     */
    public final TableField<ProfileImportRecord, Timestamp> UPDATE_TIME = createField("update_time", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "更新时间");
