...
public class WordpressTerms extends TableImpl<WordpressTermsRecord> {
    ...
    private static final long serialVersionUID = -1282585418;
     ...
     */
    public final TableField<WordpressTermsRecord, String> NAME = createField("name", org.jooq.impl.SQLDataType.VARCHAR.length(200).nullable(false).defaultValue(org.jooq.impl.DSL.field("", org.jooq.impl.SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>wordpressdb.wordpress_terms.slug</code>.
     */
    public final TableField<WordpressTermsRecord, String> SLUG = createField("slug", org.jooq.impl.SQLDataType.VARCHAR.length(200).nullable(false).defaultValue(org.jooq.impl.DSL.field("", org.jooq.impl.SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>wordpressdb.wordpress_terms.term_group</code>.
     */
    public final TableField<WordpressTermsRecord, Long> TERM_GROUP = createField("term_group", org.jooq.impl.SQLDataType.BIGINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.BIGINT)), this, "");
