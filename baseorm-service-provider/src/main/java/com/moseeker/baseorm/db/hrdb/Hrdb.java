...
public class Hrdb extends SchemaImpl {
    ...
    private static final long serialVersionUID = 267507257;
     ...
     * 自定义字段的下拉选项表
     */
    public final EmployeeOptionValue EMPLOYEE_OPTION_VALUE = com.moseeker.baseorm.db.hrdb.tables.EmployeeOptionValue.EMPLOYEE_OPTION_VALUE;
     ...
     * 员工认证-自定义显示表
     */
    public final HrEmployeeCustomDisplay HR_EMPLOYEE_CUSTOM_DISPLAY = com.moseeker.baseorm.db.hrdb.tables.HrEmployeeCustomDisplay.HR_EMPLOYEE_CUSTOM_DISPLAY;
     ...
     * 自定义字段的下拉选项表
     */
    public final HrEmployeeOptionValue HR_EMPLOYEE_OPTION_VALUE = com.moseeker.baseorm.db.hrdb.tables.HrEmployeeOptionValue.HR_EMPLOYEE_OPTION_VALUE;
    ...
    private final List<Table<?>> getTables0() {
        return Arrays.<Table<?>>asList(
            ...
            HrEmployeeCustomDisplay.HR_EMPLOYEE_CUSTOM_DISPLAY,
            HrEmployeeCustomFields.HR_EMPLOYEE_CUSTOM_FIELDS,
            HrEmployeeOptionValue.HR_EMPLOYEE_OPTION_VALUE,
