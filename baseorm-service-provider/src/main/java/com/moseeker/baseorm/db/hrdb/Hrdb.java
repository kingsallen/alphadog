...
public class Hrdb extends SchemaImpl {
    ...
    private static final long serialVersionUID = -1064268685;
     ...
     * 人工智能系统配置表
     */
    public final HrAiConf HR_AI_CONF = HrAiConf.HR_AI_CONF;
     ...
     * 自定义简历模板导出字段表
     */
    public final HrAppExportFields HR_APP_EXPORT_FIELDS = HrAppExportFields.HR_APP_EXPORT_FIELDS;
     ...
     * 邮件额度每天使用日志
     */
    public final HrCompanyCs HR_COMPANY_CS = HrCompanyCs.HR_COMPANY_CS;

    /**
     * 企业邮件总量信息表
     */
    public final HrCompanyEmailInfo HR_COMPANY_EMAIL_INFO = HrCompanyEmailInfo.HR_COMPANY_EMAIL_INFO;

    /**
     * 公司福利特色
     */
    public final HrCompanyFeature HR_COMPANY_FEATURE = HrCompanyFeature.HR_COMPANY_FEATURE;
     ...
     */
    public final HrGroupCompany HR_GROUP_COMPANY = HrGroupCompany.HR_GROUP_COMPANY;

    /**
     * The table <code>hrdb.hr_group_company_rel</code>.
     */
    public final HrGroupCompanyRel HR_GROUP_COMPANY_REL = HrGroupCompanyRel.HR_GROUP_COMPANY_REL;
     ...
     * nps打分推荐表
     */
    public final HrNps HR_NPS = HrNps.HR_NPS;

    /**
     * hr推荐同行表
     */
    public final HrNpsRecommend HR_NPS_RECOMMEND = HrNpsRecommend.HR_NPS_RECOMMEND;
     ...
     */
    public final HrWxHrChatVoice HR_WX_HR_CHAT_VOICE = HrWxHrChatVoice.HR_WX_HR_CHAT_VOICE;
