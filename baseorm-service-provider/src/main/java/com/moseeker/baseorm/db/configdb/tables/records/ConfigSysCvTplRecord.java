...
public class ConfigSysCvTplRecord extends UpdatableRecordImpl<ConfigSysCvTplRecord> implements Record17<Integer, String, String, Integer, Integer, Integer, Timestamp, Timestamp, Integer, Integer, Integer, String, String, Integer, Integer, String, String> {

    private static final long serialVersionUID = 1748348623;
    ...
    /**
     * Setter for <code>configdb.config_sys_cv_tpl.field_type</code>. 属性类型 -1:不显示 0:短文本,1:长文本,2:多选,3:单选,4:长tag,5:tag:,6:时间,7:img,8:复合字段-单条,9:复合字段-多条,10:下拉列表, 101:城市选择控件, 102:国家选择控件,103:行业选择控件,104:学校选择控件,105:火箭专业选择控件
     */
    ...
    /**
     * Getter for <code>configdb.config_sys_cv_tpl.field_type</code>. 属性类型 -1:不显示 0:短文本,1:长文本,2:多选,3:单选,4:长tag,5:tag:,6:时间,7:img,8:复合字段-单条,9:复合字段-多条,10:下拉列表, 101:城市选择控件, 102:国家选择控件,103:行业选择控件,104:学校选择控件,105:火箭专业选择控件
     */
     ...
     */
    @Override
    public Row17<Integer, String, String, Integer, Integer, Integer, Timestamp, Timestamp, Integer, Integer, Integer, String, String, Integer, Integer, String, String> fieldsRow() {
     ...
     */
    @Override
    public Row17<Integer, String, String, Integer, Integer, Integer, Timestamp, Timestamp, Integer, Integer, Integer, String, String, Integer, Integer, String, String> valuesRow() {
     ...
     */
    @Override
    public ConfigSysCvTplRecord values(Integer value1, String value2, String value3, Integer value4, Integer value5, Integer value6, Timestamp value7, Timestamp value8, Integer value9, Integer value10, Integer value11, String value12, String value13, Integer value14, Integer value15, String value16, String value17) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public ConfigSysCvTplRecord(Integer id, String fieldName, String fieldTitle, Integer fieldType, Integer priority, Integer isBasic, Timestamp createTime, Timestamp updateTime, Integer disable, Integer companyId, Integer required, String fieldDescription, String map, Integer constantParentCode, Integer parentId, String validateRe, String errorMsg) {
        super(ConfigSysCvTpl.CONFIG_SYS_CV_TPL);
