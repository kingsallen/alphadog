...
public class HrChildCompany implements Serializable {

    private static final long serialVersionUID = -1693453528;
    ...
    public HrChildCompany(HrChildCompany value) {
        this.id = value.id;
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("HrChildCompany (");
