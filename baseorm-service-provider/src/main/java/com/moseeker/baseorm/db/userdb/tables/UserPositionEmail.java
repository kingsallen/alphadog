...
public class UserPositionEmail extends TableImpl<UserPositionEmailRecord> {
     ...
     */
    public final TableField<UserPositionEmailRecord, Integer> USER_ID = createField("user_id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "用户id");

    /**
     * The column <code>userdb.user_position_email.conditions</code>. 订阅的职位条件
     */
    public final TableField<UserPositionEmailRecord, String> CONDITIONS = createField("conditions", org.jooq.impl.SQLDataType.VARCHAR.length(255).nullable(false).defaultValue(org.jooq.impl.DSL.field("", org.jooq.impl.SQLDataType.VARCHAR)), this, "订阅的职位条件");

    /**
     * The column <code>userdb.user_position_email.status</code>. 状态，0是正常，1是取消
     */
    public final TableField<UserPositionEmailRecord, Integer> STATUS = createField("status", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "状态，0是正常，1是取消");

    /**
     * The column <code>userdb.user_position_email.create_time</code>. 创建时间
     */
    public final TableField<UserPositionEmailRecord, Timestamp> CREATE_TIME = createField("create_time", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "创建时间");

    /**
     * The column <code>userdb.user_position_email.update_time</code>. 更新时间
     */
    public final TableField<UserPositionEmailRecord, Timestamp> UPDATE_TIME = createField("update_time", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "更新时间");
