...
public class HrWxTemplateMessage extends TableImpl<HrWxTemplateMessageRecord> {
    ...
    private static final long serialVersionUID = -1209618637;
     ...
     */
    public final TableField<HrWxTemplateMessageRecord, Integer> DISPLAY = createField("display", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "是否显示");

    /**
     * The column <code>hrdb.hr_wx_template_message.priority</code>. 排序
     */
    public final TableField<HrWxTemplateMessageRecord, Integer> PRIORITY = createField("priority", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("10", org.jooq.impl.SQLDataType.INTEGER)), this, "排序");

    /**
     * The column <code>hrdb.hr_wx_template_message.wechat_id</code>. 所属公众号
     */
    public final TableField<HrWxTemplateMessageRecord, Integer> WECHAT_ID = createField("wechat_id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("10", org.jooq.impl.SQLDataType.INTEGER)), this, "所属公众号");

    /**
     * The column <code>hrdb.hr_wx_template_message.disable</code>. 是否可用
     */
    public final TableField<HrWxTemplateMessageRecord, Integer> DISABLE = createField("disable", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "是否可用");
     ...
     */
    public final TableField<HrWxTemplateMessageRecord, String> TOPCOLOR = createField("topcolor", org.jooq.impl.SQLDataType.VARCHAR.length(10).defaultValue(org.jooq.impl.DSL.field("#FF0000", org.jooq.impl.SQLDataType.VARCHAR)), this, "消息头部颜色");
