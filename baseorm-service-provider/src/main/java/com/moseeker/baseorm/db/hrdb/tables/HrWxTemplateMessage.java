...
public class HrWxTemplateMessage extends TableImpl<HrWxTemplateMessageRecord> {
    ...
    private static final long serialVersionUID = -2081835155;
     ...
     */
    public final TableField<HrWxTemplateMessageRecord, UInteger> DISPLAY = createField("display", org.jooq.impl.SQLDataType.INTEGERUNSIGNED.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGERUNSIGNED)), this, "是否显示");

    /**
     * The column <code>hrdb.hr_wx_template_message.priority</code>. 排序
     */
    public final TableField<HrWxTemplateMessageRecord, UInteger> PRIORITY = createField("priority", org.jooq.impl.SQLDataType.INTEGERUNSIGNED.nullable(false).defaultValue(org.jooq.impl.DSL.field("10", org.jooq.impl.SQLDataType.INTEGERUNSIGNED)), this, "排序");

    /**
     * The column <code>hrdb.hr_wx_template_message.wechat_id</code>. 所属公众号
     */
    public final TableField<HrWxTemplateMessageRecord, UInteger> WECHAT_ID = createField("wechat_id", org.jooq.impl.SQLDataType.INTEGERUNSIGNED.nullable(false).defaultValue(org.jooq.impl.DSL.field("10", org.jooq.impl.SQLDataType.INTEGERUNSIGNED)), this, "所属公众号");

    /**
     * The column <code>hrdb.hr_wx_template_message.disable</code>. 是否可用
     */
    public final TableField<HrWxTemplateMessageRecord, UInteger> DISABLE = createField("disable", org.jooq.impl.SQLDataType.INTEGERUNSIGNED.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGERUNSIGNED)), this, "是否可用");
