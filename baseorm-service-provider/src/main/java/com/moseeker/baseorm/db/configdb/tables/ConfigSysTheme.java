...
public class ConfigSysTheme extends TableImpl<ConfigSysThemeRecord> {
    ...
    private static final long serialVersionUID = -1618712142;
    ...
    /**
     * The column <code>configdb.config_sys_theme.company_id</code>. hr_company.id,用于隔离企业自定义的颜色，0是默认色，公共可用
     */
    public final TableField<ConfigSysThemeRecord, Integer> COMPANY_ID = createField("company_id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.INTEGER)), this, "hr_company.id,用于隔离企业自定义的颜色，0是默认色，公共可用");
