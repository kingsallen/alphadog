...
public class StmPvPidRecord extends UpdatableRecordImpl<StmPvPidRecord> implements Record5<Long, String, Timestamp, String, String> {

    private static final long serialVersionUID = -1653614367;
