...
public class StOfficialPuv extends TableImpl<StOfficialPuvRecord> {
    ...
    private static final long serialVersionUID = -1501666398;
     ...
     */
    public final TableField<StOfficialPuvRecord, Integer> IP_COUNT = createField("ip_count", org.jooq.impl.SQLDataType.INTEGER.defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "pv");

    /**
     * The column <code>analytics.st_official_puv.ip_unique</code>. uv
     */
    public final TableField<StOfficialPuvRecord, Integer> IP_UNIQUE = createField("ip_unique", org.jooq.impl.SQLDataType.INTEGER.defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "uv");
     ...
     */
    public final TableField<StOfficialPuvRecord, Integer> IP_FREQ = createField("ip_freq", org.jooq.impl.SQLDataType.INTEGER.defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "访问最高ip的频次");

    /**
     * The column <code>analytics.st_official_puv.baidu_ip_count</code>. baidu来源pv
     */
    public final TableField<StOfficialPuvRecord, Integer> BAIDU_IP_COUNT = createField("baidu_ip_count", org.jooq.impl.SQLDataType.INTEGER.defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "baidu来源pv");

    /**
     * The column <code>analytics.st_official_puv.baidu_ip_unique</code>. baidu来源uv
     */
    public final TableField<StOfficialPuvRecord, Integer> BAIDU_IP_UNIQUE = createField("baidu_ip_unique", org.jooq.impl.SQLDataType.INTEGER.defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "baidu来源uv");
     ...
     */
    public final TableField<StOfficialPuvRecord, Integer> BAIDU_IP_FREQ = createField("baidu_ip_freq", org.jooq.impl.SQLDataType.INTEGER.defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "baidu来源最高访问ip频次");
