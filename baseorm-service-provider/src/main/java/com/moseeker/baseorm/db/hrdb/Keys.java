...
public class Keys {
    ...
    public static final Identity<HrAtsApplicationEmployRecord, Integer> IDENTITY_HR_ATS_APPLICATION_EMPLOY = Identities0.IDENTITY_HR_ATS_APPLICATION_EMPLOY;
    public static final Identity<HrAtsApplicationOfferRecord, Integer> IDENTITY_HR_ATS_APPLICATION_OFFER = Identities0.IDENTITY_HR_ATS_APPLICATION_OFFER;
    ...
    public static final Identity<HrAtsDepartmentRecord, Integer> IDENTITY_HR_ATS_DEPARTMENT = Identities0.IDENTITY_HR_ATS_DEPARTMENT;
    ...
    public static final Identity<HrAtsObsoleteRecord, Integer> IDENTITY_HR_ATS_OBSOLETE = Identities0.IDENTITY_HR_ATS_OBSOLETE;
    ...
    public static final Identity<HrChannelRecord, Integer> IDENTITY_HR_CHANNEL = Identities0.IDENTITY_HR_CHANNEL;
    public static final Identity<HrChannelCategoryRecord, Integer> IDENTITY_HR_CHANNEL_CATEGORY = Identities0.IDENTITY_HR_CHANNEL_CATEGORY;
    public static final Identity<HrChannelCategorySourceRelationRecord, Integer> IDENTITY_HR_CHANNEL_CATEGORY_SOURCE_RELATION = Identities0.IDENTITY_HR_CHANNEL_CATEGORY_SOURCE_RELATION;
    public static final Identity<HrChannelSourceRecord, Integer> IDENTITY_HR_CHANNEL_SOURCE = Identities0.IDENTITY_HR_CHANNEL_SOURCE;
    ...
    public static final Identity<HrCompanyAccountConfRecord, Integer> IDENTITY_HR_COMPANY_ACCOUNT_CONF = Identities0.IDENTITY_HR_COMPANY_ACCOUNT_CONF;
    public static final Identity<HrCompanyAddressRecord, Integer> IDENTITY_HR_COMPANY_ADDRESS = Identities0.IDENTITY_HR_COMPANY_ADDRESS;
    ...
    public static final Identity<HrCompanyInterviewRecord, Integer> IDENTITY_HR_COMPANY_INTERVIEW = Identities0.IDENTITY_HR_COMPANY_INTERVIEW;
    ...
    public static final Identity<HrReferralRuleConfigRecord, Integer> IDENTITY_HR_REFERRAL_RULE_CONFIG = Identities0.IDENTITY_HR_REFERRAL_RULE_CONFIG;
    ...
    public static final UniqueKey<HrAtsApplicationEmployRecord> KEY_HR_ATS_APPLICATION_EMPLOY_PRIMARY = UniqueKeys0.KEY_HR_ATS_APPLICATION_EMPLOY_PRIMARY;
    public static final UniqueKey<HrAtsApplicationOfferRecord> KEY_HR_ATS_APPLICATION_OFFER_PRIMARY = UniqueKeys0.KEY_HR_ATS_APPLICATION_OFFER_PRIMARY;
    ...
    public static final UniqueKey<HrAtsDepartmentRecord> KEY_HR_ATS_DEPARTMENT_PRIMARY = UniqueKeys0.KEY_HR_ATS_DEPARTMENT_PRIMARY;
    ...
    public static final UniqueKey<HrAtsObsoleteRecord> KEY_HR_ATS_OBSOLETE_PRIMARY = UniqueKeys0.KEY_HR_ATS_OBSOLETE_PRIMARY;
    ...
    public static final UniqueKey<HrChannelRecord> KEY_HR_CHANNEL_PRIMARY = UniqueKeys0.KEY_HR_CHANNEL_PRIMARY;
    public static final UniqueKey<HrChannelCategoryRecord> KEY_HR_CHANNEL_CATEGORY_PRIMARY = UniqueKeys0.KEY_HR_CHANNEL_CATEGORY_PRIMARY;
    public static final UniqueKey<HrChannelCategorySourceRelationRecord> KEY_HR_CHANNEL_CATEGORY_SOURCE_RELATION_PRIMARY = UniqueKeys0.KEY_HR_CHANNEL_CATEGORY_SOURCE_RELATION_PRIMARY;
    public static final UniqueKey<HrChannelSourceRecord> KEY_HR_CHANNEL_SOURCE_PRIMARY = UniqueKeys0.KEY_HR_CHANNEL_SOURCE_PRIMARY;
    ...
    public static final UniqueKey<HrCompanyAccountConfRecord> KEY_HR_COMPANY_ACCOUNT_CONF_PRIMARY = UniqueKeys0.KEY_HR_COMPANY_ACCOUNT_CONF_PRIMARY;
    public static final UniqueKey<HrCompanyAddressRecord> KEY_HR_COMPANY_ADDRESS_PRIMARY = UniqueKeys0.KEY_HR_COMPANY_ADDRESS_PRIMARY;
    ...
    public static final UniqueKey<HrCompanyInterviewRecord> KEY_HR_COMPANY_INTERVIEW_PRIMARY = UniqueKeys0.KEY_HR_COMPANY_INTERVIEW_PRIMARY;
    ...
    public static final UniqueKey<HrReferralRuleConfigRecord> KEY_HR_REFERRAL_RULE_CONFIG_PRIMARY = UniqueKeys0.KEY_HR_REFERRAL_RULE_CONFIG_PRIMARY;
    ...
    private static class Identities0 extends AbstractKeys {
        ...
        public static Identity<HrAtsApplicationEmployRecord, Integer> IDENTITY_HR_ATS_APPLICATION_EMPLOY = createIdentity(HrAtsApplicationEmploy.HR_ATS_APPLICATION_EMPLOY, HrAtsApplicationEmploy.HR_ATS_APPLICATION_EMPLOY.ID);
        public static Identity<HrAtsApplicationOfferRecord, Integer> IDENTITY_HR_ATS_APPLICATION_OFFER = createIdentity(HrAtsApplicationOffer.HR_ATS_APPLICATION_OFFER, HrAtsApplicationOffer.HR_ATS_APPLICATION_OFFER.ID);
        ...
        public static Identity<HrAtsDepartmentRecord, Integer> IDENTITY_HR_ATS_DEPARTMENT = createIdentity(HrAtsDepartment.HR_ATS_DEPARTMENT, HrAtsDepartment.HR_ATS_DEPARTMENT.ID);
        ...
        public static Identity<HrAtsObsoleteRecord, Integer> IDENTITY_HR_ATS_OBSOLETE = createIdentity(HrAtsObsolete.HR_ATS_OBSOLETE, HrAtsObsolete.HR_ATS_OBSOLETE.ID);
        ...
        public static Identity<HrChannelRecord, Integer> IDENTITY_HR_CHANNEL = createIdentity(HrChannel.HR_CHANNEL, HrChannel.HR_CHANNEL.ID);
        public static Identity<HrChannelCategoryRecord, Integer> IDENTITY_HR_CHANNEL_CATEGORY = createIdentity(HrChannelCategory.HR_CHANNEL_CATEGORY, HrChannelCategory.HR_CHANNEL_CATEGORY.ID);
        public static Identity<HrChannelCategorySourceRelationRecord, Integer> IDENTITY_HR_CHANNEL_CATEGORY_SOURCE_RELATION = createIdentity(HrChannelCategorySourceRelation.HR_CHANNEL_CATEGORY_SOURCE_RELATION, HrChannelCategorySourceRelation.HR_CHANNEL_CATEGORY_SOURCE_RELATION.ID);
        public static Identity<HrChannelSourceRecord, Integer> IDENTITY_HR_CHANNEL_SOURCE = createIdentity(HrChannelSource.HR_CHANNEL_SOURCE, HrChannelSource.HR_CHANNEL_SOURCE.ID);
        ...
        public static Identity<HrCompanyAccountConfRecord, Integer> IDENTITY_HR_COMPANY_ACCOUNT_CONF = createIdentity(HrCompanyAccountConf.HR_COMPANY_ACCOUNT_CONF, HrCompanyAccountConf.HR_COMPANY_ACCOUNT_CONF.ID);
        public static Identity<HrCompanyAddressRecord, Integer> IDENTITY_HR_COMPANY_ADDRESS = createIdentity(HrCompanyAddress.HR_COMPANY_ADDRESS, HrCompanyAddress.HR_COMPANY_ADDRESS.ID);
        ...
        public static Identity<HrCompanyInterviewRecord, Integer> IDENTITY_HR_COMPANY_INTERVIEW = createIdentity(HrCompanyInterview.HR_COMPANY_INTERVIEW, HrCompanyInterview.HR_COMPANY_INTERVIEW.ID);
        ...
        public static Identity<HrReferralRuleConfigRecord, Integer> IDENTITY_HR_REFERRAL_RULE_CONFIG = createIdentity(HrReferralRuleConfig.HR_REFERRAL_RULE_CONFIG, HrReferralRuleConfig.HR_REFERRAL_RULE_CONFIG.ID);
    ...
    private static class UniqueKeys0 extends AbstractKeys {
        ...
        public static final UniqueKey<HrAtsApplicationEmployRecord> KEY_HR_ATS_APPLICATION_EMPLOY_PRIMARY = createUniqueKey(HrAtsApplicationEmploy.HR_ATS_APPLICATION_EMPLOY, "KEY_hr_ats_application_employ_PRIMARY", HrAtsApplicationEmploy.HR_ATS_APPLICATION_EMPLOY.ID);
        public static final UniqueKey<HrAtsApplicationOfferRecord> KEY_HR_ATS_APPLICATION_OFFER_PRIMARY = createUniqueKey(HrAtsApplicationOffer.HR_ATS_APPLICATION_OFFER, "KEY_hr_ats_application_offer_PRIMARY", HrAtsApplicationOffer.HR_ATS_APPLICATION_OFFER.ID);
        ...
        public static final UniqueKey<HrAtsDepartmentRecord> KEY_HR_ATS_DEPARTMENT_PRIMARY = createUniqueKey(HrAtsDepartment.HR_ATS_DEPARTMENT, "KEY_hr_ats_department_PRIMARY", HrAtsDepartment.HR_ATS_DEPARTMENT.ID);
        ...
        public static final UniqueKey<HrAtsObsoleteRecord> KEY_HR_ATS_OBSOLETE_PRIMARY = createUniqueKey(HrAtsObsolete.HR_ATS_OBSOLETE, "KEY_hr_ats_obsolete_PRIMARY", HrAtsObsolete.HR_ATS_OBSOLETE.ID);
        ...
        public static final UniqueKey<HrChannelRecord> KEY_HR_CHANNEL_PRIMARY = createUniqueKey(HrChannel.HR_CHANNEL, "KEY_hr_channel_PRIMARY", HrChannel.HR_CHANNEL.ID);
        public static final UniqueKey<HrChannelCategoryRecord> KEY_HR_CHANNEL_CATEGORY_PRIMARY = createUniqueKey(HrChannelCategory.HR_CHANNEL_CATEGORY, "KEY_hr_channel_category_PRIMARY", HrChannelCategory.HR_CHANNEL_CATEGORY.ID);
        public static final UniqueKey<HrChannelCategorySourceRelationRecord> KEY_HR_CHANNEL_CATEGORY_SOURCE_RELATION_PRIMARY = createUniqueKey(HrChannelCategorySourceRelation.HR_CHANNEL_CATEGORY_SOURCE_RELATION, "KEY_hr_channel_category_source_relation_PRIMARY", HrChannelCategorySourceRelation.HR_CHANNEL_CATEGORY_SOURCE_RELATION.ID);
        public static final UniqueKey<HrChannelSourceRecord> KEY_HR_CHANNEL_SOURCE_PRIMARY = createUniqueKey(HrChannelSource.HR_CHANNEL_SOURCE, "KEY_hr_channel_source_PRIMARY", HrChannelSource.HR_CHANNEL_SOURCE.ID);
        ...
        public static final UniqueKey<HrCompanyAccountConfRecord> KEY_HR_COMPANY_ACCOUNT_CONF_PRIMARY = createUniqueKey(HrCompanyAccountConf.HR_COMPANY_ACCOUNT_CONF, "KEY_hr_company_account_conf_PRIMARY", HrCompanyAccountConf.HR_COMPANY_ACCOUNT_CONF.ID);
        public static final UniqueKey<HrCompanyAddressRecord> KEY_HR_COMPANY_ADDRESS_PRIMARY = createUniqueKey(HrCompanyAddress.HR_COMPANY_ADDRESS, "KEY_hr_company_address_PRIMARY", HrCompanyAddress.HR_COMPANY_ADDRESS.ID);
        ...
        public static final UniqueKey<HrCompanyInterviewRecord> KEY_HR_COMPANY_INTERVIEW_PRIMARY = createUniqueKey(HrCompanyInterview.HR_COMPANY_INTERVIEW, "KEY_hr_company_interview_PRIMARY", HrCompanyInterview.HR_COMPANY_INTERVIEW.ID);
        ...
        public static final UniqueKey<HrReferralRuleConfigRecord> KEY_HR_REFERRAL_RULE_CONFIG_PRIMARY = createUniqueKey(HrReferralRuleConfig.HR_REFERRAL_RULE_CONFIG, "KEY_hr_referral_rule_config_PRIMARY", HrReferralRuleConfig.HR_REFERRAL_RULE_CONFIG.ID);
