...
public class HrHbItems implements Serializable {

    private static final long serialVersionUID = -1619682919;
    ...
    public HrHbItems(HrHbItems value) {
        this.id = value.id;
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("HrHbItems (");
