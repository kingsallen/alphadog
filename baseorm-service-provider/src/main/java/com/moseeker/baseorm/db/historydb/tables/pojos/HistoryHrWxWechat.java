...
public class HistoryHrWxWechat implements Serializable {

    private static final long serialVersionUID = -218792160;
    ...
    public HistoryHrWxWechat(HistoryHrWxWechat value) {
        this.id = value.id;
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("HistoryHrWxWechat (");
