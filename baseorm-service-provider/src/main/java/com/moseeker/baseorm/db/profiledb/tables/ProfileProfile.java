...
public class ProfileProfile extends TableImpl<ProfileProfileRecord> {
    ...
    private static final long serialVersionUID = -20219556;
     ...
     */
    public final TableField<ProfileProfileRecord, String> UUID = createField("uuid", org.jooq.impl.SQLDataType.VARCHAR.length(64).nullable(false).defaultValue(org.jooq.impl.DSL.field("", org.jooq.impl.SQLDataType.VARCHAR)), this, "profile的uuid标识,与主键一一对应");

    /**
     * The column <code>profiledb.profile_profile.lang</code>. profile语言 1:chinese 2:english
     */
    public final TableField<ProfileProfileRecord, Byte> LANG = createField("lang", org.jooq.impl.SQLDataType.TINYINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("1", org.jooq.impl.SQLDataType.TINYINT)), this, "profile语言 1:chinese 2:english");
     ...
     */
    public final TableField<ProfileProfileRecord, Byte> COMPLETENESS = createField("completeness", org.jooq.impl.SQLDataType.TINYINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("10", org.jooq.impl.SQLDataType.TINYINT)), this, "Profile完整度");

    /**
     * The column <code>profiledb.profile_profile.user_id</code>. 用户ID
     */
    public final TableField<ProfileProfileRecord, Integer> USER_ID = createField("user_id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "用户ID");

    /**
     * The column <code>profiledb.profile_profile.disable</code>. 是否有效，0：无效 1：有效
     */
    public final TableField<ProfileProfileRecord, Byte> DISABLE = createField("disable", org.jooq.impl.SQLDataType.TINYINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.TINYINT)), this, "是否有效，0：无效 1：有效");

    /**
     * The column <code>profiledb.profile_profile.create_time</code>. 创建时间
     */
    public final TableField<ProfileProfileRecord, Timestamp> CREATE_TIME = createField("create_time", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "创建时间");

    /**
     * The column <code>profiledb.profile_profile.update_time</code>. 更新时间
     */
    public final TableField<ProfileProfileRecord, Timestamp> UPDATE_TIME = createField("update_time", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "更新时间");
     ...
     */
    public final TableField<ProfileProfileRecord, String> ORIGIN = createField("origin", org.jooq.impl.SQLDataType.VARCHAR.length(20).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.VARCHAR)), this, "简历来源二进制数值,1表示维系企业端（正常），10表示微信企业端(我要投递)，100表示微信企业端(我感兴趣)，1000表示微信企业端(我感兴趣)，10000表示微信聚合端(正常)，100000表示微信聚合端(我要投递)，1000000表示微信聚合端(我感兴趣)，1000000表示微信企业端Email申请，100000000表示微信聚合端Email申请，1000000000表示微信企业端导入，10000000000表示微信聚合端导入，10000000000表示PC导入，100000000000表示PC(正常添加)，1000000000000表示PC(我要投递)，10000000000000表示PC(我感兴趣)，1000000000000000表示51job，10000000000000000表示智联");
