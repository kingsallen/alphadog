...
public class ProfileProfile extends TableImpl<ProfileProfileRecord> {
	...
	private static final long serialVersionUID = -1105387858;
	 ...
	 */
	public final TableField<ProfileProfileRecord, Byte> DISABLE = createField("disable", org.jooq.impl.SQLDataType.TINYINT.nullable(false).defaulted(true), this, "是否有效，0：无效 1：有效");
