...
public class LogWxTemplateMessageSendrecord extends TableImpl<LogWxTemplateMessageSendrecordRecord> {
    ...
    private static final long serialVersionUID = 1945448817;
     ...
     */
    public final TableField<LogWxTemplateMessageSendrecordRecord, Integer> WECHAT_ID = createField("wechat_id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "所属公众号");

    /**
     * The column <code>logdb.log_wx_template_message_sendrecord.msgid</code>. 发送消息ID
     */
    public final TableField<LogWxTemplateMessageSendrecordRecord, Long> MSGID = createField("msgid", org.jooq.impl.SQLDataType.BIGINT.defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.BIGINT)), this, "发送消息ID");
     ...
     */
    public final TableField<LogWxTemplateMessageSendrecordRecord, Integer> SENDTYPE = createField("sendtype", org.jooq.impl.SQLDataType.INTEGER.defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "发送类型 0:微信 1:邮件 2:短信");

    /**
     * The column <code>logdb.log_wx_template_message_sendrecord.access_token</code>. 发送时的access_token
     */
    public final TableField<LogWxTemplateMessageSendrecordRecord, String> ACCESS_TOKEN = createField("access_token", org.jooq.impl.SQLDataType.VARCHAR.length(600).nullable(false).defaultValue(org.jooq.impl.DSL.field("", org.jooq.impl.SQLDataType.VARCHAR)), this, "发送时的access_token");
