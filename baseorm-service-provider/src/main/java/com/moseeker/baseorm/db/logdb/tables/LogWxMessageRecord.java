...
public class LogWxMessageRecord extends TableImpl<LogWxMessageRecordRecord> {
     ...
     */
    public final TableField<LogWxMessageRecordRecord, Long> MSGID = createField("msgid", org.jooq.impl.SQLDataType.BIGINT.defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.BIGINT)), this, "发送消息ID");
     ...
     */
    public final TableField<LogWxMessageRecordRecord, Integer> SENDTYPE = createField("sendtype", org.jooq.impl.SQLDataType.INTEGER.defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "发送类型 0:微信 1:邮件 2:短信");

    /**
     * The column <code>logdb.log_wx_message_record.access_token</code>. 发送时的access_token
     */
    public final TableField<LogWxMessageRecordRecord, String> ACCESS_TOKEN = createField("access_token", org.jooq.impl.SQLDataType.VARCHAR.length(600).nullable(false).defaultValue(org.jooq.impl.DSL.field("", org.jooq.impl.SQLDataType.VARCHAR)), this, "发送时的access_token");
