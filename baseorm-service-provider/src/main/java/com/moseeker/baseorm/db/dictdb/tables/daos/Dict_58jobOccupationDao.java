...
public class Dict_58jobOccupationDao extends DAOImpl<Dict_58jobOccupationRecord, com.moseeker.baseorm.db.dictdb.tables.pojos.Dict_58jobOccupation, Integer> {
     ...
     */
    public List<com.moseeker.baseorm.db.dictdb.tables.pojos.Dict_58jobOccupation> fetchByParentId(String... values) {
        return fetch(Dict_58jobOccupation.DICT_58JOB_OCCUPATION.PARENT_ID, values);
    }
     ...
     */
    public List<com.moseeker.baseorm.db.dictdb.tables.pojos.Dict_58jobOccupation> fetchByCodeOther(String... values) {
        return fetch(Dict_58jobOccupation.DICT_58JOB_OCCUPATION.CODE_OTHER, values);
    }

    /**
     * Fetch records that have <code>level IN (values)</code>
     */
    public List<com.moseeker.baseorm.db.dictdb.tables.pojos.Dict_58jobOccupation> fetchByLevel(Short... values) {
        return fetch(Dict_58jobOccupation.DICT_58JOB_OCCUPATION.LEVEL, values);
    }

    /**
     * Fetch records that have <code>status IN (values)</code>
     */
    public List<com.moseeker.baseorm.db.dictdb.tables.pojos.Dict_58jobOccupation> fetchByStatus(Short... values) {
        return fetch(Dict_58jobOccupation.DICT_58JOB_OCCUPATION.STATUS, values);
    }
}
