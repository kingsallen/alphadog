...
public class UserThirdpartyUser extends TableImpl<UserThirdpartyUserRecord> {
	...
	private static final long serialVersionUID = 1707536114;
	 ...
	 */
	public final TableField<UserThirdpartyUserRecord, Integer> USER_ID = createField("user_id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaulted(true), this, "user_user.id, C端用户ID");
	 ...
	 */
	public final TableField<UserThirdpartyUserRecord, Timestamp> CREATE_TIME = createField("create_time", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaulted(true), this, "创建时间");

	/**
	 * The column <code>userdb.user_thirdparty_user.update_time</code>.
	 */
	public final TableField<UserThirdpartyUserRecord, Timestamp> UPDATE_TIME = createField("update_time", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaulted(true), this, "");
