...
public class CampaignPcRecommendCompany extends TableImpl<CampaignPcRecommendCompanyRecord> {
    ...
    private static final long serialVersionUID = 80345618;
     ...
     */
    public final TableField<CampaignPcRecommendCompanyRecord, Byte> DISABLE = createField("disable", org.jooq.impl.SQLDataType.TINYINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.TINYINT)), this, "是否可用，0 ：可用， 1 ： 不可用");
