...
public class HrThirdPartyAccountRecord extends UpdatableRecordImpl<HrThirdPartyAccountRecord> implements Record17<Integer, Short, String, String, Short, Integer, Integer, Timestamp, Timestamp, Timestamp, Integer, String, String, String, Byte, Byte, Integer> {

    private static final long serialVersionUID = -143957057;
...
会员名称; 猎聘:用户在猎聘的userid; 58:用户在58的openId,accessToken,refreshToken的json串; tw104：token
     ...
     */
    @Override
    public Row17<Integer, Short, String, String, Short, Integer, Integer, Timestamp, Timestamp, Timestamp, Integer, String, String, String, Byte, Byte, Integer> fieldsRow() {
     ...
     */
    @Override
    public Row17<Integer, Short, String, String, Short, Integer, Integer, Timestamp, Timestamp, Timestamp, Integer, String, String, String, Byte, Byte, Integer> valuesRow() {
     ...
     */
    @Override
    public HrThirdPartyAccountRecord value16(Byte value) {
     ...
     */
    @Override
    public HrThirdPartyAccountRecord values(Integer value1, Short value2, String value3, String value4, Short value5, Integer value6, Integer value7, Timestamp value8, Timestamp value9, Timestamp value10, Integer value11, String value12, String value13, String value14, Byte value15, Byte value16, Integer value17) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public HrThirdPartyAccountRecord(Integer id, Short channel, String username, String password, Short binding, Integer companyId, Integer remainNum, Timestamp syncTime, Timestamp updateTime, Timestamp createTime, Integer remainProfileNum, String errorMessage, String ext, String ext2, Byte syncRequireCompany, Byte syncRequireDepartment, Integer templateSender) {
        super(HrThirdPartyAccount.HR_THIRD_PARTY_ACCOUNT);
        ...
        set(12, ext);
        set(13, ext2);
        set(14, syncRequireCompany);
        set(15, syncRequireDepartment);
