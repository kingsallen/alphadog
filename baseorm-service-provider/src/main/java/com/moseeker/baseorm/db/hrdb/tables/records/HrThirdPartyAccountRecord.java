...
public class HrThirdPartyAccountRecord extends UpdatableRecordImpl<HrThirdPartyAccountRecord> implements Record13<Integer, Short, String, String, Short, Integer, Integer, Timestamp, Timestamp, Timestamp, Integer, String, String> {
    ...
    private static final long serialVersionUID = -1284918622;
    ...
    /**
     * Setter for <code>hrdb.hr_third_party_account.binding</code>. 0：未绑定，1:绑定成功，2：绑定中，3：刷新中，4：用户名密码错误，5：绑定或刷新失败，6：绑定程序发生错误（前端和2状态一致），7：刷新程序发生错误（前端和3状态一致）8:绑定成功，正在获取信息
     */
    ...
    /**
     * Getter for <code>hrdb.hr_third_party_account.binding</code>. 0：未绑定，1:绑定成功，2：绑定中，3：刷新中，4：用户名密码错误，5：绑定或刷新失败，6：绑定程序发生错误（前端和2状态一致），7：刷新程序发生错误（前端和3状态一致）8:绑定成功，正在获取信息
     */
     ...
     */
    @Override
    public Row13<Integer, Short, String, String, Short, Integer, Integer, Timestamp, Timestamp, Timestamp, Integer, String, String> fieldsRow() {
     ...
     */
    @Override
    public Row13<Integer, Short, String, String, Short, Integer, Integer, Timestamp, Timestamp, Timestamp, Integer, String, String> valuesRow() {
     ...
     */
    @Override
    public HrThirdPartyAccountRecord values(Integer value1, Short value2, String value3, String value4, Short value5, Integer value6, Integer value7, Timestamp value8, Timestamp value9, Timestamp value10, Integer value11, String value12, String value13) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public HrThirdPartyAccountRecord(Integer id, Short channel, String username, String password, Short binding, Integer companyId, Integer remainNum, Timestamp syncTime, Timestamp updateTime, Timestamp createTime, Integer remainProfileNum, String errorMessage, String ext) {
        super(HrThirdPartyAccount.HR_THIRD_PARTY_ACCOUNT);
