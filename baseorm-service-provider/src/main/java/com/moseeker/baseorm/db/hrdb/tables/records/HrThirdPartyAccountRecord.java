...
public class HrThirdPartyAccountRecord extends UpdatableRecordImpl<HrThirdPartyAccountRecord> implements Record16<Integer, Short, String, String, Short, Integer, Integer, Timestamp, Timestamp, Timestamp, Integer, String, String, String, Byte, Byte> {
    ...
    private static final long serialVersionUID = -1665930145;
    ...
    /**
     * Setter for <code>hrdb.hr_third_party_account.ext2</code>. 扩展字段，目前是由于猎聘登录时会返回token和usereid（用户在猎聘的id）两个字段，分别使用ext和ext2存储该两个字段
     */
    ...
    /**
     * Getter for <code>hrdb.hr_third_party_account.ext2</code>. 扩展字段，目前是由于猎聘登录时会返回token和usereid（用户在猎聘的id）两个字段，分别使用ext和ext2存储该两个字段
     */
     ...
     */
    @Override
    public Row16<Integer, Short, String, String, Short, Integer, Integer, Timestamp, Timestamp, Timestamp, Integer, String, String, String, Byte, Byte> fieldsRow() {
     ...
     */
    @Override
    public Row16<Integer, Short, String, String, Short, Integer, Integer, Timestamp, Timestamp, Timestamp, Integer, String, String, String, Byte, Byte> valuesRow() {
     ...
     */
    @Override
    public HrThirdPartyAccountRecord values(Integer value1, Short value2, String value3, String value4, Short value5, Integer value6, Integer value7, Timestamp value8, Timestamp value9, Timestamp value10, Integer value11, String value12, String value13, String value14, Byte value15, Byte value16) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
