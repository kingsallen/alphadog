...
public class DictCityMap extends TableImpl<DictCityMapRecord> {
    ...
    private static final long serialVersionUID = -433068003;
     ...
     */
    public final TableField<DictCityMapRecord, Integer> CODE_OTHER = createField("code_other", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.INTEGER)), this, "第三方城市字典code");
