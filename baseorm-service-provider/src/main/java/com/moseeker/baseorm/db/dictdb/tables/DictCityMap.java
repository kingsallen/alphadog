...
public class DictCityMap extends TableImpl<DictCityMapRecord> {
    ...
    private static final long serialVersionUID = -1298349460;
    ...
    /**
     * The column <code>dictdb.dict_city_map.channel</code>. 渠道 1 51job 2 猎聘 3 智联 4 linkedin 11 job58
     */
    public final TableField<DictCityMapRecord, Integer> CHANNEL = createField("channel", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.INTEGER)), this, "渠道 1 51job 2 猎聘 3 智联 4 linkedin 11 job58");
