...
public class DictPositionRecord extends TableRecordImpl<DictPositionRecord> implements Record4<Integer, String, Integer, Byte> {

    private static final long serialVersionUID = -334046894;
