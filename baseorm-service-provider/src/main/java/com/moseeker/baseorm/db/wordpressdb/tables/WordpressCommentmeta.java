...
public class WordpressCommentmeta extends TableImpl<WordpressCommentmetaRecord> {
    ...
    private static final long serialVersionUID = 1563297554;
     ...
     */
    public final TableField<WordpressCommentmetaRecord, Long> COMMENT_ID = createField("comment_id", org.jooq.impl.SQLDataType.BIGINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.BIGINT)), this, "");
