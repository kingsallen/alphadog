...
public class CampaignEdmUserrecommendedPositions extends TableImpl<CampaignEdmUserrecommendedPositionsRecord> {
    ...
    private static final long serialVersionUID = -524814512;
     ...
     */
    public final TableField<CampaignEdmUserrecommendedPositionsRecord, Double> SCORE = createField("score", org.jooq.impl.SQLDataType.FLOAT.nullable(false).defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.FLOAT)), this, "推荐分");

    /**
     * The column <code>campaigndb.campaign_edm_userrecommended_positions.create_time</code>.
     */
    public final TableField<CampaignEdmUserrecommendedPositionsRecord, Timestamp> CREATE_TIME = createField("create_time", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.inline("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "");
