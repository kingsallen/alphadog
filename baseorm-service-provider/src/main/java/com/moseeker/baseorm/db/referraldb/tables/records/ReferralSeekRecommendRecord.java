...
public class ReferralSeekRecommendRecord extends UpdatableRecordImpl<ReferralSeekRecommendRecord> implements Record9<Integer, Integer, Integer, Integer, Integer, Integer, Timestamp, Timestamp, Timestamp> {

    private static final long serialVersionUID = 679818269;
    ...
    /**
     * Setter for <code>referraldb.referral_seek_recommend.origin</code>. 间接内推来源 1：转发 2：连连看
     */
    ...
    /**
     * Getter for <code>referraldb.referral_seek_recommend.origin</code>. 间接内推来源 1：转发 2：连连看
     */
    ...
    /**
     * Setter for <code>referraldb.referral_seek_recommend.recommend_time</code>. 求推荐时间
     */
    ...
    /**
     * Getter for <code>referraldb.referral_seek_recommend.recommend_time</code>. 求推荐时间
     */
     ...
     */
    @Override
    public Row9<Integer, Integer, Integer, Integer, Integer, Integer, Timestamp, Timestamp, Timestamp> fieldsRow() {
     ...
     */
    @Override
    public Row9<Integer, Integer, Integer, Integer, Integer, Integer, Timestamp, Timestamp, Timestamp> valuesRow() {
     ...
     */
    @Override
    public ReferralSeekRecommendRecord value6(Integer value) {
        setOrigin(value);
        return this;
    }
     ...
     */
    @Override
    public ReferralSeekRecommendRecord value8(Timestamp value) {
        setCreateTime(value);
        return this;
    }
     ...
     */
    @Override
    public ReferralSeekRecommendRecord values(Integer value1, Integer value2, Integer value3, Integer value4, Integer value5, Integer value6, Timestamp value7, Timestamp value8, Timestamp value9) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public ReferralSeekRecommendRecord(Integer id, Integer postUserId, Integer presenteeId, Integer positionId, Integer appId, Integer origin, Timestamp recommendTime, Timestamp createTime, Timestamp updateTime) {
        super(ReferralSeekRecommend.REFERRAL_SEEK_RECOMMEND);
