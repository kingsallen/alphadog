...
public class ReferralSeekRecommendRecord extends UpdatableRecordImpl<ReferralSeekRecommendRecord> implements Record8<Integer, Integer, Integer, Integer, Integer, Timestamp, Timestamp, Integer> {
     ...
     */
    @Override
    public Row8<Integer, Integer, Integer, Integer, Integer, Timestamp, Timestamp, Integer> fieldsRow() {
     ...
     */
    @Override
    public Row8<Integer, Integer, Integer, Integer, Integer, Timestamp, Timestamp, Integer> valuesRow() {
     ...
     */
    @Override
    public ReferralSeekRecommendRecord values(Integer value1, Integer value2, Integer value3, Integer value4, Integer value5, Timestamp value6, Timestamp value7, Integer value8) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public ReferralSeekRecommendRecord(Integer id, Integer postUserId, Integer presenteeUserId, Integer positionId, Integer appId, Timestamp createTime, Timestamp updateTime, Integer origin) {
        super(ReferralSeekRecommend.REFERRAL_SEEK_RECOMMEND);
