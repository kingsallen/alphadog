...
public class UserUserTmp extends TableImpl<UserUserTmpRecord> {
	...
	private static final long serialVersionUID = -364276332;
	 ...
	 */
	public final TableField<UserUserTmpRecord, Integer> ID = createField("id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaulted(true), this, "主key");
	 ...
	 */
	public final TableField<UserUserTmpRecord, Integer> PARENTID = createField("parentid", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaulted(true), this, "合并到了新用户的id");
