...
public class HrWxNoticeMessageRecord extends UpdatableRecordImpl<HrWxNoticeMessageRecord> implements Record7<Integer, Integer, Integer, String, String, Byte, Byte> {

    private static final long serialVersionUID = -1881229737;
     ...
     */
    @Override
    public Row7<Integer, Integer, Integer, String, String, Byte, Byte> fieldsRow() {
     ...
     */
    @Override
    public Row7<Integer, Integer, Integer, String, String, Byte, Byte> valuesRow() {
     ...
     */
    @Override
    public HrWxNoticeMessageRecord values(Integer value1, Integer value2, Integer value3, String value4, String value5, Byte value6, Byte value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public HrWxNoticeMessageRecord(Integer id, Integer wechatId, Integer noticeId, String first, String remark, Byte status, Byte disable) {
        super(HrWxNoticeMessage.HR_WX_NOTICE_MESSAGE);
