...
public class WordpressPosts extends TableImpl<WordpressPostsRecord> {
	 ...
	 */
	public final TableField<WordpressPostsRecord, ULong> ID = createField("ID", org.jooq.impl.SQLDataType.BIGINTUNSIGNED.nullable(false), this, "");

	/**
	 * The column <code>wordpressdb.wordpress_posts.post_author</code>.
	 */
	public final TableField<WordpressPostsRecord, ULong> POST_AUTHOR = createField("post_author", org.jooq.impl.SQLDataType.BIGINTUNSIGNED.nullable(false).defaulted(true), this, "");
	 ...
	 */
	public final TableField<WordpressPostsRecord, String> POST_STATUS = createField("post_status", org.jooq.impl.SQLDataType.VARCHAR.length(20).nullable(false).defaulted(true), this, "");

	/**
	 * The column <code>wordpressdb.wordpress_posts.comment_status</code>.
	 */
	public final TableField<WordpressPostsRecord, String> COMMENT_STATUS = createField("comment_status", org.jooq.impl.SQLDataType.VARCHAR.length(20).nullable(false).defaulted(true), this, "");

	/**
	 * The column <code>wordpressdb.wordpress_posts.ping_status</code>.
	 */
	public final TableField<WordpressPostsRecord, String> PING_STATUS = createField("ping_status", org.jooq.impl.SQLDataType.VARCHAR.length(20).nullable(false).defaulted(true), this, "");

	/**
	 * The column <code>wordpressdb.wordpress_posts.post_password</code>.
	 */
	public final TableField<WordpressPostsRecord, String> POST_PASSWORD = createField("post_password", org.jooq.impl.SQLDataType.VARCHAR.length(20).nullable(false).defaulted(true), this, "");

	/**
	 * The column <code>wordpressdb.wordpress_posts.post_name</code>.
	 */
	public final TableField<WordpressPostsRecord, String> POST_NAME = createField("post_name", org.jooq.impl.SQLDataType.VARCHAR.length(200).nullable(false).defaulted(true), this, "");
	 ...
	 */
	public final TableField<WordpressPostsRecord, ULong> POST_PARENT = createField("post_parent", org.jooq.impl.SQLDataType.BIGINTUNSIGNED.nullable(false).defaulted(true), this, "");

	/**
	 * The column <code>wordpressdb.wordpress_posts.guid</code>.
	 */
	public final TableField<WordpressPostsRecord, String> GUID = createField("guid", org.jooq.impl.SQLDataType.VARCHAR.length(255).nullable(false).defaulted(true), this, "");

	/**
	 * The column <code>wordpressdb.wordpress_posts.menu_order</code>.
	 */
	public final TableField<WordpressPostsRecord, Integer> MENU_ORDER = createField("menu_order", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaulted(true), this, "");

	/**
	 * The column <code>wordpressdb.wordpress_posts.post_type</code>.
	 */
	public final TableField<WordpressPostsRecord, String> POST_TYPE = createField("post_type", org.jooq.impl.SQLDataType.VARCHAR.length(20).nullable(false).defaulted(true), this, "");

	/**
	 * The column <code>wordpressdb.wordpress_posts.post_mime_type</code>.
	 */
	public final TableField<WordpressPostsRecord, String> POST_MIME_TYPE = createField("post_mime_type", org.jooq.impl.SQLDataType.VARCHAR.length(100).nullable(false).defaulted(true), this, "");

	/**
	 * The column <code>wordpressdb.wordpress_posts.comment_count</code>.
	 */
	public final TableField<WordpressPostsRecord, Long> COMMENT_COUNT = createField("comment_count", org.jooq.impl.SQLDataType.BIGINT.nullable(false).defaulted(true), this, "");
	 ...
	 */
	@Override
	public Identity<WordpressPostsRecord, ULong> getIdentity() {
