...
public class CampaignPcBannerRecord extends UpdatableRecordImpl<CampaignPcBannerRecord> implements Record6<Integer, String, String, Integer, Timestamp, Timestamp> {

    private static final long serialVersionUID = 127549103;
    ...
    /**
     * Setter for <code>campaigndb.campaign_pc_banner.url</code>. 图片链接
     */
    ...
    /**
     * Getter for <code>campaigndb.campaign_pc_banner.url</code>. 图片链接
     */
    ...
    public Field<String> field2() {
        return CampaignPcBanner.CAMPAIGN_PC_BANNER.URL;
    }
     ...
     */
    @Override
    public CampaignPcBannerRecord value4(Integer value) {
        setDisable(value);
        return this;
    }
     ...
     */
    @Override
    public CampaignPcBannerRecord values(Integer value1, String value2, String value3, Integer value4, Timestamp value5, Timestamp value6) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public CampaignPcBannerRecord(Integer id, String url, String imgUrl, Integer disable, Timestamp createTime, Timestamp updateTime) {
        super(CampaignPcBanner.CAMPAIGN_PC_BANNER);
