...
public class JobApplicationRemark implements Serializable {

    private static final long serialVersionUID = -1717132347;
    ...
    public JobApplicationRemark(JobApplicationRemark value) {
        this.id = value.id;
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("JobApplicationRemark (");
