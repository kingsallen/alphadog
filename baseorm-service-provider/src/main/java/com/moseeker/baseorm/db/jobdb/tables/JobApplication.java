...
public class JobApplication extends TableImpl<JobApplicationRecord> {
    ...
    private static final long serialVersionUID = -466361351;
...
:员工主动推荐; 65536:内推, 131072：58同步；262144：间接内推(联系内推)，524288：间接内推(邀请投递), 1048576 间接内推(转发投递)， 2097152:老员工回聘，4194304：员工转岗 ，8388608 猎头上传，16777216 hr推荐
     ...
     */
    public final TableField<JobApplicationRecord, String> ATS_ERRMSG = createField("ats_errmsg", org.jooq.impl.SQLDataType.VARCHAR.length(6000), this, "ats同步错误信息");
