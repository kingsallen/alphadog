...
public class JobApplication extends TableImpl<JobApplicationRecord> {
    ...
    private static final long serialVersionUID = -2028413149;
     ...
     */
    public final TableField<JobApplicationRecord, Integer> WECHAT_ID = createField("wechat_id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "sys_wechat.id, 公众号ID");
     ...
     */
    public final TableField<JobApplicationRecord, Integer> RECOMMENDER_ID = createField("recommender_id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "user_wx_user.id, 微信ID。现在已经废弃，推荐者信息请参考recommend_user_id");
     ...
     */
    public final TableField<JobApplicationRecord, Integer> STATUS_ID = createField("status_id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "hr_award_config.id, 申请状态ID");

    /**
     * The column <code>jobdb.job_application.l_application_id</code>. ATS的申请ID
     */
    public final TableField<JobApplicationRecord, Integer> L_APPLICATION_ID = createField("l_application_id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "ATS的申请ID");

    /**
     * The column <code>jobdb.job_application.reward</code>. 当前申请的积分记录
     */
    public final TableField<JobApplicationRecord, Integer> REWARD = createField("reward", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "当前申请的积分记录");

    /**
     * The column <code>jobdb.job_application.source_id</code>. 已废弃,job_source.id, 对应的ATS ID
     */
    public final TableField<JobApplicationRecord, Integer> SOURCE_ID = createField("source_id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "已废弃,job_source.id, 对应的ATS ID");
     ...
     */
    public final TableField<JobApplicationRecord, Integer> APPLIER_ID = createField("applier_id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "sys_user.id, 用户ID");

    /**
     * The column <code>jobdb.job_application.interview_id</code>. app_interview.id, 面试ID
     */
    public final TableField<JobApplicationRecord, Integer> INTERVIEW_ID = createField("interview_id", org.jooq.impl.SQLDataType.INTEGER.defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "app_interview.id, 面试ID");
     ...
     */
    public final TableField<JobApplicationRecord, Integer> ROUTINE = createField("routine", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "申请来源 0:微信企业端 1:微信聚合端 10:pc端");
     ...
     */
    public final TableField<JobApplicationRecord, Integer> COMPANY_ID = createField("company_id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "company.id，公司表ID");
     ...
     */
    public final TableField<JobApplicationRecord, Integer> APP_TPL_ID = createField("app_tpl_id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "申请状态,hr_award_config_template.id");
     ...
     */
    public final TableField<JobApplicationRecord, Integer> APPLY_TYPE = createField("apply_type", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "投递区分， 0：profile投递， 1：email投递");

    /**
     * The column <code>jobdb.job_application.email_status</code>. 0，有效；1,未收到回复邮件；2，文件格式不支持；3，附件超过10M；9，提取邮件失败
     */
    public final TableField<JobApplicationRecord, Integer> EMAIL_STATUS = createField("email_status", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "0，有效；1,未收到回复邮件；2，文件格式不支持；3，附件超过10M；9，提取邮件失败");

    /**
     * The column <code>jobdb.job_application.view_count</code>. profile浏览次数
     */
    public final TableField<JobApplicationRecord, Integer> VIEW_COUNT = createField("view_count", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "profile浏览次数");

    /**
     * The column <code>jobdb.job_application.recommender_user_id</code>. userdb.user_user.id 推荐人编号
     */
    public final TableField<JobApplicationRecord, Integer> RECOMMENDER_USER_ID = createField("recommender_user_id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "userdb.user_user.id 推荐人编号");

    /**
     * The column <code>jobdb.job_application.origin</code>. 简历来源 1 PC;2 企业号；4 聚合好； 8 51； 16 智联； 32 猎聘； 64 支付宝； 128 简历抽取； 256 员工代投 
     */
    public final TableField<JobApplicationRecord, Integer> ORIGIN = createField("origin", org.jooq.impl.SQLDataType.INTEGER.defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "简历来源 1 PC;2 企业号；4 聚合好； 8 51； 16 智联； 32 猎聘； 64 支付宝； 128 简历抽取； 256 员工代投 ");
