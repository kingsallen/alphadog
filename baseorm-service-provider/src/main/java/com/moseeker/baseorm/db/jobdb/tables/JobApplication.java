...
public class JobApplication extends TableImpl<JobApplicationRecord> {
    ...
    private static final long serialVersionUID = 1784635376;
    ...
    /**
     * The column <code>jobdb.job_application.recommender_id</code>. user_wx_user.id, 微信ID。现在推荐者信息请参考recommend_user_id
     */
    public final TableField<JobApplicationRecord, UInteger> RECOMMENDER_ID = createField("recommender_id", org.jooq.impl.SQLDataType.INTEGERUNSIGNED.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGERUNSIGNED)), this, "user_wx_user.id, 微信ID。现在推荐者信息请参考recommend_user_id");
     ...
     */
    public final TableField<JobApplicationRecord, UInteger> RECOMMENDER_USER_ID = createField("recommender_user_id", org.jooq.impl.SQLDataType.INTEGERUNSIGNED, this, "userdb.user_user.id 推荐人编号");
