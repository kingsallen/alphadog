...
public class JobApplication extends TableImpl<JobApplicationRecord> {
    ...
    private static final long serialVersionUID = 536995078;
    ...
    /**
     * The column <code>jobdb.job_application.position_id</code>. job_position.id, 职位ID
     */
    public final TableField<JobApplicationRecord, Integer> POSITION_ID = createField("position_id", org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "job_position.id, 职位ID");
    ...
    /**
     * The column <code>jobdb.job_application.origin</code>. 申请来源 1 PC;2 企业号；4 聚合号； 8 51； 16 智联； 32 猎聘； 64 支付宝； 128 简历抽取； 256 员工代投 ; 512:程序导入（和黄简历导入）; 1024: email 申请; 2048:最佳东方;4096:一览英才;8192:JobsDB;16384:民航; 32768:员工主动推荐; 65536:内推, 131072：58同步；262144：间接内推(联系内推)，524288：间接内推(邀请投递), 1048576 间接内推(转发投递)
     */
    public final TableField<JobApplicationRecord, Integer> ORIGIN = createField("origin", org.jooq.impl.SQLDataType.INTEGER.defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.INTEGER)), this, "申请来源 1 PC;2 企业号；4 聚合号； 8 51； 16 智联； 32 猎聘； 64 支付宝； 128 简历抽取； 256 员工代投 ; 512:程序导入（和黄简历导入）; 1024: email 申请; 2048:最佳东方;4096:一览英才;8192:JobsDB;16384:民航; 32768:员工主动推荐; 65536:内推, 131072：58同步；262144：间接内推(联系内推)，524288：间接内推(邀请投递), 1048576 间接内推(转发投递)");
