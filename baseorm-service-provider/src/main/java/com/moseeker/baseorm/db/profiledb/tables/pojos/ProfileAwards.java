...
public class ProfileAwards implements Serializable {

    private static final long serialVersionUID = 701471718;
    ...
    public ProfileAwards(ProfileAwards value) {
        this.id = value.id;
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("ProfileAwards (");
