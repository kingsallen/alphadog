...
public class CampaignEmailAgentdelivery extends TableImpl<CampaignEmailAgentdeliveryRecord> {
     ...
     */
    public final TableField<CampaignEmailAgentdeliveryRecord, String> FRIENDNAME = createField("friendname", org.jooq.impl.SQLDataType.VARCHAR.length(20).nullable(false).defaultValue(org.jooq.impl.DSL.field("", org.jooq.impl.SQLDataType.VARCHAR)), this, "推荐朋友姓名");

    /**
     * The column <code>campaigndb.campaign_email_agentdelivery.email</code>. 推荐朋友的邮
     */
    public final TableField<CampaignEmailAgentdeliveryRecord, String> EMAIL = createField("email", org.jooq.impl.SQLDataType.VARCHAR.length(20).nullable(false).defaultValue(org.jooq.impl.DSL.field("", org.jooq.impl.SQLDataType.VARCHAR)), this, "推荐朋友的邮");
     ...
     */
    public final TableField<CampaignEmailAgentdeliveryRecord, String> FNAME = createField("fname", org.jooq.impl.SQLDataType.VARCHAR.length(50).nullable(false).defaultValue(org.jooq.impl.DSL.field("", org.jooq.impl.SQLDataType.VARCHAR)), this, "附件原始名称");

    /**
     * The column <code>campaigndb.campaign_email_agentdelivery.uname</code>. 附件存储名称
     */
    public final TableField<CampaignEmailAgentdeliveryRecord, String> UNAME = createField("uname", org.jooq.impl.SQLDataType.VARCHAR.length(50).nullable(false).defaultValue(org.jooq.impl.DSL.field("", org.jooq.impl.SQLDataType.VARCHAR)), this, "附件存储名称");

    /**
     * The column <code>campaigndb.campaign_email_agentdelivery.code</code>. 发送邮件时携带的code
     */
    public final TableField<CampaignEmailAgentdeliveryRecord, String> CODE = createField("code", org.jooq.impl.SQLDataType.VARCHAR.length(36).nullable(false).defaultValue(org.jooq.impl.DSL.field("", org.jooq.impl.SQLDataType.VARCHAR)), this, "发送邮件时携带的code");

    /**
     * The column <code>campaigndb.campaign_email_agentdelivery.create_time</code>. 记录创建时间
     */
    public final TableField<CampaignEmailAgentdeliveryRecord, Timestamp> CREATE_TIME = createField("create_time", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "记录创建时间");

    /**
     * The column <code>campaigndb.campaign_email_agentdelivery.update_time</code>. 更新时间
     */
    public final TableField<CampaignEmailAgentdeliveryRecord, Timestamp> UPDATE_TIME = createField("update_time", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "更新时间");

    /**
     * The column <code>campaigndb.campaign_email_agentdelivery.description</code>. 上传文件描述
     */
    public final TableField<CampaignEmailAgentdeliveryRecord, String> DESCRIPTION = createField("description", org.jooq.impl.SQLDataType.VARCHAR.length(100).nullable(false).defaultValue(org.jooq.impl.DSL.field("", org.jooq.impl.SQLDataType.VARCHAR)), this, "上传文件描述");
