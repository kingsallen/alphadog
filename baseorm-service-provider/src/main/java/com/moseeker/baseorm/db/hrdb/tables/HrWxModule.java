...
public class HrWxModule extends TableImpl<HrWxModuleRecord> {
    ...
    private static final long serialVersionUID = -36066236;
     ...
     */
    public final TableField<HrWxModuleRecord, Byte> ISSYSTEM = createField("issystem", org.jooq.impl.SQLDataType.TINYINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.TINYINT)), this, "是否是系统模块");
