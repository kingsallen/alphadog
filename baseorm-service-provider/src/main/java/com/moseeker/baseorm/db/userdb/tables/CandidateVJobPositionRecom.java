...
public class CandidateVJobPositionRecom extends TableImpl<CandidateVJobPositionRecomRecord> {
	...
	private static final long serialVersionUID = -265017320;
	 ...
	 */
	public final TableField<CandidateVJobPositionRecomRecord, Long> RECOM_ID = createField("recom_id", org.jooq.impl.SQLDataType.BIGINT.nullable(false).defaulted(true), this, "userdb.user_wx_user.id 分享用户微信ID。现在已经废弃，请参考sysuser_id字段");
