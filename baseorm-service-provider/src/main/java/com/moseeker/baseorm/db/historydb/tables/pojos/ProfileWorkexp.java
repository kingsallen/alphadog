...
public class ProfileWorkexp implements Serializable {

    private static final long serialVersionUID = -1126193864;
    ...
    public ProfileWorkexp(ProfileWorkexp value) {
        this.id = value.id;
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("ProfileWorkexp (");
