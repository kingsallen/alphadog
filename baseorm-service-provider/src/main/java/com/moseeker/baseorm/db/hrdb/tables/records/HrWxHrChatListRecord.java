...
public class HrWxHrChatListRecord extends UpdatableRecordImpl<HrWxHrChatListRecord> implements Record8<UInteger, Integer, Integer, Byte, Timestamp, Timestamp, Timestamp, Timestamp> {

	private static final long serialVersionUID = -1515290588;
	 ...
	 */
	@Override
	public Row8<UInteger, Integer, Integer, Byte, Timestamp, Timestamp, Timestamp, Timestamp> fieldsRow() {
	 ...
	 */
	@Override
	public Row8<UInteger, Integer, Integer, Byte, Timestamp, Timestamp, Timestamp, Timestamp> valuesRow() {
	 ...
	 */
	@Override
	public HrWxHrChatListRecord values(UInteger value1, Integer value2, Integer value3, Byte value4, Timestamp value5, Timestamp value6, Timestamp value7, Timestamp value8) {
		value1(value1);
		value2(value2);
		value3(value3);
		value4(value4);
	 ...
	 */
	public HrWxHrChatListRecord(UInteger id, Integer sysuserId, Integer hraccountId, Byte status, Timestamp createTime, Timestamp wxChatTime, Timestamp hrChatTime, Timestamp updateTime) {
		super(HrWxHrChatList.HR_WX_HR_CHAT_LIST);
