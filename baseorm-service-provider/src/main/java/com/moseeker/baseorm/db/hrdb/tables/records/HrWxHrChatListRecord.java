...
public class HrWxHrChatListRecord extends UpdatableRecordImpl<HrWxHrChatListRecord> implements Record10<Integer, Integer, Integer, Timestamp, Timestamp, Timestamp, Timestamp, Integer, Integer, Byte> {

    private static final long serialVersionUID = 2034968366;
    ...
    /**
     * Setter for <code>hrdb.hr_wx_hr_chat_list.welcome_status</code>. 是否需要触发欢迎语的推送 0 不需要 1需要
     */
    public void setWelcomeStatus(Byte value) {
        set(9, value);
    }

    /**
     * Getter for <code>hrdb.hr_wx_hr_chat_list.welcome_status</code>. 是否需要触发欢迎语的推送 0 不需要 1需要
     */
     ...
     */
    @Override
    public Row10<Integer, Integer, Integer, Timestamp, Timestamp, Timestamp, Timestamp, Integer, Integer, Byte> fieldsRow() {
     ...
     */
    @Override
    public Row10<Integer, Integer, Integer, Timestamp, Timestamp, Timestamp, Timestamp, Integer, Integer, Byte> valuesRow() {
    ...
    public Field<Byte> field10() {
        return HrWxHrChatList.HR_WX_HR_CHAT_LIST.WELCOME_STATUS;
    }
     ...
     */
    @Override
    public HrWxHrChatListRecord value10(Byte value) {
     ...
     */
    @Override
    public HrWxHrChatListRecord values(Integer value1, Integer value2, Integer value3, Timestamp value4, Timestamp value5, Timestamp value6, Timestamp value7, Integer value8, Integer value9, Byte value10) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public HrWxHrChatListRecord(Integer id, Integer sysuserId, Integer hraccountId, Timestamp createTime, Timestamp wxChatTime, Timestamp hrChatTime, Timestamp updateTime, Integer hrUnreadCount, Integer userUnreadCount, Byte welcomeStatus) {
        super(HrWxHrChatList.HR_WX_HR_CHAT_LIST);
