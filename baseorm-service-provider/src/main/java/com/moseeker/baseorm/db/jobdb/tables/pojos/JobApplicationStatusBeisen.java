...
public class JobApplicationStatusBeisen implements Serializable {

    private static final long serialVersionUID = 957109881;
    ...
    public JobApplicationStatusBeisen(JobApplicationStatusBeisen value) {
        this.id = value.id;
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("JobApplicationStatusBeisen (");
