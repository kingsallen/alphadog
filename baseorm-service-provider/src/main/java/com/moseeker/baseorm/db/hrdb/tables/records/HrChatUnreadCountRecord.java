...
public class HrChatUnreadCountRecord extends UpdatableRecordImpl<HrChatUnreadCountRecord> implements Record9<Integer, Integer, Integer, Timestamp, Timestamp, Byte, Byte, Byte, Timestamp> {

    private static final long serialVersionUID = 1445582840;
     ...
     */
    @Override
    public Row9<Integer, Integer, Integer, Timestamp, Timestamp, Byte, Byte, Byte, Timestamp> fieldsRow() {
     ...
     */
    @Override
    public Row9<Integer, Integer, Integer, Timestamp, Timestamp, Byte, Byte, Byte, Timestamp> valuesRow() {
     ...
     */
    @Override
    public HrChatUnreadCountRecord values(Integer value1, Integer value2, Integer value3, Timestamp value4, Timestamp value5, Byte value6, Byte value7, Byte value8, Timestamp value9) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public HrChatUnreadCountRecord(Integer roomId, Integer hrId, Integer userId, Timestamp wxChatTime, Timestamp hrChatTime, Byte hrHaveUnreadMsg, Byte userHaveUnreadMsg, Byte apply, Timestamp updateTime) {
        super(HrChatUnreadCount.HR_CHAT_UNREAD_COUNT);
