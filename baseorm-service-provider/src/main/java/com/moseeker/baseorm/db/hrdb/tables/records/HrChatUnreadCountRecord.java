...
public class HrChatUnreadCountRecord extends UpdatableRecordImpl<HrChatUnreadCountRecord> implements Record7<Integer, Timestamp, Timestamp, Byte, Byte, Integer, Integer> {

    private static final long serialVersionUID = -1591256890;
     ...
     */
    @Override
    public Row7<Integer, Timestamp, Timestamp, Byte, Byte, Integer, Integer> fieldsRow() {
     ...
     */
    @Override
    public Row7<Integer, Timestamp, Timestamp, Byte, Byte, Integer, Integer> valuesRow() {
     ...
     */
    @Override
    public HrChatUnreadCountRecord values(Integer value1, Timestamp value2, Timestamp value3, Byte value4, Byte value5, Integer value6, Integer value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public HrChatUnreadCountRecord(Integer roomId, Timestamp wxChatTime, Timestamp hrChatTime, Byte hrHaveUnreadMsg, Byte userHaveUnreadMsg, Integer hrId, Integer userId) {
        super(HrChatUnreadCount.HR_CHAT_UNREAD_COUNT);
