...
public class ReferralEmployeeNetworkResourcesRecord extends UpdatableRecordImpl<ReferralEmployeeNetworkResourcesRecord> implements Record7<Integer, Integer, Integer, Timestamp, Timestamp, Byte, Integer> {

    private static final long serialVersionUID = 1161651344;
     ...
     */
    @Override
    public Row7<Integer, Integer, Integer, Timestamp, Timestamp, Byte, Integer> fieldsRow() {
     ...
     */
    @Override
    public Row7<Integer, Integer, Integer, Timestamp, Timestamp, Byte, Integer> valuesRow() {
     ...
     */
    @Override
    public ReferralEmployeeNetworkResourcesRecord values(Integer value1, Integer value2, Integer value3, Timestamp value4, Timestamp value5, Byte value6, Integer value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public ReferralEmployeeNetworkResourcesRecord(Integer id, Integer postUserId, Integer presenteeUserId, Timestamp createTime, Timestamp updateTime, Byte disable, Integer companyId) {
        super(ReferralEmployeeNetworkResources.REFERRAL_EMPLOYEE_NETWORK_RESOURCES);
