...
public class ConfigSysPointsConfTpl extends TableImpl<ConfigSysPointsConfTplRecord> {
    ...
    private static final long serialVersionUID = -41194113;
     ...
     */
    public final TableField<ConfigSysPointsConfTplRecord, Integer> AWARD = createField("award", org.jooq.impl.SQLDataType.INTEGER.defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "奖励积分");
     ...
     */
    public final TableField<ConfigSysPointsConfTplRecord, Integer> TYPE_ID = createField("type_id", org.jooq.impl.SQLDataType.INTEGER.defaultValue(org.jooq.impl.DSL.field("1", org.jooq.impl.SQLDataType.INTEGER)), this, "多套模板");

    /**
     * The column <code>configdb.config_sys_points_conf_tpl.tag</code>. inteview tag
     */
    public final TableField<ConfigSysPointsConfTplRecord, Byte> TAG = createField("tag", org.jooq.impl.SQLDataType.TINYINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("1", org.jooq.impl.SQLDataType.TINYINT)), this, "inteview tag");

    /**
     * The column <code>configdb.config_sys_points_conf_tpl.is_init_award</code>. 推荐积分初始化0:需要 1:不需要
     */
    public final TableField<ConfigSysPointsConfTplRecord, Byte> IS_INIT_AWARD = createField("is_init_award", org.jooq.impl.SQLDataType.TINYINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.TINYINT)), this, "推荐积分初始化0:需要 1:不需要");

    /**
     * The column <code>configdb.config_sys_points_conf_tpl.recruit_order</code>. 招聘进度顺序
     */
    public final TableField<ConfigSysPointsConfTplRecord, Integer> RECRUIT_ORDER = createField("recruit_order", org.jooq.impl.SQLDataType.INTEGER.defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "招聘进度顺序");

    /**
     * The column <code>configdb.config_sys_points_conf_tpl.applier_view</code>. 求职者的文案
     */
    public final TableField<ConfigSysPointsConfTplRecord, String> APPLIER_VIEW = createField("applier_view", org.jooq.impl.SQLDataType.VARCHAR.length(128).nullable(false).defaultValue(org.jooq.impl.DSL.field("", org.jooq.impl.SQLDataType.VARCHAR)), this, "求职者的文案");
