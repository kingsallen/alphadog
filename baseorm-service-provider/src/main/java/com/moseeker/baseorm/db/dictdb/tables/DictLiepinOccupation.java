...
public class DictLiepinOccupation extends TableImpl<DictLiepinOccupationRecord> {
    ...
    private static final long serialVersionUID = -1850488775;
     ...
     */
    public final TableField<DictLiepinOccupationRecord, Integer> CODE = createField("code", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "仟寻生成的code，和仟寻的职位职能无关");

    /**
     * The column <code>dictdb.dict_liepin_occupation.parent_id</code>. 上一级的职能id
     */
    public final TableField<DictLiepinOccupationRecord, Integer> PARENT_ID = createField("parent_id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "上一级的职能id");

    /**
     * The column <code>dictdb.dict_liepin_occupation.other_code</code>. 猎聘的code，可能是字符串
     */
    public final TableField<DictLiepinOccupationRecord, String> OTHER_CODE = createField("other_code", org.jooq.impl.SQLDataType.VARCHAR.length(64).nullable(false).defaultValue(org.jooq.impl.DSL.field("", org.jooq.impl.SQLDataType.VARCHAR)), this, "猎聘的code，可能是字符串");

    /**
     * The column <code>dictdb.dict_liepin_occupation.level</code>. 级层
     */
    public final TableField<DictLiepinOccupationRecord, Integer> LEVEL = createField("level", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "级层");

    /**
     * The column <code>dictdb.dict_liepin_occupation.create_time</code>.
     */
    public final TableField<DictLiepinOccupationRecord, Timestamp> CREATE_TIME = createField("create_time", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "");

    /**
     * The column <code>dictdb.dict_liepin_occupation.update_time</code>.
     */
    public final TableField<DictLiepinOccupationRecord, Timestamp> UPDATE_TIME = createField("update_time", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "");

    /**
     * The column <code>dictdb.dict_liepin_occupation.status</code>. 状态 0:有效，1:无效
     */
    public final TableField<DictLiepinOccupationRecord, Integer> STATUS = createField("status", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "状态 0:有效，1:无效");

    /**
     * The column <code>dictdb.dict_liepin_occupation.name</code>.
     */
    public final TableField<DictLiepinOccupationRecord, String> NAME = createField("name", org.jooq.impl.SQLDataType.VARCHAR.length(128).nullable(false).defaultValue(org.jooq.impl.DSL.field("", org.jooq.impl.SQLDataType.VARCHAR)), this, "");
