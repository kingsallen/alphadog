...
public class HrSearchCondition extends TableImpl<HrSearchConditionRecord> {
    ...
    private static final long serialVersionUID = -633619831;
     ...
     */
    public final TableField<HrSearchConditionRecord, String> PUBLISHER = createField("publisher", org.jooq.impl.SQLDataType.VARCHAR.length(255).nullable(false), this, "发布人id(user_hr_account.id)，多个发布人用,隔开");

    /**
     * The column <code>hrdb.hr_search_condition.position_id</code>. 职位id,多个职位用,隔开
     */
    public final TableField<HrSearchConditionRecord, String> POSITION_ID = createField("position_id", org.jooq.impl.SQLDataType.VARCHAR.length(255).nullable(false), this, "职位id,多个职位用,隔开");
     ...
     */
    public final TableField<HrSearchConditionRecord, Byte> CANDIDATE_SOURCE = createField("candidate_source", org.jooq.impl.SQLDataType.TINYINT, this, "0，社招，1，校招，2定向招聘");
     ...
     */
    public final TableField<HrSearchConditionRecord, String> ORIGINS = createField("origins", org.jooq.impl.SQLDataType.VARCHAR.length(128).nullable(false), this, "简历来源，申请来源，是否上传，多个之间用,隔开");
     ...
     */
    public final TableField<HrSearchConditionRecord, String> TAG_IDS = createField("tag_ids", org.jooq.impl.SQLDataType.VARCHAR.length(128).nullable(false), this, "标签id  -1 全部公开0我的收藏 其他则为tag_id，多个之间用逗号隔开");
