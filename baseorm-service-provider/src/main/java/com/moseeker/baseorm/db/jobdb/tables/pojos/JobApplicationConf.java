...
public class JobApplicationConf implements Serializable {

    private static final long serialVersionUID = 1621166857;
    ...
    public JobApplicationConf(JobApplicationConf value) {
        this.id = value.id;
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("JobApplicationConf (");
