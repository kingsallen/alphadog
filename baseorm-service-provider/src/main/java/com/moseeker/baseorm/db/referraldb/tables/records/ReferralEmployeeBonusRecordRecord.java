...
public class ReferralEmployeeBonusRecordRecord extends UpdatableRecordImpl<ReferralEmployeeBonusRecordRecord> implements Record9<Integer, Integer, Integer, Integer, Integer, Byte, Timestamp, Timestamp, Timestamp> {

    private static final long serialVersionUID = 1173800808;
     ...
     */
    @Override
    public ReferralEmployeeBonusRecordRecord values(Integer value1, Integer value2, Integer value3, Integer value4, Integer value5, Byte value6, Timestamp value7, Timestamp value8, Timestamp value9) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public ReferralEmployeeBonusRecordRecord(Integer id, Integer employeeId, Integer applicationId, Integer bonusStageDetailId, Integer bonus, Byte claim, Timestamp claimTime, Timestamp createTime, Timestamp updateTime) {
        super(ReferralEmployeeBonusRecord.REFERRAL_EMPLOYEE_BONUS_RECORD);
