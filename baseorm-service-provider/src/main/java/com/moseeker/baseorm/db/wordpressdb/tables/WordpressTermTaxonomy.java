...
public class WordpressTermTaxonomy extends TableImpl<WordpressTermTaxonomyRecord> {
    ...
    private static final long serialVersionUID = 1251833775;
     ...
     */
    public final TableField<WordpressTermTaxonomyRecord, Long> TERM_ID = createField("term_id", org.jooq.impl.SQLDataType.BIGINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.BIGINT)), this, "");

    /**
     * The column <code>wordpressdb.wordpress_term_taxonomy.taxonomy</code>.
     */
    public final TableField<WordpressTermTaxonomyRecord, String> TAXONOMY = createField("taxonomy", org.jooq.impl.SQLDataType.VARCHAR.length(32).nullable(false).defaultValue(org.jooq.impl.DSL.field("", org.jooq.impl.SQLDataType.VARCHAR)), this, "");
     ...
     */
    public final TableField<WordpressTermTaxonomyRecord, Long> PARENT = createField("parent", org.jooq.impl.SQLDataType.BIGINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.BIGINT)), this, "");

    /**
     * The column <code>wordpressdb.wordpress_term_taxonomy.count</code>.
     */
    public final TableField<WordpressTermTaxonomyRecord, Long> COUNT = createField("count", org.jooq.impl.SQLDataType.BIGINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.BIGINT)), this, "");
