...
public class UserEmployeePointsRecord implements Serializable {

    private static final long serialVersionUID = 1933758280;
    ...
    public UserEmployeePointsRecord(UserEmployeePointsRecord value) {
        this.id = value.id;
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("UserEmployeePointsRecord (");
