...
public class ProfileIntentionPosition implements Serializable {

    private static final long serialVersionUID = 1126530185;
    ...
    public ProfileIntentionPosition(ProfileIntentionPosition value) {
        this.id = value.id;
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("ProfileIntentionPosition (");
