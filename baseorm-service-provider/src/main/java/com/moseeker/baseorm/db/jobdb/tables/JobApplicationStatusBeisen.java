...
public class JobApplicationStatusBeisen extends TableImpl<JobApplicationStatusBeisenRecord> {
    ...
    private static final long serialVersionUID = -1896930051;
     ...
     */
    public final TableField<JobApplicationStatusBeisenRecord, UInteger> COMPANY_ID = createField("company_id", org.jooq.impl.SQLDataType.INTEGERUNSIGNED.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGERUNSIGNED)), this, "company.id, 部门ID");

    /**
     * The column <code>jobdb.job_application_status_beisen.applier_mobile</code>. 关注吉利微信公众账号的申请人的手机号
     */
    public final TableField<JobApplicationStatusBeisenRecord, Long> APPLIER_MOBILE = createField("applier_mobile", org.jooq.impl.SQLDataType.BIGINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.BIGINT)), this, "关注吉利微信公众账号的申请人的手机号");

    /**
     * The column <code>jobdb.job_application_status_beisen.applier_name</code>. 申请人真实姓名
     */
    public final TableField<JobApplicationStatusBeisenRecord, String> APPLIER_NAME = createField("applier_name", org.jooq.impl.SQLDataType.VARCHAR.length(50).nullable(false).defaultValue(org.jooq.impl.DSL.field("", org.jooq.impl.SQLDataType.VARCHAR)), this, "申请人真实姓名");

    /**
     * The column <code>jobdb.job_application_status_beisen.jobnumber</code>. 对应beisen投递状态中JobName中的code, 并非对应hr_position中jobnumber
     */
    public final TableField<JobApplicationStatusBeisenRecord, String> JOBNUMBER = createField("jobnumber", org.jooq.impl.SQLDataType.VARCHAR.length(40).nullable(false).defaultValue(org.jooq.impl.DSL.field("", org.jooq.impl.SQLDataType.VARCHAR)), this, "对应beisen投递状态中JobName中的code, 并非对应hr_position中jobnumber");

    /**
     * The column <code>jobdb.job_application_status_beisen.jobtitle</code>. 对应beisen投递状态中Jobname中的value，对应hr_position中title
     */
    public final TableField<JobApplicationStatusBeisenRecord, String> JOBTITLE = createField("jobtitle", org.jooq.impl.SQLDataType.VARCHAR.length(999).nullable(false).defaultValue(org.jooq.impl.DSL.field("", org.jooq.impl.SQLDataType.VARCHAR)), this, "对应beisen投递状态中Jobname中的value，对应hr_position中title");

    /**
     * The column <code>jobdb.job_application_status_beisen.phasecode</code>. 对应beisen投递状态中PhaseCode中的code
     */
    public final TableField<JobApplicationStatusBeisenRecord, Integer> PHASECODE = createField("phasecode", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "对应beisen投递状态中PhaseCode中的code");

    /**
     * The column <code>jobdb.job_application_status_beisen.phasename</code>. 对应beisen投递状态中PhaseName中的value
     */
    public final TableField<JobApplicationStatusBeisenRecord, String> PHASENAME = createField("phasename", org.jooq.impl.SQLDataType.VARCHAR.length(999).nullable(false).defaultValue(org.jooq.impl.DSL.field("", org.jooq.impl.SQLDataType.VARCHAR)), this, "对应beisen投递状态中PhaseName中的value");

    /**
     * The column <code>jobdb.job_application_status_beisen.statuscode</code>. 对应beisen投递状态中StatusCode中的code
     */
    public final TableField<JobApplicationStatusBeisenRecord, Integer> STATUSCODE = createField("statuscode", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "对应beisen投递状态中StatusCode中的code");

    /**
     * The column <code>jobdb.job_application_status_beisen.statusname</code>. 对应beisen投递状态中StatusName中的value
     */
    public final TableField<JobApplicationStatusBeisenRecord, String> STATUSNAME = createField("statusname", org.jooq.impl.SQLDataType.VARCHAR.length(999).nullable(false).defaultValue(org.jooq.impl.DSL.field("", org.jooq.impl.SQLDataType.VARCHAR)), this, "对应beisen投递状态中StatusName中的value");

    /**
     * The column <code>jobdb.job_application_status_beisen.create_time</code>.
     */
    public final TableField<JobApplicationStatusBeisenRecord, Timestamp> CREATE_TIME = createField("create_time", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "");

    /**
     * The column <code>jobdb.job_application_status_beisen.update_time</code>.
     */
    public final TableField<JobApplicationStatusBeisenRecord, Timestamp> UPDATE_TIME = createField("update_time", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "");
