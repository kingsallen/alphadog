...
public class JobOccupationRel extends TableImpl<JobOccupationRelRecord> {
    ...
    private static final long serialVersionUID = 1144920339;
     ...
     */
    public final TableField<JobOccupationRelRecord, Integer> PID = createField("pid", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "职位id");

    /**
     * The column <code>jobdb.job_occupation_rel.code</code>. 职位职能code
     */
    public final TableField<JobOccupationRelRecord, Integer> CODE = createField("code", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "职位职能code");
