...
public class UserUser extends TableImpl<UserUserRecord> {
	...
	private static final long serialVersionUID = -1525712128;
	 ...
	 */
	public final TableField<UserUserRecord, Short> SOURCE = createField("source", org.jooq.impl.SQLDataType.SMALLINT.nullable(false).defaulted(true), this, "来源：0:手机注册 1:聚合号一键登录 2:企业号一键登录, 7:PC(手机直接注册) 8:PC(我要投递) 9: PC(我感兴趣) 10:PC(微信扫描后手机注册)100: 简历回收自动创建");
	 ...
	 */
	public final TableField<UserUserRecord, Integer> PARENTID = createField("parentid", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaulted(true), this, "合并到了新用户的id");
	 ...
	 */
	public final TableField<UserUserRecord, Byte> EMAIL_VERIFIED = createField("email_verified", org.jooq.impl.SQLDataType.TINYINT.nullable(false).defaulted(true), this, "邮箱是否认证 2:老数据 1:已认证 0:未认证");

	/**
	 * The column <code>userdb.user_user.update_time</code>.
	 */
	public final TableField<UserUserRecord, Timestamp> UPDATE_TIME = createField("update_time", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaulted(true), this, "");
