...
public class UserUser extends TableImpl<UserUserRecord> {
    ...
    private static final long serialVersionUID = 1823655194;
     ...
     */
    public final TableField<UserUserRecord, String> COUNTRY_CODE = createField("country_code", org.jooq.impl.SQLDataType.VARCHAR.length(5).nullable(false).defaultValue(org.jooq.impl.DSL.inline("86", org.jooq.impl.SQLDataType.VARCHAR)), this, "国家代码，用于支持国际短信");
     ...
     */
    public final TableField<UserUserRecord, Byte> EMAIL_VERIFIED = createField("email_verified", org.jooq.impl.SQLDataType.TINYINT.nullable(false).defaultValue(org.jooq.impl.DSL.inline("2", org.jooq.impl.SQLDataType.TINYINT)), this, "邮箱是认证 2:老数据 1:已认证 0:未认证");
