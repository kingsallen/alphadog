...
public class UserUser extends TableImpl<UserUserRecord> {
    ...
    private static final long serialVersionUID = -1177185098;
     ...
     */
    public final TableField<UserUserRecord, String> COUNTRY_CODE = createField("country_code", org.jooq.impl.SQLDataType.VARCHAR.length(5).nullable(false).defaultValue(org.jooq.impl.DSL.field("86", org.jooq.impl.SQLDataType.VARCHAR)), this, "国家代码，用于支持国际短信");
     ...
     */
    public final TableField<UserUserRecord, Byte> IS_DISABLE = createField("is_disable", org.jooq.impl.SQLDataType.TINYINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.TINYINT)), this, "是否禁用，0：可用，1：禁用");
     ...
     */
    public final TableField<UserUserRecord, Integer> LOGIN_COUNT = createField("login_count", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "登录次数");

    /**
     * The column <code>userdb.user_user.mobile</code>. 手机号(未验证)
     */
    public final TableField<UserUserRecord, Long> MOBILE = createField("mobile", org.jooq.impl.SQLDataType.BIGINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.BIGINT)), this, "手机号(未验证)");

    /**
     * The column <code>userdb.user_user.email</code>. user pass email registe
     */
    public final TableField<UserUserRecord, String> EMAIL = createField("email", org.jooq.impl.SQLDataType.VARCHAR.length(50).nullable(false).defaultValue(org.jooq.impl.DSL.field("", org.jooq.impl.SQLDataType.VARCHAR)), this, "user pass email registe");

    /**
     * The column <code>userdb.user_user.activation</code>. is not activation 0:no 1:yes
     */
    public final TableField<UserUserRecord, Byte> ACTIVATION = createField("activation", org.jooq.impl.SQLDataType.TINYINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.TINYINT)), this, "is not activation 0:no 1:yes");

    /**
     * The column <code>userdb.user_user.activation_code</code>. activation code
     */
    public final TableField<UserUserRecord, String> ACTIVATION_CODE = createField("activation_code", org.jooq.impl.SQLDataType.VARCHAR.length(32).nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.VARCHAR)), this, "activation code");

    /**
     * The column <code>userdb.user_user.token</code>.
     */
    public final TableField<UserUserRecord, String> TOKEN = createField("token", org.jooq.impl.SQLDataType.VARCHAR.length(50).nullable(false).defaultValue(org.jooq.impl.DSL.field("", org.jooq.impl.SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>userdb.user_user.name</code>. 真实姓名
     */
    public final TableField<UserUserRecord, String> NAME = createField("name", org.jooq.impl.SQLDataType.VARCHAR.length(100).nullable(false).defaultValue(org.jooq.impl.DSL.field("", org.jooq.impl.SQLDataType.VARCHAR)), this, "真实姓名");
     ...
     */
    public final TableField<UserUserRecord, Integer> NATIONAL_CODE_ID = createField("national_code_id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("1", org.jooq.impl.SQLDataType.INTEGER)), this, "国际电话区号ID");

    /**
     * The column <code>userdb.user_user.wechat_id</code>. 注册用户来自于哪个公众号, 0:默认为来自浏览器的用户
     */
    public final TableField<UserUserRecord, Integer> WECHAT_ID = createField("wechat_id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "注册用户来自于哪个公众号, 0:默认为来自浏览器的用户");
     ...
     */
    public final TableField<UserUserRecord, String> COMPANY = createField("company", org.jooq.impl.SQLDataType.VARCHAR.length(100).nullable(false).defaultValue(org.jooq.impl.DSL.field("", org.jooq.impl.SQLDataType.VARCHAR)), this, "点击我感兴趣时填写的公司");

    /**
     * The column <code>userdb.user_user.position</code>. 点击我感兴趣时填写的职位
     */
    public final TableField<UserUserRecord, String> POSITION = createField("position", org.jooq.impl.SQLDataType.VARCHAR.length(100).nullable(false).defaultValue(org.jooq.impl.DSL.field("", org.jooq.impl.SQLDataType.VARCHAR)), this, "点击我感兴趣时填写的职位");

    /**
     * The column <code>userdb.user_user.parentid</code>. 合并到了新用户的id
     */
    public final TableField<UserUserRecord, Integer> PARENTID = createField("parentid", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "合并到了新用户的id");
     ...
     */
    public final TableField<UserUserRecord, Byte> EMAIL_VERIFIED = createField("email_verified", org.jooq.impl.SQLDataType.TINYINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("2", org.jooq.impl.SQLDataType.TINYINT)), this, "邮箱是认证 2:老数据 1:已认证 0:未认证");
