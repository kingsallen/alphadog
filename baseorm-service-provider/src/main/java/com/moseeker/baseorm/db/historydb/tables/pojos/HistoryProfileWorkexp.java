...
public class HistoryProfileWorkexp implements Serializable {

    private static final long serialVersionUID = 1103151931;
    ...
    public HistoryProfileWorkexp(HistoryProfileWorkexp value) {
        this.id = value.id;
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("HistoryProfileWorkexp (");
