...
interface CrudQuery<S, R> {
    <T> T getData(CommonQuery query, Class<T> sClass) throws SQLException;

    S getData(CommonQuery query) throws SQLException;

    <T> List<T> getDatas(CommonQuery query, Class<T> sClass) throws SQLException;

    List<S> getDatas(CommonQuery query) throws SQLException;
