...
public class DictCityMap extends TableImpl<DictCityMapRecord> {
    ...
    private static final long serialVersionUID = -1065969106;
     ...
     */
    public final TableField<DictCityMapRecord, UInteger> ID = createField("id", org.jooq.impl.SQLDataType.INTEGERUNSIGNED.nullable(false), this, "主键id");

    /**
     * The column <code>dictdb.dict_city_map.CODE</code>. 千寻城市字典code
     */
    public final TableField<DictCityMapRecord, UInteger> CODE = createField("CODE", org.jooq.impl.SQLDataType.INTEGERUNSIGNED.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGERUNSIGNED)), this, "千寻城市字典code");

    /**
     * The column <code>dictdb.dict_city_map.code_other</code>. 第三方城市字典code
     */
    public final TableField<DictCityMapRecord, UInteger> CODE_OTHER = createField("code_other", org.jooq.impl.SQLDataType.INTEGERUNSIGNED.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGERUNSIGNED)), this, "第三方城市字典code");

    /**
     * The column <code>dictdb.dict_city_map.channel</code>. 渠道 1 51job 2 猎聘 3 智联 4 linkedin
     */
    public final TableField<DictCityMapRecord, UInteger> CHANNEL = createField("channel", org.jooq.impl.SQLDataType.INTEGERUNSIGNED.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGERUNSIGNED)), this, "渠道 1 51job 2 猎聘 3 智联 4 linkedin");

    /**
     * The column <code>dictdb.dict_city_map.STATUS</code>. 状态 0 是有效 1是无效
     */
    public final TableField<DictCityMapRecord, UInteger> STATUS = createField("STATUS", org.jooq.impl.SQLDataType.INTEGERUNSIGNED.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGERUNSIGNED)), this, "状态 0 是有效 1是无效");
     ...
     */
    @Override
    public Identity<DictCityMapRecord, UInteger> getIdentity() {
