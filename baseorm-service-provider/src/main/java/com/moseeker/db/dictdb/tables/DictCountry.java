...
public class DictCountry extends TableImpl<DictCountryRecord> {
    ...
    private static final long serialVersionUID = -1229344229;
     ...
     */
    public final TableField<DictCountryRecord, UInteger> CONTINENT_CODE = createField("continent_code", org.jooq.impl.SQLDataType.INTEGERUNSIGNED.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGERUNSIGNED)), this, "7大洲code, dict_constant.parent_code: 9103");
