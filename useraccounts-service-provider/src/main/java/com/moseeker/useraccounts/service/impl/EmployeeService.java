...
public class EmployeeService {
    ...
    public EmployeeResponse getEmployee(int userId, int companyId) throws TException {
        ...
        try {
            ...
            if (employee != null && employee.getId() != 0) {
                ...
                emp.setWxuserId(getWxuserId(userId, companyId));
    ...
    public Result emailActivation(String activationCode) throws TException {
        ...
        if (userEmployeeDO != null && userEmployeeDO.getId() > 0) {
            ...
            if (StringUtils.isNotNullOrEmpty(value)) {
                ...
                response = updateEmployee(bindingParams, userEmployeeDO.getId());
                if (response.success) {
     ...
     *  获取用户wxUserId
     */
    private int getWxuserId(int userId, int companyId) {
        int wxUserId = 0;
        try {
            Query.QueryBuilder query = new Query.QueryBuilder();
            query.where("company_id", String.valueOf(companyId));
