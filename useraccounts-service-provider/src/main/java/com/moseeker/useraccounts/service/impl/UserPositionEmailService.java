...
public class UserPositionEmailService {
	...
	private String getPositionHtmlData(String pic,String title,String citys,String companyName,String salary,String experience,int positionId){
		...
		sb.append("<tr><td align='center'><table width='520' height='90' cellpadding='0' cellspacing='0' border='0' class='wrapper' bgcolor='#ffffff'><tr>");
		sb.append(" <td align='center'>");
		sb.append(" <table width='500' height='90' cellpadding='0' cellspacing='0' border='0' class='wrapper'>");
		sb.append("<tr><td height='20' style='-ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; font-size: 10px; line-height: 10px; mso-table-lspace: 0pt; mso-table-rspace: 0pt;'></td></tr><tr valign='middle' >");
		...
		sb.append("<td height='10' width='20' style='font-size:70px; line-height:10px;' class='mobileOn'>&nbsp;</td><td width='400' height='50'>");
		sb.append("<table width='400' height='50' cellpadding='0' cellspacing='0' border='0' class='wrapper'>");
		...
		sb.append("</td></tr></table></td></tr><tr>");
		sb.append("<td height='20'style='-ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; font-size: 10px; line-height: 10px; mso-table-lspace: 0pt; mso-table-rspace: 0pt;'></td>");
		sb.append("</tr></table></td></tr></table></td></tr></table></td></tr>");
		return sb.toString();
	}
