...
public class LiePinPositionVO {
    ...
    private Float ejob_monthlysalary_low;
    private Float ejob_monthlysalary_high;
    ...
    public Float getEjob_monthlysalary_low() {
        return ejob_monthlysalary_low;
    }

    public void setEjob_monthlysalary_low(Float ejob_monthlysalary_low) {
        this.ejob_monthlysalary_low = ejob_monthlysalary_low;
    }

    public Float getEjob_monthlysalary_high() {
        return ejob_monthlysalary_high;
    }

    public void setEjob_monthlysalary_high(Float ejob_monthlysalary_high) {
        this.ejob_monthlysalary_high = ejob_monthlysalary_high;
    }
