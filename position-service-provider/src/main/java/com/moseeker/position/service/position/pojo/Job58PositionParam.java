...
public class Job58PositionParam {
    ...
    public Integer getXueliyaoqiu() {
        return xueliyaoqiu;
    }

    public void setXueliyaoqiu(Integer xueliyaoqiu) {
    ...
    public Integer getGongzuodizhi() {
        return gongzuodizhi;
    }

    public void setGongzuodizhi(Integer gongzuodizhi) {
        this.gongzuodizhi = gongzuodizhi;
    }

    public Integer getYingjiesheng() {
        return yingjiesheng;
    }

    public void setYingjiesheng(Integer yingjiesheng) {
