	...
	private static void setCategorySubCode(String categorySubCode, ChannelType channelType,
		...
		if(StringUtils.isNotNullOrEmpty(categorySubCode)) {
			...
			case JOB51 : 
				...
				if(StringUtils.isNotNullOrEmpty(categorySubCode)) {
					position.setCategory_sub(df.format(Integer.valueOf(categorySubCode)));
				}
				break;
			case ZHILIAN : 
				DecimalFormat df1 = new DecimalFormat("000");
				if(StringUtils.isNotNullOrEmpty(categorySubCode)) {
					position.setCategory_sub(df1.format(Integer.valueOf(categorySubCode)));
				}
				break;
				default :
					position.setCategory_sub(categorySubCode);
			}
		}
	}
