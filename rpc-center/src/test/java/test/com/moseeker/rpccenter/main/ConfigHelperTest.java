package test.com.moseeker.rpccenter.main;
...
/* 
try { 
   Method method = ConfigHelper.getClass().getMethod("createServices", ConfigPropertiesUtil.class, List<Object>.class, AnnotationConfigApplicationContext.class); 
...
/* 
try { 
   Method method = ConfigHelper.getClass().getMethod("createServicesByClass", List<Object>.class); 
   method.setAccessible(true); 
   method.invoke(<Object>, <Parameters>); 
} catch(NoSuchMethodException e) { 
} catch(IllegalAccessException e) { 
...
/* 
try { 
   Method method = ConfigHelper.getClass().getMethod("createServicesByConf", ConfigPropertiesUtil.class, AnnotationConfigApplicationContext.class); 
   method.setAccessible(true); 
   method.invoke(<Object>, <Parameters>); 
} catch(NoSuchMethodException e) { 
} catch(IllegalAccessException e) { 
