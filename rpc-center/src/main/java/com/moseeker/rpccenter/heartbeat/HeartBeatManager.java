package com.moseeker.rpccenter.heartbeat;
...
import com.moseeker.rpccenter.monitor.NamedThreadFactory;
...
public class HeartBeatManager<T> {
    ...
    private final ScheduledExecutorService scheduled = Executors.newScheduledThreadPool(1, new NamedThreadFactory("Services-Heartbeat", true));
