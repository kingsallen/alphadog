...
public class CandidateVJobPositionRecomRecord extends TableRecordImpl<CandidateVJobPositionRecomRecord> implements Record5<Long, Long, Long, Timestamp, String> {
	...
	private static final long serialVersionUID = 1556974074;
	...
	/**
	 * Setter for <code>userdb.candidate_v_job_position_recom.recom_id</code>. userdb.user_wx_user.id 分享用户微信ID
	 */
	...
	/**
	 * Getter for <code>userdb.candidate_v_job_position_recom.recom_id</code>. userdb.user_wx_user.id 分享用户微信ID
	 */
	...
	/**
	 * Setter for <code>userdb.candidate_v_job_position_recom.presentee_id</code>. 被动求职者,浏览者的微信ID，userdb.user_wx_user.id
	 */
	...
	/**
	 * Getter for <code>userdb.candidate_v_job_position_recom.presentee_id</code>. 被动求职者,浏览者的微信ID，userdb.user_wx_user.id
	 */
