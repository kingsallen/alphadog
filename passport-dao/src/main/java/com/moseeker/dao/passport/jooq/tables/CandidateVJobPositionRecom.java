...
import com.moseeker.dao.passport.jooq.tables.records.CandidateVJobPositionRecomRecord;
...
public class CandidateVJobPositionRecom extends TableImpl<CandidateVJobPositionRecomRecord> {
	...
	private static final long serialVersionUID = 371034749;
	...
	/**
	 * The column <code>userdb.candidate_v_job_position_recom.recom_id</code>. userdb.user_wx_user.id 分享用户微信ID
	 */
	public final TableField<CandidateVJobPositionRecomRecord, Long> RECOM_ID = createField("recom_id", org.jooq.impl.SQLDataType.BIGINT.nullable(false).defaulted(true), this, "userdb.user_wx_user.id 分享用户微信ID");

	/**
	 * The column <code>userdb.candidate_v_job_position_recom.presentee_id</code>. 被动求职者,浏览者的微信ID，userdb.user_wx_user.id
	 */
	public final TableField<CandidateVJobPositionRecomRecord, Long> PRESENTEE_ID = createField("presentee_id", org.jooq.impl.SQLDataType.BIGINT.nullable(false).defaulted(true), this, "被动求职者,浏览者的微信ID，userdb.user_wx_user.id");
	...
	private CandidateVJobPositionRecom(String alias, Table<CandidateVJobPositionRecomRecord> aliased, Field<?>[] parameters) {
		super(alias, Userdb.USERDB, aliased, parameters, "VIEW");
	}
