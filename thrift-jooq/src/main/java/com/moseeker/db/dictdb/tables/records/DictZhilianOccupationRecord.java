...
public class DictZhilianOccupationRecord extends UpdatableRecordImpl<DictZhilianOccupationRecord> implements Record7<UInteger, UInteger, String, UInteger, UShort, UShort, Timestamp> {
	...
	private static final long serialVersionUID = -1623315527;
	 ...
	 */
	@Override
	public DictZhilianOccupationRecord value4(UInteger value) {
		setCodeOther(value);
		return this;
	}
	 ...
	 */
	@Override
	public DictZhilianOccupationRecord values(UInteger value1, UInteger value2, String value3, UInteger value4, UShort value5, UShort value6, Timestamp value7) {
		value1(value1);
		value2(value2);
		value3(value3);
		value4(value4);
	 ...
	 */
	public DictZhilianOccupationRecord(UInteger code, UInteger parentId, String name, UInteger codeOther, UShort level, UShort status, Timestamp createtime) {
		super(DictZhilianOccupation.DICT_ZHILIAN_OCCUPATION);
