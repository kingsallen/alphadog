...
public class DictCityMapRecord extends UpdatableRecordImpl<DictCityMapRecord> implements Record6<Integer, Integer, Integer, Integer, Integer, Timestamp> {

    private static final long serialVersionUID = -1652147959;
     ...
     */
    @Override
    public DictCityMapRecord values(Integer value1, Integer value2, Integer value3, Integer value4, Integer value5, Timestamp value6) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public DictCityMapRecord(Integer id, Integer code, Integer codeOther, Integer channel, Integer status, Timestamp createTime) {
        super(DictCityMap.DICT_CITY_MAP);
