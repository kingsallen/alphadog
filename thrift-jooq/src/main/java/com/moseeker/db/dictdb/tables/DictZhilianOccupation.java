...
public class DictZhilianOccupation extends TableImpl<DictZhilianOccupationRecord> {
    ...
    private static final long serialVersionUID = -1858663361;
     ...
     */
    public final TableField<DictZhilianOccupationRecord, UInteger> CODE_OTHER = createField("code_other", org.jooq.impl.SQLDataType.INTEGERUNSIGNED.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGERUNSIGNED)), this, "第三方职能id");

    /**
     * The column <code>dictdb.dict_zhilian_occupation.level</code>. 职能级别 1是一级2是二级依次类推
     */
    public final TableField<DictZhilianOccupationRecord, UShort> LEVEL = createField("level", org.jooq.impl.SQLDataType.SMALLINTUNSIGNED.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.SMALLINTUNSIGNED)), this, "职能级别 1是一级2是二级依次类推");

    /**
     * The column <code>dictdb.dict_zhilian_occupation.status</code>. 只能状态 0 是有效 1是无效
     */
    public final TableField<DictZhilianOccupationRecord, UShort> STATUS = createField("status", org.jooq.impl.SQLDataType.SMALLINTUNSIGNED.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.SMALLINTUNSIGNED)), this, "只能状态 0 是有效 1是无效");
