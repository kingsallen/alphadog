...
public class Dict_51jobOccupationRecord extends UpdatableRecordImpl<Dict_51jobOccupationRecord> implements Record7<Integer, Integer, String, Integer, Short, Short, Timestamp> {

    private static final long serialVersionUID = -1043487857;
     ...
     */
    @Override
    public Dict_51jobOccupationRecord values(Integer value1, Integer value2, String value3, Integer value4, Short value5, Short value6, Timestamp value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public Dict_51jobOccupationRecord(Integer code, Integer parentId, String name, Integer codeOther, Short level, Short status, Timestamp createtime) {
        super(Dict_51jobOccupation.DICT_51JOB_OCCUPATION);
