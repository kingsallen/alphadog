...
public class DictCollegeRecord extends TableRecordImpl<DictCollegeRecord> implements Record4<UInteger, String, UInteger, String> {

    private static final long serialVersionUID = -1205165552;
