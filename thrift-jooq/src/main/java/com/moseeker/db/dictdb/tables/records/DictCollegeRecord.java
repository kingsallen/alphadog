...
public class DictCollegeRecord extends UpdatableRecordImpl<DictCollegeRecord> implements Record4<UInteger, String, Integer, String> {

	private static final long serialVersionUID = -1555064611;
	 ...
	 */
	@Override
	public DictCollegeRecord values(UInteger value1, String value2, Integer value3, String value4) {
		value1(value1);
		value2(value2);
		value3(value3);
		value4(value4);
	 ...
	 */
	public DictCollegeRecord(UInteger code, String name, Integer province, String logo) {
		super(DictCollege.DICT_COLLEGE);
