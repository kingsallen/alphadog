...
public class DictIndustry extends TableImpl<DictIndustryRecord> {
	...
	private static final long serialVersionUID = 180251855;
	...
	/**
	 * The column <code>dictDB.dict_industry.level</code>. 字典level
	 */
	...
	private DictIndustry(String alias, Table<DictIndustryRecord> aliased, Field<?>[] parameters) {
		super(alias, Dictdb.DICTDB, aliased, parameters, "行业分类字典表");
	}
