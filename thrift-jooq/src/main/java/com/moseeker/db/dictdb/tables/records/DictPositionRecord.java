...
public class DictPositionRecord extends TableRecordImpl<DictPositionRecord> implements Record4<UInteger, DictPositionNameRecord, UInteger, Byte> {

    private static final long serialVersionUID = -569567411;
     ...
     */
    public void setName(DictPositionNameRecord value) {
        set(1, value);
    }
     ...
     */
    public DictPositionNameRecord getName() {
        return (DictPositionNameRecord) get(1);
    }
     ...
     */
    @Override
    public Row4<UInteger, DictPositionNameRecord, UInteger, Byte> fieldsRow() {
     ...
     */
    @Override
    public Row4<UInteger, DictPositionNameRecord, UInteger, Byte> valuesRow() {
     ...
     */
    @Override
    public Field<DictPositionNameRecord> field2() {
     ...
     */
    @Override
    public DictPositionNameRecord value2() {
        return getName();
    }
     ...
     */
    @Override
    public DictPositionRecord value2(DictPositionNameRecord value) {
        setName(value);
        return this;
    }
     ...
     */
    @Override
    public DictPositionRecord values(UInteger value1, DictPositionNameRecord value2, UInteger value3, Byte value4) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public DictPositionRecord(UInteger code, DictPositionNameRecord name, UInteger parent, Byte level) {
        super(DictPosition.DICT_POSITION);
