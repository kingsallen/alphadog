...
public class DictCollege extends TableImpl<DictCollegeRecord> {
    ...
    private static final long serialVersionUID = 156441500;
     ...
     */
    public final TableField<DictCollegeRecord, Integer> PROVINCE = createField("province", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "院校所在地");
