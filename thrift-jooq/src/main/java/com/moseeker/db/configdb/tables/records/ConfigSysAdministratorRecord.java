...
public class ConfigSysAdministratorRecord extends UpdatableRecordImpl<ConfigSysAdministratorRecord> implements Record9<Integer, String, String, String, String, Integer, Integer, Timestamp, Timestamp> {

    private static final long serialVersionUID = -1845896567;
     ...
     */
    @Override
    public Row9<Integer, String, String, String, String, Integer, Integer, Timestamp, Timestamp> fieldsRow() {
     ...
     */
    @Override
    public Row9<Integer, String, String, String, String, Integer, Integer, Timestamp, Timestamp> valuesRow() {
     ...
     */
    @Override
    public ConfigSysAdministratorRecord values(Integer value1, String value2, String value3, String value4, String value5, Integer value6, Integer value7, Timestamp value8, Timestamp value9) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public ConfigSysAdministratorRecord(Integer id, String name, String email, String mobile, String password, Integer isDisable, Integer loginCount, Timestamp lastLoginTime, Timestamp createTime) {
        super(ConfigSysAdministrator.CONFIG_SYS_ADMINISTRATOR);
