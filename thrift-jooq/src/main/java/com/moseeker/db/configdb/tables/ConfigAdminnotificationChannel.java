...
public class ConfigAdminnotificationChannel extends TableImpl<ConfigAdminnotificationChannelRecord> {
    ...
    private static final long serialVersionUID = -1853725166;
     ...
     */
    public final TableField<ConfigAdminnotificationChannelRecord, Timestamp> CREATE_TIME = createField("create_time", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "");
