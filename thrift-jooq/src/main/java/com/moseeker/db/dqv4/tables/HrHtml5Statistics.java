...
public class HrHtml5Statistics extends TableImpl<HrHtml5StatisticsRecord> {
	...
	private static final long serialVersionUID = 798704834;

	/**
	 * The reference instance of <code>dqv4.hr_html5_statistics</code>
	 */
	...
	/**
	 * The column <code>dqv4.hr_html5_statistics.id</code>. primary key
	 */
	...
	/**
	 * The column <code>dqv4.hr_html5_statistics.topic_id</code>. wx_topic.id
	 */
	...
	/**
	 * The column <code>dqv4.hr_html5_statistics.company_id</code>. company.id
	 */
	...
	/**
	 * The column <code>dqv4.hr_html5_statistics.view_num_pv</code>. 浏览次数
	 */
	...
	/**
	 * The column <code>dqv4.hr_html5_statistics.recom_view_num_pv</code>. 推荐浏览次数
	 */
	...
	/**
	 * The column <code>dqv4.hr_html5_statistics.create_date</code>. 创建日期
	 */
	...
	/**
	 * Create a <code>dqv4.hr_html5_statistics</code> table reference
	 */
	...
	/**
	 * Create an aliased <code>dqv4.hr_html5_statistics</code> table reference
	 */
	...
	private HrHtml5Statistics(String alias, Table<HrHtml5StatisticsRecord> aliased, Field<?>[] parameters) {
		super(alias, Dqv4.DQV4, aliased, parameters, "专题传播统计次数表");
	}
