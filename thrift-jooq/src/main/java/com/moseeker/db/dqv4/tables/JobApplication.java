...
public class JobApplication extends TableImpl<JobApplicationRecord> {
	...
	private static final long serialVersionUID = 2132701089;

	/**
	 * The reference instance of <code>dqv4.job_application</code>
	 */
	...
	/**
	 * The column <code>dqv4.job_application.id</code>.
	 */
	...
	/**
	 * The column <code>dqv4.job_application.wechat_id</code>. sys_wechat.id, 公众号ID
	 */
	...
	/**
	 * The column <code>dqv4.job_application.position_id</code>. hr_position.id, 职位ID
	 */
	...
	/**
	 * The column <code>dqv4.job_application.recommender_id</code>. wx_group_user.id, 微信ID
	 */
	...
	/**
	 * The column <code>dqv4.job_application.submit_time</code>. 申请提交时间
	 */
	...
	/**
	 * The column <code>dqv4.job_application.status_id</code>. hr_award_config.id, 申请状态ID
	 */
	...
	/**
	 * The column <code>dqv4.job_application.l_application_id</code>. ATS的申请ID
	 */
	...
	/**
	 * The column <code>dqv4.job_application.reward</code>. 当前申请的积分记录
	 */
	...
	/**
	 * The column <code>dqv4.job_application.source_id</code>. job_source.id, 对应的ATS ID
	 */
	...
	/**
	 * The column <code>dqv4.job_application._create_time</code>. time stamp when record created
	 */
	...
	/**
	 * The column <code>dqv4.job_application.applier_id</code>. sys_user.id, 用户ID
	 */
	...
	/**
	 * The column <code>dqv4.job_application.interview_id</code>. app_interview.id, 面试ID
	 */
	...
	/**
	 * The column <code>dqv4.job_application.resume_id</code>. mongodb collection application[id]
	 */
	...
	/**
	 * The column <code>dqv4.job_application.ats_status</code>. 0:unuse, 1:waiting, 2:failed, 3:success, 4:position expire, 5:resume unqualified
	 */
	...
	/**
	 * The column <code>dqv4.job_application.applier_name</code>. 姓名或微信昵称
	 */
	...
	/**
	 * The column <code>dqv4.job_application.disable</code>. 是否有效，0：有效，1：无效
	 */
	...
	/**
	 * The column <code>dqv4.job_application.routine</code>. 判断申请来自客户公众号还是聚合平台
	 */
	...
	/**
	 * The column <code>dqv4.job_application.is_viewed</code>. 该申请是否被浏览，0：已浏览，1：未浏览
	 */
	...
	/**
	 * The column <code>dqv4.job_application.not_suitable</code>. 是否不合适，0：合适，1：不合适
	 */
	...
	/**
	 * The column <code>dqv4.job_application.company_id</code>. company.id，公司表ID
	 */
	...
	/**
	 * The column <code>dqv4.job_application.update_time</code>.
	 */
	...
	/**
	 * The column <code>dqv4.job_application.app_tpl_id</code>. 申请状态,hr_award_config_template.id
	 */
	...
	/**
	 * The column <code>dqv4.job_application.proxy</code>. 是否是代理投递 0：正常数据，1：代理假投递
	 */
	...
	/**
	 * Create a <code>dqv4.job_application</code> table reference
	 */
	...
	/**
	 * Create an aliased <code>dqv4.job_application</code> table reference
	 */
