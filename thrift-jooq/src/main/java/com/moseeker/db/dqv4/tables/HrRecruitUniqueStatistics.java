...
public class HrRecruitUniqueStatistics extends TableImpl<HrRecruitUniqueStatisticsRecord> {
	...
	private static final long serialVersionUID = 2145177434;

	/**
	 * The reference instance of <code>dqv4.hr_recruit_unique_statistics</code>
	 */
	...
	/**
	 * The column <code>dqv4.hr_recruit_unique_statistics.id</code>. primary key
	 */
	...
	/**
	 * The column <code>dqv4.hr_recruit_unique_statistics.position_id</code>. hr_position.id
	 */
	...
	/**
	 * The column <code>dqv4.hr_recruit_unique_statistics.company_id</code>. company.id
	 */
	...
	/**
	 * The column <code>dqv4.hr_recruit_unique_statistics.jd_uv</code>. JD 页浏览人数
	 */
	...
	/**
	 * The column <code>dqv4.hr_recruit_unique_statistics.recom_jd_uv</code>. JD 页推荐浏览人数
	 */
	...
	/**
	 * The column <code>dqv4.hr_recruit_unique_statistics.fav_num</code>. 感兴趣的人数
	 */
	...
	/**
	 * The column <code>dqv4.hr_recruit_unique_statistics.recom_fav_num</code>. 推荐感兴趣的人数
	 */
	...
	/**
	 * The column <code>dqv4.hr_recruit_unique_statistics.mobile_num</code>. 留手机的人数
	 */
	...
	/**
	 * The column <code>dqv4.hr_recruit_unique_statistics.recom_mobile_num</code>. 推荐感兴趣留手机的人数
	 */
	...
	/**
	 * The column <code>dqv4.hr_recruit_unique_statistics.apply_num</code>. 投递人数
	 */
	...
	/**
	 * The column <code>dqv4.hr_recruit_unique_statistics.recom_apply_num</code>. 推荐投递人数
	 */
	...
	/**
	 * The column <code>dqv4.hr_recruit_unique_statistics.create_date</code>. 创建日期
	 */
	...
	/**
	 * The column <code>dqv4.hr_recruit_unique_statistics.info_type</code>. 0: 日数据，1：周数据，2：月数据
	 */
	...
	/**
	 * Create a <code>dqv4.hr_recruit_unique_statistics</code> table reference
	 */
	...
	/**
	 * Create an aliased <code>dqv4.hr_recruit_unique_statistics</code> table reference
	 */
	...
	private HrRecruitUniqueStatistics(String alias, Table<HrRecruitUniqueStatisticsRecord> aliased, Field<?>[] parameters) {
		super(alias, Dqv4.DQV4, aliased, parameters, "招聘数据去重信息统计表");
	}
