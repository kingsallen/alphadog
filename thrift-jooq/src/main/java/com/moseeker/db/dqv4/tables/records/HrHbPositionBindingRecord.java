...
public class HrHbPositionBindingRecord extends UpdatableRecordImpl<HrHbPositionBindingRecord> implements Record8<Integer, Integer, Integer, Byte, BigDecimal, Integer, Timestamp, Timestamp> {
	...
	private static final long serialVersionUID = -1517192296;

	/**
	 * Setter for <code>dqv4.hr_hb_position_binding.id</code>.
	 */
	...
	/**
	 * Getter for <code>dqv4.hr_hb_position_binding.id</code>.
	 */
	...
	/**
	 * Setter for <code>dqv4.hr_hb_position_binding.hb_config_id</code>. hr_hb_config.id
	 */
	...
	/**
	 * Getter for <code>dqv4.hr_hb_position_binding.hb_config_id</code>. hr_hb_config.id
	 */
	...
	/**
	 * Setter for <code>dqv4.hr_hb_position_binding.position_id</code>. hr_position.id
	 */
	...
	/**
	 * Getter for <code>dqv4.hr_hb_position_binding.position_id</code>. hr_position.id
	 */
	...
	/**
	 * Setter for <code>dqv4.hr_hb_position_binding.trigger_way</code>. 领取条件：1=职位被转发 2=职位被申请
	 */
	...
	/**
	 * Getter for <code>dqv4.hr_hb_position_binding.trigger_way</code>. 领取条件：1=职位被转发 2=职位被申请
	 */
	...
	/**
	 * Setter for <code>dqv4.hr_hb_position_binding.total_amount</code>. 总金额
	 */
	...
	/**
	 * Getter for <code>dqv4.hr_hb_position_binding.total_amount</code>. 总金额
	 */
	...
	/**
	 * Setter for <code>dqv4.hr_hb_position_binding.total_num</code>. 红包总数
	 */
	...
	/**
	 * Getter for <code>dqv4.hr_hb_position_binding.total_num</code>. 红包总数
	 */
	...
	/**
	 * Setter for <code>dqv4.hr_hb_position_binding.create_time</code>. 创建时间
	 */
	...
	/**
	 * Getter for <code>dqv4.hr_hb_position_binding.create_time</code>. 创建时间
	 */
	...
	/**
	 * Setter for <code>dqv4.hr_hb_position_binding.update_time</code>. 更新时间
	 */
	...
	/**
	 * Getter for <code>dqv4.hr_hb_position_binding.update_time</code>. 更新时间
	 */
