...
public class ProfileImport extends TableImpl<ProfileImportRecord> {
	...
	private static final long serialVersionUID = 3485797;

	/**
	 * The reference instance of <code>dqv4.profile_import</code>
	 */
	...
	/**
	 * The column <code>dqv4.profile_import.profile_id</code>. profile.id
	 */
	...
	/**
	 * The column <code>dqv4.profile_import.source</code>. 来源, 0:无法识别 1:51Job 2:Liepin 3:zhilian 4:linkedin
	 */
	...
	/**
	 * The column <code>dqv4.profile_import.last_update_time</code>. 导入简历的最后修改时间
	 */
	...
	/**
	 * The column <code>dqv4.profile_import.account_id</code>. 他系统的用户ID
	 */
	...
	/**
	 * The column <code>dqv4.profile_import.resume_id</code>. 他系统的简历ID
	 */
	...
	/**
	 * The column <code>dqv4.profile_import.user_name</code>. 他系统的登陆用户名
	 */
	...
	/**
	 * The column <code>dqv4.profile_import.create_time</code>. 创建时间
	 */
	...
	/**
	 * The column <code>dqv4.profile_import.update_time</code>. 更新时间
	 */
	...
	/**
	 * Create a <code>dqv4.profile_import</code> table reference
	 */
	...
	/**
	 * Create an aliased <code>dqv4.profile_import</code> table reference
	 */
	...
	private ProfileImport(String alias, Table<ProfileImportRecord> aliased, Field<?>[] parameters) {
		super(alias, Dqv4.DQV4, aliased, parameters, "用户profile导入记录信息");
	}
