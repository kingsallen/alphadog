...
public class HrHtml5StatisticsRecord extends UpdatableRecordImpl<HrHtml5StatisticsRecord> implements Record6<Integer, Integer, Integer, Integer, Integer, Date> {
	...
	private static final long serialVersionUID = -1250853085;

	/**
	 * Setter for <code>dqv4.hr_html5_statistics.id</code>. primary key
	 */
	...
	/**
	 * Getter for <code>dqv4.hr_html5_statistics.id</code>. primary key
	 */
	...
	/**
	 * Setter for <code>dqv4.hr_html5_statistics.topic_id</code>. wx_topic.id
	 */
	...
	/**
	 * Getter for <code>dqv4.hr_html5_statistics.topic_id</code>. wx_topic.id
	 */
	...
	/**
	 * Setter for <code>dqv4.hr_html5_statistics.company_id</code>. company.id
	 */
	...
	/**
	 * Getter for <code>dqv4.hr_html5_statistics.company_id</code>. company.id
	 */
	...
	/**
	 * Setter for <code>dqv4.hr_html5_statistics.view_num_pv</code>. 浏览次数
	 */
	...
	/**
	 * Getter for <code>dqv4.hr_html5_statistics.view_num_pv</code>. 浏览次数
	 */
	...
	/**
	 * Setter for <code>dqv4.hr_html5_statistics.recom_view_num_pv</code>. 推荐浏览次数
	 */
	...
	/**
	 * Getter for <code>dqv4.hr_html5_statistics.recom_view_num_pv</code>. 推荐浏览次数
	 */
	...
	/**
	 * Setter for <code>dqv4.hr_html5_statistics.create_date</code>. 创建日期
	 */
	...
	/**
	 * Getter for <code>dqv4.hr_html5_statistics.create_date</code>. 创建日期
	 */
