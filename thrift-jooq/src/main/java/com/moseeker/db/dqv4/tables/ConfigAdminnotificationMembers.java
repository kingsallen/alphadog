...
public class ConfigAdminnotificationMembers extends TableImpl<ConfigAdminnotificationMembersRecord> {
	...
	private static final long serialVersionUID = -494470977;

	/**
	 * The reference instance of <code>dqv4.config_adminnotification_members</code>
	 */
	...
	/**
	 * The column <code>dqv4.config_adminnotification_members.id</code>.
	 */
	...
	/**
	 * The column <code>dqv4.config_adminnotification_members.name</code>. 姓名
	 */
	...
	/**
	 * The column <code>dqv4.config_adminnotification_members.mobilephone</code>. 接收通知的手机
	 */
	...
	/**
	 * The column <code>dqv4.config_adminnotification_members.wechatopenid</code>. 接收通知的微信openid
	 */
	...
	/**
	 * The column <code>dqv4.config_adminnotification_members.email</code>. 接收通知的email
	 */
	...
	/**
	 * The column <code>dqv4.config_adminnotification_members.status</code>. 1 有效 0 无效
	 */
	...
	/**
	 * The column <code>dqv4.config_adminnotification_members.create_time</code>.
	 */
	...
	/**
	 * Create a <code>dqv4.config_adminnotification_members</code> table reference
	 */
	...
	/**
	 * Create an aliased <code>dqv4.config_adminnotification_members</code> table reference
	 */
	...
	private ConfigAdminnotificationMembers(String alias, Table<ConfigAdminnotificationMembersRecord> aliased, Field<?>[] parameters) {
		super(alias, Dqv4.DQV4, aliased, parameters, "管理员通知联系人");
	}
