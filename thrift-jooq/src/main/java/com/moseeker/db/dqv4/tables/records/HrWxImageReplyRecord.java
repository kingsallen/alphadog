...
public class HrWxImageReplyRecord extends UpdatableRecordImpl<HrWxImageReplyRecord> implements Record5<Integer, UInteger, String, Timestamp, Timestamp> {
	...
	private static final long serialVersionUID = -347187274;

	/**
	 * Setter for <code>dqv4.hr_wx_image_reply.id</code>.
	 */
	...
	/**
	 * Getter for <code>dqv4.hr_wx_image_reply.id</code>.
	 */
	...
	/**
	 * Setter for <code>dqv4.hr_wx_image_reply.rid</code>. wx_rule.id, 规则ID
	 */
	...
	/**
	 * Getter for <code>dqv4.hr_wx_image_reply.rid</code>. wx_rule.id, 规则ID
	 */
	...
	/**
	 * Setter for <code>dqv4.hr_wx_image_reply.image</code>. 回复图片的相对路径
	 */
	...
	/**
	 * Getter for <code>dqv4.hr_wx_image_reply.image</code>. 回复图片的相对路径
	 */
	...
	/**
	 * Setter for <code>dqv4.hr_wx_image_reply.create_time</code>.
	 */
	...
	/**
	 * Getter for <code>dqv4.hr_wx_image_reply.create_time</code>.
	 */
	...
	/**
	 * Setter for <code>dqv4.hr_wx_image_reply.update_time</code>.
	 */
	...
	/**
	 * Getter for <code>dqv4.hr_wx_image_reply.update_time</code>.
	 */
