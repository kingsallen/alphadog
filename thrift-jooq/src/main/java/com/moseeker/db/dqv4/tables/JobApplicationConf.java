...
public class JobApplicationConf extends TableImpl<JobApplicationConfRecord> {
	...
	private static final long serialVersionUID = -1971836699;

	/**
	 * The reference instance of <code>dqv4.job_application_conf</code>
	 */
	...
	/**
	 * The column <code>dqv4.job_application_conf.id</code>.
	 */
	...
	/**
	 * The column <code>dqv4.job_application_conf.company_id</code>. company.id, 部门ID
	 */
	...
	/**
	 * The column <code>dqv4.job_application_conf.appnotice</code>. 简历投递反馈通知
	 */
	...
	/**
	 * The column <code>dqv4.job_application_conf.appnotice_tpl</code>. 简历投递通知使用模板
	 */
	...
	/**
	 * The column <code>dqv4.job_application_conf.app_reply</code>. 申请提交成功回复信息
	 */
	...
	/**
	 * The column <code>dqv4.job_application_conf.email_appnotice</code>. 0：需要，1：不需要
	 */
	...
	/**
	 * The column <code>dqv4.job_application_conf.email_appreply</code>. 申请邮箱回复内容html格式
	 */
	...
	/**
	 * The column <code>dqv4.job_application_conf.sms_appnotice_id</code>. 短信通知ID
	 */
	...
	/**
	 * The column <code>dqv4.job_application_conf.sms_appnotice_prefix</code>. 短信通知职位前缀
	 */
	...
	/**
	 * The column <code>dqv4.job_application_conf.sms_appnotice_signature</code>. 短信通知签名
	 */
	...
	/**
	 * The column <code>dqv4.job_application_conf.sms_delay</code>. 短信通知延迟 单位： min
	 */
	...
	/**
	 * The column <code>dqv4.job_application_conf.forward_click_reward</code>. 转发点击奖励通知0:需要1:不需要
	 */
	...
	/**
	 * The column <code>dqv4.job_application_conf.forward_click_reward_tpl</code>. 转发点击奖励通知模板
	 */
	...
	/**
	 * The column <code>dqv4.job_application_conf.forward_app_reward</code>. 转发申请奖励通知0:需要1:不需要
	 */
	...
	/**
	 * The column <code>dqv4.job_application_conf.forward_app_reward_tpl</code>. 转发申请奖励通知模板
	 */
	...
	/**
	 * The column <code>dqv4.job_application_conf.email_resume_conf</code>. 0:允许使用email简历进行投递；1:不允许使用email简历投递
	 */
	...
	/**
	 * The column <code>dqv4.job_application_conf.create_time</code>.
	 */
	...
	/**
	 * The column <code>dqv4.job_application_conf.update_time</code>.
	 */
	...
	/**
	 * Create a <code>dqv4.job_application_conf</code> table reference
	 */
	...
	/**
	 * Create an aliased <code>dqv4.job_application_conf</code> table reference
	 */
	...
	private JobApplicationConf(String alias, Table<JobApplicationConfRecord> aliased, Field<?>[] parameters) {
		super(alias, Dqv4.DQV4, aliased, parameters, "部门申请配置表");
	}
