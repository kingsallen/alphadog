...
public class ConfigAdminnotificationGroupmembers extends TableImpl<ConfigAdminnotificationGroupmembersRecord> {
	...
	private static final long serialVersionUID = -612396722;

	/**
	 * The reference instance of <code>dqv4.config_adminnotification_groupmembers</code>
	 */
	...
	/**
	 * The column <code>dqv4.config_adminnotification_groupmembers.id</code>.
	 */
	...
	/**
	 * The column <code>dqv4.config_adminnotification_groupmembers.groupid</code>. 群组id
	 */
	...
	/**
	 * The column <code>dqv4.config_adminnotification_groupmembers.memberid</code>. 联系人id
	 */
	...
	/**
	 * The column <code>dqv4.config_adminnotification_groupmembers.create_time</code>.
	 */
	...
	/**
	 * Create a <code>dqv4.config_adminnotification_groupmembers</code> table reference
	 */
	...
	/**
	 * Create an aliased <code>dqv4.config_adminnotification_groupmembers</code> table reference
	 */
	...
	private ConfigAdminnotificationGroupmembers(String alias, Table<ConfigAdminnotificationGroupmembersRecord> aliased, Field<?>[] parameters) {
		super(alias, Dqv4.DQV4, aliased, parameters, "管理员通知群组联系人");
	}
