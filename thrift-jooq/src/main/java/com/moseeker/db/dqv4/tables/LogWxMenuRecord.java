...
public class LogWxMenuRecord extends TableImpl<LogWxMenuRecordRecord> {
	...
	private static final long serialVersionUID = 938745833;

	/**
	 * The reference instance of <code>dqv4.log_wx_menu_record</code>
	 */
	...
	/**
	 * The column <code>dqv4.log_wx_menu_record.id</code>.
	 */
	...
	/**
	 * The column <code>dqv4.log_wx_menu_record.wechat_id</code>.
	 */
	...
	/**
	 * The column <code>dqv4.log_wx_menu_record.name</code>.
	 */
	...
	/**
	 * The column <code>dqv4.log_wx_menu_record.errcode</code>. 微信调用返回的errcode
	 */
	...
	/**
	 * The column <code>dqv4.log_wx_menu_record.errmsg</code>. 微信调用返回的errmsg
	 */
	...
	/**
	 * Create a <code>dqv4.log_wx_menu_record</code> table reference
	 */
	...
	/**
	 * Create an aliased <code>dqv4.log_wx_menu_record</code> table reference
	 */
	...
	private LogWxMenuRecord(String alias, Table<LogWxMenuRecordRecord> aliased, Field<?>[] parameters) {
		super(alias, Dqv4.DQV4, aliased, parameters, "微信菜单操作日志表");
	}
