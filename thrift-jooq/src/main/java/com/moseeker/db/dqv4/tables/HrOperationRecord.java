...
public class HrOperationRecord extends TableImpl<HrOperationRecordRecord> {
	...
	private static final long serialVersionUID = 1496153638;

	/**
	 * The reference instance of <code>dqv4.hr_operation_record</code>
	 */
	...
	/**
	 * The column <code>dqv4.hr_operation_record.id</code>.
	 */
	...
	/**
	 * The column <code>dqv4.hr_operation_record.admin_id</code>. hr_account.id
	 */
	...
	/**
	 * The column <code>dqv4.hr_operation_record.company_id</code>. company.id
	 */
	...
	/**
	 * The column <code>dqv4.hr_operation_record.app_id</code>. job_application.id
	 */
	...
	/**
	 * The column <code>dqv4.hr_operation_record.status_id</code>. hr_award_config.id
	 */
	...
	/**
	 * The column <code>dqv4.hr_operation_record.opt_time</code>. 操作时间
	 */
	...
	/**
	 * The column <code>dqv4.hr_operation_record.operate_tpl_id</code>. hr_award_config_template.id
	 */
	...
	/**
	 * Create a <code>dqv4.hr_operation_record</code> table reference
	 */
	...
	/**
	 * Create an aliased <code>dqv4.hr_operation_record</code> table reference
	 */
	...
	private HrOperationRecord(String alias, Table<HrOperationRecordRecord> aliased, Field<?>[] parameters) {
		super(alias, Dqv4.DQV4, aliased, parameters, "hr申请状态操作记录");
	}
