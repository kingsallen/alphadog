...
public class HrHbScratchCard extends TableImpl<HrHbScratchCardRecord> {
	...
	private static final long serialVersionUID = 599972346;

	/**
	 * The reference instance of <code>dqv4.hr_hb_scratch_card</code>
	 */
	...
	/**
	 * The column <code>dqv4.hr_hb_scratch_card.id</code>.
	 */
	...
	/**
	 * The column <code>dqv4.hr_hb_scratch_card.wechat_id</code>.
	 */
	...
	/**
	 * The column <code>dqv4.hr_hb_scratch_card.cardno</code>. 随机字符串
	 */
	...
	/**
	 * The column <code>dqv4.hr_hb_scratch_card.status</code>. 状态: 0：未拆开 1：已拆开
	 */
	...
	/**
	 * The column <code>dqv4.hr_hb_scratch_card.amount</code>. 红包金额： 0.00 表示不发红包
	 */
	...
	/**
	 * The column <code>dqv4.hr_hb_scratch_card.hb_config_id</code>.
	 */
	...
	/**
	 * The column <code>dqv4.hr_hb_scratch_card.bagging_openid</code>. 聚合号的 openid
	 */
	...
	/**
	 * The column <code>dqv4.hr_hb_scratch_card.create_time</code>.
	 */
	...
	/**
	 * The column <code>dqv4.hr_hb_scratch_card.hb_item_id</code>.
	 */
	...
	/**
	 * The column <code>dqv4.hr_hb_scratch_card.tips</code>. 是否是小费 0:不是，1:是
	 */
	...
	/**
	 * Create a <code>dqv4.hr_hb_scratch_card</code> table reference
	 */
	...
	/**
	 * Create an aliased <code>dqv4.hr_hb_scratch_card</code> table reference
	 */
	...
	private HrHbScratchCard(String alias, Table<HrHbScratchCardRecord> aliased, Field<?>[] parameters) {
		super(alias, Dqv4.DQV4, aliased, parameters, "新红包刮刮卡记录表");
	}
