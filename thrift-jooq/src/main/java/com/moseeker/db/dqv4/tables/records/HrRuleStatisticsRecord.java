...
public class HrRuleStatisticsRecord extends UpdatableRecordImpl<HrRuleStatisticsRecord> implements Record7<Integer, Integer, String, Integer, Integer, Integer, Date> {
	...
	private static final long serialVersionUID = -164981798;

	/**
	 * Setter for <code>dqv4.hr_rule_statistics.id</code>. primary key
	 */
	...
	/**
	 * Getter for <code>dqv4.hr_rule_statistics.id</code>. primary key
	 */
	...
	/**
	 * Setter for <code>dqv4.hr_rule_statistics.wxrule_id</code>. wx_rule.id
	 */
	...
	/**
	 * Getter for <code>dqv4.hr_rule_statistics.wxrule_id</code>. wx_rule.id
	 */
	...
	/**
	 * Setter for <code>dqv4.hr_rule_statistics.menu_name</code>. 菜单名称
	 */
	...
	/**
	 * Getter for <code>dqv4.hr_rule_statistics.menu_name</code>. 菜单名称
	 */
	...
	/**
	 * Setter for <code>dqv4.hr_rule_statistics.type</code>. 0: wx_rule, 1: menu
	 */
	...
	/**
	 * Getter for <code>dqv4.hr_rule_statistics.type</code>. 0: wx_rule, 1: menu
	 */
	...
	/**
	 * Setter for <code>dqv4.hr_rule_statistics.company_id</code>. company.id
	 */
	...
	/**
	 * Getter for <code>dqv4.hr_rule_statistics.company_id</code>. company.id
	 */
	...
	/**
	 * Setter for <code>dqv4.hr_rule_statistics.view_num_pv</code>. 浏览人数
	 */
	...
	/**
	 * Getter for <code>dqv4.hr_rule_statistics.view_num_pv</code>. 浏览人数
	 */
	...
	/**
	 * Setter for <code>dqv4.hr_rule_statistics.create_date</code>. 创建日期
	 */
	...
	/**
	 * Getter for <code>dqv4.hr_rule_statistics.create_date</code>. 创建日期
	 */
