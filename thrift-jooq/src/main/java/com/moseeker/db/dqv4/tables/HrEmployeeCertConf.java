...
public class HrEmployeeCertConf extends TableImpl<HrEmployeeCertConfRecord> {
	...
	private static final long serialVersionUID = 1557622033;

	/**
	 * The reference instance of <code>dqv4.hr_employee_cert_conf</code>
	 */
	...
	/**
	 * The column <code>dqv4.hr_employee_cert_conf.id</code>.
	 */
	...
	/**
	 * The column <code>dqv4.hr_employee_cert_conf.company_id</code>. 所属部门
	 */
	...
	/**
	 * The column <code>dqv4.hr_employee_cert_conf.is_strict</code>. 是否严格0：严格，1：不严格
	 */
	...
	/**
	 * The column <code>dqv4.hr_employee_cert_conf.email_suffix</code>. 邮箱后缀
	 */
	...
	/**
	 * The column <code>dqv4.hr_employee_cert_conf.disable</code>. 是否启用 0：启用1：禁用
	 */
	...
	/**
	 * The column <code>dqv4.hr_employee_cert_conf.bd_add_group</code>. 用户绑定时需要加入员工组Flag, 0:需要添加到员工组 1:不需要添加到员工组
	 */
	...
	/**
	 * The column <code>dqv4.hr_employee_cert_conf.bd_use_group_id</code>. 用户绑定时需要加入员工组的分组编号
	 */
	...
	/**
	 * The column <code>dqv4.hr_employee_cert_conf.auth_mode</code>. 认证方式，0:不启用员工认证, 1:邮箱认证, 2:自定义认证, 3:姓名手机号认证, 4:邮箱自定义两种认证
	 */
	...
	/**
	 * The column <code>dqv4.hr_employee_cert_conf.auth_code</code>. 认证码（6到20位， 字母和数字组成，区分大小写）  默认为空
	 */
	...
	/**
	 * The column <code>dqv4.hr_employee_cert_conf.custom</code>. 配置的自定义认证名称
	 */
	...
	/**
	 * The column <code>dqv4.hr_employee_cert_conf.create_time</code>. 创建时间
	 */
	...
	/**
	 * The column <code>dqv4.hr_employee_cert_conf.update_time</code>. 修改时间
	 */
	...
	/**
	 * Create a <code>dqv4.hr_employee_cert_conf</code> table reference
	 */
	...
	/**
	 * Create an aliased <code>dqv4.hr_employee_cert_conf</code> table reference
	 */
	...
	private HrEmployeeCertConf(String alias, Table<HrEmployeeCertConfRecord> aliased, Field<?>[] parameters) {
		super(alias, Dqv4.DQV4, aliased, parameters, "部门员工配置表");
	}
