...
public class ConfigAdminnotificationMembersRecord extends UpdatableRecordImpl<ConfigAdminnotificationMembersRecord> implements Record7<Integer, String, String, String, String, Byte, Timestamp> {
	...
	private static final long serialVersionUID = 185871759;

	/**
	 * Setter for <code>dqv4.config_adminnotification_members.id</code>.
	 */
	...
	/**
	 * Getter for <code>dqv4.config_adminnotification_members.id</code>.
	 */
	...
	/**
	 * Setter for <code>dqv4.config_adminnotification_members.name</code>. 姓名
	 */
	...
	/**
	 * Getter for <code>dqv4.config_adminnotification_members.name</code>. 姓名
	 */
	...
	/**
	 * Setter for <code>dqv4.config_adminnotification_members.mobilephone</code>. 接收通知的手机
	 */
	...
	/**
	 * Getter for <code>dqv4.config_adminnotification_members.mobilephone</code>. 接收通知的手机
	 */
	...
	/**
	 * Setter for <code>dqv4.config_adminnotification_members.wechatopenid</code>. 接收通知的微信openid
	 */
	...
	/**
	 * Getter for <code>dqv4.config_adminnotification_members.wechatopenid</code>. 接收通知的微信openid
	 */
	...
	/**
	 * Setter for <code>dqv4.config_adminnotification_members.email</code>. 接收通知的email
	 */
	...
	/**
	 * Getter for <code>dqv4.config_adminnotification_members.email</code>. 接收通知的email
	 */
	...
	/**
	 * Setter for <code>dqv4.config_adminnotification_members.status</code>. 1 有效 0 无效
	 */
	...
	/**
	 * Getter for <code>dqv4.config_adminnotification_members.status</code>. 1 有效 0 无效
	 */
	...
	/**
	 * Setter for <code>dqv4.config_adminnotification_members.create_time</code>.
	 */
	...
	/**
	 * Getter for <code>dqv4.config_adminnotification_members.create_time</code>.
	 */
