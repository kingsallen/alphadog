...
public class LogWxMessageRecordRecord extends UpdatableRecordImpl<LogWxMessageRecordRecord> implements Record15<UInteger, UInteger, UInteger, Long, String, String, String, String, UInteger, String, Timestamp, Timestamp, String, Integer, String> {
	...
	private static final long serialVersionUID = -14296278;

	/**
	 * Setter for <code>dqv4.log_wx_message_record.id</code>. 主key
	 */
	...
	/**
	 * Getter for <code>dqv4.log_wx_message_record.id</code>. 主key
	 */
	...
	/**
	 * Setter for <code>dqv4.log_wx_message_record.template_id</code>. 我的模板ID
	 */
	...
	/**
	 * Getter for <code>dqv4.log_wx_message_record.template_id</code>. 我的模板ID
	 */
	...
	/**
	 * Setter for <code>dqv4.log_wx_message_record.wechat_id</code>. 所属公众号
	 */
	...
	/**
	 * Getter for <code>dqv4.log_wx_message_record.wechat_id</code>. 所属公众号
	 */
	...
	/**
	 * Setter for <code>dqv4.log_wx_message_record.msgid</code>. 发送消息ID
	 */
	...
	/**
	 * Getter for <code>dqv4.log_wx_message_record.msgid</code>. 发送消息ID
	 */
	...
	/**
	 * Setter for <code>dqv4.log_wx_message_record.open_id</code>. 微信用户OPENID
	 */
	...
	/**
	 * Getter for <code>dqv4.log_wx_message_record.open_id</code>. 微信用户OPENID
	 */
	...
	/**
	 * Setter for <code>dqv4.log_wx_message_record.url</code>. link
	 */
	...
	/**
	 * Getter for <code>dqv4.log_wx_message_record.url</code>. link
	 */
	...
	/**
	 * Setter for <code>dqv4.log_wx_message_record.topcolor</code>. 信息顶部颜色
	 */
	...
	/**
	 * Getter for <code>dqv4.log_wx_message_record.topcolor</code>. 信息顶部颜色
	 */
	...
	/**
	 * Setter for <code>dqv4.log_wx_message_record.jsondata</code>. 发送的json数据
	 */
	...
	/**
	 * Getter for <code>dqv4.log_wx_message_record.jsondata</code>. 发送的json数据
	 */
	...
	/**
	 * Setter for <code>dqv4.log_wx_message_record.errcode</code>. 返回结果值
	 */
	...
	/**
	 * Getter for <code>dqv4.log_wx_message_record.errcode</code>. 返回结果值
	 */
	...
	/**
	 * Setter for <code>dqv4.log_wx_message_record.errmsg</code>. 返回提示信息
	 */
	...
	/**
	 * Getter for <code>dqv4.log_wx_message_record.errmsg</code>. 返回提示信息
	 */
	...
	/**
	 * Setter for <code>dqv4.log_wx_message_record.sendtime</code>. 发送时间
	 */
	...
	/**
	 * Getter for <code>dqv4.log_wx_message_record.sendtime</code>. 发送时间
	 */
	...
	/**
	 * Setter for <code>dqv4.log_wx_message_record.updatetime</code>. 反馈状态时间
	 */
	...
	/**
	 * Getter for <code>dqv4.log_wx_message_record.updatetime</code>. 反馈状态时间
	 */
	...
	/**
	 * Setter for <code>dqv4.log_wx_message_record.sendstatus</code>. 发送状态
	 */
	...
	/**
	 * Getter for <code>dqv4.log_wx_message_record.sendstatus</code>. 发送状态
	 */
	...
	/**
	 * Setter for <code>dqv4.log_wx_message_record.sendtype</code>. 发送类型 0:微信 1:邮件 2:短信
	 */
	...
	/**
	 * Getter for <code>dqv4.log_wx_message_record.sendtype</code>. 发送类型 0:微信 1:邮件 2:短信
	 */
	...
	/**
	 * Setter for <code>dqv4.log_wx_message_record.access_token</code>. 发送时的access_token
	 */
	...
	/**
	 * Getter for <code>dqv4.log_wx_message_record.access_token</code>. 发送时的access_token
	 */
	 ...
	 */
	@Override
	public LogWxMessageRecordRecord value1(UInteger value) {
		setId(value);
		return this;
	}
	 ...
	 */
	@Override
	public LogWxMessageRecordRecord value2(UInteger value) {
		setTemplateId(value);
		return this;
	}
	 ...
	 */
	@Override
	public LogWxMessageRecordRecord value3(UInteger value) {
		setWechatId(value);
		return this;
	}
	 ...
	 */
	@Override
	public LogWxMessageRecordRecord value9(UInteger value) {
		setErrcode(value);
		return this;
	}
	 ...
	 */
	@Override
	public LogWxMessageRecordRecord values(UInteger value1, UInteger value2, UInteger value3, Long value4, String value5, String value6, String value7, String value8, UInteger value9, String value10, Timestamp value11, Timestamp value12, String value13, Integer value14, String value15) {
		value1(value1);
		value2(value2);
		value3(value3);
		value4(value4);
	 ...
	 */
	public LogWxMessageRecordRecord(UInteger id, UInteger templateId, UInteger wechatId, Long msgid, String openId, String url, String topcolor, String jsondata, UInteger errcode, String errmsg, Timestamp sendtime, Timestamp updatetime, String sendstatus, Integer sendtype, String accessToken) {
		super(LogWxMessageRecord.LOG_WX_MESSAGE_RECORD);
