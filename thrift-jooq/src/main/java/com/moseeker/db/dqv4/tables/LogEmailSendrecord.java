...
public class LogEmailSendrecord extends TableImpl<LogEmailSendrecordRecord> {
	...
	private static final long serialVersionUID = -796955287;

	/**
	 * The reference instance of <code>dqv4.log_email_sendrecord</code>
	 */
	...
	/**
	 * The column <code>dqv4.log_email_sendrecord.id</code>.
	 */
	...
	/**
	 * The column <code>dqv4.log_email_sendrecord.type</code>. 邮件类型
	 */
	...
	/**
	 * The column <code>dqv4.log_email_sendrecord.sys</code>. 来自系统，0:未知 1:platform 2:qx 3:hr 4:官网 9:script
	 */
	...
	/**
	 * The column <code>dqv4.log_email_sendrecord.email</code>. 邮箱地址
	 */
	...
	/**
	 * The column <code>dqv4.log_email_sendrecord.content</code>. 邮件变量部分内容以json方式
	 */
	...
	/**
	 * The column <code>dqv4.log_email_sendrecord.create_time</code>.
	 */
	...
	/**
	 * Create a <code>dqv4.log_email_sendrecord</code> table reference
	 */
	...
	/**
	 * Create an aliased <code>dqv4.log_email_sendrecord</code> table reference
	 */
	...
	private LogEmailSendrecord(String alias, Table<LogEmailSendrecordRecord> aliased, Field<?>[] parameters) {
		super(alias, Dqv4.DQV4, aliased, parameters, "短信发送记录表");
	}
