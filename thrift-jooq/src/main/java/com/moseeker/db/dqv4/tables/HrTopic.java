...
public class HrTopic extends TableImpl<HrTopicRecord> {
	...
	private static final long serialVersionUID = -114539903;

	/**
	 * The reference instance of <code>dqv4.hr_topic</code>
	 */
	...
	/**
	 * The column <code>dqv4.hr_topic.share_title</code>. 分享标题
	 */
	...
	/**
	 * The column <code>dqv4.hr_topic.share_logo</code>. 分享LOGO的相对路径
	 */
	...
	/**
	 * The column <code>dqv4.hr_topic.share_description</code>. 分享描述
	 */
	...
	/**
	 * The column <code>dqv4.hr_topic.style_id</code>. wx_group_user.id， 推荐者微信ID
	 */
	...
	/**
	 * The column <code>dqv4.hr_topic.creator</code>. hr_account.id
	 */
	...
	/**
	 * The column <code>dqv4.hr_topic.disable</code>. 是否有效  0：有效 1：无效
	 */
	...
	/**
	 * The column <code>dqv4.hr_topic.create_time</code>.
	 */
	...
	/**
	 * The column <code>dqv4.hr_topic.update_time</code>.
	 */
	...
	/**
	 * Create a <code>dqv4.hr_topic</code> table reference
	 */
	public HrTopic() {
		this("hr_topic", null);
	}
	...
	/**
	 * Create an aliased <code>dqv4.hr_topic</code> table reference
	 */
	...
	private HrTopic(String alias, Table<HrTopicRecord> aliased, Field<?>[] parameters) {
		super(alias, Dqv4.DQV4, aliased, parameters, "雇主主题活动表");
	}
