...
public class UserHrAccount extends TableImpl<UserHrAccountRecord> {
	...
	private static final long serialVersionUID = 919563009;

	/**
	 * The reference instance of <code>dqv4.user_hr_account</code>
	 */
	...
	/**
	 * The column <code>dqv4.user_hr_account.id</code>.
	 */
	...
	/**
	 * The column <code>dqv4.user_hr_account.company_id</code>. company.id
	 */
	...
	/**
	 * The column <code>dqv4.user_hr_account.mobile</code>. 手机号码
	 */
	...
	/**
	 * The column <code>dqv4.user_hr_account.email</code>. 邮箱
	 */
	...
	/**
	 * The column <code>dqv4.user_hr_account.wxuser_id</code>. 绑定的微信账号
	 */
	...
	/**
	 * The column <code>dqv4.user_hr_account.password</code>. 登录密码
	 */
	...
	/**
	 * The column <code>dqv4.user_hr_account.username</code>. 企业联系人
	 */
	...
	/**
	 * The column <code>dqv4.user_hr_account.account_type</code>. 0 超级账号；1：子账号; 2：普通账号
	 */
	...
	/**
	 * The column <code>dqv4.user_hr_account.activation</code>. 账号是否激活，1：激活；0：未激活
	 */
	...
	/**
	 * The column <code>dqv4.user_hr_account.disable</code>. 1：可用账号；0禁用账号 ） 遵循数据库整体的设计习惯，1表示可用，0表示不可用
	 */
	...
	/**
	 * The column <code>dqv4.user_hr_account.register_time</code>. 注册时间
	 */
	...
	/**
	 * The column <code>dqv4.user_hr_account.register_ip</code>. 注册时的IP地址
	 */
	...
	/**
	 * The column <code>dqv4.user_hr_account.last_login_time</code>. 最后的登录时间
	 */
	...
	/**
	 * The column <code>dqv4.user_hr_account.last_login_ip</code>. 最后一次登录的IP
	 */
	...
	/**
	 * The column <code>dqv4.user_hr_account.login_count</code>. 登录次数
	 */
	...
	/**
	 * The column <code>dqv4.user_hr_account.source</code>. 来源1:雇主 2:官网 3:微信扫描 4:我也要招人(聚合号) 5:我也要招人(企业号)
	 */
	...
	/**
	 * The column <code>dqv4.user_hr_account.download_token</code>. 下载行业报告校验码
	 */
	...
	/**
	 * The column <code>dqv4.user_hr_account.create_time</code>. 创建时间
	 */
	...
	/**
	 * The column <code>dqv4.user_hr_account.update_time</code>. 修改时间
	 */
	...
	/**
	 * Create a <code>dqv4.user_hr_account</code> table reference
	 */
	...
	/**
	 * Create an aliased <code>dqv4.user_hr_account</code> table reference
	 */
	...
	private UserHrAccount(String alias, Table<UserHrAccountRecord> aliased, Field<?>[] parameters) {
		super(alias, Dqv4.DQV4, aliased, parameters, "hr账号表");
	}
