...
public class JobPosition extends TableImpl<JobPositionRecord> {
	...
	private static final long serialVersionUID = -799083093;

	/**
	 * The reference instance of <code>dqv4.job_position</code>
	 */
	...
	/**
	 * The column <code>dqv4.job_position.id</code>.
	 */
	...
	/**
	 * The column <code>dqv4.job_position.jobnumber</code>. 职位编号
	 */
	...
	/**
	 * The column <code>dqv4.job_position.company_id</code>. company.id
	 */
	...
	/**
	 * The column <code>dqv4.job_position.title</code>. 职位标题
	 */
	...
	/**
	 * The column <code>dqv4.job_position.province</code>. 所在省
	 */
	...
	/**
	 * The column <code>dqv4.job_position.city</code>. 所在城市
	 */
	...
	/**
	 * The column <code>dqv4.job_position.department</code>. 所在部门
	 */
	...
	/**
	 * The column <code>dqv4.job_position.l_jobid</code>. jobid from ATS or other channel
	 */
	...
	/**
	 * The column <code>dqv4.job_position.publish_date</code>. Default: now, set by js
	 */
	...
	/**
	 * The column <code>dqv4.job_position.stop_date</code>. 截止日期
	 */
	...
	/**
	 * The column <code>dqv4.job_position.accountabilities</code>. Job responsibilities
	 */
	...
	/**
	 * The column <code>dqv4.job_position.experience</code>. 工作经验
	 */
	...
	/**
	 * The column <code>dqv4.job_position.requirement</code>. 职位要求
	 */
	...
	/**
	 * The column <code>dqv4.job_position.salary</code>. 薪水
	 */
	...
	/**
	 * The column <code>dqv4.job_position.language</code>. 外语要求
	 */
	...
	/**
	 * The column <code>dqv4.job_position.job_grade</code>. 优先级
	 */
	...
	/**
	 * The column <code>dqv4.job_position.status</code>. 0 有效, 1 无效, 2 撤销
	 */
	...
	/**
	 * The column <code>dqv4.job_position.visitnum</code>.
	 */
	...
	/**
	 * The column <code>dqv4.job_position.lastvisit</code>. openid of last visiter
	 */
	...
	/**
	 * The column <code>dqv4.job_position.source_id</code>. 职位来源 0：Moseeker
	 */
	...
	/**
	 * The column <code>dqv4.job_position.update_time</code>.
	 */
	...
	/**
	 * The column <code>dqv4.job_position.business_group</code>. 事业群
	 */
	...
	/**
	 * The column <code>dqv4.job_position.employment_type</code>. 0:全职，1：兼职：2：合同工
	 */
	...
	/**
	 * The column <code>dqv4.job_position.hr_email</code>. HR联系人邮箱，申请通知
	 */
	...
	/**
	 * The column <code>dqv4.job_position.benefits</code>. 职位福利
	 */
	...
	/**
	 * The column <code>dqv4.job_position.degree</code>. 0:无 1:大专 2:本科 3:硕士 4:MBA 5:博士
	 */
	...
	/**
	 * The column <code>dqv4.job_position.feature</code>. 职位特色
	 */
	...
	/**
	 * The column <code>dqv4.job_position.email_notice</code>. application after email notice hr, 0:yes 1:no
	 */
	...
	/**
	 * The column <code>dqv4.job_position.candidate_source</code>. 0:社招 1：校招 2:定向招聘
	 */
	...
	/**
	 * The column <code>dqv4.job_position.occupation</code>. 职位职能
	 */
	...
	/**
	 * The column <code>dqv4.job_position.is_recom</code>. 是否需要推荐0：需要 1：不需要
	 */
	...
	/**
	 * The column <code>dqv4.job_position.industry</code>. 所属行业
	 */
	...
	/**
	 * The column <code>dqv4.job_position.hongbao_config_id</code>.
	 */
	...
	/**
	 * The column <code>dqv4.job_position.hongbao_config_recom_id</code>.
	 */
	...
	/**
	 * The column <code>dqv4.job_position.hongbao_config_app_id</code>.
	 */
	...
	/**
	 * The column <code>dqv4.job_position.email_resume_conf</code>. 0:允许使用email简历进行投递；1:不允许使用email简历投递
	 */
	...
	/**
	 * The column <code>dqv4.job_position.l_PostingTargetId</code>. lumesse每一个职位会生成一个PostingTargetId,用来生成每个职位的投递邮箱地址
	 */
	...
	/**
	 * The column <code>dqv4.job_position.priority</code>. 是否置顶
	 */
	...
	/**
	 * The column <code>dqv4.job_position.share_tpl_id</code>. 分享分类0:无1:高大上2：小清新3：逗比
	 */
	...
	/**
	 * The column <code>dqv4.job_position.district</code>. 添加区(省市区的区)
	 */
	...
	/**
	 * The column <code>dqv4.job_position.count</code>. 添加招聘人数, 0：不限
	 */
	...
	/**
	 * The column <code>dqv4.job_position.salary_top</code>. 薪资上限（k）
	 */
	...
	/**
	 * The column <code>dqv4.job_position.salary_bottom</code>. 薪资下限（k）
	 */
	...
	/**
	 * The column <code>dqv4.job_position.experience_above</code>. 及以上 1：需要， 0：不需要
	 */
	...
	/**
	 * The column <code>dqv4.job_position.degree_above</code>. 及以上 1：需要， 0：不需要
	 */
	...
	/**
	 * The column <code>dqv4.job_position.management_experience</code>. 是否要求管理经验0：需要1：不需要
	 */
	...
	/**
	 * The column <code>dqv4.job_position.gender</code>. 0-> female, 1->male, 2->all
	 */
	...
	/**
	 * The column <code>dqv4.job_position.publisher</code>. hr_account.id
	 */
	...
	/**
	 * The column <code>dqv4.job_position.app_cv_config_id</code>. 职位开启并配置自定义模板 hr_app_cv_conf.id
	 */
	...
	/**
	 * The column <code>dqv4.job_position.source</code>. 0:手动创建, 1:导入, 9:ATS导入
	 */
	...
	/**
	 * The column <code>dqv4.job_position.hb_status</code>. 是否正参加活动：0=未参加  1=正参加点击红包活动  2=正参加被申请红包活动  3=正参加1+2红包活动
	 */
	...
	/**
	 * Create a <code>dqv4.job_position</code> table reference
	 */
	public JobPosition() {
	...
	/**
	 * Create an aliased <code>dqv4.job_position</code> table reference
	 */
