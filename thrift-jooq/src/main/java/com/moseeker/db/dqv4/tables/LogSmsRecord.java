...
public class LogSmsRecord extends TableImpl<LogSmsRecordRecord> {
	...
	private static final long serialVersionUID = -1074437138;

	/**
	 * The reference instance of <code>dqv4.log_sms_record</code>
	 */
	...
	/**
	 * The column <code>dqv4.log_sms_record.id</code>.
	 */
	...
	/**
	 * The column <code>dqv4.log_sms_record.sys</code>. 来自系统，0:未知 1:platform 2:qx 3:hr 4:官网 9:script
	 */
	...
	/**
	 * The column <code>dqv4.log_sms_record.mobile</code>.
	 */
	...
	/**
	 * Create a <code>dqv4.log_sms_record</code> table reference
	 */
	public LogSmsRecord() {
	...
	/**
	 * Create an aliased <code>dqv4.log_sms_record</code> table reference
	 */
