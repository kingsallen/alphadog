...
public class HrWxWechat extends TableImpl<HrWxWechatRecord> {
	...
	private static final long serialVersionUID = 62577071;

	/**
	 * The reference instance of <code>dqv4.hr_wx_wechat</code>
	 */
	...
	/**
	 * The column <code>dqv4.hr_wx_wechat.id</code>.
	 */
	...
	/**
	 * The column <code>dqv4.hr_wx_wechat.company_id</code>. 所属公司id, company.id
	 */
	...
	/**
	 * The column <code>dqv4.hr_wx_wechat.type</code>. 公众号类型, 0:订阅号, 1:服务号
	 */
	...
	/**
	 * The column <code>dqv4.hr_wx_wechat.signature</code>. 公众号ID匿名化
	 */
	...
	/**
	 * The column <code>dqv4.hr_wx_wechat.name</code>. 名称
	 */
	...
	/**
	 * The column <code>dqv4.hr_wx_wechat.alias</code>. 别名
	 */
	...
	/**
	 * The column <code>dqv4.hr_wx_wechat.username</code>. 用户名
	 */
	...
	/**
	 * The column <code>dqv4.hr_wx_wechat.password</code>. 密码
	 */
	...
	/**
	 * The column <code>dqv4.hr_wx_wechat.token</code>. 开发者token
	 */
	...
	/**
	 * The column <code>dqv4.hr_wx_wechat.appid</code>. 开发者appid
	 */
	...
	/**
	 * The column <code>dqv4.hr_wx_wechat.secret</code>. 开发者secret
	 */
	...
	/**
	 * The column <code>dqv4.hr_wx_wechat.welcome</code>. welcome message
	 */
	...
	/**
	 * The column <code>dqv4.hr_wx_wechat.default</code>. default message
	 */
	...
	/**
	 * The column <code>dqv4.hr_wx_wechat.qrcode</code>. 关注公众号的二维码
	 */
	...
	/**
	 * The column <code>dqv4.hr_wx_wechat.passive_seeker</code>. 被动求职者开关，0：开启，1：不开启
	 */
	...
	/**
	 * The column <code>dqv4.hr_wx_wechat.third_oauth</code>. 授权大岂第三方平台0：未授权 1：授权了
	 */
	...
	/**
	 * The column <code>dqv4.hr_wx_wechat.hr_register</code>. 是否启用免费雇主注册，0：不启用，1：启用
	 */
	...
	/**
	 * The column <code>dqv4.hr_wx_wechat.access_token_create_time</code>. access_token最新更新时间
	 */
	...
	/**
	 * The column <code>dqv4.hr_wx_wechat.access_token_expired</code>. access_token过期时间
	 */
	...
	/**
	 * The column <code>dqv4.hr_wx_wechat.access_token</code>. access_token
	 */
	...
	/**
	 * The column <code>dqv4.hr_wx_wechat.jsapi_ticket</code>. jsapi_ticket
	 */
	...
	/**
	 * The column <code>dqv4.hr_wx_wechat.authorized</code>. 是否授权0：无关，1：授权2：解除授权
	 */
	...
	/**
	 * The column <code>dqv4.hr_wx_wechat.unauthorized_time</code>. 解除授权的时间戳
	 */
	...
	/**
	 * The column <code>dqv4.hr_wx_wechat.authorizer_refresh_token</code>. 第三方授权的刷新token，用来刷access_token
	 */
	...
	/**
	 * The column <code>dqv4.hr_wx_wechat.create_time</code>. 创建时间
	 */
	...
	/**
	 * The column <code>dqv4.hr_wx_wechat.update_time</code>. 修改时间
	 */
	...
	/**
	 * Create a <code>dqv4.hr_wx_wechat</code> table reference
	 */
	public HrWxWechat() {
	...
	/**
	 * Create an aliased <code>dqv4.hr_wx_wechat</code> table reference
	 */
	...
	private HrWxWechat(String alias, Table<HrWxWechatRecord> aliased, Field<?>[] parameters) {
		super(alias, Dqv4.DQV4, aliased, parameters, "微信公众号表");
	}
