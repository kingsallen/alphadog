...
public class JobApplicationStatusBeisen extends TableImpl<JobApplicationStatusBeisenRecord> {
	...
	private static final long serialVersionUID = -968560490;

	/**
	 * The reference instance of <code>dqv4.job_application_status_beisen</code>
	 */
	...
	/**
	 * The column <code>dqv4.job_application_status_beisen.id</code>.
	 */
	...
	/**
	 * The column <code>dqv4.job_application_status_beisen.company_id</code>. company.id, 部门ID
	 */
	...
	/**
	 * The column <code>dqv4.job_application_status_beisen.applier_mobile</code>. 关注吉利微信公众账号的申请人的手机号
	 */
	...
	/**
	 * The column <code>dqv4.job_application_status_beisen.applier_name</code>. 申请人真实姓名
	 */
	...
	/**
	 * The column <code>dqv4.job_application_status_beisen.jobnumber</code>. 对应beisen投递状态中JobName中的code, 并非对应hr_position中jobnumber
	 */
	...
	/**
	 * The column <code>dqv4.job_application_status_beisen.jobtitle</code>. 对应beisen投递状态中Jobname中的value，对应hr_position中title
	 */
	...
	/**
	 * The column <code>dqv4.job_application_status_beisen.phasecode</code>. 对应beisen投递状态中PhaseCode中的code
	 */
	...
	/**
	 * The column <code>dqv4.job_application_status_beisen.phasename</code>. 对应beisen投递状态中PhaseName中的value
	 */
	...
	/**
	 * The column <code>dqv4.job_application_status_beisen.statuscode</code>. 对应beisen投递状态中StatusCode中的code
	 */
	...
	/**
	 * The column <code>dqv4.job_application_status_beisen.statusname</code>. 对应beisen投递状态中StatusName中的value
	 */
	...
	/**
	 * The column <code>dqv4.job_application_status_beisen.create_time</code>.
	 */
	...
	/**
	 * The column <code>dqv4.job_application_status_beisen.update_time</code>.
	 */
	...
	/**
	 * Create a <code>dqv4.job_application_status_beisen</code> table reference
	 */
	...
	/**
	 * Create an aliased <code>dqv4.job_application_status_beisen</code> table reference
	 */
	...
	private JobApplicationStatusBeisen(String alias, Table<JobApplicationStatusBeisenRecord> aliased, Field<?>[] parameters) {
		super(alias, Dqv4.DQV4, aliased, parameters, "申请状态记录（ats北森）");
	}
