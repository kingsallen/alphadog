...
public class HrWxRule extends TableImpl<HrWxRuleRecord> {
	...
	private static final long serialVersionUID = -335781253;

	/**
	 * The reference instance of <code>dqv4.hr_wx_rule</code>
	 */
	...
	/**
	 * The column <code>dqv4.hr_wx_rule.id</code>.
	 */
	...
	/**
	 * The column <code>dqv4.hr_wx_rule.wechat_id</code>.
	 */
	...
	/**
	 * The column <code>dqv4.hr_wx_rule.cid</code>.
	 */
	...
	/**
	 * The column <code>dqv4.hr_wx_rule.name</code>.
	 */
	...
	/**
	 * The column <code>dqv4.hr_wx_rule.module</code>. 模块名称
	 */
	...
	/**
	 * The column <code>dqv4.hr_wx_rule.displayorder</code>. 排序
	 */
	...
	/**
	 * The column <code>dqv4.hr_wx_rule.status</code>. 规则状态，0禁用，1启用，2置顶
	 */
	...
	/**
	 * The column <code>dqv4.hr_wx_rule.access_level</code>. 规则获取权限，0：所有，1：员工
	 */
	...
	/**
	 * The column <code>dqv4.hr_wx_rule.keywords</code>. 关键字
	 */
	...
	/**
	 * Create a <code>dqv4.hr_wx_rule</code> table reference
	 */
	public HrWxRule() {
	...
	/**
	 * Create an aliased <code>dqv4.hr_wx_rule</code> table reference
	 */
	...
	private HrWxRule(String alias, Table<HrWxRuleRecord> aliased, Field<?>[] parameters) {
		super(alias, Dqv4.DQV4, aliased, parameters, "微信回复规则表");
	}
