...
public class HrHbPositionBinding extends TableImpl<HrHbPositionBindingRecord> {
	...
	private static final long serialVersionUID = 1091027382;

	/**
	 * The reference instance of <code>dqv4.hr_hb_position_binding</code>
	 */
	...
	/**
	 * The column <code>dqv4.hr_hb_position_binding.id</code>.
	 */
	...
	/**
	 * The column <code>dqv4.hr_hb_position_binding.hb_config_id</code>. hr_hb_config.id
	 */
	...
	/**
	 * The column <code>dqv4.hr_hb_position_binding.position_id</code>. hr_position.id
	 */
	...
	/**
	 * The column <code>dqv4.hr_hb_position_binding.trigger_way</code>. 领取条件：1=职位被转发 2=职位被申请
	 */
	...
	/**
	 * The column <code>dqv4.hr_hb_position_binding.total_amount</code>. 总金额
	 */
	...
	/**
	 * The column <code>dqv4.hr_hb_position_binding.total_num</code>. 红包总数
	 */
	...
	/**
	 * The column <code>dqv4.hr_hb_position_binding.create_time</code>. 创建时间
	 */
	...
	/**
	 * The column <code>dqv4.hr_hb_position_binding.update_time</code>. 更新时间
	 */
	...
	/**
	 * Create a <code>dqv4.hr_hb_position_binding</code> table reference
	 */
	...
	/**
	 * Create an aliased <code>dqv4.hr_hb_position_binding</code> table reference
	 */
	...
	private HrHbPositionBinding(String alias, Table<HrHbPositionBindingRecord> aliased, Field<?>[] parameters) {
		super(alias, Dqv4.DQV4, aliased, parameters, "红包配置和职位绑定表");
	}
