...
public class HrWxBasicReply extends TableImpl<HrWxBasicReplyRecord> {
	...
	private static final long serialVersionUID = 588804041;

	/**
	 * The reference instance of <code>dqv4.hr_wx_basic_reply</code>
	 */
	...
	/**
	 * The column <code>dqv4.hr_wx_basic_reply.id</code>.
	 */
	...
	/**
	 * The column <code>dqv4.hr_wx_basic_reply.rid</code>.
	 */
	...
	/**
	 * The column <code>dqv4.hr_wx_basic_reply.content</code>. 文本回复内容
	 */
	...
	/**
	 * Create a <code>dqv4.hr_wx_basic_reply</code> table reference
	 */
	...
	/**
	 * Create an aliased <code>dqv4.hr_wx_basic_reply</code> table reference
	 */
	...
	private HrWxBasicReply(String alias, Table<HrWxBasicReplyRecord> aliased, Field<?>[] parameters) {
		super(alias, Dqv4.DQV4, aliased, parameters, "微信文本回复表");
	}
