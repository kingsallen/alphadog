...
public class HrWxImageReply extends TableImpl<HrWxImageReplyRecord> {
	...
	private static final long serialVersionUID = -1775354728;

	/**
	 * The reference instance of <code>dqv4.hr_wx_image_reply</code>
	 */
	...
	/**
	 * The column <code>dqv4.hr_wx_image_reply.id</code>.
	 */
	...
	/**
	 * The column <code>dqv4.hr_wx_image_reply.rid</code>. wx_rule.id, 规则ID
	 */
	...
	/**
	 * The column <code>dqv4.hr_wx_image_reply.image</code>. 回复图片的相对路径
	 */
	...
	/**
	 * The column <code>dqv4.hr_wx_image_reply.create_time</code>.
	 */
	...
	/**
	 * The column <code>dqv4.hr_wx_image_reply.update_time</code>.
	 */
	...
	/**
	 * Create a <code>dqv4.hr_wx_image_reply</code> table reference
	 */
	...
	/**
	 * Create an aliased <code>dqv4.hr_wx_image_reply</code> table reference
	 */
	...
	private HrWxImageReply(String alias, Table<HrWxImageReplyRecord> aliased, Field<?>[] parameters) {
		super(alias, Dqv4.DQV4, aliased, parameters, "微信图片回复");
	}
