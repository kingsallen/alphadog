...
public class ProfileEducation extends TableImpl<ProfileEducationRecord> {
	...
	private static final long serialVersionUID = -686643418;

	/**
	 * The reference instance of <code>dqv4.profile_education</code>
	 */
	...
	/**
	 * The column <code>dqv4.profile_education.id</code>. 主key
	 */
	...
	/**
	 * The column <code>dqv4.profile_education.profile_id</code>. profile.id
	 */
	...
	/**
	 * The column <code>dqv4.profile_education.start</code>. 起止时间-起 yyyy-mm-dd
	 */
	...
	/**
	 * The column <code>dqv4.profile_education.end</code>. 起止时间-止 yyyy-mm-dd
	 */
	...
	/**
	 * The column <code>dqv4.profile_education.end_until_now</code>. 是否至今 0：否 1：是
	 */
	...
	/**
	 * The column <code>dqv4.profile_education.degree</code>. 学历 0:未选择 1: 大专以下, 2: 大专, 3: 本科, 4: 硕士, 5: 博士, 6:博士以上
	 */
	...
	/**
	 * The column <code>dqv4.profile_education.school_code</code>. 学校字典编码
	 */
	...
	/**
	 * The column <code>dqv4.profile_education.school_name</code>. 学校名称
	 */
	...
	/**
	 * The column <code>dqv4.profile_education.major_code</code>. 专业字典编码
	 */
	...
	/**
	 * The column <code>dqv4.profile_education.major_name</code>. 专业名称
	 */
	...
	/**
	 * The column <code>dqv4.profile_education.type</code>. 专业类型 0:未选择 1:文科 2:理科 ？
	 */
	...
	/**
	 * The column <code>dqv4.profile_education.description</code>. 教育描述
	 */
	...
	/**
	 * The column <code>dqv4.profile_education.create_time</code>. 创建时间
	 */
	...
	/**
	 * The column <code>dqv4.profile_education.update_time</code>. 更新时间
	 */
	...
	/**
	 * Create a <code>dqv4.profile_education</code> table reference
	 */
	...
	/**
	 * Create an aliased <code>dqv4.profile_education</code> table reference
	 */
	...
	private ProfileEducation(String alias, Table<ProfileEducationRecord> aliased, Field<?>[] parameters) {
		super(alias, Dqv4.DQV4, aliased, parameters, "Profile的教育经历");
	}
