...
public class ConfigSysTemplateMessageLibrary extends TableImpl<ConfigSysTemplateMessageLibraryRecord> {
	...
	private static final long serialVersionUID = -969514747;

	/**
	 * The reference instance of <code>dqv4.config_sys_template_message_library</code>
	 */
	...
	/**
	 * The column <code>dqv4.config_sys_template_message_library.id</code>. 主key
	 */
	...
	/**
	 * The column <code>dqv4.config_sys_template_message_library.title</code>. 模板标题
	 */
	...
	/**
	 * The column <code>dqv4.config_sys_template_message_library.primary_industry</code>. 一级行业
	 */
	...
	/**
	 * The column <code>dqv4.config_sys_template_message_library.two_industry</code>. 二级行业
	 */
	...
	/**
	 * The column <code>dqv4.config_sys_template_message_library.content</code>. 详细内容
	 */
	...
	/**
	 * The column <code>dqv4.config_sys_template_message_library.sample</code>. 内容示例
	 */
	...
	/**
	 * The column <code>dqv4.config_sys_template_message_library.display</code>. 是否显示
	 */
	...
	/**
	 * The column <code>dqv4.config_sys_template_message_library.priority</code>. 排序
	 */
	...
	/**
	 * The column <code>dqv4.config_sys_template_message_library.disable</code>. 是否可用
	 */
	...
	/**
	 * The column <code>dqv4.config_sys_template_message_library.type</code>. 模板类别 0:微信 1:邮件 2:短信 3:申请模板 4:其他
	 */
	...
	/**
	 * The column <code>dqv4.config_sys_template_message_library.template_id_short</code>. 模板库中模板的编号
	 */
	...
	/**
	 * The column <code>dqv4.config_sys_template_message_library.send_condition</code>. 触发条件
	 */
	...
	/**
	 * The column <code>dqv4.config_sys_template_message_library.sendtime</code>. 发送时间
	 */
	...
	/**
	 * The column <code>dqv4.config_sys_template_message_library.sendto</code>. 发送对象
	 */
	...
	/**
	 * The column <code>dqv4.config_sys_template_message_library.first</code>. 消息模板first文案
	 */
	...
	/**
	 * The column <code>dqv4.config_sys_template_message_library.remark</code>. 消息模板remark文案
	 */
	...
	/**
	 * The column <code>dqv4.config_sys_template_message_library.url</code>. 跳转页面
	 */
	...
	/**
	 * Create a <code>dqv4.config_sys_template_message_library</code> table reference
	 */
	...
	/**
	 * Create an aliased <code>dqv4.config_sys_template_message_library</code> table reference
	 */
	...
	private ConfigSysTemplateMessageLibrary(String alias, Table<ConfigSysTemplateMessageLibraryRecord> aliased, Field<?>[] parameters) {
		super(alias, Dqv4.DQV4, aliased, parameters, "模板消息库");
	}
