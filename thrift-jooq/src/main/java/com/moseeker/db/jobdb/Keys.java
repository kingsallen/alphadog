...
public class Keys {
    ...
    private static class UniqueKeys0 extends AbstractKeys {
        ...
        public static final UniqueKey<JobResumeBasicRecord> KEY_JOB_RESUME_BASIC_PRIMARY = createUniqueKey(JobResumeBasic.JOB_RESUME_BASIC, "KEY_job_resume_basic_PRIMARY", JobResumeBasic.JOB_RESUME_BASIC.ID);
