...
public class JobPosition extends TableImpl<JobPositionRecord> {
    ...
    private static final long serialVersionUID = -1849571821;
     ...
     */
    public final TableField<JobPositionRecord, Short> SHARE_TPL_ID = createField("share_tpl_id", org.jooq.impl.SQLDataType.SMALLINT.defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.SMALLINT)), this, "分享分类0:无1:高大上2：小清新3：逗比");
