...
public class JobApplicationConfRecord extends UpdatableRecordImpl<JobApplicationConfRecord> implements Record18<Integer, Integer, Integer, Integer, String, Integer, String, Integer, String, String, Integer, Integer, Integer, Integer, Integer, Byte, Timestamp, Timestamp> {

    private static final long serialVersionUID = 1117815620;
     ...
     */
    @Override
    public JobApplicationConfRecord value2(Integer value) {
        setCompanyId(value);
        return this;
    }
