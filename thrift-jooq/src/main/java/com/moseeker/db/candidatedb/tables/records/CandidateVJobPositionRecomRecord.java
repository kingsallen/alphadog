...
public class CandidateVJobPositionRecomRecord extends UpdatableRecordImpl<CandidateVJobPositionRecomRecord> implements Record5<Long, Integer, Integer, Timestamp, String> {

    private static final long serialVersionUID = -174551949;
