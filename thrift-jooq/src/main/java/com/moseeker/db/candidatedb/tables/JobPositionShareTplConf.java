...
public class JobPositionShareTplConf extends TableImpl<JobPositionShareTplConfRecord> {
	...
	private static final long serialVersionUID = 2042210125;

	/**
	 * The reference instance of <code>candidatedb.job_position_share_tpl_conf</code>
	 */
	...
	/**
	 * The column <code>candidatedb.job_position_share_tpl_conf.id</code>. PK
	 */
	...
	/**
	 * The column <code>candidatedb.job_position_share_tpl_conf.type</code>. 模板分类 1：雇主分享模板 2：员工分享模板
	 */
	...
	/**
	 * The column <code>candidatedb.job_position_share_tpl_conf.name</code>. 模板名称
	 */
	...
	/**
	 * The column <code>candidatedb.job_position_share_tpl_conf.title</code>. 分享标题
	 */
	...
	/**
	 * The column <code>candidatedb.job_position_share_tpl_conf.description</code>. 分享简介
	 */
	...
	/**
	 * The column <code>candidatedb.job_position_share_tpl_conf.disable</code>. 是否禁用0：可用， 1：禁用
	 */
	...
	/**
	 * The column <code>candidatedb.job_position_share_tpl_conf.remark</code>. 备注
	 */
	...
	/**
	 * The column <code>candidatedb.job_position_share_tpl_conf.priority</code>. 优先级
	 */
	...
	/**
	 * Create a <code>candidatedb.job_position_share_tpl_conf</code> table reference
	 */
	...
	/**
	 * Create an aliased <code>candidatedb.job_position_share_tpl_conf</code> table reference
	 */
	...
	private JobPositionShareTplConf(String alias, Table<JobPositionShareTplConfRecord> aliased, Field<?>[] parameters) {
		super(alias, Candidatedb.CANDIDATEDB, aliased, parameters, "职位分享描述配置模板");
	}
