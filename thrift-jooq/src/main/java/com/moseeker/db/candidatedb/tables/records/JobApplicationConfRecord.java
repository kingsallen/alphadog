...
public class JobApplicationConfRecord extends UpdatableRecordImpl<JobApplicationConfRecord> implements Record18<Integer, UInteger, Integer, Integer, String, Integer, String, Integer, String, String, Integer, Integer, Integer, Integer, Integer, Byte, Timestamp, Timestamp> {
	...
	private static final long serialVersionUID = -1308468261;

	/**
	 * Setter for <code>candidateDB.job_application_conf.id</code>.
	 */
	...
	/**
	 * Getter for <code>candidateDB.job_application_conf.id</code>.
	 */
	...
	/**
	 * Setter for <code>candidateDB.job_application_conf.company_id</code>. company.id, 部门ID
	 */
	...
	/**
	 * Getter for <code>candidateDB.job_application_conf.company_id</code>. company.id, 部门ID
	 */
	...
	/**
	 * Setter for <code>candidateDB.job_application_conf.appnotice</code>. 简历投递反馈通知
	 */
	...
	/**
	 * Getter for <code>candidateDB.job_application_conf.appnotice</code>. 简历投递反馈通知
	 */
	...
	/**
	 * Setter for <code>candidateDB.job_application_conf.appnotice_tpl</code>. 简历投递通知使用模板
	 */
	...
	/**
	 * Getter for <code>candidateDB.job_application_conf.appnotice_tpl</code>. 简历投递通知使用模板
	 */
	...
	/**
	 * Setter for <code>candidateDB.job_application_conf.app_reply</code>. 申请提交成功回复信息
	 */
	...
	/**
	 * Getter for <code>candidateDB.job_application_conf.app_reply</code>. 申请提交成功回复信息
	 */
	...
	/**
	 * Setter for <code>candidateDB.job_application_conf.email_appnotice</code>. 0：需要，1：不需要
	 */
	...
	/**
	 * Getter for <code>candidateDB.job_application_conf.email_appnotice</code>. 0：需要，1：不需要
	 */
	...
	/**
	 * Setter for <code>candidateDB.job_application_conf.email_appreply</code>. 申请邮箱回复内容html格式
	 */
	...
	/**
	 * Getter for <code>candidateDB.job_application_conf.email_appreply</code>. 申请邮箱回复内容html格式
	 */
	...
	/**
	 * Setter for <code>candidateDB.job_application_conf.sms_appnotice_id</code>. 短信通知ID
	 */
	...
	/**
	 * Getter for <code>candidateDB.job_application_conf.sms_appnotice_id</code>. 短信通知ID
	 */
	...
	/**
	 * Setter for <code>candidateDB.job_application_conf.sms_appnotice_prefix</code>. 短信通知职位前缀
	 */
	...
	/**
	 * Getter for <code>candidateDB.job_application_conf.sms_appnotice_prefix</code>. 短信通知职位前缀
	 */
	...
	/**
	 * Setter for <code>candidateDB.job_application_conf.sms_appnotice_signature</code>. 短信通知签名
	 */
	...
	/**
	 * Getter for <code>candidateDB.job_application_conf.sms_appnotice_signature</code>. 短信通知签名
	 */
	...
	/**
	 * Setter for <code>candidateDB.job_application_conf.sms_delay</code>. 短信通知延迟 单位： min
	 */
	...
	/**
	 * Getter for <code>candidateDB.job_application_conf.sms_delay</code>. 短信通知延迟 单位： min
	 */
	...
	/**
	 * Setter for <code>candidateDB.job_application_conf.forward_click_reward</code>. 转发点击奖励通知0:需要1:不需要
	 */
	...
	/**
	 * Getter for <code>candidateDB.job_application_conf.forward_click_reward</code>. 转发点击奖励通知0:需要1:不需要
	 */
	...
	/**
	 * Setter for <code>candidateDB.job_application_conf.forward_click_reward_tpl</code>. 转发点击奖励通知模板
	 */
	...
	/**
	 * Getter for <code>candidateDB.job_application_conf.forward_click_reward_tpl</code>. 转发点击奖励通知模板
	 */
	...
	/**
	 * Setter for <code>candidateDB.job_application_conf.forward_app_reward</code>. 转发申请奖励通知0:需要1:不需要
	 */
	...
	/**
	 * Getter for <code>candidateDB.job_application_conf.forward_app_reward</code>. 转发申请奖励通知0:需要1:不需要
	 */
	...
	/**
	 * Setter for <code>candidateDB.job_application_conf.forward_app_reward_tpl</code>. 转发申请奖励通知模板
	 */
	...
	/**
	 * Getter for <code>candidateDB.job_application_conf.forward_app_reward_tpl</code>. 转发申请奖励通知模板
	 */
	...
	/**
	 * Setter for <code>candidateDB.job_application_conf.email_resume_conf</code>. 0:允许使用email简历进行投递；1:不允许使用email简历投递
	 */
	...
	/**
	 * Getter for <code>candidateDB.job_application_conf.email_resume_conf</code>. 0:允许使用email简历进行投递；1:不允许使用email简历投递
	 */
	...
	/**
	 * Setter for <code>candidateDB.job_application_conf.create_time</code>.
	 */
	...
	/**
	 * Getter for <code>candidateDB.job_application_conf.create_time</code>.
	 */
	...
	/**
	 * Setter for <code>candidateDB.job_application_conf.update_time</code>.
	 */
	...
	/**
	 * Getter for <code>candidateDB.job_application_conf.update_time</code>.
	 */
