...
public class JobPosition extends TableImpl<JobPositionRecord> {
	...
	private static final long serialVersionUID = -1570819340;

	/**
	 * The reference instance of <code>candidateDB.job_position</code>
	 */
	...
	/**
	 * The column <code>candidateDB.job_position.id</code>.
	 */
	...
	/**
	 * The column <code>candidateDB.job_position.jobnumber</code>. 职位编号
	 */
	...
	/**
	 * The column <code>candidateDB.job_position.company_id</code>. company.id
	 */
	...
	/**
	 * The column <code>candidateDB.job_position.title</code>. 职位标题
	 */
	...
	/**
	 * The column <code>candidateDB.job_position.province</code>. 所在省
	 */
	...
	/**
	 * The column <code>candidateDB.job_position.city</code>. 所在城市
	 */
	...
	/**
	 * The column <code>candidateDB.job_position.department</code>. 所在部门
	 */
	...
	/**
	 * The column <code>candidateDB.job_position.l_jobid</code>. jobid from ATS or other channel
	 */
	...
	/**
	 * The column <code>candidateDB.job_position.publish_date</code>. Default: now, set by js
	 */
	...
	/**
	 * The column <code>candidateDB.job_position.stop_date</code>. 截止日期
	 */
	...
	/**
	 * The column <code>candidateDB.job_position.accountabilities</code>. Job responsibilities
	 */
	...
	/**
	 * The column <code>candidateDB.job_position.experience</code>. 工作经验
	 */
	...
	/**
	 * The column <code>candidateDB.job_position.requirement</code>. 职位要求
	 */
	...
	/**
	 * The column <code>candidateDB.job_position.salary</code>. 薪水
	 */
	...
	/**
	 * The column <code>candidateDB.job_position.language</code>. 外语要求
	 */
	...
	/**
	 * The column <code>candidateDB.job_position.job_grade</code>. 优先级
	 */
	...
	/**
	 * The column <code>candidateDB.job_position.status</code>. 0 有效, 1 无效, 2 撤销
	 */
	...
	/**
	 * The column <code>candidateDB.job_position.visitnum</code>.
	 */
	...
	/**
	 * The column <code>candidateDB.job_position.lastvisit</code>. openid of last visiter
	 */
	...
	/**
	 * The column <code>candidateDB.job_position.source_id</code>. 职位来源 0：Moseeker
	 */
	...
	/**
	 * The column <code>candidateDB.job_position.update_time</code>.
	 */
	...
	/**
	 * The column <code>candidateDB.job_position.business_group</code>. 事业群
	 */
	...
	/**
	 * The column <code>candidateDB.job_position.employment_type</code>. 0:全职，1：兼职：2：合同工 3:实习 9:其他
	 */
	...
	/**
	 * The column <code>candidateDB.job_position.hr_email</code>. HR联系人邮箱，申请通知
	 */
	...
	/**
	 * The column <code>candidateDB.job_position.benefits</code>. 职位福利
	 */
	...
	/**
	 * The column <code>candidateDB.job_position.degree</code>. 0:无 1:大专 2:本科 3:硕士 4:MBA 5:博士
	 */
	...
	/**
	 * The column <code>candidateDB.job_position.feature</code>. 职位特色
	 */
	...
	/**
	 * The column <code>candidateDB.job_position.email_notice</code>. application after email notice hr, 0:yes 1:no
	 */
	...
	/**
	 * The column <code>candidateDB.job_position.candidate_source</code>. 0:社招 1：校招 2:定向招聘
	 */
	...
	/**
	 * The column <code>candidateDB.job_position.occupation</code>. 职位职能
	 */
	...
	/**
	 * The column <code>candidateDB.job_position.is_recom</code>. 是否需要推荐0：需要 1：不需要
	 */
	...
	/**
	 * The column <code>candidateDB.job_position.industry</code>. 所属行业
	 */
	...
	/**
	 * The column <code>candidateDB.job_position.hongbao_config_id</code>.
	 */
	...
	/**
	 * The column <code>candidateDB.job_position.hongbao_config_recom_id</code>.
	 */
	...
	/**
	 * The column <code>candidateDB.job_position.hongbao_config_app_id</code>.
	 */
	...
	/**
	 * The column <code>candidateDB.job_position.email_resume_conf</code>. 0:允许使用email简历进行投递；1:不允许使用email简历投递
	 */
	...
	/**
	 * The column <code>candidateDB.job_position.l_PostingTargetId</code>. lumesse每一个职位会生成一个PostingTargetId,用来生成每个职位的投递邮箱地址
	 */
	...
	/**
	 * The column <code>candidateDB.job_position.priority</code>. 是否置顶
	 */
	...
	/**
	 * The column <code>candidateDB.job_position.share_tpl_id</code>. 分享分类0:无1:高大上2：小清新3：逗比
	 */
	...
	/**
	 * The column <code>candidateDB.job_position.district</code>. 添加区(省市区的区)
	 */
	...
	/**
	 * The column <code>candidateDB.job_position.count</code>. 添加招聘人数, 0：不限
	 */
	...
	/**
	 * The column <code>candidateDB.job_position.salary_top</code>. 薪资上限（k）
	 */
	...
	/**
	 * The column <code>candidateDB.job_position.salary_bottom</code>. 薪资下限（k）
	 */
	...
	/**
	 * The column <code>candidateDB.job_position.experience_above</code>. 及以上 1：需要， 0：不需要
	 */
	...
	/**
	 * The column <code>candidateDB.job_position.degree_above</code>. 及以上 1：需要， 0：不需要
	 */
	...
	/**
	 * The column <code>candidateDB.job_position.management_experience</code>. 是否要求管理经验0：需要1：不需要
	 */
	...
	/**
	 * The column <code>candidateDB.job_position.gender</code>. 0-> female, 1->male, 2->all
	 */
	...
	/**
	 * The column <code>candidateDB.job_position.publisher</code>. hr_account.id
	 */
	...
	/**
	 * The column <code>candidateDB.job_position.app_cv_config_id</code>. 职位开启并配置自定义模板 hr_app_cv_conf.id
	 */
	...
	/**
	 * The column <code>candidateDB.job_position.source</code>. 0:手动创建, 1:导入, 9:ATS导入
	 */
	...
	/**
	 * The column <code>candidateDB.job_position.hb_status</code>. 是否正参加活动：0=未参加  1=正参加点击红包活动  2=正参加被申请红包活动  3=正参加1+2红包活动
	 */
	...
	/**
	 * The column <code>candidateDB.job_position.child_company_id</code>. hr_child_company.id
	 */
	...
	/**
	 * The column <code>candidateDB.job_position.age</code>. 年龄要求, 0：无要求
	 */
	...
	/**
	 * The column <code>candidateDB.job_position.major_required</code>. 专业要求
	 */
	...
	/**
	 * The column <code>candidateDB.job_position.work_address</code>. 上班地址
	 */
	...
	/**
	 * The column <code>candidateDB.job_position.keyword</code>. 职位关键词
	 */
	...
	/**
	 * The column <code>candidateDB.job_position.reporting_to</code>. 汇报对象
	 */
	...
	/**
	 * The column <code>candidateDB.job_position.is_hiring</code>. 是否急招, 1:是 0:否
	 */
	...
	/**
	 * The column <code>candidateDB.job_position.underlings</code>. 下属人数， 0:没有下属
	 */
	...
	/**
	 * The column <code>candidateDB.job_position.language_required</code>. 语言要求，1:是 0:否
	 */
	...
	/**
	 * The column <code>candidateDB.job_position.target_industry</code>. 期望人选所在行业
	 */
	...
	/**
	 * The column <code>candidateDB.job_position.current_status</code>. 0:招募中, 1: 未发布, 2:暂停, 3:撤下, 4:关闭
	 */
	...
	/**
	 * The column <code>candidateDB.job_position.position_code</code>. 职能字典code, dict_position.code
	 */
	...
	/**
	 * Create a <code>candidateDB.job_position</code> table reference
	 */
	public JobPosition() {
	...
	/**
	 * Create an aliased <code>candidateDB.job_position</code> table reference
	 */
	...
	private JobPosition(String alias, Table<JobPositionRecord> aliased, Field<?>[] parameters) {
		super(alias, Candidatedb.CANDIDATEDB, aliased, parameters, "");
	}
