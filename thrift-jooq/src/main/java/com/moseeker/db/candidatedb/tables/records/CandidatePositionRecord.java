...
public class CandidatePositionRecord extends UpdatableRecordImpl<CandidatePositionRecord> implements Record6<Integer, Timestamp, Integer, Byte, Integer, Integer> {
	...
	private static final long serialVersionUID = -1754802269;
	...
	/**
	 * Setter for <code>candidateDB.candidate_position.candidate_department_id</code>. hr_candidate_department.id
	 */
	...
	/**
	 * Getter for <code>candidateDB.candidate_position.candidate_department_id</code>. hr_candidate_department.id
	 */
