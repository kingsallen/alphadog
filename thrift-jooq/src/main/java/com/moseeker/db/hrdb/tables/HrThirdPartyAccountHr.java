...
public class HrThirdPartyAccountHr extends TableImpl<HrThirdPartyAccountHrRecord> {
    ...
    private static final long serialVersionUID = -1315660970;
     ...
     */
    public final TableField<HrThirdPartyAccountHrRecord, Short> CHANNEL = createField("channel", org.jooq.impl.SQLDataType.SMALLINT.defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.SMALLINT)), this, "1=51job,2=猎聘,3=智联,4=linkedin");

    /**
     * The column <code>hrdb.hr_third_party_account_hr.status</code>. 绑定状态：0：取消分配，1：已分配
     */
    public final TableField<HrThirdPartyAccountHrRecord, Byte> STATUS = createField("status", org.jooq.impl.SQLDataType.TINYINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("1", org.jooq.impl.SQLDataType.TINYINT)), this, "绑定状态：0：取消分配，1：已分配");

    /**
     * The column <code>hrdb.hr_third_party_account_hr.create_time</code>. 分配账号的时间
     */
    public final TableField<HrThirdPartyAccountHrRecord, Timestamp> CREATE_TIME = createField("create_time", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "分配账号的时间");

    /**
     * The column <code>hrdb.hr_third_party_account_hr.update_time</code>. 取消分配账号的时间
     */
    public final TableField<HrThirdPartyAccountHrRecord, Timestamp> UPDATE_TIME = createField("update_time", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "取消分配账号的时间");
