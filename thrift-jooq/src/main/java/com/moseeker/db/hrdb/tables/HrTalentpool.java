...
public class HrTalentpool extends TableImpl<HrTalentpoolRecord> {
	...
	private static final long serialVersionUID = -1143398284;
	 ...
	 */
	public final TableField<HrTalentpoolRecord, Timestamp> CREATE_TIME = createField("create_time", org.jooq.impl.SQLDataType.TIMESTAMP.defaulted(true), this, "");

	/**
	 * The column <code>hrdb.hr_talentpool.update_time</code>.
	 */
	public final TableField<HrTalentpoolRecord, Timestamp> UPDATE_TIME = createField("update_time", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaulted(true), this, "");

	/**
	 * The column <code>hrdb.hr_talentpool.status</code>. 状态(0：正常，1：删除)
	 */
	public final TableField<HrTalentpoolRecord, Integer> STATUS = createField("status", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaulted(true), this, "状态(0：正常，1：删除)");
	...
	private HrTalentpool(String alias, Table<HrTalentpoolRecord> aliased, Field<?>[] parameters) {
		super(alias, Hrdb.HRDB, aliased, parameters, "人才库");
	}
