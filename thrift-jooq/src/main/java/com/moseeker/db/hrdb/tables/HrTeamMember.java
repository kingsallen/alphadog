...
public class HrTeamMember extends TableImpl<HrTeamMemberRecord> {
    ...
    private static final long serialVersionUID = 1074668162;
     ...
     */
    public final TableField<HrTeamMemberRecord, String> NAME = createField("name", org.jooq.impl.SQLDataType.VARCHAR.length(128).nullable(false).defaultValue(org.jooq.impl.DSL.field("", org.jooq.impl.SQLDataType.VARCHAR)), this, "成员名称");

    /**
     * The column <code>hrdb.hr_team_member.title</code>. 成员职称
     */
    public final TableField<HrTeamMemberRecord, String> TITLE = createField("title", org.jooq.impl.SQLDataType.VARCHAR.length(128).nullable(false).defaultValue(org.jooq.impl.DSL.field("", org.jooq.impl.SQLDataType.VARCHAR)), this, "成员职称");

    /**
     * The column <code>hrdb.hr_team_member.description</code>. 成员描述
     */
    public final TableField<HrTeamMemberRecord, String> DESCRIPTION = createField("description", org.jooq.impl.SQLDataType.VARCHAR.length(2048).nullable(false).defaultValue(org.jooq.impl.DSL.field("", org.jooq.impl.SQLDataType.VARCHAR)), this, "成员描述");

    /**
     * The column <code>hrdb.hr_team_member.team_id</code>. 成员所属团队
     */
    public final TableField<HrTeamMemberRecord, Integer> TEAM_ID = createField("team_id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "成员所属团队");

    /**
     * The column <code>hrdb.hr_team_member.user_id</code>. 成员对应用户
     */
    public final TableField<HrTeamMemberRecord, Integer> USER_ID = createField("user_id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "成员对应用户");

    /**
     * The column <code>hrdb.hr_team_member.create_time</code>. 创建时间
     */
    public final TableField<HrTeamMemberRecord, Timestamp> CREATE_TIME = createField("create_time", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "创建时间");

    /**
     * The column <code>hrdb.hr_team_member.update_time</code>. 更新时间
     */
    public final TableField<HrTeamMemberRecord, Timestamp> UPDATE_TIME = createField("update_time", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "更新时间");

    /**
     * The column <code>hrdb.hr_team_member.res_id</code>. 成员头像hr_resource.id
     */
    public final TableField<HrTeamMemberRecord, Integer> RES_ID = createField("res_id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "成员头像hr_resource.id");
