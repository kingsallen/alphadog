...
public class HrResourceBackupChendiRecord extends UpdatableRecordImpl<HrResourceBackupChendiRecord> implements Record7<Integer, String, Integer, String, Integer, String, Integer> {

    private static final long serialVersionUID = -395048568;
