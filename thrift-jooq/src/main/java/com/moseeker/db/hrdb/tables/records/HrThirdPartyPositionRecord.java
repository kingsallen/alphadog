...
public class HrThirdPartyPositionRecord extends UpdatableRecordImpl<HrThirdPartyPositionRecord> implements Record9<Integer, UInteger, String, Short, Byte, Byte, Timestamp, Timestamp, Timestamp> {

	private static final long serialVersionUID = 1999056548;
	 ...
	 */
	@Override
	public HrThirdPartyPositionRecord value5(Byte value) {
	 ...
	 */
	@Override
	public HrThirdPartyPositionRecord value6(Byte value) {
		setIsRefresh(value);
		return this;
	}
	 ...
	 */
	@Override
	public HrThirdPartyPositionRecord values(Integer value1, UInteger value2, String value3, Short value4, Byte value5, Byte value6, Timestamp value7, Timestamp value8, Timestamp value9) {
		value1(value1);
		value2(value2);
		value3(value3);
		value4(value4);
	 ...
	 */
	public HrThirdPartyPositionRecord(Integer id, UInteger positionId, String thirdPartPositionId, Short channel, Byte isSynchronization, Byte isRefresh, Timestamp syncTime, Timestamp refreshTime, Timestamp updateTime) {
		super(HrThirdPartyPosition.HR_THIRD_PARTY_POSITION);
