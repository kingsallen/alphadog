...
public class HrThirdPartyPositionRecord extends UpdatableRecordImpl<HrThirdPartyPositionRecord> implements Record13<Integer, Integer, String, Short, Short, Short, Timestamp, Timestamp, Timestamp, String, String, String, Short> {

    private static final long serialVersionUID = -1566140096;
     ...
     */
    @Override
    public Row13<Integer, Integer, String, Short, Short, Short, Timestamp, Timestamp, Timestamp, String, String, String, Short> fieldsRow() {
     ...
     */
    @Override
    public Row13<Integer, Integer, String, Short, Short, Short, Timestamp, Timestamp, Timestamp, String, String, String, Short> valuesRow() {
     ...
     */
    @Override
    public HrThirdPartyPositionRecord values(Integer value1, Integer value2, String value3, Short value4, Short value5, Short value6, Timestamp value7, Timestamp value8, Timestamp value9, String value10, String value11, String value12, Short value13) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public HrThirdPartyPositionRecord(Integer id, Integer positionId, String thirdPartPositionId, Short channel, Short isSynchronization, Short isRefresh, Timestamp syncTime, Timestamp refreshTime, Timestamp updateTime, String address, String occupation, String syncFailReason, Short useCompanyAddress) {
        super(HrThirdPartyPosition.HR_THIRD_PARTY_POSITION);
