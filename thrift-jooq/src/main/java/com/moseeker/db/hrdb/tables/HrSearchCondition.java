...
public class HrSearchCondition extends TableImpl<HrSearchConditionRecord> {
	...
	private static final long serialVersionUID = 320549106;
	 ...
	 */
	public final TableField<HrSearchConditionRecord, Integer> IN_LAST_JOB_SEARCH_POSITION = createField("in_last_job_search_position", org.jooq.impl.SQLDataType.INTEGER.defaulted(true), this, "是否只在最近一份工作中搜索曾任职务(0:否，1:是)");
	 ...
	 */
	public final TableField<HrSearchConditionRecord, Integer> IN_LAST_JOB_SEARCH_COMPANY = createField("in_last_job_search_company", org.jooq.impl.SQLDataType.INTEGER.defaulted(true), this, "是否只在最近一份工作中搜索公司名称（0:否，1:是）");
	 ...
	 */
	public final TableField<HrSearchConditionRecord, Timestamp> CREATE_TIME = createField("create_time", org.jooq.impl.SQLDataType.TIMESTAMP.defaulted(true), this, "创建时间");

	/**
	 * The column <code>hrdb.hr_search_condition.update_time</code>. 简历更新时间选项（0：不限，1：最近一周，2：最近两周，3：最近一个月）
	 */
	public final TableField<HrSearchConditionRecord, Integer> UPDATE_TIME = createField("update_time", org.jooq.impl.SQLDataType.INTEGER.defaulted(true), this, "简历更新时间选项（0：不限，1：最近一周，2：最近两周，3：最近一个月）");

	/**
	 * The column <code>hrdb.hr_search_condition.type</code>. 类型（0：候选人列表筛选条件，1：人才库列表筛选条件）
	 */
	public final TableField<HrSearchConditionRecord, Integer> TYPE = createField("type", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaulted(true), this, "类型（0：候选人列表筛选条件，1：人才库列表筛选条件）");
	...
	private HrSearchCondition(String alias, Table<HrSearchConditionRecord> aliased, Field<?>[] parameters) {
		super(alias, Hrdb.HRDB, aliased, parameters, "候选人列表常用筛选项");
	}
