...
public class Keys {
	...
	private static class UniqueKeys0 extends AbstractKeys {
		...
		public static final UniqueKey<HrNpsRecord> KEY_HR_NPS_PRIMARY = createUniqueKey(HrNps.HR_NPS, HrNps.HR_NPS.ID);
		public static final UniqueKey<HrNpsRecommendRecord> KEY_HR_NPS_RECOMMEND_PRIMARY = createUniqueKey(HrNpsRecommend.HR_NPS_RECOMMEND, HrNpsRecommend.HR_NPS_RECOMMEND.ID);
		public static final UniqueKey<HrNpsRecommendRecord> KEY_HR_NPS_RECOMMEND_HR_NPS_ID = createUniqueKey(HrNpsRecommend.HR_NPS_RECOMMEND, HrNpsRecommend.HR_NPS_RECOMMEND.HR_NPS_ID);
