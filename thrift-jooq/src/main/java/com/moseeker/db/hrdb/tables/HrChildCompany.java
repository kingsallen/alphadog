...
public class HrChildCompany extends TableImpl<HrChildCompanyRecord> {
    ...
    private static final long serialVersionUID = 1390734134;
     ...
     */
    public final TableField<HrChildCompanyRecord, String> ENAME = createField("ename", org.jooq.impl.SQLDataType.VARCHAR.length(50).nullable(false).defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>hrdb.hr_child_company.status</code>. 0:onuse 1:unused
     */
    public final TableField<HrChildCompanyRecord, Byte> STATUS = createField("status", org.jooq.impl.SQLDataType.TINYINT.nullable(false).defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.TINYINT)), this, "0:onuse 1:unused");

    /**
     * The column <code>hrdb.hr_child_company.CEO</code>. CEO
     */
    public final TableField<HrChildCompanyRecord, String> CEO = createField("CEO", org.jooq.impl.SQLDataType.VARCHAR.length(32).nullable(false).defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.VARCHAR)), this, "CEO");
     ...
     */
    public final TableField<HrChildCompanyRecord, String> SCALE = createField("scale", org.jooq.impl.SQLDataType.VARCHAR.length(20).nullable(false).defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.VARCHAR)), this, "people number of the company");

    /**
     * The column <code>hrdb.hr_child_company.province</code>. province
     */
    public final TableField<HrChildCompanyRecord, String> PROVINCE = createField("province", org.jooq.impl.SQLDataType.VARCHAR.length(32).nullable(false).defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.VARCHAR)), this, "province");

    /**
     * The column <code>hrdb.hr_child_company.city</code>. city
     */
    public final TableField<HrChildCompanyRecord, String> CITY = createField("city", org.jooq.impl.SQLDataType.VARCHAR.length(32).nullable(false).defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.VARCHAR)), this, "city");

    /**
     * The column <code>hrdb.hr_child_company.address</code>. address
     */
    public final TableField<HrChildCompanyRecord, String> ADDRESS = createField("address", org.jooq.impl.SQLDataType.VARCHAR.length(100).nullable(false).defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.VARCHAR)), this, "address");

    /**
     * The column <code>hrdb.hr_child_company.property</code>. 0:国有1:三资2:集体3:私有
     */
    public final TableField<HrChildCompanyRecord, Byte> PROPERTY = createField("property", org.jooq.impl.SQLDataType.TINYINT.defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.TINYINT)), this, "0:国有1:三资2:集体3:私有");

    /**
     * The column <code>hrdb.hr_child_company.business</code>. business
     */
    public final TableField<HrChildCompanyRecord, String> BUSINESS = createField("business", org.jooq.impl.SQLDataType.VARCHAR.length(100).nullable(false).defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.VARCHAR)), this, "business");

    /**
     * The column <code>hrdb.hr_child_company.establish_time</code>. 公司成立时间
     */
    public final TableField<HrChildCompanyRecord, String> ESTABLISH_TIME = createField("establish_time", org.jooq.impl.SQLDataType.VARCHAR.length(15).defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.VARCHAR)), this, "公司成立时间");

    /**
     * The column <code>hrdb.hr_child_company.parent_id</code>. 上级公司
     */
    public final TableField<HrChildCompanyRecord, Integer> PARENT_ID = createField("parent_id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.INTEGER)), this, "上级公司");
     ...
     */
    public final TableField<HrChildCompanyRecord, Integer> COMPANY_ID = createField("company_id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.INTEGER)), this, "hr_company.id");
