...
public class HrThirdPartyAccountRecord extends UpdatableRecordImpl<HrThirdPartyAccountRecord> implements Record11<Integer, Short, String, String, String, Short, Integer, Integer, Timestamp, Timestamp, Timestamp> {

    private static final long serialVersionUID = -1407317662;
     ...
     */
    @Override
    public Row11<Integer, Short, String, String, String, Short, Integer, Integer, Timestamp, Timestamp, Timestamp> fieldsRow() {
     ...
     */
    @Override
    public Row11<Integer, Short, String, String, String, Short, Integer, Integer, Timestamp, Timestamp, Timestamp> valuesRow() {
     ...
     */
    @Override
    public HrThirdPartyAccountRecord values(Integer value1, Short value2, String value3, String value4, String value5, Short value6, Integer value7, Integer value8, Timestamp value9, Timestamp value10, Timestamp value11) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public HrThirdPartyAccountRecord(Integer id, Short channel, String username, String password, String membername, Short binding, Integer companyId, Integer remainNum, Timestamp syncTime, Timestamp updateTime, Timestamp createTime) {
        super(HrThirdPartyAccount.HR_THIRD_PARTY_ACCOUNT);
