...
public class HrCmsModule extends TableImpl<HrCmsModuleRecord> {
    ...
    private static final long serialVersionUID = -2008981897;
     ...
     */
    public final TableField<HrCmsModuleRecord, Integer> ORDER = createField("order", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.INTEGER)), this, "顺序");
