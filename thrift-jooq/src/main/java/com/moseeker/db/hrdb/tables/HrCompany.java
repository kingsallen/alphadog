...
public class HrCompany extends TableImpl<HrCompanyRecord> {
	...
	private static final long serialVersionUID = 1341157772;
	 ...
	 */
	public final TableField<HrCompanyRecord, Byte> DISABLE = createField("disable", org.jooq.impl.SQLDataType.TINYINT.nullable(false).defaulted(true), this, "0:无效 1:有效, 删除子公司使用， 母公司目前没有禁用功能");
	 ...
	 */
	public final TableField<HrCompanyRecord, String> SLOGAN = createField("slogan", org.jooq.impl.SQLDataType.VARCHAR.length(1024).nullable(false).defaulted(true), this, "公司口号");
