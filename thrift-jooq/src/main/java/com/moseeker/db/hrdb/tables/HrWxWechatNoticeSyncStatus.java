...
public class HrWxWechatNoticeSyncStatus extends TableImpl<HrWxWechatNoticeSyncStatusRecord> {
    ...
    private static final long serialVersionUID = -1355663506;
     ...
     */
    public final TableField<HrWxWechatNoticeSyncStatusRecord, UInteger> WECHAT_ID = createField("wechat_id", org.jooq.impl.SQLDataType.INTEGERUNSIGNED.nullable(false).defaultValue(org.jooq.impl.DSL.field("10", org.jooq.impl.SQLDataType.INTEGERUNSIGNED)), this, "所属公众号");
     ...
     */
    public final TableField<HrWxWechatNoticeSyncStatusRecord, Timestamp> UPDATE_TIME = createField("update_time", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "");
