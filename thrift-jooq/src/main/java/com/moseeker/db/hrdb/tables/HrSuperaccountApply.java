...
public class HrSuperaccountApply extends TableImpl<HrSuperaccountApplyRecord> {
    ...
    private static final long serialVersionUID = 1041071205;
     ...
     */
    public final TableField<HrSuperaccountApplyRecord, Integer> COMPANY_ID = createField("company_id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "hr_company.id");
     ...
     */
    public final TableField<HrSuperaccountApplyRecord, Timestamp> CREATE_TIME = createField("create_time", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "创建时间");

    /**
     * The column <code>hrdb.hr_superaccount_apply.update_time</code>. 修改时间
     */
    public final TableField<HrSuperaccountApplyRecord, Timestamp> UPDATE_TIME = createField("update_time", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "修改时间");

    /**
     * The column <code>hrdb.hr_superaccount_apply.operate</code>. config_sys_administrator.id
     */
    public final TableField<HrSuperaccountApplyRecord, Integer> OPERATE = createField("operate", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "config_sys_administrator.id");

    /**
     * The column <code>hrdb.hr_superaccount_apply.status</code>. 申请状态 0表示已经通过，1表示未处理，2表示未通过
     */
    public final TableField<HrSuperaccountApplyRecord, Integer> STATUS = createField("status", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("1", org.jooq.impl.SQLDataType.INTEGER)), this, "申请状态 0表示已经通过，1表示未处理，2表示未通过");
     ...
     */
    public final TableField<HrSuperaccountApplyRecord, String> CHILD_COMPANY_ID = createField("child_company_id", org.jooq.impl.SQLDataType.VARCHAR.length(1000).nullable(false).defaultValue(org.jooq.impl.DSL.field("", org.jooq.impl.SQLDataType.VARCHAR)), this, "合并的其他公司的编号：[1,2,3]");
     ...
     */
    public final TableField<HrSuperaccountApplyRecord, Integer> ACCOUNT_LIMIT = createField("account_limit", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("4", org.jooq.impl.SQLDataType.INTEGER)), this, "子账号数量限制");
