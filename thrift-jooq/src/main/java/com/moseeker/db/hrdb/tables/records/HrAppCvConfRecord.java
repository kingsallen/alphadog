...
public class HrAppCvConfRecord extends UpdatableRecordImpl<HrAppCvConfRecord> implements Record10<UInteger, String, UInteger, UInteger, UInteger, UInteger, UInteger, String, Timestamp, Timestamp> {
	...
	private static final long serialVersionUID = 1326486105;
	...
	/**
	 * Setter for <code>hrDB.hr_app_cv_conf.company_id</code>. 所属部门。如果是私有属性，则存在所属公司部门编号；如果不是则为0 company.id
	 */
	...
	/**
	 * Getter for <code>hrDB.hr_app_cv_conf.company_id</code>. 所属部门。如果是私有属性，则存在所属公司部门编号；如果不是则为0 company.id
	 */
