...
public class HrEmployeeCertConfRecord extends UpdatableRecordImpl<HrEmployeeCertConfRecord> implements Record12<Integer, Integer, Byte, String, Timestamp, Timestamp, Byte, Byte, Integer, Byte, String, String> {

	private static final long serialVersionUID = 437824725;
	 ...
	 */
	@Override
	public Row12<Integer, Integer, Byte, String, Timestamp, Timestamp, Byte, Byte, Integer, Byte, String, String> fieldsRow() {
	 ...
	 */
	@Override
	public Row12<Integer, Integer, Byte, String, Timestamp, Timestamp, Byte, Byte, Integer, Byte, String, String> valuesRow() {
	 ...
	 */
	@Override
	public HrEmployeeCertConfRecord values(Integer value1, Integer value2, Byte value3, String value4, Timestamp value5, Timestamp value6, Byte value7, Byte value8, Integer value9, Byte value10, String value11, String value12) {
		value1(value1);
		value2(value2);
		value3(value3);
		value4(value4);
	 ...
	 */
	public HrEmployeeCertConfRecord(Integer id, Integer companyId, Byte isStrict, String emailSuffix, Timestamp createTime, Timestamp updateTime, Byte disable, Byte bdAddGroup, Integer bdUseGroupId, Byte authMode, String authCode, String custom) {
		super(HrEmployeeCertConf.HR_EMPLOYEE_CERT_CONF);
		...
		setValue(6, disable);
		setValue(7, bdAddGroup);
		setValue(8, bdUseGroupId);
		setValue(9, authMode);
		setValue(10, authCode);
		setValue(11, custom);
	}
}
