...
public class HrEmployeeCertConf extends TableImpl<HrEmployeeCertConfRecord> {
    ...
    private static final long serialVersionUID = -1974846596;
     ...
     */
    public final TableField<HrEmployeeCertConfRecord, Byte> AUTH_MODE = createField("auth_mode", org.jooq.impl.SQLDataType.TINYINT.nullable(false).defaultValue(org.jooq.impl.DSL.inline("1", org.jooq.impl.SQLDataType.TINYINT)), this, "认证方式，0:不启用员工认证, 1:邮箱认证, 2:自定义认证, 3:姓名手机号认证, 4:邮箱自定义两种认证");
