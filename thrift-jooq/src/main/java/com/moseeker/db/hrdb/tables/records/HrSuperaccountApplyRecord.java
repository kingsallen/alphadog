...
public class HrSuperaccountApplyRecord extends UpdatableRecordImpl<HrSuperaccountApplyRecord> implements Record10<Integer, Integer, byte[], Integer, Integer, String, String, Timestamp, Timestamp, Timestamp> {
	...
	private static final long serialVersionUID = 1615377068;
	...
	/**
	 * Setter for <code>hrDB.hr_superaccount_apply.company_id</code>. company.id
	 */
	...
	/**
	 * Getter for <code>hrDB.hr_superaccount_apply.company_id</code>. company.id
	 */
	...
	/**
	 * Setter for <code>hrDB.hr_superaccount_apply.operate</code>. sys_auth.id
	 */
	...
	/**
	 * Getter for <code>hrDB.hr_superaccount_apply.operate</code>. sys_auth.id
	 */
