...
public class HrHbPositionBinding extends TableImpl<HrHbPositionBindingRecord> {
    ...
    private static final long serialVersionUID = 2142748434;
     ...
     */
    public final TableField<HrHbPositionBindingRecord, Integer> HB_CONFIG_ID = createField("hb_config_id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "hr_hb_config.id");

    /**
     * The column <code>hrdb.hr_hb_position_binding.position_id</code>. hr_position.id
     */
    public final TableField<HrHbPositionBindingRecord, Integer> POSITION_ID = createField("position_id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "hr_position.id");

    /**
     * The column <code>hrdb.hr_hb_position_binding.trigger_way</code>. 领取条件：1=职位被转发 2=职位被申请
     */
    public final TableField<HrHbPositionBindingRecord, Byte> TRIGGER_WAY = createField("trigger_way", org.jooq.impl.SQLDataType.TINYINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.TINYINT)), this, "领取条件：1=职位被转发 2=职位被申请");

    /**
     * The column <code>hrdb.hr_hb_position_binding.total_amount</code>. 总金额
     */
    public final TableField<HrHbPositionBindingRecord, BigDecimal> TOTAL_AMOUNT = createField("total_amount", org.jooq.impl.SQLDataType.DECIMAL.precision(10, 2).nullable(false).defaultValue(org.jooq.impl.DSL.field("0.00", org.jooq.impl.SQLDataType.DECIMAL)), this, "总金额");

    /**
     * The column <code>hrdb.hr_hb_position_binding.total_num</code>. 红包总数
     */
    public final TableField<HrHbPositionBindingRecord, Integer> TOTAL_NUM = createField("total_num", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "红包总数");

    /**
     * The column <code>hrdb.hr_hb_position_binding.create_time</code>. 创建时间
     */
    public final TableField<HrHbPositionBindingRecord, Timestamp> CREATE_TIME = createField("create_time", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "创建时间");

    /**
     * The column <code>hrdb.hr_hb_position_binding.update_time</code>. 更新时间
     */
    public final TableField<HrHbPositionBindingRecord, Timestamp> UPDATE_TIME = createField("update_time", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "更新时间");
