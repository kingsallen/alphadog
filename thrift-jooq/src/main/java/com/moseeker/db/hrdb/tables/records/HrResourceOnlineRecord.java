...
public class HrResourceOnlineRecord extends UpdatableRecordImpl<HrResourceOnlineRecord> implements Record4<Integer, String, Integer, String> {

    private static final long serialVersionUID = -1123768693;
