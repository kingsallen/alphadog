...
public class HrRuleStatistics extends TableImpl<HrRuleStatisticsRecord> {
    ...
    private static final long serialVersionUID = -1390535378;
     ...
     */
    public final TableField<HrRuleStatisticsRecord, Integer> WXRULE_ID = createField("wxrule_id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "wx_rule.id");
     ...
     */
    public final TableField<HrRuleStatisticsRecord, Integer> TYPE = createField("type", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "0: wx_rule, 1: menu");
     ...
     */
    public final TableField<HrRuleStatisticsRecord, Integer> VIEW_NUM_PV = createField("view_num_pv", org.jooq.impl.SQLDataType.INTEGER.defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "浏览人数");
