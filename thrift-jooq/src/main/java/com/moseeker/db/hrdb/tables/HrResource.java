...
public class HrResource extends TableImpl<HrResourceRecord> {
    ...
    private static final long serialVersionUID = -750468513;
     ...
     */
    public final TableField<HrResourceRecord, Integer> COVER = createField("cover", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.INTEGER)), this, "视频封面");
