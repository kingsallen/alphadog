...
public class HrResource extends TableImpl<HrResourceRecord> {
    ...
    private static final long serialVersionUID = 2103668935;
     ...
     */
    public final TableField<HrResourceRecord, Timestamp> CREATE_TIME = createField("create_time", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "资源创建时间");

    /**
     * The column <code>hrdb.hr_resource.update_time</code>. 资源修改时间
     */
    public final TableField<HrResourceRecord, Timestamp> UPDATE_TIME = createField("update_time", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "资源修改时间");

    /**
     * The column <code>hrdb.hr_resource.cover</code>. 视频封面
     */
    public final TableField<HrResourceRecord, String> COVER = createField("cover", org.jooq.impl.SQLDataType.VARCHAR.length(256).nullable(false).defaultValue(org.jooq.impl.DSL.field("", org.jooq.impl.SQLDataType.VARCHAR)), this, "视频封面");
