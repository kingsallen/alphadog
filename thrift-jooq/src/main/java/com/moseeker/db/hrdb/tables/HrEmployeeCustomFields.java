...
public class HrEmployeeCustomFields extends TableImpl<HrEmployeeCustomFieldsRecord> {
	...
	private static final long serialVersionUID = 1769013377;
	 ...
	 */
	public final TableField<HrEmployeeCustomFieldsRecord, String> FVALUES = createField("fvalues", org.jooq.impl.SQLDataType.VARCHAR.length(4096).nullable(false).defaulted(true), this, "自定义字段可选值");

	/**
	 * The column <code>hrdb.hr_employee_custom_fields.forder</code>. 排序优先级，0:不显示, 正整数由小到大排序
	 */
	public final TableField<HrEmployeeCustomFieldsRecord, Integer> FORDER = createField("forder", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaulted(true), this, "排序优先级，0:不显示, 正整数由小到大排序");

	/**
	 * The column <code>hrdb.hr_employee_custom_fields.disable</code>. 是否停用 0:不停用(有效)， 1:停用(无效)
	 */
	public final TableField<HrEmployeeCustomFieldsRecord, Byte> DISABLE = createField("disable", org.jooq.impl.SQLDataType.TINYINT.nullable(false).defaulted(true), this, "是否停用 0:不停用(有效)， 1:停用(无效)");

	/**
	 * The column <code>hrdb.hr_employee_custom_fields.mandatory</code>. 是否必填 0:不是必填, 1:必填
	 */
	public final TableField<HrEmployeeCustomFieldsRecord, Integer> MANDATORY = createField("mandatory", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaulted(true), this, "是否必填 0:不是必填, 1:必填");

	/**
	 * The column <code>hrdb.hr_employee_custom_fields.status</code>. 0: 正常 1: 被删除
	 */
	public final TableField<HrEmployeeCustomFieldsRecord, Integer> STATUS = createField("status", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaulted(true), this, "0: 正常 1: 被删除");
	...
	private HrEmployeeCustomFields(String alias, Table<HrEmployeeCustomFieldsRecord> aliased, Field<?>[] parameters) {
		super(alias, Hrdb.HRDB, aliased, parameters, "员工认证自定义字段表");
	}
