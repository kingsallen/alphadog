...
public class HrMedia extends TableImpl<HrMediaRecord> {
	...
	private static final long serialVersionUID = -646056706;
	 ...
	 */
	public final TableField<HrMediaRecord, String> LONGTEXT = createField("longtext", org.jooq.impl.SQLDataType.VARCHAR.length(2048).nullable(false).defaulted(true), this, "描述");

	/**
	 * The column <code>hrdb.hr_media.attrs</code>. 客户属性，可选 字段
	 */
	public final TableField<HrMediaRecord, String> ATTRS = createField("attrs", org.jooq.impl.SQLDataType.VARCHAR.length(1024).nullable(false).defaulted(true), this, "客户属性，可选 字段");

	/**
	 * The column <code>hrdb.hr_media.title</code>. 模板名称
	 */
	public final TableField<HrMediaRecord, String> TITLE = createField("title", org.jooq.impl.SQLDataType.VARCHAR.length(128).nullable(false).defaulted(true), this, "模板名称");

	/**
	 * The column <code>hrdb.hr_media.sub_title</code>. 模板子名称
	 */
	public final TableField<HrMediaRecord, String> SUB_TITLE = createField("sub_title", org.jooq.impl.SQLDataType.VARCHAR.length(128).nullable(false).defaulted(true), this, "模板子名称");

	/**
	 * The column <code>hrdb.hr_media.link</code>. 模板链接
	 */
	public final TableField<HrMediaRecord, String> LINK = createField("link", org.jooq.impl.SQLDataType.VARCHAR.length(512).nullable(false).defaulted(true), this, "模板链接");

	/**
	 * The column <code>hrdb.hr_media.res_id</code>. 资源hr_resource.id
	 */
	public final TableField<HrMediaRecord, Integer> RES_ID = createField("res_id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaulted(true), this, "资源hr_resource.id");
	...
	private HrMedia(String alias, Table<HrMediaRecord> aliased, Field<?>[] parameters) {
		super(alias, Hrdb.HRDB, aliased, parameters, "模板媒体表，存储模板渲染的媒体信息");
	}
