...
public class HrResourceRecord extends UpdatableRecordImpl<HrResourceRecord> implements Record10<Integer, String, Integer, String, Integer, String, Integer, Timestamp, Timestamp, Integer> {

    private static final long serialVersionUID = 512674990;
     ...
     */
    @Override
    public Row10<Integer, String, Integer, String, Integer, String, Integer, Timestamp, Timestamp, Integer> fieldsRow() {
     ...
     */
    @Override
    public Row10<Integer, String, Integer, String, Integer, String, Integer, Timestamp, Timestamp, Integer> valuesRow() {
     ...
     */
    @Override
    public HrResourceRecord value10(Integer value) {
        setCover(value);
        return this;
    }
     ...
     */
    @Override
    public HrResourceRecord values(Integer value1, String value2, Integer value3, String value4, Integer value5, String value6, Integer value7, Timestamp value8, Timestamp value9, Integer value10) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public HrResourceRecord(Integer id, String resUrl, Integer resType, String remark, Integer companyId, String title, Integer disable, Timestamp createTime, Timestamp updateTime, Integer cover) {
        super(HrResource.HR_RESOURCE);
