...
public class HrRecruitUniqueStatistics extends TableImpl<HrRecruitUniqueStatisticsRecord> {
    ...
    private static final long serialVersionUID = -1308572845;
     ...
     */
    public final TableField<HrRecruitUniqueStatisticsRecord, Integer> POSITION_ID = createField("position_id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "hr_position.id");

    /**
     * The column <code>hrdb.hr_recruit_unique_statistics.company_id</code>. company.id
     */
    public final TableField<HrRecruitUniqueStatisticsRecord, Integer> COMPANY_ID = createField("company_id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "company.id");

    /**
     * The column <code>hrdb.hr_recruit_unique_statistics.jd_uv</code>. JD 页浏览人数
     */
    public final TableField<HrRecruitUniqueStatisticsRecord, Integer> JD_UV = createField("jd_uv", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "JD 页浏览人数");

    /**
     * The column <code>hrdb.hr_recruit_unique_statistics.recom_jd_uv</code>. JD 页推荐浏览人数
     */
    public final TableField<HrRecruitUniqueStatisticsRecord, Integer> RECOM_JD_UV = createField("recom_jd_uv", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "JD 页推荐浏览人数");

    /**
     * The column <code>hrdb.hr_recruit_unique_statistics.fav_num</code>. 感兴趣的人数
     */
    public final TableField<HrRecruitUniqueStatisticsRecord, Integer> FAV_NUM = createField("fav_num", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "感兴趣的人数");

    /**
     * The column <code>hrdb.hr_recruit_unique_statistics.recom_fav_num</code>. 推荐感兴趣的人数
     */
    public final TableField<HrRecruitUniqueStatisticsRecord, Integer> RECOM_FAV_NUM = createField("recom_fav_num", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "推荐感兴趣的人数");

    /**
     * The column <code>hrdb.hr_recruit_unique_statistics.mobile_num</code>. 留手机的人数
     */
    public final TableField<HrRecruitUniqueStatisticsRecord, Integer> MOBILE_NUM = createField("mobile_num", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "留手机的人数");

    /**
     * The column <code>hrdb.hr_recruit_unique_statistics.recom_mobile_num</code>. 推荐感兴趣留手机的人数
     */
    public final TableField<HrRecruitUniqueStatisticsRecord, Integer> RECOM_MOBILE_NUM = createField("recom_mobile_num", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "推荐感兴趣留手机的人数");

    /**
     * The column <code>hrdb.hr_recruit_unique_statistics.apply_num</code>. 投递人数
     */
    public final TableField<HrRecruitUniqueStatisticsRecord, Integer> APPLY_NUM = createField("apply_num", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "投递人数");

    /**
     * The column <code>hrdb.hr_recruit_unique_statistics.recom_apply_num</code>. 推荐投递人数
     */
    public final TableField<HrRecruitUniqueStatisticsRecord, Integer> RECOM_APPLY_NUM = createField("recom_apply_num", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "推荐投递人数");
     ...
     */
    public final TableField<HrRecruitUniqueStatisticsRecord, Integer> INFO_TYPE = createField("info_type", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "0: 日数据，1：周数据，2：月数据");
