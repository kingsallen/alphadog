...
public class HrNpsRecommend extends TableImpl<HrNpsRecommendRecord> {
	...
	private static final long serialVersionUID = 206016784;
	 ...
	 */
	public final TableField<HrNpsRecommendRecord, String> MOBILE = createField("mobile", org.jooq.impl.SQLDataType.VARCHAR.length(32).defaulted(true), this, " 推荐的用户的手机号");

	/**
	 * The column <code>hrdb.hr_nps_recommend.company</code>. 推荐的用户所属公司
	 */
	public final TableField<HrNpsRecommendRecord, String> COMPANY = createField("company", org.jooq.impl.SQLDataType.VARCHAR.length(100).defaulted(true), this, "推荐的用户所属公司");

	/**
	 * The column <code>hrdb.hr_nps_recommend.create_time</code>. 推荐的时间
	 */
	public final TableField<HrNpsRecommendRecord, Timestamp> CREATE_TIME = createField("create_time", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaulted(true), this, "推荐的时间");
