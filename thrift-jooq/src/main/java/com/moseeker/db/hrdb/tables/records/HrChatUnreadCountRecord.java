...
public class HrChatUnreadCountRecord extends UpdatableRecordImpl<HrChatUnreadCountRecord> implements Record9<UInteger, Integer, UInteger, Integer, Integer, Timestamp, Timestamp, Byte, Byte> {

	private static final long serialVersionUID = 646550270;
	 ...
	 */
	@Override
	public Row9<UInteger, Integer, UInteger, Integer, Integer, Timestamp, Timestamp, Byte, Byte> fieldsRow() {
	 ...
	 */
	@Override
	public Row9<UInteger, Integer, UInteger, Integer, Integer, Timestamp, Timestamp, Byte, Byte> valuesRow() {
	 ...
	 */
	@Override
	public HrChatUnreadCountRecord value6(Timestamp value) {
		setWxChatTime(value);
		return this;
	}
	 ...
	 */
	@Override
	public HrChatUnreadCountRecord values(UInteger value1, Integer value2, UInteger value3, Integer value4, Integer value5, Timestamp value6, Timestamp value7, Byte value8, Byte value9) {
		value1(value1);
		value2(value2);
		value3(value3);
		value4(value4);
	 ...
	 */
	public HrChatUnreadCountRecord(UInteger roomId, Integer hrId, UInteger userId, Integer hrUnreadCount, Integer userUnreadCount, Timestamp wxChatTime, Timestamp hrChatTime, Byte hrHaveUnreadMsg, Byte userHaveUnreadMsg) {
		super(HrChatUnreadCount.HR_CHAT_UNREAD_COUNT);
		...
		setValue(7, hrHaveUnreadMsg);
		setValue(8, userHaveUnreadMsg);
	}
}
