...
public class ProfileProfileRecord extends UpdatableRecordImpl<ProfileProfileRecord> implements Record9<UInteger, String, UByte, UInteger, UByte, UInteger, UByte, Timestamp, Timestamp> {
	 ...
	 */
	@Override
	public ProfileProfileRecord values(UInteger value1, String value2, UByte value3, UInteger value4, UByte value5, UInteger value6, UByte value7, Timestamp value8, Timestamp value9) {
		value1(value1);
		value2(value2);
		value3(value3);
		value4(value4);
	 ...
	 */
	public ProfileProfileRecord(UInteger id, String uuid, UByte lang, UInteger source, UByte completeness, UInteger userId, UByte disable, Timestamp createTime, Timestamp updateTime) {
		super(ProfileProfile.PROFILE_PROFILE);
