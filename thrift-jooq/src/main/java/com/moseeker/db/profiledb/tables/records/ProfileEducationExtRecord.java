...
public class ProfileEducationExtRecord extends UpdatableRecordImpl<ProfileEducationExtRecord> implements Record7<UInteger, Date, Byte, Byte, String, Timestamp, Timestamp> {
	...
	private static final long serialVersionUID = 813739787;

	/**
	 * Setter for <code>profileDB.profile_education_ext.profile_id</code>. profile.id
	 */
	...
	/**
	 * Getter for <code>profileDB.profile_education_ext.profile_id</code>. profile.id
	 */
	...
	/**
	 * Setter for <code>profileDB.profile_education_ext.graduation</code>. 预计毕业时间 yyyy-mm-dd
	 */
	...
	/**
	 * Getter for <code>profileDB.profile_education_ext.graduation</code>. 预计毕业时间 yyyy-mm-dd
	 */
	...
	/**
	 * Setter for <code>profileDB.profile_education_ext.majorrank</code>. 专业排名 0:未选择 1: 5%, 2: 5%—15%, 3: 15%-30%, 4: 30%-50%, 5: 50%以下
	 */
	...
	/**
	 * Getter for <code>profileDB.profile_education_ext.majorrank</code>. 专业排名 0:未选择 1: 5%, 2: 5%—15%, 3: 15%-30%, 4: 30%-50%, 5: 50%以下
	 */
	...
	/**
	 * Setter for <code>profileDB.profile_education_ext.degree</code>. 最高学历 0:未选择 1: 大专以下, 2: 大专, 3: 本科, 4: 硕士, 5: 博士, 6:博士以上
	 */
	...
	/**
	 * Getter for <code>profileDB.profile_education_ext.degree</code>. 最高学历 0:未选择 1: 大专以下, 2: 大专, 3: 本科, 4: 硕士, 5: 博士, 6:博士以上
	 */
	...
	/**
	 * Setter for <code>profileDB.profile_education_ext.gpa</code>. GPA成绩
	 */
	...
	/**
	 * Getter for <code>profileDB.profile_education_ext.gpa</code>. GPA成绩
	 */
	...
	/**
	 * Setter for <code>profileDB.profile_education_ext.create_time</code>. 创建时间
	 */
	...
	/**
	 * Getter for <code>profileDB.profile_education_ext.create_time</code>. 创建时间
	 */
	...
	/**
	 * Setter for <code>profileDB.profile_education_ext.update_time</code>. 更新时间
	 */
	...
	/**
	 * Getter for <code>profileDB.profile_education_ext.update_time</code>. 更新时间
	 */
