...
public class ProfileImportBk extends TableImpl<ProfileImportBkRecord> {
	...
	private static final long serialVersionUID = 274226821;
	 ...
	 */
	public final TableField<ProfileImportBkRecord, UInteger> PROFILE_ID = createField("profile_id", org.jooq.impl.SQLDataType.INTEGERUNSIGNED.nullable(false).defaulted(true), this, "profile.id");

	/**
	 * The column <code>profiledb.profile_import_bk.source</code>. 来源, 0:无法识别 1:51Job 2:Liepin 3:zhilian 4:linkedin
	 */
	public final TableField<ProfileImportBkRecord, UByte> SOURCE = createField("source", org.jooq.impl.SQLDataType.TINYINTUNSIGNED.nullable(false).defaulted(true), this, "来源, 0:无法识别 1:51Job 2:Liepin 3:zhilian 4:linkedin");
