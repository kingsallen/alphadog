...
public class ProfileIntentionRecord extends UpdatableRecordImpl<ProfileIntentionRecord> implements Record9<UInteger, UInteger, UByte, UByte, UByte, String, Byte, Timestamp, Timestamp> {

	private static final long serialVersionUID = 967298324;
	 ...
	 */
	@Override
	public Row9<UInteger, UInteger, UByte, UByte, UByte, String, Byte, Timestamp, Timestamp> fieldsRow() {
	 ...
	 */
	@Override
	public Row9<UInteger, UInteger, UByte, UByte, UByte, String, Byte, Timestamp, Timestamp> valuesRow() {
	 ...
	 */
	@Override
	public ProfileIntentionRecord values(UInteger value1, UInteger value2, UByte value3, UByte value4, UByte value5, String value6, Byte value7, Timestamp value8, Timestamp value9) {
		value1(value1);
		value2(value2);
		value3(value3);
		value4(value4);
	 ...
	 */
	public ProfileIntentionRecord(UInteger id, UInteger profileId, UByte workstate, UByte salaryType, UByte salaryCode, String tag, Byte considerVentureCompanyOpportunities, Timestamp createTime, Timestamp updateTime) {
		super(ProfileIntention.PROFILE_INTENTION);

		setValue(0, id);
		setValue(1, profileId);
		setValue(2, workstate);
		setValue(3, salaryType);
