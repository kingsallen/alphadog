...
public class ProfileCompleteness extends TableImpl<ProfileCompletenessRecord> {
	 ...
	 */
	public final TableField<ProfileCompletenessRecord, Integer> PROFILE_BASIC = createField("profile_basic", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaulted(true), this, "profile基础信息表完成度");

	/**
	 * The column <code>profiledb.profile_completeness.profile_workexp</code>. 工作经历完成度
	 */
	public final TableField<ProfileCompletenessRecord, Integer> PROFILE_WORKEXP = createField("profile_workexp", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaulted(true), this, "工作经历完成度");

	/**
	 * The column <code>profiledb.profile_completeness.profile_education</code>. 教育经历完成度
	 */
	public final TableField<ProfileCompletenessRecord, Integer> PROFILE_EDUCATION = createField("profile_education", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaulted(true), this, "教育经历完成度");

	/**
	 * The column <code>profiledb.profile_completeness.profile_projectexp</code>. 项目经历完成度
	 */
	public final TableField<ProfileCompletenessRecord, Integer> PROFILE_PROJECTEXP = createField("profile_projectexp", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaulted(true), this, "项目经历完成度");

	/**
	 * The column <code>profiledb.profile_completeness.profile_language</code>. 语言完成度
	 */
	public final TableField<ProfileCompletenessRecord, Integer> PROFILE_LANGUAGE = createField("profile_language", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaulted(true), this, "语言完成度");

	/**
	 * The column <code>profiledb.profile_completeness.profile_skill</code>. 技能完成度
	 */
	public final TableField<ProfileCompletenessRecord, Integer> PROFILE_SKILL = createField("profile_skill", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaulted(true), this, "技能完成度");

	/**
	 * The column <code>profiledb.profile_completeness.profile_credentials</code>. 证书完成度
	 */
	public final TableField<ProfileCompletenessRecord, Integer> PROFILE_CREDENTIALS = createField("profile_credentials", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaulted(true), this, "证书完成度");

	/**
	 * The column <code>profiledb.profile_completeness.profile_awards</code>. 获得奖项完成度
	 */
	public final TableField<ProfileCompletenessRecord, Integer> PROFILE_AWARDS = createField("profile_awards", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaulted(true), this, "获得奖项完成度");

	/**
	 * The column <code>profiledb.profile_completeness.profile_works</code>. 个人作品
	 */
	public final TableField<ProfileCompletenessRecord, Integer> PROFILE_WORKS = createField("profile_works", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaulted(true), this, "个人作品");

	/**
	 * The column <code>profiledb.profile_completeness.profile_intention</code>. 求职意愿
	 */
	public final TableField<ProfileCompletenessRecord, Integer> PROFILE_INTENTION = createField("profile_intention", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaulted(true), this, "求职意愿");
	...
	private ProfileCompleteness(String alias, Table<ProfileCompletenessRecord> aliased, Field<?>[] parameters) {
		super(alias, Profiledb.PROFILEDB, aliased, parameters, "profile各个部分完成度表");
	}
