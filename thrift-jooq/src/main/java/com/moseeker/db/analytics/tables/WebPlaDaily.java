...
public class WebPlaDaily extends TableImpl<WebPlaDailyRecord> {
    ...
    private static final long serialVersionUID = -350137034;
     ...
     */
    public final TableField<WebPlaDailyRecord, Integer> P_PV = createField("p_pv", org.jooq.impl.SQLDataType.INTEGER.defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.INTEGER)), this, "职位页面浏览量");

    /**
     * The column <code>analytics.web_pla_daily.p_uv</code>. 职位页面浏览用户量
     */
    public final TableField<WebPlaDailyRecord, Integer> P_UV = createField("p_uv", org.jooq.impl.SQLDataType.INTEGER.defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.INTEGER)), this, "职位页面浏览用户量");

    /**
     * The column <code>analytics.web_pla_daily.p_s_pv</code>. 职位页面转发浏览量
     */
    public final TableField<WebPlaDailyRecord, Integer> P_S_PV = createField("p_s_pv", org.jooq.impl.SQLDataType.INTEGER.defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.INTEGER)), this, "职位页面转发浏览量");

    /**
     * The column <code>analytics.web_pla_daily.p_s_uv</code>. 职位页面转发浏览用户量
     */
    public final TableField<WebPlaDailyRecord, Integer> P_S_UV = createField("p_s_uv", org.jooq.impl.SQLDataType.INTEGER.defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.INTEGER)), this, "职位页面转发浏览用户量");

    /**
     * The column <code>analytics.web_pla_daily.l_pv</code>. 职位列表页面浏览量
     */
    public final TableField<WebPlaDailyRecord, Integer> L_PV = createField("l_pv", org.jooq.impl.SQLDataType.INTEGER.defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.INTEGER)), this, "职位列表页面浏览量");

    /**
     * The column <code>analytics.web_pla_daily.l_uv</code>. 职位列表页面浏览用户量
     */
    public final TableField<WebPlaDailyRecord, Integer> L_UV = createField("l_uv", org.jooq.impl.SQLDataType.INTEGER.defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.INTEGER)), this, "职位列表页面浏览用户量");

    /**
     * The column <code>analytics.web_pla_daily.l_s_pv</code>. 职位列表页面转发浏览量
     */
    public final TableField<WebPlaDailyRecord, Integer> L_S_PV = createField("l_s_pv", org.jooq.impl.SQLDataType.INTEGER.defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.INTEGER)), this, "职位列表页面转发浏览量");

    /**
     * The column <code>analytics.web_pla_daily.l_s_uv</code>. 职位列表页面转发浏览用户量
     */
    public final TableField<WebPlaDailyRecord, Integer> L_S_UV = createField("l_s_uv", org.jooq.impl.SQLDataType.INTEGER.defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.INTEGER)), this, "职位列表页面转发浏览用户量");
     ...
     */
    public final TableField<WebPlaDailyRecord, Integer> A_USER = createField("a_user", org.jooq.impl.SQLDataType.INTEGER.defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.INTEGER)), this, "申请人数");

    /**
     * The column <code>analytics.web_pla_daily.a_s_count</code>. 转发产生的申请量
     */
    public final TableField<WebPlaDailyRecord, Integer> A_S_COUNT = createField("a_s_count", org.jooq.impl.SQLDataType.INTEGER.defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.INTEGER)), this, "转发产生的申请量");

    /**
     * The column <code>analytics.web_pla_daily.a_s_user</code>. 转发产生的申请人数
     */
    public final TableField<WebPlaDailyRecord, Integer> A_S_USER = createField("a_s_user", org.jooq.impl.SQLDataType.INTEGER.defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.INTEGER)), this, "转发产生的申请人数");
