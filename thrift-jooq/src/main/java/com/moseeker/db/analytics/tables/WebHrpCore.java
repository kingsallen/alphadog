...
public class WebHrpCore extends TableImpl<WebHrpCoreRecord> {
	...
	private static final long serialVersionUID = -296470593;
	 ...
	 */
	public final TableField<WebHrpCoreRecord, Timestamp> CREATE_TIME = createField("create_time", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaulted(true), this, "");

	/**
	 * The column <code>analytics.web_hrp_core.sum</code>. 企业总数
	 */
	public final TableField<WebHrpCoreRecord, Integer> SUM = createField("sum", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaulted(true), this, "企业总数");

	/**
	 * The column <code>analytics.web_hrp_core.day_active</code>. 日活
	 */
	public final TableField<WebHrpCoreRecord, Integer> DAY_ACTIVE = createField("day_active", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaulted(true), this, "日活");
	 ...
	 */
	public final TableField<WebHrpCoreRecord, Integer> NEW_POSITION = createField("new_position", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaulted(true), this, "今日职位新增");
	 ...
	 */
	public final TableField<WebHrpCoreRecord, Integer> NEW_APPLICATION = createField("new_application", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaulted(true), this, "今日新增申请");

	/**
	 * The column <code>analytics.web_hrp_core.new_register</code>. 企业号今日新增求职者
	 */
	public final TableField<WebHrpCoreRecord, Integer> NEW_REGISTER = createField("new_register", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaulted(true), this, "企业号今日新增求职者");

	/**
	 * The column <code>analytics.web_hrp_core.oauth_c</code>. 企业号一键登录oauth量
	 */
	public final TableField<WebHrpCoreRecord, Integer> OAUTH_C = createField("oauth_c", org.jooq.impl.SQLDataType.INTEGER.defaulted(true), this, "企业号一键登录oauth量");

	/**
	 * The column <code>analytics.web_hrp_core.cared</code>. 我感兴趣按钮点击量
	 */
	public final TableField<WebHrpCoreRecord, Integer> CARED = createField("cared", org.jooq.impl.SQLDataType.INTEGER.defaulted(true), this, "我感兴趣按钮点击量");

	/**
	 * The column <code>analytics.web_hrp_core.phones</code>. 留手机号数量
	 */
	public final TableField<WebHrpCoreRecord, Integer> PHONES = createField("phones", org.jooq.impl.SQLDataType.INTEGER.defaulted(true), this, "留手机号数量");

	/**
	 * The column <code>analytics.web_hrp_core.effective_position</code>.
	 */
	public final TableField<WebHrpCoreRecord, Integer> EFFECTIVE_POSITION = createField("effective_position", org.jooq.impl.SQLDataType.INTEGER.defaulted(true), this, "");
