...
public class WebPositionShare extends TableImpl<WebPositionShareRecord> {
	...
	private static final long serialVersionUID = 1949608692;
	 ...
	 */
	public final TableField<WebPositionShareRecord, UInteger> ID = createField("id", org.jooq.impl.SQLDataType.INTEGERUNSIGNED.nullable(false), this, "primary key");

	/**
	 * The column <code>analytics.web_position_share.company_id</code>. 公司ID, sys_company.id
	 */
	public final TableField<WebPositionShareRecord, Integer> COMPANY_ID = createField("company_id", org.jooq.impl.SQLDataType.INTEGER.defaulted(true), this, "公司ID, sys_company.id");

	/**
	 * The column <code>analytics.web_position_share.pv</code>. page view
	 */
	public final TableField<WebPositionShareRecord, Integer> PV = createField("pv", org.jooq.impl.SQLDataType.INTEGER.defaulted(true), this, "page view");

	/**
	 * The column <code>analytics.web_position_share.uv</code>. user view
	 */
	public final TableField<WebPositionShareRecord, Integer> UV = createField("uv", org.jooq.impl.SQLDataType.INTEGER.defaulted(true), this, "user view");
	 ...
	 */
	public final TableField<WebPositionShareRecord, Integer> SHARE_PV = createField("share_pv", org.jooq.impl.SQLDataType.INTEGER.defaulted(true), this, "转发产生的pv");

	/**
	 * The column <code>analytics.web_position_share.employee_spv</code>. 员工转发产生的pv
	 */
	public final TableField<WebPositionShareRecord, Integer> EMPLOYEE_SPV = createField("employee_spv", org.jooq.impl.SQLDataType.INTEGER.defaulted(true), this, "员工转发产生的pv");

	/**
	 * The column <code>analytics.web_position_share.share_uv</code>. 转发产生的uv
	 */
	public final TableField<WebPositionShareRecord, Integer> SHARE_UV = createField("share_uv", org.jooq.impl.SQLDataType.INTEGER.defaulted(true), this, "转发产生的uv");

	/**
	 * The column <code>analytics.web_position_share.employee_suv</code>. 员工转发产生的uv
	 */
	public final TableField<WebPositionShareRecord, Integer> EMPLOYEE_SUV = createField("employee_suv", org.jooq.impl.SQLDataType.INTEGER.defaulted(true), this, "员工转发产生的uv");

	/**
	 * The column <code>analytics.web_position_share.share_application</code>. 推荐产生的申请量
	 */
	public final TableField<WebPositionShareRecord, Integer> SHARE_APPLICATION = createField("share_application", org.jooq.impl.SQLDataType.INTEGER.defaulted(true), this, "推荐产生的申请量");

	/**
	 * The column <code>analytics.web_position_share.employee_sapplication</code>. 员工推荐产生的申请量
	 */
	public final TableField<WebPositionShareRecord, Integer> EMPLOYEE_SAPPLICATION = createField("employee_sapplication", org.jooq.impl.SQLDataType.INTEGER.defaulted(true), this, "员工推荐产生的申请量");

	/**
	 * The column <code>analytics.web_position_share.share_appuser</code>. 推荐产生的申请人
	 */
	public final TableField<WebPositionShareRecord, Integer> SHARE_APPUSER = createField("share_appuser", org.jooq.impl.SQLDataType.INTEGER.defaulted(true), this, "推荐产生的申请人");

	/**
	 * The column <code>analytics.web_position_share.employee_sappuser</code>. 员工推荐产生的申请人
	 */
	public final TableField<WebPositionShareRecord, Integer> EMPLOYEE_SAPPUSER = createField("employee_sappuser", org.jooq.impl.SQLDataType.INTEGER.defaulted(true), this, "员工推荐产生的申请人");
	...
	private WebPositionShare(String alias, Table<WebPositionShareRecord> aliased, Field<?>[] parameters) {
		super(alias, Analytics.ANALYTICS, aliased, parameters, "转发效果统计表");
	}
	 ...
	 */
	@Override
	public Identity<WebPositionShareRecord, UInteger> getIdentity() {
