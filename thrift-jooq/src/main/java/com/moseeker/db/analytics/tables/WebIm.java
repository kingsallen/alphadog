...
public class WebIm extends TableImpl<WebImRecord> {
    ...
    private static final long serialVersionUID = -696001483;
     ...
     */
    public final TableField<WebImRecord, Timestamp> CREATE_TIME = createField("create_time", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.inline("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "");

    /**
     * The column <code>analytics.web_im.hr</code>. 使用IM的HR数量
     */
    public final TableField<WebImRecord, Integer> HR = createField("hr", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.INTEGER)), this, "使用IM的HR数量");

    /**
     * The column <code>analytics.web_im.hr_news</code>. HR发送消息数量
     */
    public final TableField<WebImRecord, Integer> HR_NEWS = createField("hr_news", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.INTEGER)), this, "HR发送消息数量");

    /**
     * The column <code>analytics.web_im.candidate</code>. 使用IM的求职者数量
     */
    public final TableField<WebImRecord, Integer> CANDIDATE = createField("candidate", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.INTEGER)), this, "使用IM的求职者数量");

    /**
     * The column <code>analytics.web_im.candidate_news</code>. 求职者发送的消息数量
     */
    public final TableField<WebImRecord, Integer> CANDIDATE_NEWS = createField("candidate_news", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.INTEGER)), this, "求职者发送的消息数量");
