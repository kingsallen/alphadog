...
public class RecommendedResumes extends TableImpl<RecommendedResumesRecord> {
	...
	private static final long serialVersionUID = 206629630;
	 ...
	 */
	public final TableField<RecommendedResumesRecord, Byte> LIKED = createField("liked", org.jooq.impl.SQLDataType.TINYINT.defaulted(true), this, "");

	/**
	 * The column <code>analytics.recommended_resumes.viewed</code>.
	 */
	public final TableField<RecommendedResumesRecord, Byte> VIEWED = createField("viewed", org.jooq.impl.SQLDataType.TINYINT.defaulted(true), this, "");

	/**
	 * The column <code>analytics.recommended_resumes.sim_weight</code>.
	 */
	public final TableField<RecommendedResumesRecord, Double> SIM_WEIGHT = createField("sim_weight", org.jooq.impl.SQLDataType.FLOAT.defaulted(true), this, "");
