...
public class UserSettings extends TableImpl<UserSettingsRecord> {
    ...
    private static final long serialVersionUID = -2014173221;
     ...
     */
    public final TableField<UserSettingsRecord, String> BANNER_URL = createField("banner_url", org.jooq.impl.SQLDataType.VARCHAR.length(256).nullable(false).defaultValue(org.jooq.impl.DSL.field("", org.jooq.impl.SQLDataType.VARCHAR)), this, "profile banner 的qiniu 相对url");
