...
public class UserThirdpartyUser extends TableImpl<UserThirdpartyUserRecord> {
    ...
    private static final long serialVersionUID = -1229763499;
     ...
     */
    public final TableField<UserThirdpartyUserRecord, ULong> ID = createField("id", org.jooq.impl.SQLDataType.BIGINTUNSIGNED.nullable(false), this, "主key");
     ...
     */
    public final TableField<UserThirdpartyUserRecord, UInteger> SOURCE_ID = createField("source_id", org.jooq.impl.SQLDataType.INTEGERUNSIGNED.nullable(false), this, "第三方平台ID，0：SF，1：Taleo，2：workday,3:51job,4:zhaopin,5,liepin");
     ...
     */
    @Override
    public Identity<UserThirdpartyUserRecord, ULong> getIdentity() {
