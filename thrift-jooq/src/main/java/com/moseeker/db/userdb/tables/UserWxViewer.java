...
public class UserWxViewer extends TableImpl<UserWxViewerRecord> {
    ...
    private static final long serialVersionUID = 1074377709;
     ...
     */
    public final TableField<UserWxViewerRecord, Integer> SYSUSER_ID = createField("sysuser_id", org.jooq.impl.SQLDataType.INTEGER.defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "");
     ...
     */
    public final TableField<UserWxViewerRecord, Integer> CLIENT_TYPE = createField("client_type", org.jooq.impl.SQLDataType.INTEGER.defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "");
