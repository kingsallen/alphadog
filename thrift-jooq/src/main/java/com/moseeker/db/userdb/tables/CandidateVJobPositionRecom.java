...
public class CandidateVJobPositionRecom extends TableImpl<CandidateVJobPositionRecomRecord> {
	...
	private static final long serialVersionUID = 341977271;
	...
	/**
	 * The column <code>userdb.candidate_v_job_position_recom.recom_id</code>. wx_group_user.id 分享用户微信ID
	 */
	...
	/**
	 * The column <code>userdb.candidate_v_job_position_recom.presentee_id</code>. 被动求职者,浏览者的微信ID，wx_group_user.id
	 */
