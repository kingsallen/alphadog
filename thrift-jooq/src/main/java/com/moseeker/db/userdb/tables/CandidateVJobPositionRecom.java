...
import com.moseeker.db.userdb.tables.records.CandidateVJobPositionRecomRecord;
...
public class CandidateVJobPositionRecom extends TableImpl<CandidateVJobPositionRecomRecord> {
    ...
    private static final long serialVersionUID = -1783613177;
     ...
     */
    public final TableField<CandidateVJobPositionRecomRecord, Long> PRESENTEE_ID = createField("presentee_id", org.jooq.impl.SQLDataType.BIGINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.BIGINT)), this, "被动求职者,浏览者的微信ID，userdb.user_wx_user.id。现在已经废弃，请参考presentee_user_id");
     ...
     */
    public final TableField<CandidateVJobPositionRecomRecord, String> NICKNAME = createField("nickname", org.jooq.impl.SQLDataType.VARCHAR.length(100).nullable(false).defaultValue(org.jooq.impl.DSL.field("", org.jooq.impl.SQLDataType.VARCHAR)), this, "用户昵称");
