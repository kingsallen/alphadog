...
public class UserIntentionRecord extends UpdatableRecordImpl<UserIntentionRecord> implements Record4<Integer, String, Timestamp, Timestamp> {

    private static final long serialVersionUID = -2016311393;
