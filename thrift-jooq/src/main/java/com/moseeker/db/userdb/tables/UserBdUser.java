...
public class UserBdUser extends TableImpl<UserBdUserRecord> {
    ...
    private static final long serialVersionUID = -1263931261;
     ...
     */
    public final TableField<UserBdUserRecord, Integer> USER_ID = createField("user_id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "user_user.id, C端用户ID");

    /**
     * The column <code>userdb.user_bd_user.username</code>. 登录用户名
     */
    public final TableField<UserBdUserRecord, String> USERNAME = createField("username", org.jooq.impl.SQLDataType.VARCHAR.length(100).nullable(false).defaultValue(org.jooq.impl.DSL.field("", org.jooq.impl.SQLDataType.VARCHAR)), this, "登录用户名");

    /**
     * The column <code>userdb.user_bd_user.sex</code>. 用户性别 2:未知  0:女性 1:男性
     */
    public final TableField<UserBdUserRecord, Integer> SEX = createField("sex", org.jooq.impl.SQLDataType.INTEGER.defaultValue(org.jooq.impl.DSL.field("2", org.jooq.impl.SQLDataType.INTEGER)), this, "用户性别 2:未知  0:女性 1:男性");

    /**
     * The column <code>userdb.user_bd_user.headimgurl</code>. 用户头像
     */
    public final TableField<UserBdUserRecord, String> HEADIMGURL = createField("headimgurl", org.jooq.impl.SQLDataType.VARCHAR.length(512).defaultValue(org.jooq.impl.DSL.field("", org.jooq.impl.SQLDataType.VARCHAR)), this, "用户头像");

    /**
     * The column <code>userdb.user_bd_user.create_time</code>. 创建时间
     */
    public final TableField<UserBdUserRecord, Timestamp> CREATE_TIME = createField("create_time", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "创建时间");

    /**
     * The column <code>userdb.user_bd_user.update_time</code>.
     */
    public final TableField<UserBdUserRecord, Timestamp> UPDATE_TIME = createField("update_time", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "");
