...
public class UserEmployeePointsRecord extends TableImpl<UserEmployeePointsRecordRecord> {
    ...
    private static final long serialVersionUID = 1637761886;
    ...
    /**
     * The column <code>userdb.user_employee_points_record.berecom_wxuser_id</code>. user_wx_user.id，被推荐人的微信 id
     */
    public final TableField<UserEmployeePointsRecordRecord, Long> BERECOM_WXUSER_ID = createField("berecom_wxuser_id", org.jooq.impl.SQLDataType.BIGINT.nullable(false).defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.BIGINT)), this, "user_wx_user.id，被推荐人的微信 id");
