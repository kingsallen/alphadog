...
public class UserEmployeePointsRecord extends TableImpl<UserEmployeePointsRecordRecord> {
	...
	private static final long serialVersionUID = -677122230;
	...
	/**
	 * The column <code>userDB.user_employee_points_record.employee_id</code>. employee.id
	 */
	...
	/**
	 * The column <code>userDB.user_employee_points_record.award</code>. 积分值
	 */
	...
	/**
	 * The column <code>userDB.user_employee_points_record.application_id</code>. application.id
	 */
	...
	/**
	 * The column <code>userDB.user_employee_points_record.recom_wxuser</code>. wx_user.id
	 */
	...
	/**
	 * The column <code>userDB.user_employee_points_record.create_time</code>. 创建时间
	 */
