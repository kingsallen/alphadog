...
public class UserCompanyVisitReq extends TableImpl<UserCompanyVisitReqRecord> {
    ...
    private static final long serialVersionUID = -2123689960;
     ...
     */
    public final TableField<UserCompanyVisitReqRecord, UInteger> ID = createField("id", org.jooq.impl.SQLDataType.INTEGERUNSIGNED.nullable(false), this, "id");

    /**
     * The column <code>userdb.user_company_visit_req.company_id</code>. hr_company.id
     */
    public final TableField<UserCompanyVisitReqRecord, Integer> COMPANY_ID = createField("company_id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "hr_company.id");

    /**
     * The column <code>userdb.user_company_visit_req.user_id</code>. user_user.id
     */
    public final TableField<UserCompanyVisitReqRecord, Integer> USER_ID = createField("user_id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "user_user.id");

    /**
     * The column <code>userdb.user_company_visit_req.status</code>. 0: 取消申请参观 1：申请参观
     */
    public final TableField<UserCompanyVisitReqRecord, Integer> STATUS = createField("status", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("1", org.jooq.impl.SQLDataType.INTEGER)), this, "0: 取消申请参观 1：申请参观");

    /**
     * The column <code>userdb.user_company_visit_req.source</code>. 操作来源 0: 未知 1：微信端 2：PC 端
     */
    public final TableField<UserCompanyVisitReqRecord, Integer> SOURCE = createField("source", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "操作来源 0: 未知 1：微信端 2：PC 端");

    /**
     * The column <code>userdb.user_company_visit_req.create_time</code>. 关注时间
     */
    public final TableField<UserCompanyVisitReqRecord, Timestamp> CREATE_TIME = createField("create_time", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "关注时间");

    /**
     * The column <code>userdb.user_company_visit_req.update_time</code>.
     */
    public final TableField<UserCompanyVisitReqRecord, Timestamp> UPDATE_TIME = createField("update_time", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "");
     ...
     */
    @Override
    public Identity<UserCompanyVisitReqRecord, UInteger> getIdentity() {
