...
public class UserEmployeePointsRecordRecord extends UpdatableRecordImpl<UserEmployeePointsRecordRecord> implements Record13<Integer, Long, String, Integer, Timestamp, Long, Long, Timestamp, Long, Long, Long, UInteger, UInteger> {

    private static final long serialVersionUID = 1680532284;
    ...
    /**
     * Setter for <code>userdb.user_employee_points_record.berecom_wxuser_id</code>. user_wx_user.id，被推荐人的微信 id
     */
    ...
    /**
     * Getter for <code>userdb.user_employee_points_record.berecom_wxuser_id</code>. user_wx_user.id，被推荐人的微信 id
     */
     ...
     */
    public void setBerecomUserId(UInteger value) {
        set(12, value);
    }
     ...
     */
    public UInteger getBerecomUserId() {
     ...
     */
    @Override
    public Row13<Integer, Long, String, Integer, Timestamp, Long, Long, Timestamp, Long, Long, Long, UInteger, UInteger> fieldsRow() {
     ...
     */
    @Override
    public Row13<Integer, Long, String, Integer, Timestamp, Long, Long, Timestamp, Long, Long, Long, UInteger, UInteger> valuesRow() {
     ...
     */
    @Override
    public UserEmployeePointsRecordRecord value12(UInteger value) {
     ...
     */
    @Override
    public UserEmployeePointsRecordRecord value13(UInteger value) {
     ...
     */
    @Override
    public UserEmployeePointsRecordRecord values(Integer value1, Long value2, String value3, Integer value4, Timestamp value5, Long value6, Long value7, Timestamp value8, Long value9, Long value10, Long value11, UInteger value12, UInteger value13) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public UserEmployeePointsRecordRecord(Integer id, Long employeeId, String reason, Integer award, Timestamp _CreateTime, Long applicationId, Long recomWxuser, Timestamp updateTime, Long positionId, Long berecomWxuserId, Long awardConfigId, UInteger recomUserId, UInteger berecomUserId) {
        super(UserEmployeePointsRecord.USER_EMPLOYEE_POINTS_RECORD);
