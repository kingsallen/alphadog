...
public class UserEmployeePointsRecordRecord extends UpdatableRecordImpl<UserEmployeePointsRecordRecord> implements Record8<Integer, Long, String, Integer, Long, Long, Timestamp, Timestamp> {
	...
	private static final long serialVersionUID = 970526334;
	...
	/**
	 * Setter for <code>userDB.user_employee_points_record.employee_id</code>. employee.id
	 */
	...
	/**
	 * Getter for <code>userDB.user_employee_points_record.employee_id</code>. employee.id
	 */
	...
	/**
	 * Setter for <code>userDB.user_employee_points_record.award</code>. 积分值
	 */
	...
	/**
	 * Getter for <code>userDB.user_employee_points_record.award</code>. 积分值
	 */
	...
	/**
	 * Setter for <code>userDB.user_employee_points_record.application_id</code>. application.id
	 */
	...
	/**
	 * Getter for <code>userDB.user_employee_points_record.application_id</code>. application.id
	 */
	...
	/**
	 * Setter for <code>userDB.user_employee_points_record.recom_wxuser</code>. wx_user.id
	 */
	...
	/**
	 * Getter for <code>userDB.user_employee_points_record.recom_wxuser</code>. wx_user.id
	 */
	...
	/**
	 * Setter for <code>userDB.user_employee_points_record.create_time</code>. 创建时间
	 */
	...
	/**
	 * Getter for <code>userDB.user_employee_points_record.create_time</code>. 创建时间
	 */
