...
public class UserUser extends TableImpl<UserUserRecord> {
    ...
    private static final long serialVersionUID = 1035219647;
     ...
     */
    public final TableField<UserUserRecord, UInteger> PARENTID = createField("parentid", org.jooq.impl.SQLDataType.INTEGERUNSIGNED.nullable(false).defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGERUNSIGNED)), this, "合并到了新用户的id");
