...
public class UserCompanyFollowRecord extends UpdatableRecordImpl<UserCompanyFollowRecord> implements Record8<UInteger, Integer, Integer, Integer, Integer, Timestamp, Timestamp, Timestamp> {

    private static final long serialVersionUID = -1610785472;
     ...
     */
    @Override
    public Row8<UInteger, Integer, Integer, Integer, Integer, Timestamp, Timestamp, Timestamp> fieldsRow() {
     ...
     */
    @Override
    public Row8<UInteger, Integer, Integer, Integer, Integer, Timestamp, Timestamp, Timestamp> valuesRow() {
     ...
     */
    @Override
    public UserCompanyFollowRecord value1(UInteger value) {
        setId(value);
        return this;
    }
     ...
     */
    @Override
    public UserCompanyFollowRecord values(UInteger value1, Integer value2, Integer value3, Integer value4, Integer value5, Timestamp value6, Timestamp value7, Timestamp value8) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public UserCompanyFollowRecord(UInteger id, Integer companyId, Integer userId, Integer status, Integer source, Timestamp createTime, Timestamp updateTime, Timestamp unfollowTime) {
        super(UserCompanyFollow.USER_COMPANY_FOLLOW);
