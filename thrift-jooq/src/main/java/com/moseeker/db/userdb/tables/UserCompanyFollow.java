...
public class UserCompanyFollow extends TableImpl<UserCompanyFollowRecord> {
    ...
    private static final long serialVersionUID = 1392805300;
     ...
     */
    public final TableField<UserCompanyFollowRecord, UInteger> ID = createField("id", org.jooq.impl.SQLDataType.INTEGERUNSIGNED.nullable(false), this, "id");
     ...
     */
    @Override
    public Identity<UserCompanyFollowRecord, UInteger> getIdentity() {
