...
public class ConfigSysPointConfTplDO implements org.apache.thrift.TBase<ConfigSysPointConfTplDO, ConfigSysPointConfTplDO._Fields>, java.io.Serializable, Cloneable, Comparable<ConfigSysPointConfTplDO> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("ConfigSysPointConfTplDO");
  ...
  private static final org.apache.thrift.protocol.TField TAG_FIELD_DESC = new org.apache.thrift.protocol.TField("tag", org.apache.thrift.protocol.TType.I16, (short)8);
  private static final org.apache.thrift.protocol.TField IS_INIT_AWARD_FIELD_DESC = new org.apache.thrift.protocol.TField("is_init_award", org.apache.thrift.protocol.TType.I32, (short)9);
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new ConfigSysPointConfTplDOStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new ConfigSysPointConfTplDOTupleSchemeFactory();
  ...
  public short tag; // optional
  public int is_init_award; // optional
  public int recruitOrder; // optional
  public java.lang.String applierView; // optional
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    TAG((short)8, "tag"),
    IS_INIT_AWARD((short)9, "is_init_award"),
  ...
  private static final int __IS_INIT_AWARD_ISSET_ID = 6;
  ...
  static {
    ...
    tmpMap.put(_Fields.IS_INIT_AWARD, new org.apache.thrift.meta_data.FieldMetaData("is_init_award", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I32)));
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(ConfigSysPointConfTplDO.class, metaDataMap);
  }

  public ConfigSysPointConfTplDO() {
  }

  /**
   * Performs a deep copy on <i>other</i>.
   */
  public ConfigSysPointConfTplDO(ConfigSysPointConfTplDO other) {
    ...
    this.tag = other.tag;
    this.is_init_award = other.is_init_award;
  ...
  public ConfigSysPointConfTplDO deepCopy() {
    return new ConfigSysPointConfTplDO(this);
  }
  ...
  public void clear() {
    ...
    setTagIsSet(false);
    this.tag = 0;
    setIs_init_awardIsSet(false);
    this.is_init_award = 0;
  ...
  public ConfigSysPointConfTplDO setId(int id) {
    this.id = id;
    setIdIsSet(true);
    return this;
  }
  ...
  public ConfigSysPointConfTplDO setStatus(java.lang.String status) {
    this.status = status;
    return this;
  }
  ...
  public ConfigSysPointConfTplDO setAward(int award) {
    this.award = award;
    setAwardIsSet(true);
    return this;
  }
  ...
  public ConfigSysPointConfTplDO setDescription(java.lang.String description) {
  ...
  public ConfigSysPointConfTplDO setDisable(int disable) {
  ...
  public ConfigSysPointConfTplDO setPriority(int priority) {
  ...
  public ConfigSysPointConfTplDO setTypeId(int typeId) {
    this.typeId = typeId;
    setTypeIdIsSet(true);
    return this;
  }
  ...
  public ConfigSysPointConfTplDO setTag(short tag) {
    this.tag = tag;
    setTagIsSet(true);
    return this;
  }
  ...
  public int getIs_init_award() {
    return this.is_init_award;
  }

  public ConfigSysPointConfTplDO setIs_init_award(int is_init_award) {
    this.is_init_award = is_init_award;
    setIs_init_awardIsSet(true);
    return this;
  }

  public void unsetIs_init_award() {
    __isset_bitfield = org.apache.thrift.EncodingUtils.clearBit(__isset_bitfield, __IS_INIT_AWARD_ISSET_ID);
  }

  /** Returns true if field is_init_award is set (has been assigned a value) and false otherwise */
  public boolean isSetIs_init_award() {
    return org.apache.thrift.EncodingUtils.testBit(__isset_bitfield, __IS_INIT_AWARD_ISSET_ID);
  }

  public void setIs_init_awardIsSet(boolean value) {
    __isset_bitfield = org.apache.thrift.EncodingUtils.setBit(__isset_bitfield, __IS_INIT_AWARD_ISSET_ID, value);
  }
  ...
  public ConfigSysPointConfTplDO setRecruitOrder(int recruitOrder) {
  ...
  public java.lang.String getApplierView() {
    return this.applierView;
  }

  public ConfigSysPointConfTplDO setApplierView(java.lang.String applierView) {
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case IS_INIT_AWARD:
      if (value == null) {
        ...
        setIs_init_award((java.lang.Integer)value);
      }
      break;
    ...
    case RECRUIT_ORDER:
      if (value == null) {
        ...
        setRecruitOrder((java.lang.Integer)value);
      }
      break;
    ...
    case APPLIER_VIEW:
      if (value == null) {
        ...
        setApplierView((java.lang.String)value);
      }
      break;
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof ConfigSysPointConfTplDO)
      return this.equals((ConfigSysPointConfTplDO)that);
    return false;
  }

  public boolean equals(ConfigSysPointConfTplDO that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
    ...
    boolean this_present_is_init_award = true && this.isSetIs_init_award();
    boolean that_present_is_init_award = true && that.isSetIs_init_award();
    if (this_present_is_init_award || that_present_is_init_award) {
      if (!(this_present_is_init_award && that_present_is_init_award))
        return false;
      if (this.is_init_award != that.is_init_award)
        return false;
    }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetIs_init_award()) ? 131071 : 524287);
    if (isSetIs_init_award())
      hashCode = hashCode * 8191 + is_init_award;
  ...
  @Override
  public int compareTo(ConfigSysPointConfTplDO other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetIs_init_award()).compareTo(other.isSetIs_init_award());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetIs_init_award()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.is_init_award, other.is_init_award);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = java.lang.Boolean.valueOf(isSetRecruitOrder()).compareTo(other.isSetRecruitOrder());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetRecruitOrder()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetApplierView()).compareTo(other.isSetApplierView());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetApplierView()) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("ConfigSysPointConfTplDO(");
    boolean first = true;
    ...
    if (isSetIs_init_award()) {
      if (!first) sb.append(", ");
      sb.append("is_init_award:");
      sb.append(this.is_init_award);
      first = false;
    }
    if (isSetRecruitOrder()) {
      if (!first) sb.append(", ");
  ...
  private static class ConfigSysPointConfTplDOStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public ConfigSysPointConfTplDOStandardScheme getScheme() {
      return new ConfigSysPointConfTplDOStandardScheme();
    }
  }

  private static class ConfigSysPointConfTplDOStandardScheme extends org.apache.thrift.scheme.StandardScheme<ConfigSysPointConfTplDO> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, ConfigSysPointConfTplDO struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 9: // IS_INIT_AWARD
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.is_init_award = iprot.readI32();
              struct.setIs_init_awardIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ConfigSysPointConfTplDO struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.isSetIs_init_award()) {
        oprot.writeFieldBegin(IS_INIT_AWARD_FIELD_DESC);
        oprot.writeI32(struct.is_init_award);
        oprot.writeFieldEnd();
      }
  ...
  private static class ConfigSysPointConfTplDOTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public ConfigSysPointConfTplDOTupleScheme getScheme() {
      return new ConfigSysPointConfTplDOTupleScheme();
    }
  }

  private static class ConfigSysPointConfTplDOTupleScheme extends org.apache.thrift.scheme.TupleScheme<ConfigSysPointConfTplDO> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, ConfigSysPointConfTplDO struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, ConfigSysPointConfTplDO struct) throws org.apache.thrift.TException {
