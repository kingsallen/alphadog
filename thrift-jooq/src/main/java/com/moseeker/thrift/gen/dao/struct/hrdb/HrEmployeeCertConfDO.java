...
public class HrEmployeeCertConfDO implements org.apache.thrift.TBase<HrEmployeeCertConfDO, HrEmployeeCertConfDO._Fields>, java.io.Serializable, Cloneable, Comparable<HrEmployeeCertConfDO> {
  ...
  public java.lang.String emailSuffix; // optional
  ...
  public HrEmployeeCertConfDO setEmailSuffix(java.lang.String emailSuffix) {
  ...
  public HrEmployeeCertConfDO setCreateTime(java.lang.String createTime) {
  ...
  public HrEmployeeCertConfDO setUpdateTime(java.lang.String updateTime) {
  ...
  public HrEmployeeCertConfDO setAuthCode(java.lang.String authCode) {
  ...
  public HrEmployeeCertConfDO setCustomHint(java.lang.String customHint) {
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case IS_STRICT:
      if (value == null) {
        ...
        setIsStrict((java.lang.Double)value);
      }
      break;
    ...
    case BD_ADD_GROUP:
      if (value == null) {
        ...
        setBdAddGroup((java.lang.Double)value);
      }
      break;
    ...
    case BD_USE_GROUP_ID:
      if (value == null) {
        ...
        setBdUseGroupId((java.lang.Double)value);
      }
      break;
    ...
    case AUTH_MODE:
      if (value == null) {
        ...
        setAuthMode((java.lang.Double)value);
      }
      break;
  ...
  public int compareTo(HrEmployeeCertConfDO other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetIsStrict()).compareTo(other.isSetIsStrict());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetIsStrict()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetBdAddGroup()).compareTo(other.isSetBdAddGroup());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetBdAddGroup()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetBdUseGroupId()).compareTo(other.isSetBdUseGroupId());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetBdUseGroupId()) {
