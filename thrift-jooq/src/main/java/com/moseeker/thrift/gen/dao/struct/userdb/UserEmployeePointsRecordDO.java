...
public class UserEmployeePointsRecordDO implements org.apache.thrift.TBase<UserEmployeePointsRecordDO, UserEmployeePointsRecordDO._Fields>, java.io.Serializable, Cloneable, Comparable<UserEmployeePointsRecordDO> {
  ...
  private static final org.apache.thrift.protocol.TField RECOM_USER_ID_FIELD_DESC = new org.apache.thrift.protocol.TField("recomUserId", org.apache.thrift.protocol.TType.I32, (short)12);
  private static final org.apache.thrift.protocol.TField BERECOM_USER_ID_FIELD_DESC = new org.apache.thrift.protocol.TField("berecomUserId", org.apache.thrift.protocol.TType.I32, (short)13);
  ...
  public int berecomUserId; // optional
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    RECOM_USER_ID((short)12, "recomUserId"),
    BERECOM_USER_ID((short)13, "berecomUserId");
  ...
  private static final int __RECOMUSERID_ISSET_ID = 8;
  private static final int __BERECOMUSERID_ISSET_ID = 9;
  private short __isset_bitfield = 0;
  private static final _Fields optionals[] = {_Fields.ID,_Fields.EMPLOYEE_ID,_Fields.REASON,_Fields.AWARD,_Fields.CREATE_TIME,_Fields.APPLICATION_ID,_Fields.RECOM_WXUSER,_Fields.UPDATE_TIME,_Fields.POSITION_ID,_Fields.BERECOM_WXUSER_ID,_Fields.AWARD_CONFIG_ID,_Fields.RECOM_USER_ID,_Fields.BERECOM_USER_ID};
  ...
  static {
    ...
    tmpMap.put(_Fields.RECOM_USER_ID, new org.apache.thrift.meta_data.FieldMetaData("recomUserId", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I32)));
    tmpMap.put(_Fields.BERECOM_USER_ID, new org.apache.thrift.meta_data.FieldMetaData("berecomUserId", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I32)));
  ...
  public UserEmployeePointsRecordDO(UserEmployeePointsRecordDO other) {
    ...
    this.berecomUserId = other.berecomUserId;
  }
  ...
  public void clear() {
    ...
    this.recomUserId = 0;
    setBerecomUserIdIsSet(false);
    this.berecomUserId = 0;
  }
  ...
  public UserEmployeePointsRecordDO setReason(String reason) {
    this.reason = reason;
    return this;
  }
  ...
  public UserEmployeePointsRecordDO setCreateTime(String createTime) {
  ...
  public UserEmployeePointsRecordDO setUpdateTime(String updateTime) {
  ...
  public UserEmployeePointsRecordDO setRecomUserId(int recomUserId) {
  ...
  public int getBerecomUserId() {
    return this.berecomUserId;
  }

  public UserEmployeePointsRecordDO setBerecomUserId(int berecomUserId) {
    this.berecomUserId = berecomUserId;
    setBerecomUserIdIsSet(true);
    return this;
  }

  public void unsetBerecomUserId() {
    __isset_bitfield = org.apache.thrift.EncodingUtils.clearBit(__isset_bitfield, __BERECOMUSERID_ISSET_ID);
  }

  /** Returns true if field berecomUserId is set (has been assigned a value) and false otherwise */
  public boolean isSetBerecomUserId() {
    return org.apache.thrift.EncodingUtils.testBit(__isset_bitfield, __BERECOMUSERID_ISSET_ID);
  }

  public void setBerecomUserIdIsSet(boolean value) {
    __isset_bitfield = org.apache.thrift.EncodingUtils.setBit(__isset_bitfield, __BERECOMUSERID_ISSET_ID, value);
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case BERECOM_WXUSER_ID:
      if (value == null) {
        ...
        setBerecomWxuserId((Double)value);
      }
      break;
    ...
    case BERECOM_USER_ID:
      if (value == null) {
        ...
        setBerecomUserId((Integer)value);
      }
      break;
  ...
  public boolean equals(UserEmployeePointsRecordDO that) {
    ...
    boolean this_present_berecomUserId = true && this.isSetBerecomUserId();
    boolean that_present_berecomUserId = true && that.isSetBerecomUserId();
    if (this_present_berecomUserId || that_present_berecomUserId) {
      if (!(this_present_berecomUserId && that_present_berecomUserId))
        return false;
      if (this.berecomUserId != that.berecomUserId)
        return false;
    }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetBerecomUserId()) ? 131071 : 524287);
    if (isSetBerecomUserId())
      hashCode = hashCode * 8191 + berecomUserId;
  ...
  public int compareTo(UserEmployeePointsRecordDO other) {
    ...
    lastComparison = Boolean.valueOf(isSetRecomWxuser()).compareTo(other.isSetRecomWxuser());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetRecomWxuser()) {
    ...
    lastComparison = Boolean.valueOf(isSetBerecomWxuserId()).compareTo(other.isSetBerecomWxuserId());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetBerecomWxuserId()) {
    ...
    lastComparison = Boolean.valueOf(isSetAwardConfigId()).compareTo(other.isSetAwardConfigId());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetAwardConfigId()) {
    ...
    lastComparison = Boolean.valueOf(isSetBerecomUserId()).compareTo(other.isSetBerecomUserId());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetBerecomUserId()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.berecomUserId, other.berecomUserId);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("UserEmployeePointsRecordDO(");
    boolean first = true;
    ...
    if (isSetBerecomUserId()) {
      if (!first) sb.append(", ");
      sb.append("berecomUserId:");
      sb.append(this.berecomUserId);
      first = false;
    }
    sb.append(")");
    return sb.toString();
  ...
  private static class UserEmployeePointsRecordDOStandardScheme extends org.apache.thrift.scheme.StandardScheme<UserEmployeePointsRecordDO> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, UserEmployeePointsRecordDO struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 13: // BERECOM_USER_ID
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.berecomUserId = iprot.readI32();
              struct.setBerecomUserIdIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, UserEmployeePointsRecordDO struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetBerecomUserId()) {
        oprot.writeFieldBegin(BERECOM_USER_ID_FIELD_DESC);
        oprot.writeI32(struct.berecomUserId);
        oprot.writeFieldEnd();
      }
