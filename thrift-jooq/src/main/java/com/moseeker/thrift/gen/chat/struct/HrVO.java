...
public class HrVO implements org.apache.thrift.TBase<HrVO, HrVO._Fields>, java.io.Serializable, Cloneable, Comparable<HrVO> {
  ...
  public String hrHeadImg; // optional
  ...
  private static final _Fields optionals[] = {_Fields.HR_ID,_Fields.HR_NAME,_Fields.HR_HEAD_IMG,_Fields.IS_DELETE,_Fields.COMPANY_NAME};
  ...
  public HrVO setHrName(String hrName) {
    this.hrName = hrName;
    return this;
  }
  ...
  public HrVO setHrHeadImg(String hrHeadImg) {
  ...
  public HrVO setIsDelete(boolean isDelete) {
  ...
  public HrVO setCompanyName(String companyName) {
  ...
  public int compareTo(HrVO other) {
    ...
    lastComparison = Boolean.valueOf(isSetHrHeadImg()).compareTo(other.isSetHrHeadImg());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetHrHeadImg()) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("HrVO(");
    boolean first = true;
