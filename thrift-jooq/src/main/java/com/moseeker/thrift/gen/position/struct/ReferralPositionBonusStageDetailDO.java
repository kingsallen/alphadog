...
public class ReferralPositionBonusStageDetailDO implements org.apache.thrift.TBase<ReferralPositionBonusStageDetailDO, ReferralPositionBonusStageDetailDO._Fields>, java.io.Serializable, Cloneable, Comparable<ReferralPositionBonusStageDetailDO> {
  ...
  private static final org.apache.thrift.protocol.TField STAGE_BONUS_FIELD_DESC = new org.apache.thrift.protocol.TField("stage_bonus", org.apache.thrift.protocol.TType.STRING, (short)4);
  ...
  public String stage_bonus; // optional
  ...
  private static final int __STAGE_PROPORTION_ISSET_ID = 3;
  private static final int __STAGE_TYPE_ISSET_ID = 4;
  ...
  public ReferralPositionBonusStageDetailDO setStage_bonus(String stage_bonus) {
  ...
  public boolean equals(ReferralPositionBonusStageDetailDO that) {
    ...
    if (this_present_stage_bonus || that_present_stage_bonus) {
      if (!(this_present_stage_bonus && that_present_stage_bonus))
        return false;
      if (!this.stage_bonus.equals(that.stage_bonus))
        return false;
    }
  ...
  public int hashCode() {
    ...
    if (isSetStage_bonus())
      hashCode = hashCode * 8191 + stage_bonus.hashCode();
        ...
        switch (schemeField.id) {
          ...
          case 4: // STAGE_BONUS
            if (schemeField.type == org.apache.thrift.protocol.TType.STRING) {
              struct.stage_bonus = iprot.readString();
