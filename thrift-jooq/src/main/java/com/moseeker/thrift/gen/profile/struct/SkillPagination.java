...
public class SkillPagination implements org.apache.thrift.TBase<SkillPagination, SkillPagination._Fields>, java.io.Serializable, Cloneable, Comparable<SkillPagination> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("SkillPagination");
  ...
  static {
    schemes.put(StandardScheme.class, new SkillPaginationStandardSchemeFactory());
    schemes.put(TupleScheme.class, new SkillPaginationTupleSchemeFactory());
  }
  ...
  public List<Skill> skills; // required
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(SkillPagination.class, metaDataMap);
  }
   ...
   */
  public SkillPagination(SkillPagination other) {
    ...
    if (other.isSetSkills()) {
      List<Skill> __this__skills = new ArrayList<Skill>(other.skills.size());
  ...
  public SkillPagination deepCopy() {
    return new SkillPagination(this);
  }
  ...
  public SkillPagination setTotal_row(int total_row) {
    this.total_row = total_row;
    setTotal_rowIsSet(true);
    return this;
  }
  ...
  public SkillPagination setTotal_page(int total_page) {
    this.total_page = total_page;
    setTotal_pageIsSet(true);
    return this;
  }
  ...
  public SkillPagination setPage_number(int page_number) {
    this.page_number = page_number;
    setPage_numberIsSet(true);
    return this;
  }
  ...
  public SkillPagination setPage_size(int page_size) {
    this.page_size = page_size;
    setPage_sizeIsSet(true);
    return this;
  }
  ...
  public SkillPagination setSkills(List<Skill> skills) {
    this.skills = skills;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof SkillPagination)
      return this.equals((SkillPagination)that);
    return false;
  }

  public boolean equals(SkillPagination that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(SkillPagination other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("SkillPagination(");
    boolean first = true;
  ...
  private static class SkillPaginationStandardSchemeFactory implements SchemeFactory {
    public SkillPaginationStandardScheme getScheme() {
      return new SkillPaginationStandardScheme();
    }
  }

  private static class SkillPaginationStandardScheme extends StandardScheme<SkillPagination> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, SkillPagination struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.skills = new ArrayList<Skill>(_list104.size);
                Skill _elem105;
                for (int _i106 = 0; _i106 < _list104.size; ++_i106)
                {
                  _elem105 = new Skill();
                  _elem105.read(iprot);
                  struct.skills.add(_elem105);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, SkillPagination struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.skills != null) {
        oprot.writeFieldBegin(SKILLS_FIELD_DESC);
        {
          ...
          for (Skill _iter107 : struct.skills)
          {
  ...
  private static class SkillPaginationTupleSchemeFactory implements SchemeFactory {
    public SkillPaginationTupleScheme getScheme() {
      return new SkillPaginationTupleScheme();
    }
  }

  private static class SkillPaginationTupleScheme extends TupleScheme<SkillPagination> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, SkillPagination struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetSkills()) {
        {
          ...
          for (Skill _iter108 : struct.skills)
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, SkillPagination struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(4)) {
        {
          ...
          struct.skills = new ArrayList<Skill>(_list109.size);
          Skill _elem110;
          for (int _i111 = 0; _i111 < _list109.size; ++_i111)
          {
            _elem110 = new Skill();
            _elem110.read(iprot);
            struct.skills.add(_elem110);
          }
        }
        struct.setSkillsIsSet(true);
      }
