            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.skills = new ArrayList<Skill>(_list114.size);
                Skill _elem115;
                for (int _i116 = 0; _i116 < _list114.size; ++_i116)
                {
                  _elem115 = new Skill();
                  _elem115.read(iprot);
                  struct.skills.add(_elem115);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, SkillPagination struct) throws org.apache.thrift.TException {
      ...
      if (struct.skills != null) {
        oprot.writeFieldBegin(SKILLS_FIELD_DESC);
        {
          ...
          for (Skill _iter117 : struct.skills)
          {
      ...
      if (struct.isSetSkills()) {
        {
          ...
          for (Skill _iter118 : struct.skills)
          {
      ...
      if (incoming.get(4)) {
        {
          ...
          struct.skills = new ArrayList<Skill>(_list119.size);
          Skill _elem120;
          for (int _i121 = 0; _i121 < _list119.size; ++_i121)
          {
            _elem120 = new Skill();
            _elem120.read(iprot);
            struct.skills.add(_elem120);
          }
        }
        struct.setSkillsIsSet(true);
      }
