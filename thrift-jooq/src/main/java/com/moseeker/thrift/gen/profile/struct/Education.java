...
public class Education implements org.apache.thrift.TBase<Education, Education._Fields>, java.io.Serializable, Cloneable, Comparable<Education> {
  ...
  private static final org.apache.thrift.protocol.TField COLLEGE_CODE_FIELD_DESC = new org.apache.thrift.protocol.TField("college_code", org.apache.thrift.protocol.TType.I16, (short)7);
  ...
  public short college_code; // required
  public String college_name; // required
  public String college_logo; // required
  public String major_code; // required
  public String major_name; // required
  public String description; // required
  public short is_full; // required
  public short is_unified; // required
  public short is_study_abroad; // required
  public String study_abroad_country; // required
  ...
  static {
    ...
    tmpMap.put(_Fields.COLLEGE_CODE, new org.apache.thrift.meta_data.FieldMetaData("college_code", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I16)));
    tmpMap.put(_Fields.COLLEGE_NAME, new org.apache.thrift.meta_data.FieldMetaData("college_name", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
    tmpMap.put(_Fields.COLLEGE_LOGO, new org.apache.thrift.meta_data.FieldMetaData("college_logo", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
    ...
    tmpMap.put(_Fields.DESCRIPTION, new org.apache.thrift.meta_data.FieldMetaData("description", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
    tmpMap.put(_Fields.IS_FULL, new org.apache.thrift.meta_data.FieldMetaData("is_full", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I16)));
    tmpMap.put(_Fields.IS_UNIFIED, new org.apache.thrift.meta_data.FieldMetaData("is_unified", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I16)));
    tmpMap.put(_Fields.IS_STUDY_ABROAD, new org.apache.thrift.meta_data.FieldMetaData("is_study_abroad", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I16)));
    tmpMap.put(_Fields.STUDY_ABROAD_COUNTRY, new org.apache.thrift.meta_data.FieldMetaData("study_abroad_country", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
  ...
  public Education(
    ...
    short is_full,
    short is_unified,
    short is_study_abroad,
    String study_abroad_country,
    String create_time,
    String update_time)
  {
    this();
  ...
  public Education setStart_date(String start_date) {
    this.start_date = start_date;
    return this;
  }
  ...
  public Education setEnd_date(String end_date) {
    this.end_date = end_date;
    return this;
  }
  ...
  public short getCollege_code() {
    return this.college_code;
  }

  public Education setCollege_code(short college_code) {
    this.college_code = college_code;
    setCollege_codeIsSet(true);
    return this;
  }
  ...
  public Education setCollege_name(String college_name) {
    this.college_name = college_name;
    return this;
  }
  ...
  public Education setCollege_logo(String college_logo) {
    this.college_logo = college_logo;
    return this;
  }
  ...
  public Education setMajor_code(String major_code) {
    this.major_code = major_code;
    return this;
  }
  ...
  public void unsetIs_full() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __IS_FULL_ISSET_ID);
  }

  /** Returns true if field is_full is set (has been assigned a value) and false otherwise */
  public boolean isSetIs_full() {
    return EncodingUtils.testBit(__isset_bitfield, __IS_FULL_ISSET_ID);
  }

  public void setIs_fullIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __IS_FULL_ISSET_ID, value);
  }
  ...
  public void unsetIs_unified() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __IS_UNIFIED_ISSET_ID);
  }

  /** Returns true if field is_unified is set (has been assigned a value) and false otherwise */
  public boolean isSetIs_unified() {
    return EncodingUtils.testBit(__isset_bitfield, __IS_UNIFIED_ISSET_ID);
  }

  public void setIs_unifiedIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __IS_UNIFIED_ISSET_ID, value);
  }
  ...
  public void unsetIs_study_abroad() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __IS_STUDY_ABROAD_ISSET_ID);
  }
  ...
  public boolean isSetIs_study_abroad() {
    return EncodingUtils.testBit(__isset_bitfield, __IS_STUDY_ABROAD_ISSET_ID);
  }

  public void setIs_study_abroadIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __IS_STUDY_ABROAD_ISSET_ID, value);
  }

  public String getStudy_abroad_country() {
    return this.study_abroad_country;
  }

  public Education setStudy_abroad_country(String study_abroad_country) {
    this.study_abroad_country = study_abroad_country;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case IS_STUDY_ABROAD:
      if (value == null) {
        ...
        setIs_study_abroad((Short)value);
      }
      break;
    ...
    case STUDY_ABROAD_COUNTRY:
      if (value == null) {
        ...
        setStudy_abroad_country((String)value);
      }
      break;
  ...
  public Object getFieldValue(_Fields field) {
    ...
    case COLLEGE_CODE:
      return Short.valueOf(getCollege_code());
    ...
    case IS_FULL:
      return Short.valueOf(getIs_full());

    case IS_UNIFIED:
      return Short.valueOf(getIs_unified());

    case IS_STUDY_ABROAD:
      return Short.valueOf(getIs_study_abroad());
  ...
  public boolean equals(Education that) {
    ...
    boolean this_present_is_full = true;
    boolean that_present_is_full = true;
    ...
    boolean this_present_is_unified = true;
    boolean that_present_is_unified = true;
    ...
    boolean this_present_is_study_abroad = true;
    boolean that_present_is_study_abroad = true;
  ...
  public int hashCode() {
    ...
    boolean present_college_name = true && (isSetCollege_name());
    list.add(present_college_name);
    if (present_college_name)
      list.add(college_name);

    boolean present_college_logo = true && (isSetCollege_logo());
    list.add(present_college_logo);
    if (present_college_logo)
      list.add(college_logo);

    boolean present_major_code = true && (isSetMajor_code());
    ...
    boolean present_is_full = true;
    list.add(present_is_full);
    if (present_is_full)
      list.add(is_full);

    boolean present_is_unified = true;
    list.add(present_is_unified);
    if (present_is_unified)
      list.add(is_unified);

    boolean present_is_study_abroad = true;
    list.add(present_is_study_abroad);
    if (present_is_study_abroad)
      list.add(is_study_abroad);

    boolean present_study_abroad_country = true && (isSetStudy_abroad_country());
    list.add(present_study_abroad_country);
    if (present_study_abroad_country)
      list.add(study_abroad_country);
  ...
  public int compareTo(Education other) {
    ...
    lastComparison = Boolean.valueOf(isSetCollege_name()).compareTo(other.isSetCollege_name());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = Boolean.valueOf(isSetCollege_logo()).compareTo(other.isSetCollege_logo());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = Boolean.valueOf(isSetIs_full()).compareTo(other.isSetIs_full());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetIs_full()) {
    ...
    lastComparison = Boolean.valueOf(isSetIs_unified()).compareTo(other.isSetIs_unified());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetIs_unified()) {
    ...
    lastComparison = Boolean.valueOf(isSetIs_study_abroad()).compareTo(other.isSetIs_study_abroad());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = Boolean.valueOf(isSetStudy_abroad_country()).compareTo(other.isSetStudy_abroad_country());
    if (lastComparison != 0) {
      return lastComparison;
    }
  ...
  private static class EducationStandardScheme extends StandardScheme<Education> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, Education struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 7: // COLLEGE_CODE
            if (schemeField.type == org.apache.thrift.protocol.TType.I16) {
              struct.college_code = iprot.readI16();
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Education struct) throws org.apache.thrift.TException {
      ...
      oprot.writeI16(struct.college_code);
      oprot.writeFieldEnd();
