...
public class HrAppExportFieldsDO implements org.apache.thrift.TBase<HrAppExportFieldsDO, HrAppExportFieldsDO._Fields>, java.io.Serializable, Cloneable, Comparable<HrAppExportFieldsDO> {
  ...
  private static final _Fields optionals[] = {_Fields.ID,_Fields.FIELD_NAME,_Fields.FIELD_TITLE,_Fields.DISPLAY_ORDER,_Fields.SELECTED,_Fields.SAMPLE};
  ...
  public HrAppExportFieldsDO setFieldName(String fieldName) {
  ...
  public HrAppExportFieldsDO setFieldTitle(String fieldTitle) {
  ...
  public HrAppExportFieldsDO setSample(String sample) {
    this.sample = sample;
    return this;
  }
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("HrAppExportFieldsDO(");
    boolean first = true;
