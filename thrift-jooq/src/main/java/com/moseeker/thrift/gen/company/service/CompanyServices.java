...
public class CompanyServices {
  ...
  public interface AsyncIface {
    ...
    public void ifSynchronizePosition(int companyId, int channel, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public static class ifSynchronizePosition_call extends org.apache.thrift.async.TAsyncMethodCall {
      private int companyId;
      private int channel;
      public ifSynchronizePosition_call(int companyId, int channel, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.companyId = companyId;
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class ifSynchronizePosition<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, ifSynchronizePosition_args, com.moseeker.thrift.gen.common.struct.Response> {
      ...
      public void start(I iface, ifSynchronizePosition_args args, org.apache.thrift.async.AsyncMethodCallback<com.moseeker.thrift.gen.common.struct.Response> resultHandler) throws TException {
  ...
  public static class ifSynchronizePosition_args implements org.apache.thrift.TBase<ifSynchronizePosition_args, ifSynchronizePosition_args._Fields>, java.io.Serializable, Cloneable, Comparable<ifSynchronizePosition_args>   {
    ...
    private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
    static {
      schemes.put(StandardScheme.class, new ifSynchronizePosition_argsStandardSchemeFactory());
      schemes.put(TupleScheme.class, new ifSynchronizePosition_argsTupleSchemeFactory());
    }
    ...
    private static class ifSynchronizePosition_argsStandardSchemeFactory implements SchemeFactory {
      public ifSynchronizePosition_argsStandardScheme getScheme() {
        return new ifSynchronizePosition_argsStandardScheme();
      }
    }

    private static class ifSynchronizePosition_argsStandardScheme extends StandardScheme<ifSynchronizePosition_args> {
    ...
    private static class ifSynchronizePosition_argsTupleSchemeFactory implements SchemeFactory {
      public ifSynchronizePosition_argsTupleScheme getScheme() {
        return new ifSynchronizePosition_argsTupleScheme();
      }
    }

    private static class ifSynchronizePosition_argsTupleScheme extends TupleScheme<ifSynchronizePosition_args> {
  ...
  public static class ifSynchronizePosition_result implements org.apache.thrift.TBase<ifSynchronizePosition_result, ifSynchronizePosition_result._Fields>, java.io.Serializable, Cloneable, Comparable<ifSynchronizePosition_result>   {
    ...
    private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
    static {
      schemes.put(StandardScheme.class, new ifSynchronizePosition_resultStandardSchemeFactory());
      schemes.put(TupleScheme.class, new ifSynchronizePosition_resultTupleSchemeFactory());
    }
    ...
    private static class ifSynchronizePosition_resultStandardSchemeFactory implements SchemeFactory {
      public ifSynchronizePosition_resultStandardScheme getScheme() {
        return new ifSynchronizePosition_resultStandardScheme();
      }
    }

    private static class ifSynchronizePosition_resultStandardScheme extends StandardScheme<ifSynchronizePosition_result> {
    ...
    private static class ifSynchronizePosition_resultTupleSchemeFactory implements SchemeFactory {
      public ifSynchronizePosition_resultTupleScheme getScheme() {
        return new ifSynchronizePosition_resultTupleScheme();
      }
    }

    private static class ifSynchronizePosition_resultTupleScheme extends TupleScheme<ifSynchronizePosition_result> {
