...
public class UserEmployeeBatchForm implements org.apache.thrift.TBase<UserEmployeeBatchForm, UserEmployeeBatchForm._Fields>, java.io.Serializable, Cloneable, Comparable<UserEmployeeBatchForm> {
  ...
  public boolean cancel_auth; // optional
  ...
  private static final _Fields optionals[] = {_Fields.CANCEL_AUTH,_Fields.AUTH_METHOD};
  ...
  public boolean equals(UserEmployeeBatchForm that) {
    ...
    boolean this_present_cancel_auth = true && this.isSetCancel_auth();
    boolean that_present_cancel_auth = true && that.isSetCancel_auth();
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetCancel_auth()) ? 131071 : 524287);
    if (isSetCancel_auth())
