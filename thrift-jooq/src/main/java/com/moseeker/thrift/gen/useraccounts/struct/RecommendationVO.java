            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.recommends = new java.util.ArrayList<RecommendationRecordVO>(_list8.size);
                RecommendationRecordVO _elem9;
                for (int _i10 = 0; _i10 < _list8.size; ++_i10)
                {
                  _elem9 = new RecommendationRecordVO();
                  _elem9.read(iprot);
                  struct.recommends.add(_elem9);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.recommends != null) {
        if (struct.isSetRecommends()) {
          oprot.writeFieldBegin(RECOMMENDS_FIELD_DESC);
          {
            ...
            for (RecommendationRecordVO _iter11 : struct.recommends)
            {
              _iter11.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.isSetRecommends()) {
        {
          ...
          for (RecommendationRecordVO _iter12 : struct.recommends)
          {
            _iter12.write(oprot);
          }
        }
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.recommends = new java.util.ArrayList<RecommendationRecordVO>(_list13.size);
          RecommendationRecordVO _elem14;
          for (int _i15 = 0; _i15 < _list13.size; ++_i15)
          {
            _elem14 = new RecommendationRecordVO();
            _elem14.read(iprot);
            struct.recommends.add(_elem14);
          }
        }
        struct.setRecommendsIsSet(true);
      }
