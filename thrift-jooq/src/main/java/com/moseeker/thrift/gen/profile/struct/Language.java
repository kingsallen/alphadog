...
public class Language implements org.apache.thrift.TBase<Language, Language._Fields>, java.io.Serializable, Cloneable, Comparable<Language> {
  ...
  private static final org.apache.thrift.protocol.TField NAME_FIELD_DESC = new org.apache.thrift.protocol.TField("name", org.apache.thrift.protocol.TType.I16, (short)3);
  ...
  public Language setName(short name) {
    this.name = name;
    setNameIsSet(true);
    return this;
  }
  ...
  public Language setLevel(String level) {
    this.level = level;
    return this;
  }
