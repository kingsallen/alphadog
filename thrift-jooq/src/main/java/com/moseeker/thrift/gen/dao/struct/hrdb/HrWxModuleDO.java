...
public class HrWxModuleDO implements org.apache.thrift.TBase<HrWxModuleDO, HrWxModuleDO._Fields>, java.io.Serializable, Cloneable, Comparable<HrWxModuleDO> {
  ...
  public java.lang.String ability; // optional
  ...
  public java.lang.String subscribes; // optional
  public java.lang.String handles; // optional
  public byte isrulefields; // optional
  public byte home; // optional
  public byte issystem; // optional
  public java.lang.String options; // optional
  public byte profile; // optional
  public java.lang.String siteMenus; // optional
  public java.lang.String platformMenus; // optional
  ...
  public HrWxModuleDO setName(java.lang.String name) {
    this.name = name;
    return this;
  }
  ...
  public HrWxModuleDO setTitle(java.lang.String title) {
    this.title = title;
    return this;
  }
  ...
  public HrWxModuleDO setVersion(java.lang.String version) {
  ...
  public HrWxModuleDO setAbility(java.lang.String ability) {
  ...
  public HrWxModuleDO setDescription(java.lang.String description) {
  ...
  public HrWxModuleDO setAuthor(java.lang.String author) {
    this.author = author;
    return this;
  }
  ...
  public HrWxModuleDO setUrl(java.lang.String url) {
    this.url = url;
    return this;
  }
  ...
  public java.lang.String getSubscribes() {
    return this.subscribes;
  }

  public HrWxModuleDO setSubscribes(java.lang.String subscribes) {
  ...
  public HrWxModuleDO setHandles(java.lang.String handles) {
  ...
  public HrWxModuleDO setOptions(java.lang.String options) {
  ...
  public java.lang.String getSiteMenus() {
    return this.siteMenus;
  }

  public HrWxModuleDO setSiteMenus(java.lang.String siteMenus) {
  ...
  public java.lang.String getPlatformMenus() {
    return this.platformMenus;
  }

  public HrWxModuleDO setPlatformMenus(java.lang.String platformMenus) {
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case ABILITY:
      if (value == null) {
        ...
        setAbility((java.lang.String)value);
      }
      break;
    ...
    case SETTINGS:
      if (value == null) {
        ...
        setSettings((java.lang.Byte)value);
      }
      break;
    ...
    case SUBSCRIBES:
      if (value == null) {
        ...
        setSubscribes((java.lang.String)value);
      }
      break;
    ...
    case HANDLES:
      if (value == null) {
        ...
        setHandles((java.lang.String)value);
      }
      break;
    ...
    case ISRULEFIELDS:
      if (value == null) {
        ...
        setIsrulefields((java.lang.Byte)value);
      }
      break;
    ...
    case ISSYSTEM:
      if (value == null) {
        ...
        setIssystem((java.lang.Byte)value);
      }
      break;
    ...
    case PROFILE:
      if (value == null) {
        ...
        setProfile((java.lang.Byte)value);
      }
      break;
    ...
    case SITE_MENUS:
      if (value == null) {
        ...
        setSiteMenus((java.lang.String)value);
      }
      break;
    ...
    case PLATFORM_MENUS:
      if (value == null) {
        ...
        setPlatformMenus((java.lang.String)value);
      }
      break;
  ...
  public int compareTo(HrWxModuleDO other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetAbility()).compareTo(other.isSetAbility());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetAbility()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetSubscribes()).compareTo(other.isSetSubscribes());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetSubscribes()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetHandles()).compareTo(other.isSetHandles());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetHandles()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetIsrulefields()).compareTo(other.isSetIsrulefields());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetIsrulefields()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetIssystem()).compareTo(other.isSetIssystem());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetIssystem()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetSiteMenus()).compareTo(other.isSetSiteMenus());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetSiteMenus()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetPlatformMenus()).compareTo(other.isSetPlatformMenus());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetPlatformMenus()) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("HrWxModuleDO(");
    boolean first = true;
