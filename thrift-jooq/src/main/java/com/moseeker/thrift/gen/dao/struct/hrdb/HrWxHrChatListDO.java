...
public class HrWxHrChatListDO implements org.apache.thrift.TBase<HrWxHrChatListDO, HrWxHrChatListDO._Fields>, java.io.Serializable, Cloneable, Comparable<HrWxHrChatListDO> {
  ...
  private static final org.apache.thrift.protocol.TField WX_CHAT_TIME_FIELD_DESC = new org.apache.thrift.protocol.TField("wxChatTime", org.apache.thrift.protocol.TType.STRING, (short)6);
  private static final org.apache.thrift.protocol.TField HR_CHAT_TIME_FIELD_DESC = new org.apache.thrift.protocol.TField("hrChatTime", org.apache.thrift.protocol.TType.STRING, (short)7);
  ...
  public String wxChatTime; // optional
  public String hrChatTime; // optional
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    WX_CHAT_TIME((short)6, "wxChatTime"),
    HR_CHAT_TIME((short)7, "hrChatTime"),
  ...
  private static final _Fields optionals[] = {_Fields.ID,_Fields.SYSUSER_ID,_Fields.HRACCOUNT_ID,_Fields.STATUS,_Fields.CREATE_TIME,_Fields.WX_CHAT_TIME,_Fields.HR_CHAT_TIME,_Fields.UPDATE_TIME};
  ...
  public HrWxHrChatListDO setStatus(byte status) {
    this.status = status;
    setStatusIsSet(true);
    return this;
  }
  ...
  public HrWxHrChatListDO setCreateTime(String createTime) {
  ...
  public String getWxChatTime() {
    return this.wxChatTime;
  }

  public HrWxHrChatListDO setWxChatTime(String wxChatTime) {
  ...
  public String getHrChatTime() {
    return this.hrChatTime;
  }

  public HrWxHrChatListDO setHrChatTime(String hrChatTime) {
  ...
  public HrWxHrChatListDO setUpdateTime(String updateTime) {
  ...
  public int compareTo(HrWxHrChatListDO other) {
    ...
    lastComparison = Boolean.valueOf(isSetWxChatTime()).compareTo(other.isSetWxChatTime());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetWxChatTime()) {
    ...
    lastComparison = Boolean.valueOf(isSetHrChatTime()).compareTo(other.isSetHrChatTime());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetHrChatTime()) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("HrWxHrChatListDO(");
    boolean first = true;
