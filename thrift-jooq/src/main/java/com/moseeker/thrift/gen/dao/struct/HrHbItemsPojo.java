...
public class HrHbItemsPojo implements org.apache.thrift.TBase<HrHbItemsPojo, HrHbItemsPojo._Fields>, java.io.Serializable, Cloneable, Comparable<HrHbItemsPojo> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("HrHbItemsPojo");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new HrHbItemsPojoStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new HrHbItemsPojoTupleSchemeFactory();
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(HrHbItemsPojo.class, metaDataMap);
  }

  public HrHbItemsPojo() {
  }

  /**
   * Performs a deep copy on <i>other</i>.
   */
  public HrHbItemsPojo(HrHbItemsPojo other) {
  ...
  public HrHbItemsPojo deepCopy() {
    return new HrHbItemsPojo(this);
  }
  ...
  public HrHbItemsPojo setId(int id) {
    this.id = id;
    setIdIsSet(true);
    return this;
  }
  ...
  public HrHbItemsPojo setHb_config_id(int hb_config_id) {
  ...
  public HrHbItemsPojo setBinding_id(int binding_id) {
  ...
  public HrHbItemsPojo setIndex(int index) {
    this.index = index;
    setIndexIsSet(true);
    return this;
  }
  ...
  public HrHbItemsPojo setAmount(double amount) {
    this.amount = amount;
    setAmountIsSet(true);
    return this;
  }
  ...
  public HrHbItemsPojo setStatus(int status) {
    this.status = status;
    setStatusIsSet(true);
    return this;
  }
  ...
  public HrHbItemsPojo setWxuser_id(int wxuser_id) {
  ...
  public HrHbItemsPojo setOpen_time(java.lang.String open_time) {
  ...
  public HrHbItemsPojo setCreate_time(java.lang.String create_time) {
  ...
  public HrHbItemsPojo setUpdate_time(java.lang.String update_time) {
  ...
  public HrHbItemsPojo setTrigger_wxuser_id(int trigger_wxuser_id) {
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof HrHbItemsPojo)
      return this.equals((HrHbItemsPojo)that);
    return false;
  }

  public boolean equals(HrHbItemsPojo that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(HrHbItemsPojo other) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("HrHbItemsPojo(");
    boolean first = true;
  ...
  private static class HrHbItemsPojoStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public HrHbItemsPojoStandardScheme getScheme() {
      return new HrHbItemsPojoStandardScheme();
    }
  }

  private static class HrHbItemsPojoStandardScheme extends org.apache.thrift.scheme.StandardScheme<HrHbItemsPojo> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, HrHbItemsPojo struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, HrHbItemsPojo struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class HrHbItemsPojoTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public HrHbItemsPojoTupleScheme getScheme() {
      return new HrHbItemsPojoTupleScheme();
    }
  }

  private static class HrHbItemsPojoTupleScheme extends org.apache.thrift.scheme.TupleScheme<HrHbItemsPojo> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, HrHbItemsPojo struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, HrHbItemsPojo struct) throws org.apache.thrift.TException {
