...
public class HRChatRoomVO implements org.apache.thrift.TBase<HRChatRoomVO, HRChatRoomVO._Fields>, java.io.Serializable, Cloneable, Comparable<HRChatRoomVO> {
  ...
  private static final org.apache.thrift.protocol.TField APPLY_FIELD_DESC = new org.apache.thrift.protocol.TField("apply", org.apache.thrift.protocol.TType.BOOL, (short)8);
  ...
  private static final int __APPLY_ISSET_ID = 4;
  private byte __isset_bitfield = 0;
  private static final _Fields optionals[] = {_Fields.ID,_Fields.USER_ID,_Fields.NAME,_Fields.HEAD_IMG_URL,_Fields.CREATE_TIME,_Fields.STATUS,_Fields.UN_READ_NUM,_Fields.APPLY};
  ...
  public HRChatRoomVO setApply(boolean apply) {
    this.apply = apply;
    setApplyIsSet(true);
    return this;
  }
