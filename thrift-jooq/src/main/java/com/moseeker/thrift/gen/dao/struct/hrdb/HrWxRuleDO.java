...
public class HrWxRuleDO implements org.apache.thrift.TBase<HrWxRuleDO, HrWxRuleDO._Fields>, java.io.Serializable, Cloneable, Comparable<HrWxRuleDO> {
  ...
  public String component; // optional
  ...
  public HrWxRuleDO setName(String name) {
    this.name = name;
    return this;
  }
  ...
  public HrWxRuleDO setComponent(String component) {
  ...
  public HrWxRuleDO setKeywords(String keywords) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("HrWxRuleDO(");
    boolean first = true;
