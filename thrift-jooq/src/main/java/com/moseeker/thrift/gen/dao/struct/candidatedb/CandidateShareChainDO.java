...
public class CandidateShareChainDO implements org.apache.thrift.TBase<CandidateShareChainDO, CandidateShareChainDO._Fields>, java.io.Serializable, Cloneable, Comparable<CandidateShareChainDO> {
    ...
    private static final _Fields optionals[] = {_Fields.ID,_Fields.POSITION_ID,_Fields.ROOT_RECOM_USER_ID,_Fields.ROOT2_RECOM_USER_ID,_Fields.RECOM_USER_ID,_Fields.PRESENTEE_USER_ID,_Fields.DEPTH,_Fields.PARENT_ID,_Fields.CLICK_TIME,_Fields.CREATE_TIME,_Fields.CLICK_FROM};
    ...
    public CandidateShareChainDO setClickTime(java.lang.String clickTime) {
    ...
    public CandidateShareChainDO setCreateTime(java.lang.String createTime) {
        ...
        switch (field) {
            ...
            case ROOT_RECOM_USER_ID:
                if (value == null) {
                    ...
                    setRootRecomUserId((java.lang.Integer)value);
                }
                break;
            ...
            case ROOT2_RECOM_USER_ID:
                if (value == null) {
                    ...
                    setRoot2RecomUserId((java.lang.Integer)value);
                }
                break;
    ...
    public int compareTo(CandidateShareChainDO other) {
        ...
        lastComparison = java.lang.Boolean.valueOf(isSetRootRecomUserId()).compareTo(other.isSetRootRecomUserId());
        if (lastComparison != 0) {
            return lastComparison;
        }
        if (isSetRootRecomUserId()) {
        ...
        lastComparison = java.lang.Boolean.valueOf(isSetRoot2RecomUserId()).compareTo(other.isSetRoot2RecomUserId());
        if (lastComparison != 0) {
            return lastComparison;
        }
        if (isSetRoot2RecomUserId()) {
    ...
    public java.lang.String toString() {
        java.lang.StringBuilder sb = new java.lang.StringBuilder("CandidateShareChainDO(");
        boolean first = true;
