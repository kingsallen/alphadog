...
public class ThirdPartyPosition implements org.apache.thrift.TBase<ThirdPartyPosition, ThirdPartyPosition._Fields>, java.io.Serializable, Cloneable, Comparable<ThirdPartyPosition> {
  ...
  private static final org.apache.thrift.protocol.TField SALARY_MONTH_FIELD_DESC = new org.apache.thrift.protocol.TField("salary_month", org.apache.thrift.protocol.TType.I32, (short)3);
  ...
  public int salary_month; // optional
  ...
  private static final int __SALARY_MONTH_ISSET_ID = 2;
  private static final int __COUNT_ISSET_ID = 3;
  private static final int __USE_COMPANY_ADDRESS_ISSET_ID = 4;
  private static final int __CHANNEL_ISSET_ID = 5;
  private static final int __THIRD_PARTY_ACCOUNT_ID_ISSET_ID = 6;
  private static final int __FEEDBACK_PERIOD_ISSET_ID = 7;
  ...
  public ThirdPartyPosition setSalary_month(int salary_month) {
  ...
  public ThirdPartyPosition setPractice_salary(int practice_salary) {
  ...
  public boolean equals(ThirdPartyPosition that) {
    ...
    boolean this_present_practice_salary = true && this.isSetPractice_salary();
    boolean that_present_practice_salary = true && that.isSetPractice_salary();
    ...
    boolean this_present_practice_per_week = true && this.isSetPractice_per_week();
    boolean that_present_practice_per_week = true && that.isSetPractice_per_week();
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetPractice_salary()) ? 131071 : 524287);
