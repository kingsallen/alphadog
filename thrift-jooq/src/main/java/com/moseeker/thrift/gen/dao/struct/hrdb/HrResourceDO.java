...
public class HrResourceDO implements org.apache.thrift.TBase<HrResourceDO, HrResourceDO._Fields>, java.io.Serializable, Cloneable, Comparable<HrResourceDO> {
  ...
  private static final org.apache.thrift.protocol.TField COVER_FIELD_DESC = new org.apache.thrift.protocol.TField("cover", org.apache.thrift.protocol.TType.STRING, (short)10);
  ...
  private static final _Fields optionals[] = {_Fields.ID,_Fields.RES_URL,_Fields.RES_TYPE,_Fields.REMARK,_Fields.COMPANY_ID,_Fields.TITLE,_Fields.DISABLE,_Fields.CREATE_TIME,_Fields.UPDATE_TIME,_Fields.COVER};
  ...
  public HrResourceDO setResUrl(String resUrl) {
    this.resUrl = resUrl;
    return this;
  }
  ...
  public HrResourceDO setRemark(String remark) {
    this.remark = remark;
    return this;
  }
  ...
  public HrResourceDO setTitle(String title) {
    this.title = title;
    return this;
  }
  ...
  public HrResourceDO setCreateTime(String createTime) {
  ...
  public HrResourceDO setUpdateTime(String updateTime) {
  ...
  public HrResourceDO setCover(String cover) {
    this.cover = cover;
    return this;
  }
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("HrResourceDO(");
    boolean first = true;
