...
public class ReferralReasonInfo implements org.apache.thrift.TBase<ReferralReasonInfo, ReferralReasonInfo._Fields>, java.io.Serializable, Cloneable, Comparable<ReferralReasonInfo> {
  ...
  public java.util.List<String> referralReasons; // optional
  public int relationship; // optional
  public String recomReasonText; // optional
  ...
  public ReferralReasonInfo setReferralReasons(java.util.List<String> referralReasons) {
  ...
  public ReferralReasonInfo setRecomReasonText(String recomReasonText) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("ReferralReasonInfo(");
    boolean first = true;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.referralReasons = new java.util.ArrayList<String>(_list32.size);
                String _elem33;
      ...
      if (struct.referralReasons != null) {
        if (struct.isSetReferralReasons()) {
          oprot.writeFieldBegin(REFERRAL_REASONS_FIELD_DESC);
          {
            ...
            for (String _iter35 : struct.referralReasons)
            {
      ...
      if (struct.isSetReferralReasons()) {
        {
          ...
          for (String _iter36 : struct.referralReasons)
          {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.referralReasons = new java.util.ArrayList<String>(_list37.size);
          String _elem38;
