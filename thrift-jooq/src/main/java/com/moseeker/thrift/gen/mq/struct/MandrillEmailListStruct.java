...
public class MandrillEmailListStruct implements org.apache.thrift.TBase<MandrillEmailListStruct, MandrillEmailListStruct._Fields>, java.io.Serializable, Cloneable, Comparable<MandrillEmailListStruct> {
    ...
    public MandrillEmailListStruct(MandrillEmailListStruct other) {
        ...
        if (other.isSetMergeVars()) {
            ...
            for (java.util.Map<java.lang.String,java.lang.String> other_element : other.mergeVars) {
                java.util.Map<java.lang.String,java.lang.String> __this__mergeVars_copy = new java.util.HashMap<java.lang.String,java.lang.String>(other_element);
    ...
    public java.util.Iterator<java.util.Map<java.lang.String,java.lang.String>> getMergeVarsIterator() {
        return (this.mergeVars == null) ? null : this.mergeVars.iterator();
    }

    public void addToMergeVars(java.util.Map<java.lang.String,java.lang.String> elem) {
        if (this.mergeVars == null) {
            this.mergeVars = new java.util.ArrayList<java.util.Map<java.lang.String,java.lang.String>>();
        }
        this.mergeVars.add(elem);
    }

    public java.util.List<java.util.Map<java.lang.String,java.lang.String>> getMergeVars() {
        return this.mergeVars;
    }

    public MandrillEmailListStruct setMergeVars(java.util.List<java.util.Map<java.lang.String,java.lang.String>> mergeVars) {
        ...
        switch (field) {
            ...
            case MERGE_VARS:
                if (value == null) {
                    ...
                    setMergeVars((java.util.List<java.util.Map<java.lang.String,java.lang.String>>)value);
                }
                break;
