...
public class WechatPositionListData implements org.apache.thrift.TBase<WechatPositionListData, WechatPositionListData._Fields>, java.io.Serializable, Cloneable, Comparable<WechatPositionListData> {
  ...
  private static final org.apache.thrift.protocol.TField BONUS_VO_FIELD_DESC = new org.apache.thrift.protocol.TField("bonusVO", org.apache.thrift.protocol.TType.STRUCT, (short)33);
  ...
  public ReferralPositionBonusVO bonusVO; // required
  ...
  static {
    ...
    tmpMap.put(_Fields.TEAM_ID, new org.apache.thrift.meta_data.FieldMetaData("team_id", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I32)));
    tmpMap.put(_Fields.BONUS_VO, new org.apache.thrift.meta_data.FieldMetaData("bonusVO", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRUCT        , "ReferralPositionBonusVO")));
  ...
  public WechatPositionListData(
    ReferralPositionBonusVO bonusVO)
  {
    this();
  ...
  public WechatPositionListData(WechatPositionListData other) {
    ...
    if (other.isSetBonusVO()) {
      this.bonusVO = new ReferralPositionBonusVO(other.bonusVO);
    }
  }
  ...
  public WechatPositionListData setUpdate_time(String update_time) {
  ...
  public WechatPositionListData setExperience(String experience) {
  ...
  public ReferralPositionBonusVO getBonusVO() {
    return this.bonusVO;
  }

  public WechatPositionListData setBonusVO(ReferralPositionBonusVO bonusVO) {
    this.bonusVO = bonusVO;
    return this;
  }

  public void unsetBonusVO() {
    this.bonusVO = null;
  }

  /** Returns true if field bonusVO is set (has been assigned a value) and false otherwise */
  public boolean isSetBonusVO() {
    return this.bonusVO != null;
  }

  public void setBonusVOIsSet(boolean value) {
    if (!value) {
      this.bonusVO = null;
    }
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case BONUS_VO:
      if (value == null) {
        ...
        setBonusVO((ReferralPositionBonusVO)value);
      }
      break;
  ...
  public boolean equals(WechatPositionListData that) {
    ...
    boolean this_present_bonusVO = true && this.isSetBonusVO();
    boolean that_present_bonusVO = true && that.isSetBonusVO();
    if (this_present_bonusVO || that_present_bonusVO) {
      if (!(this_present_bonusVO && that_present_bonusVO))
        return false;
      if (!this.bonusVO.equals(that.bonusVO))
        return false;
    }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetBonusVO()) ? 131071 : 524287);
    if (isSetBonusVO())
      hashCode = hashCode * 8191 + bonusVO.hashCode();
  ...
  public int compareTo(WechatPositionListData other) {
    ...
    lastComparison = Boolean.valueOf(isSetBonusVO()).compareTo(other.isSetBonusVO());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetBonusVO()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.bonusVO, other.bonusVO);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    ...
    if (!first) sb.append(", ");
    sb.append("bonusVO:");
    if (this.bonusVO == null) {
      sb.append("null");
    } else {
      sb.append(this.bonusVO);
    }
    first = false;
    sb.append(")");
    return sb.toString();
  ...
  private static class WechatPositionListDataStandardScheme extends org.apache.thrift.scheme.StandardScheme<WechatPositionListData> {
        ...
        switch (schemeField.id) {
          ...
          case 33: // BONUS_VO
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.bonusVO = new ReferralPositionBonusVO();
              struct.bonusVO.read(iprot);
              struct.setBonusVOIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, WechatPositionListData struct) throws org.apache.thrift.TException {
      ...
      if (struct.bonusVO != null) {
        oprot.writeFieldBegin(BONUS_VO_FIELD_DESC);
        struct.bonusVO.write(oprot);
        oprot.writeFieldEnd();
      }
