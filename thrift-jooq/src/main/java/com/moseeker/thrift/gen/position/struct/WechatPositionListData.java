...
public class WechatPositionListData implements org.apache.thrift.TBase<WechatPositionListData, WechatPositionListData._Fields>, java.io.Serializable, Cloneable, Comparable<WechatPositionListData> {
  ...
  static {
    ...
    tmpMap.put(_Fields.PRIORITY, new org.apache.thrift.meta_data.FieldMetaData("priority", org.apache.thrift.TFieldRequirementType.REQUIRED, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I32)));
    tmpMap.put(_Fields.PUBLISHER, new org.apache.thrift.meta_data.FieldMetaData("publisher", org.apache.thrift.TFieldRequirementType.REQUIRED, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I32)));
  ...
  public void validate() throws org.apache.thrift.TException {
    ...
    // alas, we cannot check 'publisher' because it's a primitive and you chose the non-beans generator.
  ...
  private static class WechatPositionListDataStandardScheme extends org.apache.thrift.scheme.StandardScheme<WechatPositionListData> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, WechatPositionListData struct) throws org.apache.thrift.TException {
      ...
      if (!struct.isSetPublisher()) {
        throw new org.apache.thrift.protocol.TProtocolException("Required field 'publisher' was not found in serialized data! Struct: " + toString());
      }
      struct.validate();
    }
