...
public class HrThirdPartyPositionDO implements org.apache.thrift.TBase<HrThirdPartyPositionDO, HrThirdPartyPositionDO._Fields>, java.io.Serializable, Cloneable, Comparable<HrThirdPartyPositionDO> {
  ...
  private static final org.apache.thrift.protocol.TField PRACTICE_PER_WEEK_FIELD_DESC = new org.apache.thrift.protocol.TField("practicePerWeek", org.apache.thrift.protocol.TType.I32, (short)22);
  ...
  public int practicePerWeek; // optional
  ...
  public HrThirdPartyPositionDO setDepartment(java.lang.String department) {
  ...
  public int getPracticePerWeek() {
    return this.practicePerWeek;
  }

  public HrThirdPartyPositionDO setPracticePerWeek(int practicePerWeek) {
    ...
    switch (field) {
      ...
      case SALARY_MONTH:
        if (value == null) {
          ...
          setSalaryMonth((java.lang.Integer)value);
        }
        break;
      ...
      case FEEDBACK_PERIOD:
        if (value == null) {
          ...
          setFeedbackPeriod((java.lang.Integer)value);
        }
        break;
      ...
      case SALARY_DISCUSS:
        if (value == null) {
          ...
          setSalaryDiscuss((java.lang.Integer)value);
        }
        break;
      ...
      case PRACTICE_SALARY:
        if (value == null) {
          ...
          setPracticeSalary((java.lang.Integer)value);
        }
        break;
      ...
      case PRACTICE_PER_WEEK:
        if (value == null) {
          ...
          setPracticePerWeek((java.lang.Integer)value);
        }
        break;
  ...
  public int hashCode() {
    ...
    if (isSetPracticePerWeek())
      hashCode = hashCode * 8191 + practicePerWeek;
  ...
  public int compareTo(HrThirdPartyPositionDO other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetSalaryMonth()).compareTo(other.isSetSalaryMonth());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetSalaryMonth()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetFeedbackPeriod()).compareTo(other.isSetFeedbackPeriod());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetFeedbackPeriod()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetSalaryDiscuss()).compareTo(other.isSetSalaryDiscuss());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetSalaryDiscuss()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetPracticeSalary()).compareTo(other.isSetPracticeSalary());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetPracticeSalary()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetPracticePerWeek()).compareTo(other.isSetPracticePerWeek());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetPracticePerWeek()) {
  ...
  private static class HrThirdPartyPositionDOStandardScheme extends org.apache.thrift.scheme.StandardScheme<HrThirdPartyPositionDO> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, HrThirdPartyPositionDO struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 22: // PRACTICE_PER_WEEK
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.practicePerWeek = iprot.readI32();
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, HrThirdPartyPositionDO struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetPracticePerWeek()) {
        ...
        oprot.writeI32(struct.practicePerWeek);
        oprot.writeFieldEnd();
      }
