            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.schoolJobs = new ArrayList<SchoolJob>(_list96.size);
                SchoolJob _elem97;
                for (int _i98 = 0; _i98 < _list96.size; ++_i98)
                {
                  _elem97 = new SchoolJob();
                  _elem97.read(iprot);
                  struct.schoolJobs.add(_elem97);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, SchoolJobPagination struct) throws org.apache.thrift.TException {
      ...
      if (struct.schoolJobs != null) {
        oprot.writeFieldBegin(SCHOOL_JOBS_FIELD_DESC);
        {
          ...
          for (SchoolJob _iter99 : struct.schoolJobs)
          {
            _iter99.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.isSetSchoolJobs()) {
        {
          ...
          for (SchoolJob _iter100 : struct.schoolJobs)
          {
      ...
      if (incoming.get(4)) {
        {
          ...
          struct.schoolJobs = new ArrayList<SchoolJob>(_list101.size);
          SchoolJob _elem102;
          for (int _i103 = 0; _i103 < _list101.size; ++_i103)
          {
            _elem102 = new SchoolJob();
            _elem102.read(iprot);
            struct.schoolJobs.add(_elem102);
          }
        }
        struct.setSchoolJobsIsSet(true);
      }
