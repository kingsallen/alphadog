...
public class ThirdPartyAccountInfo implements org.apache.thrift.TBase<ThirdPartyAccountInfo, ThirdPartyAccountInfo._Fields>, java.io.Serializable, Cloneable, Comparable<ThirdPartyAccountInfo> {
  ...
  public String sync_time; // optional
  ...
  private static final _Fields optionals[] = {_Fields.ID,_Fields.BOUND,_Fields.CHANNEL,_Fields.USERNAME,_Fields.EXT,_Fields.REMAIN_PROFILE_NUM,_Fields.REMAIN_NUM,_Fields.SYNC_TIME,_Fields.COMPANY_ID,_Fields.HRS};
  ...
  public ThirdPartyAccountInfo setUsername(String username) {
  ...
  public ThirdPartyAccountInfo setExt(String ext) {
    this.ext = ext;
    return this;
  }
  ...
  public ThirdPartyAccountInfo setSync_time(String sync_time) {
  ...
  public int compareTo(ThirdPartyAccountInfo other) {
    ...
    lastComparison = Boolean.valueOf(isSetBound()).compareTo(other.isSetBound());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetBound()) {
