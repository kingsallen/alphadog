              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.skills = new ArrayList<com.moseeker.thrift.gen.profile.struct.Skill>(_list312.size);
                  com.moseeker.thrift.gen.profile.struct.Skill _elem313;
                  for (int _i314 = 0; _i314 < _list312.size; ++_i314)
                  {
                    _elem313 = new com.moseeker.thrift.gen.profile.struct.Skill();
                    _elem313.read(iprot);
                    struct.skills.add(_elem313);
                  }
                  iprot.readListEnd();
                }
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, postResources_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.skills != null) {
          oprot.writeFieldBegin(SKILLS_FIELD_DESC);
          {
            ...
            for (com.moseeker.thrift.gen.profile.struct.Skill _iter315 : struct.skills)
            {
        ...
        if (struct.isSetSkills()) {
          {
            ...
            for (com.moseeker.thrift.gen.profile.struct.Skill _iter316 : struct.skills)
            {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.skills = new ArrayList<com.moseeker.thrift.gen.profile.struct.Skill>(_list317.size);
            com.moseeker.thrift.gen.profile.struct.Skill _elem318;
            for (int _i319 = 0; _i319 < _list317.size; ++_i319)
            {
              _elem318 = new com.moseeker.thrift.gen.profile.struct.Skill();
              _elem318.read(iprot);
              struct.skills.add(_elem318);
            }
          }
          struct.setSkillsIsSet(true);
        }
    ...
    private static class putResources_argsStandardScheme extends StandardScheme<putResources_args> {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.skills = new ArrayList<com.moseeker.thrift.gen.profile.struct.Skill>(_list320.size);
                  com.moseeker.thrift.gen.profile.struct.Skill _elem321;
                  for (int _i322 = 0; _i322 < _list320.size; ++_i322)
                  {
                    _elem321 = new com.moseeker.thrift.gen.profile.struct.Skill();
                    _elem321.read(iprot);
                    struct.skills.add(_elem321);
                  }
                  iprot.readListEnd();
                }
                struct.setSkillsIsSet(true);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, putResources_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.skills != null) {
          ...
          {
            oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, struct.skills.size()));
            for (com.moseeker.thrift.gen.profile.struct.Skill _iter323 : struct.skills)
            {
    ...
    private static class putResources_argsTupleScheme extends TupleScheme<putResources_args> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, putResources_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.isSetSkills()) {
          {
            oprot.writeI32(struct.skills.size());
            for (com.moseeker.thrift.gen.profile.struct.Skill _iter324 : struct.skills)
            {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.skills = new ArrayList<com.moseeker.thrift.gen.profile.struct.Skill>(_list325.size);
            com.moseeker.thrift.gen.profile.struct.Skill _elem326;
            for (int _i327 = 0; _i327 < _list325.size; ++_i327)
            {
              _elem326 = new com.moseeker.thrift.gen.profile.struct.Skill();
              _elem326.read(iprot);
              struct.skills.add(_elem326);
            }
          }
          struct.setSkillsIsSet(true);
        }
    ...
    private static class delResources_argsStandardScheme extends StandardScheme<delResources_args> {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.skills = new ArrayList<com.moseeker.thrift.gen.profile.struct.Skill>(_list328.size);
                  com.moseeker.thrift.gen.profile.struct.Skill _elem329;
                  for (int _i330 = 0; _i330 < _list328.size; ++_i330)
                  {
                    _elem329 = new com.moseeker.thrift.gen.profile.struct.Skill();
                    _elem329.read(iprot);
                    struct.skills.add(_elem329);
                  }
                  iprot.readListEnd();
                }
                struct.setSkillsIsSet(true);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, delResources_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.skills != null) {
          ...
          {
            oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, struct.skills.size()));
            for (com.moseeker.thrift.gen.profile.struct.Skill _iter331 : struct.skills)
            {
    ...
    private static class delResources_argsTupleScheme extends TupleScheme<delResources_args> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, delResources_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.isSetSkills()) {
          {
            oprot.writeI32(struct.skills.size());
            for (com.moseeker.thrift.gen.profile.struct.Skill _iter332 : struct.skills)
            {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.skills = new ArrayList<com.moseeker.thrift.gen.profile.struct.Skill>(_list333.size);
            com.moseeker.thrift.gen.profile.struct.Skill _elem334;
            for (int _i335 = 0; _i335 < _list333.size; ++_i335)
            {
              _elem334 = new com.moseeker.thrift.gen.profile.struct.Skill();
              _elem334.read(iprot);
              struct.skills.add(_elem334);
            }
          }
          struct.setSkillsIsSet(true);
        }
