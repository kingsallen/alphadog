...
public class UserEmployeeStruct implements org.apache.thrift.TBase<UserEmployeeStruct, UserEmployeeStruct._Fields>, java.io.Serializable, Cloneable, Comparable<UserEmployeeStruct> {
  ...
  static {
    schemes.put(StandardScheme.class, new UserEmployeeStructStandardSchemeFactory());
    schemes.put(TupleScheme.class, new UserEmployeeStructTupleSchemeFactory());
  }
  ...
  public void unsetSection_id() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __SECTION_ID_ISSET_ID);
  }

  /** Returns true if field section_id is set (has been assigned a value) and false otherwise */
  public boolean isSetSection_id() {
    return EncodingUtils.testBit(__isset_bitfield, __SECTION_ID_ISSET_ID);
  }

  public void setSection_idIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __SECTION_ID_ISSET_ID, value);
  }
  ...
  public int hashCode() {
    ...
    boolean present_section_id = true && (isSetSection_id());
    list.add(present_section_id);
    if (present_section_id)
      list.add(section_id);

    boolean present_custom_field = true && (isSetCustom_field());
    list.add(present_custom_field);
    if (present_custom_field)
  ...
  private static class UserEmployeeStructStandardSchemeFactory implements SchemeFactory {
    public UserEmployeeStructStandardScheme getScheme() {
      return new UserEmployeeStructStandardScheme();
    }
  }

  private static class UserEmployeeStructStandardScheme extends StandardScheme<UserEmployeeStruct> {
  ...
  private static class UserEmployeeStructTupleSchemeFactory implements SchemeFactory {
    public UserEmployeeStructTupleScheme getScheme() {
      return new UserEmployeeStructTupleScheme();
    }
  }

  private static class UserEmployeeStructTupleScheme extends TupleScheme<UserEmployeeStruct> {
