            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.educationExts = new ArrayList<EducationExt>(_list32.size);
                EducationExt _elem33;
                for (int _i34 = 0; _i34 < _list32.size; ++_i34)
                {
                  _elem33 = new EducationExt();
                  _elem33.read(iprot);
                  struct.educationExts.add(_elem33);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, EducationExtPagination struct) throws org.apache.thrift.TException {
      ...
      if (struct.educationExts != null) {
        oprot.writeFieldBegin(EDUCATION_EXTS_FIELD_DESC);
        {
          ...
          for (EducationExt _iter35 : struct.educationExts)
          {
            _iter35.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.isSetEducationExts()) {
        {
          ...
          for (EducationExt _iter36 : struct.educationExts)
          {
            _iter36.write(oprot);
          }
        }
      ...
      if (incoming.get(4)) {
        {
          ...
          struct.educationExts = new ArrayList<EducationExt>(_list37.size);
          EducationExt _elem38;
          for (int _i39 = 0; _i39 < _list37.size; ++_i39)
          {
            _elem38 = new EducationExt();
            _elem38.read(iprot);
            struct.educationExts.add(_elem38);
          }
        }
        struct.setEducationExtsIsSet(true);
      }
