...
@javax.annotation.Generated(value = "Autogenerated by Thrift Compiler (0.10.0)", date = "2019-01-03")
public class RadarUserInfo implements org.apache.thrift.TBase<RadarUserInfo, RadarUserInfo._Fields>, java.io.Serializable, Cloneable, Comparable<RadarUserInfo> {
    ...
    private static final _Fields optionals[] = {_Fields.USER_ID,_Fields.NICKNAME,_Fields.VIEW_COUNT,_Fields.SEEK_RECOMMEND,_Fields.DEPTH,_Fields.HEADIMGURL,_Fields.POSITION_TITLE,_Fields.POSITION_ID,_Fields.FORWARD_NAME,_Fields.FORWARD_SOURCE_WX,_Fields.REFERRAL_ID,_Fields.CLICK_TIME};
        ...
        switch (field) {
            ...
            case SEEK_RECOMMEND:
                if (value == null) {
                    ...
                    setSeekRecommend((java.lang.Integer)value);
                }
                break;
