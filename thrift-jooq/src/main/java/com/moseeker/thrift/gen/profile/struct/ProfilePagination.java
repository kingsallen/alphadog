            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.profiles = new ArrayList<Profile>(_list0.size);
                Profile _elem1;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ProfilePagination struct) throws org.apache.thrift.TException {
      ...
      if (struct.profiles != null) {
        oprot.writeFieldBegin(PROFILES_FIELD_DESC);
        {
          ...
          for (Profile _iter3 : struct.profiles)
          {
            _iter3.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.isSetProfiles()) {
        {
          ...
          for (Profile _iter4 : struct.profiles)
          {
            _iter4.write(oprot);
          }
        }
      ...
      if (incoming.get(4)) {
        {
          ...
          struct.profiles = new ArrayList<Profile>(_list5.size);
          Profile _elem6;
