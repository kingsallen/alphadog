...
public class OrderService {
  ...
  public interface Iface {
    ...
    public String getEmployeeOrderList(int employeeId) throws com.moseeker.thrift.gen.common.struct.BIZException, org.apache.thrift.TException;
    ...
    public void updateOrder(java.util.List<Integer> ids, int companyId, int state) throws com.moseeker.thrift.gen.common.struct.BIZException, org.apache.thrift.TException;
  ...
  public interface AsyncIface {
    ...
    public void getEmployeeOrderList(int employeeId, org.apache.thrift.async.AsyncMethodCallback<String> resultHandler) throws org.apache.thrift.TException;
    ...
    public void updateOrder(java.util.List<Integer> ids, int companyId, int state, org.apache.thrift.async.AsyncMethodCallback<Void> resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public String getEmployeeOrderList(int employeeId) throws com.moseeker.thrift.gen.common.struct.BIZException, org.apache.thrift.TException
    {
      send_getEmployeeOrderList(employeeId);
      return recv_getEmployeeOrderList();
    }

    public void send_getEmployeeOrderList(int employeeId) throws org.apache.thrift.TException
    {
    ...
    public void updateOrder(java.util.List<Integer> ids, int companyId, int state) throws com.moseeker.thrift.gen.common.struct.BIZException, org.apache.thrift.TException
    {
      send_updateOrder(ids, companyId, state);
      recv_updateOrder();
    }

    public void send_updateOrder(java.util.List<Integer> ids, int companyId, int state) throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public void getEmployeeOrderList(int employeeId, org.apache.thrift.async.AsyncMethodCallback<String> resultHandler) throws org.apache.thrift.TException {
      checkReady();
      getEmployeeOrderList_call method_call = new getEmployeeOrderList_call(employeeId, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }
    ...
    public static class getEmployeeOrderList_call extends org.apache.thrift.async.TAsyncMethodCall<String> {
      ...
      public getEmployeeOrderList_call(int employeeId, org.apache.thrift.async.AsyncMethodCallback<String> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
    ...
    public void updateOrder(java.util.List<Integer> ids, int companyId, int state, org.apache.thrift.async.AsyncMethodCallback<Void> resultHandler) throws org.apache.thrift.TException {
      checkReady();
      updateOrder_call method_call = new updateOrder_call(ids, companyId, state, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }
    ...
    public static class updateOrder_call extends org.apache.thrift.async.TAsyncMethodCall<Void> {
      ...
      private int state;
      public updateOrder_call(java.util.List<Integer> ids, int companyId, int state, org.apache.thrift.async.AsyncMethodCallback<Void> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.ids = ids;
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class getEmployeeOrderList<I extends Iface> extends org.apache.thrift.ProcessFunction<I, getEmployeeOrderList_args> {
      ...
      public getEmployeeOrderList_result getResult(I iface, getEmployeeOrderList_args args) throws org.apache.thrift.TException {
        getEmployeeOrderList_result result = new getEmployeeOrderList_result();
        try {
          result.success = iface.getEmployeeOrderList(args.employeeId);
        } catch (com.moseeker.thrift.gen.common.struct.BIZException e) {
          result.e = e;
        }
        return result;
    ...
    public static class updateOrder<I extends Iface> extends org.apache.thrift.ProcessFunction<I, updateOrder_args> {
      ...
      public updateOrder_result getResult(I iface, updateOrder_args args) throws org.apache.thrift.TException {
        updateOrder_result result = new updateOrder_result();
        try {
          iface.updateOrder(args.ids, args.companyId, args.state);
        } catch (com.moseeker.thrift.gen.common.struct.BIZException e) {
          result.e = e;
        }
        return result;
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class getEmployeeOrderList<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, getEmployeeOrderList_args, String> {
      ...
      public void start(I iface, getEmployeeOrderList_args args, org.apache.thrift.async.AsyncMethodCallback<String> resultHandler) throws org.apache.thrift.TException {
        iface.getEmployeeOrderList(args.employeeId,resultHandler);
      }
    }
    ...
    public static class updateOrder<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, updateOrder_args, Void> {
      ...
      public void start(I iface, updateOrder_args args, org.apache.thrift.async.AsyncMethodCallback<Void> resultHandler) throws org.apache.thrift.TException {
        iface.updateOrder(args.ids, args.companyId, args.state,resultHandler);
      }
    }
  ...
  public static class getEmployeeOrderList_args implements org.apache.thrift.TBase<getEmployeeOrderList_args, getEmployeeOrderList_args._Fields>, java.io.Serializable, Cloneable, Comparable<getEmployeeOrderList_args>   {
    ...
    public getEmployeeOrderList_args setEmployeeId(int employeeId) {
      this.employeeId = employeeId;
      setEmployeeIdIsSet(true);
      return this;
    }
  ...
  public static class updateOrder_args implements org.apache.thrift.TBase<updateOrder_args, updateOrder_args._Fields>, java.io.Serializable, Cloneable, Comparable<updateOrder_args>   {
    ...
    public updateOrder_args setIds(java.util.List<Integer> ids) {
      this.ids = ids;
      return this;
    }
    ...
    public updateOrder_args setCompanyId(int companyId) {
      this.companyId = companyId;
      setCompanyIdIsSet(true);
      return this;
    }
    ...
    public updateOrder_args setState(int state) {
      this.state = state;
      setStateIsSet(true);
      return this;
    }
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.ids = new java.util.ArrayList<Integer>(_list10.size);
                  int _elem11;
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.ids = new java.util.ArrayList<Integer>(_list15.size);
            int _elem16;
            for (int _i17 = 0; _i17 < _list15.size; ++_i17)
            {
              _elem16 = iprot.readI32();
              struct.ids.add(_elem16);
            }
          }
          struct.setIdsIsSet(true);
        }
