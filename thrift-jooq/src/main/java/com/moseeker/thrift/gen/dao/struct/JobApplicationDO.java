...
public class JobApplicationDO implements org.apache.thrift.TBase<JobApplicationDO, JobApplicationDO._Fields>, java.io.Serializable, Cloneable, Comparable<JobApplicationDO> {
  ...
  public JobApplicationDO setRecommendUserId(int recommendUserId) {
  ...
  public JobApplicationDO setIsViewed(int isViewed) {
  ...
  public JobApplicationDO setNotSuitable(int notSuitable) {
  ...
  public JobApplicationDO setApplyType(byte applyType) {
  ...
  public JobApplicationDO setEmailStatus(byte emailStatus) {
