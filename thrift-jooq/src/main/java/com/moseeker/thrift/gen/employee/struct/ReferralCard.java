...
public class ReferralCard implements org.apache.thrift.TBase<ReferralCard, ReferralCard._Fields>, java.io.Serializable, Cloneable, Comparable<ReferralCard> {
  ...
  private static final org.apache.thrift.protocol.TField CLAIM_FIELD_DESC = new org.apache.thrift.protocol.TField("claim", org.apache.thrift.protocol.TType.BOOL, (short)8);
  ...
  private static final int __CLAIM_ISSET_ID = 1;
  private static final int __EMPLOYEEID_ISSET_ID = 2;
  private byte __isset_bitfield = 0;
  private static final _Fields optionals[] = {_Fields.USER_NAME,_Fields.EMPLOYEE_NAME,_Fields.COMPANY_NAME,_Fields.COMPANY_ABBREVIATION,_Fields.POSITION,_Fields.MOBILE,_Fields.APPLY_ID,_Fields.CLAIM,_Fields.EMPLOYEE_ID};
  ...
  public ReferralCard setClaim(boolean claim) {
    this.claim = claim;
    setClaimIsSet(true);
    return this;
  }
  ...
  public void unsetClaim() {
    __isset_bitfield = org.apache.thrift.EncodingUtils.clearBit(__isset_bitfield, __CLAIM_ISSET_ID);
  }

  /** Returns true if field claim is set (has been assigned a value) and false otherwise */
  public boolean isSetClaim() {
    return org.apache.thrift.EncodingUtils.testBit(__isset_bitfield, __CLAIM_ISSET_ID);
  }

  public void setClaimIsSet(boolean value) {
    __isset_bitfield = org.apache.thrift.EncodingUtils.setBit(__isset_bitfield, __CLAIM_ISSET_ID, value);
  }
  ...
  public ReferralCard setEmployeeId(int employeeId) {
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case CLAIM:
      if (value == null) {
        ...
        setClaim((java.lang.Boolean)value);
      }
      break;
  ...
  public boolean equals(ReferralCard that) {
    ...
    boolean this_present_claim = true && this.isSetClaim();
    boolean that_present_claim = true && that.isSetClaim();
    if (this_present_claim || that_present_claim) {
      if (!(this_present_claim && that_present_claim))
        return false;
      if (this.claim != that.claim)
        return false;
    }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetClaim()) ? 131071 : 524287);
    if (isSetClaim())
      hashCode = hashCode * 8191 + ((claim) ? 131071 : 524287);
  ...
  public int compareTo(ReferralCard other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetClaim()).compareTo(other.isSetClaim());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetClaim()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.claim, other.claim);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  private static class ReferralCardStandardScheme extends org.apache.thrift.scheme.StandardScheme<ReferralCard> {
        ...
        switch (schemeField.id) {
          ...
          case 8: // CLAIM
            if (schemeField.type == org.apache.thrift.protocol.TType.BOOL) {
              struct.claim = iprot.readBool();
              struct.setClaimIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ReferralCard struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetClaim()) {
        oprot.writeFieldBegin(CLAIM_FIELD_DESC);
        oprot.writeBool(struct.claim);
        oprot.writeFieldEnd();
      }
