...
public class TalentPoolProfileMoveDetailDO implements org.apache.thrift.TBase<TalentPoolProfileMoveDetailDO, TalentPoolProfileMoveDetailDO._Fields>, java.io.Serializable, Cloneable, Comparable<TalentPoolProfileMoveDetailDO> {
  ...
  private static final org.apache.thrift.protocol.TField PROFILE_MOVE_ID_FIELD_DESC = new org.apache.thrift.protocol.TField("profile_move_id", org.apache.thrift.protocol.TType.I32, (short)3);
  private static final org.apache.thrift.protocol.TField PROFILE_MOVE_STATUS_FIELD_DESC = new org.apache.thrift.protocol.TField("profile_move_status", org.apache.thrift.protocol.TType.BYTE, (short)4);
  ...
  public int profile_move_id; // optional
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    PROFILE_MOVE_ID((short)3, "profile_move_id"),
    PROFILE_MOVE_STATUS((short)4, "profile_move_status"),
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        ...
        case 2: // MOBILE
          return MOBILE;
        case 3: // PROFILE_MOVE_ID
          return PROFILE_MOVE_ID;
        case 4: // PROFILE_MOVE_STATUS
  ...
  private static final int __PROFILE_MOVE_ID_ISSET_ID = 2;
  private static final int __PROFILE_MOVE_STATUS_ISSET_ID = 3;
  private byte __isset_bitfield = 0;
  private static final _Fields optionals[] = {_Fields.ID,_Fields.MOBILE,_Fields.PROFILE_MOVE_ID,_Fields.PROFILE_MOVE_STATUS,_Fields.CREATE_TIME,_Fields.UPDATE_TIME};
  ...
  static {
    ...
    tmpMap.put(_Fields.PROFILE_MOVE_ID, new org.apache.thrift.meta_data.FieldMetaData("profile_move_id", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I32)));
  ...
  public TalentPoolProfileMoveDetailDO(TalentPoolProfileMoveDetailDO other) {
    ...
    this.profile_move_id = other.profile_move_id;
  ...
  public void clear() {
    ...
    this.mobile = 0;
    setProfile_move_idIsSet(false);
    this.profile_move_id = 0;
  ...
  public int getProfile_move_id() {
    return this.profile_move_id;
  }

  public TalentPoolProfileMoveDetailDO setProfile_move_id(int profile_move_id) {
    this.profile_move_id = profile_move_id;
    setProfile_move_idIsSet(true);
    return this;
  }

  public void unsetProfile_move_id() {
    __isset_bitfield = org.apache.thrift.EncodingUtils.clearBit(__isset_bitfield, __PROFILE_MOVE_ID_ISSET_ID);
  }

  /** Returns true if field profile_move_id is set (has been assigned a value) and false otherwise */
  public boolean isSetProfile_move_id() {
    return org.apache.thrift.EncodingUtils.testBit(__isset_bitfield, __PROFILE_MOVE_ID_ISSET_ID);
  }

  public void setProfile_move_idIsSet(boolean value) {
    __isset_bitfield = org.apache.thrift.EncodingUtils.setBit(__isset_bitfield, __PROFILE_MOVE_ID_ISSET_ID, value);
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case PROFILE_MOVE_ID:
      if (value == null) {
        unsetProfile_move_id();
      } else {
        setProfile_move_id((Integer)value);
      }
      break;
  ...
  public boolean equals(TalentPoolProfileMoveDetailDO that) {
    ...
    boolean this_present_profile_move_id = true && this.isSetProfile_move_id();
    boolean that_present_profile_move_id = true && that.isSetProfile_move_id();
    if (this_present_profile_move_id || that_present_profile_move_id) {
      if (!(this_present_profile_move_id && that_present_profile_move_id))
        return false;
      if (this.profile_move_id != that.profile_move_id)
        return false;
    }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetProfile_move_id()) ? 131071 : 524287);
    if (isSetProfile_move_id())
      hashCode = hashCode * 8191 + profile_move_id;
  ...
  public int compareTo(TalentPoolProfileMoveDetailDO other) {
    ...
    lastComparison = Boolean.valueOf(isSetProfile_move_id()).compareTo(other.isSetProfile_move_id());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetProfile_move_id()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.profile_move_id, other.profile_move_id);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    ...
    if (isSetProfile_move_id()) {
      if (!first) sb.append(", ");
      sb.append("profile_move_id:");
      sb.append(this.profile_move_id);
      first = false;
    }
    if (isSetProfile_move_status()) {
      if (!first) sb.append(", ");
  ...
  private static class TalentPoolProfileMoveDetailDOStandardScheme extends org.apache.thrift.scheme.StandardScheme<TalentPoolProfileMoveDetailDO> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, TalentPoolProfileMoveDetailDO struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 3: // PROFILE_MOVE_ID
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.profile_move_id = iprot.readI32();
              struct.setProfile_move_idIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TalentPoolProfileMoveDetailDO struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetProfile_move_id()) {
        oprot.writeFieldBegin(PROFILE_MOVE_ID_FIELD_DESC);
        oprot.writeI32(struct.profile_move_id);
        oprot.writeFieldEnd();
      }
