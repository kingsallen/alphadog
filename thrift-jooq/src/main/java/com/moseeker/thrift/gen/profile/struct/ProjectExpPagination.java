            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.projectExps = new ArrayList<ProjectExp>(_list80.size);
                ProjectExp _elem81;
                for (int _i82 = 0; _i82 < _list80.size; ++_i82)
                {
                  _elem81 = new ProjectExp();
                  _elem81.read(iprot);
                  struct.projectExps.add(_elem81);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ProjectExpPagination struct) throws org.apache.thrift.TException {
      ...
      if (struct.projectExps != null) {
        oprot.writeFieldBegin(PROJECT_EXPS_FIELD_DESC);
        {
          ...
          for (ProjectExp _iter83 : struct.projectExps)
          {
            _iter83.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.isSetProjectExps()) {
        {
          ...
          for (ProjectExp _iter84 : struct.projectExps)
          {
            _iter84.write(oprot);
          }
        }
      ...
      if (incoming.get(4)) {
        {
          ...
          struct.projectExps = new ArrayList<ProjectExp>(_list85.size);
          ProjectExp _elem86;
          for (int _i87 = 0; _i87 < _list85.size; ++_i87)
          {
            _elem86 = new ProjectExp();
            _elem86.read(iprot);
            struct.projectExps.add(_elem86);
          }
        }
        struct.setProjectExpsIsSet(true);
      }
