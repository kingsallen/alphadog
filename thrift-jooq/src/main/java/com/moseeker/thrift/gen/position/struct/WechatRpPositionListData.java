...
public class WechatRpPositionListData implements org.apache.thrift.TBase<WechatRpPositionListData, WechatRpPositionListData._Fields>, java.io.Serializable, Cloneable, Comparable<WechatRpPositionListData> {
  ...
  private static final _Fields optionals[] = {_Fields.ID,_Fields.TITLE,_Fields.FIXED,_Fields.SALARY_TOP,_Fields.SALARY_BOTTOM,_Fields.PUBLISH_DATE,_Fields.DEPARTMENT,_Fields.VISITNUM,_Fields.IN_HB,_Fields.COUNT,_Fields.COMPANY_ABBR,_Fields.COMPANY_LOGO,_Fields.COMPANY_NAME,_Fields.IS_NEW,_Fields.REMAIN,_Fields.EMPLOYEE_ONLY,_Fields.CITY,_Fields.CANDIDATE_SOURCE,_Fields.REQUIREMENT,_Fields.TOTAL_NUM,_Fields.CITY_ENAME,_Fields.IS_REFERRAL};
  ...
  public WechatRpPositionListData setTitle(String title) {
    this.title = title;
    return this;
  }
  ...
  public WechatRpPositionListData setPublish_date(String publish_date) {
  ...
  public WechatRpPositionListData setDepartment(String department) {
  ...
  public WechatRpPositionListData setCompany_abbr(String company_abbr) {
  ...
  public WechatRpPositionListData setCompany_logo(String company_logo) {
  ...
  public WechatRpPositionListData setCompany_name(String company_name) {
  ...
  public WechatRpPositionListData setCity(String city) {
    this.city = city;
    return this;
  }
  ...
  public WechatRpPositionListData setRequirement(String requirement) {
  ...
  public WechatRpPositionListData setCity_ename(String city_ename) {
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case EMPLOYEE_ONLY:
      if (value == null) {
        ...
        setEmployee_only((Boolean)value);
      }
      break;
  ...
  public int compareTo(WechatRpPositionListData other) {
    ...
    lastComparison = Boolean.valueOf(isSetFixed()).compareTo(other.isSetFixed());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetFixed()) {
    ...
    lastComparison = Boolean.valueOf(isSetEmployee_only()).compareTo(other.isSetEmployee_only());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetEmployee_only()) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("WechatRpPositionListData(");
    boolean first = true;
