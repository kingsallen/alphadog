...
public class ChatsVO implements org.apache.thrift.TBase<ChatsVO, ChatsVO._Fields>, java.io.Serializable, Cloneable, Comparable<ChatsVO> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("ChatsVO");
  ...
  private static final org.apache.thrift.protocol.TField CHAT_LOGS_FIELD_DESC = new org.apache.thrift.protocol.TField("chatLogs", org.apache.thrift.protocol.TType.LIST, (short)5);

  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new ChatsVOStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new ChatsVOTupleSchemeFactory();

  public int pageNo; // optional
  public int pageSize; // optional
  public int totalPage; // optional
  public int totalRow; // optional
  public java.util.List<ChatVO> chatLogs; // optional
  ...
  private static final _Fields optionals[] = {_Fields.PAGE_NO,_Fields.PAGE_SIZE,_Fields.TOTAL_PAGE,_Fields.TOTAL_ROW,_Fields.CHAT_LOGS};
  ...
  static {
    ...
    tmpMap.put(_Fields.TOTAL_ROW, new org.apache.thrift.meta_data.FieldMetaData("totalRow", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I32)));
    tmpMap.put(_Fields.CHAT_LOGS, new org.apache.thrift.meta_data.FieldMetaData("chatLogs", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(ChatsVO.class, metaDataMap);
  }
   ...
   */
  public ChatsVO(ChatsVO other) {
    __isset_bitfield = other.__isset_bitfield;
    this.pageNo = other.pageNo;
    this.pageSize = other.pageSize;
    this.totalPage = other.totalPage;
    this.totalRow = other.totalRow;
    if (other.isSetChatLogs()) {
      java.util.List<ChatVO> __this__chatLogs = new java.util.ArrayList<ChatVO>(other.chatLogs.size());
      for (ChatVO other_element : other.chatLogs) {
        __this__chatLogs.add(new ChatVO(other_element));
      }
      this.chatLogs = __this__chatLogs;
    }
  }

  public ChatsVO deepCopy() {
    return new ChatsVO(this);
  }
  ...
  public ChatsVO setPageNo(int pageNo) {
    this.pageNo = pageNo;
    setPageNoIsSet(true);
    return this;
  }
  ...
  public ChatsVO setPageSize(int pageSize) {
  ...
  public ChatsVO setTotalPage(int totalPage) {
  ...
  public ChatsVO setTotalRow(int totalRow) {
  ...
  public int getChatLogsSize() {
    return (this.chatLogs == null) ? 0 : this.chatLogs.size();
  }

  public java.util.Iterator<ChatVO> getChatLogsIterator() {
    return (this.chatLogs == null) ? null : this.chatLogs.iterator();
  }

  public void addToChatLogs(ChatVO elem) {
    if (this.chatLogs == null) {
      this.chatLogs = new java.util.ArrayList<ChatVO>();
    }
    this.chatLogs.add(elem);
  }

  public java.util.List<ChatVO> getChatLogs() {
    return this.chatLogs;
  }

  public ChatsVO setChatLogs(java.util.List<ChatVO> chatLogs) {
    this.chatLogs = chatLogs;
    return this;
  }

  public void unsetChatLogs() {
    this.chatLogs = null;
  }

  /** Returns true if field chatLogs is set (has been assigned a value) and false otherwise */
  public boolean isSetChatLogs() {
    return this.chatLogs != null;
  }

  public void setChatLogsIsSet(boolean value) {
    if (!value) {
      this.chatLogs = null;
    }
  }
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case CHAT_LOGS:
      if (value == null) {
        ...
        setChatLogs((java.util.List<ChatVO>)value);
      }
      break;
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof ChatsVO)
      return this.equals((ChatsVO)that);
    return false;
  }

  public boolean equals(ChatsVO that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
    ...
    boolean this_present_chatLogs = true && this.isSetChatLogs();
    boolean that_present_chatLogs = true && that.isSetChatLogs();
    if (this_present_chatLogs || that_present_chatLogs) {
      if (!(this_present_chatLogs && that_present_chatLogs))
        return false;
      if (!this.chatLogs.equals(that.chatLogs))
        return false;
    }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetChatLogs()) ? 131071 : 524287);
    if (isSetChatLogs())
      hashCode = hashCode * 8191 + chatLogs.hashCode();

    return hashCode;
  }

  @Override
  public int compareTo(ChatsVO other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetChatLogs()).compareTo(other.isSetChatLogs());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetChatLogs()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.chatLogs, other.chatLogs);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("ChatsVO(");
    boolean first = true;
  ...
  private static class ChatsVOStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public ChatsVOStandardScheme getScheme() {
      return new ChatsVOStandardScheme();
    }
  }

  private static class ChatsVOStandardScheme extends org.apache.thrift.scheme.StandardScheme<ChatsVO> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, ChatsVO struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.chatLogs = new java.util.ArrayList<ChatVO>(_list16.size);
                ChatVO _elem17;
                for (int _i18 = 0; _i18 < _list16.size; ++_i18)
                {
                  _elem17 = new ChatVO();
                  _elem17.read(iprot);
                  struct.chatLogs.add(_elem17);
                }
                iprot.readListEnd();
              }
              struct.setChatLogsIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ChatsVO struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.chatLogs != null) {
        if (struct.isSetChatLogs()) {
          oprot.writeFieldBegin(CHAT_LOGS_FIELD_DESC);
          {
            oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, struct.chatLogs.size()));
            for (ChatVO _iter19 : struct.chatLogs)
            {
              _iter19.write(oprot);
            }
            oprot.writeListEnd();
  ...
  private static class ChatsVOTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public ChatsVOTupleScheme getScheme() {
      return new ChatsVOTupleScheme();
    }
  }

  private static class ChatsVOTupleScheme extends org.apache.thrift.scheme.TupleScheme<ChatsVO> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, ChatsVO struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetChatLogs()) {
        {
          oprot.writeI32(struct.chatLogs.size());
          for (ChatVO _iter20 : struct.chatLogs)
          {
            _iter20.write(oprot);
          }
        }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, ChatsVO struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(4)) {
        {
          ...
          struct.chatLogs = new java.util.ArrayList<ChatVO>(_list21.size);
          ChatVO _elem22;
          for (int _i23 = 0; _i23 < _list21.size; ++_i23)
          {
            _elem22 = new ChatVO();
            _elem22.read(iprot);
            struct.chatLogs.add(_elem22);
          }
        }
        struct.setChatLogsIsSet(true);
      }
