...
@javax.annotation.Generated(value = "Autogenerated by Thrift Compiler (0.10.0)", date = "2018-04-11")
public class TalentpoolProfileFilterDO implements org.apache.thrift.TBase<TalentpoolProfileFilterDO, TalentpoolProfileFilterDO._Fields>, java.io.Serializable, Cloneable, Comparable<TalentpoolProfileFilterDO> {
  ...
  public String origins; // optional
  public String work_years; // optional
  public String submit_time; // optional
  public String city_name; // optional
  public String city_code; // optional
  public String degree; // optional
  public String past_position; // optional
  public int in_last_job_search_position; // optional
  public int min_age; // optional
  public int max_age; // optional
  public String intention_city_name; // optional
  public String intention_city_code; // optional
  public String intention_salary_code; // optional
  ...
  public TalentpoolProfileFilterDO setName(String name) {
    this.name = name;
    return this;
  }
  ...
  public TalentpoolProfileFilterDO setOrigins(String origins) {
  ...
  public TalentpoolProfileFilterDO setWork_years(String work_years) {
  ...
  public TalentpoolProfileFilterDO setSubmit_time(String submit_time) {
  ...
  public TalentpoolProfileFilterDO setCity_name(String city_name) {
  ...
  public TalentpoolProfileFilterDO setCity_code(String city_code) {
  ...
  public TalentpoolProfileFilterDO setDegree(String degree) {
    this.degree = degree;
    return this;
  }
  ...
  public TalentpoolProfileFilterDO setPast_position(String past_position) {
  ...
  public TalentpoolProfileFilterDO setIntention_city_name(String intention_city_name) {
  ...
  public TalentpoolProfileFilterDO setIntention_city_code(String intention_city_code) {
  ...
  public TalentpoolProfileFilterDO setIntention_salary_code(String intention_salary_code) {
  ...
  public TalentpoolProfileFilterDO setCompany_name(String company_name) {
  ...
  public TalentpoolProfileFilterDO setCreate_time(String create_time) {
  ...
  public TalentpoolProfileFilterDO setUpdate_time(String update_time) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("TalentpoolProfileFilterDO(");
    boolean first = true;
