      ...
      if (struct.equalFilter != null) {
        if (struct.isSetEqualFilter()) {
          oprot.writeFieldBegin(EQUAL_FILTER_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter4 : struct.equalFilter.entrySet())
            {
      ...
      if (struct.isSetEqualFilter()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter5 : struct.equalFilter.entrySet())
          {
      ...
      if (incoming.get(7)) {
        {
          ...
          struct.equalFilter = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map6.size);
