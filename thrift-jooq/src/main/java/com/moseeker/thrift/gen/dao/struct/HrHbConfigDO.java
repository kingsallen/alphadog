...
public class HrHbConfigDO implements org.apache.thrift.TBase<HrHbConfigDO, HrHbConfigDO._Fields>, java.io.Serializable, Cloneable, Comparable<HrHbConfigDO> {
  ...
  public HrHbConfigDO setType(int type) {
    this.type = type;
    setTypeIsSet(true);
    return this;
  }
  ...
  public HrHbConfigDO setTarget(int target) {
    this.target = target;
    setTargetIsSet(true);
    return this;
  }
  ...
  public HrHbConfigDO setCompany_id(int company_id) {
  ...
  public HrHbConfigDO setStart_time(java.lang.String start_time) {
  ...
  public HrHbConfigDO setEnd_time(java.lang.String end_time) {
  ...
  public HrHbConfigDO setTotal_amount(int total_amount) {
  ...
  public HrHbConfigDO setRange_min(double range_min) {
  ...
  public HrHbConfigDO setRange_max(double range_max) {
  ...
  public HrHbConfigDO setProbability(int probability) {
  ...
  public HrHbConfigDO setD_type(int d_type) {
    this.d_type = d_type;
    setD_typeIsSet(true);
    return this;
  }
  ...
  public HrHbConfigDO setHeadline_failure(java.lang.String headline_failure) {
  ...
  public HrHbConfigDO setShare_title(java.lang.String share_title) {
  ...
  public HrHbConfigDO setShare_desc(java.lang.String share_desc) {
  ...
  public HrHbConfigDO setShare_img(java.lang.String share_img) {
  ...
  public HrHbConfigDO setStatus(int status) {
    this.status = status;
    setStatusIsSet(true);
    return this;
  }
  ...
  public HrHbConfigDO setChecked(int checked) {
  ...
  public HrHbConfigDO setEstimated_total(int estimated_total) {
  ...
  public HrHbConfigDO setCreate_time(java.lang.String create_time) {
  ...
  public HrHbConfigDO setUpdate_time(java.lang.String update_time) {
  ...
  public HrHbConfigDO setActual_total(int actual_total) {
  ...
  private static class HrHbConfigPojoStandardScheme extends org.apache.thrift.scheme.StandardScheme<HrHbConfigDO> {
  ...
  private static class HrHbConfigPojoTupleScheme extends org.apache.thrift.scheme.TupleScheme<HrHbConfigDO> {
