...
public class ProfileOtherDO implements org.apache.thrift.TBase<ProfileOtherDO, ProfileOtherDO._Fields>, java.io.Serializable, Cloneable, Comparable<ProfileOtherDO> {
  ...
  public ProfileOtherDO setProfileId(int profileId) {
  ...
  public ProfileOtherDO setOther(String other) {
    this.other = other;
    return this;
  }
  ...
  public ProfileOtherDO setCreateTime(String createTime) {
  ...
  public ProfileOtherDO setUpdateTime(String updateTime) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("ProfileOtherDO(");
    boolean first = true;
