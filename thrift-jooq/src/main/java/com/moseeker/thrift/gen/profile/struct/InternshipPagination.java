            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.internships = new ArrayList<Internship>(_list64.size);
                Internship _elem65;
                for (int _i66 = 0; _i66 < _list64.size; ++_i66)
                {
                  _elem65 = new Internship();
                  _elem65.read(iprot);
                  struct.internships.add(_elem65);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, InternshipPagination struct) throws org.apache.thrift.TException {
      ...
      if (struct.internships != null) {
        oprot.writeFieldBegin(INTERNSHIPS_FIELD_DESC);
        {
          ...
          for (Internship _iter67 : struct.internships)
          {
            _iter67.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.isSetInternships()) {
        {
          ...
          for (Internship _iter68 : struct.internships)
          {
            _iter68.write(oprot);
          }
        }
      ...
      if (incoming.get(4)) {
        {
          ...
          struct.internships = new ArrayList<Internship>(_list69.size);
          Internship _elem70;
          for (int _i71 = 0; _i71 < _list69.size; ++_i71)
          {
            _elem70 = new Internship();
            _elem70.read(iprot);
            struct.internships.add(_elem70);
          }
        }
        struct.setInternshipsIsSet(true);
      }
