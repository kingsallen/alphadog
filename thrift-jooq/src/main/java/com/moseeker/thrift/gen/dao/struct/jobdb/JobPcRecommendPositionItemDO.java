...
public class JobPcRecommendPositionItemDO implements org.apache.thrift.TBase<JobPcRecommendPositionItemDO, JobPcRecommendPositionItemDO._Fields>, java.io.Serializable, Cloneable, Comparable<JobPcRecommendPositionItemDO> {
  ...
  private static final _Fields optionals[] = {_Fields.ID,_Fields.MODULE_ID,_Fields.POSITION_ID,_Fields.CREATE_TIME,_Fields.UPDATE_TIME,_Fields.STATUS};
  ...
  public JobPcRecommendPositionItemDO setStatus(byte status) {
    this.status = status;
    setStatusIsSet(true);
    return this;
  }
