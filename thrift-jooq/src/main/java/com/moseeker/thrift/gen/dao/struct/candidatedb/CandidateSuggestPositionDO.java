...
public class CandidateSuggestPositionDO implements org.apache.thrift.TBase<CandidateSuggestPositionDO, CandidateSuggestPositionDO._Fields>, java.io.Serializable, Cloneable, Comparable<CandidateSuggestPositionDO> {
  ...
  private static final _Fields optionals[] = {_Fields.ID,_Fields.HRACCOUNT_ID,_Fields.POSITION_ID,_Fields.WXUSER_ID,_Fields.CREATE_TIME,_Fields.UPDATE_TIME,_Fields.DISABLE,_Fields.USER_ID};
  ...
  public CandidateSuggestPositionDO setWxuserId(int wxuserId) {
  ...
  public CandidateSuggestPositionDO setCreateTime(String createTime) {
  ...
  public CandidateSuggestPositionDO setUpdateTime(String updateTime) {
  ...
  public CandidateSuggestPositionDO setDisable(int disable) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("CandidateSuggestPositionDO(");
    boolean first = true;
