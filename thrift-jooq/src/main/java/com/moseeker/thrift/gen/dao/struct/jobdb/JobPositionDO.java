...
public class JobPositionDO implements org.apache.thrift.TBase<JobPositionDO, JobPositionDO._Fields>, java.io.Serializable, Cloneable, Comparable<JobPositionDO> {
    ...
    private static final org.apache.thrift.protocol.TField PROFILE_TOHR_MAIL_ENABLED_FIELD_DESC = new org.apache.thrift.protocol.TField("profile_tohr_mail_enabled", org.apache.thrift.protocol.TType.BYTE, (short)66);
    ...
    public byte profile_tohr_mail_enabled; // optional
    ...
    public enum _Fields implements org.apache.thrift.TFieldIdEnum {
        ...
        PROFILE_TOHR_MAIL_ENABLED((short)66, "profile_tohr_mail_enabled");
        ...
        public static _Fields findByThriftId(int fieldId) {
            switch(fieldId) {
                ...
                case 66: // PROFILE_TOHR_MAIL_ENABLED
                    return PROFILE_TOHR_MAIL_ENABLED;
                default:
                    return null;
            }
        }
    ...
    static {
        ...
        tmpMap.put(_Fields.PROFILE_CC_MAIL_ENABLED, new org.apache.thrift.meta_data.FieldMetaData("profile_cc_mail_enabled", org.apache.thrift.TFieldRequirementType.OPTIONAL,
                new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.BYTE)));
        tmpMap.put(_Fields.PROFILE_TOHR_MAIL_ENABLED, new org.apache.thrift.meta_data.FieldMetaData("profile_tohr_mail_enabled", org.apache.thrift.TFieldRequirementType.OPTIONAL,
                new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.BYTE)));
    ...
    public JobPositionDO(JobPositionDO other) {
        ...
        this.profile_tohr_mail_enabled = other.profile_tohr_mail_enabled;
    }
    ...
    public void clear() {
        ...
        setProfile_tohr_mail_enabledIsSet(false);
        this.profile_tohr_mail_enabled = 0;
    }
    ...
    public byte getProfile_tohr_mail_enabled() {
        return this.profile_tohr_mail_enabled;
    }

    public JobPositionDO setProfile_tohr_mail_enabled(byte profile_tohr_mail_enabled) {
        this.profile_tohr_mail_enabled = profile_tohr_mail_enabled;
        setProfile_tohr_mail_enabledIsSet(true);
        return this;
    }

    public void unsetProfile_tohr_mail_enabled() {
        __isset_bitfield = org.apache.thrift.EncodingUtils.clearBit(__isset_bitfield, __PROFILE_TOHR_MAIL_ENABLED_ISSET_ID);
    }

    /** Returns true if field profile_tohr_mail_enabled is set (has been assigned a value) and false otherwise */
    public boolean isSetProfile_tohr_mail_enabled() {
        return org.apache.thrift.EncodingUtils.testBit(__isset_bitfield, __PROFILE_TOHR_MAIL_ENABLED_ISSET_ID);
    }

    public void setProfile_tohr_mail_enabledIsSet(boolean value) {
        __isset_bitfield = org.apache.thrift.EncodingUtils.setBit(__isset_bitfield, __PROFILE_TOHR_MAIL_ENABLED_ISSET_ID, value);
    }
    ...
    public void setFieldValue(_Fields field, java.lang.Object value) {
        switch (field) {
            ...
            case PROFILE_TOHR_MAIL_ENABLED:
                if (value == null) {
                    unsetProfile_tohr_mail_enabled();
                } else {
                    setProfile_tohr_mail_enabled((java.lang.Byte)value);
                }
                break;
    ...
    public java.lang.Object getFieldValue(_Fields field) {
        switch (field) {
            ...
            case PROFILE_TOHR_MAIL_ENABLED:
                return getProfile_tohr_mail_enabled();
    ...
    public boolean isSet(_Fields field) {
        ...
        switch (field) {
            ...
            case PROFILE_TOHR_MAIL_ENABLED:
                return isSetProfile_tohr_mail_enabled();
        }
        throw new java.lang.IllegalStateException();
    }
    ...
    public boolean equals(JobPositionDO that) {
        ...
        boolean this_present_profile_tohr_mail_enabled = true && this.isSetProfile_tohr_mail_enabled();
        boolean that_present_profile_tohr_mail_enabled = true && that.isSetProfile_tohr_mail_enabled();
        if (this_present_profile_tohr_mail_enabled || that_present_profile_tohr_mail_enabled) {
            if (!(this_present_profile_tohr_mail_enabled && that_present_profile_tohr_mail_enabled))
                return false;
            if (this.profile_tohr_mail_enabled != that.profile_tohr_mail_enabled)
                return false;
        }
    ...
    public int hashCode() {
        ...
        hashCode = hashCode * 8191 + ((isSetProfile_tohr_mail_enabled()) ? 131071 : 524287);
        if (isSetProfile_tohr_mail_enabled())
            hashCode = hashCode * 8191 + (int) (profile_tohr_mail_enabled);
    ...
    public int compareTo(JobPositionDO other) {
        ...
        lastComparison = java.lang.Boolean.valueOf(isSetProfile_tohr_mail_enabled()).compareTo(other.isSetProfile_tohr_mail_enabled());
        if (lastComparison != 0) {
            return lastComparison;
        }
        if (isSetProfile_tohr_mail_enabled()) {
            lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.profile_tohr_mail_enabled, other.profile_tohr_mail_enabled);
            if (lastComparison != 0) {
                return lastComparison;
            }
        }
    ...
    public java.lang.String toString() {
        ...
        if (isSetProfile_tohr_mail_enabled()) {
            if (!first) sb.append(", ");
            sb.append("profile_tohr_mail_enabled:");
            sb.append(this.profile_tohr_mail_enabled);
            first = false;
        }
        sb.append(")");
        return sb.toString();
    ...
    private static class JobPositionDOStandardScheme extends org.apache.thrift.scheme.StandardScheme<JobPositionDO> {
        ...
        public void read(org.apache.thrift.protocol.TProtocol iprot, JobPositionDO struct) throws org.apache.thrift.TException {
            ...
            while (true)
            {
                ...
                switch (schemeField.id) {
                    ...
                    case 66: // PROFILE_TOHR_MAIL_ENABLED
                        if (schemeField.type == org.apache.thrift.protocol.TType.BYTE) {
                            struct.profile_tohr_mail_enabled = iprot.readByte();
                            struct.setProfile_tohr_mail_enabledIsSet(true);
                        } else {
                            org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
                        }
                        break;
        ...
        public void write(org.apache.thrift.protocol.TProtocol oprot, JobPositionDO struct) throws org.apache.thrift.TException {
            ...
            if (struct.isSetProfile_tohr_mail_enabled()) {
                oprot.writeFieldBegin(PROFILE_TOHR_MAIL_ENABLED_FIELD_DESC);
                oprot.writeByte(struct.profile_tohr_mail_enabled);
                oprot.writeFieldEnd();
            }
