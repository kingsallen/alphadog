...
public class ProfileApplicationForm implements org.apache.thrift.TBase<ProfileApplicationForm, ProfileApplicationForm._Fields>, java.io.Serializable, Cloneable, Comparable<ProfileApplicationForm> {
  ...
  public java.util.Map<String,java.util.List<String>> filter; // optional
  public java.util.Map<String,String> conditions; // optional
  ...
  public ProfileApplicationForm(ProfileApplicationForm other) {
    ...
    if (other.isSetConditions()) {
      java.util.Map<String,String> __this__conditions = new java.util.HashMap<String,String>(other.conditions);
  ...
  public ProfileApplicationForm setFilter(java.util.Map<String,java.util.List<String>> filter) {
    this.filter = filter;
    return this;
  }
  ...
  public void putToConditions(String key, String val) {
    if (this.conditions == null) {
      this.conditions = new java.util.HashMap<String,String>();
    }
  ...
  public ProfileApplicationForm setConditions(java.util.Map<String,String> conditions) {
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case CONDITIONS:
      if (value == null) {
        ...
        setConditions((java.util.Map<String,String>)value);
      }
      break;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("ProfileApplicationForm(");
    boolean first = true;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.filter = new java.util.HashMap<String,java.util.List<String>>(2*_map30.size);
                String _key31;
                java.util.List<String> _val32;
                for (int _i33 = 0; _i33 < _map30.size; ++_i33)
                {
                  _key31 = iprot.readString();
                  {
                    org.apache.thrift.protocol.TList _list34 = iprot.readListBegin();
                    _val32 = new java.util.ArrayList<String>(_list34.size);
                    String _elem35;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.conditions = new java.util.HashMap<String,String>(2*_map37.size);
                String _key38;
                String _val39;
      ...
      if (struct.filter != null) {
        if (struct.isSetFilter()) {
          oprot.writeFieldBegin(FILTER_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<String, java.util.List<String>> _iter41 : struct.filter.entrySet())
            {
      ...
      if (struct.conditions != null) {
        if (struct.isSetConditions()) {
          oprot.writeFieldBegin(CONDITIONS_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<String, String> _iter43 : struct.conditions.entrySet())
            {
      ...
      if (struct.isSetFilter()) {
        {
          ...
          for (java.util.Map.Entry<String, java.util.List<String>> _iter44 : struct.filter.entrySet())
          {
      ...
      if (struct.isSetConditions()) {
        {
          ...
          for (java.util.Map.Entry<String, String> _iter46 : struct.conditions.entrySet())
          {
      ...
      if (incoming.get(5)) {
        {
          ...
          struct.filter = new java.util.HashMap<String,java.util.List<String>>(2*_map47.size);
          String _key48;
      ...
      if (incoming.get(6)) {
        {
          ...
          struct.conditions = new java.util.HashMap<String,String>(2*_map54.size);
          String _key55;
          String _val56;
