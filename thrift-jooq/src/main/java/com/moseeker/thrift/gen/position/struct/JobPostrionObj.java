...
public class JobPostrionObj implements org.apache.thrift.TBase<JobPostrionObj, JobPostrionObj._Fields>, java.io.Serializable, Cloneable, Comparable<JobPostrionObj> {
  ...
  private static final org.apache.thrift.protocol.TField FEATURE_FIELD_DESC = new org.apache.thrift.protocol.TField("feature", org.apache.thrift.protocol.TType.LIST, (short)17);
  ...
  public java.util.List<String> feature; // required
  ...
  private static final _Fields optionals[] = {_Fields.PROFILE_CC_MAIL_ENABLED};
  ...
  public JobPostrionObj setFeature(java.util.List<String> feature) {
    this.feature = feature;
    return this;
  }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.feature = new java.util.ArrayList<String>(_list50.size);
                String _elem51;
                for (int _i52 = 0; _i52 < _list50.size; ++_i52)
                {
                  _elem51 = iprot.readString();
                  struct.feature.add(_elem51);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.city = new java.util.ArrayList<City>(_list53.size);
                City _elem54;
                for (int _i55 = 0; _i55 < _list53.size; ++_i55)
                {
                  _elem54 = new City();
                  _elem54.read(iprot);
                  struct.city.add(_elem54);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.ccmail = new java.util.ArrayList<String>(_list56.size);
                String _elem57;
                for (int _i58 = 0; _i58 < _list56.size; ++_i58)
                {
                  _elem57 = iprot.readString();
                  struct.ccmail.add(_elem57);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, JobPostrionObj struct) throws org.apache.thrift.TException {
      ...
      if (struct.feature != null) {
        oprot.writeFieldBegin(FEATURE_FIELD_DESC);
        {
          ...
          for (String _iter59 : struct.feature)
          {
      ...
      if (struct.ccmail != null) {
        oprot.writeFieldBegin(CCMAIL_FIELD_DESC);
        {
          ...
          for (String _iter61 : struct.ccmail)
          {
      ...
      if (struct.isSetFeature()) {
        {
          ...
          for (String _iter62 : struct.feature)
          {
      ...
      if (struct.isSetCcmail()) {
        {
          ...
          for (String _iter64 : struct.ccmail)
          {
      ...
      if (incoming.get(16)) {
        {
          ...
          struct.feature = new java.util.ArrayList<String>(_list65.size);
          String _elem66;
          for (int _i67 = 0; _i67 < _list65.size; ++_i67)
          {
            _elem66 = iprot.readString();
            struct.feature.add(_elem66);
          }
        }
        struct.setFeatureIsSet(true);
      }
      ...
      if (incoming.get(44)) {
        {
          ...
          struct.city = new java.util.ArrayList<City>(_list68.size);
          City _elem69;
          for (int _i70 = 0; _i70 < _list68.size; ++_i70)
          {
            _elem69 = new City();
            _elem69.read(iprot);
            struct.city.add(_elem69);
          }
        }
        struct.setCityIsSet(true);
      }
      ...
      if (incoming.get(51)) {
        {
          ...
          struct.ccmail = new java.util.ArrayList<String>(_list71.size);
          String _elem72;
          for (int _i73 = 0; _i73 < _list71.size; ++_i73)
          {
            _elem72 = iprot.readString();
            struct.ccmail.add(_elem72);
          }
        }
        struct.setCcmailIsSet(true);
      }
