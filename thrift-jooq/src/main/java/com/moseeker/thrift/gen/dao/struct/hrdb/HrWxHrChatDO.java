...
public class HrWxHrChatDO implements org.apache.thrift.TBase<HrWxHrChatDO, HrWxHrChatDO._Fields>, java.io.Serializable, Cloneable, Comparable<HrWxHrChatDO> {
  ...
  private static final _Fields optionals[] = {_Fields.ID,_Fields.CHATLIST_ID,_Fields.CONTENT,_Fields.PID,_Fields.SPEAKER,_Fields.STATUS,_Fields.CREATE_TIME,_Fields.ORIGIN,_Fields.MSG_TYPE,_Fields.PIC_URL,_Fields.BTN_CONTENT};
  ...
  public HrWxHrChatDO setMsgType(String msgType) {
  ...
  public HrWxHrChatDO setPicUrl(String picUrl) {
    this.picUrl = picUrl;
    return this;
  }
  ...
  public HrWxHrChatDO setBtnContent(String btnContent) {
