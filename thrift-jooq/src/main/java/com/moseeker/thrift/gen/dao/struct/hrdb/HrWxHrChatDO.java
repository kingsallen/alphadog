...
public class HrWxHrChatDO implements org.apache.thrift.TBase<HrWxHrChatDO, HrWxHrChatDO._Fields>, java.io.Serializable, Cloneable, Comparable<HrWxHrChatDO> {
  ...
  private static final org.apache.thrift.protocol.TField MSG_TYPE_FIELD_DESC = new org.apache.thrift.protocol.TField("msg_type", org.apache.thrift.protocol.TType.STRING, (short)9);
  ...
  public String msg_type; // optional
  ...
  private static final _Fields optionals[] = {_Fields.ID,_Fields.CHATLIST_ID,_Fields.CONTENT,_Fields.PID,_Fields.SPEAKER,_Fields.STATUS,_Fields.CREATE_TIME,_Fields.ORIGIN,_Fields.MSG_TYPE};
  ...
  static {
    ...
    tmpMap.put(_Fields.ORIGIN, new org.apache.thrift.meta_data.FieldMetaData("origin", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.BYTE)));
    tmpMap.put(_Fields.MSG_TYPE, new org.apache.thrift.meta_data.FieldMetaData("msg_type", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
  ...
  public HrWxHrChatDO setContent(String content) {
  ...
  public HrWxHrChatDO setCreateTime(String createTime) {
  ...
  public HrWxHrChatDO setMsg_type(String msg_type) {
  ...
  /** Returns true if field msg_type is set (has been assigned a value) and false otherwise */
  ...
  public boolean equals(HrWxHrChatDO that) {
    ...
    boolean this_present_msg_type = true && this.isSetMsg_type();
    boolean that_present_msg_type = true && that.isSetMsg_type();
    if (this_present_msg_type || that_present_msg_type) {
      if (!(this_present_msg_type && that_present_msg_type))
        return false;
      if (!this.msg_type.equals(that.msg_type))
        return false;
    }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetMsg_type()) ? 131071 : 524287);
    if (isSetMsg_type())
      hashCode = hashCode * 8191 + msg_type.hashCode();
  ...
  public int compareTo(HrWxHrChatDO other) {
    ...
    lastComparison = Boolean.valueOf(isSetChatlistId()).compareTo(other.isSetChatlistId());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetChatlistId()) {
    ...
    lastComparison = Boolean.valueOf(isSetMsg_type()).compareTo(other.isSetMsg_type());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetMsg_type()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.msg_type, other.msg_type);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("HrWxHrChatDO(");
    boolean first = true;
  ...
  private static class HrWxHrChatDOStandardScheme extends org.apache.thrift.scheme.StandardScheme<HrWxHrChatDO> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, HrWxHrChatDO struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 9: // MSG_TYPE
            if (schemeField.type == org.apache.thrift.protocol.TType.STRING) {
              struct.msg_type = iprot.readString();
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, HrWxHrChatDO struct) throws org.apache.thrift.TException {
      ...
      if (struct.msg_type != null) {
        if (struct.isSetMsg_type()) {
          oprot.writeFieldBegin(MSG_TYPE_FIELD_DESC);
          oprot.writeString(struct.msg_type);
          oprot.writeFieldEnd();
        }
      }
