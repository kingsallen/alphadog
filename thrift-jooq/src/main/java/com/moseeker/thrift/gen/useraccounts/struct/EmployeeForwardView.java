...
public class EmployeeForwardView implements org.apache.thrift.TBase<EmployeeForwardView, EmployeeForwardView._Fields>, java.io.Serializable, Cloneable, Comparable<EmployeeForwardView> {
  ...
  public java.util.List<Connection> chain; // optional
  ...
  private static final _Fields optionals[] = {_Fields.USER_ID,_Fields.NICKNAME,_Fields.VIEW_COUNT,_Fields.CONNECTION,_Fields.DEPTH,_Fields.HEADIMGURL,_Fields.POSITION_TITLE,_Fields.POSITION_ID,_Fields.FORWARD_NAME,_Fields.FORWARD_SOURCE_WX,_Fields.CLICK_TIME,_Fields.INVITATION_STATUS,_Fields.CHAIN};
  ...
  public EmployeeForwardView(EmployeeForwardView other) {
    ...
    if (other.isSetChain()) {
      ...
      for (Connection other_element : other.chain) {
        __this__chain.add(other_element);
      }
  ...
  public EmployeeForwardView setNickname(String nickname) {
  ...
  public EmployeeForwardView setHeadimgurl(String headimgurl) {
  ...
  public EmployeeForwardView setPositionTitle(String positionTitle) {
  ...
  public EmployeeForwardView setForwardName(String forwardName) {
  ...
  public EmployeeForwardView setClickTime(String clickTime) {
  ...
  public EmployeeForwardView setChain(java.util.List<Connection> chain) {
    this.chain = chain;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case INVITATION_STATUS:
      if (value == null) {
        ...
        setInvitationStatus((Integer)value);
      }
      break;
  ...
  public int compareTo(EmployeeForwardView other) {
    ...
    lastComparison = Boolean.valueOf(isSetInvitationStatus()).compareTo(other.isSetInvitationStatus());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetInvitationStatus()) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("EmployeeForwardView(");
    boolean first = true;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.chain = new java.util.ArrayList<Connection>(_list132.size);
                Connection _elem133;
                for (int _i134 = 0; _i134 < _list132.size; ++_i134)
                {
                  _elem133 = new Connection();
                  _elem133.read(iprot);
                  struct.chain.add(_elem133);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.chain != null) {
        if (struct.isSetChain()) {
          oprot.writeFieldBegin(CHAIN_FIELD_DESC);
          {
            ...
            for (Connection _iter135 : struct.chain)
            {
      ...
      if (struct.isSetChain()) {
        {
          ...
          for (Connection _iter136 : struct.chain)
          {
      ...
      if (incoming.get(12)) {
        {
          ...
          struct.chain = new java.util.ArrayList<Connection>(_list137.size);
          Connection _elem138;
          for (int _i139 = 0; _i139 < _list137.size; ++_i139)
          {
            _elem138 = new Connection();
            _elem138.read(iprot);
            struct.chain.add(_elem138);
          }
        }
        struct.setChainIsSet(true);
      }
