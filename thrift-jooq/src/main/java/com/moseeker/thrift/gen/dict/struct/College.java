...
public class College implements org.apache.thrift.TBase<College, College._Fields>, java.io.Serializable, Cloneable, Comparable<College> {
  ...
  private static final org.apache.thrift.protocol.TField COLLGE_LOGO_FIELD_DESC = new org.apache.thrift.protocol.TField("collge_logo", org.apache.thrift.protocol.TType.STRING, (short)3);
  ...
  public String collge_name; // optional
  public String collge_logo; // optional
  public int province_code; // optional
  public String province_name; // optional

  /** The set of fields this struct contains, along with convenience methods for finding and manipulating them. */
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    COLLEGE_CODE((short)1, "college_code"),
    COLLGE_NAME((short)2, "collge_name"),
    COLLGE_LOGO((short)3, "collge_logo"),
  ...
  private static final _Fields optionals[] = {_Fields.COLLEGE_CODE,_Fields.COLLGE_NAME,_Fields.COLLGE_LOGO,_Fields.PROVINCE_CODE,_Fields.PROVINCE_NAME};
  ...
  static {
    ...
    tmpMap.put(_Fields.COLLGE_NAME, new org.apache.thrift.meta_data.FieldMetaData("collge_name", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
    tmpMap.put(_Fields.COLLGE_LOGO, new org.apache.thrift.meta_data.FieldMetaData("collge_logo", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
  ...
  public College(College other) {
    ...
    if (other.isSetCollge_logo()) {
      this.collge_logo = other.collge_logo;
    }
  ...
  public String getCollge_logo() {
    return this.collge_logo;
  }

  public College setCollge_logo(String collge_logo) {
    this.collge_logo = collge_logo;
    return this;
  }

  public void unsetCollge_logo() {
    this.collge_logo = null;
  }

  /** Returns true if field collge_logo is set (has been assigned a value) and false otherwise */
  public boolean isSetCollge_logo() {
    return this.collge_logo != null;
  }

  public void setCollge_logoIsSet(boolean value) {
    if (!value) {
      this.collge_logo = null;
    }
  }
  ...
  public boolean equals(College that) {
    ...
    boolean this_present_collge_logo = true && this.isSetCollge_logo();
    boolean that_present_collge_logo = true && that.isSetCollge_logo();
    if (this_present_collge_logo || that_present_collge_logo) {
      if (!(this_present_collge_logo && that_present_collge_logo))
        return false;
      if (!this.collge_logo.equals(that.collge_logo))
        return false;
    }
  ...
  public int hashCode() {
    ...
    boolean present_collge_logo = true && (isSetCollge_logo());
    list.add(present_collge_logo);
    if (present_collge_logo)
      list.add(collge_logo);

    boolean present_province_code = true && (isSetProvince_code());
  ...
  public int compareTo(College other) {
    ...
    lastComparison = Boolean.valueOf(isSetCollge_logo()).compareTo(other.isSetCollge_logo());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetCollge_logo()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.collge_logo, other.collge_logo);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    ...
    if (isSetCollge_logo()) {
      if (!first) sb.append(", ");
      sb.append("collge_logo:");
      if (this.collge_logo == null) {
        sb.append("null");
      } else {
        sb.append(this.collge_logo);
      }
      first = false;
    }
    if (isSetProvince_code()) {
  ...
  private static class CollegeStandardScheme extends StandardScheme<College> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, College struct) throws TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 3: // COLLGE_LOGO
            if (schemeField.type == org.apache.thrift.protocol.TType.STRING) {
              struct.collge_logo = iprot.readString();
              struct.setCollge_logoIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, College struct) throws TException {
      struct.validate();
      ...
      if (struct.collge_logo != null) {
        if (struct.isSetCollge_logo()) {
          oprot.writeFieldBegin(COLLGE_LOGO_FIELD_DESC);
          oprot.writeString(struct.collge_logo);
          oprot.writeFieldEnd();
        }
      }
  ...
  private static class CollegeTupleScheme extends TupleScheme<College> {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, College struct) throws TException {
