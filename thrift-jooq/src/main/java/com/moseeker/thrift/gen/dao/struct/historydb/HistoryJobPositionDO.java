...
public class HistoryJobPositionDO implements org.apache.thrift.TBase<HistoryJobPositionDO, HistoryJobPositionDO._Fields>, java.io.Serializable, Cloneable, Comparable<HistoryJobPositionDO> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("HistoryJobPositionDO");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new HistoryJobPositionDOStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new HistoryJobPositionDOTupleSchemeFactory();
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(HistoryJobPositionDO.class, metaDataMap);
  }

  public HistoryJobPositionDO() {
  }

  /**
   * Performs a deep copy on <i>other</i>.
   */
  public HistoryJobPositionDO(HistoryJobPositionDO other) {
  ...
  public HistoryJobPositionDO deepCopy() {
    return new HistoryJobPositionDO(this);
  }
  ...
  public HistoryJobPositionDO setId(int id) {
    this.id = id;
    setIdIsSet(true);
    return this;
  }
  ...
  public HistoryJobPositionDO setJobnumber(java.lang.String jobnumber) {
  ...
  public HistoryJobPositionDO setCompanyId(int companyId) {
  ...
  public HistoryJobPositionDO setTitle(java.lang.String title) {
    this.title = title;
    return this;
  }
  ...
  public HistoryJobPositionDO setProvince(java.lang.String province) {
  ...
  public HistoryJobPositionDO setCity(java.lang.String city) {
    this.city = city;
    return this;
  }
  ...
  public HistoryJobPositionDO setDepartment(java.lang.String department) {
  ...
  public HistoryJobPositionDO setLJobid(int lJobid) {
    this.lJobid = lJobid;
    setLJobidIsSet(true);
    return this;
  }
  ...
  public HistoryJobPositionDO setPublishDate(java.lang.String publishDate) {
  ...
  public HistoryJobPositionDO setStopDate(java.lang.String stopDate) {
  ...
  public HistoryJobPositionDO setAccountabilities(java.lang.String accountabilities) {
  ...
  public HistoryJobPositionDO setExperience(java.lang.String experience) {
  ...
  public HistoryJobPositionDO setRequirement(java.lang.String requirement) {
  ...
  public HistoryJobPositionDO setSalary(java.lang.String salary) {
    this.salary = salary;
    return this;
  }
  ...
  public HistoryJobPositionDO setLanguage(java.lang.String language) {
  ...
  public HistoryJobPositionDO setJobGrade(int jobGrade) {
  ...
  public HistoryJobPositionDO setStatus(double status) {
    this.status = status;
    setStatusIsSet(true);
    return this;
  }
  ...
  public HistoryJobPositionDO setVisitnum(int visitnum) {
  ...
  public HistoryJobPositionDO setLastvisit(java.lang.String lastvisit) {
  ...
  public HistoryJobPositionDO setSourceId(int sourceId) {
  ...
  public HistoryJobPositionDO setUpdateTime(java.lang.String updateTime) {
  ...
  public HistoryJobPositionDO setBusinessGroup(java.lang.String businessGroup) {
  ...
  public HistoryJobPositionDO setEmploymentType(double employmentType) {
  ...
  public HistoryJobPositionDO setHrEmail(java.lang.String hrEmail) {
  ...
  public HistoryJobPositionDO setBenefits(java.lang.String benefits) {
  ...
  public HistoryJobPositionDO setDegree(double degree) {
    this.degree = degree;
    setDegreeIsSet(true);
    return this;
  }
  ...
  public HistoryJobPositionDO setFeature(java.lang.String feature) {
  ...
  public HistoryJobPositionDO setEmailNotice(byte emailNotice) {
  ...
  public HistoryJobPositionDO setCandidateSource(double candidateSource) {
  ...
  public HistoryJobPositionDO setOccupation(java.lang.String occupation) {
  ...
  public HistoryJobPositionDO setIsRecom(int isRecom) {
  ...
  public HistoryJobPositionDO setIndustry(java.lang.String industry) {
  ...
  public HistoryJobPositionDO setHongbaoConfigId(int hongbaoConfigId) {
  ...
  public HistoryJobPositionDO setHongbaoConfigRecomId(int hongbaoConfigRecomId) {
  ...
  public HistoryJobPositionDO setHongbaoConfigAppId(int hongbaoConfigAppId) {
  ...
  public HistoryJobPositionDO setEmailResumeConf(double emailResumeConf) {
  ...
  public HistoryJobPositionDO setLPostingtargetid(double lPostingtargetid) {
  ...
  public HistoryJobPositionDO setPriority(double priority) {
  ...
  public HistoryJobPositionDO setShareTplId(double shareTplId) {
  ...
  public HistoryJobPositionDO setDistrict(java.lang.String district) {
  ...
  public HistoryJobPositionDO setCount(double count) {
    this.count = count;
    setCountIsSet(true);
    return this;
  }
  ...
  public HistoryJobPositionDO setSalaryTop(double salaryTop) {
  ...
  public HistoryJobPositionDO setSalaryBottom(double salaryBottom) {
  ...
  public HistoryJobPositionDO setExperienceAbove(byte experienceAbove) {
  ...
  public HistoryJobPositionDO setDegreeAbove(byte degreeAbove) {
  ...
  public HistoryJobPositionDO setManagementExperience(double managementExperience) {
  ...
  public HistoryJobPositionDO setGender(double gender) {
    this.gender = gender;
    setGenderIsSet(true);
    return this;
  }
  ...
  public HistoryJobPositionDO setPublisher(int publisher) {
  ...
  public HistoryJobPositionDO setAppCvConfigId(int appCvConfigId) {
  ...
  public HistoryJobPositionDO setSource(double source) {
    this.source = source;
    setSourceIsSet(true);
    return this;
  }
  ...
  public HistoryJobPositionDO setHbStatus(byte hbStatus) {
  ...
  public HistoryJobPositionDO setChildCompanyId(int childCompanyId) {
  ...
  public HistoryJobPositionDO setAge(byte age) {
    this.age = age;
    setAgeIsSet(true);
    return this;
  }
  ...
  public HistoryJobPositionDO setMajorRequired(java.lang.String majorRequired) {
  ...
  public HistoryJobPositionDO setWorkAddress(java.lang.String workAddress) {
  ...
  public HistoryJobPositionDO setKeyword(java.lang.String keyword) {
  ...
  public HistoryJobPositionDO setReportingTo(java.lang.String reportingTo) {
  ...
  public HistoryJobPositionDO setIsHiring(byte isHiring) {
  ...
  public HistoryJobPositionDO setUnderlings(byte underlings) {
  ...
  public HistoryJobPositionDO setLanguageRequired(byte languageRequired) {
  ...
  public HistoryJobPositionDO setTargetIndustry(byte targetIndustry) {
  ...
  public HistoryJobPositionDO setCurrentStatus(byte currentStatus) {
  ...
  public HistoryJobPositionDO setPositionCode(int positionCode) {
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof HistoryJobPositionDO)
      return this.equals((HistoryJobPositionDO)that);
    return false;
  }

  public boolean equals(HistoryJobPositionDO that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(HistoryJobPositionDO other) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("HistoryJobPositionDO(");
    boolean first = true;
  ...
  private static class HistoryJobPositionDOStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public HistoryJobPositionDOStandardScheme getScheme() {
      return new HistoryJobPositionDOStandardScheme();
    }
  }

  private static class HistoryJobPositionDOStandardScheme extends org.apache.thrift.scheme.StandardScheme<HistoryJobPositionDO> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, HistoryJobPositionDO struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, HistoryJobPositionDO struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class HistoryJobPositionDOTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public HistoryJobPositionDOTupleScheme getScheme() {
      return new HistoryJobPositionDOTupleScheme();
    }
  }

  private static class HistoryJobPositionDOTupleScheme extends org.apache.thrift.scheme.TupleScheme<HistoryJobPositionDO> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, HistoryJobPositionDO struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, HistoryJobPositionDO struct) throws org.apache.thrift.TException {
