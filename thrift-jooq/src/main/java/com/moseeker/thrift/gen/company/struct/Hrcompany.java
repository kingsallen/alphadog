...
@Generated(value = "Autogenerated by Thrift Compiler (1.0.0-dev)", date = "2016-05-25")
public class Hrcompany implements org.apache.thrift.TBase<Hrcompany, Hrcompany._Fields>, java.io.Serializable, Cloneable, Comparable<Hrcompany> {
  ...
  private static final SchemeFactory STANDARD_SCHEME_FACTORY = new HrcompanyStandardSchemeFactory();
  private static final SchemeFactory TUPLE_SCHEME_FACTORY = new HrcompanyTupleSchemeFactory();
