...
public class HrWxTemplateMessageDO implements org.apache.thrift.TBase<HrWxTemplateMessageDO, HrWxTemplateMessageDO._Fields>, java.io.Serializable, Cloneable, Comparable<HrWxTemplateMessageDO> {
  ...
  public String wxTemplateId; // optional
  ...
  public HrWxTemplateMessageDO setWxTemplateId(String wxTemplateId) {
  ...
  public HrWxTemplateMessageDO setUrl(String url) {
    this.url = url;
    return this;
  }
  ...
  public HrWxTemplateMessageDO setTopcolor(String topcolor) {
  ...
  public HrWxTemplateMessageDO setFirst(String first) {
    this.first = first;
    return this;
  }
  ...
  public HrWxTemplateMessageDO setRemark(String remark) {
    this.remark = remark;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case SYS_TEMPLATE_ID:
      if (value == null) {
        ...
        setSysTemplateId((Integer)value);
      }
      break;
  ...
  public int compareTo(HrWxTemplateMessageDO other) {
    ...
    lastComparison = Boolean.valueOf(isSetSysTemplateId()).compareTo(other.isSetSysTemplateId());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetSysTemplateId()) {
    ...
    lastComparison = Boolean.valueOf(isSetWxTemplateId()).compareTo(other.isSetWxTemplateId());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetWxTemplateId()) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("HrWxTemplateMessageDO(");
    boolean first = true;
