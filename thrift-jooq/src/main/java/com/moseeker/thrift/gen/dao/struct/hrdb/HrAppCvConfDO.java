...
public class HrAppCvConfDO implements org.apache.thrift.TBase<HrAppCvConfDO, HrAppCvConfDO._Fields>, java.io.Serializable, Cloneable, Comparable<HrAppCvConfDO> {
  ...
  public HrAppCvConfDO setName(String name) {
    this.name = name;
    return this;
  }
  ...
  public HrAppCvConfDO setCreateTime(String createTime) {
  ...
  public HrAppCvConfDO setUpdateTime(String updateTime) {
  ...
  public HrAppCvConfDO setFieldValue(String fieldValue) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("HrAppCvConfDO(");
    boolean first = true;
