            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.trainings = new ArrayList<Training>(_list112.size);
                Training _elem113;
                for (int _i114 = 0; _i114 < _list112.size; ++_i114)
                {
                  _elem113 = new Training();
                  _elem113.read(iprot);
                  struct.trainings.add(_elem113);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TrainingPagination struct) throws org.apache.thrift.TException {
      ...
      if (struct.trainings != null) {
        oprot.writeFieldBegin(TRAININGS_FIELD_DESC);
        {
          ...
          for (Training _iter115 : struct.trainings)
          {
      ...
      if (struct.isSetTrainings()) {
        {
          ...
          for (Training _iter116 : struct.trainings)
          {
      ...
      if (incoming.get(4)) {
        {
          ...
          struct.trainings = new ArrayList<Training>(_list117.size);
          Training _elem118;
          for (int _i119 = 0; _i119 < _list117.size; ++_i119)
          {
            _elem118 = new Training();
            _elem118.read(iprot);
            struct.trainings.add(_elem118);
          }
        }
        struct.setTrainingsIsSet(true);
      }
