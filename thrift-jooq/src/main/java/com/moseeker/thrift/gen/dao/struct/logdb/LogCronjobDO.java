...
public class LogCronjobDO implements org.apache.thrift.TBase<LogCronjobDO, LogCronjobDO._Fields>, java.io.Serializable, Cloneable, Comparable<LogCronjobDO> {
  ...
  public LogCronjobDO setStartTime(java.lang.String startTime) {
  ...
  public LogCronjobDO setEndTime(java.lang.String endTime) {
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case CRONJOB_ID:
      if (value == null) {
        ...
        setCronjobId((java.lang.Integer)value);
      }
      break;
  ...
  public int compareTo(LogCronjobDO other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetCronjobId()).compareTo(other.isSetCronjobId());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetCronjobId()) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("LogCronjobDO(");
    boolean first = true;
