                            ...
                            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                                {
                                    ...
                                    struct.tag_ids = new java.util.ArrayList<java.lang.Integer>(_list334.size);
                                    int _elem335;
                                    for (int _i336 = 0; _i336 < _list334.size; ++_i336)
                                    {
                                        _elem335 = iprot.readI32();
                                        struct.tag_ids.add(_elem335);
                                    }
                                    iprot.readListEnd();
                                }
            ...
            public void write(org.apache.thrift.protocol.TProtocol oprot, deleteHrAutoMaticTagByIds_args struct) throws org.apache.thrift.TException {
                ...
                if (struct.tag_ids != null) {
                    oprot.writeFieldBegin(TAG_IDS_FIELD_DESC);
                    {
                        ...
                        for (int _iter337 : struct.tag_ids)
                        {
                ...
                if (struct.isSetTag_ids()) {
                    {
                        ...
                        for (int _iter338 : struct.tag_ids)
                        {
                ...
                if (incoming.get(2)) {
                    {
                        ...
                        struct.tag_ids = new java.util.ArrayList<java.lang.Integer>(_list339.size);
                        int _elem340;
                        for (int _i341 = 0; _i341 < _list339.size; ++_i341)
                        {
                            _elem340 = iprot.readI32();
                            struct.tag_ids.add(_elem340);
                        }
                    }
                    struct.setTag_idsIsSet(true);
                }
