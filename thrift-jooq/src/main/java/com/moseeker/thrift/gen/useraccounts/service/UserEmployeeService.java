              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.applicationIdList = new java.util.ArrayList<java.lang.Integer>(_list140.size);
                  int _elem141;
                  for (int _i142 = 0; _i142 < _list140.size; ++_i142)
                  {
                    _elem141 = iprot.readI32();
                    struct.applicationIdList.add(_elem141);
                  }
                  iprot.readListEnd();
                }
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, addEmployeeAward_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.applicationIdList != null) {
          oprot.writeFieldBegin(APPLICATION_ID_LIST_FIELD_DESC);
          {
            ...
            for (int _iter143 : struct.applicationIdList)
            {
        ...
        if (struct.isSetApplicationIdList()) {
          {
            ...
            for (int _iter144 : struct.applicationIdList)
            {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.applicationIdList = new java.util.ArrayList<java.lang.Integer>(_list145.size);
            int _elem146;
            for (int _i147 = 0; _i147 < _list145.size; ++_i147)
            {
              _elem146 = iprot.readI32();
              struct.applicationIdList.add(_elem146);
            }
          }
          struct.setApplicationIdListIsSet(true);
        }
