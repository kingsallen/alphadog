...
public class UserEmployeeService {
  ...
  public interface Iface {
    ...
    public com.moseeker.thrift.gen.common.struct.Response getValidateUserEmployee(int company_id, java.lang.String email) throws com.moseeker.thrift.gen.common.struct.BIZException, org.apache.thrift.TException;
  ...
  public interface AsyncIface {
    ...
    public void getValidateUserEmployee(int company_id, java.lang.String email, org.apache.thrift.async.AsyncMethodCallback<com.moseeker.thrift.gen.common.struct.Response> resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public com.moseeker.thrift.gen.common.struct.Response getValidateUserEmployee(int company_id, java.lang.String email) throws com.moseeker.thrift.gen.common.struct.BIZException, org.apache.thrift.TException
    {
      send_getValidateUserEmployee(company_id, email);
      return recv_getValidateUserEmployee();
    }

    public void send_getValidateUserEmployee(int company_id, java.lang.String email) throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public void getValidateUserEmployee(int company_id, java.lang.String email, org.apache.thrift.async.AsyncMethodCallback<com.moseeker.thrift.gen.common.struct.Response> resultHandler) throws org.apache.thrift.TException {
      checkReady();
      getValidateUserEmployee_call method_call = new getValidateUserEmployee_call(company_id, email, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }
    ...
    public static class getValidateUserEmployee_call extends org.apache.thrift.async.TAsyncMethodCall<com.moseeker.thrift.gen.common.struct.Response> {
      ...
      public getValidateUserEmployee_call(int company_id, java.lang.String email, org.apache.thrift.async.AsyncMethodCallback<com.moseeker.thrift.gen.common.struct.Response> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class getValidateUserEmployee<I extends Iface> extends org.apache.thrift.ProcessFunction<I, getValidateUserEmployee_args> {
      ...
      public getValidateUserEmployee_result getResult(I iface, getValidateUserEmployee_args args) throws org.apache.thrift.TException {
        getValidateUserEmployee_result result = new getValidateUserEmployee_result();
        try {
          result.success = iface.getValidateUserEmployee(args.company_id, args.email);
        } catch (com.moseeker.thrift.gen.common.struct.BIZException e) {
          result.e = e;
        }
        return result;
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class getValidateUserEmployee<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, getValidateUserEmployee_args, com.moseeker.thrift.gen.common.struct.Response> {
      ...
      public void start(I iface, getValidateUserEmployee_args args, org.apache.thrift.async.AsyncMethodCallback<com.moseeker.thrift.gen.common.struct.Response> resultHandler) throws org.apache.thrift.TException {
        iface.getValidateUserEmployee(args.company_id, args.email,resultHandler);
      }
    }
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.applicationIdList = new java.util.ArrayList<java.lang.Integer>(_list132.size);
                  int _elem133;
                  for (int _i134 = 0; _i134 < _list132.size; ++_i134)
                  {
                    _elem133 = iprot.readI32();
                    struct.applicationIdList.add(_elem133);
                  }
                  iprot.readListEnd();
                }
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, addEmployeeAward_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.applicationIdList != null) {
          oprot.writeFieldBegin(APPLICATION_ID_LIST_FIELD_DESC);
          {
            ...
            for (int _iter135 : struct.applicationIdList)
            {
        ...
        if (struct.isSetApplicationIdList()) {
          {
            ...
            for (int _iter136 : struct.applicationIdList)
            {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.applicationIdList = new java.util.ArrayList<java.lang.Integer>(_list137.size);
            int _elem138;
            for (int _i139 = 0; _i139 < _list137.size; ++_i139)
            {
              _elem138 = iprot.readI32();
              struct.applicationIdList.add(_elem138);
            }
          }
          struct.setApplicationIdListIsSet(true);
        }
