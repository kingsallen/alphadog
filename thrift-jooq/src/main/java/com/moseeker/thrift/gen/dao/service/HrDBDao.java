...
public class HrDBDao {
  ...
  public interface AsyncIface {
    ...
    public void getHrTeam(com.moseeker.thrift.gen.common.struct.CommonQuery query, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public static class getHrTeam_call extends org.apache.thrift.async.TAsyncMethodCall {
      private com.moseeker.thrift.gen.common.struct.CommonQuery query;
      public getHrTeam_call(com.moseeker.thrift.gen.common.struct.CommonQuery query, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.query = query;
      }
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class getHrTeam<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, getHrTeam_args, com.moseeker.thrift.gen.common.struct.Response> {
      ...
      public void start(I iface, getHrTeam_args args, org.apache.thrift.async.AsyncMethodCallback<com.moseeker.thrift.gen.common.struct.Response> resultHandler) throws TException {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.record = new ArrayList<HrOperationrecordStruct>(_list120.size);
                  HrOperationrecordStruct _elem121;
                  for (int _i122 = 0; _i122 < _list120.size; ++_i122)
                  {
                    _elem121 = new HrOperationrecordStruct();
                    _elem121.read(iprot);
                    struct.record.add(_elem121);
                  }
                  iprot.readListEnd();
                }
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, postHrOperationrecords_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.record != null) {
          oprot.writeFieldBegin(RECORD_FIELD_DESC);
          {
            ...
            for (HrOperationrecordStruct _iter123 : struct.record)
            {
        ...
        if (struct.isSetRecord()) {
          {
            ...
            for (HrOperationrecordStruct _iter124 : struct.record)
            {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.record = new ArrayList<HrOperationrecordStruct>(_list125.size);
            HrOperationrecordStruct _elem126;
            for (int _i127 = 0; _i127 < _list125.size; ++_i127)
            {
              _elem126 = new HrOperationrecordStruct();
              _elem126.read(iprot);
              struct.record.add(_elem126);
            }
          }
          struct.setRecordIsSet(true);
        }
    ...
    private static class getHrHistoryOperations_argsStandardScheme extends StandardScheme<getHrHistoryOperations_args> {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.record = new ArrayList<com.moseeker.thrift.gen.application.struct.ProcessValidationStruct>(_list128.size);
                  com.moseeker.thrift.gen.application.struct.ProcessValidationStruct _elem129;
                  for (int _i130 = 0; _i130 < _list128.size; ++_i130)
                  {
                    _elem129 = new com.moseeker.thrift.gen.application.struct.ProcessValidationStruct();
                    _elem129.read(iprot);
                    struct.record.add(_elem129);
                  }
                  iprot.readListEnd();
                }
                struct.setRecordIsSet(true);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getHrHistoryOperations_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.record != null) {
          ...
          {
            oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, struct.record.size()));
            for (com.moseeker.thrift.gen.application.struct.ProcessValidationStruct _iter131 : struct.record)
            {
    ...
    private static class getHrHistoryOperations_argsTupleScheme extends TupleScheme<getHrHistoryOperations_args> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, getHrHistoryOperations_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.isSetRecord()) {
          {
            oprot.writeI32(struct.record.size());
            for (com.moseeker.thrift.gen.application.struct.ProcessValidationStruct _iter132 : struct.record)
            {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.record = new ArrayList<com.moseeker.thrift.gen.application.struct.ProcessValidationStruct>(_list133.size);
            com.moseeker.thrift.gen.application.struct.ProcessValidationStruct _elem134;
            for (int _i135 = 0; _i135 < _list133.size; ++_i135)
            {
              _elem134 = new com.moseeker.thrift.gen.application.struct.ProcessValidationStruct();
              _elem134.read(iprot);
              struct.record.add(_elem134);
            }
          }
          struct.setRecordIsSet(true);
        }
  ...
  public static class getHrTeam_args implements org.apache.thrift.TBase<getHrTeam_args, getHrTeam_args._Fields>, java.io.Serializable, Cloneable, Comparable<getHrTeam_args>   {
    ...
    private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
    static {
      schemes.put(StandardScheme.class, new getHrTeam_argsStandardSchemeFactory());
      schemes.put(TupleScheme.class, new getHrTeam_argsTupleSchemeFactory());
    }
    ...
    private static class getHrTeam_argsStandardSchemeFactory implements SchemeFactory {
      public getHrTeam_argsStandardScheme getScheme() {
        return new getHrTeam_argsStandardScheme();
      }
    }

    private static class getHrTeam_argsStandardScheme extends StandardScheme<getHrTeam_args> {
    ...
    private static class getHrTeam_argsTupleSchemeFactory implements SchemeFactory {
      public getHrTeam_argsTupleScheme getScheme() {
        return new getHrTeam_argsTupleScheme();
      }
    }

    private static class getHrTeam_argsTupleScheme extends TupleScheme<getHrTeam_args> {
  ...
  public static class getHrTeam_result implements org.apache.thrift.TBase<getHrTeam_result, getHrTeam_result._Fields>, java.io.Serializable, Cloneable, Comparable<getHrTeam_result>   {
    ...
    private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
    static {
      schemes.put(StandardScheme.class, new getHrTeam_resultStandardSchemeFactory());
      schemes.put(TupleScheme.class, new getHrTeam_resultTupleSchemeFactory());
    }
    ...
    private static class getHrTeam_resultStandardSchemeFactory implements SchemeFactory {
      public getHrTeam_resultStandardScheme getScheme() {
        return new getHrTeam_resultStandardScheme();
      }
    }

    private static class getHrTeam_resultStandardScheme extends StandardScheme<getHrTeam_result> {
    ...
    private static class getHrTeam_resultTupleSchemeFactory implements SchemeFactory {
      public getHrTeam_resultTupleScheme getScheme() {
        return new getHrTeam_resultTupleScheme();
      }
    }

    private static class getHrTeam_resultTupleScheme extends TupleScheme<getHrTeam_result> {
