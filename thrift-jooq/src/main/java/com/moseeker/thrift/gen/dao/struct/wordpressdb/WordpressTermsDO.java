...
public class WordpressTermsDO implements org.apache.thrift.TBase<WordpressTermsDO, WordpressTermsDO._Fields>, java.io.Serializable, Cloneable, Comparable<WordpressTermsDO> {
  ...
  private static final org.apache.thrift.protocol.TField TERM_ID_FIELD_DESC = new org.apache.thrift.protocol.TField("termId", org.apache.thrift.protocol.TType.I64, (short)1);
  ...
  private static final org.apache.thrift.protocol.TField TERM_GROUP_FIELD_DESC = new org.apache.thrift.protocol.TField("termGroup", org.apache.thrift.protocol.TType.I64, (short)4);
  ...
  public long termGroup; // optional
  ...
  public WordpressTermsDO setTermId(long termId) {
    this.termId = termId;
    setTermIdIsSet(true);
    return this;
  }
  ...
  public WordpressTermsDO setName(String name) {
    this.name = name;
    return this;
  }
  ...
  public WordpressTermsDO setSlug(String slug) {
    this.slug = slug;
    return this;
  }
  ...
  public WordpressTermsDO setTermGroup(long termGroup) {
  ...
  public int hashCode() {
    ...
    if (isSetTermGroup())
      hashCode = hashCode * 8191 + org.apache.thrift.TBaseHelper.hashCode(termGroup);
  ...
  public int compareTo(WordpressTermsDO other) {
    ...
    lastComparison = Boolean.valueOf(isSetTermGroup()).compareTo(other.isSetTermGroup());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetTermGroup()) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("WordpressTermsDO(");
    boolean first = true;
  ...
  private static class WordpressTermsDOStandardScheme extends org.apache.thrift.scheme.StandardScheme<WordpressTermsDO> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, WordpressTermsDO struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 4: // TERM_GROUP
            if (schemeField.type == org.apache.thrift.protocol.TType.I64) {
              struct.termGroup = iprot.readI64();
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, WordpressTermsDO struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetTermGroup()) {
        ...
        oprot.writeI64(struct.termGroup);
        oprot.writeFieldEnd();
      }
