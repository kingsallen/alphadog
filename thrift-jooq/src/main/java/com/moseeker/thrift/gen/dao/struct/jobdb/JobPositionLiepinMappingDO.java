...
@javax.annotation.Generated(value = "Autogenerated by Thrift Compiler (0.10.0)", date = "2018-06-10")
public class JobPositionLiepinMappingDO implements org.apache.thrift.TBase<JobPositionLiepinMappingDO, JobPositionLiepinMappingDO._Fields>, java.io.Serializable, Cloneable, Comparable<JobPositionLiepinMappingDO> {
  ...
  private static final _Fields optionals[] = {_Fields.ID,_Fields.JOB_ID,_Fields.LIEPIN_JOB_ID,_Fields.CITY_CODE,_Fields.JOB_TITLE,_Fields.ERR_MSG,_Fields.STATE,_Fields.CREATE_TIME,_Fields.UPDATE_TIME};
  ...
  public JobPositionLiepinMappingDO setJobId(int jobId) {
    this.jobId = jobId;
    setJobIdIsSet(true);
    return this;
  }
