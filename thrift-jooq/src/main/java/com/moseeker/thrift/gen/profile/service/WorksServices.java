              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.works = new ArrayList<com.moseeker.thrift.gen.profile.struct.Works>(_list384.size);
                  com.moseeker.thrift.gen.profile.struct.Works _elem385;
                  for (int _i386 = 0; _i386 < _list384.size; ++_i386)
                  {
                    _elem385 = new com.moseeker.thrift.gen.profile.struct.Works();
                    _elem385.read(iprot);
                    struct.works.add(_elem385);
                  }
                  iprot.readListEnd();
                }
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, postResources_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.works != null) {
          oprot.writeFieldBegin(WORKS_FIELD_DESC);
          {
            ...
            for (com.moseeker.thrift.gen.profile.struct.Works _iter387 : struct.works)
            {
        ...
        if (struct.isSetWorks()) {
          {
            ...
            for (com.moseeker.thrift.gen.profile.struct.Works _iter388 : struct.works)
            {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.works = new ArrayList<com.moseeker.thrift.gen.profile.struct.Works>(_list389.size);
            com.moseeker.thrift.gen.profile.struct.Works _elem390;
            for (int _i391 = 0; _i391 < _list389.size; ++_i391)
            {
              _elem390 = new com.moseeker.thrift.gen.profile.struct.Works();
              _elem390.read(iprot);
              struct.works.add(_elem390);
            }
          }
          struct.setWorksIsSet(true);
        }
    ...
    private static class putResources_argsStandardScheme extends StandardScheme<putResources_args> {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.works = new ArrayList<com.moseeker.thrift.gen.profile.struct.Works>(_list392.size);
                  com.moseeker.thrift.gen.profile.struct.Works _elem393;
                  for (int _i394 = 0; _i394 < _list392.size; ++_i394)
                  {
                    _elem393 = new com.moseeker.thrift.gen.profile.struct.Works();
                    _elem393.read(iprot);
                    struct.works.add(_elem393);
                  }
                  iprot.readListEnd();
                }
                struct.setWorksIsSet(true);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, putResources_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.works != null) {
          ...
          {
            oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, struct.works.size()));
            for (com.moseeker.thrift.gen.profile.struct.Works _iter395 : struct.works)
            {
    ...
    private static class putResources_argsTupleScheme extends TupleScheme<putResources_args> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, putResources_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.isSetWorks()) {
          {
            oprot.writeI32(struct.works.size());
            for (com.moseeker.thrift.gen.profile.struct.Works _iter396 : struct.works)
            {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.works = new ArrayList<com.moseeker.thrift.gen.profile.struct.Works>(_list397.size);
            com.moseeker.thrift.gen.profile.struct.Works _elem398;
            for (int _i399 = 0; _i399 < _list397.size; ++_i399)
            {
              _elem398 = new com.moseeker.thrift.gen.profile.struct.Works();
              _elem398.read(iprot);
              struct.works.add(_elem398);
            }
          }
          struct.setWorksIsSet(true);
        }
    ...
    private static class delResources_argsStandardScheme extends StandardScheme<delResources_args> {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.works = new ArrayList<com.moseeker.thrift.gen.profile.struct.Works>(_list400.size);
                  com.moseeker.thrift.gen.profile.struct.Works _elem401;
                  for (int _i402 = 0; _i402 < _list400.size; ++_i402)
                  {
                    _elem401 = new com.moseeker.thrift.gen.profile.struct.Works();
                    _elem401.read(iprot);
                    struct.works.add(_elem401);
                  }
                  iprot.readListEnd();
                }
                struct.setWorksIsSet(true);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, delResources_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.works != null) {
          ...
          {
            oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, struct.works.size()));
            for (com.moseeker.thrift.gen.profile.struct.Works _iter403 : struct.works)
            {
    ...
    private static class delResources_argsTupleScheme extends TupleScheme<delResources_args> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, delResources_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.isSetWorks()) {
          {
            oprot.writeI32(struct.works.size());
            for (com.moseeker.thrift.gen.profile.struct.Works _iter404 : struct.works)
            {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.works = new ArrayList<com.moseeker.thrift.gen.profile.struct.Works>(_list405.size);
            com.moseeker.thrift.gen.profile.struct.Works _elem406;
            for (int _i407 = 0; _i407 < _list405.size; ++_i407)
            {
              _elem406 = new com.moseeker.thrift.gen.profile.struct.Works();
              _elem406.read(iprot);
              struct.works.add(_elem406);
            }
          }
          struct.setWorksIsSet(true);
        }
