            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.profileExts = new ArrayList<ProfileExt>(_list40.size);
                ProfileExt _elem41;
                for (int _i42 = 0; _i42 < _list40.size; ++_i42)
                {
                  _elem41 = new ProfileExt();
                  _elem41.read(iprot);
                  struct.profileExts.add(_elem41);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ProfileExtPagination struct) throws org.apache.thrift.TException {
      ...
      if (struct.profileExts != null) {
        oprot.writeFieldBegin(PROFILE_EXTS_FIELD_DESC);
        {
          ...
          for (ProfileExt _iter43 : struct.profileExts)
          {
            _iter43.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.isSetProfileExts()) {
        {
          ...
          for (ProfileExt _iter44 : struct.profileExts)
          {
            _iter44.write(oprot);
          }
        }
      ...
      if (incoming.get(4)) {
        {
          ...
          struct.profileExts = new ArrayList<ProfileExt>(_list45.size);
          ProfileExt _elem46;
          for (int _i47 = 0; _i47 < _list45.size; ++_i47)
          {
            _elem46 = new ProfileExt();
            _elem46.read(iprot);
            struct.profileExts.add(_elem46);
          }
        }
        struct.setProfileExtsIsSet(true);
      }
