...
public class BatchHandlerJobPostion implements org.apache.thrift.TBase<BatchHandlerJobPostion, BatchHandlerJobPostion._Fields>, java.io.Serializable, Cloneable, Comparable<BatchHandlerJobPostion> {
  ...
  private static final org.apache.thrift.protocol.TField IS_CREATE_DEPARMENT_FIELD_DESC = new org.apache.thrift.protocol.TField("isCreateDeparment", org.apache.thrift.protocol.TType.BOOL, (short)6);
  ...
  public String fields_nohash; // required
  public boolean isCreateDeparment; // required
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    IS_CREATE_DEPARMENT((short)6, "isCreateDeparment");
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        ...
        case 6: // IS_CREATE_DEPARMENT
          return IS_CREATE_DEPARMENT;
        default:
          return null;
      }
    }
  ...
  private static final int __ISCREATEDEPARMENT_ISSET_ID = 2;
  ...
  static {
    ...
    tmpMap.put(_Fields.FIELDS_NOHASH, new org.apache.thrift.meta_data.FieldMetaData("fields_nohash", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
    tmpMap.put(_Fields.IS_CREATE_DEPARMENT, new org.apache.thrift.meta_data.FieldMetaData("isCreateDeparment", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.BOOL)));
  ...
  public BatchHandlerJobPostion(
    ...
    String fields_nooverwrite,
    boolean nodelete,
    String fields_nohash,
    boolean isCreateDeparment)
  {
    this();
    this.appid = appid;
    setAppidIsSet(true);
    ...
    this.isCreateDeparment = isCreateDeparment;
    setIsCreateDeparmentIsSet(true);
  }
  ...
  public BatchHandlerJobPostion(BatchHandlerJobPostion other) {
    ...
    if (other.isSetData()) {
      ...
      for (JobPostrionObj other_element : other.data) {
        __this__data.add(new JobPostrionObj(other_element));
      }
    ...
    this.isCreateDeparment = other.isCreateDeparment;
  }
  ...
  public void clear() {
    ...
    setIsCreateDeparmentIsSet(false);
    this.isCreateDeparment = false;
  }
  ...
  public String getFields_nooverwrite() {
    return this.fields_nooverwrite;
  }

  public BatchHandlerJobPostion setFields_nooverwrite(String fields_nooverwrite) {
    this.fields_nooverwrite = fields_nooverwrite;
    return this;
  }
  ...
  public String getFields_nohash() {
    return this.fields_nohash;
  }

  public BatchHandlerJobPostion setFields_nohash(String fields_nohash) {
    this.fields_nohash = fields_nohash;
    return this;
  }
  ...
  public boolean isIsCreateDeparment() {
    return this.isCreateDeparment;
  }

  public BatchHandlerJobPostion setIsCreateDeparment(boolean isCreateDeparment) {
    this.isCreateDeparment = isCreateDeparment;
    setIsCreateDeparmentIsSet(true);
    return this;
  }

  public void unsetIsCreateDeparment() {
    __isset_bitfield = org.apache.thrift.EncodingUtils.clearBit(__isset_bitfield, __ISCREATEDEPARMENT_ISSET_ID);
  }

  /** Returns true if field isCreateDeparment is set (has been assigned a value) and false otherwise */
  public boolean isSetIsCreateDeparment() {
    return org.apache.thrift.EncodingUtils.testBit(__isset_bitfield, __ISCREATEDEPARMENT_ISSET_ID);
  }

  public void setIsCreateDeparmentIsSet(boolean value) {
    __isset_bitfield = org.apache.thrift.EncodingUtils.setBit(__isset_bitfield, __ISCREATEDEPARMENT_ISSET_ID, value);
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case FIELDS_NOOVERWRITE:
      if (value == null) {
        ...
        setFields_nooverwrite((String)value);
      }
      break;
    ...
    case FIELDS_NOHASH:
      if (value == null) {
        ...
        setFields_nohash((String)value);
      }
      break;

    case IS_CREATE_DEPARMENT:
      if (value == null) {
        unsetIsCreateDeparment();
      } else {
        setIsCreateDeparment((Boolean)value);
      }
      break;
  ...
  public boolean equals(BatchHandlerJobPostion that) {
    ...
    boolean this_present_isCreateDeparment = true;
    boolean that_present_isCreateDeparment = true;
    if (this_present_isCreateDeparment || that_present_isCreateDeparment) {
      if (!(this_present_isCreateDeparment && that_present_isCreateDeparment))
        return false;
      if (this.isCreateDeparment != that.isCreateDeparment)
        return false;
    }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isCreateDeparment) ? 131071 : 524287);
  ...
  public int compareTo(BatchHandlerJobPostion other) {
    ...
    lastComparison = Boolean.valueOf(isSetFields_nooverwrite()).compareTo(other.isSetFields_nooverwrite());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetFields_nooverwrite()) {
    ...
    lastComparison = Boolean.valueOf(isSetNodelete()).compareTo(other.isSetNodelete());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetNodelete()) {
    ...
    lastComparison = Boolean.valueOf(isSetFields_nohash()).compareTo(other.isSetFields_nohash());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetFields_nohash()) {
    ...
    lastComparison = Boolean.valueOf(isSetIsCreateDeparment()).compareTo(other.isSetIsCreateDeparment());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetIsCreateDeparment()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.isCreateDeparment, other.isCreateDeparment);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("BatchHandlerJobPostion(");
    boolean first = true;
    ...
    first = false;
    if (!first) sb.append(", ");
    sb.append("isCreateDeparment:");
    sb.append(this.isCreateDeparment);
    first = false;
    sb.append(")");
    return sb.toString();
  }
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, BatchHandlerJobPostion struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.data = new java.util.ArrayList<JobPostrionObj>(_list42.size);
                JobPostrionObj _elem43;
                for (int _i44 = 0; _i44 < _list42.size; ++_i44)
                {
                  _elem43 = new JobPostrionObj();
                  _elem43.read(iprot);
                  struct.data.add(_elem43);
                }
                iprot.readListEnd();
              }
          ...
          case 6: // IS_CREATE_DEPARMENT
            if (schemeField.type == org.apache.thrift.protocol.TType.BOOL) {
              struct.isCreateDeparment = iprot.readBool();
              struct.setIsCreateDeparmentIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, BatchHandlerJobPostion struct) throws org.apache.thrift.TException {
      ...
      if (struct.data != null) {
        oprot.writeFieldBegin(DATA_FIELD_DESC);
        {
          ...
          for (JobPostrionObj _iter45 : struct.data)
          {
            _iter45.write(oprot);
          }
          oprot.writeListEnd();
      ...
      oprot.writeFieldBegin(IS_CREATE_DEPARMENT_FIELD_DESC);
      oprot.writeBool(struct.isCreateDeparment);
      oprot.writeFieldEnd();
  ...
  private static class BatchHandlerJobPostionTupleScheme extends org.apache.thrift.scheme.TupleScheme<BatchHandlerJobPostion> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, BatchHandlerJobPostion struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetIsCreateDeparment()) {
        optionals.set(5);
      }
      ...
      if (struct.isSetData()) {
        {
          ...
          for (JobPostrionObj _iter46 : struct.data)
          {
            _iter46.write(oprot);
          }
        }
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.data = new java.util.ArrayList<JobPostrionObj>(_list47.size);
          JobPostrionObj _elem48;
          for (int _i49 = 0; _i49 < _list47.size; ++_i49)
          {
            _elem48 = new JobPostrionObj();
            _elem48.read(iprot);
            struct.data.add(_elem48);
          }
        }
        struct.setDataIsSet(true);
      }
