...
public class HrWxHrChatListDO implements org.apache.thrift.TBase<HrWxHrChatListDO, HrWxHrChatListDO._Fields>, java.io.Serializable, Cloneable, Comparable<HrWxHrChatListDO> {
  ...
  public HrWxHrChatListDO setChatlistId(int chatlistId) {
  ...
  public HrWxHrChatListDO setContent(java.lang.String content) {
  ...
  public HrWxHrChatListDO setPid(int pid) {
    this.pid = pid;
    setPidIsSet(true);
    return this;
  }
  ...
  public HrWxHrChatListDO setSpeaker(boolean speaker) {
