...
public class UserBdUserDO implements org.apache.thrift.TBase<UserBdUserDO, UserBdUserDO._Fields>, java.io.Serializable, Cloneable, Comparable<UserBdUserDO> {
  ...
  public UserBdUserDO setId(long id) {
    this.id = id;
    setIdIsSet(true);
    return this;
  }
  ...
  public UserBdUserDO setUid(long uid) {
    this.uid = uid;
    setUidIsSet(true);
    return this;
  }
  ...
  public UserBdUserDO setUsername(String username) {
  ...
  public UserBdUserDO setHeadimgurl(String headimgurl) {
  ...
  public UserBdUserDO setCreateTime(String createTime) {
  ...
  public UserBdUserDO setUpdateTime(String updateTime) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("UserBdUserDO(");
    boolean first = true;
