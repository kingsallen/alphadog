...
public class DictDao {
  ...
  public interface AsyncIface {
    ...
    public void getDictMap(com.moseeker.thrift.gen.common.struct.CommonQuery query, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public static class getDictMap_call extends org.apache.thrift.async.TAsyncMethodCall {
      private com.moseeker.thrift.gen.common.struct.CommonQuery query;
      public getDictMap_call(com.moseeker.thrift.gen.common.struct.CommonQuery query, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class getDictMap<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, getDictMap_args, com.moseeker.thrift.gen.dict.struct.CityMap> {
      ...
      public AsyncMethodCallback<com.moseeker.thrift.gen.dict.struct.CityMap> getResultHandler(final AsyncFrameBuffer fb, final int seqid) {
        final org.apache.thrift.AsyncProcessFunction fcall = this;
        return new AsyncMethodCallback<com.moseeker.thrift.gen.dict.struct.CityMap>() { 
      ...
      public void start(I iface, getDictMap_args args, org.apache.thrift.async.AsyncMethodCallback<com.moseeker.thrift.gen.dict.struct.CityMap> resultHandler) throws TException {
  ...
  public static class getDictMap_args implements org.apache.thrift.TBase<getDictMap_args, getDictMap_args._Fields>, java.io.Serializable, Cloneable, Comparable<getDictMap_args>   {
    ...
    static {
      schemes.put(StandardScheme.class, new getDictMap_argsStandardSchemeFactory());
      schemes.put(TupleScheme.class, new getDictMap_argsTupleSchemeFactory());
    }
    ...
    public String toString() {
      StringBuilder sb = new StringBuilder("getDictMap_args(");
      boolean first = true;
    ...
    private static class getDictMap_argsStandardSchemeFactory implements SchemeFactory {
      public getDictMap_argsStandardScheme getScheme() {
        return new getDictMap_argsStandardScheme();
      }
    }

    private static class getDictMap_argsStandardScheme extends StandardScheme<getDictMap_args> {
    ...
    private static class getDictMap_argsTupleSchemeFactory implements SchemeFactory {
      public getDictMap_argsTupleScheme getScheme() {
        return new getDictMap_argsTupleScheme();
      }
    }

    private static class getDictMap_argsTupleScheme extends TupleScheme<getDictMap_args> {
  ...
  public static class getDictMap_result implements org.apache.thrift.TBase<getDictMap_result, getDictMap_result._Fields>, java.io.Serializable, Cloneable, Comparable<getDictMap_result>   {
    ...
    private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
    static {
      schemes.put(StandardScheme.class, new getDictMap_resultStandardSchemeFactory());
      schemes.put(TupleScheme.class, new getDictMap_resultTupleSchemeFactory());
    }
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("getDictMap_result(");
      boolean first = true;
    ...
    private static class getDictMap_resultStandardSchemeFactory implements SchemeFactory {
      public getDictMap_resultStandardScheme getScheme() {
        return new getDictMap_resultStandardScheme();
      }
    }

    private static class getDictMap_resultStandardScheme extends StandardScheme<getDictMap_result> {
    ...
    private static class getDictMap_resultTupleSchemeFactory implements SchemeFactory {
      public getDictMap_resultTupleScheme getScheme() {
        return new getDictMap_resultTupleScheme();
      }
    }

    private static class getDictMap_resultTupleScheme extends TupleScheme<getDictMap_result> {
