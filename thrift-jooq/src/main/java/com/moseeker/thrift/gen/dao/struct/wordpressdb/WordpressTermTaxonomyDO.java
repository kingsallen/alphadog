...
public class WordpressTermTaxonomyDO implements org.apache.thrift.TBase<WordpressTermTaxonomyDO, WordpressTermTaxonomyDO._Fields>, java.io.Serializable, Cloneable, Comparable<WordpressTermTaxonomyDO> {
  ...
  public WordpressTermTaxonomyDO setTermTaxonomyId(long termTaxonomyId) {
  ...
  public WordpressTermTaxonomyDO setTermId(long termId) {
    this.termId = termId;
    setTermIdIsSet(true);
    return this;
  }
  ...
  public WordpressTermTaxonomyDO setTaxonomy(String taxonomy) {
  ...
  public WordpressTermTaxonomyDO setDescription(String description) {
  ...
  public WordpressTermTaxonomyDO setParent(long parent) {
    this.parent = parent;
    setParentIsSet(true);
    return this;
  }
  ...
  public WordpressTermTaxonomyDO setCount(long count) {
    this.count = count;
    setCountIsSet(true);
    return this;
  }
  ...
  public int compareTo(WordpressTermTaxonomyDO other) {
    ...
    lastComparison = Boolean.valueOf(isSetTaxonomy()).compareTo(other.isSetTaxonomy());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetTaxonomy()) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("WordpressTermTaxonomyDO(");
    boolean first = true;
