            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.data = new java.util.ArrayList<HrNpsInfo>(_list24.size);
                HrNpsInfo _elem25;
                for (int _i26 = 0; _i26 < _list24.size; ++_i26)
                {
                  _elem25 = new HrNpsInfo();
                  _elem25.read(iprot);
      ...
      if (struct.data != null) {
        if (struct.isSetData()) {
          oprot.writeFieldBegin(DATA_FIELD_DESC);
          {
            ...
            for (HrNpsInfo _iter27 : struct.data)
            {
              _iter27.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.isSetData()) {
        {
          ...
          for (HrNpsInfo _iter28 : struct.data)
          {
            _iter28.write(oprot);
          }
        }
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.data = new java.util.ArrayList<HrNpsInfo>(_list29.size);
          HrNpsInfo _elem30;
          for (int _i31 = 0; _i31 < _list29.size; ++_i31)
          {
            _elem30 = new HrNpsInfo();
            _elem30.read(iprot);
