...
public class SearchCondition implements org.apache.thrift.TBase<SearchCondition, SearchCondition._Fields>, java.io.Serializable, Cloneable, Comparable<SearchCondition> {
  ...
  private static final org.apache.thrift.protocol.TField CANDIDATE_SOURCE_FIELD_DESC = new org.apache.thrift.protocol.TField("candidate_source", org.apache.thrift.protocol.TType.I32, (short)22);
  ...
  private static final org.apache.thrift.protocol.TField ORIGINS_FIELD_DESC = new org.apache.thrift.protocol.TField("origins", org.apache.thrift.protocol.TType.I32, (short)24);
  ...
  private static final org.apache.thrift.protocol.TField IS_FRESH_GRADUATES_FIELD_DESC = new org.apache.thrift.protocol.TField("is_fresh_graduates", org.apache.thrift.protocol.TType.I32, (short)26);
  private static final org.apache.thrift.protocol.TField TAG_ID_FIELD_DESC = new org.apache.thrift.protocol.TField("tag_id", org.apache.thrift.protocol.TType.I32, (short)27);
  private static final org.apache.thrift.protocol.TField FAVORITE_HRS_FIELD_DESC = new org.apache.thrift.protocol.TField("favorite_hrs", org.apache.thrift.protocol.TType.STRING, (short)28);
  ...
  public int origins; // required
  public int is_recommend; // required
  public int is_fresh_graduates; // required
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    IS_FRESH_GRADUATES((short)26, "is_fresh_graduates"),
    TAG_ID((short)27, "tag_id"),
    FAVORITE_HRS((short)28, "favorite_hrs");
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        ...
        case 25: // IS_RECOMMEND
          return IS_RECOMMEND;
        case 26: // IS_FRESH_GRADUATES
          return IS_FRESH_GRADUATES;
        case 27: // TAG_ID
          return TAG_ID;
        case 28: // FAVORITE_HRS
          return FAVORITE_HRS;
        default:
          return null;
      }
  ...
  private static final int __CANDIDATE_SOURCE_ISSET_ID = 9;
  private static final int __IS_PUBLIC_ISSET_ID = 10;
  private static final int __ORIGINS_ISSET_ID = 11;
  private static final int __IS_RECOMMEND_ISSET_ID = 12;
  private static final int __IS_FRESH_GRADUATES_ISSET_ID = 13;
  private static final int __TAG_ID_ISSET_ID = 14;
  ...
  static {
    ...
    tmpMap.put(_Fields.IS_RECOMMEND, new org.apache.thrift.meta_data.FieldMetaData("is_recommend", org.apache.thrift.TFieldRequirementType.DEFAULT,
            new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I32)));
    tmpMap.put(_Fields.IS_FRESH_GRADUATES, new org.apache.thrift.meta_data.FieldMetaData("is_fresh_graduates", org.apache.thrift.TFieldRequirementType.DEFAULT,
            new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I32)));
          ...
          java.lang.String favorite_hrs)
  {
    ...
    setOriginsIsSet(true);
    this.is_recommend = is_recommend;
    setIs_recommendIsSet(true);
    this.is_fresh_graduates = is_fresh_graduates;
    setIs_fresh_graduatesIsSet(true);
    this.tag_id = tag_id;
    setTag_idIsSet(true);
  ...
  public SearchCondition(SearchCondition other) {
    ...
    this.is_fresh_graduates = other.is_fresh_graduates;
  ...
  public void clear() {
    ...
    this.is_public = 0;
    setOriginsIsSet(false);
    this.origins = 0;
    setIs_recommendIsSet(false);
    this.is_recommend = 0;
    setIs_fresh_graduatesIsSet(false);
    this.is_fresh_graduates = 0;
  ...
  public SearchCondition setCandidate_source(int candidate_source) {
    this.candidate_source = candidate_source;
    setCandidate_sourceIsSet(true);
    return this;
  }
  ...
  public SearchCondition setOrigins(int origins) {
    this.origins = origins;
    setOriginsIsSet(true);
    return this;
  }
  ...
  public void unsetOrigins() {
    __isset_bitfield = org.apache.thrift.EncodingUtils.clearBit(__isset_bitfield, __ORIGINS_ISSET_ID);
  }

  /** Returns true if field origins is set (has been assigned a value) and false otherwise */
  public boolean isSetOrigins() {
    return org.apache.thrift.EncodingUtils.testBit(__isset_bitfield, __ORIGINS_ISSET_ID);
  }

  public void setOriginsIsSet(boolean value) {
    __isset_bitfield = org.apache.thrift.EncodingUtils.setBit(__isset_bitfield, __ORIGINS_ISSET_ID, value);
  }
  ...
  public int getIs_fresh_graduates() {
    return this.is_fresh_graduates;
  }

  public SearchCondition setIs_fresh_graduates(int is_fresh_graduates) {
    this.is_fresh_graduates = is_fresh_graduates;
    setIs_fresh_graduatesIsSet(true);
    return this;
  }

  public void unsetIs_fresh_graduates() {
    __isset_bitfield = org.apache.thrift.EncodingUtils.clearBit(__isset_bitfield, __IS_FRESH_GRADUATES_ISSET_ID);
  }

  /** Returns true if field is_fresh_graduates is set (has been assigned a value) and false otherwise */
  public boolean isSetIs_fresh_graduates() {
    return org.apache.thrift.EncodingUtils.testBit(__isset_bitfield, __IS_FRESH_GRADUATES_ISSET_ID);
  }

  public void setIs_fresh_graduatesIsSet(boolean value) {
    __isset_bitfield = org.apache.thrift.EncodingUtils.setBit(__isset_bitfield, __IS_FRESH_GRADUATES_ISSET_ID, value);
  }
  ...
  public SearchCondition setTag_id(int tag_id) {
    this.tag_id = tag_id;
    setTag_idIsSet(true);
    return this;
  }
    ...
    switch (field) {
      ...
      case ORIGINS:
        if (value == null) {
          ...
          setOrigins((java.lang.Integer)value);
        }
        break;
      ...
      case IS_FRESH_GRADUATES:
        if (value == null) {
          unsetIs_fresh_graduates();
        } else {
          setIs_fresh_graduates((java.lang.Integer)value);
        }
        break;
  ...
  public boolean isSet(_Fields field) {
    ...
    switch (field) {
      ...
      case IS_FRESH_GRADUATES:
        return isSetIs_fresh_graduates();
      case TAG_ID:
        return isSetTag_id();
      case FAVORITE_HRS:
  ...
  public boolean equals(SearchCondition that) {
    ...
    boolean this_present_origins = true;
    boolean that_present_origins = true;
    if (this_present_origins || that_present_origins) {
      if (!(this_present_origins && that_present_origins))
        return false;
      if (this.origins != that.origins)
        return false;
    }
    ...
    boolean this_present_is_fresh_graduates = true;
    boolean that_present_is_fresh_graduates = true;
    if (this_present_is_fresh_graduates || that_present_is_fresh_graduates) {
      if (!(this_present_is_fresh_graduates && that_present_is_fresh_graduates))
        return false;
      if (this.is_fresh_graduates != that.is_fresh_graduates)
        return false;
    }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + origins;

    hashCode = hashCode * 8191 + is_recommend;

    hashCode = hashCode * 8191 + is_fresh_graduates;
  ...
  public int compareTo(SearchCondition other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetIs_fresh_graduates()).compareTo(other.isSetIs_fresh_graduates());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetIs_fresh_graduates()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.is_fresh_graduates, other.is_fresh_graduates);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public java.lang.String toString() {
    ...
    first = false;
    if (!first) sb.append(", ");
    sb.append("is_fresh_graduates:");
    sb.append(this.is_fresh_graduates);
    first = false;
    if (!first) sb.append(", ");
    sb.append("tag_id:");
  ...
  private static class SearchConditionStandardScheme extends org.apache.thrift.scheme.StandardScheme<SearchCondition> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, SearchCondition struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 26: // IS_FRESH_GRADUATES
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.is_fresh_graduates = iprot.readI32();
              struct.setIs_fresh_graduatesIsSet(true);
            } else {
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, SearchCondition struct) throws org.apache.thrift.TException {
      ...
      oprot.writeI32(struct.origins);
      oprot.writeFieldEnd();
      oprot.writeFieldBegin(IS_RECOMMEND_FIELD_DESC);
      oprot.writeI32(struct.is_recommend);
      oprot.writeFieldEnd();
      oprot.writeFieldBegin(IS_FRESH_GRADUATES_FIELD_DESC);
      oprot.writeI32(struct.is_fresh_graduates);
      oprot.writeFieldEnd();
  ...
  private static class SearchConditionTupleScheme extends org.apache.thrift.scheme.TupleScheme<SearchCondition> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, SearchCondition struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetIs_fresh_graduates()) {
        optionals.set(25);
      }
