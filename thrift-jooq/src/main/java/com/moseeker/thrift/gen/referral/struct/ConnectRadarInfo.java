...
public class ConnectRadarInfo implements org.apache.thrift.TBase<ConnectRadarInfo, ConnectRadarInfo._Fields>, java.io.Serializable, Cloneable, Comparable<ConnectRadarInfo> {
  ...
  private static final _Fields optionals[] = {_Fields.CHAIN_ID,_Fields.RECOM_USER_ID,_Fields.NEXT_USER_ID};
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case CHAIN_ID:
      if (value == null) {
        ...
        setChainId((java.lang.Integer)value);
      }
      break;
    ...
    case NEXT_USER_ID:
      if (value == null) {
        ...
        setNextUserId((java.lang.Integer)value);
      }
      break;
  ...
  public int compareTo(ConnectRadarInfo other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetChainId()).compareTo(other.isSetChainId());
    if (lastComparison != 0) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetNextUserId()).compareTo(other.isSetNextUserId());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetNextUserId()) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("ConnectRadarInfo(");
    boolean first = true;
