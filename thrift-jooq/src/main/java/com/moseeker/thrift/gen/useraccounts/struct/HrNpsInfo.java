...
public class HrNpsInfo implements org.apache.thrift.TBase<HrNpsInfo, HrNpsInfo._Fields>, java.io.Serializable, Cloneable, Comparable<HrNpsInfo> {
  ...
  private static final org.apache.thrift.protocol.TField COMPANY_ID_FIELD_DESC = new org.apache.thrift.protocol.TField("company_id", org.apache.thrift.protocol.TType.I32, (short)12);
  private static final org.apache.thrift.protocol.TField COMPANY_TYPE_FIELD_DESC = new org.apache.thrift.protocol.TField("company_type", org.apache.thrift.protocol.TType.I32, (short)13);
  ...
  public int company_type; // optional
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    COMPANY_ID((short)12, "company_id"),
    COMPANY_TYPE((short)13, "company_type");
  ...
  private static final int __COMPANY_TYPE_ISSET_ID = 6;
  private byte __isset_bitfield = 0;
  private static final _Fields optionals[] = {_Fields.ID,_Fields.DATE,_Fields.HR_ACCOUNT_ID,_Fields.HR_MOBILE,_Fields.HR_ACCOUNT_TYPE,_Fields.COMPANY,_Fields.INTENTION,_Fields.ACCEPT_CONTACT,_Fields.RECOMMEND_USER,_Fields.RECOMMEND_MOBILE,_Fields.RECOMMEND_COMPANY,_Fields.COMPANY_ID,_Fields.COMPANY_TYPE};
  ...
  static {
    ...
    tmpMap.put(_Fields.COMPANY_ID, new org.apache.thrift.meta_data.FieldMetaData("company_id", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I32)));
    tmpMap.put(_Fields.COMPANY_TYPE, new org.apache.thrift.meta_data.FieldMetaData("company_type", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I32)));
  ...
  public HrNpsInfo(HrNpsInfo other) {
    ...
    this.company_type = other.company_type;
  }
  ...
  public HrNpsInfo setCompany_id(int company_id) {
  ...
  public HrNpsInfo setCompany_type(int company_type) {
    this.company_type = company_type;
    setCompany_typeIsSet(true);
    return this;
  }

  public void unsetCompany_type() {
    __isset_bitfield = org.apache.thrift.EncodingUtils.clearBit(__isset_bitfield, __COMPANY_TYPE_ISSET_ID);
  }

  /** Returns true if field company_type is set (has been assigned a value) and false otherwise */
  public boolean isSetCompany_type() {
    return org.apache.thrift.EncodingUtils.testBit(__isset_bitfield, __COMPANY_TYPE_ISSET_ID);
  }

  public void setCompany_typeIsSet(boolean value) {
    __isset_bitfield = org.apache.thrift.EncodingUtils.setBit(__isset_bitfield, __COMPANY_TYPE_ISSET_ID, value);
  }
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case COMPANY_TYPE:
      if (value == null) {
        ...
        setCompany_type((java.lang.Integer)value);
      }
      break;
  ...
  public boolean equals(HrNpsInfo that) {
    ...
    boolean this_present_company_type = true && this.isSetCompany_type();
    boolean that_present_company_type = true && that.isSetCompany_type();
    if (this_present_company_type || that_present_company_type) {
      if (!(this_present_company_type && that_present_company_type))
        return false;
      if (this.company_type != that.company_type)
        return false;
    }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetCompany_type()) ? 131071 : 524287);
    if (isSetCompany_type())
      hashCode = hashCode * 8191 + company_type;
  ...
  public int compareTo(HrNpsInfo other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetCompany_type()).compareTo(other.isSetCompany_type());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetCompany_type()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.company_type, other.company_type);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  private static class HrNpsInfoStandardScheme extends org.apache.thrift.scheme.StandardScheme<HrNpsInfo> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, HrNpsInfo struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 13: // COMPANY_TYPE
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.company_type = iprot.readI32();
              struct.setCompany_typeIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, HrNpsInfo struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetCompany_type()) {
        oprot.writeFieldBegin(COMPANY_TYPE_FIELD_DESC);
        oprot.writeI32(struct.company_type);
        oprot.writeFieldEnd();
      }
