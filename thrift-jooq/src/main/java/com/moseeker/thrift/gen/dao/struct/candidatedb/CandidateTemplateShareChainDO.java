...
@javax.annotation.Generated(value = "Autogenerated by Thrift Compiler (0.10.0)", date = "2018-12-31")
public class CandidateTemplateShareChainDO implements org.apache.thrift.TBase<CandidateTemplateShareChainDO, CandidateTemplateShareChainDO._Fields>, java.io.Serializable, Cloneable, Comparable<CandidateTemplateShareChainDO> {
  ...
  private static final org.apache.thrift.protocol.TField ROOT2_USER_ID_FIELD_DESC = new org.apache.thrift.protocol.TField("root2UserId", org.apache.thrift.protocol.TType.I32, (short)4);
  ...
  private static final org.apache.thrift.protocol.TField SEEK_REFERRAL_FIELD_DESC = new org.apache.thrift.protocol.TField("seekReferral", org.apache.thrift.protocol.TType.I32, (short)9);
  ...
  public int seekReferral; // optional
  ...
  private static final int __ROOT2USERID_ISSET_ID = 3;
  ...
  private static final int __SEEKREFERRAL_ISSET_ID = 8;
  private static final int __TYPE_ISSET_ID = 9;
  private static final int __SENDTIME_ISSET_ID = 10;
  private short __isset_bitfield = 0;
  private static final _Fields optionals[] = {_Fields.ID,_Fields.POSITION_ID,_Fields.ROOT_USER_ID,_Fields.ROOT2_USER_ID,_Fields.RECOM_USER_ID,_Fields.PRESENTEE_USER_ID,_Fields.DEPTH,_Fields.PARENT_ID,_Fields.SEEK_REFERRAL,_Fields.TYPE,_Fields.SEND_TIME};
  ...
  static {
    ...
    tmpMap.put(_Fields.PARENT_ID, new org.apache.thrift.meta_data.FieldMetaData("parentId", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I32)));
    tmpMap.put(_Fields.SEEK_REFERRAL, new org.apache.thrift.meta_data.FieldMetaData("seekReferral", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I32)));
  ...
  public CandidateTemplateShareChainDO(CandidateTemplateShareChainDO other) {
    ...
    this.seekReferral = other.seekReferral;
  ...
  public int getSeekReferral() {
    return this.seekReferral;
  }

  public CandidateTemplateShareChainDO setSeekReferral(int seekReferral) {
    this.seekReferral = seekReferral;
    setSeekReferralIsSet(true);
    return this;
  }

  public void unsetSeekReferral() {
    __isset_bitfield = org.apache.thrift.EncodingUtils.clearBit(__isset_bitfield, __SEEKREFERRAL_ISSET_ID);
  }

  /** Returns true if field seekReferral is set (has been assigned a value) and false otherwise */
  public boolean isSetSeekReferral() {
    return org.apache.thrift.EncodingUtils.testBit(__isset_bitfield, __SEEKREFERRAL_ISSET_ID);
  }

  public void setSeekReferralIsSet(boolean value) {
    __isset_bitfield = org.apache.thrift.EncodingUtils.setBit(__isset_bitfield, __SEEKREFERRAL_ISSET_ID, value);
  }
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case ROOT_USER_ID:
      if (value == null) {
        ...
        setRootUserId((java.lang.Integer)value);
      }
      break;
    ...
    case ROOT2_USER_ID:
      if (value == null) {
        ...
        setRoot2UserId((java.lang.Integer)value);
      }
      break;
    ...
    case SEEK_REFERRAL:
      if (value == null) {
        ...
        setSeekReferral((java.lang.Integer)value);
      }
      break;
  ...
  public boolean equals(CandidateTemplateShareChainDO that) {
    ...
    boolean this_present_seekReferral = true && this.isSetSeekReferral();
    boolean that_present_seekReferral = true && that.isSetSeekReferral();
    if (this_present_seekReferral || that_present_seekReferral) {
      if (!(this_present_seekReferral && that_present_seekReferral))
        return false;
      if (this.seekReferral != that.seekReferral)
        return false;
    }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetSeekReferral()) ? 131071 : 524287);
    if (isSetSeekReferral())
      hashCode = hashCode * 8191 + seekReferral;
  ...
  public int compareTo(CandidateTemplateShareChainDO other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetRootUserId()).compareTo(other.isSetRootUserId());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetRootUserId()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetRoot2UserId()).compareTo(other.isSetRoot2UserId());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetRoot2UserId()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetSeekReferral()).compareTo(other.isSetSeekReferral());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetSeekReferral()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.seekReferral, other.seekReferral);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("CandidateTemplateShareChainDO(");
    boolean first = true;
    ...
    if (isSetSeekReferral()) {
      if (!first) sb.append(", ");
      sb.append("seekReferral:");
      sb.append(this.seekReferral);
      first = false;
    }
    if (isSetType()) {
      if (!first) sb.append(", ");
  ...
  private static class CandidateTemplateShareChainDOStandardScheme extends org.apache.thrift.scheme.StandardScheme<CandidateTemplateShareChainDO> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, CandidateTemplateShareChainDO struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 9: // SEEK_REFERRAL
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.seekReferral = iprot.readI32();
              struct.setSeekReferralIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, CandidateTemplateShareChainDO struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetSeekReferral()) {
        oprot.writeFieldBegin(SEEK_REFERRAL_FIELD_DESC);
        oprot.writeI32(struct.seekReferral);
        oprot.writeFieldEnd();
      }
      if (struct.isSetType()) {
