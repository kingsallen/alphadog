...
public class ChatVO implements org.apache.thrift.TBase<ChatVO, ChatVO._Fields>, java.io.Serializable, Cloneable, Comparable<ChatVO> {
  ...
  public String assetUrl; // optional
  ...
  private static final _Fields optionals[] = {_Fields.SERVER_ID, _Fields.CONTENT, _Fields.SPEAKER, _Fields.ORIGIN, _Fields.ORIGIN_STR, _Fields.MSG_TYPE, _Fields.ASSET_URL, _Fields.BTN_CONTENT, _Fields.ROOM_ID, _Fields.POSITION_ID, _Fields.DURATION, _Fields.ID, _Fields.CREATE_TIME};
  ...
  public ChatVO setServerId(String serverId) {
  ...
  public ChatVO setAssetUrl(String assetUrl) {
  ...
  public ChatVO setCreateTime(String createTime) {
  ...
  public int compareTo(ChatVO other) {
    ...
    lastComparison = Boolean.valueOf(isSetAssetUrl()).compareTo(other.isSetAssetUrl());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetAssetUrl()) {
