...
public class JobApplication implements org.apache.thrift.TBase<JobApplication, JobApplication._Fields>, java.io.Serializable, Cloneable, Comparable<JobApplication> {
  ...
  private static final org.apache.thrift.protocol.TField CHANNEL_FIELD_DESC = new org.apache.thrift.protocol.TField("channel", org.apache.thrift.protocol.TType.LIST, (short)32);
  ...
  public java.util.List<java.util.Map<String, String>> channel; // optional
  ...
  public JobApplication(JobApplication other) {
    ...
    if (other.isSetChannel()) {
      java.util.List<java.util.Map<String, String>> __this__channel = new java.util.ArrayList<java.util.Map<String, String>>(other.channel.size());
      for (java.util.Map<String, String> other_element : other.channel) {
        java.util.Map<String, String> __this__channel_copy = new java.util.HashMap<String, String>(other_element);
        __this__channel.add(__this__channel_copy);
      }
  ...
  public java.util.Iterator<java.util.Map<String, String>> getChannelIterator() {
    return (this.channel == null) ? null : this.channel.iterator();
  }

  public void addToChannel(java.util.Map<String, String> elem) {
    if (this.channel == null) {
      this.channel = new java.util.ArrayList<java.util.Map<String, String>>();
    }
    this.channel.add(elem);
  }

  public java.util.List<java.util.Map<String, String>> getChannel() {
    return this.channel;
  }

  public JobApplication setChannel(java.util.List<java.util.Map<String, String>> channel) {
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case CHANNEL:
      if (value == null) {
        ...
        setChannel((java.util.List<java.util.Map<String, String>>)value);
      }
      break;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.channel = new java.util.ArrayList<java.util.Map<String, String>>(_list0.size);
                java.util.Map<String, String> _elem1;
                for (int _i2 = 0; _i2 < _list0.size; ++_i2)
                {
                  {
                    org.apache.thrift.protocol.TMap _map3 = iprot.readMapBegin();
                    _elem1 = new java.util.HashMap<String, String>(2*_map3.size);
                    String _key4;
                    String _val5;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, JobApplication struct) throws org.apache.thrift.TException {
      ...
      if (struct.channel != null) {
        if (struct.isSetChannel()) {
          ...
          {
            oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.MAP, struct.channel.size()));
            for (java.util.Map<String, String> _iter7 : struct.channel)
            {
              {
                ...
                for (java.util.Map.Entry<String, String> _iter8 : _iter7.entrySet())
                {
      ...
      if (struct.isSetChannel()) {
        {
          ...
          for (java.util.Map<String, String> _iter9 : struct.channel)
          {
            {
              oprot.writeI32(_iter9.size());
              for (java.util.Map.Entry<String, String> _iter10 : _iter9.entrySet())
              {
      ...
      if (incoming.get(31)) {
        {
          ...
          struct.channel = new java.util.ArrayList<java.util.Map<String, String>>(_list11.size);
          java.util.Map<String, String> _elem12;
          for (int _i13 = 0; _i13 < _list11.size; ++_i13)
          {
            {
              org.apache.thrift.protocol.TMap _map14 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.STRING, iprot.readI32());
              _elem12 = new java.util.HashMap<String, String>(2*_map14.size);
              String _key15;
              String _val16;
