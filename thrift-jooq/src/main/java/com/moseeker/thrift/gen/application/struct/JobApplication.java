...
public class JobApplication implements org.apache.thrift.TBase<JobApplication, JobApplication._Fields>, java.io.Serializable, Cloneable, Comparable<JobApplication> {
  ...
  public void unsetApply_type() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __APPLY_TYPE_ISSET_ID);
  }

  /** Returns true if field apply_type is set (has been assigned a value) and false otherwise */
  public boolean isSetApply_type() {
    return EncodingUtils.testBit(__isset_bitfield, __APPLY_TYPE_ISSET_ID);
  }

  public void setApply_typeIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __APPLY_TYPE_ISSET_ID, value);
  }
  ...
  public void unsetEmail_status() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __EMAIL_STATUS_ISSET_ID);
  }

  /** Returns true if field email_status is set (has been assigned a value) and false otherwise */
  public boolean isSetEmail_status() {
    return EncodingUtils.testBit(__isset_bitfield, __EMAIL_STATUS_ISSET_ID);
  }

  public void setEmail_statusIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __EMAIL_STATUS_ISSET_ID, value);
  }
  ...
  public void unsetRecommender_user_id() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __RECOMMENDER_USER_ID_ISSET_ID);
  }
  ...
  public boolean isSetRecommender_user_id() {
    return EncodingUtils.testBit(__isset_bitfield, __RECOMMENDER_USER_ID_ISSET_ID);
  }

  public void setRecommender_user_idIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __RECOMMENDER_USER_ID_ISSET_ID, value);
  }
  ...
  public Object getFieldValue(_Fields field) {
    ...
    case APPLY_TYPE:
      return Integer.valueOf(getApply_type());

    case EMAIL_STATUS:
      return Integer.valueOf(getEmail_status());

    case RECOMMENDER_USER_ID:
      return Long.valueOf(getRecommender_user_id());
  ...
  public int hashCode() {
    ...
    boolean present_apply_type = true && (isSetApply_type());
    list.add(present_apply_type);
    if (present_apply_type)
      list.add(apply_type);

    boolean present_email_status = true && (isSetEmail_status());
    list.add(present_email_status);
    if (present_email_status)
      list.add(email_status);

    boolean present_recommender_user_id = true && (isSetRecommender_user_id());
    list.add(present_recommender_user_id);
    if (present_recommender_user_id)
      list.add(recommender_user_id);
