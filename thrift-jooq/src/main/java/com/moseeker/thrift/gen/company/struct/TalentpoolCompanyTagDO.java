...
public class TalentpoolCompanyTagDO implements org.apache.thrift.TBase<TalentpoolCompanyTagDO, TalentpoolCompanyTagDO._Fields>, java.io.Serializable, Cloneable, Comparable<TalentpoolCompanyTagDO> {
    ...
    private static final org.apache.thrift.protocol.TField KEYWORDS_FIELD_DESC = new org.apache.thrift.protocol.TField("keywords", org.apache.thrift.protocol.TType.LIST, (short)25);
    ...
    public java.util.List<java.lang.String> keywords; // optional
    ...
    private static final _Fields optionals[] = {_Fields.ID,_Fields.COMPANY_ID,_Fields.NAME,_Fields.COLOR,_Fields.WORK_YEARS,_Fields.CITY_NAME,_Fields.CITY_CODE,_Fields.DEGREE,_Fields.PAST_POSITION,_Fields.IN_LAST_JOB_SEARCH_POSITION,_Fields.MIN_AGE,_Fields.MAX_AGE,_Fields.INTENTION_CITY_NAME,_Fields.INTENTION_CITY_CODE,_Fields.INTENTION_SALARY_CODE,_Fields.SEX,_Fields.IS_RECOMMEND,_Fields.COMPANY_NAME,_Fields.IN_LAST_JOB_SEARCH_COMPANY,_Fields.SOURCE,_Fields.CREATE_TIME,_Fields.UPDATE_TIME,_Fields.DISABLE,_Fields.ORIGINS,_Fields.KEYWORDS,_Fields.CONTAIN_ANY_KEY};
    ...
    public TalentpoolCompanyTagDO(TalentpoolCompanyTagDO other) {
        ...
        if (other.isSetKeywords()) {
            java.util.List<java.lang.String> __this__keywords = new java.util.ArrayList<java.lang.String>(other.keywords);
    ...
    public java.util.Iterator<java.lang.String> getKeywordsIterator() {
        return (this.keywords == null) ? null : this.keywords.iterator();
    }

    public void addToKeywords(java.lang.String elem) {
        if (this.keywords == null) {
            this.keywords = new java.util.ArrayList<java.lang.String>();
        }
    ...
    public TalentpoolCompanyTagDO setKeywords(java.util.List<java.lang.String> keywords) {
                        ...
                        if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                            {
                                ...
                                struct.keywords = new java.util.ArrayList<java.lang.String>(_list0.size);
                                java.lang.String _elem1;
                                for (int _i2 = 0; _i2 < _list0.size; ++_i2)
                                {
                                    _elem1 = iprot.readString();
                                    struct.keywords.add(_elem1);
                                }
                                iprot.readListEnd();
                            }
            ...
            if (struct.keywords != null) {
                if (struct.isSetKeywords()) {
                    oprot.writeFieldBegin(KEYWORDS_FIELD_DESC);
                    {
                        ...
                        for (java.lang.String _iter3 : struct.keywords)
                        {
            ...
            if (struct.isSetKeywords()) {
                {
                    ...
                    for (java.lang.String _iter4 : struct.keywords)
                    {
            ...
            if (incoming.get(24)) {
                {
                    ...
                    struct.keywords = new java.util.ArrayList<java.lang.String>(_list5.size);
