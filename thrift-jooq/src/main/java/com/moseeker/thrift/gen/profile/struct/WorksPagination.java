            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.works = new ArrayList<Works>(_list128.size);
                Works _elem129;
                for (int _i130 = 0; _i130 < _list128.size; ++_i130)
                {
                  _elem129 = new Works();
                  _elem129.read(iprot);
                  struct.works.add(_elem129);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, WorksPagination struct) throws org.apache.thrift.TException {
      ...
      if (struct.works != null) {
        oprot.writeFieldBegin(WORKS_FIELD_DESC);
        {
          ...
          for (Works _iter131 : struct.works)
          {
      ...
      if (struct.isSetWorks()) {
        {
          ...
          for (Works _iter132 : struct.works)
          {
      ...
      if (incoming.get(4)) {
        {
          ...
          struct.works = new ArrayList<Works>(_list133.size);
          Works _elem134;
          for (int _i135 = 0; _i135 < _list133.size; ++_i135)
          {
            _elem134 = new Works();
            _elem134.read(iprot);
            struct.works.add(_elem134);
          }
        }
        struct.setWorksIsSet(true);
      }
