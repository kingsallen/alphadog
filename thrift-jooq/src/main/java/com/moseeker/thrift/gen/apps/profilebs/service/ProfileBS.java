...
public class ProfileBS {
  ...
  public interface Iface {
    ...
    public com.moseeker.thrift.gen.common.struct.Response profileProcess(int company_id, int progress_status, List<Integer> aids, int account_id) throws org.apache.thrift.TException;
  ...
  public interface AsyncIface {
    ...
    public void profileProcess(int company_id, int progress_status, List<Integer> aids, int account_id, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;

    public void profileProcessAts(int progress_status, String aids, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public void send_profileProcess(int company_id, int progress_status, List<Integer> aids, int account_id) throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public static class profileProcess_call extends org.apache.thrift.async.TAsyncMethodCall {
      private int company_id;
      private int progress_status;
      private List<Integer> aids;
      private int account_id;
      public profileProcess_call(int company_id, int progress_status, List<Integer> aids, int account_id, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
    ...
    public static class profileProcessAts_call extends org.apache.thrift.async.TAsyncMethodCall {
      private int progress_status;
      private String aids;
      public profileProcessAts_call(int progress_status, String aids, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.progress_status = progress_status;
        this.aids = aids;
      }
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class profileProcess<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, profileProcess_args, com.moseeker.thrift.gen.common.struct.Response> {
      ...
      public void start(I iface, profileProcess_args args, org.apache.thrift.async.AsyncMethodCallback<com.moseeker.thrift.gen.common.struct.Response> resultHandler) throws TException {
    ...
    public static class profileProcessAts<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, profileProcessAts_args, com.moseeker.thrift.gen.common.struct.Response> {
      ...
      public void start(I iface, profileProcessAts_args args, org.apache.thrift.async.AsyncMethodCallback<com.moseeker.thrift.gen.common.struct.Response> resultHandler) throws TException {
  ...
  public static class profileProcess_args implements org.apache.thrift.TBase<profileProcess_args, profileProcess_args._Fields>, java.io.Serializable, Cloneable, Comparable<profileProcess_args>   {
    ...
    private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
    static {
      schemes.put(StandardScheme.class, new profileProcess_argsStandardSchemeFactory());
      schemes.put(TupleScheme.class, new profileProcess_argsTupleSchemeFactory());
    }

    public int company_id; // required
    public int progress_status; // required
    public List<Integer> aids; // required
    ...
    public profileProcess_args(profileProcess_args other) {
      ...
      if (other.isSetAids()) {
        List<Integer> __this__aids = new ArrayList<Integer>(other.aids);
    ...
    public void unsetProgress_status() {
      __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __PROGRESS_STATUS_ISSET_ID);
    }
    ...
    public boolean isSetProgress_status() {
      return EncodingUtils.testBit(__isset_bitfield, __PROGRESS_STATUS_ISSET_ID);
    }

    public void setProgress_statusIsSet(boolean value) {
      __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __PROGRESS_STATUS_ISSET_ID, value);
    }
    ...
    public profileProcess_args setAids(List<Integer> aids) {
      this.aids = aids;
      return this;
    }
    ...
    public int hashCode() {
      ...
      boolean present_progress_status = true;
      list.add(present_progress_status);
      if (present_progress_status)
        list.add(progress_status);

      boolean present_aids = true && (isSetAids());
      list.add(present_aids);
      if (present_aids)
        list.add(aids);
    ...
    private static class profileProcess_argsStandardSchemeFactory implements SchemeFactory {
      public profileProcess_argsStandardScheme getScheme() {
        return new profileProcess_argsStandardScheme();
      }
    }

    private static class profileProcess_argsStandardScheme extends StandardScheme<profileProcess_args> {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.aids = new ArrayList<Integer>(_list0.size);
                  int _elem1;
    ...
    private static class profileProcess_argsTupleSchemeFactory implements SchemeFactory {
      public profileProcess_argsTupleScheme getScheme() {
        return new profileProcess_argsTupleScheme();
      }
    }

    private static class profileProcess_argsTupleScheme extends TupleScheme<profileProcess_args> {
        ...
        if (incoming.get(2)) {
          {
            ...
            struct.aids = new ArrayList<Integer>(_list5.size);
            int _elem6;
  ...
  public static class profileProcess_result implements org.apache.thrift.TBase<profileProcess_result, profileProcess_result._Fields>, java.io.Serializable, Cloneable, Comparable<profileProcess_result>   {
    ...
    private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
    static {
      schemes.put(StandardScheme.class, new profileProcess_resultStandardSchemeFactory());
      schemes.put(TupleScheme.class, new profileProcess_resultTupleSchemeFactory());
    }
    ...
    private static class profileProcess_resultStandardSchemeFactory implements SchemeFactory {
      public profileProcess_resultStandardScheme getScheme() {
        return new profileProcess_resultStandardScheme();
      }
    }

    private static class profileProcess_resultStandardScheme extends StandardScheme<profileProcess_result> {
    ...
    private static class profileProcess_resultTupleSchemeFactory implements SchemeFactory {
      public profileProcess_resultTupleScheme getScheme() {
        return new profileProcess_resultTupleScheme();
      }
    }

    private static class profileProcess_resultTupleScheme extends TupleScheme<profileProcess_result> {
  ...
  public static class profileProcessAts_args implements org.apache.thrift.TBase<profileProcessAts_args, profileProcessAts_args._Fields>, java.io.Serializable, Cloneable, Comparable<profileProcessAts_args>   {
    ...
    private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
    static {
      schemes.put(StandardScheme.class, new profileProcessAts_argsStandardSchemeFactory());
      schemes.put(TupleScheme.class, new profileProcessAts_argsTupleSchemeFactory());
    }
    ...
    private static class profileProcessAts_argsStandardSchemeFactory implements SchemeFactory {
      public profileProcessAts_argsStandardScheme getScheme() {
        return new profileProcessAts_argsStandardScheme();
      }
    }

    private static class profileProcessAts_argsStandardScheme extends StandardScheme<profileProcessAts_args> {
    ...
    private static class profileProcessAts_argsTupleSchemeFactory implements SchemeFactory {
      public profileProcessAts_argsTupleScheme getScheme() {
        return new profileProcessAts_argsTupleScheme();
      }
    }

    private static class profileProcessAts_argsTupleScheme extends TupleScheme<profileProcessAts_args> {
  ...
  public static class profileProcessAts_result implements org.apache.thrift.TBase<profileProcessAts_result, profileProcessAts_result._Fields>, java.io.Serializable, Cloneable, Comparable<profileProcessAts_result>   {
    ...
    private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
    static {
      schemes.put(StandardScheme.class, new profileProcessAts_resultStandardSchemeFactory());
      schemes.put(TupleScheme.class, new profileProcessAts_resultTupleSchemeFactory());
    }
    ...
    private static class profileProcessAts_resultStandardSchemeFactory implements SchemeFactory {
      public profileProcessAts_resultStandardScheme getScheme() {
        return new profileProcessAts_resultStandardScheme();
      }
    }

    private static class profileProcessAts_resultStandardScheme extends StandardScheme<profileProcessAts_result> {
    ...
    private static class profileProcessAts_resultTupleSchemeFactory implements SchemeFactory {
      public profileProcessAts_resultTupleScheme getScheme() {
        return new profileProcessAts_resultTupleScheme();
      }
    }

    private static class profileProcessAts_resultTupleScheme extends TupleScheme<profileProcessAts_result> {
