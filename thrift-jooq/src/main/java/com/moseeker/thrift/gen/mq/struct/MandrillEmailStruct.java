...
public class MandrillEmailStruct implements org.apache.thrift.TBase<MandrillEmailStruct, MandrillEmailStruct._Fields>, java.io.Serializable, Cloneable, Comparable<MandrillEmailStruct> {
  ...
  static {
    schemes.put(StandardScheme.class, new MandrillEmailStructStandardSchemeFactory());
    schemes.put(TupleScheme.class, new MandrillEmailStructTupleSchemeFactory());
  }

  public String templateName; // required
  public String to_email; // required
  public String to_name; // optional
  public Map<String,String> mergeVars; // optional
  ...
  public MandrillEmailStruct(MandrillEmailStruct other) {
    ...
    if (other.isSetMergeVars()) {
      Map<String,String> __this__mergeVars = new HashMap<String,String>(other.mergeVars);
  ...
  public MandrillEmailStruct setTemplateName(String templateName) {
    this.templateName = templateName;
    return this;
  }
  ...
  public MandrillEmailStruct setTo_email(String to_email) {
    this.to_email = to_email;
    return this;
  }
  ...
  public MandrillEmailStruct setTo_name(String to_name) {
  ...
  public void putToMergeVars(String key, String val) {
    if (this.mergeVars == null) {
      this.mergeVars = new HashMap<String,String>();
    }
  ...
  public MandrillEmailStruct setMergeVars(Map<String,String> mergeVars) {
  ...
  public MandrillEmailStruct setFrom_email(String from_email) {
  ...
  public MandrillEmailStruct setFrom_name(String from_name) {
  ...
  public MandrillEmailStruct setSubject(String subject) {
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case MERGE_VARS:
      if (value == null) {
        ...
        setMergeVars((Map<String,String>)value);
      }
      break;
  ...
  public int hashCode() {
    ...
    boolean present_to_email = true && (isSetTo_email());
    list.add(present_to_email);
    if (present_to_email)
      list.add(to_email);

    boolean present_to_name = true && (isSetTo_name());
    list.add(present_to_name);
    if (present_to_name)
      list.add(to_name);

    boolean present_mergeVars = true && (isSetMergeVars());
    list.add(present_mergeVars);
    if (present_mergeVars)
      list.add(mergeVars);

    boolean present_from_email = true && (isSetFrom_email());
    list.add(present_from_email);
    if (present_from_email)
      list.add(from_email);

    boolean present_from_name = true && (isSetFrom_name());
    list.add(present_from_name);
    if (present_from_name)
      list.add(from_name);
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("MandrillEmailStruct(");
    boolean first = true;
  ...
  private static class MandrillEmailStructStandardSchemeFactory implements SchemeFactory {
    public MandrillEmailStructStandardScheme getScheme() {
      return new MandrillEmailStructStandardScheme();
    }
  }

  private static class MandrillEmailStructStandardScheme extends StandardScheme<MandrillEmailStruct> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.mergeVars = new HashMap<String,String>(2*_map10.size);
                String _key11;
                String _val12;
      ...
      if (struct.mergeVars != null) {
        if (struct.isSetMergeVars()) {
          oprot.writeFieldBegin(MERGE_VARS_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, String> _iter14 : struct.mergeVars.entrySet())
            {
  ...
  private static class MandrillEmailStructTupleSchemeFactory implements SchemeFactory {
    public MandrillEmailStructTupleScheme getScheme() {
      return new MandrillEmailStructTupleScheme();
    }
  }

  private static class MandrillEmailStructTupleScheme extends TupleScheme<MandrillEmailStruct> {
      ...
      if (struct.isSetMergeVars()) {
        {
          ...
          for (Map.Entry<String, String> _iter15 : struct.mergeVars.entrySet())
          {
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.mergeVars = new HashMap<String,String>(2*_map16.size);
          String _key17;
          String _val18;
