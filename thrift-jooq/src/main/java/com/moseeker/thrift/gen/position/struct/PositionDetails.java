...
public class PositionDetails implements org.apache.thrift.TBase<PositionDetails, PositionDetails._Fields>, java.io.Serializable, Cloneable, Comparable<PositionDetails> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("PositionDetails");
  ...
  private static final org.apache.thrift.protocol.TField RES_URL_FIELD_DESC = new org.apache.thrift.protocol.TField("resUrl", org.apache.thrift.protocol.TType.STRING, (short)64);
  private static final org.apache.thrift.protocol.TField TEAM_ID_FIELD_DESC = new org.apache.thrift.protocol.TField("teamId", org.apache.thrift.protocol.TType.I32, (short)65);
  private static final org.apache.thrift.protocol.TField TEAM_NAME_FIELD_DESC = new org.apache.thrift.protocol.TField("teamName", org.apache.thrift.protocol.TType.STRING, (short)66);
  private static final org.apache.thrift.protocol.TField TEAM_DESCRIPTION_FIELD_DESC = new org.apache.thrift.protocol.TField("teamDescription", org.apache.thrift.protocol.TType.STRING, (short)67);

  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new PositionDetailsStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new PositionDetailsTupleSchemeFactory();
  ...
  public String resUrl; // optional
  public int teamId; // optional
  public String teamName; // optional
  public String teamDescription; // optional
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    RES_URL((short)64, "resUrl"),
    TEAM_ID((short)65, "teamId"),
    TEAM_NAME((short)66, "teamName"),
    TEAM_DESCRIPTION((short)67, "teamDescription");
  ...
  static {
    ...
    tmpMap.put(_Fields.TEAM_NAME, new org.apache.thrift.meta_data.FieldMetaData("teamName", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
    tmpMap.put(_Fields.TEAM_DESCRIPTION, new org.apache.thrift.meta_data.FieldMetaData("teamDescription", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
    metaDataMap = java.util.Collections.unmodifiableMap(tmpMap);
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(PositionDetails.class, metaDataMap);
  }
   ...
   */
  public PositionDetails(PositionDetails other) {
    ...
    if (other.isSetTeamDescription()) {
      this.teamDescription = other.teamDescription;
    }
  }

  public PositionDetails deepCopy() {
    return new PositionDetails(this);
  }
  ...
  public PositionDetails setId(int id) {
    this.id = id;
    setIdIsSet(true);
    return this;
  }
  ...
  public PositionDetails setJobnumber(String jobnumber) {
  ...
  public PositionDetails setCompanyId(int companyId) {
  ...
  public PositionDetails setTitle(String title) {
    this.title = title;
    return this;
  }
  ...
  public PositionDetails setCity(String city) {
    this.city = city;
    return this;
  }
  ...
  public PositionDetails setDepartment(String department) {
  ...
  public PositionDetails setLJobid(int lJobid) {
    this.lJobid = lJobid;
    setLJobidIsSet(true);
    return this;
  }
  ...
  public PositionDetails setPublishDate(String publishDate) {
  ...
  public PositionDetails setStopDate(String stopDate) {
  ...
  public PositionDetails setAccountabilities(String accountabilities) {
  ...
  public PositionDetails setExperience(String experience) {
  ...
  public PositionDetails setRequirement(String requirement) {
  ...
  public PositionDetails setSalary(String salary) {
    this.salary = salary;
    return this;
  }
  ...
  public PositionDetails setLanguage(String language) {
  ...
  public PositionDetails setJobGrade(String jobGrade) {
  ...
  public PositionDetails setStatus(int status) {
    this.status = status;
    setStatusIsSet(true);
    return this;
  }
  ...
  public PositionDetails setVisitnum(int visitnum) {
  ...
  public PositionDetails setLastvisit(String lastvisit) {
  ...
  public PositionDetails setSource_id(int source_id) {
  ...
  public PositionDetails setUpdateTime(String updateTime) {
  ...
  public PositionDetails setBusinessGroup(String businessGroup) {
  ...
  public PositionDetails setEmploymentType(byte employmentType) {
  ...
  public PositionDetails setHrEmail(String hrEmail) {
  ...
  public PositionDetails setBenefits(String benefits) {
  ...
  public PositionDetails setDegree(byte degree) {
    this.degree = degree;
    setDegreeIsSet(true);
    return this;
  }
  ...
  public PositionDetails setFeature(String feature) {
  ...
  public PositionDetails setEmailNotice(boolean emailNotice) {
  ...
  public PositionDetails setCandidateSource(byte candidateSource) {
  ...
  public PositionDetails setOccupation(String occupation) {
  ...
  public PositionDetails setIsRecom(boolean isRecom) {
  ...
  public PositionDetails setIndustry(String industry) {
  ...
  public PositionDetails setHongbaoConfigId(int hongbaoConfigId) {
  ...
  public PositionDetails setHongbaoConfigRecomId(int hongbaoConfigRecomId) {
  ...
  public PositionDetails setHongbaoConfigAppId(int hongbaoConfigAppId) {
  ...
  public PositionDetails setEmailResumeConf(boolean emailResumeConf) {
  ...
  public PositionDetails setLPostingTargetId(int lPostingTargetId) {
  ...
  public PositionDetails setPriority(byte priority) {
  ...
  public PositionDetails setShareTplId(int shareTplId) {
  ...
  public PositionDetails setDistrict(String district) {
  ...
  public PositionDetails setCount(short count) {
    this.count = count;
    setCountIsSet(true);
    return this;
  }
  ...
  public PositionDetails setSalaryTop(int salaryTop) {
  ...
  public PositionDetails setSalaryBottom(int salaryBottom) {
  ...
  public PositionDetails setExperienceAbove(boolean experienceAbove) {
  ...
  public PositionDetails setDegreeAbove(boolean degreeAbove) {
  ...
  public PositionDetails setManagementExperience(boolean managementExperience) {
  ...
  public PositionDetails setGender(byte gender) {
    this.gender = gender;
    setGenderIsSet(true);
    return this;
  }
  ...
  public PositionDetails setPublisher(int publisher) {
  ...
  public PositionDetails setAppCvConfigId(int appCvConfigId) {
  ...
  public PositionDetails setSource(short source) {
    this.source = source;
    setSourceIsSet(true);
    return this;
  }
  ...
  public PositionDetails setHbStatus(byte hbStatus) {
  ...
  public PositionDetails setChildCompanyId(int childCompanyId) {
  ...
  public PositionDetails setAge(byte age) {
    this.age = age;
    setAgeIsSet(true);
    return this;
  }
  ...
  public PositionDetails setMajorRequired(String majorRequired) {
  ...
  public PositionDetails setWorkAddress(String workAddress) {
  ...
  public PositionDetails setKeyword(String keyword) {
  ...
  public PositionDetails setReportingTo(String reportingTo) {
  ...
  public PositionDetails setIsHiring(boolean isHiring) {
  ...
  public PositionDetails setUnderlings(short underlings) {
  ...
  public PositionDetails setLanguageRequired(boolean languageRequired) {
  ...
  public PositionDetails setTargetIndustry(int targetIndustry) {
  ...
  public PositionDetails setCurrentStatus(byte currentStatus) {
  ...
  public PositionDetails setPositionCode(short positionCode) {
  ...
  public PositionDetails setResUrl(String resUrl) {
    this.resUrl = resUrl;
    return this;
  }
  ...
  public PositionDetails setTeamId(int teamId) {
    this.teamId = teamId;
    setTeamIdIsSet(true);
    return this;
  }
  ...
  public PositionDetails setTeamName(String teamName) {
  ...
  public PositionDetails setTeamDescription(String teamDescription) {
    this.teamDescription = teamDescription;
    return this;
  }

  public void unsetTeamDescription() {
    this.teamDescription = null;
  }

  /** Returns true if field teamDescription is set (has been assigned a value) and false otherwise */
  public boolean isSetTeamDescription() {
    return this.teamDescription != null;
  }

  public void setTeamDescriptionIsSet(boolean value) {
    if (!value) {
      this.teamDescription = null;
    }
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case TEAM_DESCRIPTION:
      if (value == null) {
        unsetTeamDescription();
      } else {
        setTeamDescription((String)value);
      }
      break;
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof PositionDetails)
      return this.equals((PositionDetails)that);
    return false;
  }

  public boolean equals(PositionDetails that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
    ...
    boolean this_present_teamDescription = true && this.isSetTeamDescription();
    boolean that_present_teamDescription = true && that.isSetTeamDescription();
    if (this_present_teamDescription || that_present_teamDescription) {
      if (!(this_present_teamDescription && that_present_teamDescription))
        return false;
      if (!this.teamDescription.equals(that.teamDescription))
        return false;
    }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetTeamDescription()) ? 131071 : 524287);
    if (isSetTeamDescription())
      hashCode = hashCode * 8191 + teamDescription.hashCode();

    return hashCode;
  }

  @Override
  public int compareTo(PositionDetails other) {
    ...
    lastComparison = Boolean.valueOf(isSetResUrl()).compareTo(other.isSetResUrl());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetResUrl()) {
    ...
    lastComparison = Boolean.valueOf(isSetTeamDescription()).compareTo(other.isSetTeamDescription());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetTeamDescription()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.teamDescription, other.teamDescription);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("PositionDetails(");
    boolean first = true;
    ...
    if (isSetTeamDescription()) {
      ...
      if (this.teamDescription == null) {
        ...
        sb.append(this.teamDescription);
      }
      first = false;
    }
    sb.append(")");
  ...
  private static class PositionDetailsStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public PositionDetailsStandardScheme getScheme() {
      return new PositionDetailsStandardScheme();
    }
  }

  private static class PositionDetailsStandardScheme extends org.apache.thrift.scheme.StandardScheme<PositionDetails> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, PositionDetails struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 67: // TEAM_DESCRIPTION
            if (schemeField.type == org.apache.thrift.protocol.TType.STRING) {
              struct.teamDescription = iprot.readString();
              struct.setTeamDescriptionIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, PositionDetails struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.teamDescription != null) {
        if (struct.isSetTeamDescription()) {
          oprot.writeFieldBegin(TEAM_DESCRIPTION_FIELD_DESC);
          oprot.writeString(struct.teamDescription);
          oprot.writeFieldEnd();
        }
      }
  ...
  private static class PositionDetailsTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public PositionDetailsTupleScheme getScheme() {
      return new PositionDetailsTupleScheme();
    }
  }

  private static class PositionDetailsTupleScheme extends org.apache.thrift.scheme.TupleScheme<PositionDetails> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, PositionDetails struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, PositionDetails struct) throws org.apache.thrift.TException {
