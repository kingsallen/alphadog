...
public class ReferralProgressQueryInfo implements org.apache.thrift.TBase<ReferralProgressQueryInfo, ReferralProgressQueryInfo._Fields>, java.io.Serializable, Cloneable, Comparable<ReferralProgressQueryInfo> {
  ...
  private static final org.apache.thrift.protocol.TField RECOM_TYPE_FIELD_DESC = new org.apache.thrift.protocol.TField("recomType", org.apache.thrift.protocol.TType.I32, (short)5);
  private static final org.apache.thrift.protocol.TField PROGRESS_FIELD_DESC = new org.apache.thrift.protocol.TField("progress", org.apache.thrift.protocol.TType.I32, (short)6);
  ...
  private static final int __RECOMTYPE_ISSET_ID = 4;
  private static final int __PROGRESS_ISSET_ID = 5;
  private byte __isset_bitfield = 0;
  private static final _Fields optionals[] = {_Fields.USER_ID,_Fields.PRESENTEE_USER_ID,_Fields.PID,_Fields.COMPANY_ID,_Fields.RECOM_TYPE,_Fields.PROGRESS};
  ...
  static {
    ...
    tmpMap.put(_Fields.COMPANY_ID, new org.apache.thrift.meta_data.FieldMetaData("companyId", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I32)));
    tmpMap.put(_Fields.RECOM_TYPE, new org.apache.thrift.meta_data.FieldMetaData("recomType", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I32)));
  ...
  public ReferralProgressQueryInfo(ReferralProgressQueryInfo other) {
    ...
    this.recomType = other.recomType;
  ...
  public ReferralProgressQueryInfo setPid(int pid) {
    this.pid = pid;
    setPidIsSet(true);
    return this;
  }
  ...
  public ReferralProgressQueryInfo setRecomType(int recomType) {
    this.recomType = recomType;
    setRecomTypeIsSet(true);
    return this;
  }

  public void unsetRecomType() {
    __isset_bitfield = org.apache.thrift.EncodingUtils.clearBit(__isset_bitfield, __RECOMTYPE_ISSET_ID);
  }

  /** Returns true if field recomType is set (has been assigned a value) and false otherwise */
  public boolean isSetRecomType() {
    return org.apache.thrift.EncodingUtils.testBit(__isset_bitfield, __RECOMTYPE_ISSET_ID);
  }

  public void setRecomTypeIsSet(boolean value) {
    __isset_bitfield = org.apache.thrift.EncodingUtils.setBit(__isset_bitfield, __RECOMTYPE_ISSET_ID, value);
  }
  ...
  public boolean equals(ReferralProgressQueryInfo that) {
    ...
    boolean this_present_recomType = true && this.isSetRecomType();
    boolean that_present_recomType = true && that.isSetRecomType();
    if (this_present_recomType || that_present_recomType) {
      if (!(this_present_recomType && that_present_recomType))
        return false;
      if (this.recomType != that.recomType)
        return false;
    }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetRecomType()) ? 131071 : 524287);
    if (isSetRecomType())
      hashCode = hashCode * 8191 + recomType;
  ...
  public int compareTo(ReferralProgressQueryInfo other) {
    ...
    lastComparison = Boolean.valueOf(isSetRecomType()).compareTo(other.isSetRecomType());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetRecomType()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.recomType, other.recomType);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  private static class ReferralProgressQueryInfoStandardScheme extends org.apache.thrift.scheme.StandardScheme<ReferralProgressQueryInfo> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, ReferralProgressQueryInfo struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 5: // RECOM_TYPE
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.recomType = iprot.readI32();
              struct.setRecomTypeIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ReferralProgressQueryInfo struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetRecomType()) {
        oprot.writeFieldBegin(RECOM_TYPE_FIELD_DESC);
        oprot.writeI32(struct.recomType);
        oprot.writeFieldEnd();
      }
