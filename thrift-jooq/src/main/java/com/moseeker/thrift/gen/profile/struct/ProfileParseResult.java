...
@javax.annotation.Generated(value = "Autogenerated by Thrift Compiler (0.10.0)", date = "2018-10-25")
public class ProfileParseResult implements org.apache.thrift.TBase<ProfileParseResult, ProfileParseResult._Fields>, java.io.Serializable, Cloneable, Comparable<ProfileParseResult> {
  ...
  public ProfileParseResult setFile(String file) {
    this.file = file;
    return this;
  }
  ...
  public ProfileParseResult setName(String name) {
    this.name = name;
    return this;
  }
  ...
  public ProfileParseResult setMobile(String mobile) {
    this.mobile = mobile;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case MOBILEEDITABLE:
      if (value == null) {
        ...
        setMobileeditable((Boolean)value);
      }
      break;
  ...
  public int compareTo(ProfileParseResult other) {
    ...
    lastComparison = Boolean.valueOf(isSetMobileeditable()).compareTo(other.isSetMobileeditable());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetMobileeditable()) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("ProfileParseResult(");
    boolean first = true;
