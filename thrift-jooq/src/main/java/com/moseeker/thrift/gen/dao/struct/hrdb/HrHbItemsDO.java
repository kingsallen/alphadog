...
public class HrHbItemsDO implements org.apache.thrift.TBase<HrHbItemsDO, HrHbItemsDO._Fields>, java.io.Serializable, Cloneable, Comparable<HrHbItemsDO> {
  ...
  public java.lang.String openTime; // optional
  ...
  public HrHbItemsDO setOpenTime(java.lang.String openTime) {
  ...
  public HrHbItemsDO setCreateTime(java.lang.String createTime) {
  ...
  public HrHbItemsDO setUpdateTime(java.lang.String updateTime) {
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case BINDING_ID:
      if (value == null) {
        ...
        setBindingId((java.lang.Integer)value);
      }
      break;
    ...
    case OPEN_TIME:
      if (value == null) {
        ...
        setOpenTime((java.lang.String)value);
      }
      break;
    ...
    case TRIGGER_WXUSER_ID:
      if (value == null) {
        ...
        setTriggerWxuserId((java.lang.Integer)value);
      }
      break;
  ...
  public int compareTo(HrHbItemsDO other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetBindingId()).compareTo(other.isSetBindingId());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetBindingId()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetTriggerWxuserId()).compareTo(other.isSetTriggerWxuserId());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetTriggerWxuserId()) {
