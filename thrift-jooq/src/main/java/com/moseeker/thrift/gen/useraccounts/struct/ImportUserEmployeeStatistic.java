            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.userEmployeeDO = new java.util.ArrayList<ImportErrorUserEmployee>(_list92.size);
                ImportErrorUserEmployee _elem93;
                for (int _i94 = 0; _i94 < _list92.size; ++_i94)
                {
                  _elem93 = new ImportErrorUserEmployee();
                  _elem93.read(iprot);
                  struct.userEmployeeDO.add(_elem93);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.userEmployeeDO != null) {
        if (struct.isSetUserEmployeeDO()) {
          oprot.writeFieldBegin(USER_EMPLOYEE_DO_FIELD_DESC);
          {
            ...
            for (ImportErrorUserEmployee _iter95 : struct.userEmployeeDO)
            {
              _iter95.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.isSetUserEmployeeDO()) {
        {
          ...
          for (ImportErrorUserEmployee _iter96 : struct.userEmployeeDO)
          {
            _iter96.write(oprot);
          }
        }
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.userEmployeeDO = new java.util.ArrayList<ImportErrorUserEmployee>(_list97.size);
          ImportErrorUserEmployee _elem98;
          for (int _i99 = 0; _i99 < _list97.size; ++_i99)
          {
            _elem98 = new ImportErrorUserEmployee();
            _elem98.read(iprot);
            struct.userEmployeeDO.add(_elem98);
          }
        }
        struct.setUserEmployeeDOIsSet(true);
      }
