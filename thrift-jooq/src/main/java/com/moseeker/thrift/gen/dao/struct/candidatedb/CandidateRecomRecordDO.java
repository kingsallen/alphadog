...
public class CandidateRecomRecordDO implements org.apache.thrift.TBase<CandidateRecomRecordDO, CandidateRecomRecordDO._Fields>, java.io.Serializable, Cloneable, Comparable<CandidateRecomRecordDO> {
  ...
  public String recomReason; // optional
  public String recomTime; // optional
  ...
  public CandidateRecomRecordDO setClickTime(String clickTime) {
  ...
  public CandidateRecomRecordDO setRealname(String realname) {
  ...
  public CandidateRecomRecordDO setCompany(String company) {
  ...
  public CandidateRecomRecordDO setPosition(String position) {
  ...
  public CandidateRecomRecordDO setRecomReason(String recomReason) {
  ...
  public CandidateRecomRecordDO setRecomTime(String recomTime) {
  ...
  public CandidateRecomRecordDO setCreateTime(String createTime) {
  ...
  public CandidateRecomRecordDO setUpdateTime(String updateTime) {
  ...
  public CandidateRecomRecordDO setMobile(String mobile) {
    this.mobile = mobile;
    return this;
  }
  ...
  public int compareTo(CandidateRecomRecordDO other) {
    ...
    lastComparison = Boolean.valueOf(isSetRecomId2()).compareTo(other.isSetRecomId2());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetRecomId2()) {
    ...
    lastComparison = Boolean.valueOf(isSetRecomReason()).compareTo(other.isSetRecomReason());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetRecomReason()) {
    ...
    lastComparison = Boolean.valueOf(isSetRecomTime()).compareTo(other.isSetRecomTime());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetRecomTime()) {
    ...
    lastComparison = Boolean.valueOf(isSetRepostUserId()).compareTo(other.isSetRepostUserId());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetRepostUserId()) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("CandidateRecomRecordDO(");
    boolean first = true;
