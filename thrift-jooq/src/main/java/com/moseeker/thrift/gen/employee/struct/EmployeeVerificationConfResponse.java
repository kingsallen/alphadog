...
public class EmployeeVerificationConfResponse implements org.apache.thrift.TBase<EmployeeVerificationConfResponse, EmployeeVerificationConfResponse._Fields>, java.io.Serializable, Cloneable, Comparable<EmployeeVerificationConfResponse> {
  ...
  private static final org.apache.thrift.protocol.TField EXITS_FIELD_DESC = new org.apache.thrift.protocol.TField("exits", org.apache.thrift.protocol.TType.BOOL, (short)1);
  ...
  private static final int __EXITS_ISSET_ID = 0;
  ...
  static {
    ...
    tmpMap.put(_Fields.EXITS, new org.apache.thrift.meta_data.FieldMetaData("exits", org.apache.thrift.TFieldRequirementType.REQUIRED, 
  ...
  public EmployeeVerificationConfResponse setExits(boolean exits) {
    this.exits = exits;
    setExitsIsSet(true);
    return this;
  }
  ...
  public void unsetExits() {
    __isset_bitfield = org.apache.thrift.EncodingUtils.clearBit(__isset_bitfield, __EXITS_ISSET_ID);
  }

  /** Returns true if field exits is set (has been assigned a value) and false otherwise */
  public boolean isSetExits() {
    return org.apache.thrift.EncodingUtils.testBit(__isset_bitfield, __EXITS_ISSET_ID);
  }

  public void setExitsIsSet(boolean value) {
    __isset_bitfield = org.apache.thrift.EncodingUtils.setBit(__isset_bitfield, __EXITS_ISSET_ID, value);
  }
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case EXITS:
      if (value == null) {
        ...
        setExits((java.lang.Boolean)value);
      }
      break;
  ...
  public boolean equals(EmployeeVerificationConfResponse that) {
    ...
    boolean this_present_exits = true;
    boolean that_present_exits = true;
    if (this_present_exits || that_present_exits) {
      if (!(this_present_exits && that_present_exits))
        return false;
      if (this.exits != that.exits)
        return false;
    }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((exits) ? 131071 : 524287);
  ...
  public int compareTo(EmployeeVerificationConfResponse other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetExits()).compareTo(other.isSetExits());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetExits()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.exits, other.exits);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public void validate() throws org.apache.thrift.TException {
    ...
    // alas, we cannot check 'exits' because it's a primitive and you chose the non-beans generator.
  ...
  private static class EmployeeVerificationConfResponseStandardScheme extends org.apache.thrift.scheme.StandardScheme<EmployeeVerificationConfResponse> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, EmployeeVerificationConfResponse struct) throws org.apache.thrift.TException {
      ...
      if (!struct.isSetExits()) {
        throw new org.apache.thrift.protocol.TProtocolException("Required field 'exits' was not found in serialized data! Struct: " + toString());
      }
      struct.validate();
    }
