...
public class UserEmployeeDO implements org.apache.thrift.TBase<UserEmployeeDO, UserEmployeeDO._Fields>, java.io.Serializable, Cloneable, Comparable<UserEmployeeDO> {
  ...
  private static final org.apache.thrift.protocol.TField DOWNLOA_DOKEN_FIELD_DESC = new org.apache.thrift.protocol.TField("downloaDOken", org.apache.thrift.protocol.TType.STRING, (short)41);
  ...
  public java.lang.String downloaDOken; // optional
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    DOWNLOA_DOKEN((short)41, "downloaDOken"),
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        ...
        case 40: // SOURCE
          return SOURCE;
        case 41: // DOWNLOA_DOKEN
          return DOWNLOA_DOKEN;
  ...
  static {
    ...
    tmpMap.put(_Fields.SOURCE, new org.apache.thrift.meta_data.FieldMetaData("source", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.BYTE)));
    tmpMap.put(_Fields.DOWNLOA_DOKEN, new org.apache.thrift.meta_data.FieldMetaData("downloaDOken", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
  ...
  public UserEmployeeDO(UserEmployeeDO other) {
    ...
    if (other.isSetDownloaDOken()) {
      this.downloaDOken = other.downloaDOken;
    }
  ...
  public UserEmployeeDO setSex(byte sex) {
    this.sex = sex;
    setSexIsSet(true);
    return this;
  }
  ...
  public UserEmployeeDO setIsAdmin(boolean isAdmin) {
  ...
  public UserEmployeeDO setActivation(byte activation) {
  ...
  public UserEmployeeDO setActivation_code(java.lang.String activation_code) {
  ...
  public UserEmployeeDO setDisable(byte disable) {
  ...
  public UserEmployeeDO setAuthLevel(byte authLevel) {
  ...
  public UserEmployeeDO setLoginCount(int loginCount) {
  ...
  public UserEmployeeDO setSource(byte source) {
    this.source = source;
    setSourceIsSet(true);
    return this;
  }
  ...
  public java.lang.String getDownloaDOken() {
    return this.downloaDOken;
  }

  public UserEmployeeDO setDownloaDOken(java.lang.String downloaDOken) {
    this.downloaDOken = downloaDOken;
    return this;
  }

  public void unsetDownloaDOken() {
    this.downloaDOken = null;
  }

  /** Returns true if field downloaDOken is set (has been assigned a value) and false otherwise */
  public boolean isSetDownloaDOken() {
    return this.downloaDOken != null;
  }

  public void setDownloaDOkenIsSet(boolean value) {
    if (!value) {
      this.downloaDOken = null;
    }
  }
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case DOWNLOA_DOKEN:
      if (value == null) {
        ...
        setDownloaDOken((java.lang.String)value);
      }
      break;
  ...
  public boolean equals(UserEmployeeDO that) {
    ...
    boolean this_present_downloaDOken = true && this.isSetDownloaDOken();
    boolean that_present_downloaDOken = true && that.isSetDownloaDOken();
    if (this_present_downloaDOken || that_present_downloaDOken) {
      if (!(this_present_downloaDOken && that_present_downloaDOken))
        return false;
      if (!this.downloaDOken.equals(that.downloaDOken))
        return false;
    }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetDownloaDOken()) ? 131071 : 524287);
    if (isSetDownloaDOken())
      hashCode = hashCode * 8191 + downloaDOken.hashCode();
  ...
  public int compareTo(UserEmployeeDO other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetDownloaDOken()).compareTo(other.isSetDownloaDOken());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetDownloaDOken()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.downloaDOken, other.downloaDOken);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public java.lang.String toString() {
    ...
    if (isSetDownloaDOken()) {
      if (!first) sb.append(", ");
      sb.append("downloaDOken:");
      if (this.downloaDOken == null) {
        sb.append("null");
      } else {
        sb.append(this.downloaDOken);
      }
      first = false;
    }
    if (isSetHrWxuserId()) {
  ...
  private static class UserEmployeeDOStandardScheme extends org.apache.thrift.scheme.StandardScheme<UserEmployeeDO> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, UserEmployeeDO struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 41: // DOWNLOA_DOKEN
            if (schemeField.type == org.apache.thrift.protocol.TType.STRING) {
              struct.downloaDOken = iprot.readString();
              struct.setDownloaDOkenIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, UserEmployeeDO struct) throws org.apache.thrift.TException {
      ...
      if (struct.downloaDOken != null) {
        if (struct.isSetDownloaDOken()) {
          oprot.writeFieldBegin(DOWNLOA_DOKEN_FIELD_DESC);
          oprot.writeString(struct.downloaDOken);
          oprot.writeFieldEnd();
        }
      }
