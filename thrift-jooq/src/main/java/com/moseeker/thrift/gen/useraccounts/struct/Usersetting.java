...
public class Usersetting implements org.apache.thrift.TBase<Usersetting, Usersetting._Fields>, java.io.Serializable, Cloneable, Comparable<Usersetting> {
  ...
  private static final SchemeFactory STANDARD_SCHEME_FACTORY = new UsersettingStandardSchemeFactory();
  private static final SchemeFactory TUPLE_SCHEME_FACTORY = new UsersettingTupleSchemeFactory();
