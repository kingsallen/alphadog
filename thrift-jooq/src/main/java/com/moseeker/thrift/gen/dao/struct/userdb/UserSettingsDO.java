...
public class UserSettingsDO implements org.apache.thrift.TBase<UserSettingsDO, UserSettingsDO._Fields>, java.io.Serializable, Cloneable, Comparable<UserSettingsDO> {
  ...
  public String bannerUrl; // optional
  ...
  public UserSettingsDO setBannerUrl(String bannerUrl) {
  ...
  public int compareTo(UserSettingsDO other) {
    ...
    lastComparison = Boolean.valueOf(isSetBannerUrl()).compareTo(other.isSetBannerUrl());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetBannerUrl()) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("UserSettingsDO(");
    boolean first = true;
