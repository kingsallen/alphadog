...
public class ProfileSkillDO implements org.apache.thrift.TBase<ProfileSkillDO, ProfileSkillDO._Fields>, java.io.Serializable, Cloneable, Comparable<ProfileSkillDO> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("ProfileSkillDO");
  ...
  private static final org.apache.thrift.protocol.TField MONTH_FIELD_DESC = new org.apache.thrift.protocol.TField("month", org.apache.thrift.protocol.TType.I32, (short)5);
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new ProfileSkillDOStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new ProfileSkillDOTupleSchemeFactory();

  public int id; // optional
  public int profileId; // optional
  public String name; // optional
  public byte level; // optional
  public int month; // optional
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(ProfileSkillDO.class, metaDataMap);
  }

  public ProfileSkillDO() {
  }

  /**
   * Performs a deep copy on <i>other</i>.
   */
  public ProfileSkillDO(ProfileSkillDO other) {
  ...
  public ProfileSkillDO deepCopy() {
    return new ProfileSkillDO(this);
  }
  ...
  public ProfileSkillDO setId(int id) {
    this.id = id;
    setIdIsSet(true);
    return this;
  }
  ...
  public ProfileSkillDO setProfileId(int profileId) {
  ...
  public ProfileSkillDO setName(String name) {
    this.name = name;
    return this;
  }
  ...
  public ProfileSkillDO setLevel(byte level) {
    this.level = level;
    setLevelIsSet(true);
    return this;
  }
  ...
  public ProfileSkillDO setMonth(int month) {
    this.month = month;
    setMonthIsSet(true);
    return this;
  }
  ...
  public ProfileSkillDO setCreateTime(String createTime) {
  ...
  public ProfileSkillDO setUpdateTime(String updateTime) {
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof ProfileSkillDO)
      return this.equals((ProfileSkillDO)that);
    return false;
  }

  public boolean equals(ProfileSkillDO that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(ProfileSkillDO other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("ProfileSkillDO(");
    boolean first = true;
  ...
  private static class ProfileSkillDOStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public ProfileSkillDOStandardScheme getScheme() {
      return new ProfileSkillDOStandardScheme();
    }
  }

  private static class ProfileSkillDOStandardScheme extends org.apache.thrift.scheme.StandardScheme<ProfileSkillDO> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, ProfileSkillDO struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ProfileSkillDO struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class ProfileSkillDOTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public ProfileSkillDOTupleScheme getScheme() {
      return new ProfileSkillDOTupleScheme();
    }
  }

  private static class ProfileSkillDOTupleScheme extends org.apache.thrift.scheme.TupleScheme<ProfileSkillDO> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, ProfileSkillDO struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, ProfileSkillDO struct) throws org.apache.thrift.TException {
