...
public class DictCityMapDO implements org.apache.thrift.TBase<DictCityMapDO, DictCityMapDO._Fields>, java.io.Serializable, Cloneable, Comparable<DictCityMapDO> {
  ...
  private static final org.apache.thrift.protocol.TField CODE_OTHER_FIELD_DESC = new org.apache.thrift.protocol.TField("codeOther", org.apache.thrift.protocol.TType.I32, (short)3);
  ...
  public DictCityMapDO setCodeOther(int codeOther) {
  ...
  public DictCityMapDO setCreateTime(String createTime) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("DictCityMapDO(");
    boolean first = true;
