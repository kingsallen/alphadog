            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.positionStatus = new java.util.HashMap<java.lang.Integer,java.lang.Integer>(2*_map8.size);
                int _key9;
                int _val10;
                for (int _i11 = 0; _i11 < _map8.size; ++_i11)
                {
                  ...
                  struct.positionStatus.put(_key9, _val10);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.positionStatus != null) {
        if (struct.isSetPositionStatus()) {
          oprot.writeFieldBegin(POSITION_STATUS_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<java.lang.Integer, java.lang.Integer> _iter12 : struct.positionStatus.entrySet())
            {
      ...
      if (struct.isSetPositionStatus()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.Integer, java.lang.Integer> _iter13 : struct.positionStatus.entrySet())
          {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.positionStatus = new java.util.HashMap<java.lang.Integer,java.lang.Integer>(2*_map14.size);
          int _key15;
          int _val16;
          for (int _i17 = 0; _i17 < _map14.size; ++_i17)
          {
            ...
            struct.positionStatus.put(_key15, _val16);
          }
        }
        struct.setPositionStatusIsSet(true);
      }
