...
@javax.annotation.Generated(value = "Autogenerated by Thrift Compiler (0.10.0)", date = "2017-05-26")
public class Position implements org.apache.thrift.TBase<Position, Position._Fields>, java.io.Serializable, Cloneable, Comparable<Position> {
  ...
  public java.lang.String stop_date; // optional
  ...
  public java.lang.String hr_email; // optional
  ...
  public java.lang.String major_required; // optional
  public java.lang.String work_address; // optional
  public java.lang.String keyword; // optional
  public java.lang.String reporting_to; // optional
  ...
  public java.util.Map<java.lang.Integer,java.lang.String> cities; // optional
  ...
  public Position(Position other) {
    ...
    if (other.isSetCities()) {
      java.util.Map<java.lang.Integer,java.lang.String> __this__cities = new java.util.HashMap<java.lang.Integer,java.lang.String>(other.cities);
  ...
  public Position setJobnumber(java.lang.String jobnumber) {
  ...
  public Position setTitle(java.lang.String title) {
    this.title = title;
    return this;
  }
  ...
  public Position setCity(java.lang.String city) {
    this.city = city;
    return this;
  }
  ...
  public Position setDepartment(java.lang.String department) {
  ...
  public void unsetL_jobid() {
    __isset_bitfield = org.apache.thrift.EncodingUtils.clearBit(__isset_bitfield, __L_JOBID_ISSET_ID);
  }

  /** Returns true if field l_jobid is set (has been assigned a value) and false otherwise */
  public boolean isSetL_jobid() {
    return org.apache.thrift.EncodingUtils.testBit(__isset_bitfield, __L_JOBID_ISSET_ID);
  }

  public void setL_jobidIsSet(boolean value) {
    __isset_bitfield = org.apache.thrift.EncodingUtils.setBit(__isset_bitfield, __L_JOBID_ISSET_ID, value);
  }
  ...
  public Position setPublish_date(java.lang.String publish_date) {
  ...
  public Position setStop_date(java.lang.String stop_date) {
  ...
  public Position setAccountabilities(java.lang.String accountabilities) {
  ...
  public Position setExperience(java.lang.String experience) {
  ...
  public Position setRequirement(java.lang.String requirement) {
  ...
  public Position setLanguage(java.lang.String language) {
  ...
  public Position setUpdate_time(java.lang.String update_time) {
  ...
  public Position setHr_email(java.lang.String hr_email) {
  ...
  public Position setFeature(java.lang.String feature) {
  ...
  public Position setOccupation(java.lang.String occupation) {
  ...
  public Position setIndustry(java.lang.String industry) {
  ...
  public void unsetL_PostingTargetId() {
    __isset_bitfield = org.apache.thrift.EncodingUtils.clearBit(__isset_bitfield, __L_POSTINGTARGETID_ISSET_ID);
  }
  ...
  public boolean isSetL_PostingTargetId() {
    return org.apache.thrift.EncodingUtils.testBit(__isset_bitfield, __L_POSTINGTARGETID_ISSET_ID);
  }

  public void setL_PostingTargetIdIsSet(boolean value) {
    __isset_bitfield = org.apache.thrift.EncodingUtils.setBit(__isset_bitfield, __L_POSTINGTARGETID_ISSET_ID, value);
  }
  ...
  public void unsetShare_tpl_id() {
    __isset_bitfield = org.apache.thrift.EncodingUtils.clearBit(__isset_bitfield, __SHARE_TPL_ID_ISSET_ID);
  }

  /** Returns true if field share_tpl_id is set (has been assigned a value) and false otherwise */
  public boolean isSetShare_tpl_id() {
    return org.apache.thrift.EncodingUtils.testBit(__isset_bitfield, __SHARE_TPL_ID_ISSET_ID);
  }

  public void setShare_tpl_idIsSet(boolean value) {
    __isset_bitfield = org.apache.thrift.EncodingUtils.setBit(__isset_bitfield, __SHARE_TPL_ID_ISSET_ID, value);
  }
  ...
  public Position setMajor_required(java.lang.String major_required) {
  ...
  public Position setWork_address(java.lang.String work_address) {
  ...
  public Position setKeyword(java.lang.String keyword) {
  ...
  public Position setReporting_to(java.lang.String reporting_to) {
  ...
  public void unsetTarget_industry() {
    __isset_bitfield = org.apache.thrift.EncodingUtils.clearBit(__isset_bitfield, __TARGET_INDUSTRY_ISSET_ID);
  }
  ...
  public boolean isSetTarget_industry() {
    return org.apache.thrift.EncodingUtils.testBit(__isset_bitfield, __TARGET_INDUSTRY_ISSET_ID);
  }

  public void setTarget_industryIsSet(boolean value) {
    __isset_bitfield = org.apache.thrift.EncodingUtils.setBit(__isset_bitfield, __TARGET_INDUSTRY_ISSET_ID, value);
  }
  ...
  public void putToCities(int key, java.lang.String val) {
    if (this.cities == null) {
      this.cities = new java.util.HashMap<java.lang.Integer,java.lang.String>();
    }
    this.cities.put(key, val);
  }

  public java.util.Map<java.lang.Integer,java.lang.String> getCities() {
    return this.cities;
  }

  public Position setCities(java.util.Map<java.lang.Integer,java.lang.String> cities) {
    this.cities = cities;
    return this;
  }
  ...
  public Position setTeam_id(int team_id) {
    ...
    switch (field) {
      ...
      case L_JOBID:
        if (value == null) {
          ...
          setL_jobid((java.lang.Integer)value);
        }
        break;
      ...
      case EMPLOYMENT_TYPE:
        if (value == null) {
          ...
          setEmployment_type((java.lang.Byte)value);
        }
        break;
      ...
      case EMAIL_RESUME_CONF:
        if (value == null) {
          ...
          setEmail_resume_conf((java.lang.Byte)value);
        }
        break;
      ...
      case L__POSTING_TARGET_ID:
        if (value == null) {
          ...
          setL_PostingTargetId((java.lang.Integer)value);
        }
        break;
      ...
      case SHARE_TPL_ID:
        if (value == null) {
          ...
          setShare_tpl_id((java.lang.Integer)value);
        }
        break;
      ...
      case EXPERIENCE_ABOVE:
        if (value == null) {
          ...
          setExperience_above((java.lang.Byte)value);
        }
        break;
      ...
      case DEGREE_ABOVE:
        if (value == null) {
          ...
          setDegree_above((java.lang.Byte)value);
        }
        break;
      ...
      case MANAGEMENT_EXPERIENCE:
        if (value == null) {
          ...
          setManagement_experience((java.lang.Byte)value);
        }
        break;
      ...
      case HB_STATUS:
        if (value == null) {
          ...
          setHb_status((java.lang.Byte)value);
        }
        break;
      ...
      case LANGUAGE_REQUIRED:
        if (value == null) {
          ...
          setLanguage_required((java.lang.Byte)value);
        }
        break;
      ...
      case TARGET_INDUSTRY:
        if (value == null) {
          ...
          setTarget_industry((java.lang.Integer)value);
        }
        break;
      ...
      case CITIES:
        if (value == null) {
          ...
          setCities((java.util.Map<java.lang.Integer,java.lang.String>)value);
        }
        break;
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetL_jobid()) ? 131071 : 524287);
    if (isSetL_jobid())
      hashCode = hashCode * 8191 + l_jobid;
    ...
    if (isSetEmployment_type())
      hashCode = hashCode * 8191 + (int) (employment_type);
    ...
    hashCode = hashCode * 8191 + ((isSetEmail_resume_conf()) ? 131071 : 524287);
    if (isSetEmail_resume_conf())
      hashCode = hashCode * 8191 + (int) (email_resume_conf);

    hashCode = hashCode * 8191 + ((isSetL_PostingTargetId()) ? 131071 : 524287);
    if (isSetL_PostingTargetId())
      hashCode = hashCode * 8191 + l_PostingTargetId;

    hashCode = hashCode * 8191 + ((isSetPriority()) ? 131071 : 524287);
    if (isSetPriority())
      hashCode = hashCode * 8191 + priority;

    hashCode = hashCode * 8191 + ((isSetShare_tpl_id()) ? 131071 : 524287);
    if (isSetShare_tpl_id())
      hashCode = hashCode * 8191 + share_tpl_id;
    ...
    if (isSetExperience_above())
      hashCode = hashCode * 8191 + (int) (experience_above);

    hashCode = hashCode * 8191 + ((isSetDegree_above()) ? 131071 : 524287);
    if (isSetDegree_above())
      hashCode = hashCode * 8191 + (int) (degree_above);

    hashCode = hashCode * 8191 + ((isSetManagement_experience()) ? 131071 : 524287);
    if (isSetManagement_experience())
      hashCode = hashCode * 8191 + (int) (management_experience);
    ...
    hashCode = hashCode * 8191 + ((isSetApp_cv_config_id()) ? 131071 : 524287);
    ...
    if (isSetHb_status())
      hashCode = hashCode * 8191 + (int) (hb_status);
    ...
    hashCode = hashCode * 8191 + ((isSetIs_hiring()) ? 131071 : 524287);
    if (isSetIs_hiring())
    ...
    hashCode = hashCode * 8191 + ((isSetLanguage_required()) ? 131071 : 524287);
    if (isSetLanguage_required())
      hashCode = hashCode * 8191 + (int) (language_required);

    hashCode = hashCode * 8191 + ((isSetTarget_industry()) ? 131071 : 524287);
    if (isSetTarget_industry())
      hashCode = hashCode * 8191 + target_industry;
  ...
  public int compareTo(Position other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetL_jobid()).compareTo(other.isSetL_jobid());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetL_jobid()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetL_PostingTargetId()).compareTo(other.isSetL_PostingTargetId());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetL_PostingTargetId()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetShare_tpl_id()).compareTo(other.isSetShare_tpl_id());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetShare_tpl_id()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetHb_status()).compareTo(other.isSetHb_status());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetHb_status()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetTarget_industry()).compareTo(other.isSetTarget_industry());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetTarget_industry()) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.cities = new java.util.HashMap<java.lang.Integer,java.lang.String>(2*_map0.size);
                int _key1;
      ...
      if (struct.cities != null) {
        if (struct.isSetCities()) {
          oprot.writeFieldBegin(CITIES_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<java.lang.Integer, java.lang.String> _iter4 : struct.cities.entrySet())
            {
      ...
      if (struct.isSetCities()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.Integer, java.lang.String> _iter5 : struct.cities.entrySet())
          {
      ...
      if (incoming.get(49)) {
        {
          ...
          struct.cities = new java.util.HashMap<java.lang.Integer,java.lang.String>(2*_map6.size);
          int _key7;
