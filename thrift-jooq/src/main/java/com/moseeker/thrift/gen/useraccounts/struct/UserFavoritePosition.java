...
public class UserFavoritePosition implements org.apache.thrift.TBase<UserFavoritePosition, UserFavoritePosition._Fields>, java.io.Serializable, Cloneable, Comparable<UserFavoritePosition> {
  ...
  public Object getFieldValue(_Fields field) {
    ...
    case SYSUSER_ID:
      return Integer.valueOf(getSysuser_id());
    ...
    case RECOM_ID:
      return Integer.valueOf(getRecom_id());
  ...
  public int hashCode() {
    ...
    boolean present_sysuser_id = true && (isSetSysuser_id());
    ...
    boolean present_favorite = true && (isSetFavorite());
    ...
    boolean present_recom_id = true && (isSetRecom_id());
