...
public class UserFavoritePosition implements org.apache.thrift.TBase<UserFavoritePosition, UserFavoritePosition._Fields>, java.io.Serializable, Cloneable, Comparable<UserFavoritePosition> {
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new UserFavoritePositionStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new UserFavoritePositionTupleSchemeFactory();
  ...
  private static final _Fields optionals[] = {_Fields.ID,_Fields.SYSUSER_ID,_Fields.POSITION_ID,_Fields.FAVORITE,_Fields.MOBILE,_Fields.WXUSER_ID,_Fields.RECOM_ID,_Fields.CREATE_TIME,_Fields.UPDATE_TIME};
  ...
  static {
    ...
    tmpMap.put(_Fields.WXUSER_ID, new org.apache.thrift.meta_data.FieldMetaData("wxuser_id", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I64)));
    tmpMap.put(_Fields.RECOM_ID, new org.apache.thrift.meta_data.FieldMetaData("recom_id", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I32)));
  ...
  public UserFavoritePosition setMobile(java.lang.String mobile) {
    this.mobile = mobile;
    return this;
  }
  ...
  public void unsetRecom_id() {
    __isset_bitfield = org.apache.thrift.EncodingUtils.clearBit(__isset_bitfield, __RECOM_ID_ISSET_ID);
  }

  /** Returns true if field recom_id is set (has been assigned a value) and false otherwise */
  public boolean isSetRecom_id() {
    return org.apache.thrift.EncodingUtils.testBit(__isset_bitfield, __RECOM_ID_ISSET_ID);
  }

  public void setRecom_idIsSet(boolean value) {
    __isset_bitfield = org.apache.thrift.EncodingUtils.setBit(__isset_bitfield, __RECOM_ID_ISSET_ID, value);
  }
  ...
  public UserFavoritePosition setCreate_time(java.lang.String create_time) {
  ...
  public UserFavoritePosition setUpdate_time(java.lang.String update_time) {
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case RECOM_ID:
      if (value == null) {
        ...
        setRecom_id((java.lang.Integer)value);
      }
      break;
  ...
  public boolean equals(UserFavoritePosition that) {
    ...
    boolean this_present_recom_id = true && this.isSetRecom_id();
    boolean that_present_recom_id = true && that.isSetRecom_id();
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetRecom_id()) ? 131071 : 524287);
    if (isSetRecom_id())
      hashCode = hashCode * 8191 + recom_id;
  ...
  public int compareTo(UserFavoritePosition other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetRecom_id()).compareTo(other.isSetRecom_id());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetRecom_id()) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("UserFavoritePosition(");
    boolean first = true;
  ...
  private static class UserFavoritePositionStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public UserFavoritePositionStandardScheme getScheme() {
      return new UserFavoritePositionStandardScheme();
    }
  }

  private static class UserFavoritePositionStandardScheme extends org.apache.thrift.scheme.StandardScheme<UserFavoritePosition> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, UserFavoritePosition struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, UserFavoritePosition struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class UserFavoritePositionTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public UserFavoritePositionTupleScheme getScheme() {
      return new UserFavoritePositionTupleScheme();
    }
  }

  private static class UserFavoritePositionTupleScheme extends org.apache.thrift.scheme.TupleScheme<UserFavoritePosition> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, UserFavoritePosition struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, UserFavoritePosition struct) throws org.apache.thrift.TException {
