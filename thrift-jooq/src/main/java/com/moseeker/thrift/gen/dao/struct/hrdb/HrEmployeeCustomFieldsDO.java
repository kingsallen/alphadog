...
public class HrEmployeeCustomFieldsDO implements org.apache.thrift.TBase<HrEmployeeCustomFieldsDO, HrEmployeeCustomFieldsDO._Fields>, java.io.Serializable, Cloneable, Comparable<HrEmployeeCustomFieldsDO> {
  ...
  public String fvalues; // optional
  ...
  public HrEmployeeCustomFieldsDO setFname(String fname) {
    this.fname = fname;
    return this;
  }
  ...
  public HrEmployeeCustomFieldsDO setFvalues(String fvalues) {
  ...
  public int compareTo(HrEmployeeCustomFieldsDO other) {
    ...
    lastComparison = Boolean.valueOf(isSetForder()).compareTo(other.isSetForder());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetForder()) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("HrEmployeeCustomFieldsDO(");
    boolean first = true;
