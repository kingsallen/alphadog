...
public class ActivityDTO implements org.apache.thrift.TBase<ActivityDTO, ActivityDTO._Fields>, java.io.Serializable, Cloneable, Comparable<ActivityDTO> {
  ...
  private static final org.apache.thrift.protocol.TField RANG_MIN_FIELD_DESC = new org.apache.thrift.protocol.TField("rangMin", org.apache.thrift.protocol.TType.DOUBLE, (short)7);
  private static final org.apache.thrift.protocol.TField RANG_MAX_FIELD_DESC = new org.apache.thrift.protocol.TField("rangMax", org.apache.thrift.protocol.TType.DOUBLE, (short)8);
  ...
  public double rangMin; // optional
  public double rangMax; // optional
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    RANG_MIN((short)7, "rangMin"),
    RANG_MAX((short)8, "rangMax"),
  ...
  private static final int __RANGMIN_ISSET_ID = 3;
  private static final int __RANGMAX_ISSET_ID = 4;
  ...
  static {
    ...
    tmpMap.put(_Fields.RANG_MIN, new org.apache.thrift.meta_data.FieldMetaData("rangMin", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.DOUBLE)));
    tmpMap.put(_Fields.RANG_MAX, new org.apache.thrift.meta_data.FieldMetaData("rangMax", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.DOUBLE)));
  ...
  public ActivityDTO(ActivityDTO other) {
    ...
    this.rangMin = other.rangMin;
    this.rangMax = other.rangMax;
  ...
  public void clear() {
    ...
    setRangMinIsSet(false);
    this.rangMin = 0.0;
    setRangMaxIsSet(false);
    this.rangMax = 0.0;
  ...
  public ActivityDTO setRangMin(double rangMin) {
    this.rangMin = rangMin;
    setRangMinIsSet(true);
    return this;
  }

  public void unsetRangMin() {
    __isset_bitfield = org.apache.thrift.EncodingUtils.clearBit(__isset_bitfield, __RANGMIN_ISSET_ID);
  }

  /** Returns true if field rangMin is set (has been assigned a value) and false otherwise */
  public boolean isSetRangMin() {
    return org.apache.thrift.EncodingUtils.testBit(__isset_bitfield, __RANGMIN_ISSET_ID);
  }

  public void setRangMinIsSet(boolean value) {
    __isset_bitfield = org.apache.thrift.EncodingUtils.setBit(__isset_bitfield, __RANGMIN_ISSET_ID, value);
  }
  ...
  public ActivityDTO setRangMax(double rangMax) {
    this.rangMax = rangMax;
    setRangMaxIsSet(true);
    return this;
  }

  public void unsetRangMax() {
    __isset_bitfield = org.apache.thrift.EncodingUtils.clearBit(__isset_bitfield, __RANGMAX_ISSET_ID);
  }

  /** Returns true if field rangMax is set (has been assigned a value) and false otherwise */
  public boolean isSetRangMax() {
    return org.apache.thrift.EncodingUtils.testBit(__isset_bitfield, __RANGMAX_ISSET_ID);
  }

  public void setRangMaxIsSet(boolean value) {
    __isset_bitfield = org.apache.thrift.EncodingUtils.setBit(__isset_bitfield, __RANGMAX_ISSET_ID, value);
  }
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case RANG_MIN:
      if (value == null) {
        ...
        setRangMin((java.lang.Double)value);
      }
      break;
    ...
    case RANG_MAX:
      if (value == null) {
        ...
        setRangMax((java.lang.Double)value);
      }
      break;
  ...
  public boolean equals(ActivityDTO that) {
    ...
    boolean this_present_rangMin = true && this.isSetRangMin();
    boolean that_present_rangMin = true && that.isSetRangMin();
    if (this_present_rangMin || that_present_rangMin) {
      if (!(this_present_rangMin && that_present_rangMin))
        return false;
      if (this.rangMin != that.rangMin)
        return false;
    }

    boolean this_present_rangMax = true && this.isSetRangMax();
    boolean that_present_rangMax = true && that.isSetRangMax();
    if (this_present_rangMax || that_present_rangMax) {
      if (!(this_present_rangMax && that_present_rangMax))
        return false;
      if (this.rangMax != that.rangMax)
        return false;
    }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetRangMin()) ? 131071 : 524287);
    if (isSetRangMin())
      hashCode = hashCode * 8191 + org.apache.thrift.TBaseHelper.hashCode(rangMin);

    hashCode = hashCode * 8191 + ((isSetRangMax()) ? 131071 : 524287);
    if (isSetRangMax())
      hashCode = hashCode * 8191 + org.apache.thrift.TBaseHelper.hashCode(rangMax);
  ...
  public int compareTo(ActivityDTO other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetRangMin()).compareTo(other.isSetRangMin());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetRangMin()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.rangMin, other.rangMin);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = java.lang.Boolean.valueOf(isSetRangMax()).compareTo(other.isSetRangMax());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetRangMax()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.rangMax, other.rangMax);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public java.lang.String toString() {
    ...
    if (isSetRangMin()) {
      if (!first) sb.append(", ");
      sb.append("rangMin:");
      sb.append(this.rangMin);
      first = false;
    }
    if (isSetRangMax()) {
      if (!first) sb.append(", ");
      sb.append("rangMax:");
      sb.append(this.rangMax);
      first = false;
    }
    if (isSetProbability()) {
      if (!first) sb.append(", ");
  ...
  private static class ActivityDTOStandardScheme extends org.apache.thrift.scheme.StandardScheme<ActivityDTO> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, ActivityDTO struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 7: // RANG_MIN
            if (schemeField.type == org.apache.thrift.protocol.TType.DOUBLE) {
              struct.rangMin = iprot.readDouble();
              struct.setRangMinIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
          case 8: // RANG_MAX
            if (schemeField.type == org.apache.thrift.protocol.TType.DOUBLE) {
              struct.rangMax = iprot.readDouble();
              struct.setRangMaxIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ActivityDTO struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetRangMin()) {
        oprot.writeFieldBegin(RANG_MIN_FIELD_DESC);
        oprot.writeDouble(struct.rangMin);
        oprot.writeFieldEnd();
      }
      if (struct.isSetRangMax()) {
        oprot.writeFieldBegin(RANG_MAX_FIELD_DESC);
        oprot.writeDouble(struct.rangMax);
        oprot.writeFieldEnd();
      }
