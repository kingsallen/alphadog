...
@javax.annotation.Generated(value = "Autogenerated by Thrift Compiler (0.10.0)", date = "2019-01-23")
public class ActivityDTO implements org.apache.thrift.TBase<ActivityDTO, ActivityDTO._Fields>, java.io.Serializable, Cloneable, Comparable<ActivityDTO> {
  ...
  private static final org.apache.thrift.protocol.TField REDPACKET_THEME_FIELD_DESC = new org.apache.thrift.protocol.TField("redpacket_theme", org.apache.thrift.protocol.TType.I32, (short)21);
  ...
  public int redpacket_theme; // optional
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    REDPACKET_THEME((short)21, "redpacket_theme");
  ...
  static {
    ...
    tmpMap.put(_Fields.POSITION_IDS, new org.apache.thrift.meta_data.FieldMetaData("positionIds", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
            new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I32))));
    tmpMap.put(_Fields.REDPACKET_THEME, new org.apache.thrift.meta_data.FieldMetaData("redpacket_theme", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I32)));
  ...
  public ActivityDTO(ActivityDTO other) {
    ...
    this.redpacket_theme = other.redpacket_theme;
  }
  ...
  public void clear() {
    ...
    setRedpacket_themeIsSet(false);
    this.redpacket_theme = 0;
  }
  ...
  public int getRedpacket_theme() {
    return this.redpacket_theme;
  }

  public ActivityDTO setRedpacket_theme(int redpacket_theme) {
    this.redpacket_theme = redpacket_theme;
    setRedpacket_themeIsSet(true);
    return this;
  }

  public void unsetRedpacket_theme() {
    __isset_bitfield = org.apache.thrift.EncodingUtils.clearBit(__isset_bitfield, __REDPACKET_THEME_ISSET_ID);
  }

  /** Returns true if field redpacket_theme is set (has been assigned a value) and false otherwise */
  public boolean isSetRedpacket_theme() {
    return org.apache.thrift.EncodingUtils.testBit(__isset_bitfield, __REDPACKET_THEME_ISSET_ID);
  }

  public void setRedpacket_themeIsSet(boolean value) {
    __isset_bitfield = org.apache.thrift.EncodingUtils.setBit(__isset_bitfield, __REDPACKET_THEME_ISSET_ID, value);
  }
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case REDPACKET_THEME:
      if (value == null) {
        unsetRedpacket_theme();
      } else {
        setRedpacket_theme((java.lang.Integer)value);
      }
      break;
  ...
  public boolean equals(ActivityDTO that) {
    ...
    boolean this_present_redpacket_theme = true && this.isSetRedpacket_theme();
    boolean that_present_redpacket_theme = true && that.isSetRedpacket_theme();
    if (this_present_redpacket_theme || that_present_redpacket_theme) {
      if (!(this_present_redpacket_theme && that_present_redpacket_theme))
        return false;
      if (this.redpacket_theme != that.redpacket_theme)
        return false;
    }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetRedpacket_theme()) ? 131071 : 524287);
    if (isSetRedpacket_theme())
      hashCode = hashCode * 8191 + redpacket_theme;
  ...
  public int compareTo(ActivityDTO other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetRedpacket_theme()).compareTo(other.isSetRedpacket_theme());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetRedpacket_theme()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.redpacket_theme, other.redpacket_theme);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public java.lang.String toString() {
    ...
    if (isSetRedpacket_theme()) {
      if (!first) sb.append(", ");
      sb.append("redpacket_theme:");
      sb.append(this.redpacket_theme);
      first = false;
    }
    sb.append(")");
    return sb.toString();
  ...
  private static class ActivityDTOStandardScheme extends org.apache.thrift.scheme.StandardScheme<ActivityDTO> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, ActivityDTO struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 21: // REDPACKET_THEME
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.redpacket_theme = iprot.readI32();
              struct.setRedpacket_themeIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ActivityDTO struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetRedpacket_theme()) {
        oprot.writeFieldBegin(REDPACKET_THEME_FIELD_DESC);
        oprot.writeI32(struct.redpacket_theme);
        oprot.writeFieldEnd();
      }
