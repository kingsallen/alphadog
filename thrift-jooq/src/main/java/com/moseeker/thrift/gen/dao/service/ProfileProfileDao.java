...
public class ProfileProfileDao {

  public interface Iface {

    public com.moseeker.thrift.gen.common.struct.Response getResourceByApplication(String downloadApi, String password, int companyId, int sourceId, int atsStatus, boolean recommender, boolean dl_url_required) throws org.apache.thrift.TException;

  }

  public interface AsyncIface {

    public void getResourceByApplication(String downloadApi, String password, int companyId, int sourceId, int atsStatus, boolean recommender, boolean dl_url_required, org.apache.thrift.async.AsyncMethodCallback<com.moseeker.thrift.gen.common.struct.Response> resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public com.moseeker.thrift.gen.common.struct.Response getResourceByApplication(String downloadApi, String password, int companyId, int sourceId, int atsStatus, boolean recommender, boolean dl_url_required) throws org.apache.thrift.TException
    {
      send_getResourceByApplication(downloadApi, password, companyId, sourceId, atsStatus, recommender, dl_url_required);
      return recv_getResourceByApplication();
    }

    public void send_getResourceByApplication(String downloadApi, String password, int companyId, int sourceId, int atsStatus, boolean recommender, boolean dl_url_required) throws org.apache.thrift.TException
    {
      getResourceByApplication_args args = new getResourceByApplication_args();
      args.setDownloadApi(downloadApi);
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public void getResourceByApplication(String downloadApi, String password, int companyId, int sourceId, int atsStatus, boolean recommender, boolean dl_url_required, org.apache.thrift.async.AsyncMethodCallback<com.moseeker.thrift.gen.common.struct.Response> resultHandler) throws org.apache.thrift.TException {
      checkReady();
      getResourceByApplication_call method_call = new getResourceByApplication_call(downloadApi, password, companyId, sourceId, atsStatus, recommender, dl_url_required, resultHandler, this, ___protocolFactory, ___transport);
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class getResourceByApplication<I extends Iface> extends org.apache.thrift.ProcessFunction<I, getResourceByApplication_args> {
      ...
      public getResourceByApplication_result getResult(I iface, getResourceByApplication_args args) throws org.apache.thrift.TException {
        getResourceByApplication_result result = new getResourceByApplication_result();
        result.success = iface.getResourceByApplication(args.downloadApi, args.password, args.companyId, args.sourceId, args.atsStatus, args.recommender, args.dl_url_required);
        return result;
      }
    }
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class getResourceByApplication<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, getResourceByApplication_args, com.moseeker.thrift.gen.common.struct.Response> {
      ...
      public void start(I iface, getResourceByApplication_args args, org.apache.thrift.async.AsyncMethodCallback<com.moseeker.thrift.gen.common.struct.Response> resultHandler) throws org.apache.thrift.TException {
        iface.getResourceByApplication(args.downloadApi, args.password, args.companyId, args.sourceId, args.atsStatus, args.recommender, args.dl_url_required,resultHandler);
      }
    }
  ...
  public static class getResourceByApplication_args implements org.apache.thrift.TBase<getResourceByApplication_args, getResourceByApplication_args._Fields>, java.io.Serializable, Cloneable, Comparable<getResourceByApplication_args>   {
    ...
    private static final org.apache.thrift.protocol.TField DOWNLOAD_API_FIELD_DESC = new org.apache.thrift.protocol.TField("downloadApi", org.apache.thrift.protocol.TType.STRING, (short)1);
    ...
    private static final org.apache.thrift.protocol.TField ATS_STATUS_FIELD_DESC = new org.apache.thrift.protocol.TField("atsStatus", org.apache.thrift.protocol.TType.I32, (short)5);
    private static final org.apache.thrift.protocol.TField RECOMMENDER_FIELD_DESC = new org.apache.thrift.protocol.TField("recommender", org.apache.thrift.protocol.TType.BOOL, (short)6);
    private static final org.apache.thrift.protocol.TField DL_URL_REQUIRED_FIELD_DESC = new org.apache.thrift.protocol.TField("dl_url_required", org.apache.thrift.protocol.TType.BOOL, (short)7);
    ...
    public String downloadApi; // required
    ...
    public enum _Fields implements org.apache.thrift.TFieldIdEnum {
      DOWNLOAD_API((short)1, "downloadApi"),
      PASSWORD((short)2, "password"),
      COMPANY_ID((short)3, "companyId"),
      SOURCE_ID((short)4, "sourceId"),
      ATS_STATUS((short)5, "atsStatus"),
      RECOMMENDER((short)6, "recommender"),
      DL_URL_REQUIRED((short)7, "dl_url_required");
    ...
    static {
      ...
      tmpMap.put(_Fields.DOWNLOAD_API, new org.apache.thrift.meta_data.FieldMetaData("downloadApi", org.apache.thrift.TFieldRequirementType.DEFAULT, 
    ...
    public getResourceByApplication_args(getResourceByApplication_args other) {
      ...
      if (other.isSetDownloadApi()) {
        this.downloadApi = other.downloadApi;
      }
    ...
    public getResourceByApplication_args setDownloadApi(String downloadApi) {
      this.downloadApi = downloadApi;
      return this;
    }

    public void unsetDownloadApi() {
      this.downloadApi = null;
    }

    /** Returns true if field downloadApi is set (has been assigned a value) and false otherwise */
    public boolean isSetDownloadApi() {
      return this.downloadApi != null;
    }

    public void setDownloadApiIsSet(boolean value) {
      if (!value) {
        this.downloadApi = null;
      }
    }
    ...
    public getResourceByApplication_args setPassword(String password) {
      this.password = password;
      return this;
    }
    ...
    public boolean equals(getResourceByApplication_args that) {
      ...
      boolean this_present_downloadApi = true && this.isSetDownloadApi();
      boolean that_present_downloadApi = true && that.isSetDownloadApi();
      if (this_present_downloadApi || that_present_downloadApi) {
        if (!(this_present_downloadApi && that_present_downloadApi))
          return false;
        if (!this.downloadApi.equals(that.downloadApi))
          return false;
      }
    ...
    public int hashCode() {
      ...
      hashCode = hashCode * 8191 + ((isSetDownloadApi()) ? 131071 : 524287);
      if (isSetDownloadApi())
        hashCode = hashCode * 8191 + downloadApi.hashCode();
    ...
    public int compareTo(getResourceByApplication_args other) {
      ...
      lastComparison = Boolean.valueOf(isSetDownloadApi()).compareTo(other.isSetDownloadApi());
      if (lastComparison != 0) {
        return lastComparison;
      }
      if (isSetDownloadApi()) {
        lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.downloadApi, other.downloadApi);
        if (lastComparison != 0) {
          return lastComparison;
        }
      }
    ...
    public String toString() {
      ...
      sb.append("downloadApi:");
      if (this.downloadApi == null) {
        sb.append("null");
      } else {
        sb.append(this.downloadApi);
      }
      first = false;
      if (!first) sb.append(", ");
      sb.append("password:");
    ...
    private static class getResourceByApplication_argsStandardScheme extends org.apache.thrift.scheme.StandardScheme<getResourceByApplication_args> {
          ...
          switch (schemeField.id) {
            case 1: // DOWNLOAD_API
              if (schemeField.type == org.apache.thrift.protocol.TType.STRING) {
                struct.downloadApi = iprot.readString();
                struct.setDownloadApiIsSet(true);
              } else { 
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getResourceByApplication_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.downloadApi != null) {
          oprot.writeFieldBegin(DOWNLOAD_API_FIELD_DESC);
          oprot.writeString(struct.downloadApi);
          oprot.writeFieldEnd();
        }
