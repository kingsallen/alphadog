...
public class RecommendationRecordVO implements org.apache.thrift.TBase<RecommendationRecordVO, RecommendationRecordVO._Fields>, java.io.Serializable, Cloneable, Comparable<RecommendationRecordVO> {
  ...
  private static final _Fields optionals[] = {_Fields.RECOM_STATUS,_Fields.APPLIER_NAME,_Fields.APPLIER_REL,_Fields.POSITION,_Fields.CLICK_TIME,_Fields.STATUS,_Fields.IS_INTERESTED,_Fields.VIEW_NUMBER,_Fields.HEADIMGURL,_Fields.ID};
  ...
  public RecommendationRecordVO setId(int id) {
    this.id = id;
    setIdIsSet(true);
    return this;
  }
