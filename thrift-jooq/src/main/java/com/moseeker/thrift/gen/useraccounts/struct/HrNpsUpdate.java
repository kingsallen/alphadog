...
public class HrNpsUpdate implements org.apache.thrift.TBase<HrNpsUpdate, HrNpsUpdate._Fields>, java.io.Serializable, Cloneable, Comparable<HrNpsUpdate> {
  ...
  public HrNpsUpdate setStart_date(String start_date) {
  ...
  public HrNpsUpdate setEnd_date(String end_date) {
  ...
  public HrNpsUpdate setUsername(String username) {
  ...
  public HrNpsUpdate setMobile(String mobile) {
    this.mobile = mobile;
    return this;
  }
  ...
  public HrNpsUpdate setCompany(String company) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("HrNpsUpdate(");
    boolean first = true;
