...
public class DictCountryDO implements org.apache.thrift.TBase<DictCountryDO, DictCountryDO._Fields>, java.io.Serializable, Cloneable, Comparable<DictCountryDO> {
  ...
  private static final org.apache.thrift.protocol.TField PRIORITY_FIELD_DESC = new org.apache.thrift.protocol.TField("priority", org.apache.thrift.protocol.TType.I16, (short)10);
  private static final org.apache.thrift.protocol.TField SMS_ENABLED_FIELD_DESC = new org.apache.thrift.protocol.TField("smsEnabled", org.apache.thrift.protocol.TType.BYTE, (short)11);
  ...
  public short priority; // optional
  public byte smsEnabled; // optional
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    SMS_ENABLED((short)11, "smsEnabled");
  ...
  private static final int __SMSENABLED_ISSET_ID = 4;
  private byte __isset_bitfield = 0;
  private static final _Fields optionals[] = {_Fields.ID,_Fields.NAME,_Fields.ENAME,_Fields.ISO_CODE2,_Fields.ISO_CODE3,_Fields.CODE,_Fields.ICON_CLASS,_Fields.HOT_COUNTRY,_Fields.CONTINENT_CODE,_Fields.PRIORITY,_Fields.SMS_ENABLED};
  ...
  static {
    ...
    tmpMap.put(_Fields.SMS_ENABLED, new org.apache.thrift.meta_data.FieldMetaData("smsEnabled", org.apache.thrift.TFieldRequirementType.OPTIONAL,
            new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.BYTE)));
  ...
  public DictCountryDO setPriority(short priority) {
  ...
  public DictCountryDO setSmsEnabled(byte smsEnabled) {
    this.smsEnabled = smsEnabled;
    setSmsEnabledIsSet(true);
    return this;
  }

  public void unsetSmsEnabled() {
    __isset_bitfield = org.apache.thrift.EncodingUtils.clearBit(__isset_bitfield, __SMSENABLED_ISSET_ID);
  }

  /** Returns true if field smsEnabled is set (has been assigned a value) and false otherwise */
  public boolean isSetSmsEnabled() {
    return org.apache.thrift.EncodingUtils.testBit(__isset_bitfield, __SMSENABLED_ISSET_ID);
  }

  public void setSmsEnabledIsSet(boolean value) {
    __isset_bitfield = org.apache.thrift.EncodingUtils.setBit(__isset_bitfield, __SMSENABLED_ISSET_ID, value);
  }
    ...
    switch (field) {
      ...
      case SMS_ENABLED:
        if (value == null) {
          ...
          setSmsEnabled((java.lang.Byte)value);
        }
        break;
  ...
  public boolean equals(DictCountryDO that) {
    ...
    boolean this_present_smsEnabled = true && this.isSetSmsEnabled();
    boolean that_present_smsEnabled = true && that.isSetSmsEnabled();
    if (this_present_smsEnabled || that_present_smsEnabled) {
      if (!(this_present_smsEnabled && that_present_smsEnabled))
        return false;
      if (this.smsEnabled != that.smsEnabled)
        return false;
    }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetSmsEnabled()) ? 131071 : 524287);
    if (isSetSmsEnabled())
      hashCode = hashCode * 8191 + (int) (smsEnabled);
  ...
  public int compareTo(DictCountryDO other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetSmsEnabled()).compareTo(other.isSetSmsEnabled());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetSmsEnabled()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.smsEnabled, other.smsEnabled);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  private static class DictCountryDOStandardScheme extends org.apache.thrift.scheme.StandardScheme<DictCountryDO> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, DictCountryDO struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 11: // SMS_ENABLED
            if (schemeField.type == org.apache.thrift.protocol.TType.BYTE) {
              struct.smsEnabled = iprot.readByte();
              struct.setSmsEnabledIsSet(true);
            } else {
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, DictCountryDO struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetSmsEnabled()) {
        oprot.writeFieldBegin(SMS_ENABLED_FIELD_DESC);
        oprot.writeByte(struct.smsEnabled);
        oprot.writeFieldEnd();
      }
