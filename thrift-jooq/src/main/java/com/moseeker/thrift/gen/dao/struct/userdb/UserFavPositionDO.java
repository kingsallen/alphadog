...
public class UserFavPositionDO implements org.apache.thrift.TBase<UserFavPositionDO, UserFavPositionDO._Fields>, java.io.Serializable, Cloneable, Comparable<UserFavPositionDO> {
  ...
  public UserFavPositionDO setCreateTime(String createTime) {
  ...
  public UserFavPositionDO setUpdateTime(String updateTime) {
  ...
  public UserFavPositionDO setMobile(String mobile) {
    this.mobile = mobile;
    return this;
  }
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("UserFavPositionDO(");
    boolean first = true;
