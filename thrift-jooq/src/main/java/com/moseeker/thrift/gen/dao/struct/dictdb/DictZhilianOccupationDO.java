...
public class DictZhilianOccupationDO implements org.apache.thrift.TBase<DictZhilianOccupationDO, DictZhilianOccupationDO._Fields>, java.io.Serializable, Cloneable, Comparable<DictZhilianOccupationDO> {
  ...
  public DictZhilianOccupationDO setName(String name) {
    this.name = name;
    return this;
  }
  ...
  public DictZhilianOccupationDO setLevel(short level) {
    this.level = level;
    setLevelIsSet(true);
    return this;
  }
  ...
  public DictZhilianOccupationDO setStatus(short status) {
    this.status = status;
    setStatusIsSet(true);
    return this;
  }
  ...
  public DictZhilianOccupationDO setCreatetime(String createtime) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("DictZhilianOccupationDO(");
    boolean first = true;
