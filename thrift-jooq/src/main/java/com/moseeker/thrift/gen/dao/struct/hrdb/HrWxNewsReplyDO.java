...
public class HrWxNewsReplyDO implements org.apache.thrift.TBase<HrWxNewsReplyDO, HrWxNewsReplyDO._Fields>, java.io.Serializable, Cloneable, Comparable<HrWxNewsReplyDO> {
  ...
  public HrWxNewsReplyDO setTitle(String title) {
    this.title = title;
    return this;
  }
  ...
  public HrWxNewsReplyDO setDescription(String description) {
  ...
  public HrWxNewsReplyDO setThumb(String thumb) {
    this.thumb = thumb;
    return this;
  }
  ...
  public HrWxNewsReplyDO setContent(String content) {
  ...
  public HrWxNewsReplyDO setUrl(String url) {
    this.url = url;
    return this;
  }
  ...
  public int compareTo(HrWxNewsReplyDO other) {
    ...
    lastComparison = Boolean.valueOf(isSetThumb()).compareTo(other.isSetThumb());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetThumb()) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("HrWxNewsReplyDO(");
    boolean first = true;
