...
public class DictCityPostcodeDO implements org.apache.thrift.TBase<DictCityPostcodeDO, DictCityPostcodeDO._Fields>, java.io.Serializable, Cloneable, Comparable<DictCityPostcodeDO> {
  ...
  public DictCityPostcodeDO setPostcode(String postcode) {
  ...
  public DictCityPostcodeDO setProvince(String province) {
  ...
  public DictCityPostcodeDO setCity(String city) {
    this.city = city;
    return this;
  }
  ...
  public DictCityPostcodeDO setDistrict(String district) {
  ...
  public DictCityPostcodeDO setCode(String code) {
    this.code = code;
    return this;
  }
  ...
  public int compareTo(DictCityPostcodeDO other) {
    ...
    lastComparison = Boolean.valueOf(isSetPostcode()).compareTo(other.isSetPostcode());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetPostcode()) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("DictCityPostcodeDO(");
    boolean first = true;
