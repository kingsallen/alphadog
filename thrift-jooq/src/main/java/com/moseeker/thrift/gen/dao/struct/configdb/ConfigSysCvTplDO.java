...
public class ConfigSysCvTplDO implements org.apache.thrift.TBase<ConfigSysCvTplDO, ConfigSysCvTplDO._Fields>, java.io.Serializable, Cloneable, Comparable<ConfigSysCvTplDO> {
  ...
  private static final org.apache.thrift.protocol.TField FIELD_VALUE_FIELD_DESC = new org.apache.thrift.protocol.TField("fieldValue", org.apache.thrift.protocol.TType.STRING, (short)5);
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    FIELD_VALUE((short)5, "fieldValue"),
  ...
  private static final _Fields optionals[] = {_Fields.ID,_Fields.FIELD_NAME,_Fields.FIELD_TITLE,_Fields.FIELD_TYPE,_Fields.FIELD_VALUE,_Fields.PRIORITY,_Fields.IS_BASIC,_Fields.CREATE_TIME,_Fields.UPDATE_TIME,_Fields.DISABLE,_Fields.COMPANY_ID,_Fields.NEEDED,_Fields.FIELD_DESCRIPTION,_Fields.MAPPING};
  ...
  public ConfigSysCvTplDO setFieldName(String fieldName) {
  ...
  public ConfigSysCvTplDO setFieldTitle(String fieldTitle) {
  ...
  public ConfigSysCvTplDO setFieldValue(String fieldValue) {
  ...
  public ConfigSysCvTplDO setCreateTime(String createTime) {
  ...
  public ConfigSysCvTplDO setUpdateTime(String updateTime) {
  ...
  public ConfigSysCvTplDO setFieldDescription(String fieldDescription) {
  ...
  public ConfigSysCvTplDO setMapping(String mapping) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("ConfigSysCvTplDO(");
    boolean first = true;
