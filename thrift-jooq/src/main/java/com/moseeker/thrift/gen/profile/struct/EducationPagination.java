            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.educations = new ArrayList<Education>(_list24.size);
                Education _elem25;
                for (int _i26 = 0; _i26 < _list24.size; ++_i26)
                {
                  _elem25 = new Education();
                  _elem25.read(iprot);
                  struct.educations.add(_elem25);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, EducationPagination struct) throws org.apache.thrift.TException {
      ...
      if (struct.educations != null) {
        oprot.writeFieldBegin(EDUCATIONS_FIELD_DESC);
        {
          ...
          for (Education _iter27 : struct.educations)
          {
            _iter27.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.isSetEducations()) {
        {
          ...
          for (Education _iter28 : struct.educations)
          {
            _iter28.write(oprot);
          }
        }
      ...
      if (incoming.get(4)) {
        {
          ...
          struct.educations = new ArrayList<Education>(_list29.size);
          Education _elem30;
          for (int _i31 = 0; _i31 < _list29.size; ++_i31)
          {
            _elem30 = new Education();
            _elem30.read(iprot);
            struct.educations.add(_elem30);
          }
        }
        struct.setEducationsIsSet(true);
      }
