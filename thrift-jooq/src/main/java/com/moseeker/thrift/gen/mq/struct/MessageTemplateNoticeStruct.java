...
public class MessageTemplateNoticeStruct implements org.apache.thrift.TBase<MessageTemplateNoticeStruct, MessageTemplateNoticeStruct._Fields>, java.io.Serializable, Cloneable, Comparable<MessageTemplateNoticeStruct> {
  ...
  private static final org.apache.thrift.protocol.TField DELAY_FIELD_DESC = new org.apache.thrift.protocol.TField("delay", org.apache.thrift.protocol.TType.BYTE, (short)7);
  ...
  private static final _Fields optionals[] = {_Fields.USER_ID,_Fields.SYS_TEMPLATE_ID,_Fields.URL,_Fields.COMPANY_ID,_Fields.DATA,_Fields.ENABLE_QX_RETRY,_Fields.DELAY};
  ...
  public MessageTemplateNoticeStruct setDelay(byte delay) {
    this.delay = delay;
    setDelayIsSet(true);
    return this;
  }
