...
public class MessageTemplateNoticeStruct implements org.apache.thrift.TBase<MessageTemplateNoticeStruct, MessageTemplateNoticeStruct._Fields>, java.io.Serializable, Cloneable, Comparable<MessageTemplateNoticeStruct> {
  ...
  public Map<String,Map<String,MessageTplDataCol>> data; // optional
  ...
  public MessageTemplateNoticeStruct(MessageTemplateNoticeStruct other) {
    ...
    if (other.isSetData()) {
      Map<String,Map<String,MessageTplDataCol>> __this__data = new HashMap<String,Map<String,MessageTplDataCol>>(other.data.size());
      for (Map.Entry<String, Map<String,MessageTplDataCol>> other_element : other.data.entrySet()) {

        String other_element_key = other_element.getKey();
        Map<String,MessageTplDataCol> other_element_value = other_element.getValue();

        String __this__data_copy_key = other_element_key;

        Map<String,MessageTplDataCol> __this__data_copy_value = new HashMap<String,MessageTplDataCol>(other_element_value.size());
        for (Map.Entry<String, MessageTplDataCol> other_element_value_element : other_element_value.entrySet()) {

          String other_element_value_element_key = other_element_value_element.getKey();
          MessageTplDataCol other_element_value_element_value = other_element_value_element.getValue();

          String __this__data_copy_value_copy_key = other_element_value_element_key;

          MessageTplDataCol __this__data_copy_value_copy_value = new MessageTplDataCol(other_element_value_element_value);
  ...
  public void putToData(String key, Map<String,MessageTplDataCol> val) {
    if (this.data == null) {
      this.data = new HashMap<String,Map<String,MessageTplDataCol>>();
    }
    this.data.put(key, val);
  }

  public Map<String,Map<String,MessageTplDataCol>> getData() {
    return this.data;
  }

  public MessageTemplateNoticeStruct setData(Map<String,Map<String,MessageTplDataCol>> data) {
    this.data = data;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case DATA:
      if (value == null) {
        ...
        setData((Map<String,Map<String,MessageTplDataCol>>)value);
      }
      break;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.data = new HashMap<String,Map<String,MessageTplDataCol>>(2*_map0.size);
                String _key1;
                Map<String,MessageTplDataCol> _val2;
                for (int _i3 = 0; _i3 < _map0.size; ++_i3)
                {
                  _key1 = iprot.readString();
                  {
                    org.apache.thrift.protocol.TMap _map4 = iprot.readMapBegin();
                    _val2 = new HashMap<String,MessageTplDataCol>(2*_map4.size);
                    String _key5;
                    MessageTplDataCol _val6;
                    for (int _i7 = 0; _i7 < _map4.size; ++_i7)
                    {
                      _key5 = iprot.readString();
                      _val6 = new MessageTplDataCol();
                      _val6.read(iprot);
      ...
      if (struct.data != null) {
        if (struct.isSetData()) {
          oprot.writeFieldBegin(DATA_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Map<String,MessageTplDataCol>> _iter8 : struct.data.entrySet())
            {
              oprot.writeString(_iter8.getKey());
              {
                ...
                for (Map.Entry<String, MessageTplDataCol> _iter9 : _iter8.getValue().entrySet())
                {
      ...
      if (struct.isSetData()) {
        {
          ...
          for (Map.Entry<String, Map<String,MessageTplDataCol>> _iter10 : struct.data.entrySet())
          {
            oprot.writeString(_iter10.getKey());
            {
              oprot.writeI32(_iter10.getValue().size());
              for (Map.Entry<String, MessageTplDataCol> _iter11 : _iter10.getValue().entrySet())
              {
      ...
      if (incoming.get(5)) {
        {
          ...
          struct.data = new HashMap<String,Map<String,MessageTplDataCol>>(2*_map12.size);
          String _key13;
          Map<String,MessageTplDataCol> _val14;
          for (int _i15 = 0; _i15 < _map12.size; ++_i15)
          {
            _key13 = iprot.readString();
            {
              ...
              _val14 = new HashMap<String,MessageTplDataCol>(2*_map16.size);
              String _key17;
              MessageTplDataCol _val18;
              for (int _i19 = 0; _i19 < _map16.size; ++_i19)
              {
                _key17 = iprot.readString();
                _val18 = new MessageTplDataCol();
                _val18.read(iprot);
