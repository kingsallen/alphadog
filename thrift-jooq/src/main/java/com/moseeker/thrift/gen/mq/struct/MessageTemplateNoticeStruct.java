...
public class MessageTemplateNoticeStruct implements org.apache.thrift.TBase<MessageTemplateNoticeStruct, MessageTemplateNoticeStruct._Fields>, java.io.Serializable, Cloneable, Comparable<MessageTemplateNoticeStruct> {
  ...
  private static final org.apache.thrift.protocol.TField DELAY_FIELD_DESC = new org.apache.thrift.protocol.TField("delay", org.apache.thrift.protocol.TType.I64, (short)7);
  private static final org.apache.thrift.protocol.TField VALIDATORS_FIELD_DESC = new org.apache.thrift.protocol.TField("validators", org.apache.thrift.protocol.TType.STRING, (short)8);
  ...
  private static final _Fields optionals[] = {_Fields.USER_ID,_Fields.SYS_TEMPLATE_ID,_Fields.URL,_Fields.COMPANY_ID,_Fields.DATA,_Fields.ENABLE_QX_RETRY,_Fields.DELAY,_Fields.VALIDATORS,_Fields.ID};
  ...
  public int hashCode() {
    ...
    boolean present_delay = true && (isSetDelay());
    list.add(present_delay);
    if (present_delay)
      list.add(delay);

    boolean present_validators = true && (isSetValidators());
    list.add(present_validators);
    if (present_validators)
      list.add(validators);
