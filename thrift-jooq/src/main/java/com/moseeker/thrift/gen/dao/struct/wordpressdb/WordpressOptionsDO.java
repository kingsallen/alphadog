...
public class WordpressOptionsDO implements org.apache.thrift.TBase<WordpressOptionsDO, WordpressOptionsDO._Fields>, java.io.Serializable, Cloneable, Comparable<WordpressOptionsDO> {
  ...
  public long optionId; // optional
  public String optionName; // optional
  public String optionValue; // optional
  public String autoload; // optional
  ...
  public WordpressOptionsDO setOptionId(long optionId) {
  ...
  public WordpressOptionsDO setOptionName(String optionName) {
  ...
  public WordpressOptionsDO setOptionValue(String optionValue) {
  ...
  public WordpressOptionsDO setAutoload(String autoload) {
  ...
  public int hashCode() {
    ...
    if (isSetOptionId())
      hashCode = hashCode * 8191 + org.apache.thrift.TBaseHelper.hashCode(optionId);
  ...
  public int compareTo(WordpressOptionsDO other) {
    ...
    lastComparison = Boolean.valueOf(isSetOptionValue()).compareTo(other.isSetOptionValue());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetOptionValue()) {
    ...
    lastComparison = Boolean.valueOf(isSetAutoload()).compareTo(other.isSetAutoload());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetAutoload()) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("WordpressOptionsDO(");
    boolean first = true;
