            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.basics = new ArrayList<Basic>(_list16.size);
                Basic _elem17;
                for (int _i18 = 0; _i18 < _list16.size; ++_i18)
                {
                  _elem17 = new Basic();
                  _elem17.read(iprot);
                  struct.basics.add(_elem17);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, BasicPagination struct) throws org.apache.thrift.TException {
      ...
      if (struct.basics != null) {
        oprot.writeFieldBegin(BASICS_FIELD_DESC);
        {
          ...
          for (Basic _iter19 : struct.basics)
          {
            _iter19.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.isSetBasics()) {
        {
          ...
          for (Basic _iter20 : struct.basics)
          {
            _iter20.write(oprot);
          }
        }
      ...
      if (incoming.get(4)) {
        {
          ...
          struct.basics = new ArrayList<Basic>(_list21.size);
          Basic _elem22;
          for (int _i23 = 0; _i23 < _list21.size; ++_i23)
          {
            _elem22 = new Basic();
            _elem22.read(iprot);
            struct.basics.add(_elem22);
          }
        }
        struct.setBasicsIsSet(true);
      }
