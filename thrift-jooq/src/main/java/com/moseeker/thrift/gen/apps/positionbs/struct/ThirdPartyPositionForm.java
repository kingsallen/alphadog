...
public class ThirdPartyPositionForm implements org.apache.thrift.TBase<ThirdPartyPositionForm, ThirdPartyPositionForm._Fields>, java.io.Serializable, Cloneable, Comparable<ThirdPartyPositionForm> {
  ...
  private static final org.apache.thrift.protocol.TField REQUEST_TYPE_FIELD_DESC = new org.apache.thrift.protocol.TField("requestType", org.apache.thrift.protocol.TType.I32, (short)4);
  ...
  public java.util.List<String> channels; // required
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    REQUEST_TYPE((short)4, "requestType");
  ...
  private static final int __REQUESTTYPE_ISSET_ID = 2;
  ...
  public ThirdPartyPositionForm(ThirdPartyPositionForm other) {
    ...
    if (other.isSetChannels()) {
      java.util.List<String> __this__channels = new java.util.ArrayList<String>(other.channels);
  ...
  public java.util.Iterator<String> getChannelsIterator() {
    return (this.channels == null) ? null : this.channels.iterator();
  }

  public void addToChannels(String elem) {
    if (this.channels == null) {
      this.channels = new java.util.ArrayList<String>();
    }
  ...
  public ThirdPartyPositionForm setChannels(java.util.List<String> channels) {
    this.channels = channels;
    return this;
  }
  ...
  public ThirdPartyPositionForm setRequestType(int requestType) {
    this.requestType = requestType;
    setRequestTypeIsSet(true);
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case CHANNELS:
      if (value == null) {
        ...
        setChannels((java.util.List<String>)value);
      }
      break;
  ...
  private static class ThirdPartyPositionFormStandardScheme extends org.apache.thrift.scheme.StandardScheme<ThirdPartyPositionForm> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.channels = new java.util.ArrayList<String>(_list8.size);
                String _elem9;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ThirdPartyPositionForm struct) throws org.apache.thrift.TException {
      ...
      if (struct.channels != null) {
        ...
        {
          oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRING, struct.channels.size()));
          for (String _iter11 : struct.channels)
          {
      ...
      if (struct.isSetChannels()) {
        {
          ...
          for (String _iter12 : struct.channels)
          {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.channels = new java.util.ArrayList<String>(_list13.size);
          String _elem14;
