...
public class ThirdPartyPositionForm implements org.apache.thrift.TBase<ThirdPartyPositionForm, ThirdPartyPositionForm._Fields>, java.io.Serializable, Cloneable, Comparable<ThirdPartyPositionForm> {
  ...
  public java.util.List<java.util.Map<String,String>> channels; // required
  ...
  public ThirdPartyPositionForm(
    int positionId,
    int appid,
    java.util.List<java.util.Map<String,String>> channels)
  {
    this();
  ...
  public ThirdPartyPositionForm(ThirdPartyPositionForm other) {
    ...
    if (other.isSetChannels()) {
      java.util.List<java.util.Map<String,String>> __this__channels = new java.util.ArrayList<java.util.Map<String,String>>(other.channels.size());
      for (java.util.Map<String,String> other_element : other.channels) {
        java.util.Map<String,String> __this__channels_copy = new java.util.HashMap<String,String>(other_element);
        __this__channels.add(__this__channels_copy);
      }
  ...
  public java.util.Iterator<java.util.Map<String,String>> getChannelsIterator() {
    return (this.channels == null) ? null : this.channels.iterator();
  }

  public void addToChannels(java.util.Map<String,String> elem) {
    if (this.channels == null) {
      this.channels = new java.util.ArrayList<java.util.Map<String,String>>();
    }
    this.channels.add(elem);
  }

  public java.util.List<java.util.Map<String,String>> getChannels() {
    return this.channels;
  }

  public ThirdPartyPositionForm setChannels(java.util.List<java.util.Map<String,String>> channels) {
    this.channels = channels;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case CHANNELS:
      if (value == null) {
        ...
        setChannels((java.util.List<java.util.Map<String,String>>)value);
      }
      break;
  ...
  private static class ThirdPartyPositionFormStandardScheme extends org.apache.thrift.scheme.StandardScheme<ThirdPartyPositionForm> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.channels = new java.util.ArrayList<java.util.Map<String,String>>(_list8.size);
                java.util.Map<String,String> _elem9;
                for (int _i10 = 0; _i10 < _list8.size; ++_i10)
                {
                  {
                    org.apache.thrift.protocol.TMap _map11 = iprot.readMapBegin();
                    _elem9 = new java.util.HashMap<String,String>(2*_map11.size);
                    String _key12;
                    String _val13;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ThirdPartyPositionForm struct) throws org.apache.thrift.TException {
      ...
      if (struct.channels != null) {
        ...
        {
          oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.MAP, struct.channels.size()));
          for (java.util.Map<String,String> _iter15 : struct.channels)
          {
            {
              oprot.writeMapBegin(new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.STRING, _iter15.size()));
              for (java.util.Map.Entry<String, String> _iter16 : _iter15.entrySet())
              {
      ...
      if (struct.isSetChannels()) {
        {
          ...
          for (java.util.Map<String,String> _iter17 : struct.channels)
          {
            {
              oprot.writeI32(_iter17.size());
              for (java.util.Map.Entry<String, String> _iter18 : _iter17.entrySet())
              {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.channels = new java.util.ArrayList<java.util.Map<String,String>>(_list19.size);
          java.util.Map<String,String> _elem20;
          for (int _i21 = 0; _i21 < _list19.size; ++_i21)
          {
            {
              org.apache.thrift.protocol.TMap _map22 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.STRING, iprot.readI32());
              _elem20 = new java.util.HashMap<String,String>(2*_map22.size);
              String _key23;
              String _val24;
