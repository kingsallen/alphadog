...
public class ThirdPartyPositionForm implements org.apache.thrift.TBase<ThirdPartyPositionForm, ThirdPartyPositionForm._Fields>, java.io.Serializable, Cloneable, Comparable<ThirdPartyPositionForm> {
  ...
  public ThirdPartyPositionForm setUser_id(int user_id) {
    this.user_id = user_id;
    setUser_idIsSet(true);
    return this;
  }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.channels = new java.util.ArrayList<ThirdPartyPosition>(_list0.size);
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.channels = new java.util.ArrayList<ThirdPartyPosition>(_list5.size);
