...
public class HrPointsConfDO implements org.apache.thrift.TBase<HrPointsConfDO, HrPointsConfDO._Fields>, java.io.Serializable, Cloneable, Comparable<HrPointsConfDO> {
  ...
  public String applierFirst; // optional
  public String applierRemark; // optional
  public double isRecomSend; // optional
  public String recomFirst; // optional
  public String recomRemark; // optional
  ...
  public HrPointsConfDO setStatusName(String statusName) {
  ...
  public HrPointsConfDO setDescription(String description) {
  ...
  public HrPointsConfDO setUpdateTime(String updateTime) {
  ...
  public HrPointsConfDO setTag(String tag) {
    this.tag = tag;
    return this;
  }
  ...
  public HrPointsConfDO setApplierFirst(String applierFirst) {
  ...
  public HrPointsConfDO setApplierRemark(String applierRemark) {
  ...
  public HrPointsConfDO setRecomFirst(String recomFirst) {
  ...
  public HrPointsConfDO setRecomRemark(String recomRemark) {
  ...
  public int compareTo(HrPointsConfDO other) {
    ...
    lastComparison = Boolean.valueOf(isSetIsApplierSend()).compareTo(other.isSetIsApplierSend());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetIsApplierSend()) {
    ...
    lastComparison = Boolean.valueOf(isSetApplierFirst()).compareTo(other.isSetApplierFirst());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetApplierFirst()) {
    ...
    lastComparison = Boolean.valueOf(isSetApplierRemark()).compareTo(other.isSetApplierRemark());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetApplierRemark()) {
    ...
    lastComparison = Boolean.valueOf(isSetIsRecomSend()).compareTo(other.isSetIsRecomSend());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetIsRecomSend()) {
    ...
    lastComparison = Boolean.valueOf(isSetRecomFirst()).compareTo(other.isSetRecomFirst());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetRecomFirst()) {
    ...
    lastComparison = Boolean.valueOf(isSetRecomRemark()).compareTo(other.isSetRecomRemark());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetRecomRemark()) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("HrPointsConfDO(");
    boolean first = true;
