...
public class CandidateShareChainDO implements org.apache.thrift.TBase<CandidateShareChainDO, CandidateShareChainDO._Fields>, java.io.Serializable, Cloneable, Comparable<CandidateShareChainDO> {
  ...
  private static final _Fields optionals[] = {_Fields.ID,_Fields.POSITION_ID,_Fields.ROOT_RECOM_USER_ID,_Fields.ROOT2_RECOM_USER_ID,_Fields.RECOM_USER_ID,_Fields.PRESENTEE_USER_ID,_Fields.DEPTH,_Fields.PARENT_ID,_Fields.CLICK_TIME,_Fields.CREATE_TIME};
  ...
  public CandidateShareChainDO setDepth(short depth) {
    this.depth = depth;
    setDepthIsSet(true);
    return this;
  }
