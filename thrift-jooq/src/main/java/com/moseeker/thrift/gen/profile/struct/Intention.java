...
public class Intention implements org.apache.thrift.TBase<Intention, Intention._Fields>, java.io.Serializable, Cloneable, Comparable<Intention> {
  ...
  private static final org.apache.thrift.protocol.TField WORKSTATE_FIELD_DESC = new org.apache.thrift.protocol.TField("workstate", org.apache.thrift.protocol.TType.I16, (short)3);
  ...
  private static final org.apache.thrift.protocol.TField SALARY_CODE_FIELD_DESC = new org.apache.thrift.protocol.TField("salary_code", org.apache.thrift.protocol.TType.I16, (short)5);
  ...
  private static final org.apache.thrift.protocol.TField SALARY_STR_FIELD_DESC = new org.apache.thrift.protocol.TField("salary_str", org.apache.thrift.protocol.TType.STRING, (short)10);
  private static final org.apache.thrift.protocol.TField INDUSTRIES_FIELD_DESC = new org.apache.thrift.protocol.TField("industries", org.apache.thrift.protocol.TType.MAP, (short)11);
  private static final org.apache.thrift.protocol.TField POSITIONS_FIELD_DESC = new org.apache.thrift.protocol.TField("positions", org.apache.thrift.protocol.TType.MAP, (short)12);
  private static final org.apache.thrift.protocol.TField CITIES_FIELD_DESC = new org.apache.thrift.protocol.TField("cities", org.apache.thrift.protocol.TType.MAP, (short)13);
  ...
  public short consider_venture_company_opportunities; // required
  public String create_time; // required
  public String update_time; // required
  public String salary_str; // required
  public Map<Integer,String> industries; // required
  public Map<Integer,String> positions; // required
  public Map<Integer,String> cities; // required
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    SALARY_STR((short)10, "salary_str"),
    INDUSTRIES((short)11, "industries"),
    POSITIONS((short)12, "positions"),
    CITIES((short)13, "cities");
  ...
  static {
    ...
    tmpMap.put(_Fields.CONSIDER_VENTURE_COMPANY_OPPORTUNITIES, new org.apache.thrift.meta_data.FieldMetaData("consider_venture_company_opportunities", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I16)));
    ...
    tmpMap.put(_Fields.UPDATE_TIME, new org.apache.thrift.meta_data.FieldMetaData("update_time", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING        , "Timestamp")));
    tmpMap.put(_Fields.SALARY_STR, new org.apache.thrift.meta_data.FieldMetaData("salary_str", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
  ...
  public Intention(
    ...
    short salary_code,
    String tag,
    short consider_venture_company_opportunities,
    String create_time,
    String update_time,
    String salary_str,
    Map<Integer,String> industries,
  ...
  public Intention(Intention other) {
    ...
    if (other.isSetIndustries()) {
      Map<Integer,String> __this__industries = new HashMap<Integer,String>(other.industries);
      this.industries = __this__industries;
    }
    if (other.isSetPositions()) {
      Map<Integer,String> __this__positions = new HashMap<Integer,String>(other.positions);
  ...
  public void putToIndustries(int key, String val) {
    if (this.industries == null) {
      this.industries = new HashMap<Integer,String>();
    }
  ...
  public Intention setIndustries(Map<Integer,String> industries) {
    this.industries = industries;
    return this;
  }
  ...
  public void putToPositions(int key, String val) {
    if (this.positions == null) {
      this.positions = new HashMap<Integer,String>();
    }
  ...
  public Intention setPositions(Map<Integer,String> positions) {
    this.positions = positions;
    return this;
  }
  ...
  public Intention setCities(Map<Integer,String> cities) {
    this.cities = cities;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case INDUSTRIES:
      if (value == null) {
        ...
        setIndustries((Map<Integer,String>)value);
      }
      break;
    ...
    case POSITIONS:
      if (value == null) {
        ...
        setPositions((Map<Integer,String>)value);
      }
      break;
  ...
  public boolean equals(Intention that) {
    ...
    boolean this_present_consider_venture_company_opportunities = true;
    boolean that_present_consider_venture_company_opportunities = true;
  ...
  public int hashCode() {
    ...
    boolean present_consider_venture_company_opportunities = true;
  ...
  private static class IntentionStandardScheme extends StandardScheme<Intention> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.industries = new HashMap<Integer,String>(2*_map0.size);
                int _key1;
                String _val2;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.positions = new HashMap<Integer,String>(2*_map4.size);
                int _key5;
                String _val6;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.cities = new HashMap<Integer,String>(2*_map8.size);
                int _key9;
                String _val10;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Intention struct) throws org.apache.thrift.TException {
      ...
      if (struct.industries != null) {
        ...
        {
          oprot.writeMapBegin(new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.I32, org.apache.thrift.protocol.TType.STRING, struct.industries.size()));
          for (Map.Entry<Integer, String> _iter12 : struct.industries.entrySet())
          {
      ...
      if (struct.positions != null) {
        ...
        {
          oprot.writeMapBegin(new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.I32, org.apache.thrift.protocol.TType.STRING, struct.positions.size()));
          for (Map.Entry<Integer, String> _iter13 : struct.positions.entrySet())
          {
      ...
      if (struct.cities != null) {
        oprot.writeFieldBegin(CITIES_FIELD_DESC);
        {
          ...
          for (Map.Entry<Integer, String> _iter14 : struct.cities.entrySet())
          {
  ...
  private static class IntentionTupleScheme extends TupleScheme<Intention> {
      ...
      if (struct.isSetIndustries()) {
        {
          ...
          for (Map.Entry<Integer, String> _iter15 : struct.industries.entrySet())
          {
      ...
      if (struct.isSetPositions()) {
        {
          ...
          for (Map.Entry<Integer, String> _iter16 : struct.positions.entrySet())
          {
      ...
      if (struct.isSetCities()) {
        {
          ...
          for (Map.Entry<Integer, String> _iter17 : struct.cities.entrySet())
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, Intention struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(10)) {
        {
          org.apache.thrift.protocol.TMap _map18 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.I32, org.apache.thrift.protocol.TType.STRING, iprot.readI32());
          struct.industries = new HashMap<Integer,String>(2*_map18.size);
          int _key19;
          String _val20;
      ...
      if (incoming.get(11)) {
        {
          ...
          struct.positions = new HashMap<Integer,String>(2*_map22.size);
          int _key23;
          String _val24;
      ...
      if (incoming.get(12)) {
        {
          ...
          struct.cities = new HashMap<Integer,String>(2*_map26.size);
          int _key27;
          String _val28;
