...
public class CompanyCertConf implements org.apache.thrift.TBase<CompanyCertConf, CompanyCertConf._Fields>, java.io.Serializable, Cloneable, Comparable<CompanyCertConf> {
  ...
  private static final org.apache.thrift.protocol.TField HR_EMPLOYEE_CERT_CONF_FIELD_DESC = new org.apache.thrift.protocol.TField("hrEmployeeCertConf", org.apache.thrift.protocol.TType.STRUCT, (short)1);
  ...
  public com.moseeker.thrift.gen.dao.struct.hrdb.HrEmployeeCertConfDO hrEmployeeCertConf; // required
  public com.moseeker.thrift.gen.dao.struct.hrdb.HrImporterMonitorDO hrImporterMonitor; // required
  ...
  public CompanyCertConf(
    com.moseeker.thrift.gen.dao.struct.hrdb.HrEmployeeCertConfDO hrEmployeeCertConf,
    com.moseeker.thrift.gen.dao.struct.hrdb.HrImporterMonitorDO hrImporterMonitor)
  {
    this();
  ...
  public CompanyCertConf(CompanyCertConf other) {
    if (other.isSetHrEmployeeCertConf()) {
      this.hrEmployeeCertConf = new com.moseeker.thrift.gen.dao.struct.hrdb.HrEmployeeCertConfDO(other.hrEmployeeCertConf);
    }
    if (other.isSetHrImporterMonitor()) {
      this.hrImporterMonitor = new com.moseeker.thrift.gen.dao.struct.hrdb.HrImporterMonitorDO(other.hrImporterMonitor);
    }
  }
  ...
  public com.moseeker.thrift.gen.dao.struct.hrdb.HrEmployeeCertConfDO getHrEmployeeCertConf() {
    return this.hrEmployeeCertConf;
  }

  public CompanyCertConf setHrEmployeeCertConf(com.moseeker.thrift.gen.dao.struct.hrdb.HrEmployeeCertConfDO hrEmployeeCertConf) {
    this.hrEmployeeCertConf = hrEmployeeCertConf;
    return this;
  }
  ...
  public com.moseeker.thrift.gen.dao.struct.hrdb.HrImporterMonitorDO getHrImporterMonitor() {
    return this.hrImporterMonitor;
  }

  public CompanyCertConf setHrImporterMonitor(com.moseeker.thrift.gen.dao.struct.hrdb.HrImporterMonitorDO hrImporterMonitor) {
    this.hrImporterMonitor = hrImporterMonitor;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case HR_EMPLOYEE_CERT_CONF:
      if (value == null) {
        ...
        setHrEmployeeCertConf((com.moseeker.thrift.gen.dao.struct.hrdb.HrEmployeeCertConfDO)value);
      }
      break;
    ...
    case HR_IMPORTER_MONITOR:
      if (value == null) {
        ...
        setHrImporterMonitor((com.moseeker.thrift.gen.dao.struct.hrdb.HrImporterMonitorDO)value);
      }
      break;
  ...
  public int compareTo(CompanyCertConf other) {
    ...
    lastComparison = Boolean.valueOf(isSetHrEmployeeCertConf()).compareTo(other.isSetHrEmployeeCertConf());
    if (lastComparison != 0) {
    ...
    lastComparison = Boolean.valueOf(isSetHrImporterMonitor()).compareTo(other.isSetHrImporterMonitor());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetHrImporterMonitor()) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("CompanyCertConf(");
    boolean first = true;
  ...
  public void validate() throws org.apache.thrift.TException {
    ...
    if (hrEmployeeCertConf != null) {
      hrEmployeeCertConf.validate();
    }
    if (hrImporterMonitor != null) {
      hrImporterMonitor.validate();
    }
  }
  ...
  private static class CompanyCertConfStandardScheme extends org.apache.thrift.scheme.StandardScheme<CompanyCertConf> {
        ...
        switch (schemeField.id) {
          case 1: // HR_EMPLOYEE_CERT_CONF
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.hrEmployeeCertConf = new com.moseeker.thrift.gen.dao.struct.hrdb.HrEmployeeCertConfDO();
              struct.hrEmployeeCertConf.read(iprot);
          ...
          case 2: // HR_IMPORTER_MONITOR
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.hrImporterMonitor = new com.moseeker.thrift.gen.dao.struct.hrdb.HrImporterMonitorDO();
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, CompanyCertConf struct) throws org.apache.thrift.TException {
      ...
      if (struct.hrEmployeeCertConf != null) {
        ...
        struct.hrEmployeeCertConf.write(oprot);
        oprot.writeFieldEnd();
      }
