...
public class HrRuleUniqueStatisticsDO implements org.apache.thrift.TBase<HrRuleUniqueStatisticsDO, HrRuleUniqueStatisticsDO._Fields>, java.io.Serializable, Cloneable, Comparable<HrRuleUniqueStatisticsDO> {
  ...
  public HrRuleUniqueStatisticsDO setMenuName(String menuName) {
  ...
  public HrRuleUniqueStatisticsDO setCreateDate(String createDate) {
  ...
  public int compareTo(HrRuleUniqueStatisticsDO other) {
    ...
    lastComparison = Boolean.valueOf(isSetWxruleId()).compareTo(other.isSetWxruleId());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetWxruleId()) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("HrRuleUniqueStatisticsDO(");
    boolean first = true;
