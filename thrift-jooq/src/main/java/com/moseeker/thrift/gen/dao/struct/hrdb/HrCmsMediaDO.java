...
public class HrCmsMediaDO implements org.apache.thrift.TBase<HrCmsMediaDO, HrCmsMediaDO._Fields>, java.io.Serializable, Cloneable, Comparable<HrCmsMediaDO> {
  ...
  public String longtexts; // optional
  ...
  public HrCmsMediaDO setLongtexts(String longtexts) {
  ...
  public HrCmsMediaDO setAttrs(String attrs) {
    this.attrs = attrs;
    return this;
  }
  ...
  public HrCmsMediaDO setTitle(String title) {
    this.title = title;
    return this;
  }
  ...
  public HrCmsMediaDO setSubTitle(String subTitle) {
  ...
  public HrCmsMediaDO setLink(String link) {
    this.link = link;
    return this;
  }
  ...
  public HrCmsMediaDO setCreateTime(String createTime) {
  ...
  public HrCmsMediaDO setUpdateTime(String updateTime) {
  ...
  public int compareTo(HrCmsMediaDO other) {
    ...
    lastComparison = Boolean.valueOf(isSetLongtexts()).compareTo(other.isSetLongtexts());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetLongtexts()) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("HrCmsMediaDO(");
    boolean first = true;
