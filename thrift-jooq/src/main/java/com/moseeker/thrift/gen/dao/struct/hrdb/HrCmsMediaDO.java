...
public class HrCmsMediaDO implements org.apache.thrift.TBase<HrCmsMediaDO, HrCmsMediaDO._Fields>, java.io.Serializable, Cloneable, Comparable<HrCmsMediaDO> {
  ...
  private static final org.apache.thrift.protocol.TField LONGTEXT_FIELD_DESC = new org.apache.thrift.protocol.TField("longtext", org.apache.thrift.protocol.TType.STRING, (short)3);
  ...
  private static final _Fields optionals[] = {_Fields.ID,_Fields.MODULE_ID,_Fields.LONGTEXT,_Fields.ATTRS,_Fields.TITLE,_Fields.SUB_TITLE,_Fields.LINK,_Fields.RES_ID,_Fields.ORDER,_Fields.IS_SHOW,_Fields.DISABLE,_Fields.CREATE_TIME,_Fields.UPDATE_TIME};
  ...
  public HrCmsMediaDO setLongtext(java.lang.String longtext) {
  ...
  public HrCmsMediaDO setOrder(int order) {
    this.order = order;
    setOrderIsSet(true);
    return this;
  }
