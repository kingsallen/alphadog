...
@javax.annotation.Generated(value = "Autogenerated by Thrift Compiler (0.10.0)", date = "2018-10-09")
public class UserEmployeeDetailVO implements org.apache.thrift.TBase<UserEmployeeDetailVO, UserEmployeeDetailVO._Fields>, java.io.Serializable, Cloneable, Comparable<UserEmployeeDetailVO> {
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    UNBINDING_TIME((short)17, "unbindingTime");
  ...
  public UserEmployeeDetailVO setUnbindingTime(String unbindingTime) {
    this.unbindingTime = unbindingTime;
    return this;
  }

  public void unsetUnbindingTime() {
    this.unbindingTime = null;
  }

  /** Returns true if field unbindingTime is set (has been assigned a value) and false otherwise */
  public boolean isSetUnbindingTime() {
    return this.unbindingTime != null;
  }

  public void setUnbindingTimeIsSet(boolean value) {
    if (!value) {
      this.unbindingTime = null;
    }
  }
  ...
  public boolean equals(UserEmployeeDetailVO that) {
    ...
    boolean this_present_unbindingTime = true && this.isSetUnbindingTime();
    boolean that_present_unbindingTime = true && that.isSetUnbindingTime();
    if (this_present_unbindingTime || that_present_unbindingTime) {
      if (!(this_present_unbindingTime && that_present_unbindingTime))
        return false;
      if (!this.unbindingTime.equals(that.unbindingTime))
        return false;
    }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetUnbindingTime()) ? 131071 : 524287);
    if (isSetUnbindingTime())
      hashCode = hashCode * 8191 + unbindingTime.hashCode();
  ...
  public int compareTo(UserEmployeeDetailVO other) {
    ...
    lastComparison = Boolean.valueOf(isSetUnbindingTime()).compareTo(other.isSetUnbindingTime());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetUnbindingTime()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.unbindingTime, other.unbindingTime);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    ...
    if (isSetUnbindingTime()) {
      if (!first) sb.append(", ");
      sb.append("unbindingTime:");
      if (this.unbindingTime == null) {
        sb.append("null");
      } else {
        sb.append(this.unbindingTime);
      }
      first = false;
    }
    sb.append(")");
  ...
  private static class UserEmployeeDetailVOStandardScheme extends org.apache.thrift.scheme.StandardScheme<UserEmployeeDetailVO> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, UserEmployeeDetailVO struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 17: // UNBINDING_TIME
            if (schemeField.type == org.apache.thrift.protocol.TType.STRING) {
              struct.unbindingTime = iprot.readString();
              struct.setUnbindingTimeIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, UserEmployeeDetailVO struct) throws org.apache.thrift.TException {
      ...
      if (struct.unbindingTime != null) {
        if (struct.isSetUnbindingTime()) {
          oprot.writeFieldBegin(UNBINDING_TIME_FIELD_DESC);
          oprot.writeString(struct.unbindingTime);
          oprot.writeFieldEnd();
        }
      }
