...
public class LogWxTemplateMessageSendrecordDO implements org.apache.thrift.TBase<LogWxTemplateMessageSendrecordDO, LogWxTemplateMessageSendrecordDO._Fields>, java.io.Serializable, Cloneable, Comparable<LogWxTemplateMessageSendrecordDO> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("LogWxTemplateMessageSendrecordDO");
  ...
  private static final org.apache.thrift.protocol.TField MSGID_FIELD_DESC = new org.apache.thrift.protocol.TField("msgid", org.apache.thrift.protocol.TType.I64, (short)4);
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new LogWxTemplateMessageSendrecordDOStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new LogWxTemplateMessageSendrecordDOTupleSchemeFactory();
  ...
  public String sendstatus; // optional
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(LogWxTemplateMessageSendrecordDO.class, metaDataMap);
  }

  public LogWxTemplateMessageSendrecordDO() {
  }

  /**
   * Performs a deep copy on <i>other</i>.
   */
  public LogWxTemplateMessageSendrecordDO(LogWxTemplateMessageSendrecordDO other) {
  ...
  public LogWxTemplateMessageSendrecordDO deepCopy() {
    return new LogWxTemplateMessageSendrecordDO(this);
  }
  ...
  public LogWxTemplateMessageSendrecordDO setId(int id) {
    this.id = id;
    setIdIsSet(true);
    return this;
  }
  ...
  public LogWxTemplateMessageSendrecordDO setTemplateId(int templateId) {
  ...
  public LogWxTemplateMessageSendrecordDO setWechatId(int wechatId) {
  ...
  public LogWxTemplateMessageSendrecordDO setMsgid(long msgid) {
    this.msgid = msgid;
    setMsgidIsSet(true);
    return this;
  }
  ...
  public LogWxTemplateMessageSendrecordDO setOpenId(String openId) {
    this.openId = openId;
    return this;
  }
  ...
  public LogWxTemplateMessageSendrecordDO setUrl(String url) {
    this.url = url;
    return this;
  }
  ...
  public LogWxTemplateMessageSendrecordDO setTopcolor(String topcolor) {
  ...
  public LogWxTemplateMessageSendrecordDO setJsondata(String jsondata) {
  ...
  public LogWxTemplateMessageSendrecordDO setErrcode(int errcode) {
  ...
  public LogWxTemplateMessageSendrecordDO setErrmsg(String errmsg) {
    this.errmsg = errmsg;
    return this;
  }
  ...
  public LogWxTemplateMessageSendrecordDO setSendtime(String sendtime) {
  ...
  public LogWxTemplateMessageSendrecordDO setUpdatetime(String updatetime) {
  ...
  public LogWxTemplateMessageSendrecordDO setSendstatus(String sendstatus) {
  ...
  public LogWxTemplateMessageSendrecordDO setSendtype(int sendtype) {
  ...
  public LogWxTemplateMessageSendrecordDO setAccessToken(String accessToken) {
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof LogWxTemplateMessageSendrecordDO)
      return this.equals((LogWxTemplateMessageSendrecordDO)that);
    return false;
  }

  public boolean equals(LogWxTemplateMessageSendrecordDO that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(LogWxTemplateMessageSendrecordDO other) {
    ...
    lastComparison = Boolean.valueOf(isSetSendstatus()).compareTo(other.isSetSendstatus());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetSendstatus()) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("LogWxTemplateMessageSendrecordDO(");
    boolean first = true;
  ...
  private static class LogWxTemplateMessageSendrecordDOStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public LogWxTemplateMessageSendrecordDOStandardScheme getScheme() {
      return new LogWxTemplateMessageSendrecordDOStandardScheme();
    }
  }

  private static class LogWxTemplateMessageSendrecordDOStandardScheme extends org.apache.thrift.scheme.StandardScheme<LogWxTemplateMessageSendrecordDO> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, LogWxTemplateMessageSendrecordDO struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, LogWxTemplateMessageSendrecordDO struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class LogWxTemplateMessageSendrecordDOTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public LogWxTemplateMessageSendrecordDOTupleScheme getScheme() {
      return new LogWxTemplateMessageSendrecordDOTupleScheme();
    }
  }

  private static class LogWxTemplateMessageSendrecordDOTupleScheme extends org.apache.thrift.scheme.TupleScheme<LogWxTemplateMessageSendrecordDO> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, LogWxTemplateMessageSendrecordDO struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, LogWxTemplateMessageSendrecordDO struct) throws org.apache.thrift.TException {
