...
public class HrTopicDO implements org.apache.thrift.TBase<HrTopicDO, HrTopicDO._Fields>, java.io.Serializable, Cloneable, Comparable<HrTopicDO> {
  ...
  public String shareLogo; // optional
  public String shareDescription; // optional
  ...
  public HrTopicDO setShareTitle(String shareTitle) {
  ...
  public HrTopicDO setShareLogo(String shareLogo) {
  ...
  public HrTopicDO setShareDescription(String shareDescription) {
  ...
  public HrTopicDO setCreateTime(String createTime) {
  ...
  public HrTopicDO setUpdateTime(String updateTime) {
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case SHARE_DESCRIPTION:
      if (value == null) {
        ...
        setShareDescription((String)value);
      }
      break;
  ...
  public int compareTo(HrTopicDO other) {
    ...
    lastComparison = Boolean.valueOf(isSetShareLogo()).compareTo(other.isSetShareLogo());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetShareLogo()) {
    ...
    lastComparison = Boolean.valueOf(isSetShareDescription()).compareTo(other.isSetShareDescription());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetShareDescription()) {
    ...
    lastComparison = Boolean.valueOf(isSetStyleId()).compareTo(other.isSetStyleId());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetStyleId()) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("HrTopicDO(");
    boolean first = true;
