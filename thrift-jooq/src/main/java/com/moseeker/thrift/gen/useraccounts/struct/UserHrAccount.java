...
public class UserHrAccount implements org.apache.thrift.TBase<UserHrAccount, UserHrAccount._Fields>, java.io.Serializable, Cloneable, Comparable<UserHrAccount> {
  ...
  private static final org.apache.thrift.protocol.TField LEAVE_TO_MOBOT_FIELD_DESC = new org.apache.thrift.protocol.TField("leave_to_mobot", org.apache.thrift.protocol.TType.BYTE, (short)21);
  ...
  public byte leave_to_mobot; // optional
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    LEAVE_TO_MOBOT((short)21, "leave_to_mobot");
  ...
  private static final int __LEAVE_TO_MOBOT_ISSET_ID = 8;
  ...
  static {
    ...
    tmpMap.put(_Fields.HEADIMGURL, new org.apache.thrift.meta_data.FieldMetaData("headimgurl", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
    tmpMap.put(_Fields.LEAVE_TO_MOBOT, new org.apache.thrift.meta_data.FieldMetaData("leave_to_mobot", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.BYTE)));
  ...
  public UserHrAccount(UserHrAccount other) {
    ...
    this.leave_to_mobot = other.leave_to_mobot;
  }
  ...
  public void clear() {
    ...
    setLeave_to_mobotIsSet(false);
    this.leave_to_mobot = 0;
  }
  ...
  public UserHrAccount setHeadimgurl(String headimgurl) {
  ...
  public byte getLeave_to_mobot() {
    return this.leave_to_mobot;
  }

  public UserHrAccount setLeave_to_mobot(byte leave_to_mobot) {
    this.leave_to_mobot = leave_to_mobot;
    setLeave_to_mobotIsSet(true);
    return this;
  }

  public void unsetLeave_to_mobot() {
    __isset_bitfield = org.apache.thrift.EncodingUtils.clearBit(__isset_bitfield, __LEAVE_TO_MOBOT_ISSET_ID);
  }

  /** Returns true if field leave_to_mobot is set (has been assigned a value) and false otherwise */
  public boolean isSetLeave_to_mobot() {
    return org.apache.thrift.EncodingUtils.testBit(__isset_bitfield, __LEAVE_TO_MOBOT_ISSET_ID);
  }

  public void setLeave_to_mobotIsSet(boolean value) {
    __isset_bitfield = org.apache.thrift.EncodingUtils.setBit(__isset_bitfield, __LEAVE_TO_MOBOT_ISSET_ID, value);
  }
  ...
  public boolean equals(UserHrAccount that) {
    ...
    boolean this_present_leave_to_mobot = true && this.isSetLeave_to_mobot();
    boolean that_present_leave_to_mobot = true && that.isSetLeave_to_mobot();
    if (this_present_leave_to_mobot || that_present_leave_to_mobot) {
      if (!(this_present_leave_to_mobot && that_present_leave_to_mobot))
        return false;
      if (this.leave_to_mobot != that.leave_to_mobot)
        return false;
    }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetLeave_to_mobot()) ? 131071 : 524287);
    if (isSetLeave_to_mobot())
      hashCode = hashCode * 8191 + (int) (leave_to_mobot);
  ...
  public int compareTo(UserHrAccount other) {
    ...
    lastComparison = Boolean.valueOf(isSetLeave_to_mobot()).compareTo(other.isSetLeave_to_mobot());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetLeave_to_mobot()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.leave_to_mobot, other.leave_to_mobot);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    ...
    if (isSetLeave_to_mobot()) {
      if (!first) sb.append(", ");
      sb.append("leave_to_mobot:");
      sb.append(this.leave_to_mobot);
      first = false;
    }
    sb.append(")");
    return sb.toString();
  ...
  private static class UserHrAccountStandardScheme extends org.apache.thrift.scheme.StandardScheme<UserHrAccount> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, UserHrAccount struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 21: // LEAVE_TO_MOBOT
            if (schemeField.type == org.apache.thrift.protocol.TType.BYTE) {
              struct.leave_to_mobot = iprot.readByte();
              struct.setLeave_to_mobotIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, UserHrAccount struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetLeave_to_mobot()) {
        oprot.writeFieldBegin(LEAVE_TO_MOBOT_FIELD_DESC);
        oprot.writeByte(struct.leave_to_mobot);
        oprot.writeFieldEnd();
      }
