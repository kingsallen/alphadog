...
public class ThirdPartyPositionForSynchronization implements org.apache.thrift.TBase<ThirdPartyPositionForSynchronization, ThirdPartyPositionForSynchronization._Fields>, java.io.Serializable, Cloneable, Comparable<ThirdPartyPositionForSynchronization> {
  ...
  private static final org.apache.thrift.protocol.TField WELFARE_FIELD_DESC = new org.apache.thrift.protocol.TField("welfare", org.apache.thrift.protocol.TType.LIST, (short)26);
  ...
  public java.util.List<java.lang.String> welfare; // required
  ...
  public ThirdPartyPositionForSynchronization(
    ...
    int account_id,
    int feedback_period,
    java.util.List<java.lang.String> welfare)
  {
    this();
    this.title = title;
  ...
  public ThirdPartyPositionForSynchronization(ThirdPartyPositionForSynchronization other) {
    ...
    if (other.isSetWelfare()) {
      java.util.List<java.lang.String> __this__welfare = new java.util.ArrayList<java.lang.String>(other.welfare);
  ...
  public java.util.Iterator<java.lang.String> getWelfareIterator() {
    return (this.welfare == null) ? null : this.welfare.iterator();
  }

  public void addToWelfare(java.lang.String elem) {
    if (this.welfare == null) {
      this.welfare = new java.util.ArrayList<java.lang.String>();
    }
    this.welfare.add(elem);
  }

  public java.util.List<java.lang.String> getWelfare() {
    return this.welfare;
  }

  public ThirdPartyPositionForSynchronization setWelfare(java.util.List<java.lang.String> welfare) {
    this.welfare = welfare;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case WELFARE:
      if (value == null) {
        ...
        setWelfare((java.util.List<java.lang.String>)value);
      }
      break;
  ...
  public int compareTo(ThirdPartyPositionForSynchronization other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetWelfare()).compareTo(other.isSetWelfare());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetWelfare()) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.welfare = new java.util.ArrayList<java.lang.String>(_list19.size);
                java.lang.String _elem20;
                for (int _i21 = 0; _i21 < _list19.size; ++_i21)
                {
                  _elem20 = iprot.readString();
                  struct.welfare.add(_elem20);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ThirdPartyPositionForSynchronization struct) throws org.apache.thrift.TException {
      ...
      if (struct.cities != null) {
        oprot.writeFieldBegin(CITIES_FIELD_DESC);
        {
          ...
          {
            {
              oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRING, _iter23.size()));
      ...
      if (struct.welfare != null) {
        oprot.writeFieldBegin(WELFARE_FIELD_DESC);
        {
          ...
          for (java.lang.String _iter25 : struct.welfare)
          {
  ...
  private static class ThirdPartyPositionForSynchronizationTupleScheme extends org.apache.thrift.scheme.TupleScheme<ThirdPartyPositionForSynchronization> {
      ...
      if (struct.isSetOccupation()) {
        {
          ...
          for (java.lang.String _iter26 : struct.occupation)
          {
      ...
      if (struct.isSetCities()) {
        {
          ...
          for (java.util.List<java.lang.String> _iter27 : struct.cities)
          {
            {
              oprot.writeI32(_iter27.size());
              for (java.lang.String _iter28 : _iter27)
              {
      ...
      if (struct.isSetWelfare()) {
        {
          ...
          for (java.lang.String _iter29 : struct.welfare)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, ThirdPartyPositionForSynchronization struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.occupation = new java.util.ArrayList<java.lang.String>(_list30.size);
          java.lang.String _elem31;
          for (int _i32 = 0; _i32 < _list30.size; ++_i32)
          {
            _elem31 = iprot.readString();
            struct.occupation.add(_elem31);
          }
        }
        struct.setOccupationIsSet(true);
      }
      if (incoming.get(2)) {
        {
          org.apache.thrift.protocol.TList _list33 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.LIST, iprot.readI32());
          struct.cities = new java.util.ArrayList<java.util.List<java.lang.String>>(_list33.size);
          java.util.List<java.lang.String> _elem34;
          ...
          {
            {
              ...
              _elem34 = new java.util.ArrayList<java.lang.String>(_list36.size);
      ...
      if (incoming.get(25)) {
        {
          ...
          struct.welfare = new java.util.ArrayList<java.lang.String>(_list39.size);
          java.lang.String _elem40;
          for (int _i41 = 0; _i41 < _list39.size; ++_i41)
          {
            _elem40 = iprot.readString();
            struct.welfare.add(_elem40);
          }
        }
        struct.setWelfareIsSet(true);
      }
