...
public class CandidateService {
  ...
  public interface Iface {
    ...
    public com.moseeker.thrift.gen.candidate.struct.RecommendResult getRecomendations(int companyId, java.util.List<Integer> idList) throws com.moseeker.thrift.gen.common.struct.BIZException, org.apache.thrift.TException;
    ...
    public com.moseeker.thrift.gen.candidate.struct.RecommendResult ignore(int id, int companyId, int postUserId, String clickTime) throws com.moseeker.thrift.gen.common.struct.BIZException, org.apache.thrift.TException;
    ...
    public com.moseeker.thrift.gen.candidate.struct.PositionLayerInfo getPositionLayerInfo(int userId, int companyId, int positionId) throws com.moseeker.thrift.gen.common.struct.BIZException, org.apache.thrift.TException;
    ...
    public com.moseeker.thrift.gen.common.struct.Response getCandidateRecoms(java.util.List<Integer> appIds) throws com.moseeker.thrift.gen.common.struct.BIZException, org.apache.thrift.TException;
  ...
  public interface AsyncIface {
    ...
    public void getRecomendations(int companyId, java.util.List<Integer> idList, org.apache.thrift.async.AsyncMethodCallback<com.moseeker.thrift.gen.candidate.struct.RecommendResult> resultHandler) throws org.apache.thrift.TException;
    ...
    public void ignore(int id, int companyId, int postUserId, String clickTime, org.apache.thrift.async.AsyncMethodCallback<com.moseeker.thrift.gen.candidate.struct.RecommendResult> resultHandler) throws org.apache.thrift.TException;
    ...
    public void getPositionLayerInfo(int userId, int companyId, int positionId, org.apache.thrift.async.AsyncMethodCallback<com.moseeker.thrift.gen.candidate.struct.PositionLayerInfo> resultHandler) throws org.apache.thrift.TException;
    ...
    public void getCandidateRecoms(java.util.List<Integer> appIds, org.apache.thrift.async.AsyncMethodCallback<com.moseeker.thrift.gen.common.struct.Response> resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public void send_getRecomendations(int companyId, java.util.List<Integer> idList) throws org.apache.thrift.TException
    {
    ...
    public void send_ignore(int id, int companyId, int postUserId, String clickTime) throws org.apache.thrift.TException
    {
    ...
    public com.moseeker.thrift.gen.candidate.struct.PositionLayerInfo recv_getPositionLayerInfo() throws com.moseeker.thrift.gen.common.struct.BIZException, org.apache.thrift.TException
    {
    ...
    public com.moseeker.thrift.gen.common.struct.Response getCandidateRecoms(java.util.List<Integer> appIds) throws com.moseeker.thrift.gen.common.struct.BIZException, org.apache.thrift.TException
    {
      send_getCandidateRecoms(appIds);
      return recv_getCandidateRecoms();
    }

    public void send_getCandidateRecoms(java.util.List<Integer> appIds) throws org.apache.thrift.TException
    {
      getCandidateRecoms_args args = new getCandidateRecoms_args();
      args.setAppIds(appIds);
      sendBase("getCandidateRecoms", args);
    }

    public com.moseeker.thrift.gen.common.struct.Response recv_getCandidateRecoms() throws com.moseeker.thrift.gen.common.struct.BIZException, org.apache.thrift.TException
    {
      getCandidateRecoms_result result = new getCandidateRecoms_result();
      receiveBase(result, "getCandidateRecoms");
      if (result.isSetSuccess()) {
        return result.success;
      }
      if (result.e != null) {
      ...
      throw new org.apache.thrift.TApplicationException(org.apache.thrift.TApplicationException.MISSING_RESULT, "getCandidateRecoms failed: unknown result");
    }
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public static class getRecomendations_call extends org.apache.thrift.async.TAsyncMethodCall<com.moseeker.thrift.gen.candidate.struct.RecommendResult> {
      ...
      private java.util.List<Integer> idList;
      public getRecomendations_call(int companyId, java.util.List<Integer> idList, org.apache.thrift.async.AsyncMethodCallback<com.moseeker.thrift.gen.candidate.struct.RecommendResult> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
    ...
    public static class ignore_call extends org.apache.thrift.async.TAsyncMethodCall<com.moseeker.thrift.gen.candidate.struct.RecommendResult> {
      ...
      public ignore_call(int id, int companyId, int postUserId, String clickTime, org.apache.thrift.async.AsyncMethodCallback<com.moseeker.thrift.gen.candidate.struct.RecommendResult> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.id = id;
        this.companyId = companyId;
        this.postUserId = postUserId;
    ...
    public static class getPositionLayerInfo_call extends org.apache.thrift.async.TAsyncMethodCall<com.moseeker.thrift.gen.candidate.struct.PositionLayerInfo> {
      private int userId;
      private int companyId;
      private int positionId;
      public getPositionLayerInfo_call(int userId, int companyId, int positionId, org.apache.thrift.async.AsyncMethodCallback<com.moseeker.thrift.gen.candidate.struct.PositionLayerInfo> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.userId = userId;
        this.companyId = companyId;
        this.positionId = positionId;
      ...
      public com.moseeker.thrift.gen.candidate.struct.PositionLayerInfo getResult() throws com.moseeker.thrift.gen.common.struct.BIZException, org.apache.thrift.TException {
        if (getState() != State.RESPONSE_READ) {
          throw new IllegalStateException("Method call not finished!");
        }
        org.apache.thrift.transport.TMemoryInputTransport memoryTransport = new org.apache.thrift.transport.TMemoryInputTransport(getFrameBuffer().array());
    ...
    public void getCandidateRecoms(java.util.List<Integer> appIds, org.apache.thrift.async.AsyncMethodCallback<com.moseeker.thrift.gen.common.struct.Response> resultHandler) throws org.apache.thrift.TException {
      checkReady();
      getCandidateRecoms_call method_call = new getCandidateRecoms_call(appIds, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }

    public static class getCandidateRecoms_call extends org.apache.thrift.async.TAsyncMethodCall<com.moseeker.thrift.gen.common.struct.Response> {
      private java.util.List<Integer> appIds;
      public getCandidateRecoms_call(java.util.List<Integer> appIds, org.apache.thrift.async.AsyncMethodCallback<com.moseeker.thrift.gen.common.struct.Response> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.appIds = appIds;
      }

      public void write_args(org.apache.thrift.protocol.TProtocol prot) throws org.apache.thrift.TException {
        prot.writeMessageBegin(new org.apache.thrift.protocol.TMessage("getCandidateRecoms", org.apache.thrift.protocol.TMessageType.CALL, 0));
        getCandidateRecoms_args args = new getCandidateRecoms_args();
        args.setAppIds(appIds);
        args.write(prot);
        prot.writeMessageEnd();
      ...
      public com.moseeker.thrift.gen.common.struct.Response getResult() throws com.moseeker.thrift.gen.common.struct.BIZException, org.apache.thrift.TException {
        ...
        org.apache.thrift.transport.TMemoryInputTransport memoryTransport = new org.apache.thrift.transport.TMemoryInputTransport(getFrameBuffer().array());
        org.apache.thrift.protocol.TProtocol prot = client.getProtocolFactory().getProtocol(memoryTransport);
        return (new Client(prot)).recv_getCandidateRecoms();
      }
    }
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    private static <I extends Iface> java.util.Map<String,  org.apache.thrift.ProcessFunction<I, ? extends org.apache.thrift.TBase>> getProcessMap(java.util.Map<String, org.apache.thrift.ProcessFunction<I, ? extends  org.apache.thrift.TBase>> processMap) {
      ...
      processMap.put("getCandidateRecoms", new getCandidateRecoms());
      return processMap;
    }
    ...
    public static class getCandidateRecoms<I extends Iface> extends org.apache.thrift.ProcessFunction<I, getCandidateRecoms_args> {
      public getCandidateRecoms() {
        super("getCandidateRecoms");
      }

      public getCandidateRecoms_args getEmptyArgsInstance() {
        return new getCandidateRecoms_args();
      }
      ...
      public getCandidateRecoms_result getResult(I iface, getCandidateRecoms_args args) throws org.apache.thrift.TException {
        getCandidateRecoms_result result = new getCandidateRecoms_result();
        try {
          result.success = iface.getCandidateRecoms(args.appIds);
        } catch (com.moseeker.thrift.gen.common.struct.BIZException e) {
          result.e = e;
        }
        return result;
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class getPositionLayerInfo<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, getPositionLayerInfo_args, com.moseeker.thrift.gen.candidate.struct.PositionLayerInfo> {
      public getPositionLayerInfo() {
        super("getPositionLayerInfo");
      }
      ...
      public org.apache.thrift.async.AsyncMethodCallback<com.moseeker.thrift.gen.candidate.struct.PositionLayerInfo> getResultHandler(final org.apache.thrift.server.AbstractNonblockingServer.AsyncFrameBuffer fb, final int seqid) {
        final org.apache.thrift.AsyncProcessFunction fcall = this;
        return new org.apache.thrift.async.AsyncMethodCallback<com.moseeker.thrift.gen.candidate.struct.PositionLayerInfo>() { 
          public void onComplete(com.moseeker.thrift.gen.candidate.struct.PositionLayerInfo o) {
            getPositionLayerInfo_result result = new getPositionLayerInfo_result();
            result.success = o;
            try {
              fcall.sendResponse(fb, result, org.apache.thrift.protocol.TMessageType.REPLY,seqid);
      ...
      public void start(I iface, getPositionLayerInfo_args args, org.apache.thrift.async.AsyncMethodCallback<com.moseeker.thrift.gen.candidate.struct.PositionLayerInfo> resultHandler) throws org.apache.thrift.TException {
    ...
    public static class getCandidateRecoms<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, getCandidateRecoms_args, com.moseeker.thrift.gen.common.struct.Response> {
      public getCandidateRecoms() {
        super("getCandidateRecoms");
      }
      ...
      public void start(I iface, getCandidateRecoms_args args, org.apache.thrift.async.AsyncMethodCallback<com.moseeker.thrift.gen.common.struct.Response> resultHandler) throws org.apache.thrift.TException {
        iface.getCandidateRecoms(args.appIds,resultHandler);
      }
    }
  ...
  public static class glancePosition_args implements org.apache.thrift.TBase<glancePosition_args, glancePosition_args._Fields>, java.io.Serializable, Cloneable, Comparable<glancePosition_args>   {
    ...
    public String toString() {
      StringBuilder sb = new StringBuilder("glancePosition_args(");
      boolean first = true;
...
;
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("glancePosition_result(");
      boolean first = true;
  ...
  public static class changeInteresting_args implements org.apache.thrift.TBase<changeInteresting_args, changeInteresting_args._Fields>, java.io.Serializable, Cloneable, Comparable<changeInteresting_args>   {
    ...
    public int compareTo(changeInteresting_args other) {
      ...
      lastComparison = Boolean.valueOf(isSetIs_interested()).compareTo(other.isSetIs_interested());
      if (lastComparison != 0) {
        return lastComparison;
      }
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("changeInteresting_args(");
      boolean first = true;
  ...
  public static class changeInteresting_result implements org.apache.thrift.TBase<changeInteresting_result, changeInteresting_result._Fields>, java.io.Serializable, Cloneable, Comparable<changeInteresting_result>   {
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("changeInteresting_result(");
      boolean first = true;
  ...
  public static class candidateList_args implements org.apache.thrift.TBase<candidateList_args, candidateList_args._Fields>, java.io.Serializable, Cloneable, Comparable<candidateList_args>   {
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("candidateList_args(");
      boolean first = true;
  ...
  public static class candidateList_result implements org.apache.thrift.TBase<candidateList_result, candidateList_result._Fields>, java.io.Serializable, Cloneable, Comparable<candidateList_result>   {
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("candidateList_result(");
      boolean first = true;
  ...
  public static class getRecomendations_args implements org.apache.thrift.TBase<getRecomendations_args, getRecomendations_args._Fields>, java.io.Serializable, Cloneable, Comparable<getRecomendations_args>   {
    ...
    public java.util.List<Integer> idList; // required
    ...
    public getRecomendations_args(getRecomendations_args other) {
      ...
      if (other.isSetIdList()) {
        java.util.List<Integer> __this__idList = new java.util.ArrayList<Integer>(other.idList);
    ...
    public void addToIdList(int elem) {
      if (this.idList == null) {
        this.idList = new java.util.ArrayList<Integer>();
      }
      this.idList.add(elem);
    }

    public java.util.List<Integer> getIdList() {
      return this.idList;
    }

    public getRecomendations_args setIdList(java.util.List<Integer> idList) {
      this.idList = idList;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case ID_LIST:
        if (value == null) {
          ...
          setIdList((java.util.List<Integer>)value);
        }
        break;
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("getRecomendations_args(");
      boolean first = true;
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.idList = new java.util.ArrayList<Integer>(_list8.size);
                  int _elem9;
        ...
        if (incoming.get(1)) {
          {
            ...
            struct.idList = new java.util.ArrayList<Integer>(_list13.size);
            int _elem14;
  ...
  public static class getRecomendations_result implements org.apache.thrift.TBase<getRecomendations_result, getRecomendations_result._Fields>, java.io.Serializable, Cloneable, Comparable<getRecomendations_result>   {
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("getRecomendations_result(");
      boolean first = true;
  ...
  public static class getRecommendatorySorting_args implements org.apache.thrift.TBase<getRecommendatorySorting_args, getRecommendatorySorting_args._Fields>, java.io.Serializable, Cloneable, Comparable<getRecommendatorySorting_args>   {
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("getRecommendatorySorting_args(");
      boolean first = true;
  ...
  public static class getRecommendatorySorting_result implements org.apache.thrift.TBase<getRecommendatorySorting_result, getRecommendatorySorting_result._Fields>, java.io.Serializable, Cloneable, Comparable<getRecommendatorySorting_result>   {
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("getRecommendatorySorting_result(");
      boolean first = true;
  ...
  public static class ignore_args implements org.apache.thrift.TBase<ignore_args, ignore_args._Fields>, java.io.Serializable, Cloneable, Comparable<ignore_args>   {
    ...
    public int companyId; // required
    public int postUserId; // required
    public String clickTime; // required
    ...
    public ignore_args setClickTime(String clickTime) {
      this.clickTime = clickTime;
      return this;
    }
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("ignore_args(");
      boolean first = true;
  ...
  public static class ignore_result implements org.apache.thrift.TBase<ignore_result, ignore_result._Fields>, java.io.Serializable, Cloneable, Comparable<ignore_result>   {
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("ignore_result(");
      boolean first = true;
  ...
  public static class getCandidateInfo_args implements org.apache.thrift.TBase<getCandidateInfo_args, getCandidateInfo_args._Fields>, java.io.Serializable, Cloneable, Comparable<getCandidateInfo_args>   {
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("getCandidateInfo_args(");
      boolean first = true;
  ...
  public static class getCandidateInfo_result implements org.apache.thrift.TBase<getCandidateInfo_result, getCandidateInfo_result._Fields>, java.io.Serializable, Cloneable, Comparable<getCandidateInfo_result>   {
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("getCandidateInfo_result(");
      boolean first = true;
  ...
  public static class getRecentPosition_args implements org.apache.thrift.TBase<getRecentPosition_args, getRecentPosition_args._Fields>, java.io.Serializable, Cloneable, Comparable<getRecentPosition_args>   {
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("getRecentPosition_args(");
      boolean first = true;
  ...
  public static class getRecentPosition_result implements org.apache.thrift.TBase<getRecentPosition_result, getRecentPosition_result._Fields>, java.io.Serializable, Cloneable, Comparable<getRecentPosition_result>   {
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("getRecentPosition_result(");
      boolean first = true;
  ...
  public static class addApplicationReferral_args implements org.apache.thrift.TBase<addApplicationReferral_args, addApplicationReferral_args._Fields>, java.io.Serializable, Cloneable, Comparable<addApplicationReferral_args>   {
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case DIRECT_REFERRAL_USER_ID:
        if (value == null) {
          ...
          setDirectReferralUserId((Integer)value);
        }
        break;
    ...
    public int compareTo(addApplicationReferral_args other) {
      ...
      lastComparison = Boolean.valueOf(isSetDirectReferralUserId()).compareTo(other.isSetDirectReferralUserId());
      if (lastComparison != 0) {
        return lastComparison;
      }
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("addApplicationReferral_args(");
      boolean first = true;
  ...
  public static class addApplicationReferral_result implements org.apache.thrift.TBase<addApplicationReferral_result, addApplicationReferral_result._Fields>, java.io.Serializable, Cloneable, Comparable<addApplicationReferral_result>   {
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("addApplicationReferral_result(");
      boolean first = true;
  ...
  public static class getApplicationReferral_args implements org.apache.thrift.TBase<getApplicationReferral_args, getApplicationReferral_args._Fields>, java.io.Serializable, Cloneable, Comparable<getApplicationReferral_args>   {
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("getApplicationReferral_args(");
      boolean first = true;
  ...
  public static class getApplicationReferral_result implements org.apache.thrift.TBase<getApplicationReferral_result, getApplicationReferral_result._Fields>, java.io.Serializable, Cloneable, Comparable<getApplicationReferral_result>   {
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("getApplicationReferral_result(");
      boolean first = true;
  ...
  public static class getPositionLayerInfo_args implements org.apache.thrift.TBase<getPositionLayerInfo_args, getPositionLayerInfo_args._Fields>, java.io.Serializable, Cloneable, Comparable<getPositionLayerInfo_args>   {
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("getPositionLayerInfo_args(");
      boolean first = true;
  ...
  public static class getPositionLayerInfo_result implements org.apache.thrift.TBase<getPositionLayerInfo_result, getPositionLayerInfo_result._Fields>, java.io.Serializable, Cloneable, Comparable<getPositionLayerInfo_result>   {
    ...
    public com.moseeker.thrift.gen.candidate.struct.PositionLayerInfo success; // required
    public com.moseeker.thrift.gen.common.struct.BIZException e; // required
    ...
    static {
      java.util.Map<_Fields, org.apache.thrift.meta_data.FieldMetaData> tmpMap = new java.util.EnumMap<_Fields, org.apache.thrift.meta_data.FieldMetaData>(_Fields.class);
      tmpMap.put(_Fields.SUCCESS, new org.apache.thrift.meta_data.FieldMetaData("success", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, com.moseeker.thrift.gen.candidate.struct.PositionLayerInfo.class)));
      tmpMap.put(_Fields.E, new org.apache.thrift.meta_data.FieldMetaData("e", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, com.moseeker.thrift.gen.common.struct.BIZException.class)));
      metaDataMap = java.util.Collections.unmodifiableMap(tmpMap);
    ...
    public getPositionLayerInfo_result(
      com.moseeker.thrift.gen.candidate.struct.PositionLayerInfo success,
      com.moseeker.thrift.gen.common.struct.BIZException e)
    {
      this();
      this.success = success;
    ...
    public getPositionLayerInfo_result(getPositionLayerInfo_result other) {
      if (other.isSetSuccess()) {
        this.success = new com.moseeker.thrift.gen.candidate.struct.PositionLayerInfo(other.success);
      }
      if (other.isSetE()) {
        this.e = new com.moseeker.thrift.gen.common.struct.BIZException(other.e);
      }
    ...
    public com.moseeker.thrift.gen.candidate.struct.PositionLayerInfo getSuccess() {
      return this.success;
    }

    public getPositionLayerInfo_result setSuccess(com.moseeker.thrift.gen.candidate.struct.PositionLayerInfo success) {
      this.success = success;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case SUCCESS:
        if (value == null) {
          ...
          setSuccess((com.moseeker.thrift.gen.candidate.struct.PositionLayerInfo)value);
        }
        break;
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("getPositionLayerInfo_result(");
      boolean first = true;
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, getPositionLayerInfo_result struct) throws org.apache.thrift.TException {
        ...
        while (true)
        {
          ...
          switch (schemeField.id) {
            case 0: // SUCCESS
              if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
                struct.success = new com.moseeker.thrift.gen.candidate.struct.PositionLayerInfo();
                struct.success.read(iprot);
                struct.setSuccessIsSet(true);
              } else { 
                org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
  ...
  public static class handerElasticLayer_args implements org.apache.thrift.TBase<handerElasticLayer_args, handerElasticLayer_args._Fields>, java.io.Serializable, Cloneable, Comparable<handerElasticLayer_args>   {
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("handerElasticLayer_args(");
      boolean first = true;
  ...
  public static class handerElasticLayer_result implements org.apache.thrift.TBase<handerElasticLayer_result, handerElasticLayer_result._Fields>, java.io.Serializable, Cloneable, Comparable<handerElasticLayer_result>   {
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("handerElasticLayer_result(");
      boolean first = true;
  ...
  public static class getCandidateRecoms_args implements org.apache.thrift.TBase<getCandidateRecoms_args, getCandidateRecoms_args._Fields>, java.io.Serializable, Cloneable, Comparable<getCandidateRecoms_args>   {
    private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("getCandidateRecoms_args");
    ...
    private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new getCandidateRecoms_argsStandardSchemeFactory();
    private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new getCandidateRecoms_argsTupleSchemeFactory();

    public java.util.List<Integer> appIds; // required
    ...
    static {
      ...
      tmpMap.put(_Fields.APP_IDS, new org.apache.thrift.meta_data.FieldMetaData("appIds", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
              new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I32))));
      metaDataMap = java.util.Collections.unmodifiableMap(tmpMap);
      org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(getCandidateRecoms_args.class, metaDataMap);
    }

    public getCandidateRecoms_args() {
    }
     ...
     * Performs a deep copy on <i>other</i>.
     */
    public getCandidateRecoms_args(getCandidateRecoms_args other) {
      if (other.isSetAppIds()) {
        java.util.List<Integer> __this__appIds = new java.util.ArrayList<Integer>(other.appIds);
        this.appIds = __this__appIds;
      }
    }

    public getCandidateRecoms_args deepCopy() {
      return new getCandidateRecoms_args(this);
    }
    ...
    public void addToAppIds(int elem) {
      if (this.appIds == null) {
        this.appIds = new java.util.ArrayList<Integer>();
      }
      this.appIds.add(elem);
    }

    public java.util.List<Integer> getAppIds() {
      return this.appIds;
    }

    public getCandidateRecoms_args setAppIds(java.util.List<Integer> appIds) {
      this.appIds = appIds;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case APP_IDS:
        if (value == null) {
          ...
          setAppIds((java.util.List<Integer>)value);
        }
        break;
    ...
    public boolean equals(Object that) {
      if (that == null)
        return false;
      if (that instanceof getCandidateRecoms_args)
        return this.equals((getCandidateRecoms_args)that);
      return false;
    }

    public boolean equals(getCandidateRecoms_args that) {
      if (that == null)
        return false;
      if (this == that)
        return true;
    ...
    @Override
    public int compareTo(getCandidateRecoms_args other) {
      if (!getClass().equals(other.getClass())) {
        return getClass().getName().compareTo(other.getClass().getName());
      }
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("getCandidateRecoms_args(");
      boolean first = true;
    ...
    private static class getCandidateRecoms_argsStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
      public getCandidateRecoms_argsStandardScheme getScheme() {
        return new getCandidateRecoms_argsStandardScheme();
      }
    }

    private static class getCandidateRecoms_argsStandardScheme extends org.apache.thrift.scheme.StandardScheme<getCandidateRecoms_args> {

      public void read(org.apache.thrift.protocol.TProtocol iprot, getCandidateRecoms_args struct) throws org.apache.thrift.TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.appIds = new java.util.ArrayList<Integer>(_list16.size);
                  int _elem17;
                  for (int _i18 = 0; _i18 < _list16.size; ++_i18)
                  {
                    _elem17 = iprot.readI32();
                    struct.appIds.add(_elem17);
                  }
                  iprot.readListEnd();
                }
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getCandidateRecoms_args struct) throws org.apache.thrift.TException {
        struct.validate();
    ...
    private static class getCandidateRecoms_argsTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
      public getCandidateRecoms_argsTupleScheme getScheme() {
        return new getCandidateRecoms_argsTupleScheme();
      }
    }

    private static class getCandidateRecoms_argsTupleScheme extends org.apache.thrift.scheme.TupleScheme<getCandidateRecoms_args> {

      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, getCandidateRecoms_args struct) throws org.apache.thrift.TException {
        org.apache.thrift.protocol.TTupleProtocol oprot = (org.apache.thrift.protocol.TTupleProtocol) prot;
        java.util.BitSet optionals = new java.util.BitSet();
      ...
      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, getCandidateRecoms_args struct) throws org.apache.thrift.TException {
        org.apache.thrift.protocol.TTupleProtocol iprot = (org.apache.thrift.protocol.TTupleProtocol) prot;
        java.util.BitSet incoming = iprot.readBitSet(1);
        if (incoming.get(0)) {
          {
            org.apache.thrift.protocol.TList _list21 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.I32, iprot.readI32());
            struct.appIds = new java.util.ArrayList<Integer>(_list21.size);
            int _elem22;
            for (int _i23 = 0; _i23 < _list21.size; ++_i23)
            {
              _elem22 = iprot.readI32();
              struct.appIds.add(_elem22);
            }
          }
          struct.setAppIdsIsSet(true);
        }
  ...
  public static class getCandidateRecoms_result implements org.apache.thrift.TBase<getCandidateRecoms_result, getCandidateRecoms_result._Fields>, java.io.Serializable, Cloneable, Comparable<getCandidateRecoms_result>   {
    private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("getCandidateRecoms_result");

    private static final org.apache.thrift.protocol.TField SUCCESS_FIELD_DESC = new org.apache.thrift.protocol.TField("success", org.apache.thrift.protocol.TType.STRUCT, (short)0);
    private static final org.apache.thrift.protocol.TField E_FIELD_DESC = new org.apache.thrift.protocol.TField("e", org.apache.thrift.protocol.TType.STRUCT, (short)1);

    private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new getCandidateRecoms_resultStandardSchemeFactory();
    private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new getCandidateRecoms_resultTupleSchemeFactory();
    ...
    static {
      ...
      tmpMap.put(_Fields.E, new org.apache.thrift.meta_data.FieldMetaData("e", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, com.moseeker.thrift.gen.common.struct.BIZException.class)));
      metaDataMap = java.util.Collections.unmodifiableMap(tmpMap);
      org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(getCandidateRecoms_result.class, metaDataMap);
    }

    public getCandidateRecoms_result() {
    }
     ...
     * Performs a deep copy on <i>other</i>.
     */
    public getCandidateRecoms_result(getCandidateRecoms_result other) {
      if (other.isSetSuccess()) {
        this.success = new com.moseeker.thrift.gen.common.struct.Response(other.success);
      }
      if (other.isSetE()) {
    ...
    public getCandidateRecoms_result deepCopy() {
      return new getCandidateRecoms_result(this);
    }
    ...
    public getCandidateRecoms_result setSuccess(com.moseeker.thrift.gen.common.struct.Response success) {
      this.success = success;
      return this;
    }
    ...
    public getCandidateRecoms_result setE(com.moseeker.thrift.gen.common.struct.BIZException e) {
      this.e = e;
      return this;
    }
    ...
    public boolean equals(Object that) {
      if (that == null)
        return false;
      if (that instanceof getCandidateRecoms_result)
        return this.equals((getCandidateRecoms_result)that);
      return false;
    }

    public boolean equals(getCandidateRecoms_result that) {
      if (that == null)
        return false;
      if (this == that)
        return true;
    ...
    @Override
    public int compareTo(getCandidateRecoms_result other) {
      if (!getClass().equals(other.getClass())) {
        return getClass().getName().compareTo(other.getClass().getName());
      }
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("getCandidateRecoms_result(");
      boolean first = true;
    ...
    private static class getCandidateRecoms_resultStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
      public getCandidateRecoms_resultStandardScheme getScheme() {
        return new getCandidateRecoms_resultStandardScheme();
      }
    }

    private static class getCandidateRecoms_resultStandardScheme extends org.apache.thrift.scheme.StandardScheme<getCandidateRecoms_result> {

      public void read(org.apache.thrift.protocol.TProtocol iprot, getCandidateRecoms_result struct) throws org.apache.thrift.TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getCandidateRecoms_result struct) throws org.apache.thrift.TException {
        struct.validate();
    ...
    private static class getCandidateRecoms_resultTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
      public getCandidateRecoms_resultTupleScheme getScheme() {
        return new getCandidateRecoms_resultTupleScheme();
      }
    }

    private static class getCandidateRecoms_resultTupleScheme extends org.apache.thrift.scheme.TupleScheme<getCandidateRecoms_result> {

      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, getCandidateRecoms_result struct) throws org.apache.thrift.TException {
        org.apache.thrift.protocol.TTupleProtocol oprot = (org.apache.thrift.protocol.TTupleProtocol) prot;
        java.util.BitSet optionals = new java.util.BitSet();
        if (struct.isSetSuccess()) {
          optionals.set(0);
      ...
      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, getCandidateRecoms_result struct) throws org.apache.thrift.TException {
        org.apache.thrift.protocol.TTupleProtocol iprot = (org.apache.thrift.protocol.TTupleProtocol) prot;
        java.util.BitSet incoming = iprot.readBitSet(2);
        if (incoming.get(0)) {
          struct.success = new com.moseeker.thrift.gen.common.struct.Response();
