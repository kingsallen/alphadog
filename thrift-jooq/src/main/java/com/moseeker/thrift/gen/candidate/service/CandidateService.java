...
public class CandidateService {
  ...
  public interface Iface {
    ...
    public void glancePosition(int userId, int positionId, boolean fromEmployee) throws org.apache.thrift.TException;

  }

  public interface AsyncIface {

    public void glancePosition(int userId, int positionId, boolean fromEmployee, org.apache.thrift.async.AsyncMethodCallback<Void> resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public void glancePosition(int userId, int positionId, boolean fromEmployee) throws org.apache.thrift.TException
    {
      send_glancePosition(userId, positionId, fromEmployee);
      recv_glancePosition();
    }

    public void send_glancePosition(int userId, int positionId, boolean fromEmployee) throws org.apache.thrift.TException
    {
      glancePosition_args args = new glancePosition_args();
      args.setUserId(userId);
      args.setPositionId(positionId);
      args.setFromEmployee(fromEmployee);
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public void glancePosition(int userId, int positionId, boolean fromEmployee, org.apache.thrift.async.AsyncMethodCallback<Void> resultHandler) throws org.apache.thrift.TException {
      checkReady();
      glancePosition_call method_call = new glancePosition_call(userId, positionId, fromEmployee, resultHandler, this, ___protocolFactory, ___transport);
    ...
    public static class glancePosition_call extends org.apache.thrift.async.TAsyncMethodCall<Void> {
      ...
      public glancePosition_call(int userId, int positionId, boolean fromEmployee, org.apache.thrift.async.AsyncMethodCallback<Void> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class glancePosition<I extends Iface> extends org.apache.thrift.ProcessFunction<I, glancePosition_args> {
      ...
      public glancePosition_result getResult(I iface, glancePosition_args args) throws org.apache.thrift.TException {
        glancePosition_result result = new glancePosition_result();
        iface.glancePosition(args.userId, args.positionId, args.fromEmployee);
        return result;
      }
    }
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class glancePosition<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, glancePosition_args, Void> {
      ...
      public void start(I iface, glancePosition_args args, org.apache.thrift.async.AsyncMethodCallback<Void> resultHandler) throws org.apache.thrift.TException {
        iface.glancePosition(args.userId, args.positionId, args.fromEmployee,resultHandler);
      }
    }
  ...
  public static class glancePosition_args implements org.apache.thrift.TBase<glancePosition_args, glancePosition_args._Fields>, java.io.Serializable, Cloneable, Comparable<glancePosition_args>   {
    ...
    private static final org.apache.thrift.protocol.TField FROM_EMPLOYEE_FIELD_DESC = new org.apache.thrift.protocol.TField("fromEmployee", org.apache.thrift.protocol.TType.BOOL, (short)3);
    ...
    public boolean fromEmployee; // required

    /** The set of fields this struct contains, along with convenience methods for finding and manipulating them. */
    public enum _Fields implements org.apache.thrift.TFieldIdEnum {
      USER_ID((short)1, "userId"),
      POSITION_ID((short)2, "positionId"),
      FROM_EMPLOYEE((short)3, "fromEmployee");
    ...
    private static final int __FROMEMPLOYEE_ISSET_ID = 2;
    ...
    static {
      ...
      tmpMap.put(_Fields.POSITION_ID, new org.apache.thrift.meta_data.FieldMetaData("positionId", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I32)));
      tmpMap.put(_Fields.FROM_EMPLOYEE, new org.apache.thrift.meta_data.FieldMetaData("fromEmployee", org.apache.thrift.TFieldRequirementType.DEFAULT, 
    ...
    public glancePosition_args(glancePosition_args other) {
      ...
      this.fromEmployee = other.fromEmployee;
    }
    ...
    public glancePosition_args setFromEmployee(boolean fromEmployee) {
      this.fromEmployee = fromEmployee;
      setFromEmployeeIsSet(true);
      return this;
    }

    public void unsetFromEmployee() {
      __isset_bitfield = org.apache.thrift.EncodingUtils.clearBit(__isset_bitfield, __FROMEMPLOYEE_ISSET_ID);
    }

    /** Returns true if field fromEmployee is set (has been assigned a value) and false otherwise */
    public boolean isSetFromEmployee() {
      return org.apache.thrift.EncodingUtils.testBit(__isset_bitfield, __FROMEMPLOYEE_ISSET_ID);
    }

    public void setFromEmployeeIsSet(boolean value) {
      __isset_bitfield = org.apache.thrift.EncodingUtils.setBit(__isset_bitfield, __FROMEMPLOYEE_ISSET_ID, value);
    }
    ...
    public void setFieldValue(_Fields field, java.lang.Object value) {
      ...
      case FROM_EMPLOYEE:
        if (value == null) {
          ...
          setFromEmployee((java.lang.Boolean)value);
        }
        break;
    ...
    public boolean equals(glancePosition_args that) {
      ...
      boolean this_present_fromEmployee = true;
      boolean that_present_fromEmployee = true;
      if (this_present_fromEmployee || that_present_fromEmployee) {
        if (!(this_present_fromEmployee && that_present_fromEmployee))
          return false;
        if (this.fromEmployee != that.fromEmployee)
          return false;
      }
    ...
    public int hashCode() {
      ...
      hashCode = hashCode * 8191 + ((fromEmployee) ? 131071 : 524287);
    ...
    public int compareTo(glancePosition_args other) {
      ...
      lastComparison = java.lang.Boolean.valueOf(isSetFromEmployee()).compareTo(other.isSetFromEmployee());
      if (lastComparison != 0) {
        return lastComparison;
      }
      if (isSetFromEmployee()) {
        lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.fromEmployee, other.fromEmployee);
        if (lastComparison != 0) {
          return lastComparison;
        }
      }
    ...
    public java.lang.String toString() {
      ...
      first = false;
      if (!first) sb.append(", ");
      sb.append("fromEmployee:");
      sb.append(this.fromEmployee);
      first = false;
      sb.append(")");
      return sb.toString();
    }
    ...
    private static class glancePosition_argsStandardScheme extends org.apache.thrift.scheme.StandardScheme<glancePosition_args> {
          ...
          switch (schemeField.id) {
            ...
            case 3: // FROM_EMPLOYEE
              if (schemeField.type == org.apache.thrift.protocol.TType.BOOL) {
                struct.fromEmployee = iprot.readBool();
                struct.setFromEmployeeIsSet(true);
              } else { 
                org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
              }
              break;
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, glancePosition_args struct) throws org.apache.thrift.TException {
        ...
        oprot.writeFieldEnd();
        oprot.writeFieldBegin(FROM_EMPLOYEE_FIELD_DESC);
        oprot.writeBool(struct.fromEmployee);
        oprot.writeFieldEnd();
