...
public class EmployeeAward implements org.apache.thrift.TBase<EmployeeAward, EmployeeAward._Fields>, java.io.Serializable, Cloneable, Comparable<EmployeeAward> {
  ...
  private static final _Fields optionals[] = {_Fields.EMPLOYEE_ID,_Fields.NAME,_Fields.RANKING,_Fields.AWARD_TOTAL,_Fields.HEADIMGURL};
  ...
  public EmployeeAward setName(String name) {
    this.name = name;
    return this;
  }
  ...
  public EmployeeAward setHeadimgurl(String headimgurl) {
  ...
  public int compareTo(EmployeeAward other) {
    ...
    lastComparison = Boolean.valueOf(isSetAwardTotal()).compareTo(other.isSetAwardTotal());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetAwardTotal()) {
