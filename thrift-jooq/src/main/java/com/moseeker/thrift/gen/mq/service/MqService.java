...
public class MqService {
  ...
  public interface Iface {
    ...
    public com.moseeker.thrift.gen.common.struct.Response sendAuthEMail(java.util.Map<String, String> params, int eventType, String email, String subject, String senderName, String senderDisplay) throws org.apache.thrift.TException;
    ...
    public com.moseeker.thrift.gen.common.struct.Response sendSMS(com.moseeker.thrift.gen.mq.struct.SmsType smsType, String mobile, java.util.Map<String, String> data, String sys, String ip) throws org.apache.thrift.TException;

    public com.moseeker.thrift.gen.common.struct.Response sendMessageAndEmail(int application_id) throws org.apache.thrift.TException, ConnectException;
  ...
  public interface AsyncIface {
    ...
    public void sendAuthEMail(java.util.Map<String, String> params, int eventType, String email, String subject, String senderName, String senderDisplay, org.apache.thrift.async.AsyncMethodCallback<com.moseeker.thrift.gen.common.struct.Response> resultHandler) throws org.apache.thrift.TException;
    ...
    public void sendSMS(com.moseeker.thrift.gen.mq.struct.SmsType smsType, String mobile, java.util.Map<String, String> data, String sys, String ip, org.apache.thrift.async.AsyncMethodCallback<com.moseeker.thrift.gen.common.struct.Response> resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public void send_sendAuthEMail(java.util.Map<String,String> params, int eventType, String email, String subject, String senderName, String senderDisplay) throws org.apache.thrift.TException
    {
    ...
    public void send_sendSMS(com.moseeker.thrift.gen.mq.struct.SmsType smsType, String mobile, java.util.Map<String,String> data, String sys, String ip) throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public static class sendAuthEMail_call extends org.apache.thrift.async.TAsyncMethodCall<com.moseeker.thrift.gen.common.struct.Response> {
      ...
      public sendAuthEMail_call(java.util.Map<String,String> params, int eventType, String email, String subject, String senderName, String senderDisplay, org.apache.thrift.async.AsyncMethodCallback<com.moseeker.thrift.gen.common.struct.Response> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.params = params;
    ...
    public static class sendSMS_call extends org.apache.thrift.async.TAsyncMethodCall<com.moseeker.thrift.gen.common.struct.Response> {
      ...
      private String sys;
      private String ip;
      public sendSMS_call(com.moseeker.thrift.gen.mq.struct.SmsType smsType, String mobile, java.util.Map<String,String> data, String sys, String ip, org.apache.thrift.async.AsyncMethodCallback<com.moseeker.thrift.gen.common.struct.Response> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
  ...
  public static class sendAuthEMail_args implements org.apache.thrift.TBase<sendAuthEMail_args, sendAuthEMail_args._Fields>, java.io.Serializable, Cloneable, Comparable<sendAuthEMail_args>   {
    ...
    public String senderName; // required
    public String senderDisplay; // required
    ...
    public sendAuthEMail_args setParams(java.util.Map<String,String> params) {
      this.params = params;
      return this;
    }
    ...
    public sendAuthEMail_args setEmail(String email) {
      this.email = email;
      return this;
    }
    ...
    public sendAuthEMail_args setSubject(String subject) {
      this.subject = subject;
      return this;
    }
    ...
    public sendAuthEMail_args setSenderName(String senderName) {
      this.senderName = senderName;
      return this;
    }
    ...
    public sendAuthEMail_args setSenderDisplay(String senderDisplay) {
      this.senderDisplay = senderDisplay;
      return this;
    }
    ...
    public int compareTo(sendAuthEMail_args other) {
      ...
      lastComparison = Boolean.valueOf(isSetSenderDisplay()).compareTo(other.isSetSenderDisplay());
      if (lastComparison != 0) {
        return lastComparison;
      }
      if (isSetSenderDisplay()) {
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("sendAuthEMail_args(");
      boolean first = true;
  ...
  public static class sendAuthEMail_result implements org.apache.thrift.TBase<sendAuthEMail_result, sendAuthEMail_result._Fields>, java.io.Serializable, Cloneable, Comparable<sendAuthEMail_result>   {
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("sendAuthEMail_result(");
      boolean first = true;
  ...
  public static class sendSMS_args implements org.apache.thrift.TBase<sendSMS_args, sendSMS_args._Fields>, java.io.Serializable, Cloneable, Comparable<sendSMS_args>   {
    ...
    public java.util.Map<String,String> data; // required
    public String sys; // required
    ...
    public sendSMS_args setData(java.util.Map<String,String> data) {
      this.data = data;
      return this;
    }
    ...
    public sendSMS_args setSys(String sys) {
      this.sys = sys;
      return this;
    }
    ...
    public sendSMS_args setIp(String ip) {
      this.ip = ip;
      return this;
    }
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
                {
                  ...
                  struct.data = new java.util.HashMap<String,String>(2*_map10.size);
                  String _key11;
                  String _val12;
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, sendSMS_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.data != null) {
          oprot.writeFieldBegin(DATA_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<String, String> _iter14 : struct.data.entrySet())
            {
        ...
        if (struct.isSetData()) {
          {
            ...
            for (java.util.Map.Entry<String, String> _iter15 : struct.data.entrySet())
            {
        ...
        if (incoming.get(2)) {
          {
            ...
            struct.data = new java.util.HashMap<String,String>(2*_map16.size);
            String _key17;
            String _val18;
  ...
  public static class sendMessageAndEmail_args implements org.apache.thrift.TBase<sendMessageAndEmail_args, sendMessageAndEmail_args._Fields>, java.io.Serializable, Cloneable, Comparable<sendMessageAndEmail_args>   {
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("sendMessageAndEmail_args(");
      boolean first = true;
  ...
  public static class sendMessageAndEmail_result implements org.apache.thrift.TBase<sendMessageAndEmail_result, sendMessageAndEmail_result._Fields>, java.io.Serializable, Cloneable, Comparable<sendMessageAndEmail_result>   {
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("sendMessageAndEmail_result(");
      boolean first = true;
