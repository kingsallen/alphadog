...
public class HrOperationRecordDO implements org.apache.thrift.TBase<HrOperationRecordDO, HrOperationRecordDO._Fields>, java.io.Serializable, Cloneable, Comparable<HrOperationRecordDO> {
  ...
  public String optTime; // optional
  ...
  public HrOperationRecordDO setOptTime(String optTime) {
  ...
  public int compareTo(HrOperationRecordDO other) {
    ...
    lastComparison = Boolean.valueOf(isSetOptTime()).compareTo(other.isSetOptTime());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetOptTime()) {
    ...
    lastComparison = Boolean.valueOf(isSetOperateTplId()).compareTo(other.isSetOperateTplId());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetOperateTplId()) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("HrOperationRecordDO(");
    boolean first = true;
