...
@javax.annotation.Generated(value = "Autogenerated by Thrift Compiler (0.10.0)", date = "2018-12-24")
public class BindingParams implements org.apache.thrift.TBase<BindingParams, BindingParams._Fields>, java.io.Serializable, Cloneable, Comparable<BindingParams> {
    ...
    private static final _Fields optionals[] = {_Fields.EMAIL,_Fields.MOBILE,_Fields.CUSTOM_FIELD,_Fields.NAME,_Fields.ANSWER1,_Fields.ANSWER2,_Fields.SOURCE};
