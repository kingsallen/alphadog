...
public class ThirdPartAccountData implements org.apache.thrift.TBase<ThirdPartAccountData, ThirdPartAccountData._Fields>, java.io.Serializable, Cloneable, Comparable<ThirdPartAccountData> {
  ...
  static {
    schemes.put(StandardScheme.class, new ThirdPartAccountDataStandardSchemeFactory());
    schemes.put(TupleScheme.class, new ThirdPartAccountDataTupleSchemeFactory());
  }
  ...
  private static class ThirdPartAccountDataStandardSchemeFactory implements SchemeFactory {
    public ThirdPartAccountDataStandardScheme getScheme() {
      return new ThirdPartAccountDataStandardScheme();
    }
  }

  private static class ThirdPartAccountDataStandardScheme extends StandardScheme<ThirdPartAccountData> {
  ...
  private static class ThirdPartAccountDataTupleSchemeFactory implements SchemeFactory {
    public ThirdPartAccountDataTupleScheme getScheme() {
      return new ThirdPartAccountDataTupleScheme();
    }
  }

  private static class ThirdPartAccountDataTupleScheme extends TupleScheme<ThirdPartAccountData> {
