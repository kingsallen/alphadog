...
@javax.annotation.Generated(value = "Autogenerated by Thrift Compiler (0.10.0)", date = "2018-05-28")
public class HrThirdPartyAccountDO implements org.apache.thrift.TBase<HrThirdPartyAccountDO, HrThirdPartyAccountDO._Fields>, java.io.Serializable, Cloneable, Comparable<HrThirdPartyAccountDO> {
  ...
  private static final org.apache.thrift.protocol.TField EXT2_FIELD_DESC = new org.apache.thrift.protocol.TField("ext2", org.apache.thrift.protocol.TType.STRING, (short)17);
  ...
  static {
    ...
    tmpMap.put(_Fields.SYNC_REQUIRE_DEPARTMENT, new org.apache.thrift.meta_data.FieldMetaData("syncRequireDepartment", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.BYTE)));
    tmpMap.put(_Fields.EXT2, new org.apache.thrift.meta_data.FieldMetaData("ext2", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
  ...
  public HrThirdPartyAccountDO setExt2(String ext2) {
    this.ext2 = ext2;
    return this;
  }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetExt2()) ? 131071 : 524287);
    if (isSetExt2())
      hashCode = hashCode * 8191 + ext2.hashCode();
  ...
  public int compareTo(HrThirdPartyAccountDO other) {
    ...
    lastComparison = Boolean.valueOf(isSetExt2()).compareTo(other.isSetExt2());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetExt2()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.ext2, other.ext2);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, HrThirdPartyAccountDO struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 17: // EXT2
            if (schemeField.type == org.apache.thrift.protocol.TType.STRING) {
              struct.ext2 = iprot.readString();
              struct.setExt2IsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
