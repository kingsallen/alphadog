...
public class HrThirdPartyAccountDO implements org.apache.thrift.TBase<HrThirdPartyAccountDO, HrThirdPartyAccountDO._Fields>, java.io.Serializable, Cloneable, Comparable<HrThirdPartyAccountDO> {
  ...
  private static final _Fields optionals[] = {_Fields.ID,_Fields.CHANNEL,_Fields.USERNAME,_Fields.PASSWORD,_Fields.MEMBERNAME,_Fields.BINDING,_Fields.COMPANY_ID,_Fields.REMAIN_NUM,_Fields.SYNC_TIME,_Fields.UPDATE_TIME,_Fields.CREATE_TIME,_Fields.REMAIN_PROFILE_NUM,_Fields.ERROR_MESSAGE};
  ...
  public HrThirdPartyAccountDO setErrorMessage(java.lang.String errorMessage) {
    ...
    switch (field) {
      ...
      case CHANNEL:
        if (value == null) {
          ...
          setChannel((java.lang.Short)value);
        }
        break;
      ...
      case BINDING:
        if (value == null) {
          ...
          setBinding((java.lang.Short)value);
        }
        break;
