            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.intentions = new ArrayList<Intention>(_list56.size);
                Intention _elem57;
                for (int _i58 = 0; _i58 < _list56.size; ++_i58)
                {
                  _elem57 = new Intention();
                  _elem57.read(iprot);
                  struct.intentions.add(_elem57);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, IntentionPagination struct) throws org.apache.thrift.TException {
      ...
      if (struct.intentions != null) {
        oprot.writeFieldBegin(INTENTIONS_FIELD_DESC);
        {
          ...
          for (Intention _iter59 : struct.intentions)
          {
            _iter59.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.isSetIntentions()) {
        {
          ...
          for (Intention _iter60 : struct.intentions)
          {
            _iter60.write(oprot);
          }
        }
      ...
      if (incoming.get(4)) {
        {
          ...
          struct.intentions = new ArrayList<Intention>(_list61.size);
          Intention _elem62;
          for (int _i63 = 0; _i63 < _list61.size; ++_i63)
          {
            _elem62 = new Intention();
            _elem62.read(iprot);
            struct.intentions.add(_elem62);
          }
        }
        struct.setIntentionsIsSet(true);
      }
