...
public class RewardVO implements org.apache.thrift.TBase<RewardVO, RewardVO._Fields>, java.io.Serializable, Cloneable, Comparable<RewardVO> {
  ...
  public java.lang.String publisherName; // optional
  public int employeeId; // optional
  public java.lang.String employeeName; // optional
  public int recommendId; // optional
  public java.lang.String recommendName; // optional
  public int berecomId; // optional
  public java.lang.String berecomName; // optional
  ...
  public RewardVO setReason(java.lang.String reason) {
    this.reason = reason;
    return this;
  }
  ...
  public RewardVO setUpdateTime(java.lang.String updateTime) {
  ...
  public RewardVO setPositionName(java.lang.String positionName) {
  ...
  public RewardVO setPublisherName(java.lang.String publisherName) {
  ...
  public RewardVO setEmployeeId(int employeeId) {
  ...
  public RewardVO setEmployeeName(java.lang.String employeeName) {
  ...
  public RewardVO setRecommendName(java.lang.String recommendName) {
  ...
  public java.lang.String getBerecomName() {
    return this.berecomName;
  }

  public RewardVO setBerecomName(java.lang.String berecomName) {
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case PUBLISHER_ID:
      if (value == null) {
        ...
        setPublisherId((java.lang.Integer)value);
      }
      break;
    ...
    case PUBLISHER_NAME:
      if (value == null) {
        ...
        setPublisherName((java.lang.String)value);
      }
      break;
    ...
    case RECOMMEND_ID:
      if (value == null) {
        ...
        setRecommendId((java.lang.Integer)value);
      }
      break;
    ...
    case RECOMMEND_NAME:
      if (value == null) {
        ...
        setRecommendName((java.lang.String)value);
      }
      break;
    ...
    case BERECOM_ID:
      if (value == null) {
        ...
        setBerecomId((java.lang.Integer)value);
      }
      break;
    ...
    case BERECOM_NAME:
      if (value == null) {
        ...
        setBerecomName((java.lang.String)value);
      }
      break;
  ...
  public int compareTo(RewardVO other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetPublisherName()).compareTo(other.isSetPublisherName());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetPublisherName()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetRecommendId()).compareTo(other.isSetRecommendId());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetRecommendId()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetRecommendName()).compareTo(other.isSetRecommendName());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetRecommendName()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetBerecomId()).compareTo(other.isSetBerecomId());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetBerecomId()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetBerecomName()).compareTo(other.isSetBerecomName());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetBerecomName()) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("RewardVO(");
    boolean first = true;
