...
public class MallSwitchForm implements org.apache.thrift.TBase<MallSwitchForm, MallSwitchForm._Fields>, java.io.Serializable, Cloneable, Comparable<MallSwitchForm> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("MallSwitchForm");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new MallSwitchFormStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new MallSwitchFormTupleSchemeFactory();
  ...
  private static final _Fields optionals[] = {_Fields.COMPANY_ID,_Fields.HR_ID,_Fields.STATE};
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(MallSwitchForm.class, metaDataMap);
  }

  public MallSwitchForm() {
  }

  /**
   * Performs a deep copy on <i>other</i>.
   */
  public MallSwitchForm(MallSwitchForm other) {
  ...
  public MallSwitchForm deepCopy() {
    return new MallSwitchForm(this);
  }
  ...
  public MallSwitchForm setCompany_id(int company_id) {
  ...
  public MallSwitchForm setHr_id(int hr_id) {
    this.hr_id = hr_id;
    setHr_idIsSet(true);
    return this;
  }
  ...
  public MallSwitchForm setState(byte state) {
    this.state = state;
    setStateIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof MallSwitchForm)
      return this.equals((MallSwitchForm)that);
    return false;
  }

  public boolean equals(MallSwitchForm that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(MallSwitchForm other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("MallSwitchForm(");
    boolean first = true;
  ...
  private static class MallSwitchFormStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public MallSwitchFormStandardScheme getScheme() {
      return new MallSwitchFormStandardScheme();
    }
  }

  private static class MallSwitchFormStandardScheme extends org.apache.thrift.scheme.StandardScheme<MallSwitchForm> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, MallSwitchForm struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, MallSwitchForm struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class MallSwitchFormTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public MallSwitchFormTupleScheme getScheme() {
      return new MallSwitchFormTupleScheme();
    }
  }

  private static class MallSwitchFormTupleScheme extends org.apache.thrift.scheme.TupleScheme<MallSwitchForm> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, MallSwitchForm struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, MallSwitchForm struct) throws org.apache.thrift.TException {
