...
public class MallGoodsOrderUpdateForm implements org.apache.thrift.TBase<MallGoodsOrderUpdateForm, MallGoodsOrderUpdateForm._Fields>, java.io.Serializable, Cloneable, Comparable<MallGoodsOrderUpdateForm> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("MallGoodsOrderUpdateForm");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new MallGoodsOrderUpdateFormStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new MallGoodsOrderUpdateFormTupleSchemeFactory();
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(MallGoodsOrderUpdateForm.class, metaDataMap);
  }

  public MallGoodsOrderUpdateForm() {
  }

  /**
   * Performs a deep copy on <i>other</i>.
   */
  public MallGoodsOrderUpdateForm(MallGoodsOrderUpdateForm other) {
  ...
  public MallGoodsOrderUpdateForm deepCopy() {
    return new MallGoodsOrderUpdateForm(this);
  }
  ...
  public MallGoodsOrderUpdateForm setCompany_id(int company_id) {
  ...
  public MallGoodsOrderUpdateForm setHr_id(int hr_id) {
    this.hr_id = hr_id;
    setHr_idIsSet(true);
    return this;
  }
  ...
  public MallGoodsOrderUpdateForm setIds(java.util.List<Integer> ids) {
    this.ids = ids;
    return this;
  }
  ...
  public MallGoodsOrderUpdateForm setState(int state) {
    this.state = state;
    setStateIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof MallGoodsOrderUpdateForm)
      return this.equals((MallGoodsOrderUpdateForm)that);
    return false;
  }

  public boolean equals(MallGoodsOrderUpdateForm that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(MallGoodsOrderUpdateForm other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("MallGoodsOrderUpdateForm(");
    boolean first = true;
  ...
  private static class MallGoodsOrderUpdateFormStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public MallGoodsOrderUpdateFormStandardScheme getScheme() {
      return new MallGoodsOrderUpdateFormStandardScheme();
    }
  }

  private static class MallGoodsOrderUpdateFormStandardScheme extends org.apache.thrift.scheme.StandardScheme<MallGoodsOrderUpdateForm> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, MallGoodsOrderUpdateForm struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.ids = new java.util.ArrayList<Integer>(_list8.size);
                int _elem9;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, MallGoodsOrderUpdateForm struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class MallGoodsOrderUpdateFormTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public MallGoodsOrderUpdateFormTupleScheme getScheme() {
      return new MallGoodsOrderUpdateFormTupleScheme();
    }
  }

  private static class MallGoodsOrderUpdateFormTupleScheme extends org.apache.thrift.scheme.TupleScheme<MallGoodsOrderUpdateForm> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, MallGoodsOrderUpdateForm struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, MallGoodsOrderUpdateForm struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.ids = new java.util.ArrayList<Integer>(_list13.size);
          int _elem14;
