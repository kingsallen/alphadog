...
public class HrChildCompanyDO implements org.apache.thrift.TBase<HrChildCompanyDO, HrChildCompanyDO._Fields>, java.io.Serializable, Cloneable, Comparable<HrChildCompanyDO> {
  ...
  public String business; // optional
  public String establishTime; // optional
  ...
  public HrChildCompanyDO setName(String name) {
    this.name = name;
    return this;
  }
  ...
  public HrChildCompanyDO setEname(String ename) {
    this.ename = ename;
    return this;
  }
  ...
  public HrChildCompanyDO setCeo(String ceo) {
    this.ceo = ceo;
    return this;
  }
  ...
  public HrChildCompanyDO setIntroduction(String introduction) {
  ...
  public HrChildCompanyDO setScale(String scale) {
    this.scale = scale;
    return this;
  }
  ...
  public HrChildCompanyDO setProvince(String province) {
  ...
  public HrChildCompanyDO setCity(String city) {
    this.city = city;
    return this;
  }
  ...
  public HrChildCompanyDO setAddress(String address) {
  ...
  public HrChildCompanyDO setBusiness(String business) {
  ...
  public HrChildCompanyDO setEstablishTime(String establishTime) {
  ...
  public HrChildCompanyDO setHomepage(String homepage) {
  ...
  public int compareTo(HrChildCompanyDO other) {
    ...
    lastComparison = Boolean.valueOf(isSetCeo()).compareTo(other.isSetCeo());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetCeo()) {
    ...
    lastComparison = Boolean.valueOf(isSetEstablishTime()).compareTo(other.isSetEstablishTime());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetEstablishTime()) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("HrChildCompanyDO(");
    boolean first = true;
