            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.rewards = new ArrayList<Reward>(_list88.size);
                Reward _elem89;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, RewardPagination struct) throws org.apache.thrift.TException {
      ...
      if (struct.rewards != null) {
        oprot.writeFieldBegin(REWARDS_FIELD_DESC);
        {
          ...
          for (Reward _iter91 : struct.rewards)
          {
            _iter91.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.isSetRewards()) {
        {
          ...
          for (Reward _iter92 : struct.rewards)
          {
            _iter92.write(oprot);
          }
        }
      ...
      if (incoming.get(4)) {
        {
          ...
          struct.rewards = new ArrayList<Reward>(_list93.size);
          Reward _elem94;
