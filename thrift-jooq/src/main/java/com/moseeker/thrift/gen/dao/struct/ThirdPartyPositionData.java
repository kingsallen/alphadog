...
public class ThirdPartyPositionData implements org.apache.thrift.TBase<ThirdPartyPositionData, ThirdPartyPositionData._Fields>, java.io.Serializable, Cloneable, Comparable<ThirdPartyPositionData> {
  ...
  static {
    schemes.put(StandardScheme.class, new ThirdPartyPositionDataStandardSchemeFactory());
    schemes.put(TupleScheme.class, new ThirdPartyPositionDataTupleSchemeFactory());
  }
  ...
  public Object getFieldValue(_Fields field) {
    ...
    case IS_SYNCHRONIZATION:
      return Byte.valueOf(getIs_synchronization());

    case IS_REFRESH:
      return Byte.valueOf(getIs_refresh());
  ...
  public int hashCode() {
    ...
    boolean present_refresh_time = true && (isSetRefresh_time());
    list.add(present_refresh_time);
    if (present_refresh_time)
      list.add(refresh_time);
    ...
    boolean present_sync_fail_reason = true && (isSetSync_fail_reason());
    list.add(present_sync_fail_reason);
    if (present_sync_fail_reason)
      list.add(sync_fail_reason);
  ...
  private static class ThirdPartyPositionDataStandardSchemeFactory implements SchemeFactory {
    public ThirdPartyPositionDataStandardScheme getScheme() {
      return new ThirdPartyPositionDataStandardScheme();
    }
  }

  private static class ThirdPartyPositionDataStandardScheme extends StandardScheme<ThirdPartyPositionData> {
  ...
  private static class ThirdPartyPositionDataTupleSchemeFactory implements SchemeFactory {
    public ThirdPartyPositionDataTupleScheme getScheme() {
      return new ThirdPartyPositionDataTupleScheme();
    }
  }

  private static class ThirdPartyPositionDataTupleScheme extends TupleScheme<ThirdPartyPositionData> {
