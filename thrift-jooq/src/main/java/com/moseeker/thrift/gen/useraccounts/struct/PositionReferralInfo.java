...
public class PositionReferralInfo implements org.apache.thrift.TBase<PositionReferralInfo, PositionReferralInfo._Fields>, java.io.Serializable, Cloneable, Comparable<PositionReferralInfo> {
  ...
  private static final _Fields optionals[] = {_Fields.USER_ID,_Fields.EMPLOYEE_NAME,_Fields.EMPLOYEE_ID,_Fields.POSITION_NAME,_Fields.POSITION_ID};
  ...
  public PositionReferralInfo setEmployeeName(String employeeName) {
  ...
  public PositionReferralInfo setPositionName(String positionName) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("PositionReferralInfo(");
    boolean first = true;
