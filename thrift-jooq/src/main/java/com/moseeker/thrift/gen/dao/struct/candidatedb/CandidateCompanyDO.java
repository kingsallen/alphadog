...
public class CandidateCompanyDO implements org.apache.thrift.TBase<CandidateCompanyDO, CandidateCompanyDO._Fields>, java.io.Serializable, Cloneable, Comparable<CandidateCompanyDO> {
  ...
  private static final _Fields optionals[] = {_Fields.ID,_Fields.COMPANY_ID,_Fields.UPDATE_TIME,_Fields.WXUSER_ID,_Fields.STATUS,_Fields.IS_RECOMMEND,_Fields.NAME,_Fields.EMAIL,_Fields.MOBILE,_Fields.NICKNAME,_Fields.HEADIMGURL,_Fields.SYS_USER_ID,_Fields.CLICK_FROM,_Fields.USER_ID};
  ...
  public CandidateCompanyDO setUserId(int userId) {
    this.userId = userId;
    setUserIdIsSet(true);
    return this;
  }
