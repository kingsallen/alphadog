...
public class CandidateCompanyDO implements org.apache.thrift.TBase<CandidateCompanyDO, CandidateCompanyDO._Fields>, java.io.Serializable, Cloneable, Comparable<CandidateCompanyDO> {
  ...
  private static final _Fields optionals[] = {_Fields.ID,_Fields.COMPANY_ID,_Fields.UPDATE_TIME,_Fields.WXUSER_ID,_Fields.STATUS,_Fields.IS_RECOMMEND,_Fields.NAME,_Fields.EMAIL,_Fields.MOBILE,_Fields.NICKNAME,_Fields.HEADIMGURL,_Fields.SYS_USER_ID,_Fields.CLICK_FROM};
  ...
  public CandidateCompanyDO setUpdateTime(String updateTime) {
  ...
  public CandidateCompanyDO setName(String name) {
    this.name = name;
    return this;
  }
  ...
  public CandidateCompanyDO setEmail(String email) {
    this.email = email;
    return this;
  }
  ...
  public CandidateCompanyDO setMobile(String mobile) {
    this.mobile = mobile;
    return this;
  }
  ...
  public CandidateCompanyDO setNickname(String nickname) {
  ...
  public CandidateCompanyDO setHeadimgurl(String headimgurl) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("CandidateCompanyDO(");
    boolean first = true;
