...
public class ReferralService {
  ...
  public interface Iface {
    ...
    public com.moseeker.thrift.gen.referral.struct.RedPackets getRedPackets(int userId, int pageNum, int pageSize) throws com.moseeker.thrift.gen.common.struct.BIZException, org.apache.thrift.TException;

    public com.moseeker.thrift.gen.referral.struct.BonusList getBonus(int userId, int pageNum, int pageSize) throws com.moseeker.thrift.gen.common.struct.BIZException, org.apache.thrift.TException;

  }

  public interface AsyncIface {

    public void getRedPackets(int userId, int pageNum, int pageSize, org.apache.thrift.async.AsyncMethodCallback<com.moseeker.thrift.gen.referral.struct.RedPackets> resultHandler) throws org.apache.thrift.TException;

    public void getBonus(int userId, int pageNum, int pageSize, org.apache.thrift.async.AsyncMethodCallback<com.moseeker.thrift.gen.referral.struct.BonusList> resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public com.moseeker.thrift.gen.referral.struct.RedPackets getRedPackets(int userId, int pageNum, int pageSize) throws com.moseeker.thrift.gen.common.struct.BIZException, org.apache.thrift.TException
    {
      send_getRedPackets(userId, pageNum, pageSize);
      return recv_getRedPackets();
    }

    public void send_getRedPackets(int userId, int pageNum, int pageSize) throws org.apache.thrift.TException
    {
    ...
    public com.moseeker.thrift.gen.referral.struct.BonusList getBonus(int userId, int pageNum, int pageSize) throws com.moseeker.thrift.gen.common.struct.BIZException, org.apache.thrift.TException
    {
      send_getBonus(userId, pageNum, pageSize);
      return recv_getBonus();
    }

    public void send_getBonus(int userId, int pageNum, int pageSize) throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public void getRedPackets(int userId, int pageNum, int pageSize, org.apache.thrift.async.AsyncMethodCallback<com.moseeker.thrift.gen.referral.struct.RedPackets> resultHandler) throws org.apache.thrift.TException {
      checkReady();
      getRedPackets_call method_call = new getRedPackets_call(userId, pageNum, pageSize, resultHandler, this, ___protocolFactory, ___transport);
    ...
    public static class getRedPackets_call extends org.apache.thrift.async.TAsyncMethodCall<com.moseeker.thrift.gen.referral.struct.RedPackets> {
      ...
      public getRedPackets_call(int userId, int pageNum, int pageSize, org.apache.thrift.async.AsyncMethodCallback<com.moseeker.thrift.gen.referral.struct.RedPackets> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
    ...
    public void getBonus(int userId, int pageNum, int pageSize, org.apache.thrift.async.AsyncMethodCallback<com.moseeker.thrift.gen.referral.struct.BonusList> resultHandler) throws org.apache.thrift.TException {
      checkReady();
      getBonus_call method_call = new getBonus_call(userId, pageNum, pageSize, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }
    ...
    public static class getBonus_call extends org.apache.thrift.async.TAsyncMethodCall<com.moseeker.thrift.gen.referral.struct.BonusList> {
      ...
      private int pageNum;
      private int pageSize;
      public getBonus_call(int userId, int pageNum, int pageSize, org.apache.thrift.async.AsyncMethodCallback<com.moseeker.thrift.gen.referral.struct.BonusList> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.userId = userId;
        this.pageNum = pageNum;
        this.pageSize = pageSize;
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class getRedPackets<I extends Iface> extends org.apache.thrift.ProcessFunction<I, getRedPackets_args> {
      ...
      public getRedPackets_result getResult(I iface, getRedPackets_args args) throws org.apache.thrift.TException {
        getRedPackets_result result = new getRedPackets_result();
        try {
          result.success = iface.getRedPackets(args.userId, args.pageNum, args.pageSize);
    ...
    public static class getBonus<I extends Iface> extends org.apache.thrift.ProcessFunction<I, getBonus_args> {
      ...
      public getBonus_result getResult(I iface, getBonus_args args) throws org.apache.thrift.TException {
        getBonus_result result = new getBonus_result();
        try {
          result.success = iface.getBonus(args.userId, args.pageNum, args.pageSize);
        } catch (com.moseeker.thrift.gen.common.struct.BIZException e) {
          result.e = e;
        }
        return result;
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class getRedPackets<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, getRedPackets_args, com.moseeker.thrift.gen.referral.struct.RedPackets> {
      ...
      public void start(I iface, getRedPackets_args args, org.apache.thrift.async.AsyncMethodCallback<com.moseeker.thrift.gen.referral.struct.RedPackets> resultHandler) throws org.apache.thrift.TException {
        iface.getRedPackets(args.userId, args.pageNum, args.pageSize,resultHandler);
      }
    }
    ...
    public static class getBonus<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, getBonus_args, com.moseeker.thrift.gen.referral.struct.BonusList> {
      ...
      public void start(I iface, getBonus_args args, org.apache.thrift.async.AsyncMethodCallback<com.moseeker.thrift.gen.referral.struct.BonusList> resultHandler) throws org.apache.thrift.TException {
        iface.getBonus(args.userId, args.pageNum, args.pageSize,resultHandler);
      }
    }
