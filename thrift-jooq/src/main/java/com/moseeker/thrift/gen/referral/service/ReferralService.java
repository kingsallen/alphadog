...
public class ReferralService {
  ...
  public interface Iface {
    ...
    public void employeeReferralReason(int userId, int positionId, int referralId, java.util.List<String> referralReasons, byte relationship, String recomReasonText, int postUserId) throws com.moseeker.thrift.gen.common.struct.BIZException, org.apache.thrift.TException;
  ...
  public interface AsyncIface {
    ...
    public void employeeReferralReason(int userId, int positionId, int referralId, java.util.List<String> referralReasons, byte relationship, String recomReasonText, int postUserId, org.apache.thrift.async.AsyncMethodCallback<Void> resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public void employeeReferralReason(int userId, int positionId, int referralId, java.util.List<String> referralReasons, byte relationship, String recomReasonText, int postUserId) throws com.moseeker.thrift.gen.common.struct.BIZException, org.apache.thrift.TException
    {
      send_employeeReferralReason(userId, positionId, referralId, referralReasons, relationship, recomReasonText, postUserId);
      recv_employeeReferralReason();
    }

    public void send_employeeReferralReason(int userId, int positionId, int referralId, java.util.List<String> referralReasons, byte relationship, String recomReasonText, int postUserId) throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public void employeeReferralReason(int userId, int positionId, int referralId, java.util.List<String> referralReasons, byte relationship, String recomReasonText, int postUserId, org.apache.thrift.async.AsyncMethodCallback<Void> resultHandler) throws org.apache.thrift.TException {
      checkReady();
      employeeReferralReason_call method_call = new employeeReferralReason_call(userId, positionId, referralId, referralReasons, relationship, recomReasonText, postUserId, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }
    ...
    public static class employeeReferralReason_call extends org.apache.thrift.async.TAsyncMethodCall<Void> {
      ...
      private int postUserId;
      public employeeReferralReason_call(int userId, int positionId, int referralId, java.util.List<String> referralReasons, byte relationship, String recomReasonText, int postUserId, org.apache.thrift.async.AsyncMethodCallback<Void> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.userId = userId;
        this.positionId = positionId;
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class employeeReferralReason<I extends Iface> extends org.apache.thrift.ProcessFunction<I, employeeReferralReason_args> {
      ...
      public employeeReferralReason_result getResult(I iface, employeeReferralReason_args args) throws org.apache.thrift.TException {
        employeeReferralReason_result result = new employeeReferralReason_result();
        try {
          iface.employeeReferralReason(args.userId, args.positionId, args.referralId, args.referralReasons, args.relationship, args.recomReasonText, args.postUserId);
        } catch (com.moseeker.thrift.gen.common.struct.BIZException e) {
          result.e = e;
        }
        return result;
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class employeeReferralReason<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, employeeReferralReason_args, Void> {
      ...
      public void start(I iface, employeeReferralReason_args args, org.apache.thrift.async.AsyncMethodCallback<Void> resultHandler) throws org.apache.thrift.TException {
        iface.employeeReferralReason(args.userId, args.positionId, args.referralId, args.referralReasons, args.relationship, args.recomReasonText, args.postUserId,resultHandler);
      }
    }
  ...
  public static class employeeReferralReason_args implements org.apache.thrift.TBase<employeeReferralReason_args, employeeReferralReason_args._Fields>, java.io.Serializable, Cloneable, Comparable<employeeReferralReason_args>   {
    ...
    private static final org.apache.thrift.protocol.TField POST_USER_ID_FIELD_DESC = new org.apache.thrift.protocol.TField("postUserId", org.apache.thrift.protocol.TType.I32, (short)7);
    ...
    public enum _Fields implements org.apache.thrift.TFieldIdEnum {
      ...
      POST_USER_ID((short)7, "postUserId");
    ...
    private static final int __POSTUSERID_ISSET_ID = 4;
    private byte __isset_bitfield = 0;
    public static final java.util.Map<_Fields, org.apache.thrift.meta_data.FieldMetaData> metaDataMap;
    static {
      java.util.Map<_Fields, org.apache.thrift.meta_data.FieldMetaData> tmpMap = new java.util.EnumMap<_Fields, org.apache.thrift.meta_data.FieldMetaData>(_Fields.class);
    ...
    public employeeReferralReason_args setUserId(int userId) {
      this.userId = userId;
      setUserIdIsSet(true);
      return this;
    }
