...
public class ReferralService {
  ...
  public interface Iface {
    ...
    public void addUserSeekRecommend(int userId, int postUserId, int positionId, int origin) throws com.moseeker.thrift.gen.common.struct.BIZException, org.apache.thrift.TException;

    public void employeeReferralReason(int postUserId, int positionId, int referralId, java.util.List<String> referralReasons, byte relationship, String recomReasonText) throws com.moseeker.thrift.gen.common.struct.BIZException, org.apache.thrift.TException;

    public com.moseeker.thrift.gen.referral.struct.ContactPushInfo fetchSeekRecommend(int referralId, int postUserId) throws com.moseeker.thrift.gen.common.struct.BIZException, org.apache.thrift.TException;
    ...
    public void employeeReferralRecomEvaluation(int postUserId, int positionId, int presenteeId, java.util.List<String> referralReasons, byte relationship, String recomReasonText) throws com.moseeker.thrift.gen.common.struct.BIZException, org.apache.thrift.TException;
  ...
  public interface AsyncIface {
    ...
    public void addUserSeekRecommend(int userId, int postUserId, int positionId, int origin, org.apache.thrift.async.AsyncMethodCallback<Void> resultHandler) throws org.apache.thrift.TException;

    public void employeeReferralReason(int postUserId, int positionId, int referralId, java.util.List<String> referralReasons, byte relationship, String recomReasonText, org.apache.thrift.async.AsyncMethodCallback<Void> resultHandler) throws org.apache.thrift.TException;

    public void fetchSeekRecommend(int referralId, int postUserId, org.apache.thrift.async.AsyncMethodCallback<com.moseeker.thrift.gen.referral.struct.ContactPushInfo> resultHandler) throws org.apache.thrift.TException;
    ...
    public void employeeReferralRecomEvaluation(int postUserId, int positionId, int presenteeId, java.util.List<String> referralReasons, byte relationship, String recomReasonText, org.apache.thrift.async.AsyncMethodCallback<Void> resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public void addUserSeekRecommend(int userId, int postUserId, int positionId, int origin) throws com.moseeker.thrift.gen.common.struct.BIZException, org.apache.thrift.TException
    {
      send_addUserSeekRecommend(userId, postUserId, positionId, origin);
      recv_addUserSeekRecommend();
    }

    public void send_addUserSeekRecommend(int userId, int postUserId, int positionId, int origin) throws org.apache.thrift.TException
    {
    ...
    public void employeeReferralReason(int postUserId, int positionId, int referralId, java.util.List<String> referralReasons, byte relationship, String recomReasonText) throws com.moseeker.thrift.gen.common.struct.BIZException, org.apache.thrift.TException
    {
      send_employeeReferralReason(postUserId, positionId, referralId, referralReasons, relationship, recomReasonText);
      recv_employeeReferralReason();
    }

    public void send_employeeReferralReason(int postUserId, int positionId, int referralId, java.util.List<String> referralReasons, byte relationship, String recomReasonText) throws org.apache.thrift.TException
    {
    ...
    public com.moseeker.thrift.gen.referral.struct.ContactPushInfo fetchSeekRecommend(int referralId, int postUserId) throws com.moseeker.thrift.gen.common.struct.BIZException, org.apache.thrift.TException
    {
      send_fetchSeekRecommend(referralId, postUserId);
      return recv_fetchSeekRecommend();
    }

    public void send_fetchSeekRecommend(int referralId, int postUserId) throws org.apache.thrift.TException
    {
    ...
    public void employeeReferralRecomEvaluation(int postUserId, int positionId, int presenteeId, java.util.List<String> referralReasons, byte relationship, String recomReasonText) throws com.moseeker.thrift.gen.common.struct.BIZException, org.apache.thrift.TException
    {
      send_employeeReferralRecomEvaluation(postUserId, positionId, presenteeId, referralReasons, relationship, recomReasonText);
      recv_employeeReferralRecomEvaluation();
    }

    public void send_employeeReferralRecomEvaluation(int postUserId, int positionId, int presenteeId, java.util.List<String> referralReasons, byte relationship, String recomReasonText) throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public void addUserSeekRecommend(int userId, int postUserId, int positionId, int origin, org.apache.thrift.async.AsyncMethodCallback<Void> resultHandler) throws org.apache.thrift.TException {
      checkReady();
      addUserSeekRecommend_call method_call = new addUserSeekRecommend_call(userId, postUserId, positionId, origin, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }
    ...
    public void employeeReferralReason(int postUserId, int positionId, int referralId, java.util.List<String> referralReasons, byte relationship, String recomReasonText, org.apache.thrift.async.AsyncMethodCallback<Void> resultHandler) throws org.apache.thrift.TException {
      checkReady();
      employeeReferralReason_call method_call = new employeeReferralReason_call(postUserId, positionId, referralId, referralReasons, relationship, recomReasonText, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }
    ...
    public void fetchSeekRecommend(int referralId, int postUserId, org.apache.thrift.async.AsyncMethodCallback<com.moseeker.thrift.gen.referral.struct.ContactPushInfo> resultHandler) throws org.apache.thrift.TException {
      checkReady();
      fetchSeekRecommend_call method_call = new fetchSeekRecommend_call(referralId, postUserId, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }
    ...
    public void employeeReferralRecomEvaluation(int postUserId, int positionId, int presenteeId, java.util.List<String> referralReasons, byte relationship, String recomReasonText, org.apache.thrift.async.AsyncMethodCallback<Void> resultHandler) throws org.apache.thrift.TException {
      checkReady();
      employeeReferralRecomEvaluation_call method_call = new employeeReferralRecomEvaluation_call(postUserId, positionId, presenteeId, referralReasons, relationship, recomReasonText, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class addUserSeekRecommend<I extends Iface> extends org.apache.thrift.ProcessFunction<I, addUserSeekRecommend_args> {
      ...
      public addUserSeekRecommend_result getResult(I iface, addUserSeekRecommend_args args) throws org.apache.thrift.TException {
        addUserSeekRecommend_result result = new addUserSeekRecommend_result();
        try {
          iface.addUserSeekRecommend(args.userId, args.postUserId, args.positionId, args.origin);
        } catch (com.moseeker.thrift.gen.common.struct.BIZException e) {
          result.e = e;
        }
        return result;
    ...
    public static class employeeReferralReason<I extends Iface> extends org.apache.thrift.ProcessFunction<I, employeeReferralReason_args> {
      ...
      public employeeReferralReason_result getResult(I iface, employeeReferralReason_args args) throws org.apache.thrift.TException {
        employeeReferralReason_result result = new employeeReferralReason_result();
        try {
          iface.employeeReferralReason(args.postUserId, args.positionId, args.referralId, args.referralReasons, args.relationship, args.recomReasonText);
        } catch (com.moseeker.thrift.gen.common.struct.BIZException e) {
          result.e = e;
        }
        return result;
    ...
    public static class fetchSeekRecommend<I extends Iface> extends org.apache.thrift.ProcessFunction<I, fetchSeekRecommend_args> {
      ...
      public fetchSeekRecommend_result getResult(I iface, fetchSeekRecommend_args args) throws org.apache.thrift.TException {
        fetchSeekRecommend_result result = new fetchSeekRecommend_result();
        try {
          result.success = iface.fetchSeekRecommend(args.referralId, args.postUserId);
        } catch (com.moseeker.thrift.gen.common.struct.BIZException e) {
          result.e = e;
        }
        return result;
    ...
    public static class employeeReferralRecomEvaluation<I extends Iface> extends org.apache.thrift.ProcessFunction<I, employeeReferralRecomEvaluation_args> {
      ...
      public employeeReferralRecomEvaluation_result getResult(I iface, employeeReferralRecomEvaluation_args args) throws org.apache.thrift.TException {
        employeeReferralRecomEvaluation_result result = new employeeReferralRecomEvaluation_result();
        try {
          iface.employeeReferralRecomEvaluation(args.postUserId, args.positionId, args.presenteeId, args.referralReasons, args.relationship, args.recomReasonText);
        } catch (com.moseeker.thrift.gen.common.struct.BIZException e) {
          result.e = e;
        }
        return result;
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class addUserSeekRecommend<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, addUserSeekRecommend_args, Void> {
      ...
      public void start(I iface, addUserSeekRecommend_args args, org.apache.thrift.async.AsyncMethodCallback<Void> resultHandler) throws org.apache.thrift.TException {
        iface.addUserSeekRecommend(args.userId, args.postUserId, args.positionId, args.origin,resultHandler);
      }
    }
    ...
    public static class employeeReferralReason<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, employeeReferralReason_args, Void> {
      ...
      public void start(I iface, employeeReferralReason_args args, org.apache.thrift.async.AsyncMethodCallback<Void> resultHandler) throws org.apache.thrift.TException {
        iface.employeeReferralReason(args.postUserId, args.positionId, args.referralId, args.referralReasons, args.relationship, args.recomReasonText,resultHandler);
      }
    }
    ...
    public static class fetchSeekRecommend<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, fetchSeekRecommend_args, com.moseeker.thrift.gen.referral.struct.ContactPushInfo> {
      ...
      public void start(I iface, fetchSeekRecommend_args args, org.apache.thrift.async.AsyncMethodCallback<com.moseeker.thrift.gen.referral.struct.ContactPushInfo> resultHandler) throws org.apache.thrift.TException {
        iface.fetchSeekRecommend(args.referralId, args.postUserId,resultHandler);
      }
    }
    ...
    public static class employeeReferralRecomEvaluation<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, employeeReferralRecomEvaluation_args, Void> {
      ...
      public void start(I iface, employeeReferralRecomEvaluation_args args, org.apache.thrift.async.AsyncMethodCallback<Void> resultHandler) throws org.apache.thrift.TException {
        iface.employeeReferralRecomEvaluation(args.postUserId, args.positionId, args.presenteeId, args.referralReasons, args.relationship, args.recomReasonText,resultHandler);
      }
    }
  ...
  public static class employeeReferralReason_args implements org.apache.thrift.TBase<employeeReferralReason_args, employeeReferralReason_args._Fields>, java.io.Serializable, Cloneable, Comparable<employeeReferralReason_args>   {
    ...
    private static final org.apache.thrift.protocol.TField REFERRAL_ID_FIELD_DESC = new org.apache.thrift.protocol.TField("referralId", org.apache.thrift.protocol.TType.I32, (short)3);
    ...
    private static final org.apache.thrift.protocol.TField RELATIONSHIP_FIELD_DESC = new org.apache.thrift.protocol.TField("relationship", org.apache.thrift.protocol.TType.BYTE, (short)5);
    private static final org.apache.thrift.protocol.TField RECOM_REASON_TEXT_FIELD_DESC = new org.apache.thrift.protocol.TField("recomReasonText", org.apache.thrift.protocol.TType.STRING, (short)6);
    ...
    public enum _Fields implements org.apache.thrift.TFieldIdEnum {
      ...
      REFERRAL_ID((short)3, "referralId"),
      REFERRAL_REASONS((short)4, "referralReasons"),
      RELATIONSHIP((short)5, "relationship"),
      RECOM_REASON_TEXT((short)6, "recomReasonText");
    ...
    private static final int __REFERRALID_ISSET_ID = 2;
  ...
  public static class fetchSeekRecommend_args implements org.apache.thrift.TBase<fetchSeekRecommend_args, fetchSeekRecommend_args._Fields>, java.io.Serializable, Cloneable, Comparable<fetchSeekRecommend_args>   {
    ...
    private static final org.apache.thrift.protocol.TField REFERRAL_ID_FIELD_DESC = new org.apache.thrift.protocol.TField("referralId", org.apache.thrift.protocol.TType.I32, (short)1);
    private static final org.apache.thrift.protocol.TField POST_USER_ID_FIELD_DESC = new org.apache.thrift.protocol.TField("postUserId", org.apache.thrift.protocol.TType.I32, (short)2);
    ...
    /** The set of fields this struct contains, along with convenience methods for finding and manipulating them. */
    public enum _Fields implements org.apache.thrift.TFieldIdEnum {
      REFERRAL_ID((short)1, "referralId"),
      POST_USER_ID((short)2, "postUserId");
    ...
    // isset id assignments
    private static final int __REFERRALID_ISSET_ID = 0;
    private static final int __POSTUSERID_ISSET_ID = 1;
    private byte __isset_bitfield = 0;
    public static final java.util.Map<_Fields, org.apache.thrift.meta_data.FieldMetaData> metaDataMap;
    static {
  ...
  public static class employeeReferralRecomEvaluation_args implements org.apache.thrift.TBase<employeeReferralRecomEvaluation_args, employeeReferralRecomEvaluation_args._Fields>, java.io.Serializable, Cloneable, Comparable<employeeReferralRecomEvaluation_args>   {
    ...
    private static final org.apache.thrift.protocol.TField POST_USER_ID_FIELD_DESC = new org.apache.thrift.protocol.TField("postUserId", org.apache.thrift.protocol.TType.I32, (short)1);
    private static final org.apache.thrift.protocol.TField POSITION_ID_FIELD_DESC = new org.apache.thrift.protocol.TField("positionId", org.apache.thrift.protocol.TType.I32, (short)2);
    private static final org.apache.thrift.protocol.TField PRESENTEE_ID_FIELD_DESC = new org.apache.thrift.protocol.TField("presenteeId", org.apache.thrift.protocol.TType.I32, (short)3);
    private static final org.apache.thrift.protocol.TField REFERRAL_REASONS_FIELD_DESC = new org.apache.thrift.protocol.TField("referralReasons", org.apache.thrift.protocol.TType.LIST, (short)4);
    private static final org.apache.thrift.protocol.TField RELATIONSHIP_FIELD_DESC = new org.apache.thrift.protocol.TField("relationship", org.apache.thrift.protocol.TType.BYTE, (short)5);
    private static final org.apache.thrift.protocol.TField RECOM_REASON_TEXT_FIELD_DESC = new org.apache.thrift.protocol.TField("recomReasonText", org.apache.thrift.protocol.TType.STRING, (short)6);
    ...
    public enum _Fields implements org.apache.thrift.TFieldIdEnum {
      POST_USER_ID((short)1, "postUserId"),
      POSITION_ID((short)2, "positionId"),
      PRESENTEE_ID((short)3, "presenteeId"),
      REFERRAL_REASONS((short)4, "referralReasons"),
      RELATIONSHIP((short)5, "relationship"),
      RECOM_REASON_TEXT((short)6, "recomReasonText");
    ...
    private static final int __POSTUSERID_ISSET_ID = 0;
    private static final int __POSITIONID_ISSET_ID = 1;
    private static final int __PRESENTEEID_ISSET_ID = 2;
    private static final int __RELATIONSHIP_ISSET_ID = 3;
    private byte __isset_bitfield = 0;
    public static final java.util.Map<_Fields, org.apache.thrift.meta_data.FieldMetaData> metaDataMap;
    static {
