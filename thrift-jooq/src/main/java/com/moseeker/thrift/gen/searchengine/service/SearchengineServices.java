...
public class SearchengineServices {
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public com.moseeker.thrift.gen.common.struct.Response query(String keywords, String cities, String industries, String occupations, String scale, String employment_type, String candidate_source, String experience, String degree, String salary, String company_id, int page_from, int page_size, String child_company_id) throws org.apache.thrift.TException
    {
      send_query(keywords, cities, industries, occupations, scale, employment_type, candidate_source, experience, degree, salary, company_id, page_from, page_size, child_company_id);
      return recv_query();
    }
    ...
    public void send_query(String keywords, String cities, String industries, String occupations, String scale, String employment_type, String candidate_source, String experience, String degree, String salary, String company_id, int page_from, int page_size, String child_company_id) throws org.apache.thrift.TException
    {
      ...
      args.setChild_company_id(child_company_id);
      sendBase("query", args);
    }
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public void query(String keywords, String cities, String industries, String occupations, String scale, String employment_type, String candidate_source, String experience, String degree, String salary, String company_id, int page_from, int page_size, String child_company_id, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException {
      checkReady();
      query_call method_call = new query_call(keywords, cities, industries, occupations, scale, employment_type, candidate_source, experience, degree, salary, company_id, page_from, page_size, child_company_id, resultHandler, this, ___protocolFactory, ___transport);
    ...
    public static class query_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      private String child_company_id;
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class query<I extends Iface> extends org.apache.thrift.ProcessFunction<I, query_args> {
      ...
      public query_result getResult(I iface, query_args args) throws org.apache.thrift.TException {
        query_result result = new query_result();
        result.success = iface.query(args.keywords, args.cities, args.industries, args.occupations, args.scale, args.employment_type, args.candidate_source, args.experience, args.degree, args.salary, args.company_id, args.page_from, args.page_size, args.child_company_id);
        return result;
      }
    }
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class query<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, query_args, com.moseeker.thrift.gen.common.struct.Response> {
      ...
      public void start(I iface, query_args args, org.apache.thrift.async.AsyncMethodCallback<com.moseeker.thrift.gen.common.struct.Response> resultHandler) throws TException {
        iface.query(args.keywords, args.cities, args.industries, args.occupations, args.scale, args.employment_type, args.candidate_source, args.experience, args.degree, args.salary, args.company_id, args.page_from, args.page_size, args.child_company_id,resultHandler);
      }
    }
  ...
  public static class query_args implements org.apache.thrift.TBase<query_args, query_args._Fields>, java.io.Serializable, Cloneable, Comparable<query_args>   {
    ...
    private static final org.apache.thrift.protocol.TField COMPANY_ID_FIELD_DESC = new org.apache.thrift.protocol.TField("company_id", org.apache.thrift.protocol.TType.STRING, (short)11);
    ...
    private static final org.apache.thrift.protocol.TField CHILD_COMPANY_ID_FIELD_DESC = new org.apache.thrift.protocol.TField("child_company_id", org.apache.thrift.protocol.TType.STRING, (short)14);
    ...
    public String company_id; // required
    public int page_from; // required
    public int page_size; // required
    public String child_company_id; // required
    ...
    public enum _Fields implements org.apache.thrift.TFieldIdEnum {
      ...
      COMPANY_ID((short)11, "company_id"),
      PAGE_FROM((short)12, "page_from"),
      PAGE_SIZE((short)13, "page_size"),
      CHILD_COMPANY_ID((short)14, "child_company_id");
    ...
    public query_args setCompany_id(String company_id) {
      this.company_id = company_id;
      return this;
    }
    ...
    public String getChild_company_id() {
      return this.child_company_id;
    }

    public query_args setChild_company_id(String child_company_id) {
      this.child_company_id = child_company_id;
      return this;
    }
    ...
    public boolean isSetChild_company_id() {
      return this.child_company_id != null;
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case CHILD_COMPANY_ID:
        if (value == null) {
          ...
          setChild_company_id((String)value);
        }
        break;
    ...
    public boolean equals(query_args that) {
      ...
      if (this_present_company_id || that_present_company_id) {
        if (!(this_present_company_id && that_present_company_id))
          return false;
        if (!this.company_id.equals(that.company_id))
          return false;
      }
      ...
      boolean this_present_child_company_id = true && this.isSetChild_company_id();
      boolean that_present_child_company_id = true && that.isSetChild_company_id();
      if (this_present_child_company_id || that_present_child_company_id) {
        if (!(this_present_child_company_id && that_present_child_company_id))
          return false;
        if (!this.child_company_id.equals(that.child_company_id))
          return false;
      }
    ...
    public int hashCode() {
      ...
      boolean present_child_company_id = true && (isSetChild_company_id());
    ...
    private static class query_argsStandardScheme extends StandardScheme<query_args> {
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, query_args struct) throws org.apache.thrift.TException {
        ...
        while (true)
        {
          ...
          switch (schemeField.id) {
            ...
            case 11: // COMPANY_ID
              if (schemeField.type == org.apache.thrift.protocol.TType.STRING) {
                struct.company_id = iprot.readString();
            ...
            case 14: // CHILD_COMPANY_ID
              if (schemeField.type == org.apache.thrift.protocol.TType.STRING) {
                struct.child_company_id = iprot.readString();
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, query_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.company_id != null) {
          oprot.writeFieldBegin(COMPANY_ID_FIELD_DESC);
          oprot.writeString(struct.company_id);
          oprot.writeFieldEnd();
        }
        ...
        oprot.writeFieldEnd();
        if (struct.child_company_id != null) {
          oprot.writeFieldBegin(CHILD_COMPANY_ID_FIELD_DESC);
          oprot.writeString(struct.child_company_id);
          oprot.writeFieldEnd();
        }
