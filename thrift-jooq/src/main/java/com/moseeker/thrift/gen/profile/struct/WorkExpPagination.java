...
public class WorkExpPagination implements org.apache.thrift.TBase<WorkExpPagination, WorkExpPagination._Fields>, java.io.Serializable, Cloneable, Comparable<WorkExpPagination> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("WorkExpPagination");
  ...
  private static final org.apache.thrift.protocol.TField WORK_EXPS_FIELD_DESC = new org.apache.thrift.protocol.TField("workExps", org.apache.thrift.protocol.TType.LIST, (short)5);

  private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
  static {
    schemes.put(StandardScheme.class, new WorkExpPaginationStandardSchemeFactory());
    schemes.put(TupleScheme.class, new WorkExpPaginationTupleSchemeFactory());
  }
  ...
  public List<WorkExp> workExps; // required
  ...
  static {
    ...
    tmpMap.put(_Fields.WORK_EXPS, new org.apache.thrift.meta_data.FieldMetaData("workExps", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
            new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, WorkExp.class))));
    metaDataMap = Collections.unmodifiableMap(tmpMap);
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(WorkExpPagination.class, metaDataMap);
  }

  public WorkExpPagination() {
  }
   ...
   */
  public WorkExpPagination(WorkExpPagination other) {
    ...
    if (other.isSetWorkExps()) {
      List<WorkExp> __this__workExps = new ArrayList<WorkExp>(other.workExps.size());
      for (WorkExp other_element : other.workExps) {
        __this__workExps.add(new WorkExp(other_element));
      }
      this.workExps = __this__workExps;
    }
  }

  public WorkExpPagination deepCopy() {
    return new WorkExpPagination(this);
  }
  ...
  public WorkExpPagination setTotal_row(int total_row) {
    this.total_row = total_row;
    setTotal_rowIsSet(true);
    return this;
  }
  ...
  public WorkExpPagination setTotal_page(int total_page) {
    this.total_page = total_page;
    setTotal_pageIsSet(true);
    return this;
  }
  ...
  public WorkExpPagination setPage_number(int page_number) {
    this.page_number = page_number;
    setPage_numberIsSet(true);
    return this;
  }
  ...
  public WorkExpPagination setPage_size(int page_size) {
    this.page_size = page_size;
    setPage_sizeIsSet(true);
    return this;
  }
  ...
  public java.util.Iterator<WorkExp> getWorkExpsIterator() {
    return (this.workExps == null) ? null : this.workExps.iterator();
  }

  public void addToWorkExps(WorkExp elem) {
  ...
  public WorkExpPagination setWorkExps(List<WorkExp> workExps) {
    this.workExps = workExps;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case WORK_EXPS:
      if (value == null) {
        ...
        setWorkExps((List<WorkExp>)value);
      }
      break;
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof WorkExpPagination)
      return this.equals((WorkExpPagination)that);
    return false;
  }

  public boolean equals(WorkExpPagination that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(WorkExpPagination other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("WorkExpPagination(");
    boolean first = true;
  ...
  private static class WorkExpPaginationStandardSchemeFactory implements SchemeFactory {
    public WorkExpPaginationStandardScheme getScheme() {
      return new WorkExpPaginationStandardScheme();
    }
  }

  private static class WorkExpPaginationStandardScheme extends StandardScheme<WorkExpPagination> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, WorkExpPagination struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.workExps = new ArrayList<WorkExp>(_list120.size);
                WorkExp _elem121;
                for (int _i122 = 0; _i122 < _list120.size; ++_i122)
                {
                  _elem121 = new WorkExp();
                  _elem121.read(iprot);
                  struct.workExps.add(_elem121);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, WorkExpPagination struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.workExps != null) {
        oprot.writeFieldBegin(WORK_EXPS_FIELD_DESC);
        {
          ...
          for (WorkExp _iter123 : struct.workExps)
          {
  ...
  private static class WorkExpPaginationTupleSchemeFactory implements SchemeFactory {
    public WorkExpPaginationTupleScheme getScheme() {
      return new WorkExpPaginationTupleScheme();
    }
  }

  private static class WorkExpPaginationTupleScheme extends TupleScheme<WorkExpPagination> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, WorkExpPagination struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetWorkExps()) {
        {
          ...
          for (WorkExp _iter124 : struct.workExps)
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, WorkExpPagination struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(4)) {
        {
          ...
          struct.workExps = new ArrayList<WorkExp>(_list125.size);
          WorkExp _elem126;
          for (int _i127 = 0; _i127 < _list125.size; ++_i127)
          {
            _elem126 = new WorkExp();
            _elem126.read(iprot);
            struct.workExps.add(_elem126);
          }
        }
        struct.setWorkExpsIsSet(true);
      }
