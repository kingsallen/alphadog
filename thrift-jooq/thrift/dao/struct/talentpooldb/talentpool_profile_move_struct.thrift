...
struct TalentPoolProfileMoveDO {
	...
	5: optional i8 crawlType,	//简历类型 1.主动投递简历  2.已下载简历
	6: optional string startDate,	//操作简历搬家的投递开始时间
	7: optional string endDate,	//操作简历搬家的投递结束时间
	8: optional i32 crawlNum,	//本次简历搬家获取简历数
	9: optional i8 status,	//0.获取中 1.已完成  2.获取失败
	10: optional string statusDisplay,	//状态中文展示
	11: optional i32 currentEmailNum,	//当前邮件数量
	12: optional i32 totalEmailNum,	//邮件数量
