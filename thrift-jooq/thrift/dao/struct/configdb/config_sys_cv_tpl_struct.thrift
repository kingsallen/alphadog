...
struct ConfigSysCvTplDO {
	...
	4: optional i32 fieldType,	//属性类型 0:短文本, 1:长文本,  2:多选, 3:单选, 4:长tag, 5tag:, 6:时间, 7img, 8:复合字段-单条, 9:复合字段-多条,10:下拉列表, 11:数字输入框(用于校验)
	5: optional string errorMsg,	//错误提示
	...
	14: optional string mapping,	//与profile的映射关系
	15: optional i32 parentId,	//复合字段关联
	16: optional string validateRe,	//数据校验规则（正则）
	17: optional i32 dictConstantId	//下拉选项关联字典表
