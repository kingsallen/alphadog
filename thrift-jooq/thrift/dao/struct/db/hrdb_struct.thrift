...
struct HrCmsModuleDO {
	...
	4: optional i32 type,	//1,企业模块A 2，企业模块B，3企业模块C，4，企业模块D，5，企业模块E，6地图，7，二维码 8,团队详情9，职位详情
...
struct HrCompanyDO {
	...
	7: optional i8 property,	//公司性质 0:没选择 1:国有 2:三资 3:集体 4:私有
	...
	16: optional i8 disable,	//0:无效 1:有效
	17: optional string createTime,	//创建时间
	18: optional string updateTime,	//更新时间
	19: optional i8 source,	//添加来源 {"0":"hr系统", "8":"微信端添加" "9":"profile添加"}
...
struct HrMediaDO {
	...
	3: optional string attrs,	//客户属性，可选字段
...
struct HrTeamDO {
	...
	6: optional i32 companyId,	//团队所在母公司
	7: optional string createTime,	//创建时间
	8: optional string updateTime,	//更新时间
	9: optional i32 isShow,	//当前团队在列表等处是否显示, 0:不显示, 1:显示
	10: optional string slogan,	//团队标语
	11: optional i32 resId,	//团队主图片hr_resource.id
	12: optional i32 disable,	//0是正常 1是删除
	13: optional string teamDetail,	//团队详情页配置hr_media.id: [1, 23, 32]
	14: optional string jdMedia	//成员一天信息hr_media.id: [1, 23, 32]
