namespace java com.moseeker.thrift.gen.dao.struct.historydb
namespace py thrift_gen.gen.dao.struct.historydb


struct HistoryUserEmployeeDO {
	...
	30: optional double activation,	//员工认证激活状态，0 ：认证成功，1：认证后取消认证 2：认证失败 3：未认证 4：认证后又认证了其他公司导致本条数据变成未认证
