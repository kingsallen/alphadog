              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.application = new ArrayList<com.moseeker.thrift.gen.application.struct.JobApplication>(_list64.size);
                  com.moseeker.thrift.gen.application.struct.JobApplication _elem65;
                  for (int _i66 = 0; _i66 < _list64.size; ++_i66)
                  {
                    _elem65 = new com.moseeker.thrift.gen.application.struct.JobApplication();
                    _elem65.read(iprot);
                    struct.application.add(_elem65);
                  }
                  iprot.readListEnd();
                }
                struct.setApplicationIsSet(true);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, putApplications_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.application != null) {
          oprot.writeFieldBegin(APPLICATION_FIELD_DESC);
          {
            ...
            for (com.moseeker.thrift.gen.application.struct.JobApplication _iter67 : struct.application)
            {
              _iter67.write(oprot);
            }
            oprot.writeListEnd();
        ...
        if (struct.isSetApplication()) {
          {
            ...
            for (com.moseeker.thrift.gen.application.struct.JobApplication _iter68 : struct.application)
            {
              _iter68.write(oprot);
            }
          }
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.application = new ArrayList<com.moseeker.thrift.gen.application.struct.JobApplication>(_list69.size);
            com.moseeker.thrift.gen.application.struct.JobApplication _elem70;
            for (int _i71 = 0; _i71 < _list69.size; ++_i71)
            {
              _elem70 = new com.moseeker.thrift.gen.application.struct.JobApplication();
              _elem70.read(iprot);
              struct.application.add(_elem70);
            }
          }
          struct.setApplicationIsSet(true);
        }
