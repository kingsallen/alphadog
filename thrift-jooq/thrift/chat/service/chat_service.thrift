...
service ChatService {
    chat_struct.HRChatRoomsVO listHRChatRoom(1: i32 hrId, 2: i32 pageNum, 3: i32 pageSize) throws (1: common_struct.CURDException e)
    ...
    chat_struct.UserChatRoomsVO listUserChatRoom(1: i32 userId, 2: i32 pageNum, 3: i32 pageSize) throws (1: common_struct.CURDException e)
    ...
    //列出聊天记录
    chat_struct.ChatsVO listChatLogs(1: i32 roomId, 2: i32 pageNum, 3: i32 pageSize) throws (1: common_struct.CURDException e)
    //保存聊天记录
