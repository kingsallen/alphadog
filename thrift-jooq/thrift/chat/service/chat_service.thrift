...
service ChatService {
    ...
    chat_struct.HRChatRoomsIndexVO listHRChatRoomByIndex(1: i32 hrId, 2: string keyword, 3: i32 userId, 4: bool apply, 5: i32 pageSize) throws (1: common_struct.BIZException e)
