...
public class ProfilePagination implements org.apache.thrift.TBase<ProfilePagination, ProfilePagination._Fields>, java.io.Serializable, Cloneable, Comparable<ProfilePagination> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("ProfilePagination");
  ...
  private static final org.apache.thrift.protocol.TField PROFILES_FIELD_DESC = new org.apache.thrift.protocol.TField("profiles", org.apache.thrift.protocol.TType.LIST, (short)5);

  private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
  static {
    schemes.put(StandardScheme.class, new ProfilePaginationStandardSchemeFactory());
    schemes.put(TupleScheme.class, new ProfilePaginationTupleSchemeFactory());
  }
  ...
  public List<Profile> profiles; // required
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(ProfilePagination.class, metaDataMap);
  }
   ...
   */
  public ProfilePagination(ProfilePagination other) {
    ...
    if (other.isSetProfiles()) {
      List<Profile> __this__profiles = new ArrayList<Profile>(other.profiles.size());
      for (Profile other_element : other.profiles) {
        __this__profiles.add(new Profile(other_element));
      }
      this.profiles = __this__profiles;
    }
  }

  public ProfilePagination deepCopy() {
    return new ProfilePagination(this);
  }
  ...
  public ProfilePagination setTotal_row(int total_row) {
    this.total_row = total_row;
    setTotal_rowIsSet(true);
    return this;
  }
  ...
  public ProfilePagination setTotal_page(int total_page) {
    this.total_page = total_page;
    setTotal_pageIsSet(true);
    return this;
  }
  ...
  public ProfilePagination setPage_number(int page_number) {
    this.page_number = page_number;
    setPage_numberIsSet(true);
    return this;
  }
  ...
  public ProfilePagination setPage_size(int page_size) {
    this.page_size = page_size;
    setPage_sizeIsSet(true);
    return this;
  }
  ...
  public java.util.Iterator<Profile> getProfilesIterator() {
    return (this.profiles == null) ? null : this.profiles.iterator();
  }

  public void addToProfiles(Profile elem) {
  ...
  public ProfilePagination setProfiles(List<Profile> profiles) {
    this.profiles = profiles;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case PROFILES:
      if (value == null) {
        ...
        setProfiles((List<Profile>)value);
      }
      break;
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof ProfilePagination)
      return this.equals((ProfilePagination)that);
    return false;
  }

  public boolean equals(ProfilePagination that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(ProfilePagination other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("ProfilePagination(");
    boolean first = true;
  ...
  private static class ProfilePaginationStandardSchemeFactory implements SchemeFactory {
    public ProfilePaginationStandardScheme getScheme() {
      return new ProfilePaginationStandardScheme();
    }
  }

  private static class ProfilePaginationStandardScheme extends StandardScheme<ProfilePagination> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, ProfilePagination struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.profiles = new ArrayList<Profile>(_list10.size);
                Profile _elem11;
                for (int _i12 = 0; _i12 < _list10.size; ++_i12)
                {
                  _elem11 = new Profile();
                  _elem11.read(iprot);
                  struct.profiles.add(_elem11);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ProfilePagination struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.profiles != null) {
        oprot.writeFieldBegin(PROFILES_FIELD_DESC);
        {
          ...
          for (Profile _iter13 : struct.profiles)
          {
            _iter13.write(oprot);
          }
          oprot.writeListEnd();
  ...
  private static class ProfilePaginationTupleSchemeFactory implements SchemeFactory {
    public ProfilePaginationTupleScheme getScheme() {
      return new ProfilePaginationTupleScheme();
    }
  }

  private static class ProfilePaginationTupleScheme extends TupleScheme<ProfilePagination> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, ProfilePagination struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetProfiles()) {
        {
          ...
          for (Profile _iter14 : struct.profiles)
          {
            _iter14.write(oprot);
          }
        }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, ProfilePagination struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(4)) {
        {
          ...
          struct.profiles = new ArrayList<Profile>(_list15.size);
          Profile _elem16;
          for (int _i17 = 0; _i17 < _list15.size; ++_i17)
          {
            _elem16 = new Profile();
            _elem16.read(iprot);
            struct.profiles.add(_elem16);
          }
        }
        struct.setProfilesIsSet(true);
      }
