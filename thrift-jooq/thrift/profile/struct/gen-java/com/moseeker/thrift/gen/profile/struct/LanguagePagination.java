...
public class LanguagePagination implements org.apache.thrift.TBase<LanguagePagination, LanguagePagination._Fields>, java.io.Serializable, Cloneable, Comparable<LanguagePagination> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("LanguagePagination");
  ...
  static {
    schemes.put(StandardScheme.class, new LanguagePaginationStandardSchemeFactory());
    schemes.put(TupleScheme.class, new LanguagePaginationTupleSchemeFactory());
  }
  ...
  public List<Language> languages; // required
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(LanguagePagination.class, metaDataMap);
  }

  public LanguagePagination() {
  }
   ...
   */
  public LanguagePagination(LanguagePagination other) {
    ...
    if (other.isSetLanguages()) {
      List<Language> __this__languages = new ArrayList<Language>(other.languages.size());
      for (Language other_element : other.languages) {
        __this__languages.add(new Language(other_element));
      }
      this.languages = __this__languages;
    }
  }

  public LanguagePagination deepCopy() {
    return new LanguagePagination(this);
  }
  ...
  public LanguagePagination setTotal_row(int total_row) {
    this.total_row = total_row;
    setTotal_rowIsSet(true);
    return this;
  }
  ...
  public LanguagePagination setTotal_page(int total_page) {
    this.total_page = total_page;
    setTotal_pageIsSet(true);
    return this;
  }
  ...
  public LanguagePagination setPage_number(int page_number) {
    this.page_number = page_number;
    setPage_numberIsSet(true);
    return this;
  }
  ...
  public LanguagePagination setPage_size(int page_size) {
    this.page_size = page_size;
    setPage_sizeIsSet(true);
    return this;
  }
  ...
  public java.util.Iterator<Language> getLanguagesIterator() {
    return (this.languages == null) ? null : this.languages.iterator();
  }

  public void addToLanguages(Language elem) {
  ...
  public LanguagePagination setLanguages(List<Language> languages) {
    this.languages = languages;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case LANGUAGES:
      if (value == null) {
        ...
        setLanguages((List<Language>)value);
      }
      break;
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof LanguagePagination)
      return this.equals((LanguagePagination)that);
    return false;
  }

  public boolean equals(LanguagePagination that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(LanguagePagination other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("LanguagePagination(");
    boolean first = true;
  ...
  private static class LanguagePaginationStandardSchemeFactory implements SchemeFactory {
    public LanguagePaginationStandardScheme getScheme() {
      return new LanguagePaginationStandardScheme();
    }
  }

  private static class LanguagePaginationStandardScheme extends StandardScheme<LanguagePagination> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, LanguagePagination struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.languages = new ArrayList<Language>(_list82.size);
                Language _elem83;
                for (int _i84 = 0; _i84 < _list82.size; ++_i84)
                {
                  _elem83 = new Language();
                  _elem83.read(iprot);
                  struct.languages.add(_elem83);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, LanguagePagination struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.languages != null) {
        oprot.writeFieldBegin(LANGUAGES_FIELD_DESC);
        {
          ...
          for (Language _iter85 : struct.languages)
          {
            _iter85.write(oprot);
          }
          oprot.writeListEnd();
  ...
  private static class LanguagePaginationTupleSchemeFactory implements SchemeFactory {
    public LanguagePaginationTupleScheme getScheme() {
      return new LanguagePaginationTupleScheme();
    }
  }

  private static class LanguagePaginationTupleScheme extends TupleScheme<LanguagePagination> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, LanguagePagination struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetLanguages()) {
        {
          ...
          for (Language _iter86 : struct.languages)
          {
            _iter86.write(oprot);
          }
        }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, LanguagePagination struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(4)) {
        {
          ...
          struct.languages = new ArrayList<Language>(_list87.size);
          Language _elem88;
          for (int _i89 = 0; _i89 < _list87.size; ++_i89)
          {
            _elem88 = new Language();
            _elem88.read(iprot);
            struct.languages.add(_elem88);
          }
        }
        struct.setLanguagesIsSet(true);
      }
