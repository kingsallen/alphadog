...
public class SchoolJobPagination implements org.apache.thrift.TBase<SchoolJobPagination, SchoolJobPagination._Fields>, java.io.Serializable, Cloneable, Comparable<SchoolJobPagination> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("SchoolJobPagination");
  ...
  private static final org.apache.thrift.protocol.TField SCHOOL_JOBS_FIELD_DESC = new org.apache.thrift.protocol.TField("schoolJobs", org.apache.thrift.protocol.TType.LIST, (short)5);

  private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
  static {
    schemes.put(StandardScheme.class, new SchoolJobPaginationStandardSchemeFactory());
    schemes.put(TupleScheme.class, new SchoolJobPaginationTupleSchemeFactory());
  }
  ...
  public List<SchoolJob> schoolJobs; // required
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    SCHOOL_JOBS((short)5, "schoolJobs");
  ...
  static {
    ...
    tmpMap.put(_Fields.SCHOOL_JOBS, new org.apache.thrift.meta_data.FieldMetaData("schoolJobs", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
            new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, SchoolJob.class))));
    metaDataMap = Collections.unmodifiableMap(tmpMap);
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(SchoolJobPagination.class, metaDataMap);
  }

  public SchoolJobPagination() {
  }
   ...
   */
  public SchoolJobPagination(SchoolJobPagination other) {
    ...
    if (other.isSetSchoolJobs()) {
      List<SchoolJob> __this__schoolJobs = new ArrayList<SchoolJob>(other.schoolJobs.size());
      for (SchoolJob other_element : other.schoolJobs) {
        __this__schoolJobs.add(new SchoolJob(other_element));
      }
      this.schoolJobs = __this__schoolJobs;
    }
  }

  public SchoolJobPagination deepCopy() {
    return new SchoolJobPagination(this);
  }
  ...
  public SchoolJobPagination setTotal_row(int total_row) {
    this.total_row = total_row;
    setTotal_rowIsSet(true);
    return this;
  }
  ...
  public SchoolJobPagination setTotal_page(int total_page) {
    this.total_page = total_page;
    setTotal_pageIsSet(true);
    return this;
  }
  ...
  public SchoolJobPagination setPage_number(int page_number) {
    this.page_number = page_number;
    setPage_numberIsSet(true);
    return this;
  }
  ...
  public SchoolJobPagination setPage_size(int page_size) {
    this.page_size = page_size;
    setPage_sizeIsSet(true);
    return this;
  }
  ...
  public java.util.Iterator<SchoolJob> getSchoolJobsIterator() {
    return (this.schoolJobs == null) ? null : this.schoolJobs.iterator();
  }

  public void addToSchoolJobs(SchoolJob elem) {
    if (this.schoolJobs == null) {
      this.schoolJobs = new ArrayList<SchoolJob>();
    }
    this.schoolJobs.add(elem);
  }

  public List<SchoolJob> getSchoolJobs() {
    return this.schoolJobs;
  }

  public SchoolJobPagination setSchoolJobs(List<SchoolJob> schoolJobs) {
    this.schoolJobs = schoolJobs;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case SCHOOL_JOBS:
      if (value == null) {
        ...
        setSchoolJobs((List<SchoolJob>)value);
      }
      break;
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof SchoolJobPagination)
      return this.equals((SchoolJobPagination)that);
    return false;
  }

  public boolean equals(SchoolJobPagination that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(SchoolJobPagination other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("SchoolJobPagination(");
    boolean first = true;
  ...
  private static class SchoolJobPaginationStandardSchemeFactory implements SchemeFactory {
    public SchoolJobPaginationStandardScheme getScheme() {
      return new SchoolJobPaginationStandardScheme();
    }
  }

  private static class SchoolJobPaginationStandardScheme extends StandardScheme<SchoolJobPagination> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, SchoolJobPagination struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.schoolJobs = new ArrayList<SchoolJob>(_list106.size);
                SchoolJob _elem107;
                for (int _i108 = 0; _i108 < _list106.size; ++_i108)
                {
                  _elem107 = new SchoolJob();
                  _elem107.read(iprot);
                  struct.schoolJobs.add(_elem107);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, SchoolJobPagination struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.schoolJobs != null) {
        oprot.writeFieldBegin(SCHOOL_JOBS_FIELD_DESC);
        {
          ...
          for (SchoolJob _iter109 : struct.schoolJobs)
          {
  ...
  private static class SchoolJobPaginationTupleSchemeFactory implements SchemeFactory {
    public SchoolJobPaginationTupleScheme getScheme() {
      return new SchoolJobPaginationTupleScheme();
    }
  }

  private static class SchoolJobPaginationTupleScheme extends TupleScheme<SchoolJobPagination> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, SchoolJobPagination struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetSchoolJobs()) {
        {
          ...
          for (SchoolJob _iter110 : struct.schoolJobs)
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, SchoolJobPagination struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(4)) {
        {
          ...
          struct.schoolJobs = new ArrayList<SchoolJob>(_list111.size);
          SchoolJob _elem112;
          for (int _i113 = 0; _i113 < _list111.size; ++_i113)
          {
            _elem112 = new SchoolJob();
            _elem112.read(iprot);
            struct.schoolJobs.add(_elem112);
          }
        }
        struct.setSchoolJobsIsSet(true);
      }
