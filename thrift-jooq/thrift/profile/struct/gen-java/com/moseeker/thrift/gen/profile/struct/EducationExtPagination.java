...
public class EducationExtPagination implements org.apache.thrift.TBase<EducationExtPagination, EducationExtPagination._Fields>, java.io.Serializable, Cloneable, Comparable<EducationExtPagination> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("EducationExtPagination");
  ...
  private static final org.apache.thrift.protocol.TField EDUCATION_EXTS_FIELD_DESC = new org.apache.thrift.protocol.TField("educationExts", org.apache.thrift.protocol.TType.LIST, (short)5);

  private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
  static {
    schemes.put(StandardScheme.class, new EducationExtPaginationStandardSchemeFactory());
    schemes.put(TupleScheme.class, new EducationExtPaginationTupleSchemeFactory());
  }
  ...
  public List<EducationExt> educationExts; // required
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    EDUCATION_EXTS((short)5, "educationExts");
  ...
  static {
    ...
    tmpMap.put(_Fields.EDUCATION_EXTS, new org.apache.thrift.meta_data.FieldMetaData("educationExts", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
            new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, EducationExt.class))));
    metaDataMap = Collections.unmodifiableMap(tmpMap);
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(EducationExtPagination.class, metaDataMap);
  }

  public EducationExtPagination() {
  }
  ...
  public EducationExtPagination(
    ...
    int page_number,
    int page_size,
    List<EducationExt> educationExts)
  {
    this();
   ...
   */
  public EducationExtPagination(EducationExtPagination other) {
    ...
    if (other.isSetEducationExts()) {
      List<EducationExt> __this__educationExts = new ArrayList<EducationExt>(other.educationExts.size());
      for (EducationExt other_element : other.educationExts) {
        __this__educationExts.add(new EducationExt(other_element));
      }
      this.educationExts = __this__educationExts;
    }
  }

  public EducationExtPagination deepCopy() {
    return new EducationExtPagination(this);
  }
  ...
  public EducationExtPagination setTotal_row(int total_row) {
    this.total_row = total_row;
    setTotal_rowIsSet(true);
    return this;
  }
  ...
  public EducationExtPagination setTotal_page(int total_page) {
    this.total_page = total_page;
    setTotal_pageIsSet(true);
    return this;
  }
  ...
  public EducationExtPagination setPage_number(int page_number) {
    this.page_number = page_number;
    setPage_numberIsSet(true);
    return this;
  }
  ...
  public EducationExtPagination setPage_size(int page_size) {
    this.page_size = page_size;
    setPage_sizeIsSet(true);
    return this;
  }
  ...
  public java.util.Iterator<EducationExt> getEducationExtsIterator() {
    return (this.educationExts == null) ? null : this.educationExts.iterator();
  }

  public void addToEducationExts(EducationExt elem) {
    if (this.educationExts == null) {
      this.educationExts = new ArrayList<EducationExt>();
    }
    this.educationExts.add(elem);
  }

  public List<EducationExt> getEducationExts() {
    return this.educationExts;
  }

  public EducationExtPagination setEducationExts(List<EducationExt> educationExts) {
    this.educationExts = educationExts;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case EDUCATION_EXTS:
      if (value == null) {
        ...
        setEducationExts((List<EducationExt>)value);
      }
      break;
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof EducationExtPagination)
      return this.equals((EducationExtPagination)that);
    return false;
  }

  public boolean equals(EducationExtPagination that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(EducationExtPagination other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("EducationExtPagination(");
    boolean first = true;
  ...
  private static class EducationExtPaginationStandardSchemeFactory implements SchemeFactory {
    public EducationExtPaginationStandardScheme getScheme() {
      return new EducationExtPaginationStandardScheme();
    }
  }

  private static class EducationExtPaginationStandardScheme extends StandardScheme<EducationExtPagination> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, EducationExtPagination struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.educationExts = new ArrayList<EducationExt>(_list42.size);
                EducationExt _elem43;
                for (int _i44 = 0; _i44 < _list42.size; ++_i44)
                {
                  _elem43 = new EducationExt();
                  _elem43.read(iprot);
                  struct.educationExts.add(_elem43);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, EducationExtPagination struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.educationExts != null) {
        oprot.writeFieldBegin(EDUCATION_EXTS_FIELD_DESC);
        {
          ...
          for (EducationExt _iter45 : struct.educationExts)
          {
            _iter45.write(oprot);
          }
          oprot.writeListEnd();
  ...
  private static class EducationExtPaginationTupleSchemeFactory implements SchemeFactory {
    public EducationExtPaginationTupleScheme getScheme() {
      return new EducationExtPaginationTupleScheme();
    }
  }

  private static class EducationExtPaginationTupleScheme extends TupleScheme<EducationExtPagination> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, EducationExtPagination struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetEducationExts()) {
        {
          ...
          for (EducationExt _iter46 : struct.educationExts)
          {
            _iter46.write(oprot);
          }
        }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, EducationExtPagination struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(4)) {
        {
          ...
          struct.educationExts = new ArrayList<EducationExt>(_list47.size);
          EducationExt _elem48;
          for (int _i49 = 0; _i49 < _list47.size; ++_i49)
          {
            _elem48 = new EducationExt();
            _elem48.read(iprot);
            struct.educationExts.add(_elem48);
          }
        }
        struct.setEducationExtsIsSet(true);
      }
