            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.profileImports = new ArrayList<ProfileImport>(_list58.size);
                ProfileImport _elem59;
                for (int _i60 = 0; _i60 < _list58.size; ++_i60)
                {
                  _elem59 = new ProfileImport();
                  _elem59.read(iprot);
                  struct.profileImports.add(_elem59);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ProfileImportPagination struct) throws org.apache.thrift.TException {
      ...
      if (struct.profileImports != null) {
        oprot.writeFieldBegin(PROFILE_IMPORTS_FIELD_DESC);
        {
          ...
          for (ProfileImport _iter61 : struct.profileImports)
          {
            _iter61.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.isSetProfileImports()) {
        {
          ...
          for (ProfileImport _iter62 : struct.profileImports)
          {
            _iter62.write(oprot);
          }
        }
      ...
      if (incoming.get(4)) {
        {
          ...
          struct.profileImports = new ArrayList<ProfileImport>(_list63.size);
          ProfileImport _elem64;
          for (int _i65 = 0; _i65 < _list63.size; ++_i65)
          {
            _elem64 = new ProfileImport();
            _elem64.read(iprot);
            struct.profileImports.add(_elem64);
          }
        }
        struct.setProfileImportsIsSet(true);
      }
