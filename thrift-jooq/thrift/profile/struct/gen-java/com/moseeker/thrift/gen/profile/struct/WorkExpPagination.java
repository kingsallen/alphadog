            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.workExps = new ArrayList<WorkExp>(_list130.size);
                WorkExp _elem131;
                for (int _i132 = 0; _i132 < _list130.size; ++_i132)
                {
                  _elem131 = new WorkExp();
                  _elem131.read(iprot);
                  struct.workExps.add(_elem131);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, WorkExpPagination struct) throws org.apache.thrift.TException {
      ...
      if (struct.workExps != null) {
        oprot.writeFieldBegin(WORK_EXPS_FIELD_DESC);
        {
          ...
          for (WorkExp _iter133 : struct.workExps)
          {
      ...
      if (struct.isSetWorkExps()) {
        {
          ...
          for (WorkExp _iter134 : struct.workExps)
          {
      ...
      if (incoming.get(4)) {
        {
          ...
          struct.workExps = new ArrayList<WorkExp>(_list135.size);
          WorkExp _elem136;
          for (int _i137 = 0; _i137 < _list135.size; ++_i137)
          {
            _elem136 = new WorkExp();
            _elem136.read(iprot);
            struct.workExps.add(_elem136);
          }
        }
        struct.setWorkExpsIsSet(true);
      }
