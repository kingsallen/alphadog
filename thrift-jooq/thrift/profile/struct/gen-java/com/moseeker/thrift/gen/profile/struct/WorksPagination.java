...
public class WorksPagination implements org.apache.thrift.TBase<WorksPagination, WorksPagination._Fields>, java.io.Serializable, Cloneable, Comparable<WorksPagination> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("WorksPagination");
  ...
  private static final org.apache.thrift.protocol.TField WORKS_FIELD_DESC = new org.apache.thrift.protocol.TField("works", org.apache.thrift.protocol.TType.LIST, (short)5);

  private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
  static {
    schemes.put(StandardScheme.class, new WorksPaginationStandardSchemeFactory());
    schemes.put(TupleScheme.class, new WorksPaginationTupleSchemeFactory());
  }
  ...
  public List<Works> works; // required
  ...
  static {
    ...
    tmpMap.put(_Fields.WORKS, new org.apache.thrift.meta_data.FieldMetaData("works", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
            new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, Works.class))));
    metaDataMap = Collections.unmodifiableMap(tmpMap);
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(WorksPagination.class, metaDataMap);
  }

  public WorksPagination() {
  }
   ...
   */
  public WorksPagination(WorksPagination other) {
    ...
    if (other.isSetWorks()) {
      List<Works> __this__works = new ArrayList<Works>(other.works.size());
      for (Works other_element : other.works) {
        __this__works.add(new Works(other_element));
      }
      this.works = __this__works;
    }
  }

  public WorksPagination deepCopy() {
    return new WorksPagination(this);
  }
  ...
  public WorksPagination setTotal_row(int total_row) {
    this.total_row = total_row;
    setTotal_rowIsSet(true);
    return this;
  }
  ...
  public WorksPagination setTotal_page(int total_page) {
    this.total_page = total_page;
    setTotal_pageIsSet(true);
    return this;
  }
  ...
  public WorksPagination setPage_number(int page_number) {
    this.page_number = page_number;
    setPage_numberIsSet(true);
    return this;
  }
  ...
  public WorksPagination setPage_size(int page_size) {
    this.page_size = page_size;
    setPage_sizeIsSet(true);
    return this;
  }
  ...
  public java.util.Iterator<Works> getWorksIterator() {
    return (this.works == null) ? null : this.works.iterator();
  }

  public void addToWorks(Works elem) {
    if (this.works == null) {
  ...
  public WorksPagination setWorks(List<Works> works) {
    this.works = works;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof WorksPagination)
      return this.equals((WorksPagination)that);
    return false;
  }

  public boolean equals(WorksPagination that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(WorksPagination other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("WorksPagination(");
    boolean first = true;
  ...
  private static class WorksPaginationStandardSchemeFactory implements SchemeFactory {
    public WorksPaginationStandardScheme getScheme() {
      return new WorksPaginationStandardScheme();
    }
  }

  private static class WorksPaginationStandardScheme extends StandardScheme<WorksPagination> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, WorksPagination struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.works = new ArrayList<Works>(_list138.size);
                Works _elem139;
                for (int _i140 = 0; _i140 < _list138.size; ++_i140)
                {
                  _elem139 = new Works();
                  _elem139.read(iprot);
                  struct.works.add(_elem139);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, WorksPagination struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.works != null) {
        oprot.writeFieldBegin(WORKS_FIELD_DESC);
        {
          ...
          for (Works _iter141 : struct.works)
          {
  ...
  private static class WorksPaginationTupleSchemeFactory implements SchemeFactory {
    public WorksPaginationTupleScheme getScheme() {
      return new WorksPaginationTupleScheme();
    }
  }

  private static class WorksPaginationTupleScheme extends TupleScheme<WorksPagination> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, WorksPagination struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetWorks()) {
        {
          ...
          for (Works _iter142 : struct.works)
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, WorksPagination struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(4)) {
        {
          ...
          struct.works = new ArrayList<Works>(_list143.size);
          Works _elem144;
          for (int _i145 = 0; _i145 < _list143.size; ++_i145)
          {
            _elem144 = new Works();
            _elem144.read(iprot);
            struct.works.add(_elem144);
          }
        }
        struct.setWorksIsSet(true);
      }
