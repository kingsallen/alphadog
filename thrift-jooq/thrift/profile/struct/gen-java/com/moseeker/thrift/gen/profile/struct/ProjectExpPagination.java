...
public class ProjectExpPagination implements org.apache.thrift.TBase<ProjectExpPagination, ProjectExpPagination._Fields>, java.io.Serializable, Cloneable, Comparable<ProjectExpPagination> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("ProjectExpPagination");
  ...
  private static final org.apache.thrift.protocol.TField PROJECT_EXPS_FIELD_DESC = new org.apache.thrift.protocol.TField("projectExps", org.apache.thrift.protocol.TType.LIST, (short)5);

  private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
  static {
    schemes.put(StandardScheme.class, new ProjectExpPaginationStandardSchemeFactory());
    schemes.put(TupleScheme.class, new ProjectExpPaginationTupleSchemeFactory());
  }
  ...
  public List<ProjectExp> projectExps; // required
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    PROJECT_EXPS((short)5, "projectExps");
  ...
  static {
    ...
    tmpMap.put(_Fields.PROJECT_EXPS, new org.apache.thrift.meta_data.FieldMetaData("projectExps", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
            new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, ProjectExp.class))));
    metaDataMap = Collections.unmodifiableMap(tmpMap);
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(ProjectExpPagination.class, metaDataMap);
  }

  public ProjectExpPagination() {
  }
   ...
   */
  public ProjectExpPagination(ProjectExpPagination other) {
    ...
    if (other.isSetProjectExps()) {
      List<ProjectExp> __this__projectExps = new ArrayList<ProjectExp>(other.projectExps.size());
      for (ProjectExp other_element : other.projectExps) {
        __this__projectExps.add(new ProjectExp(other_element));
      }
      this.projectExps = __this__projectExps;
    }
  }

  public ProjectExpPagination deepCopy() {
    return new ProjectExpPagination(this);
  }
  ...
  public ProjectExpPagination setTotal_row(int total_row) {
    this.total_row = total_row;
    setTotal_rowIsSet(true);
    return this;
  }
  ...
  public ProjectExpPagination setTotal_page(int total_page) {
    this.total_page = total_page;
    setTotal_pageIsSet(true);
    return this;
  }
  ...
  public ProjectExpPagination setPage_number(int page_number) {
    this.page_number = page_number;
    setPage_numberIsSet(true);
    return this;
  }
  ...
  public ProjectExpPagination setPage_size(int page_size) {
    this.page_size = page_size;
    setPage_sizeIsSet(true);
    return this;
  }
  ...
  public java.util.Iterator<ProjectExp> getProjectExpsIterator() {
    return (this.projectExps == null) ? null : this.projectExps.iterator();
  }

  public void addToProjectExps(ProjectExp elem) {
    if (this.projectExps == null) {
      this.projectExps = new ArrayList<ProjectExp>();
    }
  ...
  public ProjectExpPagination setProjectExps(List<ProjectExp> projectExps) {
    this.projectExps = projectExps;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case PROJECT_EXPS:
      if (value == null) {
        ...
        setProjectExps((List<ProjectExp>)value);
      }
      break;
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof ProjectExpPagination)
      return this.equals((ProjectExpPagination)that);
    return false;
  }

  public boolean equals(ProjectExpPagination that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(ProjectExpPagination other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("ProjectExpPagination(");
    boolean first = true;
  ...
  private static class ProjectExpPaginationStandardSchemeFactory implements SchemeFactory {
    public ProjectExpPaginationStandardScheme getScheme() {
      return new ProjectExpPaginationStandardScheme();
    }
  }

  private static class ProjectExpPaginationStandardScheme extends StandardScheme<ProjectExpPagination> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, ProjectExpPagination struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.projectExps = new ArrayList<ProjectExp>(_list90.size);
                ProjectExp _elem91;
                for (int _i92 = 0; _i92 < _list90.size; ++_i92)
                {
                  _elem91 = new ProjectExp();
                  _elem91.read(iprot);
                  struct.projectExps.add(_elem91);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ProjectExpPagination struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.projectExps != null) {
        oprot.writeFieldBegin(PROJECT_EXPS_FIELD_DESC);
        {
          ...
          for (ProjectExp _iter93 : struct.projectExps)
          {
            _iter93.write(oprot);
          }
          oprot.writeListEnd();
  ...
  private static class ProjectExpPaginationTupleSchemeFactory implements SchemeFactory {
    public ProjectExpPaginationTupleScheme getScheme() {
      return new ProjectExpPaginationTupleScheme();
    }
  }

  private static class ProjectExpPaginationTupleScheme extends TupleScheme<ProjectExpPagination> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, ProjectExpPagination struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetProjectExps()) {
        {
          ...
          for (ProjectExp _iter94 : struct.projectExps)
          {
            _iter94.write(oprot);
          }
        }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, ProjectExpPagination struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(4)) {
        {
          ...
          struct.projectExps = new ArrayList<ProjectExp>(_list95.size);
          ProjectExp _elem96;
          for (int _i97 = 0; _i97 < _list95.size; ++_i97)
          {
            _elem96 = new ProjectExp();
            _elem96.read(iprot);
            struct.projectExps.add(_elem96);
          }
        }
        struct.setProjectExpsIsSet(true);
      }
