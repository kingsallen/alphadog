...
service ProfileServices {
    list<profile_struct.Profile> getResources(1:profile_struct.CommonQuery query);
    profile_struct.ProfilePagination getPagination(1:profile_struct.CommonQuery query);
    ...
    profile_struct.Profile getResource(1:profile_struct.CommonQuery query);
...
service AttachmentServices {
    list<profile_struct.Attachment> getResources(1:profile_struct.CommonQuery query);
    profile_struct.AttachmentPagination getPagination(1:profile_struct.CommonQuery query);
    ...
    profile_struct.Attachment getResource(1:profile_struct.CommonQuery query);
...
service BasicServices {
    list<profile_struct.Basic> getResources(1:profile_struct.CommonQuery query);
    profile_struct.BasicPagination getPagination(1:profile_struct.CommonQuery query);
    ...
    profile_struct.Basic getResource(1:profile_struct.CommonQuery query);
...
service EducationServices {
    list<profile_struct.Education> getResources(1:profile_struct.CommonQuery query);
    profile_struct.EducationPagination getPagination(1:profile_struct.CommonQuery query);
    ...
    profile_struct.Education getResource(1:profile_struct.CommonQuery query);
...
service EducationExtServices {
    list<profile_struct.EducationExt> getResources(1:profile_struct.CommonQuery query);
    profile_struct.EducationExtPagination getPagination(1:profile_struct.CommonQuery query);
    ...
    profile_struct.EducationExt getResource(1:profile_struct.CommonQuery query);
...
service ProfileExtServices {
    list<profile_struct.ProfileExt> getResources(1:profile_struct.CommonQuery query);
    profile_struct.ProfileExtPagination getPagination(1:profile_struct.CommonQuery query);
    ...
    profile_struct.ProfileExt getResource(1:profile_struct.CommonQuery query);
...
service IntentionServices {
    list<profile_struct.Intention> getResources(1:profile_struct.CommonQuery query);
    profile_struct.IntentionPagination getPagination(1:profile_struct.CommonQuery query);
    ...
    profile_struct.Intention getResource(1:profile_struct.CommonQuery query);
...
service InternshipServices {
    list<profile_struct.Internship> getResources(1:profile_struct.CommonQuery query);
    profile_struct.InternshipPagination getPagination(1:profile_struct.CommonQuery query);
    ...
    profile_struct.Internship getResource(1:profile_struct.CommonQuery query);
...
service LanguageServices {
    list<profile_struct.Language> getResources(1:profile_struct.CommonQuery query);
    profile_struct.LanguagePagination getPagination(1:profile_struct.CommonQuery query);
    ...
    profile_struct.Language getResource(1:profile_struct.CommonQuery query);
...
service ProjectExpServices {
    list<profile_struct.ProjectExp> getResources(1:profile_struct.CommonQuery query);
    profile_struct.ProjectExpPagination getPagination(1:profile_struct.CommonQuery query);
    ...
    profile_struct.ProjectExp getResource(1:profile_struct.CommonQuery query);
...
service RewardServices {
    list<profile_struct.Reward> getResources(1:profile_struct.CommonQuery query);
    profile_struct.RewardPagination getPagination(1:profile_struct.CommonQuery query);
    ...
    profile_struct.Reward getResource(1:profile_struct.CommonQuery query);
...
service SchoolJobServices {
    list<profile_struct.SchoolJob> getResources(1:profile_struct.CommonQuery query);
    profile_struct.SchoolJobPagination getPagination(1:profile_struct.CommonQuery query);
    ...
    profile_struct.SchoolJob getResource(1:profile_struct.CommonQuery query);
...
service SkillServices {
    list<profile_struct.Skill> getResources(1:profile_struct.CommonQuery query);
    profile_struct.SkillPagination getPagination(1:profile_struct.CommonQuery query);
    ...
    profile_struct.Skill getResource(1:profile_struct.CommonQuery query);
...
service TrainingServices {
    list<profile_struct.Training> getResources(1:profile_struct.CommonQuery query);
    profile_struct.TrainingPagination getPagination(1:profile_struct.CommonQuery query);
    ...
    profile_struct.Training getResource(1:profile_struct.CommonQuery query);
...
service WorkExpServices {
    list<profile_struct.WorkExp> getResources(1:profile_struct.CommonQuery query);
    profile_struct.WorkExpPagination getPagination(1:profile_struct.CommonQuery query);
    ...
    profile_struct.WorkExp getResource(1:profile_struct.CommonQuery query);
...
service WorksServices {
    list<profile_struct.Works> getResources(1:profile_struct.CommonQuery query);
    profile_struct.WorksPagination getPagination(1:profile_struct.CommonQuery query);
    ...
    profile_struct.Works getResource(1:profile_struct.CommonQuery query);
