...
public class Colleage implements org.apache.thrift.TBase<Colleage, Colleage._Fields>, java.io.Serializable, Cloneable, Comparable<Colleage> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("Colleage");
  ...
  static {
    schemes.put(StandardScheme.class, new ColleageStandardSchemeFactory());
    schemes.put(TupleScheme.class, new ColleageTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(Colleage.class, metaDataMap);
  }
   ...
   */
  public Colleage(Colleage other) {
  ...
  public Colleage deepCopy() {
    return new Colleage(this);
  }
  ...
  public Colleage setCode(int code) {
    this.code = code;
    setCodeIsSet(true);
    return this;
  }
  ...
  public Colleage setName(String name) {
    this.name = name;
    return this;
  }
  ...
  public Colleage setProvince(int province) {
    this.province = province;
    setProvinceIsSet(true);
    return this;
  }
  ...
  public Colleage setLogo(String logo) {
    this.logo = logo;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof Colleage)
      return this.equals((Colleage)that);
    return false;
  }

  public boolean equals(Colleage that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(Colleage other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("Colleage(");
    boolean first = true;
  ...
  private static class ColleageStandardSchemeFactory implements SchemeFactory {
    public ColleageStandardScheme getScheme() {
      return new ColleageStandardScheme();
    }
  }

  private static class ColleageStandardScheme extends StandardScheme<Colleage> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, Colleage struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Colleage struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class ColleageTupleSchemeFactory implements SchemeFactory {
    public ColleageTupleScheme getScheme() {
      return new ColleageTupleScheme();
    }
  }

  private static class ColleageTupleScheme extends TupleScheme<Colleage> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, Colleage struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, Colleage struct) throws org.apache.thrift.TException {
