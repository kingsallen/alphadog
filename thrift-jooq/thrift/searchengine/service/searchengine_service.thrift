...
service SearchengineServices {
    ...
    7:string startTime,8:string endTime,9:i32 companyId,10:i32 teamId,11:i32 motherCompanyId,12:i32 order,13:i32 moduleId);
    ...
    common_struct.Response searchPositionSuggest(1: map<string,string> params);
    common_struct.Response searchProfileSuggest(1: map<string,string> params);
