...
service SearchengineServices {
    ...
    common_struct.Response positionQuery(1: string keyWords,2:string citys,3:string industry,4:string salaryCode,5:i32 page,6:i32 pageSize,7:string startTime,8:string endTime,9:i32 order);
}