...
service TalentpoolServices {
    ...
    common_struct.Response addProfileFilter(1:talentpool_struct.TalentpoolProfileFilterDO companyTagDO, 2:list<talentpool_struct.ActionForm> actionForm,3:list<i32> positionIdList, 4:i32 hr_id, 5:i32 position_total) throws (1: common_struct.BIZException e)
    common_struct.Response updateProfileFilter(1:talentpool_struct.TalentpoolProfileFilterDO companyTagDO, 2:list<talentpool_struct.ActionForm> actionForm,3:list<i32> positionIdList, 4:i32 hr_id, 5:i32 position_total) throws (1: common_struct.BIZException e)
