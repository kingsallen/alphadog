...
public class NewsletterStruct implements org.apache.thrift.TBase<NewsletterStruct, NewsletterStruct._Fields>, java.io.Serializable, Cloneable, Comparable<NewsletterStruct> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("NewsletterStruct");
  ...
  static {
    schemes.put(StandardScheme.class, new NewsletterStructStandardSchemeFactory());
    schemes.put(TupleScheme.class, new NewsletterStructTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(NewsletterStruct.class, metaDataMap);
  }

  public NewsletterStruct() {
  }
   ...
   */
  public NewsletterStruct(NewsletterStruct other) {
  ...
  public NewsletterStruct deepCopy() {
    return new NewsletterStruct(this);
  }
  ...
  public NewsletterStruct setShow_new_version(byte show_new_version) {
    this.show_new_version = show_new_version;
    setShow_new_versionIsSet(true);
    return this;
  }
  ...
  public NewsletterStruct setVersion(String version) {
    this.version = version;
    return this;
  }
  ...
  public NewsletterStruct setUpdate_time(String update_time) {
    this.update_time = update_time;
    return this;
  }
  ...
  public NewsletterStruct setUpdate_list(List<String> update_list) {
    this.update_list = update_list;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof NewsletterStruct)
      return this.equals((NewsletterStruct)that);
    return false;
  }

  public boolean equals(NewsletterStruct that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(NewsletterStruct other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("NewsletterStruct(");
    boolean first = true;
  ...
  private static class NewsletterStructStandardSchemeFactory implements SchemeFactory {
    public NewsletterStructStandardScheme getScheme() {
      return new NewsletterStructStandardScheme();
    }
  }

  private static class NewsletterStructStandardScheme extends StandardScheme<NewsletterStruct> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, NewsletterStruct struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, NewsletterStruct struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class NewsletterStructTupleSchemeFactory implements SchemeFactory {
    public NewsletterStructTupleScheme getScheme() {
      return new NewsletterStructTupleScheme();
    }
  }

  private static class NewsletterStructTupleScheme extends TupleScheme<NewsletterStruct> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, NewsletterStruct struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, NewsletterStruct struct) throws org.apache.thrift.TException {
