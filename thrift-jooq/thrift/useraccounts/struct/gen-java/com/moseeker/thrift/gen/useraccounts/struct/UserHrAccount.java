...
public class UserHrAccount implements org.apache.thrift.TBase<UserHrAccount, UserHrAccount._Fields>, java.io.Serializable, Cloneable, Comparable<UserHrAccount> {
  ...
  public int hashCode() {
    ...
    boolean present_wxuser_id = true && (isSetWxuser_id());
    ...
    boolean present_account_type = true && (isSetAccount_type());
    list.add(present_account_type);
    if (present_account_type)
      list.add(account_type);

    boolean present_activation = true && (isSetActivation());
    ...
    boolean present_login_count = true && (isSetLogin_count());
