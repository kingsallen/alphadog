...
service UserHrAccountService {
    ...
    //新员工列表
    useraccounts_struct.UserEmployeeVOPageVO getEmployees(1:string keyword, 2:i32 companyId, 3:i32 filter, 4:string order, 5:string asc, 6:i32 pageNumber, 7:i32 pageSize,8:string email_validate) throws (1: common_struct.BIZException e);
    // 员工信息导出
