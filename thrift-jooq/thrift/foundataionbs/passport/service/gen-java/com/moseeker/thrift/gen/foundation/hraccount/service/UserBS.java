...
public class UserBS {
  ...
  public interface AsyncIface {
    ...
    public void isHaveProfile(int userId, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public static class isHaveProfile_call extends org.apache.thrift.async.TAsyncMethodCall {
      private int userId;
      public isHaveProfile_call(int userId, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class isHaveProfile<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, isHaveProfile_args, Boolean> {
      public isHaveProfile() {
        super("isHaveProfile");
      }
      ...
      public void start(I iface, isHaveProfile_args args, org.apache.thrift.async.AsyncMethodCallback<Boolean> resultHandler) throws TException {
  ...
  public static class isHaveProfile_args implements org.apache.thrift.TBase<isHaveProfile_args, isHaveProfile_args._Fields>, java.io.Serializable, Cloneable, Comparable<isHaveProfile_args>   {
    ...
    static {
      schemes.put(StandardScheme.class, new isHaveProfile_argsStandardSchemeFactory());
      schemes.put(TupleScheme.class, new isHaveProfile_argsTupleSchemeFactory());
    }
    ...
    public String toString() {
      StringBuilder sb = new StringBuilder("isHaveProfile_args(");
      boolean first = true;
    ...
    private static class isHaveProfile_argsStandardSchemeFactory implements SchemeFactory {
      public isHaveProfile_argsStandardScheme getScheme() {
        return new isHaveProfile_argsStandardScheme();
      }
    }

    private static class isHaveProfile_argsStandardScheme extends StandardScheme<isHaveProfile_args> {
    ...
    private static class isHaveProfile_argsTupleSchemeFactory implements SchemeFactory {
      public isHaveProfile_argsTupleScheme getScheme() {
        return new isHaveProfile_argsTupleScheme();
      }
    }

    private static class isHaveProfile_argsTupleScheme extends TupleScheme<isHaveProfile_args> {
  ...
  public static class isHaveProfile_result implements org.apache.thrift.TBase<isHaveProfile_result, isHaveProfile_result._Fields>, java.io.Serializable, Cloneable, Comparable<isHaveProfile_result>   {
    ...
    private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
    static {
      schemes.put(StandardScheme.class, new isHaveProfile_resultStandardSchemeFactory());
      schemes.put(TupleScheme.class, new isHaveProfile_resultTupleSchemeFactory());
    }
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("isHaveProfile_result(");
      boolean first = true;
    ...
    private static class isHaveProfile_resultStandardSchemeFactory implements SchemeFactory {
      public isHaveProfile_resultStandardScheme getScheme() {
        return new isHaveProfile_resultStandardScheme();
      }
    }

    private static class isHaveProfile_resultStandardScheme extends StandardScheme<isHaveProfile_result> {
    ...
    private static class isHaveProfile_resultTupleSchemeFactory implements SchemeFactory {
      public isHaveProfile_resultTupleScheme getScheme() {
        return new isHaveProfile_resultTupleScheme();
      }
    }

    private static class isHaveProfile_resultTupleScheme extends TupleScheme<isHaveProfile_result> {
