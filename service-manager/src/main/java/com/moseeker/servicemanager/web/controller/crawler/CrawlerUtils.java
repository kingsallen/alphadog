...
public class CrawlerUtils {
	...
	public String fetchFirstResume(String userName, String password, int type, int userId) {
		String result = null;
		switch(type) {
		...
		return cleanning(result, userId);
	}

	@SuppressWarnings("unchecked")
	private String cleanning(String result, int userId) {
	...
	public static void main(String[] args) {
		...
		System.out.println(crawlerUtils.cleanning(profile, 1));
	...
	public void MessageBeanTest() {
		System.out.println(cleanning("", 0));
	}
}
