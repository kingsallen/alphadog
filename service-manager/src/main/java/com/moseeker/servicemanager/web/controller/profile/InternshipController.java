...
public class InternshipController {
	...
	public String get(HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			...
			Response result = internshipService.getResources(query);
	...
	public String post(HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			...
			Response result = internshipService.postResource(education);
	...
	public String put(HttpServletRequest request, HttpServletResponse response) {
		try {
			...
			Response result = internshipService.putResource(internship);
	...
	public String delete(HttpServletRequest request, HttpServletResponse response) {
		try {
			Internship internship = ParamUtils.initModelForm(request, Internship.class);
			Response result = internshipService.delResource(internship);
