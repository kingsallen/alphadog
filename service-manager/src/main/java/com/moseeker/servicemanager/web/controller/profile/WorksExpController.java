...
public class WorksExpController {
	...
	public String get(HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			...
			ProviderResult result = worksService.getResources(query);
	...
	public String post(HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			...
			ProviderResult result = worksService.postResource(works);
			jsonStringResponse = JSON.toJSONString(result);
	...
	public String put(HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			Works works = ParamUtils.initModelForm(request, Works.class);
			ProviderResult result = worksService.putResource(works);
			jsonStringResponse = JSON.toJSONString(result);
	...
	public String delete(HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			Works works = ParamUtils.initModelForm(request, Works.class);
			ProviderResult result = worksService.delResource(works);
			jsonStringResponse = JSON.toJSONString(result);
