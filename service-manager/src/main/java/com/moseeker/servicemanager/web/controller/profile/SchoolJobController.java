...
public class SchoolJobController {
	...
	public String get(HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			...
			Response result = schoolJobService.getResources(query);
	...
	public String post(HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			...
			Response result = schoolJobService.postResource(schoolJob);
	...
	public String put(HttpServletRequest request, HttpServletResponse response) {
		try {
			SchoolJob schoolJob = ParamUtils.initModelForm(request, SchoolJob.class);
			Response result = schoolJobService.putResource(schoolJob);
	...
	public String delete(HttpServletRequest request, HttpServletResponse response) {
		try {
			SchoolJob schoolJob = ParamUtils.initModelForm(request, SchoolJob.class);
			Response result = schoolJobService.delResource(schoolJob);
