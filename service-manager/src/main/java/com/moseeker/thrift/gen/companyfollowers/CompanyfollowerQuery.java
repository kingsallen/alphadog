...
public class CompanyfollowerQuery implements org.apache.thrift.TBase<CompanyfollowerQuery, CompanyfollowerQuery._Fields>, java.io.Serializable, Cloneable, Comparable<CompanyfollowerQuery>, CommonQuery<CompanyfollowerQuery> {
  ...
  static {
    schemes.put(StandardScheme.class, new CompanyfollowerQueryStandardSchemeFactory());
    schemes.put(TupleScheme.class, new CompanyfollowerQueryTupleSchemeFactory());
  }
