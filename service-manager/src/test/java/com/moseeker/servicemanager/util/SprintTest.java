...
public class SprintTest {
	...
	public void initCommonQueryTest() {
		MockHttpServletRequest request = new MockHttpServletRequest("GET", "/main.app?appid=1&limit=10&offset=2&page=1&per_page=10&sortby=id&fields=id&fields=name&nocache=1");  
		String[] appid = {"1"};
		String[] limit = {"10"};
		String[] offset = {"2"};
		String[] page = {"1"};
