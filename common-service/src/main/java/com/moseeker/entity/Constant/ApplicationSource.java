...
public enum ApplicationSource {
    ...
    EMPLOYEE_REFERRAL(65536,10000000000000000l),SEEK_REFERRAL(131062,100000000000000000l),INVITE_REFERRAL(262124,1000000000000000000l),
    FORWARD_APPLICATION(524228, 2^19);
