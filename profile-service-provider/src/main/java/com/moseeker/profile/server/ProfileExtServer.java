...
import com.moseeker.profile.service.impl.ProfileExtServicesImpl;
 ...
 * @version Beta
 */
public class ProfileExtServer {
	
	private static Logger LOGGER = LoggerFactory.getLogger(ProfileExtServer.class);
