...
public class InternshipPagination implements org.apache.thrift.TBase<InternshipPagination, InternshipPagination._Fields>, java.io.Serializable, Cloneable, Comparable<InternshipPagination> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("InternshipPagination");
  ...
  private static final org.apache.thrift.protocol.TField INTERNSHIPS_FIELD_DESC = new org.apache.thrift.protocol.TField("internships", org.apache.thrift.protocol.TType.LIST, (short)5);

  private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
  static {
    schemes.put(StandardScheme.class, new InternshipPaginationStandardSchemeFactory());
    schemes.put(TupleScheme.class, new InternshipPaginationTupleSchemeFactory());
  }
  ...
  public List<Internship> internships; // required
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    INTERNSHIPS((short)5, "internships");
  ...
  static {
    ...
    tmpMap.put(_Fields.INTERNSHIPS, new org.apache.thrift.meta_data.FieldMetaData("internships", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
            new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, Internship.class))));
    metaDataMap = Collections.unmodifiableMap(tmpMap);
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(InternshipPagination.class, metaDataMap);
  }

  public InternshipPagination() {
  }
   ...
   */
  public InternshipPagination(InternshipPagination other) {
    ...
    if (other.isSetInternships()) {
      List<Internship> __this__internships = new ArrayList<Internship>(other.internships.size());
      for (Internship other_element : other.internships) {
        __this__internships.add(new Internship(other_element));
      }
      this.internships = __this__internships;
    }
  }

  public InternshipPagination deepCopy() {
    return new InternshipPagination(this);
  }
  ...
  public InternshipPagination setTotal_row(int total_row) {
    this.total_row = total_row;
    setTotal_rowIsSet(true);
    return this;
  }
  ...
  public InternshipPagination setTotal_page(int total_page) {
    this.total_page = total_page;
    setTotal_pageIsSet(true);
    return this;
  }
  ...
  public InternshipPagination setPage_number(int page_number) {
    this.page_number = page_number;
    setPage_numberIsSet(true);
    return this;
  }
  ...
  public InternshipPagination setPage_size(int page_size) {
    this.page_size = page_size;
    setPage_sizeIsSet(true);
    return this;
  }
  ...
  public java.util.Iterator<Internship> getInternshipsIterator() {
    return (this.internships == null) ? null : this.internships.iterator();
  }

  public void addToInternships(Internship elem) {
  ...
  public InternshipPagination setInternships(List<Internship> internships) {
    this.internships = internships;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case INTERNSHIPS:
      if (value == null) {
        ...
        setInternships((List<Internship>)value);
      }
      break;
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof InternshipPagination)
      return this.equals((InternshipPagination)that);
    return false;
  }

  public boolean equals(InternshipPagination that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(InternshipPagination other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("InternshipPagination(");
    boolean first = true;
  ...
  private static class InternshipPaginationStandardSchemeFactory implements SchemeFactory {
    public InternshipPaginationStandardScheme getScheme() {
      return new InternshipPaginationStandardScheme();
    }
  }

  private static class InternshipPaginationStandardScheme extends StandardScheme<InternshipPagination> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, InternshipPagination struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.internships = new ArrayList<Internship>(_list74.size);
                Internship _elem75;
                for (int _i76 = 0; _i76 < _list74.size; ++_i76)
                {
                  _elem75 = new Internship();
                  _elem75.read(iprot);
                  struct.internships.add(_elem75);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, InternshipPagination struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.internships != null) {
        oprot.writeFieldBegin(INTERNSHIPS_FIELD_DESC);
        {
          ...
          for (Internship _iter77 : struct.internships)
          {
            _iter77.write(oprot);
          }
          oprot.writeListEnd();
  ...
  private static class InternshipPaginationTupleSchemeFactory implements SchemeFactory {
    public InternshipPaginationTupleScheme getScheme() {
      return new InternshipPaginationTupleScheme();
    }
  }

  private static class InternshipPaginationTupleScheme extends TupleScheme<InternshipPagination> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, InternshipPagination struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetInternships()) {
        {
          ...
          for (Internship _iter78 : struct.internships)
          {
            _iter78.write(oprot);
          }
        }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, InternshipPagination struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(4)) {
        {
          ...
          struct.internships = new ArrayList<Internship>(_list79.size);
          Internship _elem80;
          for (int _i81 = 0; _i81 < _list79.size; ++_i81)
          {
            _elem80 = new Internship();
            _elem80.read(iprot);
            struct.internships.add(_elem80);
          }
        }
        struct.setInternshipsIsSet(true);
      }
