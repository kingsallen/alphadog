...
public class EducationPagination implements org.apache.thrift.TBase<EducationPagination, EducationPagination._Fields>, java.io.Serializable, Cloneable, Comparable<EducationPagination> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("EducationPagination");
  ...
  private static final org.apache.thrift.protocol.TField EDUCATIONS_FIELD_DESC = new org.apache.thrift.protocol.TField("educations", org.apache.thrift.protocol.TType.LIST, (short)5);

  private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
  static {
    schemes.put(StandardScheme.class, new EducationPaginationStandardSchemeFactory());
    schemes.put(TupleScheme.class, new EducationPaginationTupleSchemeFactory());
  }
  ...
  public List<Education> educations; // required
  ...
  static {
    ...
    tmpMap.put(_Fields.EDUCATIONS, new org.apache.thrift.meta_data.FieldMetaData("educations", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
            new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, Education.class))));
    metaDataMap = Collections.unmodifiableMap(tmpMap);
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(EducationPagination.class, metaDataMap);
  }

  public EducationPagination() {
  }
   ...
   */
  public EducationPagination(EducationPagination other) {
    ...
    if (other.isSetEducations()) {
      List<Education> __this__educations = new ArrayList<Education>(other.educations.size());
      for (Education other_element : other.educations) {
        __this__educations.add(new Education(other_element));
      }
      this.educations = __this__educations;
    }
  }

  public EducationPagination deepCopy() {
    return new EducationPagination(this);
  }
  ...
  public EducationPagination setTotal_row(int total_row) {
    this.total_row = total_row;
    setTotal_rowIsSet(true);
    return this;
  }
  ...
  public EducationPagination setTotal_page(int total_page) {
    this.total_page = total_page;
    setTotal_pageIsSet(true);
    return this;
  }
  ...
  public EducationPagination setPage_number(int page_number) {
    this.page_number = page_number;
    setPage_numberIsSet(true);
    return this;
  }
  ...
  public EducationPagination setPage_size(int page_size) {
    this.page_size = page_size;
    setPage_sizeIsSet(true);
    return this;
  }
  ...
  public java.util.Iterator<Education> getEducationsIterator() {
    return (this.educations == null) ? null : this.educations.iterator();
  }

  public void addToEducations(Education elem) {
  ...
  public EducationPagination setEducations(List<Education> educations) {
    this.educations = educations;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case EDUCATIONS:
      if (value == null) {
        ...
        setEducations((List<Education>)value);
      }
      break;
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof EducationPagination)
      return this.equals((EducationPagination)that);
    return false;
  }

  public boolean equals(EducationPagination that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(EducationPagination other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("EducationPagination(");
    boolean first = true;
  ...
  private static class EducationPaginationStandardSchemeFactory implements SchemeFactory {
    public EducationPaginationStandardScheme getScheme() {
      return new EducationPaginationStandardScheme();
    }
  }

  private static class EducationPaginationStandardScheme extends StandardScheme<EducationPagination> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, EducationPagination struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.educations = new ArrayList<Education>(_list34.size);
                Education _elem35;
                for (int _i36 = 0; _i36 < _list34.size; ++_i36)
                {
                  _elem35 = new Education();
                  _elem35.read(iprot);
                  struct.educations.add(_elem35);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, EducationPagination struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.educations != null) {
        oprot.writeFieldBegin(EDUCATIONS_FIELD_DESC);
        {
          ...
          for (Education _iter37 : struct.educations)
          {
            _iter37.write(oprot);
          }
          oprot.writeListEnd();
  ...
  private static class EducationPaginationTupleSchemeFactory implements SchemeFactory {
    public EducationPaginationTupleScheme getScheme() {
      return new EducationPaginationTupleScheme();
    }
  }

  private static class EducationPaginationTupleScheme extends TupleScheme<EducationPagination> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, EducationPagination struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetEducations()) {
        {
          ...
          for (Education _iter38 : struct.educations)
          {
            _iter38.write(oprot);
          }
        }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, EducationPagination struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(4)) {
        {
          ...
          struct.educations = new ArrayList<Education>(_list39.size);
          Education _elem40;
          for (int _i41 = 0; _i41 < _list39.size; ++_i41)
          {
            _elem40 = new Education();
            _elem40.read(iprot);
            struct.educations.add(_elem40);
          }
        }
        struct.setEducationsIsSet(true);
      }
