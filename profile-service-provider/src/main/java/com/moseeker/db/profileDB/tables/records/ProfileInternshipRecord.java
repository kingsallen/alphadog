...
public class ProfileInternshipRecord extends UpdatableRecordImpl<ProfileInternshipRecord> implements Record12<UInteger, UInteger, Date, Date, Byte, String, String, Byte, Byte, String, Timestamp, Timestamp> {
	...
	private static final long serialVersionUID = -1621946127;

	/**
	 * Setter for <code>profileDB.profile_internship.id</code>. 主key
	 */
	...
	/**
	 * Getter for <code>profileDB.profile_internship.id</code>. 主key
	 */
	...
	/**
	 * Setter for <code>profileDB.profile_internship.profile_id</code>. profile.id
	 */
	...
	/**
	 * Getter for <code>profileDB.profile_internship.profile_id</code>. profile.id
	 */
	...
	/**
	 * Setter for <code>profileDB.profile_internship.start</code>. 起止时间-起 yyyy-mm-dd
	 */
	...
	/**
	 * Getter for <code>profileDB.profile_internship.start</code>. 起止时间-起 yyyy-mm-dd
	 */
	...
	/**
	 * Setter for <code>profileDB.profile_internship.end</code>. 起止时间-止 yyyy-mm-dd
	 */
	...
	/**
	 * Getter for <code>profileDB.profile_internship.end</code>. 起止时间-止 yyyy-mm-dd
	 */
	public Date getEnd() {
	...
	/**
	 * Setter for <code>profileDB.profile_internship.end_until_now</code>. 是否至今 0：否 1：是
	 */
	...
	/**
	 * Getter for <code>profileDB.profile_internship.end_until_now</code>. 是否至今 0：否 1：是
	 */
	...
	/**
	 * Setter for <code>profileDB.profile_internship.company</code>. 公司名称
	 */
	...
	/**
	 * Getter for <code>profileDB.profile_internship.company</code>. 公司名称
	 */
	...
	/**
	 * Setter for <code>profileDB.profile_internship.department</code>. 部门名称
	 */
	...
	/**
	 * Getter for <code>profileDB.profile_internship.department</code>. 部门名称
	 */
	...
	/**
	 * Setter for <code>profileDB.profile_internship.position_code</code>. 职位字典编码
	 */
	...
	/**
	 * Getter for <code>profileDB.profile_internship.position_code</code>. 职位字典编码
	 */
	...
	/**
	 * Setter for <code>profileDB.profile_internship.position_name</code>. 职位名称
	 */
	...
	/**
	 * Getter for <code>profileDB.profile_internship.position_name</code>. 职位名称
	 */
	...
	/**
	 * Setter for <code>profileDB.profile_internship.description</code>. 工作描述
	 */
	...
	/**
	 * Getter for <code>profileDB.profile_internship.description</code>. 工作描述
	 */
	...
	/**
	 * Setter for <code>profileDB.profile_internship.create_time</code>. 创建时间
	 */
	...
	/**
	 * Getter for <code>profileDB.profile_internship.create_time</code>. 创建时间
	 */
	...
	/**
	 * Setter for <code>profileDB.profile_internship.update_time</code>. 更新时间
	 */
	...
	/**
	 * Getter for <code>profileDB.profile_internship.update_time</code>. 更新时间
	 */
