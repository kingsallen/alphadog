...
public class HrHtml5UniqueStatistics extends TableImpl<HrHtml5UniqueStatisticsRecord> {
	...
	private static final long serialVersionUID = 972696736;

	/**
	 * The reference instance of <code>dqv4.hr_html5_unique_statistics</code>
	 */
	...
	/**
	 * The column <code>dqv4.hr_html5_unique_statistics.id</code>. primary key
	 */
	...
	/**
	 * The column <code>dqv4.hr_html5_unique_statistics.topic_id</code>. wx_topic.id
	 */
	public final TableField<HrHtml5UniqueStatisticsRecord, Integer> TOPIC_ID = createField("topic_id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaulted(true), this, "wx_topic.id");

	/**
	 * The column <code>dqv4.hr_html5_unique_statistics.company_id</code>. company.id
	 */
	...
	/**
	 * The column <code>dqv4.hr_html5_unique_statistics.view_num_uv</code>. 浏览人数
	 */
	public final TableField<HrHtml5UniqueStatisticsRecord, Integer> VIEW_NUM_UV = createField("view_num_uv", org.jooq.impl.SQLDataType.INTEGER.defaulted(true), this, "浏览人数");

	/**
	 * The column <code>dqv4.hr_html5_unique_statistics.recom_view_num_uv</code>. 推荐浏览人数
	 */
	public final TableField<HrHtml5UniqueStatisticsRecord, Integer> RECOM_VIEW_NUM_UV = createField("recom_view_num_uv", org.jooq.impl.SQLDataType.INTEGER.defaulted(true), this, "推荐浏览人数");

	/**
	 * The column <code>dqv4.hr_html5_unique_statistics.create_date</code>. 创建日期
	 */
	...
	/**
	 * The column <code>dqv4.hr_html5_unique_statistics.info_type</code>. 0: 日数据，1：周数据，2：月数据
	 */
	public final TableField<HrHtml5UniqueStatisticsRecord, Integer> INFO_TYPE = createField("info_type", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaulted(true), this, "0: 日数据，1：周数据，2：月数据");

	/**
	 * Create a <code>dqv4.hr_html5_unique_statistics</code> table reference
	 */
	...
	/**
	 * Create an aliased <code>dqv4.hr_html5_unique_statistics</code> table reference
	 */
	...
	private HrHtml5UniqueStatistics(String alias, Table<HrHtml5UniqueStatisticsRecord> aliased, Field<?>[] parameters) {
		super(alias, Dqv4.DQV4, aliased, parameters, "专题传播统计去重信息表");
	}
