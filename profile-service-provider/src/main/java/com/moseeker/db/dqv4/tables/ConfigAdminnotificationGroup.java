...
public class ConfigAdminnotificationGroup extends TableImpl<ConfigAdminnotificationGroupRecord> {
	...
	private static final long serialVersionUID = -1702025011;

	/**
	 * The reference instance of <code>dqv4.config_adminnotification_group</code>
	 */
	...
	/**
	 * The column <code>dqv4.config_adminnotification_group.id</code>.
	 */
	...
	/**
	 * The column <code>dqv4.config_adminnotification_group.name</code>. 群组名称
	 */
	...
	/**
	 * The column <code>dqv4.config_adminnotification_group.create_time</code>.
	 */
	...
	/**
	 * Create a <code>dqv4.config_adminnotification_group</code> table reference
	 */
	...
	/**
	 * Create an aliased <code>dqv4.config_adminnotification_group</code> table reference
	 */
	...
	private ConfigAdminnotificationGroup(String alias, Table<ConfigAdminnotificationGroupRecord> aliased, Field<?>[] parameters) {
		super(alias, Dqv4.DQV4, aliased, parameters, "管理员通知群组");
	}
