...
public class ConfigSysTheme extends TableImpl<ConfigSysThemeRecord> {
	...
	private static final long serialVersionUID = -1917674512;

	/**
	 * The reference instance of <code>dqv4.config_sys_theme</code>
	 */
	...
	/**
	 * The column <code>dqv4.config_sys_theme.id</code>.
	 */
	...
	/**
	 * The column <code>dqv4.config_sys_theme.background_color</code>. 背景色
	 */
	...
	/**
	 * The column <code>dqv4.config_sys_theme.title_color</code>. 标题
	 */
	...
	/**
	 * The column <code>dqv4.config_sys_theme.button_color</code>. 按钮
	 */
	...
	/**
	 * The column <code>dqv4.config_sys_theme.other_color</code>. other
	 */
	...
	/**
	 * The column <code>dqv4.config_sys_theme.free</code>. 是否免费 0：免费 1：收费，只能在大岂后台操作收费主题
	 */
	...
	/**
	 * The column <code>dqv4.config_sys_theme.prority</code>. 排序优先级
	 */
	...
	/**
	 * The column <code>dqv4.config_sys_theme.disable</code>. 是否禁用 0：可用1：不可用
	 */
	...
	/**
	 * The column <code>dqv4.config_sys_theme.create_time</code>.
	 */
	...
	/**
	 * The column <code>dqv4.config_sys_theme.update_time</code>.
	 */
	...
	/**
	 * Create a <code>dqv4.config_sys_theme</code> table reference
	 */
	...
	/**
	 * Create an aliased <code>dqv4.config_sys_theme</code> table reference
	 */
	...
	private ConfigSysTheme(String alias, Table<ConfigSysThemeRecord> aliased, Field<?>[] parameters) {
		super(alias, Dqv4.DQV4, aliased, parameters, "部门主题表");
	}
