...
public class HrRuleUniqueStatisticsRecord extends UpdatableRecordImpl<HrRuleUniqueStatisticsRecord> implements Record8<Integer, Integer, String, Integer, Integer, Integer, Date, Integer> {
	...
	private static final long serialVersionUID = 1982344490;

	/**
	 * Setter for <code>dqv4.hr_rule_unique_statistics.id</code>. primary key
	 */
	...
	/**
	 * Getter for <code>dqv4.hr_rule_unique_statistics.id</code>. primary key
	 */
	...
	/**
	 * Setter for <code>dqv4.hr_rule_unique_statistics.wxrule_id</code>. wx_rule.id
	 */
	...
	/**
	 * Getter for <code>dqv4.hr_rule_unique_statistics.wxrule_id</code>. wx_rule.id
	 */
	...
	/**
	 * Setter for <code>dqv4.hr_rule_unique_statistics.menu_name</code>. 菜单名称
	 */
	...
	/**
	 * Getter for <code>dqv4.hr_rule_unique_statistics.menu_name</code>. 菜单名称
	 */
	...
	/**
	 * Setter for <code>dqv4.hr_rule_unique_statistics.type</code>. 0: wx_rule, 1: menu
	 */
	...
	/**
	 * Getter for <code>dqv4.hr_rule_unique_statistics.type</code>. 0: wx_rule, 1: menu
	 */
	...
	/**
	 * Setter for <code>dqv4.hr_rule_unique_statistics.company_id</code>. company.id
	 */
	...
	/**
	 * Getter for <code>dqv4.hr_rule_unique_statistics.company_id</code>. company.id
	 */
	...
	/**
	 * Setter for <code>dqv4.hr_rule_unique_statistics.view_num_uv</code>. 浏览人数
	 */
	...
	/**
	 * Getter for <code>dqv4.hr_rule_unique_statistics.view_num_uv</code>. 浏览人数
	 */
	...
	/**
	 * Setter for <code>dqv4.hr_rule_unique_statistics.create_date</code>. 创建日期
	 */
	...
	/**
	 * Getter for <code>dqv4.hr_rule_unique_statistics.create_date</code>. 创建日期
	 */
	...
	/**
	 * Setter for <code>dqv4.hr_rule_unique_statistics.info_type</code>. 0: 日数据，1：周数据，2：月数据
	 */
	...
	/**
	 * Getter for <code>dqv4.hr_rule_unique_statistics.info_type</code>. 0: 日数据，1：周数据，2：月数据
	 */
