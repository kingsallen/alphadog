...
public class HrHtml5UniqueStatisticsRecord extends UpdatableRecordImpl<HrHtml5UniqueStatisticsRecord> implements Record7<Integer, Integer, Integer, Integer, Integer, Date, Integer> {
	...
	private static final long serialVersionUID = 1055989659;

	/**
	 * Setter for <code>dqv4.hr_html5_unique_statistics.id</code>. primary key
	 */
	...
	/**
	 * Getter for <code>dqv4.hr_html5_unique_statistics.id</code>. primary key
	 */
	...
	/**
	 * Setter for <code>dqv4.hr_html5_unique_statistics.topic_id</code>. wx_topic.id
	 */
	...
	/**
	 * Getter for <code>dqv4.hr_html5_unique_statistics.topic_id</code>. wx_topic.id
	 */
	...
	/**
	 * Setter for <code>dqv4.hr_html5_unique_statistics.company_id</code>. company.id
	 */
	...
	/**
	 * Getter for <code>dqv4.hr_html5_unique_statistics.company_id</code>. company.id
	 */
	...
	/**
	 * Setter for <code>dqv4.hr_html5_unique_statistics.view_num_uv</code>. 浏览人数
	 */
	...
	/**
	 * Getter for <code>dqv4.hr_html5_unique_statistics.view_num_uv</code>. 浏览人数
	 */
	...
	/**
	 * Setter for <code>dqv4.hr_html5_unique_statistics.recom_view_num_uv</code>. 推荐浏览人数
	 */
	...
	/**
	 * Getter for <code>dqv4.hr_html5_unique_statistics.recom_view_num_uv</code>. 推荐浏览人数
	 */
	...
	/**
	 * Setter for <code>dqv4.hr_html5_unique_statistics.create_date</code>. 创建日期
	 */
	...
	/**
	 * Getter for <code>dqv4.hr_html5_unique_statistics.create_date</code>. 创建日期
	 */
	...
	/**
	 * Setter for <code>dqv4.hr_html5_unique_statistics.info_type</code>. 0: 日数据，1：周数据，2：月数据
	 */
	...
	/**
	 * Getter for <code>dqv4.hr_html5_unique_statistics.info_type</code>. 0: 日数据，1：周数据，2：月数据
	 */
	...
	public HrHtml5UniqueStatisticsRecord(Integer id, Integer topicId, Integer companyId, Integer viewNumUv, Integer recomViewNumUv, Date createDate, Integer infoType) {
		...
		setValue(3, viewNumUv);
		setValue(4, recomViewNumUv);
