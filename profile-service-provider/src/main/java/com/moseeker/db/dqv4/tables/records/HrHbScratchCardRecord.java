...
public class HrHbScratchCardRecord extends UpdatableRecordImpl<HrHbScratchCardRecord> implements Record10<Integer, Integer, String, Integer, BigDecimal, Integer, String, Timestamp, Integer, Byte> {
	...
	private static final long serialVersionUID = 1433645482;

	/**
	 * Setter for <code>dqv4.hr_hb_scratch_card.id</code>.
	 */
	...
	/**
	 * Getter for <code>dqv4.hr_hb_scratch_card.id</code>.
	 */
	...
	/**
	 * Setter for <code>dqv4.hr_hb_scratch_card.wechat_id</code>.
	 */
	...
	/**
	 * Getter for <code>dqv4.hr_hb_scratch_card.wechat_id</code>.
	 */
	...
	/**
	 * Setter for <code>dqv4.hr_hb_scratch_card.cardno</code>. 随机字符串
	 */
	...
	/**
	 * Getter for <code>dqv4.hr_hb_scratch_card.cardno</code>. 随机字符串
	 */
	...
	/**
	 * Setter for <code>dqv4.hr_hb_scratch_card.status</code>. 状态: 0：未拆开 1：已拆开
	 */
	...
	/**
	 * Getter for <code>dqv4.hr_hb_scratch_card.status</code>. 状态: 0：未拆开 1：已拆开
	 */
	...
	/**
	 * Setter for <code>dqv4.hr_hb_scratch_card.amount</code>. 红包金额： 0.00 表示不发红包
	 */
	...
	/**
	 * Getter for <code>dqv4.hr_hb_scratch_card.amount</code>. 红包金额： 0.00 表示不发红包
	 */
	...
	/**
	 * Setter for <code>dqv4.hr_hb_scratch_card.hb_config_id</code>.
	 */
	...
	/**
	 * Getter for <code>dqv4.hr_hb_scratch_card.hb_config_id</code>.
	 */
	...
	/**
	 * Setter for <code>dqv4.hr_hb_scratch_card.bagging_openid</code>. 聚合号的 openid
	 */
	...
	/**
	 * Getter for <code>dqv4.hr_hb_scratch_card.bagging_openid</code>. 聚合号的 openid
	 */
	...
	/**
	 * Setter for <code>dqv4.hr_hb_scratch_card.create_time</code>.
	 */
	...
	/**
	 * Getter for <code>dqv4.hr_hb_scratch_card.create_time</code>.
	 */
	...
	/**
	 * Setter for <code>dqv4.hr_hb_scratch_card.hb_item_id</code>.
	 */
	...
	/**
	 * Getter for <code>dqv4.hr_hb_scratch_card.hb_item_id</code>.
	 */
	...
	/**
	 * Setter for <code>dqv4.hr_hb_scratch_card.tips</code>. 是否是小费 0:不是，1:是
	 */
	...
	/**
	 * Getter for <code>dqv4.hr_hb_scratch_card.tips</code>. 是否是小费 0:不是，1:是
	 */
	public Byte getTips() {
	...
	public HrHbScratchCardRecord(Integer id, Integer wechatId, String cardno, Integer status, BigDecimal amount, Integer hbConfigId, String baggingOpenid, Timestamp createTime, Integer hbItemId, Byte tips) {
		...
		setValue(3, status);
		setValue(4, amount);
		setValue(5, hbConfigId);
		setValue(6, baggingOpenid);
