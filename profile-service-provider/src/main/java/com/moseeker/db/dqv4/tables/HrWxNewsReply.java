...
public class HrWxNewsReply extends TableImpl<HrWxNewsReplyRecord> {
	...
	private static final long serialVersionUID = -145825370;

	/**
	 * The reference instance of <code>dqv4.hr_wx_news_reply</code>
	 */
	...
	/**
	 * The column <code>dqv4.hr_wx_news_reply.id</code>.
	 */
	...
	/**
	 * The column <code>dqv4.hr_wx_news_reply.rid</code>.
	 */
	...
	/**
	 * The column <code>dqv4.hr_wx_news_reply.parentid</code>.
	 */
	...
	/**
	 * The column <code>dqv4.hr_wx_news_reply.title</code>.
	 */
	...
	/**
	 * The column <code>dqv4.hr_wx_news_reply.description</code>.
	 */
	...
	/**
	 * The column <code>dqv4.hr_wx_news_reply.thumb</code>.
	 */
	...
	/**
	 * The column <code>dqv4.hr_wx_news_reply.content</code>.
	 */
	...
	/**
	 * The column <code>dqv4.hr_wx_news_reply.url</code>.
	 */
	...
	/**
	 * Create a <code>dqv4.hr_wx_news_reply</code> table reference
	 */
	...
	/**
	 * Create an aliased <code>dqv4.hr_wx_news_reply</code> table reference
	 */
	...
	private HrWxNewsReply(String alias, Table<HrWxNewsReplyRecord> aliased, Field<?>[] parameters) {
		super(alias, Dqv4.DQV4, aliased, parameters, "微信图文回复表");
	}
