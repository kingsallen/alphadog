...
public class CandidateDepartment extends TableImpl<CandidateDepartmentRecord> {
	...
	private static final long serialVersionUID = 382221477;

	/**
	 * The reference instance of <code>dqv4.candidate_department</code>
	 */
	...
	/**
	 * The column <code>dqv4.candidate_department.id</code>.
	 */
	...
	/**
	 * The column <code>dqv4.candidate_department.department_id</code>. hr_position.id
	 */
	...
	/**
	 * The column <code>dqv4.candidate_department.update_time</code>. 修改时间
	 */
	...
	/**
	 * The column <code>dqv4.candidate_department.wxuser_id</code>. wx_group_user.id
	 */
	...
	/**
	 * The column <code>dqv4.candidate_department.status</code>. 候选人状态，0：删除，1：正常状态
	 */
	...
	/**
	 * The column <code>dqv4.candidate_department.is_recommend</code>. 是否推荐 false:未推荐，true:推荐
	 */
	...
	/**
	 * The column <code>dqv4.candidate_department.name</code>. sys_user.name 姓名或微信昵称
	 */
	...
	/**
	 * The column <code>dqv4.candidate_department.email</code>. sys_user.email 邮箱
	 */
	...
	/**
	 * The column <code>dqv4.candidate_department.mobile</code>. sys_user.mobile 电话
	 */
	...
	/**
	 * The column <code>dqv4.candidate_department.nickname</code>. wx_group_user.nickname 用户昵称
	 */
	...
	/**
	 * The column <code>dqv4.candidate_department.headimgurl</code>. wx_group_user.headimgurl 用户头像
	 */
	...
	/**
	 * The column <code>dqv4.candidate_department.sys_user_id</code>. sys_user.id
	 */
	...
	/**
	 * The column <code>dqv4.candidate_department.click_from</code>. 来自, 0:未知, 朋友圈(timeline ) 1, 微信群(groupmessage) 2, 个人消息(singlemessage)
	 */
	...
	/**
	 * Create a <code>dqv4.candidate_department</code> table reference
	 */
	...
	/**
	 * Create an aliased <code>dqv4.candidate_department</code> table reference
	 */
	...
	private CandidateDepartment(String alias, Table<CandidateDepartmentRecord> aliased, Field<?>[] parameters) {
		super(alias, Dqv4.DQV4, aliased, parameters, "候选人表");
	}
