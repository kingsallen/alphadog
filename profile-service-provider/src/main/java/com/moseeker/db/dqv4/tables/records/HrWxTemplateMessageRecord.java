...
public class HrWxTemplateMessageRecord extends UpdatableRecordImpl<HrWxTemplateMessageRecord> implements Record11<UInteger, Integer, String, UInteger, UInteger, UInteger, UInteger, String, String, String, String> {
	...
	private static final long serialVersionUID = -810763372;

	/**
	 * Setter for <code>dqv4.hr_wx_template_message.id</code>. 主key
	 */
	...
	/**
	 * Getter for <code>dqv4.hr_wx_template_message.id</code>. 主key
	 */
	...
	/**
	 * Setter for <code>dqv4.hr_wx_template_message.sys_template_id</code>. 模板ID
	 */
	...
	/**
	 * Getter for <code>dqv4.hr_wx_template_message.sys_template_id</code>. 模板ID
	 */
	...
	/**
	 * Setter for <code>dqv4.hr_wx_template_message.wx_template_id</code>. 微信模板ID
	 */
	...
	/**
	 * Getter for <code>dqv4.hr_wx_template_message.wx_template_id</code>. 微信模板ID
	 */
	...
	/**
	 * Setter for <code>dqv4.hr_wx_template_message.display</code>. 是否显示
	 */
	...
	/**
	 * Getter for <code>dqv4.hr_wx_template_message.display</code>. 是否显示
	 */
	...
	/**
	 * Setter for <code>dqv4.hr_wx_template_message.priority</code>. 排序
	 */
	...
	/**
	 * Getter for <code>dqv4.hr_wx_template_message.priority</code>. 排序
	 */
	...
	/**
	 * Setter for <code>dqv4.hr_wx_template_message.wechat_id</code>. 所属公众号
	 */
	...
	/**
	 * Getter for <code>dqv4.hr_wx_template_message.wechat_id</code>. 所属公众号
	 */
	...
	/**
	 * Setter for <code>dqv4.hr_wx_template_message.disable</code>. 是否可用
	 */
	...
	/**
	 * Getter for <code>dqv4.hr_wx_template_message.disable</code>. 是否可用
	 */
	...
	/**
	 * Setter for <code>dqv4.hr_wx_template_message.url</code>. 跳转URL
	 */
	...
	/**
	 * Getter for <code>dqv4.hr_wx_template_message.url</code>. 跳转URL
	 */
	...
	/**
	 * Setter for <code>dqv4.hr_wx_template_message.topcolor</code>. 消息头部颜色
	 */
	...
	/**
	 * Getter for <code>dqv4.hr_wx_template_message.topcolor</code>. 消息头部颜色
	 */
	...
	/**
	 * Setter for <code>dqv4.hr_wx_template_message.first</code>. 问候语
	 */
	...
	/**
	 * Getter for <code>dqv4.hr_wx_template_message.first</code>. 问候语
	 */
	...
	/**
	 * Setter for <code>dqv4.hr_wx_template_message.remark</code>. 结束语
	 */
	...
	/**
	 * Getter for <code>dqv4.hr_wx_template_message.remark</code>. 结束语
	 */
