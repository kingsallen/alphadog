...
public class LogWxMenuRecordRecord extends UpdatableRecordImpl<LogWxMenuRecordRecord> implements Record7<UInteger, UInteger, String, String, Timestamp, UInteger, String> {
	...
	private static final long serialVersionUID = -1612778972;

	/**
	 * Setter for <code>dqv4.log_wx_menu_record.id</code>.
	 */
	...
	/**
	 * Getter for <code>dqv4.log_wx_menu_record.id</code>.
	 */
	...
	/**
	 * Setter for <code>dqv4.log_wx_menu_record.wechat_id</code>.
	 */
	...
	/**
	 * Getter for <code>dqv4.log_wx_menu_record.wechat_id</code>.
	 */
	...
	/**
	 * Setter for <code>dqv4.log_wx_menu_record.name</code>.
	 */
	...
	/**
	 * Getter for <code>dqv4.log_wx_menu_record.name</code>.
	 */
	...
	/**
	 * Setter for <code>dqv4.log_wx_menu_record.json</code>. 菜单的json数据
	 */
	...
	/**
	 * Getter for <code>dqv4.log_wx_menu_record.json</code>. 菜单的json数据
	 */
	...
	/**
	 * Setter for <code>dqv4.log_wx_menu_record._create_time</code>.
	 */
	...
	/**
	 * Getter for <code>dqv4.log_wx_menu_record._create_time</code>.
	 */
	...
	/**
	 * Setter for <code>dqv4.log_wx_menu_record.errcode</code>. 微信调用返回的errcode
	 */
	...
	/**
	 * Getter for <code>dqv4.log_wx_menu_record.errcode</code>. 微信调用返回的errcode
	 */
	...
	/**
	 * Setter for <code>dqv4.log_wx_menu_record.errmsg</code>. 微信调用返回的errmsg
	 */
	...
	/**
	 * Getter for <code>dqv4.log_wx_menu_record.errmsg</code>. 微信调用返回的errmsg
	 */
