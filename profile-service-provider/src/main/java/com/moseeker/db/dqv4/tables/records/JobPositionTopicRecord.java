...
public class JobPositionTopicRecord extends TableRecordImpl<JobPositionTopicRecord> implements Record2<UInteger, UInteger> {
	...
	private static final long serialVersionUID = -800261761;

	/**
	 * Setter for <code>dqv4.job_position_topic.position_id</code>. hr_position.id, 职位ID
	 */
	...
	/**
	 * Getter for <code>dqv4.job_position_topic.position_id</code>. hr_position.id, 职位ID
	 */
	...
	/**
	 * Setter for <code>dqv4.job_position_topic.topic_id</code>. hr_topic.id, 主题ID
	 */
	...
	/**
	 * Getter for <code>dqv4.job_position_topic.topic_id</code>. hr_topic.id, 主题ID
	 */
