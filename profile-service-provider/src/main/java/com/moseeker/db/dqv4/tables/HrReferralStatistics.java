...
public class HrReferralStatistics extends TableImpl<HrReferralStatisticsRecord> {
	...
	private static final long serialVersionUID = -570658086;

	/**
	 * The reference instance of <code>dqv4.hr_referral_statistics</code>
	 */
	...
	/**
	 * The column <code>dqv4.hr_referral_statistics.id</code>. primary key
	 */
	...
	/**
	 * The column <code>dqv4.hr_referral_statistics.position_title</code>. hr_position.title
	 */
	...
	/**
	 * The column <code>dqv4.hr_referral_statistics.employee_name</code>. sys_employee.cname
	 */
	...
	/**
	 * The column <code>dqv4.hr_referral_statistics.employee_id</code>. 推荐员工 sys.employee.id
	 */
	...
	/**
	 * The column <code>dqv4.hr_referral_statistics.company_id</code>. sys_wechat.id
	 */
	...
	/**
	 * The column <code>dqv4.hr_referral_statistics.create_date</code>. 创建时间
	 */
	...
	/**
	 * The column <code>dqv4.hr_referral_statistics.recom_num</code>. 推荐浏览人次
	 */
	...
	/**
	 * The column <code>dqv4.hr_referral_statistics.recom_fav_num</code>. 推荐感兴趣人次
	 */
	...
	/**
	 * The column <code>dqv4.hr_referral_statistics.recom_mobile_num</code>. 推荐留手机人次
	 */
	...
	/**
	 * The column <code>dqv4.hr_referral_statistics.recom_apply_num</code>. 推荐投递人次
	 */
	...
	/**
	 * The column <code>dqv4.hr_referral_statistics.recom_after_review_num</code>. 推荐评审通过人数
	 */
	...
	/**
	 * The column <code>dqv4.hr_referral_statistics.recom_after_interview_num</code>. 推荐面试通过人数
	 */
	...
	/**
	 * The column <code>dqv4.hr_referral_statistics.recom_on_board_num</code>. 推荐入职人数
	 */
	...
	/**
	 * The column <code>dqv4.hr_referral_statistics.info_type</code>. 0: 日数据，1：周数据，2：月数据
	 */
	...
	/**
	 * The column <code>dqv4.hr_referral_statistics.publisher</code>.
	 */
	...
	/**
	 * Create a <code>dqv4.hr_referral_statistics</code> table reference
	 */
	...
	/**
	 * Create an aliased <code>dqv4.hr_referral_statistics</code> table reference
	 */
	...
	private HrReferralStatistics(String alias, Table<HrReferralStatisticsRecord> aliased, Field<?>[] parameters) {
		super(alias, Dqv4.DQV4, aliased, parameters, "内推统计表");
	}
