...
public class HrOperationRecordRecord extends UpdatableRecordImpl<HrOperationRecordRecord> implements Record7<Integer, Long, Long, Long, Long, Timestamp, Integer> {
	...
	private static final long serialVersionUID = -1520036821;

	/**
	 * Setter for <code>dqv4.hr_operation_record.id</code>.
	 */
	...
	/**
	 * Getter for <code>dqv4.hr_operation_record.id</code>.
	 */
	...
	/**
	 * Setter for <code>dqv4.hr_operation_record.admin_id</code>. hr_account.id
	 */
	...
	/**
	 * Getter for <code>dqv4.hr_operation_record.admin_id</code>. hr_account.id
	 */
	...
	/**
	 * Setter for <code>dqv4.hr_operation_record.company_id</code>. company.id
	 */
	...
	/**
	 * Getter for <code>dqv4.hr_operation_record.company_id</code>. company.id
	 */
	...
	/**
	 * Setter for <code>dqv4.hr_operation_record.app_id</code>. job_application.id
	 */
	...
	/**
	 * Getter for <code>dqv4.hr_operation_record.app_id</code>. job_application.id
	 */
	...
	/**
	 * Setter for <code>dqv4.hr_operation_record.status_id</code>. hr_award_config.id
	 */
	...
	/**
	 * Getter for <code>dqv4.hr_operation_record.status_id</code>. hr_award_config.id
	 */
	...
	/**
	 * Setter for <code>dqv4.hr_operation_record.opt_time</code>. 操作时间
	 */
	...
	/**
	 * Getter for <code>dqv4.hr_operation_record.opt_time</code>. 操作时间
	 */
	...
	/**
	 * Setter for <code>dqv4.hr_operation_record.operate_tpl_id</code>. hr_award_config_template.id
	 */
	...
	/**
	 * Getter for <code>dqv4.hr_operation_record.operate_tpl_id</code>. hr_award_config_template.id
	 */
