...
import com.moseeker.jooqhelper.tables.records.AuthorRecord;
import com.moseeker.jooqhelper.tables.records.BookRecord;
import com.moseeker.jooqhelper.tables.records.BookStoreRecord;
import com.moseeker.jooqhelper.tables.records.BookToBookStoreRecord;
import com.moseeker.jooqhelper.tables.records.LanguageRecord;
...
public class Keys {
	...
	private static class ForeignKeys0 extends AbstractKeys {
		public static final ForeignKey<BookRecord, AuthorRecord> FK_BOOK_AUTHOR = createForeignKey(com.moseeker.jooqhelper.Keys.KEY_AUTHOR_PRIMARY, Book.BOOK, Book.BOOK.AUTHOR_ID);
		public static final ForeignKey<BookRecord, LanguageRecord> FK_BOOK_LANGUAGE = createForeignKey(com.moseeker.jooqhelper.Keys.KEY_LANGUAGE_PRIMARY, Book.BOOK, Book.BOOK.LANGUAGE_ID);
		public static final ForeignKey<BookToBookStoreRecord, BookStoreRecord> FK_B2BS_BOOK_STORE = createForeignKey(com.moseeker.jooqhelper.Keys.KEY_BOOK_STORE_NAME, BookToBookStore.BOOK_TO_BOOK_STORE, BookToBookStore.BOOK_TO_BOOK_STORE.NAME);
		public static final ForeignKey<BookToBookStoreRecord, BookRecord> FK_B2BS_BOOK = createForeignKey(com.moseeker.jooqhelper.Keys.KEY_BOOK_PRIMARY, BookToBookStore.BOOK_TO_BOOK_STORE, BookToBookStore.BOOK_TO_BOOK_STORE.BOOK_ID);
	}
}
