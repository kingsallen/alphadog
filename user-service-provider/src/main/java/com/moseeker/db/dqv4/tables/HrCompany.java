...
public class HrCompany extends TableImpl<HrCompanyRecord> {
	...
	private static final long serialVersionUID = -1766797133;

	/**
	 * The reference instance of <code>dqv4.hr_company</code>
	 */
	...
	/**
	 * The column <code>dqv4.hr_company.id</code>.
	 */
	...
	/**
	 * The column <code>dqv4.hr_company.type</code>. 公司区分(其它:2,免费用户:1,企业用户:0)
	 */
	...
	/**
	 * The column <code>dqv4.hr_company.name</code>. 公司注册名称
	 */
	...
	/**
	 * The column <code>dqv4.hr_company.introduction</code>. 公司介绍
	 */
	...
	/**
	 * The column <code>dqv4.hr_company.scale</code>. 公司规模
	 */
	...
	/**
	 * The column <code>dqv4.hr_company.address</code>. 公司地址
	 */
	...
	/**
	 * The column <code>dqv4.hr_company.property</code>. 公司性质 0:没选择 1:国有 2:三资 3:集体 4:私有
	 */
	...
	/**
	 * The column <code>dqv4.hr_company.industry</code>. 所属行业
	 */
	...
	/**
	 * The column <code>dqv4.hr_company.homepage</code>. 公司主页
	 */
	...
	/**
	 * The column <code>dqv4.hr_company.impression</code>. json格式的企业印象
	 */
	...
	/**
	 * The column <code>dqv4.hr_company.banner</code>. json格式的企业banner
	 */
	...
	/**
	 * The column <code>dqv4.hr_company.parent_id</code>. 上级公司
	 */
	...
	/**
	 * The column <code>dqv4.hr_company.hraccount_id</code>. 公司联系人, hr_account.id
	 */
	...
	/**
	 * The column <code>dqv4.hr_company.create_time</code>. 创建时间
	 */
	...
	/**
	 * The column <code>dqv4.hr_company.update_time</code>. 更新时间
	 */
	...
	/**
	 * Create a <code>dqv4.hr_company</code> table reference
	 */
	public HrCompany() {
	...
	/**
	 * Create an aliased <code>dqv4.hr_company</code> table reference
	 */
	...
	private HrCompany(String alias, Table<HrCompanyRecord> aliased, Field<?>[] parameters) {
		super(alias, Dqv4.DQV4, aliased, parameters, "公司表");
	}
