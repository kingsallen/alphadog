...
public class ConfigSysH5StyleTpl extends TableImpl<ConfigSysH5StyleTplRecord> {
	...
	private static final long serialVersionUID = -858664037;

	/**
	 * The reference instance of <code>dqv4.config_sys_h5_style_tpl</code>
	 */
	...
	/**
	 * The column <code>dqv4.config_sys_h5_style_tpl.id</code>.
	 */
	...
	/**
	 * The column <code>dqv4.config_sys_h5_style_tpl.name</code>. 模板名称
	 */
	...
	/**
	 * The column <code>dqv4.config_sys_h5_style_tpl.logo</code>. 模板LOGO的相对路径
	 */
	...
	/**
	 * The column <code>dqv4.config_sys_h5_style_tpl.hr_tpl</code>. 模板风格名称，只允许英文，hr预览用
	 */
	...
	/**
	 * The column <code>dqv4.config_sys_h5_style_tpl.wx_tpl</code>. 模板风格名称，只允许英文，微信端用
	 */
	...
	/**
	 * The column <code>dqv4.config_sys_h5_style_tpl.priority</code>. 排序优先级
	 */
	...
	/**
	 * The column <code>dqv4.config_sys_h5_style_tpl.disable</code>. 是否有效  0：有效 1：无效
	 */
	...
	/**
	 * The column <code>dqv4.config_sys_h5_style_tpl.create_time</code>.
	 */
	...
	/**
	 * The column <code>dqv4.config_sys_h5_style_tpl.update_time</code>.
	 */
	...
	/**
	 * Create a <code>dqv4.config_sys_h5_style_tpl</code> table reference
	 */
	...
	/**
	 * Create an aliased <code>dqv4.config_sys_h5_style_tpl</code> table reference
	 */
	...
	private ConfigSysH5StyleTpl(String alias, Table<ConfigSysH5StyleTplRecord> aliased, Field<?>[] parameters) {
		super(alias, Dqv4.DQV4, aliased, parameters, "大岂H5模板表");
	}
