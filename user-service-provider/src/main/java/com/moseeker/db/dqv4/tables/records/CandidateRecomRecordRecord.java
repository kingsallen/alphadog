...
public class CandidateRecomRecordRecord extends UpdatableRecordImpl<CandidateRecomRecordRecord> implements Record17<UInteger, Integer, Integer, Integer, Timestamp, Integer, Integer, Integer, String, String, String, String, Timestamp, Integer, Timestamp, Timestamp, String> {
	...
	private static final long serialVersionUID = -850479519;

	/**
	 * Setter for <code>dqv4.candidate_recom_record.id</code>. 主key
	 */
	...
	/**
	 * Getter for <code>dqv4.candidate_recom_record.id</code>. 主key
	 */
	...
	/**
	 * Setter for <code>dqv4.candidate_recom_record.position_id</code>. 推荐的职位ID, hr_position.id
	 */
	...
	/**
	 * Getter for <code>dqv4.candidate_recom_record.position_id</code>. 推荐的职位ID, hr_position.id
	 */
	...
	/**
	 * Setter for <code>dqv4.candidate_recom_record.app_id</code>. job_application.id, 被推荐者申请ID
	 */
	...
	/**
	 * Getter for <code>dqv4.candidate_recom_record.app_id</code>. job_application.id, 被推荐者申请ID
	 */
	...
	/**
	 * Setter for <code>dqv4.candidate_recom_record.presentee_id</code>. wx_group_user.id, 被推荐者的微信ID
	 */
	...
	/**
	 * Getter for <code>dqv4.candidate_recom_record.presentee_id</code>. wx_group_user.id, 被推荐者的微信ID
	 */
	...
	/**
	 * Setter for <code>dqv4.candidate_recom_record.click_time</code>. 职位点击时间
	 */
	...
	/**
	 * Getter for <code>dqv4.candidate_recom_record.click_time</code>. 职位点击时间
	 */
	...
	/**
	 * Setter for <code>dqv4.candidate_recom_record.depth</code>. 第几层关系
	 */
	...
	/**
	 * Getter for <code>dqv4.candidate_recom_record.depth</code>. 第几层关系
	 */
	...
	/**
	 * Setter for <code>dqv4.candidate_recom_record.recom_id_2</code>. wx_group_user.id, 第2度人脉推荐人微信ID，用来标记谁的朋友
	 */
	...
	/**
	 * Getter for <code>dqv4.candidate_recom_record.recom_id_2</code>. wx_group_user.id, 第2度人脉推荐人微信ID，用来标记谁的朋友
	 */
	...
	/**
	 * Setter for <code>dqv4.candidate_recom_record.recom_id</code>. wx_group_user.id, 推荐者的微信ID
	 */
	...
	/**
	 * Getter for <code>dqv4.candidate_recom_record.recom_id</code>. wx_group_user.id, 推荐者的微信ID
	 */
	...
	/**
	 * Setter for <code>dqv4.candidate_recom_record.realname</code>. 被推荐人真实姓名
	 */
	...
	/**
	 * Getter for <code>dqv4.candidate_recom_record.realname</code>. 被推荐人真实姓名
	 */
	...
	/**
	 * Setter for <code>dqv4.candidate_recom_record.company</code>. 被推荐者目前就职公司
	 */
	...
	/**
	 * Getter for <code>dqv4.candidate_recom_record.company</code>. 被推荐者目前就职公司
	 */
	...
	/**
	 * Setter for <code>dqv4.candidate_recom_record.position</code>. 被推荐者的职位
	 */
	...
	/**
	 * Getter for <code>dqv4.candidate_recom_record.position</code>. 被推荐者的职位
	 */
	...
	/**
	 * Setter for <code>dqv4.candidate_recom_record.recom_reason</code>. 推荐理由, 逗号分隔
	 */
	...
	/**
	 * Getter for <code>dqv4.candidate_recom_record.recom_reason</code>. 推荐理由, 逗号分隔
	 */
	...
	/**
	 * Setter for <code>dqv4.candidate_recom_record.recom_time</code>. 推荐时间
	 */
	...
	/**
	 * Getter for <code>dqv4.candidate_recom_record.recom_time</code>. 推荐时间
	 */
	...
	/**
	 * Setter for <code>dqv4.candidate_recom_record.is_recom</code>. 推荐状态，0：推荐过，1：未推荐
	 */
	...
	/**
	 * Getter for <code>dqv4.candidate_recom_record.is_recom</code>. 推荐状态，0：推荐过，1：未推荐
	 */
	...
	/**
	 * Setter for <code>dqv4.candidate_recom_record.create_time</code>. 创建时间
	 */
	...
	/**
	 * Getter for <code>dqv4.candidate_recom_record.create_time</code>. 创建时间
	 */
	...
	/**
	 * Setter for <code>dqv4.candidate_recom_record.update_time</code>. 更新时间
	 */
	...
	/**
	 * Getter for <code>dqv4.candidate_recom_record.update_time</code>. 更新时间
	 */
	...
	/**
	 * Setter for <code>dqv4.candidate_recom_record.mobile</code>. 被推荐者的手机号
	 */
	...
	/**
	 * Getter for <code>dqv4.candidate_recom_record.mobile</code>. 被推荐者的手机号
	 */
