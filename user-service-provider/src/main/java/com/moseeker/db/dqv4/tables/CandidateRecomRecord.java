...
public class CandidateRecomRecord extends TableImpl<CandidateRecomRecordRecord> {
	...
	private static final long serialVersionUID = 1598683698;

	/**
	 * The reference instance of <code>dqv4.candidate_recom_record</code>
	 */
	...
	/**
	 * The column <code>dqv4.candidate_recom_record.id</code>. 主key
	 */
	...
	/**
	 * The column <code>dqv4.candidate_recom_record.position_id</code>. 推荐的职位ID, hr_position.id
	 */
	...
	/**
	 * The column <code>dqv4.candidate_recom_record.app_id</code>. job_application.id, 被推荐者申请ID
	 */
	...
	/**
	 * The column <code>dqv4.candidate_recom_record.presentee_id</code>. wx_group_user.id, 被推荐者的微信ID
	 */
	...
	/**
	 * The column <code>dqv4.candidate_recom_record.click_time</code>. 职位点击时间
	 */
	...
	/**
	 * The column <code>dqv4.candidate_recom_record.depth</code>. 第几层关系
	 */
	...
	/**
	 * The column <code>dqv4.candidate_recom_record.recom_id_2</code>. wx_group_user.id, 第2度人脉推荐人微信ID，用来标记谁的朋友
	 */
	...
	/**
	 * The column <code>dqv4.candidate_recom_record.recom_id</code>. wx_group_user.id, 推荐者的微信ID
	 */
	...
	/**
	 * The column <code>dqv4.candidate_recom_record.realname</code>. 被推荐人真实姓名
	 */
	...
	/**
	 * The column <code>dqv4.candidate_recom_record.company</code>. 被推荐者目前就职公司
	 */
	...
	/**
	 * The column <code>dqv4.candidate_recom_record.position</code>. 被推荐者的职位
	 */
	...
	/**
	 * The column <code>dqv4.candidate_recom_record.recom_reason</code>. 推荐理由, 逗号分隔
	 */
	...
	/**
	 * The column <code>dqv4.candidate_recom_record.recom_time</code>. 推荐时间
	 */
	...
	/**
	 * The column <code>dqv4.candidate_recom_record.is_recom</code>. 推荐状态，0：推荐过，1：未推荐
	 */
	...
	/**
	 * The column <code>dqv4.candidate_recom_record.create_time</code>. 创建时间
	 */
	...
	/**
	 * The column <code>dqv4.candidate_recom_record.update_time</code>. 更新时间
	 */
	...
	/**
	 * The column <code>dqv4.candidate_recom_record.mobile</code>. 被推荐者的手机号
	 */
	...
	/**
	 * Create a <code>dqv4.candidate_recom_record</code> table reference
	 */
	...
	/**
	 * Create an aliased <code>dqv4.candidate_recom_record</code> table reference
	 */
	...
	private CandidateRecomRecord(String alias, Table<CandidateRecomRecordRecord> aliased, Field<?>[] parameters) {
		super(alias, Dqv4.DQV4, aliased, parameters, "候选人推荐记录表");
	}
