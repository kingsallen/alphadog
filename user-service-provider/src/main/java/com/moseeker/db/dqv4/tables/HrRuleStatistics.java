...
public class HrRuleStatistics extends TableImpl<HrRuleStatisticsRecord> {
	...
	private static final long serialVersionUID = 442890209;

	/**
	 * The reference instance of <code>dqv4.hr_rule_statistics</code>
	 */
	...
	/**
	 * The column <code>dqv4.hr_rule_statistics.id</code>. primary key
	 */
	...
	/**
	 * The column <code>dqv4.hr_rule_statistics.wxrule_id</code>. wx_rule.id
	 */
	...
	/**
	 * The column <code>dqv4.hr_rule_statistics.menu_name</code>. 菜单名称
	 */
	...
	/**
	 * The column <code>dqv4.hr_rule_statistics.type</code>. 0: wx_rule, 1: menu
	 */
	...
	/**
	 * The column <code>dqv4.hr_rule_statistics.company_id</code>. company.id
	 */
	...
	/**
	 * The column <code>dqv4.hr_rule_statistics.view_num_pv</code>. 浏览人数
	 */
	...
	/**
	 * The column <code>dqv4.hr_rule_statistics.create_date</code>. 创建日期
	 */
	...
	/**
	 * Create a <code>dqv4.hr_rule_statistics</code> table reference
	 */
	...
	/**
	 * Create an aliased <code>dqv4.hr_rule_statistics</code> table reference
	 */
	...
	private HrRuleStatistics(String alias, Table<HrRuleStatisticsRecord> aliased, Field<?>[] parameters) {
		super(alias, Dqv4.DQV4, aliased, parameters, "微信图文传播次数统计表");
	}
