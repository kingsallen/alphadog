...
public class HrPointsConf extends TableImpl<HrPointsConfRecord> {
	...
	private static final long serialVersionUID = -629379336;

	/**
	 * The reference instance of <code>dqv4.hr_points_conf</code>
	 */
	...
	/**
	 * The column <code>dqv4.hr_points_conf.id</code>.
	 */
	...
	/**
	 * The column <code>dqv4.hr_points_conf.company_id</code>.
	 */
	...
	/**
	 * The column <code>dqv4.hr_points_conf.status_name</code>. name of status defined, if using ATS, please set it the same as ATS
	 */
	...
	/**
	 * The column <code>dqv4.hr_points_conf.reward</code>. 积分数量
	 */
	...
	/**
	 * The column <code>dqv4.hr_points_conf.description</code>.
	 */
	...
	/**
	 * The column <code>dqv4.hr_points_conf.is_using</code>. 是否启用0：启用1：禁用
	 */
	...
	/**
	 * The column <code>dqv4.hr_points_conf.order_num</code>. 优先级
	 */
	...
	/**
	 * The column <code>dqv4.hr_points_conf.tag</code>.
	 */
	public final TableField<HrPointsConfRecord, String> TAG = createField("tag", org.jooq.impl.SQLDataType.VARCHAR.length(30), this, "");

	/**
	 * The column <code>dqv4.hr_points_conf.is_applier_send</code>. 申请者是否发送消息模板0:发送1:不发送
	 */
	...
	/**
	 * The column <code>dqv4.hr_points_conf.applier_first</code>. 申请状态模板发送问候语
	 */
	...
	/**
	 * The column <code>dqv4.hr_points_conf.applier_remark</code>. 申请状态模板发送结束语
	 */
	...
	/**
	 * The column <code>dqv4.hr_points_conf.is_recom_send</code>. 推荐者是否发送消息模板0:发送1:不发送
	 */
	...
	/**
	 * The column <code>dqv4.hr_points_conf.recom_first</code>. 推荐者申请状态模板发送问候语
	 */
	...
	/**
	 * The column <code>dqv4.hr_points_conf.recom_remark</code>. 推荐者申请状态模板发送结束语
	 */
	...
	/**
	 * The column <code>dqv4.hr_points_conf.template_id</code>. 申请状态模板ID，hr_award_config_template.id
	 */
	...
	/**
	 * The column <code>dqv4.hr_points_conf.update_time</code>.
	 */
	...
	/**
	 * Create a <code>dqv4.hr_points_conf</code> table reference
	 */
	public HrPointsConf() {
	...
	/**
	 * Create an aliased <code>dqv4.hr_points_conf</code> table reference
	 */
	...
	private HrPointsConf(String alias, Table<HrPointsConfRecord> aliased, Field<?>[] parameters) {
		super(alias, Dqv4.DQV4, aliased, parameters, "雇主积分规则配置表");
	}
