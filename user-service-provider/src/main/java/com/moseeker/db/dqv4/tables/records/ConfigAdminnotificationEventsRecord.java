...
public class ConfigAdminnotificationEventsRecord extends UpdatableRecordImpl<ConfigAdminnotificationEventsRecord> implements Record12<Integer, String, String, String, String, Integer, Integer, Byte, Byte, Byte, Integer, Timestamp> {
	...
	private static final long serialVersionUID = 480548364;

	/**
	 * Setter for <code>dqv4.config_adminnotification_events.id</code>.
	 */
	...
	/**
	 * Getter for <code>dqv4.config_adminnotification_events.id</code>.
	 */
	...
	/**
	 * Setter for <code>dqv4.config_adminnotification_events.project_appid</code>. 项目appid
	 */
	...
	/**
	 * Getter for <code>dqv4.config_adminnotification_events.project_appid</code>. 项目appid
	 */
	...
	/**
	 * Setter for <code>dqv4.config_adminnotification_events.event_key</code>. 事件标识符，大写英文
	 */
	...
	/**
	 * Getter for <code>dqv4.config_adminnotification_events.event_key</code>. 事件标识符，大写英文
	 */
	...
	/**
	 * Setter for <code>dqv4.config_adminnotification_events.event_name</code>. 事件名称
	 */
	...
	/**
	 * Getter for <code>dqv4.config_adminnotification_events.event_name</code>. 事件名称
	 */
	...
	/**
	 * Setter for <code>dqv4.config_adminnotification_events.event_desc</code>. 事件描述
	 */
	...
	/**
	 * Getter for <code>dqv4.config_adminnotification_events.event_desc</code>. 事件描述
	 */
	...
	/**
	 * Setter for <code>dqv4.config_adminnotification_events.threshold_value</code>. 触发几次后通知
	 */
	...
	/**
	 * Getter for <code>dqv4.config_adminnotification_events.threshold_value</code>. 触发几次后通知
	 */
	...
	/**
	 * Setter for <code>dqv4.config_adminnotification_events.threshold_interval</code>. 单位秒，0表示不限制，  thresholdinterval和thresholdvalue搭配使用，表达 每分钟超过5次 报警。
	 */
	...
	/**
	 * Getter for <code>dqv4.config_adminnotification_events.threshold_interval</code>. 单位秒，0表示不限制，  thresholdinterval和thresholdvalue搭配使用，表达 每分钟超过5次 报警。
	 */
	...
	/**
	 * Setter for <code>dqv4.config_adminnotification_events.enable_notifyby_email</code>. 是否email通知， 1是 0否
	 */
	...
	/**
	 * Getter for <code>dqv4.config_adminnotification_events.enable_notifyby_email</code>. 是否email通知， 1是 0否
	 */
	...
	/**
	 * Setter for <code>dqv4.config_adminnotification_events.enable_notifyby_sms</code>. 是否短信通知， 1是 0否
	 */
	...
	/**
	 * Getter for <code>dqv4.config_adminnotification_events.enable_notifyby_sms</code>. 是否短信通知， 1是 0否
	 */
	...
	/**
	 * Setter for <code>dqv4.config_adminnotification_events.enable_notifyby_wechattemplatemessage</code>. 是否微信模板消息通知， 1是 0否
	 */
	...
	/**
	 * Getter for <code>dqv4.config_adminnotification_events.enable_notifyby_wechattemplatemessage</code>. 是否微信模板消息通知， 1是 0否
	 */
	...
	/**
	 * Setter for <code>dqv4.config_adminnotification_events.groupid</code>. 发送给哪个组
	 */
	...
	/**
	 * Getter for <code>dqv4.config_adminnotification_events.groupid</code>. 发送给哪个组
	 */
	...
	/**
	 * Setter for <code>dqv4.config_adminnotification_events.create_time</code>.
	 */
	...
	/**
	 * Getter for <code>dqv4.config_adminnotification_events.create_time</code>.
	 */
