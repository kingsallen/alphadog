...
public class HrRuleUniqueStatistics extends TableImpl<HrRuleUniqueStatisticsRecord> {
	...
	private static final long serialVersionUID = -481997651;

	/**
	 * The reference instance of <code>dqv4.hr_rule_unique_statistics</code>
	 */
	...
	/**
	 * The column <code>dqv4.hr_rule_unique_statistics.id</code>. primary key
	 */
	...
	/**
	 * The column <code>dqv4.hr_rule_unique_statistics.wxrule_id</code>. wx_rule.id
	 */
	...
	/**
	 * The column <code>dqv4.hr_rule_unique_statistics.menu_name</code>. 菜单名称
	 */
	...
	/**
	 * The column <code>dqv4.hr_rule_unique_statistics.type</code>. 0: wx_rule, 1: menu
	 */
	...
	/**
	 * The column <code>dqv4.hr_rule_unique_statistics.company_id</code>. company.id
	 */
	...
	/**
	 * The column <code>dqv4.hr_rule_unique_statistics.view_num_uv</code>. 浏览人数
	 */
	...
	/**
	 * The column <code>dqv4.hr_rule_unique_statistics.create_date</code>. 创建日期
	 */
	...
	/**
	 * The column <code>dqv4.hr_rule_unique_statistics.info_type</code>. 0: 日数据，1：周数据，2：月数据
	 */
	...
	/**
	 * Create a <code>dqv4.hr_rule_unique_statistics</code> table reference
	 */
	...
	/**
	 * Create an aliased <code>dqv4.hr_rule_unique_statistics</code> table reference
	 */
	...
	private HrRuleUniqueStatistics(String alias, Table<HrRuleUniqueStatisticsRecord> aliased, Field<?>[] parameters) {
		super(alias, Dqv4.DQV4, aliased, parameters, "微信图文传播去重信息统计表");
	}
