...
public class ConfigSysAppTemplate extends TableImpl<ConfigSysAppTemplateRecord> {
	...
	private static final long serialVersionUID = 1922012553;

	/**
	 * The reference instance of <code>dqv4.config_sys_app_template</code>
	 */
	...
	/**
	 * The column <code>dqv4.config_sys_app_template.id</code>.
	 */
	...
	/**
	 * The column <code>dqv4.config_sys_app_template.enname</code>. 申请字段英文名称
	 */
	...
	/**
	 * The column <code>dqv4.config_sys_app_template.chname</code>. 申请字段中文名称
	 */
	...
	/**
	 * The column <code>dqv4.config_sys_app_template.priority</code>. 排序
	 */
	...
	/**
	 * The column <code>dqv4.config_sys_app_template.display</code>. 是否显示0：是，1：否
	 */
	...
	/**
	 * The column <code>dqv4.config_sys_app_template.required</code>. 是否必填0：是，1：否
	 */
	...
	/**
	 * The column <code>dqv4.config_sys_app_template.type</code>. 模板类型
	 */
	...
	/**
	 * The column <code>dqv4.config_sys_app_template.remark</code>. 备注
	 */
	...
	/**
	 * The column <code>dqv4.config_sys_app_template.entitle</code>. 字段英文名称
	 */
	...
	/**
	 * The column <code>dqv4.config_sys_app_template.parent_id</code>. 字段父子关系
	 */
	...
	/**
	 * Create a <code>dqv4.config_sys_app_template</code> table reference
	 */
	...
	/**
	 * Create an aliased <code>dqv4.config_sys_app_template</code> table reference
	 */
	...
	private ConfigSysAppTemplate(String alias, Table<ConfigSysAppTemplateRecord> aliased, Field<?>[] parameters) {
		super(alias, Dqv4.DQV4, aliased, parameters, "申请字段模板表");
	}
