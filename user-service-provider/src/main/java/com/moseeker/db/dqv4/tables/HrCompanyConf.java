...
public class HrCompanyConf extends TableImpl<HrCompanyConfRecord> {
	...
	private static final long serialVersionUID = -357477640;

	/**
	 * The reference instance of <code>dqv4.hr_company_conf</code>
	 */
	...
	/**
	 * The column <code>dqv4.hr_company_conf.company_id</code>.
	 */
	...
	/**
	 * The column <code>dqv4.hr_company_conf.topic_id</code>. hr_topic id
	 */
	...
	/**
	 * The column <code>dqv4.hr_company_conf.theme_id</code>. sys_theme id
	 */
	...
	/**
	 * The column <code>dqv4.hr_company_conf.hb_throttle</code>. 全局每人每次红包活动可以获得的红包金额上限
	 */
	...
	/**
	 * The column <code>dqv4.hr_company_conf.app_reply</code>. 申请提交成功回复信息
	 */
	...
	/**
	 * The column <code>dqv4.hr_company_conf.email_resume_conf</code>. 0:允许使用email简历进行投递；1:不允许使用email简历投递
	 */
	...
	/**
	 * The column <code>dqv4.hr_company_conf.create_time</code>. 创建时间
	 */
	...
	/**
	 * The column <code>dqv4.hr_company_conf.update_time</code>. 更新时间
	 */
	...
	/**
	 * Create a <code>dqv4.hr_company_conf</code> table reference
	 */
	...
	/**
	 * Create an aliased <code>dqv4.hr_company_conf</code> table reference
	 */
	...
	private HrCompanyConf(String alias, Table<HrCompanyConfRecord> aliased, Field<?>[] parameters) {
		super(alias, Dqv4.DQV4, aliased, parameters, "公司级别的配置信息表");
	}
