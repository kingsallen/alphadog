...
public class HrWxHrChat extends TableImpl<HrWxHrChatRecord> {
	...
	private static final long serialVersionUID = -243433397;

	/**
	 * The reference instance of <code>dqv4.hr_wx_hr_chat</code>
	 */
	...
	/**
	 * The column <code>dqv4.hr_wx_hr_chat.id</code>. ID
	 */
	...
	/**
	 * The column <code>dqv4.hr_wx_hr_chat.chatlist_id</code>. wx_hr_chat_list.id
	 */
	...
	/**
	 * The column <code>dqv4.hr_wx_hr_chat.content</code>. 聊天内容
	 */
	...
	/**
	 * The column <code>dqv4.hr_wx_hr_chat.pid</code>. hr_position.id
	 */
	...
	/**
	 * The column <code>dqv4.hr_wx_hr_chat.speaker</code>. 状态，0：求职者，1：HR
	 */
	...
	/**
	 * The column <code>dqv4.hr_wx_hr_chat.status</code>. 状态，0：有效，1：无效
	 */
	...
	/**
	 * The column <code>dqv4.hr_wx_hr_chat.create_time</code>. 创建时间
	 */
	...
	/**
	 * Create a <code>dqv4.hr_wx_hr_chat</code> table reference
	 */
	public HrWxHrChat() {
	...
	/**
	 * Create an aliased <code>dqv4.hr_wx_hr_chat</code> table reference
	 */
	...
	private HrWxHrChat(String alias, Table<HrWxHrChatRecord> aliased, Field<?>[] parameters) {
		super(alias, Dqv4.DQV4, aliased, parameters, "IM聊天");
	}
