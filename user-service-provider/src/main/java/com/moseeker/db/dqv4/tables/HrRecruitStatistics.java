...
public class HrRecruitStatistics extends TableImpl<HrRecruitStatisticsRecord> {
	...
	private static final long serialVersionUID = -1895996692;

	/**
	 * The reference instance of <code>dqv4.hr_recruit_statistics</code>
	 */
	...
	/**
	 * The column <code>dqv4.hr_recruit_statistics.id</code>. primary key
	 */
	...
	/**
	 * The column <code>dqv4.hr_recruit_statistics.position_id</code>. hr_position.id
	 */
	...
	/**
	 * The column <code>dqv4.hr_recruit_statistics.company_id</code>. company.id
	 */
	...
	/**
	 * The column <code>dqv4.hr_recruit_statistics.jd_pv</code>. JD 页浏览次数
	 */
	...
	/**
	 * The column <code>dqv4.hr_recruit_statistics.recom_jd_pv</code>. JD 页推荐浏览次数
	 */
	...
	/**
	 * The column <code>dqv4.hr_recruit_statistics.fav_num</code>. 感兴趣的次数
	 */
	...
	/**
	 * The column <code>dqv4.hr_recruit_statistics.recom_fav_num</code>. 推荐感兴趣的次数
	 */
	...
	/**
	 * The column <code>dqv4.hr_recruit_statistics.apply_num</code>. 投递次数
	 */
	...
	/**
	 * The column <code>dqv4.hr_recruit_statistics.recom_apply_num</code>. 推荐投递次数
	 */
	...
	/**
	 * The column <code>dqv4.hr_recruit_statistics.create_date</code>. 创建日期
	 */
	...
	/**
	 * The column <code>dqv4.hr_recruit_statistics.after_review_num</code>. 评审通过人数
	 */
	...
	/**
	 * The column <code>dqv4.hr_recruit_statistics.recom_after_review_num</code>. 推荐评审通过人数
	 */
	...
	/**
	 * The column <code>dqv4.hr_recruit_statistics.after_interview_num</code>. 面试通过人数
	 */
	...
	/**
	 * The column <code>dqv4.hr_recruit_statistics.recom_after_interview_num</code>. 推荐面试通过人数
	 */
	...
	/**
	 * The column <code>dqv4.hr_recruit_statistics.on_board_num</code>. 入职人数
	 */
	...
	/**
	 * The column <code>dqv4.hr_recruit_statistics.recom_on_board_num</code>. 推荐入职人数
	 */
	...
	/**
	 * Create a <code>dqv4.hr_recruit_statistics</code> table reference
	 */
	...
	/**
	 * Create an aliased <code>dqv4.hr_recruit_statistics</code> table reference
	 */
	...
	private HrRecruitStatistics(String alias, Table<HrRecruitStatisticsRecord> aliased, Field<?>[] parameters) {
		super(alias, Dqv4.DQV4, aliased, parameters, "招聘数据次数统计表");
	}
