...
public class CandidatePositionShareRecord extends TableImpl<CandidatePositionShareRecordRecord> {
	...
	private static final long serialVersionUID = 705555514;

	/**
	 * The reference instance of <code>dqv4.candidate_position_share_record</code>
	 */
	...
	/**
	 * The column <code>dqv4.candidate_position_share_record.id</code>.
	 */
	...
	/**
	 * The column <code>dqv4.candidate_position_share_record.wechat_id</code>. 所属公众号
	 */
	...
	/**
	 * The column <code>dqv4.candidate_position_share_record.position_id</code>. position.id 分享职位ID
	 */
	...
	/**
	 * The column <code>dqv4.candidate_position_share_record.recom_id</code>. wx_group_user.id 分享用户微信ID
	 */
	...
	/**
	 * The column <code>dqv4.candidate_position_share_record.sysuser_id</code>. sysuser.id 浏览用户sysuser.id
	 */
	...
	/**
	 * The column <code>dqv4.candidate_position_share_record.viewer_id</code>. wx_viewer.id 浏览用户ID
	 */
	...
	/**
	 * The column <code>dqv4.candidate_position_share_record.viewer_ip</code>. 浏览用户IP
	 */
	...
	/**
	 * The column <code>dqv4.candidate_position_share_record.source</code>. 来源0：企业后台1：聚合平台
	 */
	...
	/**
	 * The column <code>dqv4.candidate_position_share_record.create_time</code>. 创建时间
	 */
	...
	/**
	 * The column <code>dqv4.candidate_position_share_record.update_time</code>. 修改时间
	 */
	...
	/**
	 * The column <code>dqv4.candidate_position_share_record.presentee_id</code>. 被动求职者,浏览者的微信ID，wx_group_user.id
	 */
	...
	/**
	 * The column <code>dqv4.candidate_position_share_record.click_from</code>. 来自, 0:未知, 朋友圈(timeline ) 1, 微信群(groupmessage) 2, 个人消息(singlemessage) 3
	 */
	...
	/**
	 * Create a <code>dqv4.candidate_position_share_record</code> table reference
	 */
	...
	/**
	 * Create an aliased <code>dqv4.candidate_position_share_record</code> table reference
	 */
	...
	private CandidatePositionShareRecord(String alias, Table<CandidatePositionShareRecordRecord> aliased, Field<?>[] parameters) {
		super(alias, Dqv4.DQV4, aliased, parameters, "用户分享职位访问记录");
	}
