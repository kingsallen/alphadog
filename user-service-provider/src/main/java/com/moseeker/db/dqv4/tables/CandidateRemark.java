...
public class CandidateRemark extends TableImpl<CandidateRemarkRecord> {
	...
	private static final long serialVersionUID = 1508120451;

	/**
	 * The reference instance of <code>dqv4.candidate_remark</code>
	 */
	...
	/**
	 * The column <code>dqv4.candidate_remark.id</code>.
	 */
	...
	/**
	 * The column <code>dqv4.candidate_remark.hraccount_id</code>. 做候选人标记的账号编号 hr_account.id
	 */
	...
	/**
	 * The column <code>dqv4.candidate_remark.wxuser_id</code>. wx_group_user.id 被推荐者 微信 ID
	 */
	...
	/**
	 * The column <code>dqv4.candidate_remark.gender</code>. 0：未知，1：男，2：女
	 */
	...
	/**
	 * The column <code>dqv4.candidate_remark.age</code>. 年龄
	 */
	...
	/**
	 * The column <code>dqv4.candidate_remark.mobile</code>. 联系方式
	 */
	...
	/**
	 * The column <code>dqv4.candidate_remark.email</code>. 邮箱
	 */
	...
	/**
	 * The column <code>dqv4.candidate_remark.current_company</code>. 现处公司
	 */
	...
	/**
	 * The column <code>dqv4.candidate_remark.current_position</code>. 职务
	 */
	...
	/**
	 * The column <code>dqv4.candidate_remark.education</code>. 毕业院校
	 */
	...
	/**
	 * The column <code>dqv4.candidate_remark.degree</code>. 学历
	 */
	...
	/**
	 * The column <code>dqv4.candidate_remark.graduate_at</code>. 毕业时间
	 */
	...
	/**
	 * The column <code>dqv4.candidate_remark.is_star</code>. 0: 星标 1: 没有星标
	 */
	...
	/**
	 * The column <code>dqv4.candidate_remark.remark</code>. 备注
	 */
	...
	/**
	 * The column <code>dqv4.candidate_remark.create_time</code>. 创建时间
	 */
	...
	/**
	 * The column <code>dqv4.candidate_remark.update_time</code>. 修改时间
	 */
	...
	/**
	 * The column <code>dqv4.candidate_remark.status</code>. 0: 新数据 1: 正常 2:被忽略
	 */
	...
	/**
	 * The column <code>dqv4.candidate_remark.name</code>. 候选人姓名
	 */
	...
	/**
	 * Create a <code>dqv4.candidate_remark</code> table reference
	 */
	...
	/**
	 * Create an aliased <code>dqv4.candidate_remark</code> table reference
	 */
	...
	private CandidateRemark(String alias, Table<CandidateRemarkRecord> aliased, Field<?>[] parameters) {
		super(alias, Dqv4.DQV4, aliased, parameters, "HR对候选人备注信息信息");
	}
